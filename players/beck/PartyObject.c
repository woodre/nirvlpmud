...
id(str){ return str == "party_object" || str == "object" || str == "party object"; }
...
long(){
   ...
   "party remove                 Remove a player from the party.\n"+
...
share_exp(amount){   MASTER->ShareExp(amount,RealPartyName,environment(this_object())); }
