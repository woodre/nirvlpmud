...
"so far that the beach is hardly visible; And offers no protection!\n"+
...
swim(arg) {
if(!arg) {write("You can swim around, back,beach, or out, but you must swim somewhere.\n");
return 1; }
if(arg =="back") {
call_other(this_player(),"move_player","swim#/players/beck/room/sea2.c");
...
if(arg=="around") {
call_other(this_player(),"move_player","swim#/players/beck/room/sea13.c");
write("You swim counter-clockwise around the island.\n");
return 1;
}
if(arg=="beach") {
write("You swim back to the beach.\n");
call_other(this_player(),"move_player","swim#/players/beck/room/venus1.c");
}
}
