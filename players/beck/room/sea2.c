...
return 1; }
if(arg =="back") {
call_other(this_player(),"move_player","swim#/players/beck/room/sea3.c");
...
if(arg=="around") {
call_other(this_player(),"move_player","swim#/players/beck/room/sea1.c");
write("You swim counter-clockwise around the island.\n");
return 1;
}
if(arg=="beach") {
write("You swim back to the beach.\n");
call_other(this_player(),"move_player","swim#/players/beck/room/venus2.c");
return 1;
}
}
