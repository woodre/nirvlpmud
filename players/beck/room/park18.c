...
reset(arg) {
   ...
   "There is a steep cliff wall to the north.\n"+
   "",
   items=
   ({
   ...
   dest_dir=
   ({
   "players/beck/room/park21","northeast",
   "players/beck/room/park22","east",
   "players/beck/room/park14","west",
   "players/beck/room/park13","northwest",
   });
}
