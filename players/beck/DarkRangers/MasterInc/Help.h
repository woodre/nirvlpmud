ranger_help(str){
   ...
   if(!str){
      write(""+
         "\n"+
         "The Dark Rangers guild is based loosely on the Fox TV show.\n"+
         "It should be considered a 'evil' guild, where anything goes.\n"+
         "In this guild any weak link will be amplified.\n"+
   ...
   if(str == "training"){
      write(""+
         "*************************Dark Ranger Training***********************\n"+
         "\n\n"+
         "Training for the Dark Rangers guild differs slightly from that of \n"+
   ...
   if(str == "morphed"){
      write(""+
         ...
         "teleport     40  ($) Teleports a ranger to special rooms.\n"+
   ...
   if(str == "unmorphed"){
      write(""+
         ...
         "morph       100-250($) Morphs a ranger.\n"+
         "ninja       40 ($) Turns a ranger into a ninja.\n"+
         "teleport    70 ($) Teleports a ranger to special rooms.\n"+
         "** All numbers are rated in guild power  **\n"+
   ...
   if(str == "combat"){
      write(""+
         "***************************COMBAT***********************************\n"+
         "\n\n"+
         "Combat is the Primary ability of the Dark Rangers Guild.\n"+
         "There are a few key differences between the Rangers and any other\n"+
         "guild.\n"+
         "The main difference is that Dark Rangers never have a need for \n"+
         "Armor or Weapons.   \n"+
         "A Dark Ranger is equipped with the only weapon and armor they\n"+
         "need, automatically at the point they login to Nirvana.\n"+
         "Dark Rangers can engage in combat anytime, but they receive special\n"+
         ...
         "Dark Rangers cannot initially attack a very evil creature while morphed.\n"+
         "");
      return 1;
   }
   if(str == "spells"){
      write(""+
         "******************************SPELLS**********************************\n"+
         "\n\n"+
         "Dark Rangers have no spell use capability.  They may not use \n"+
         "the standard game spells, and there are no guild spells.\n"+
         "There is no guild healing spell either.\n"+
         "Dark Rangers are designed to be completely hand to hand combat\n"+
         "oriented.\n"+
         "");
      return 1;
   }
...
/*
         "As a member of the Dark Rangers I expect you will conduct yourself\n"+
...
*/  
   ...
   if(str == "teleport"){
      write(""+
         ...
         "while unmorphed.\n"+
         "Locations:\n"+
         "   castle           Lord Zed's Castle\n"+
         "   church           Village Church of Nirvana\n"+
         "   park             Angel Grove Park\n"+
         "   <name>           By entering the name of another Dark Ranger\n"+
   ...
   if(str == "pk"){
      write(""+
         "*********************Player Killing*********************************\n"+
         "\n\n"+
         "The Dark Rangers are allowed to set their Player Killing if they\n"+
         "choose to do so.  \n"+
