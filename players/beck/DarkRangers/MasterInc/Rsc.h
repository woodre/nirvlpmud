...
Rsc(){
   ...
   if(TP->GLEVEL > 69){ type = "Dimensional"; }
   else if(TP->GLEVEL > 59){ type = "Stellar"; }
   else if(TP->GLEVEL > 49){ type = "Shadow"; }
   else if(TP->GLEVEL > 39){ type = "General"; }
   else if(TP->GLEVEL > 29){ type = "Ninja"; }
   else if(TP->GLEVEL > 19){ type = "Warrior"; }
   else if(TP->GLEVEL > 9){ type = "Servant"; }
   else{ type = "Initiate"; }
