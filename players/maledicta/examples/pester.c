...
#define HP ENV->query_hp()
#define HP2 (ENV->query_hp() - 6400)
#define HP3 (ENV->query_hp() - 8435)
#define HP4 (ENV->query_hp() - 10311)
#define HP5 (ENV->query_hp() - 15888)
#define HP6 (ENV->query_hp() - 19075)
#define HP7 (ENV->query_hp() - 24089)
#define HP8 (ENV->query_hp() - 29434)
