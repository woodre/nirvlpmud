...
set_a_chat_chance(15);
  ...
  load_a_chat("Archangel snarls with anger as his Scythe strikes at you!\n");
...
heart_beat() {
  ...
  if(attacked && query_changed() == 0){
  	...
  	"armor. A flaming scythe is held in his hands, its elongated blade\n"+
  	"razor sharp.  Huge flaming wings spread out from its back, sending out\n"+
  	"flaming waves of heat. You detect no humanity eminating from this\n"+
  	"thing of evil.\n");
...
monster_died() {
  ...
  tell_room(environment(this_object()),
  "As the Archangel dies you see his flaming Scythe fall from his limp hands, it\n"+
  "clatters to the ground loudly.\n\n\n"+
  "\n\nA searing heat encompasses the corpse, burning it into ashes.\n");	
  move_object(clone_object("/players/maledicta/ruins/weapons/flaming_scythe.c"),
