...
set_a_chat_chance(15);
  ...
  load_a_chat("Archangel snarls with anger as his Maul strikes at you!\n");
...
heart_beat() {
  ...
  if(attacked && query_changed() == 0){
  	...
  	"armor. A flaming maul is held in his hands, its deadly steel head\n"+
  	"glistening in the flames.  Huge flaming wings spread out from its back,\n"+
  	"sending out flaming waves of heat. You detect no humanity eminating\n"+
  	"from this thing of evil.\n");
...
monster_died() {
  ...
  tell_room(environment(this_object()),
  "As the Archangel dies you see his flaming Maul fall from his limp hand, it\n"+
  "clatters to the ground loudly.\n\n\n"+
  "\n\nA searing heat encompasses the corpse, burning it into ashes.\n");	
  move_object(clone_object("/players/maledicta/ruins/weapons/flaming_maul.c"),
