...
set_a_chat_chance(15);
  ...
  load_a_chat("Archangel snarls with anger as his Lance strikes at you!\n");
...
heart_beat() {
  ...
  if(attacked && query_changed() == 0){
  	...
  	"is a long wicked footman's lance, its gleaming shaft covered\n"+
  	"with a frosty coating. This creature seems nearly impenetrable\n"+
  	"in its armor.\n");
...
monster_died() {
  ...
  "allowing the Lance to fall from its grasp. It clatters to the ground\n"+
  "with a loud clang.\n\n\n"+
  "\n\nThe body immediately melts leaving a blackened puddle of water.\n");	
  move_object(clone_object("/players/maledicta/ruins/weapons/ice_lance.c"),
