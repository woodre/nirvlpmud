...
set_alias("icebrand");
set_short(""+BOLD+""+BLK+"Chu'Sarth Stiletto Dagger"+HIB+" [Icebrand]"+NORM+"");
set_long(
...
init(){
    ...
    if(present("collectable_obj_fire")){
    	write("The Dagger Shatters as it comes too close to a weapon of flame!\n");
...
if(W>16)  {
  say("\t"+BOLD+""+BLK+""+user+"'s Stiletto Dagger summons forth a powerful\n\n"+
      ""+HIB+"                             CYCLONE OF FROST "+NORM+"\n\n"+
      "\t\t"+BOLD+""+BLK+"which engulf's its victim with tendrils of pure pain!"+NORM+"\n");

  write(
  "\t"+BOLD+""+BLK+"Your Stiletto Dagger summons forth a"+NORM+"\n\n"+
  ""+HIB+"                        CYCLONE OF FROST"+NORM+"\n\n"+
  "\t\t"+BOLD+""+BLK+" which engulf's your foe with tendrils of pure pain!"+NORM+"\n");
  return 7;
   }
if(W>9)  {
  say(""+BOLD+""+BLK+""+user+"'s Stiletto Dagger drives into it's victim slamming them with"+
  " shards of "+HIB+"ICE!"+NORM+"\n");

  write(
  ""+BOLD+""+BLK+"Your Stiletto Dagger drives into your foe sending shards of"+HIB+" ICE"+NORM+""+
