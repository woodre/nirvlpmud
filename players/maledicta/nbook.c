...
read(arg) {
  ...
  if(arg == "page 7") 
    ...
    "Bards:  Good fighters, Role-playing guild, using pets and songs.\n"+
    " They do NOT PK.  Excellent in parties.\n\n"+
	 ...
	 " restrictions.\n\n"+
     "Shardaks: An evil guild that is excellent as fighters. Known for\n"+
     " their Pk style of combat.  Alignment restriction, hard at low\n"+
     " levels and early in the guild.\n\n"+
	 "Symbiotes: Based on the Marvel character Venom, this guild offers\n"+
     " a unique method of fighting.  Good fighters that do not rely on\n"+
     " outside weapons and armor.\n\n"+
     "NeoSymbs: The evolution of the Symbiote, this guild allows more of\n"+
     " the human side to show forth as compared to the Symbiotes.  You\n"+
     " must become a high level Symbiote to enter this guild. Allows the\n"+
     " wielding and wearing of equipment.\n\n"+
	 "Vampires: Very good  fighters, interesting spells, pets, unique\n"+
	 " guild hall, close family atmosphere, slow to get in.\n\n"+
     "Warriors:  A vast guild with too many options to list.  The idea\n"+
     " is to allow a player to shape themself to many forms of combat.\n\n");
    return 1; 
    }
