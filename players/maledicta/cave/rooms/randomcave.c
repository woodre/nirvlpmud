...
renew_room(int x, int a){
	...
	if(encounter[room_num] < 1)
	{
		...
		{
			move_object(clone_object("/players/fred/misc/bknight.c"), this_object());
		}
		else if(x < 6)
                {
                	if(random(100) < 50)
                        {
                            mob = clone_object("/players/maledicta/cave/mobs/newbie.c");
		...
		else if(x < 15)
                {
                	if(random(100) < 50)
                        {
                            mob = clone_object("/players/maledicta/cave/mobs/midlevel.c");
                            move_object(mob, this_object());
                            mob->set_al(-a);
                        }
		...
		if(encounter[room_num] < 1){
			if(room_num == spec_mob && x > 18){
				...
				if(random(100) < 50){
					move_object(clone_object("/players/maledicta/cave/mobs/gnewbie.c"), this_object());
				}
				move_object(clone_object("/players/maledicta/cave/mobs/gnewbie.c"), this_object());
			}
			else if(x < 15){
				if(random(100) < 50){
					move_object(clone_object("/players/maledicta/cave/mobs/gmidlevel.c"), this_object());
				}
				move_object(clone_object("/players/maledicta/cave/mobs/gmidlevel.c"), this_object());
			}
			else if(x > 14){
				if(random(100) < 50){
					move_object(clone_object("/players/maledicta/cave/mobs/ghighlevel.c"), this_object());
				}
				move_object(clone_object("/players/maledicta/cave/mobs/ghighlevel.c"), this_object());
			}
			else{
