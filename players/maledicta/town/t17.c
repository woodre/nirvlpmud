...
browse_it(){
  ...
  "\t : "+NORM+"3. BlasterPistol______________________50000  "+HIG+":\n"+
  "\t : "+NORM+"4. BlasterRifle_______________________70000  "+HIG+":\n"+
  "\t : "+NORM+"5. Clip [blaster pistol]________________800  "+HIG+":\n"+
  "\t : "+NORM+"6. Clip [blaster rifle]________________1200  "+HIG+":\n"+
  "\t :..............................................:"+NORM+"\n"+
...
purchase_it(string str){
 ...
 if(!present("weapon_owner", this_object())){
	...
	if(purchase == "1"){
	  ...
	  write("Store owner says: Sorry, we are currently out of stock on that. Try later.\n");
	  return 1;
	  /*
	  cost = 50000;
	  item = clone_object("/players/maledicta/town/weapons/blaster.c");
	  what = "blaster pistol";
	  */
	  }
	else if(purchase == "4"){
	  ...
	  /*
	  cost = 70000;
	  item = clone_object("/players/maledicta/town/weapons/brifle.c");
	  what = "blaster rifle";
	  }
	  */
	else if(purchase == "5"){
