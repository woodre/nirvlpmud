...
set_race("human");
set_short("Gadvey da Rulesse, Archmage of the Templars");
set_long(
"  This is the Archmage Gadvey.  He is dressed in the grey robes\n"+
"of a mage, its fabric covered in runes and symbols, each shining\n"+
"gold. He stands tall, and seems to be about middle aged, although\n"+
"his robes make it hard to tell. A very thin dagger is sheathed at\n"+
"his side on a leather belt and a beautiful red ring decorates his\n"+
"middle finger. Gadvey seems very busy, but he is ready to assist\n"+
"if you 'ask' him too.\n");  
set_level(20);
set_hp(800);
set_al(50);
...
write(
"The Archmage nods and speaks,\n"+
"   'I am here to assist the Knights Templar in their most worthy of\n"+
"    causes..'\n\n"+
"He smiles and continues,\n"+
"   'I can help you with the following magical items or assistance:\n\n"+
"    "+HIY+"Portal"+NORM+"......will take you to a certain location of your choosing,\n"+
"    I know the way to the church, advance, post, shop, or tower(of hope). This is free.\n\n"+
"    "+HIY+"Mend"+NORM+"......I can magically mend any weapon that is broken.  The cost\n"+
"    is only 300 coins.'\n\n"+
"    "+HIY+"Empower"+NORM+" <weapon>.....I can empower your weapon with magical energies. This\n"+
"    will assist you in doing more damage.  The cost is 3000 coins.\n\n"+
"He walks over to you and says,\n"+
"    'I can send you to any of those locations if you type:\n"+
"     portal <destination>.  Good luck Worthy Knight.'\n\n\n"); 
return 1;
}
write("Ask who?\n");
return 1;
...
purchaser(str){
	...
	if(str == "scroll"){
		if(this_player()->query_sp() < 100){
			write("The Archmage shakes his head and says, 'You don't have the spell points\n"+
				  "necessary for me to drain from you.'\n");
			return 1;
		}
		scroll = clone_object("/players/maledicta/templar/items/scroll.c");
		move_object(scroll, this_player());
		write("The Archmage grabs your hand and drains the necessary power to enchant\n"+
			  "the small parchment.\n"+
...
locale = 0;
   if(str == "church"){
      ...
      locale = "players/maledicta/hope/rooms/hinner";
   }
   if(locale){
portal = clone_object("players/maledicta/templar/items/portal.c");
move_object(portal, locale);
write("The Mage waves his arms and summons forth a ring of\n"+
	  "magic. You step into it...\n");
...
if(hit_point > 0){
if(attacker_ob && random(100) < 5 && hit_point < max_hp/20 && filename(environment()) != "/players/maledicta/templar/rooms/adv_inner.c"){
tell_room(environment(),
"Gadvey chants loudly and disappears!\n");
move_object(this_object(), "/players/maledicta/templar/rooms/adv_inner");
  }  
}
...
mob = clone_object("players/maledicta/cave/mobs/highlevel.c");
