...
#define CHUNK 20
#define SAVE_PATH "players/maledicta/templar/eplate/plate_obj"
...
short(){ return ""+HIY+"The Golden Plates of the Elite"+NORM+""; }
...
read_spec(str){
if(!str){
write("Read the specific deeds of which Elite Guardsman?\n");
return 1;
}
if(file_size("/players/maledicta/templar/eplate/"+str+".plt") < 1){
...
more("/players/maledicta/templar/eplate/"+str+".plt");
return 1;
}
...
cat("/players/maledicta/templar/eplate/"+i+".plt");
write(
HIY+""+
"_______________________________________________________________"+NORM+"\n");
return 1;
...
if(counter < 9){
write_file("/players/maledicta/templar/eplate/"+numero+".plt",
...
write_file("/players/maledicta/templar/eplate/"+namer+".plt",
