...
if(random(100) < 40){ set_gender("female"); pgender = "she"; }
...
short(){ return capitalize(query_name())+" "+HIW+"("+HIR+"Ares Citizen"+NORM+HIW+")"+
                " ["+NORM+RED+capitalize(query_race())+HIW+"]"+NORM; } 

long(){
  write(
"This is a citizen of the city of New Ares. "+capitalize(pgender)+" is a "+pchar+" looking\n"+
query_race()+" with "+phair+" hair and "+peyes+" eyes. "+capitalize(pgender)+""+
" is "+phght_ft+" feet "+phght_in+""+
" inches in\n"+
"height and weighs around "+pwght+" pounds.\n");  
return 1;
}
