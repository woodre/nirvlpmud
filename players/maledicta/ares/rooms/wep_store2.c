...
if(!present("weapon_owner")){
	owner = clone_object("/players/maledicta/ares/mobs/weapon_owner.c");
...
purchase_it(string str){
 ...
 if(!present("weapon_owner", this_object())){
 	...
 	return 1;
      ...
      item = clone_object("/players/maledicta/weapon/weapon.c");
...
item->set_value(350);
        ...
        cost = 5000;
        item = clone_object("/players/maledicta/ares/weapons/crossbow.c");
	  }
...
item->set_value(1100);
	  ...
	  cost = 3000;
        item = clone_object("/players/maledicta/ares/weapons/longbow.c");	
        }
...
item->set_two_handed_wep(1);
	  ...
	  cost = 2400;
        item = clone_object("/players/maledicta/ares/weapons/shortbow.c");	
        }
...
item->set_value(1000);
	  ...
	  cost = 100;
        item = clone_object("/players/maledicta/ares/weapons/bolts.c");	
        }
	else if(purchase == "arrows"){
	  cost = 50;
        item = clone_object("/players/maledicta/ares/weapons/arrows.c");	
        }
	else{
