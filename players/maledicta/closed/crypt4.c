...
open_door(){
  ...
  if(!"/players/wocket/necro/room/necroent.c"->query_door())
    "/players/wocket/necro/room/necroent.c"->open_door();
...
enter(str){
  ...
  move_object(this_player(),"/players/wocket/necro/room/necroent.c");
