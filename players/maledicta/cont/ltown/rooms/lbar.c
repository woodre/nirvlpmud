...
move_object(clone_object("/players/maledicta/cont/ltown/mobs/lbartender.c"), this_object());
}		
  if(arg) return;
set_light(1);

short_desc = ""+HIG+"The Lizards Bite"+NORM+" [bar]";
long_desc =
...
dest_dir = ({
  "/players/maledicta/cont/ltown/rooms/l1.c","out",
