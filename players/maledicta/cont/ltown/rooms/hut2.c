...
if(!present("cont_lizardguard")){
	owner = clone_object("/players/maledicta/cont/ltown/mobs/lguard.c");
...
dest_dir = ({
  "/players/maledicta/cont/ltown/rooms/l3.c", "out",
});
...
if(!searched){
move_object(clone_object("/players/maledicta/cont/ltown/objects/meat.c"), this_object());
