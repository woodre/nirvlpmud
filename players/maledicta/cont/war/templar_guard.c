...
block_exit(){
 if(present("KnightInvite", this_player())){ 
    write("The Guard bows low and says, \n\"There is no reason to go in as of this moment. I will update you when you can.\"\n");
return 1;
  }
write("The guard steps forward and says, \"No entrance.\"\n");
return 1;
}
