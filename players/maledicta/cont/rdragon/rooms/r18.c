...
dest_dir = ({
  "/players/maledicta/cont/rdragon/rooms/r19.c","east",
  "/players/maledicta/cont/rdragon/rooms/r16.c","north",
});
...
squeeze(str){
 ...
 if(str == "into gap" || str == "gap" || str == "wall" || str == "into wall"){
  ...
  move_object(this_player(), "/players/maledicta/cont/rdragon/rooms/r20.c");
