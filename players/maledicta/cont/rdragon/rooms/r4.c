...
move_object(clone_object("/players/maledicta/cont/mobs/prisoner"), this_object());
}
if(!present("undead dragon", this_object())){
move_object(clone_object("/players/maledicta/cont/mobs/undead_dragon"), this_object());
}
  if(arg) return;
set_light(1);
...
dest_dir = ({
  "/players/maledicta/cont/rdragon/rooms/r3.c","east",
});
}
