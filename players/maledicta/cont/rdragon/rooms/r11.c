...
move_object(clone_object("/players/maledicta/cont/mobs/rdragon1.c"), this_object());
move_object(clone_object("/players/maledicta/cont/mobs/rdragon1.c"), this_object());
}
  if(arg) return;
set_light(1);
...
dest_dir = ({
  "/players/maledicta/cont/rdragon/rooms/r12.c","west",
  "/players/maledicta/cont/rdragon/rooms/r10.c","east",
