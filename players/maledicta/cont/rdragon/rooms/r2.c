...
for(i = 0; i < 4; i++){
 move_object(clone_object("/players/maledicta/cont/mobs/darkling"), this_object());
 } 
}
  if(arg) return;
set_light(1);
...
dest_dir = ({
  "/players/maledicta/cont/rdragon/rooms/r3.c","north",
  "/players/maledicta/cont/rdragon/rooms/r1.c","east",
  "/players/maledicta/cont/rdragon/rooms/r5.c","west",
});
