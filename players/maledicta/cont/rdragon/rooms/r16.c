...
dest_dir = ({
  "/players/maledicta/cont/rdragon/rooms/r15.c","north",
  "/players/maledicta/cont/rdragon/rooms/r18.c","south",
  "/players/maledicta/cont/rdragon/rooms/r17.c","outcropping"
});
}
