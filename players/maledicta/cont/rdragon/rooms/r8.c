...
move_object(clone_object("/players/maledicta/cont/mobs/rdragon1"), this_object());
move_object(clone_object("/players/maledicta/cont/mobs/rdragon1"), this_object());
}
  if(arg) return;
set_light(1);
...
dest_dir = ({
  "/players/maledicta/cont/rdragon/rooms/r6.c","east",
  "/players/maledicta/cont/rdragon/rooms/r9.c","west",
});
...
no_west(){
if(present("cont_dragon", this_object())){
write("The Red Dragon steps in front of you, blocking your entrance into the chamber!\n");
return 1;
}
return;
}
