...
move_object(clone_object("/players/maledicta/hope/board.c"), this_object());
}
if(!present("high_guard", this_object())){
move_object(clone_object("/players/maledicta/hope/mobs/high_templar2.c"), this_object());
move_object(clone_object("/players/maledicta/hope/mobs/high_templar2.c"), this_object());
}
  if(arg) return;
set_light(1);
...
dest_dir = ({
  "/players/maledicta/hope/rooms/hportal.c", "north",
  "/players/maledicta/hope/rooms/hmain.c","south",
  "/players/maledicta/hope/rooms/hviewer.c","up",
});
...
move_object(this_player(), "/players/maledicta/hope/rooms/hsanctum.c");
return 1;
}
no_hunter(){ return 1; }
