...
#define BOARD_NAME "players/maledicta/hope/board"
...
long() {
	int ind;
	write("This is the Allies Bulletin Board. Here you are free\n"+
            "to discuss issues that effect the alliance. ANY topic\n"+
            "can be placed here as long as it has to do with the\n"+
            "alliance. Notes will stay one week, unless needed longer.\n");
