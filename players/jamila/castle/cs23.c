...
dest_dir = ({
  "/players/jamila/castle/cs24.c","east",
  }); 
  }
...
{
	::init();
	add_action("cmd_west","climb");
}

cmd_west(str)
{
	write("You carefully climb up the slippery slide!\n");
	this_player()->move_player("west#/players/jamila/castle/cs16.c");
	return 1;
