...
dest_dir = ({
  "/players/jamila/castle/cs15.c","north",
  "/players/jamila/castle/cs17.c","west",
  }); 
  }
...
{
	::init();
	add_action("cmd_west","slide");
}

cmd_west(str)
{
	write("You twist down a few stories on a large slide!\n");
	this_player()->move_player("west#/players/jamila/castle/cs23.c");
	return 1;
