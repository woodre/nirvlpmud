...
weapon_hit(attacker) {
  ...
  "                     in the "+HIM+"life essence"+NORM+" of its foe.\n");
      ...
      if(random(TP->query_attrib("wil")) < 17) break;
    case 4: case 5:
      write("You feel weaker as "+HIM+"Soul"+BLK+"thief"+NORM+" drains you for energy.\n");
      energy+=5;
      TP->add_spell_point(-random(10));
      break;
    case 6:
      write(HIM+"Soul"+BLK+"thief"+NORM+" glows with an otherworldly aura as it snatches a piece\n"+
            "of your soul.\n");
