...
*/
#define DEST "room/south/sforst15"  /* Nirvana home */
...
*/
           || str == "east" || str == "bushes";  /* Rumplemintz */
}
...
*/
    return "You can see a small path winding east through some shrubbery";
/* Rumplemintz */
}
...
*/
    write("To the east some dense bushes are obstructing the view.\n");
/* Rumplemintz */
...
*/
    add_action("east", "east");      /* Rumplemintz */
}
...
*/
    this_player()->move_player("east#/players/padrone/outside/path1");
   /* Rumplemintz */
...
#if 0 /* Rumplemintz - haven't gone through mirror_maze yet, do not load */
    call_out("load_mirrormaze", 300);	/* Load the mirrormaze 5 minutes from now! */
#endif

    /* Load some facades and other objects that we need */
/* Rump - load front_yard for ticket generation */
    call_other("players/padrone/outside/front_yard", "short");
/* This is called to make sure quest is loaded into quest_room */
    fix_the_quest();
...
/* Not sure why he did it this way, changing it - Rumplemintz
...
*/
	...
	qobj->set_hint("Padrone is sad. He built a beautiful walking castle,\n" +
		       ...
		       "but it's always a good idea to bring a weapon and some armor...\n");
