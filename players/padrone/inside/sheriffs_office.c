 ...
 *  Version: 1.6 (Jan 6, 2010) -- Rumplemintz
 *
...
#if 0  /* Not needed anymore -- Rumplemintz */
...
#if 0  /* Rumplemintz */
	sheriff = clone_object("obj/monster_lars");	/* NEW, IMPROVED monster class! */
...
#else
      sheriff = clone_object("/players/padrone/inside/npc/sheriff");
      move_object(sheriff, this_object());
#endif
    }
} /* extra_reset */
