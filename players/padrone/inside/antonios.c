...
extra_reset(arg) {
   ...
   if (!antonio) {
#if 0  /* Rumplemintz */
      antonio = clone_object("obj/monster_lars");
      ...
      move_object((object)"/players/padrone/outside/front_yard"->make_ticket(), antonio);
...
#else
    antonio = clone_object("/players/padrone/inside/npc/antonio");
    move_object(antonio, this_object());
#endif
   }
...
/* Before moving the bodyguard here, or he could attack Antnio: */
