...
#if 0  /* Changed this a bit -- Rumplemintz */
	    the_guard = clone_object("obj/monster_lars");
...
#else
    the_guard = clone_object("/players/padrone/outside/npc/fy_guard");
    move_object(the_guard, this_object());
#endif
	    return 1;
	}
...
#if 0 /* Rumplemintz - no longer called */
setup_arrays() {
