...
make_golem() {
    ...
    golem = clone_object("obj/monster_lars");	/* NEW, IMPROVED monster class! */
    golem->set_name("golem-padrone");
    golem->set_alias("golem");
    golem->set_level(21);
/* Do not set exp on Nirvana - handled by level -- Rumplemintz
    golem->set_ep(120000);
*/
    golem->set_hp(1000);  /* More than regular lvl 21 npc - Rumplemintz */
    golem->set_ac(19);  /* Bumped from 5 to 19 - Rumplemintz */
    golem->set_wc(34);  /* Added wc - Rumplemintz */
    golem->set_al(0);
