...
extra_reset(arg) {
    ...
    if (!pirate5) {
	pirate5 = clone_object("obj/monster_lars");	/* NEW, IMPROVED monster class! */
    ...
    if (!pirate4) {
	pirate4 = clone_object("obj/monster_lars");	/* NEW, IMPROVED monster class! */
    ...
    if (!pirate3) {
	pirate3 = clone_object("obj/monster_lars");	/* NEW, IMPROVED monster class! */
    ...
    if (!pirate2) {
	pirate2 = clone_object("obj/monster_lars");	/* NEW, IMPROVED monster class! */
    ...
    if (!pirate1) {
	pirate1 = clone_object("obj/monster_lars");	/* NEW, IMPROVED monster class! */
