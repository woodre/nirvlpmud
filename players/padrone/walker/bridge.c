...
reset(arg) {
    ...
    if (!pilot) {
#if 0 /* Rumplemintz */
	pilot = clone_object("obj/monster_lars");
...
#else
        pilot = clone_object("/players/padrone/walker/npc/pilot");
#endif
    ...
    if (!pirate1) {
#if 0 /* Rumplemintz */
	pirate1 = clone_object("obj/monster_lars");
...
#else
        pirate1 = clone_object("/players/padrone/walker/npc/bridge_pirate1");
        move_object(pirate1, this_object());
#endif
    }
    ...
    if (!pirate2) {
#if 0 /* Rumplemintz */
	pirate2 = clone_object("obj/monster_lars");
...
#else
        pirate2 = clone_object("/players/padrone/walker/npc/bridge_pirate2");
        move_object(pirate2, this_object());
#endif
    }
    ...
    if (!pirate_king) {
#if 0 /* Rumplemintz */
	pirate_king = clone_object("obj/monster_lars");
	...
	MAKE_KEY(key, "bullet-proof", "walkervault")
        move_object(key, bag);
#else
        pirate_king = clone_object("/players/padrone/walker/npc/bridge_pking");
        move_object(pirate_king, this_object());
#endif
    }
} /* reset */
