...
object smo;   /* For the silent move object on Nirvana - Rumplemintz */
...
reset(arg) {
	...
	/* Monsters and players CAN attack it! */
        set_hp(1000000);
        set_ac(1000000);
/* Next lines for the silent move object for Nirvana - Rumplemintz */
        smo = clone_object("/players/padrone/walker/mover_sm");
        move_object(smo, this_object());
    }
} /* reset */
