...
climb(str) {
    ...
    move_object(this_player(), ROPE_LADDER);
    say(this_player()->query_name()+" climbs up on the rope ladder.\n");
    tell_room(this_object()->query_environment(),
      this_player()->query_name()+" climbs up the rope ladder.\n");
    return 1;
} /* climb */
