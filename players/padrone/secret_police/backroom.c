...
extra_reset() {
    ...
    if (!spm2) {
#if 0 /* Rumplemintz */
	spm2 = clone_object("obj/monster_lars");
...
#else
    spm2 = clone_object("/players/padrone/secret_police/npc/policeman");
    spm2->setup_mob(2);
    move_object(spm2, this_object());
#endif
    }
    ...
    if (!spm1) {
#if 0 /* Rumplemintz */
	spm1 = clone_object("obj/monster_lars");
...
#else
    spm1 = clone_object("/players/padrone/secret_police/npc/policeman");
    spm1->setup_mob(1);
    move_object(spm1, this_object());
#endif
    }
