/* These are from Fred's area.  One thing I'd do different is use
 * an #include "defs." line, and have the rooms path defined, as well
 * as object and monster paths....that way if stuff changes directory,
 * or other changes are made, it's as simple as changing one line in
 * a defs file rather than a line in each room file.
 */
#include <ansi.h>
