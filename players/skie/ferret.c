/* These examples are from Fred's area */
#include <ansi.h>
...
reset(arg) {
  ...
  set_name("ferret");
  set_race("creature");
  set_short(BOLD+RED+"Fe"+NORM+YEL+"rr"+NORM+HIC+"et"+NORM+BOLD+" of"+NORM+HIB+" DOOM"+NORM);
  set_long(
  ...
  set_spell_dam(25);
  set_spell_mess1(
    "The ferret "+BOLD+"L A S H E S"+NORM+" out at you with it's huge paws!\n");
  set_spell_mess2(
