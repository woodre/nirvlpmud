...
return str+">"+HIY+capitalize(OWNER)+"'s Battlefield"+NORM+str+"<"+NORM;
  }
}
...
teleport(str) {
  ...
  if(!str) {
    write(
 "You may teleport to : church, magus, post, portal, shrine, grotto, cleric, temple, battle, tower, vegeta.\n"
    );
    return 1;
  }
  if(locked) {
...
case "magus": dest="/players/earwax/closed/shardak/room/magusroom";break;
    case "grotto": dest="/players/earwax/closed/shardak/room/grotto";break;
case "cleric": dest="/players/mosobp/areas/TEMPLE/CLERICS/c1.c";break;
case "temple": dest="/players/mosobp/areas/TEMPLE/rooms/temple8.c";break;
  case "battle": dest="/players/mosobp/areas/BATTLE/rooms/bb00.c";break;
  case "tower": dest="/players/mosobp/areas/TOWER/rooms/t1.c";break;
case "vegeta": dest="players/mosobp/areas/VEGETA/rooms/vegeta0.c";break;
