...
long_desc = 
"Houses are dotted along the street, and mountains are directly.\n"+
"to the east.\n";
set_light(1);
dest_dir = ({
"players/mosobp/areas/HOUSING/rooms/h15.c","west",
"players/mosobp/areas/HOUSING/rooms/h12.c","north",
});
