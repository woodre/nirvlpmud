...
{
  ::reset(arg);
  if( !present("yamcha", this_object()) )
  move_object(clone_object("/players/mosobp/areas/TOWER/NPC/yamcha.c"), this_object());    
  if(arg) return;
  set_light(1);
  ...
  dest_dir =
  ({
    "/players/mosobp/areas/TOWER/rooms/t17.c",  "east",
    "/players/mosobp/areas/TOWER/rooms/t20.c",  "south",
    "/players/mosobp/areas/TOWER/rooms/t11.c",  "north",
  });
  return 1;
}