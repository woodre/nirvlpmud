/*                                       
 *  File:   /players/mosobp/areas/BATTLE/rooms/b21.c    
 *  Function:  room                      
...
reset(arg)
{
  ...
  "To the south a temple is barely visible.\n";
  ...
  ({
    ...
    "temple",
    "The Namekian Temple is visible to the south",
  });

  dest_dir =
  ({
    "players/mosobp/areas/BATTLE/rooms/b17.c",   "north",
    "players/mosobp/areas/BATTLE/rooms/b18.c",   "northeast",
    "players/mosobp/areas/BATTLE/rooms/b22.c",   "east",
    "players/mosobp/areas/BATTLE/rooms/bb00.c",  "south",
  });
}
init()
{
