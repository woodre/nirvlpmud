/*                                       
 *  File:   /players/mosobp/areas/BATTLE/rooms/b13.c    
 *  Function:  room                      
...
reset(arg)
{
  ...
  "The temple is drawing closer to the south.\n";
  ...
  dest_dir =
  ({
    "players/mosobp/areas/BATTLE/rooms/b8.c",   "north",
    "players/mosobp/areas/BATTLE/rooms/b9.c",   "northeast",
    "players/mosobp/areas/BATTLE/rooms/b14.c",  "east",
    "players/mosobp/areas/BATTLE/rooms/b18.c",  "southeast",
    "players/mosobp/areas/BATTLE/rooms/b17.c",  "south",
  });
}
init()
{
