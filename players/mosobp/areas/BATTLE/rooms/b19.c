/*                                       
 *  File:   /players/mosobp/areas/BATTLE/rooms/b19.c    
 *  Function:  room                      
...
reset(arg)
{
  ...
  dest_dir =
  ({
    "players/mosobp/areas/BATTLE/rooms/b14.c",  "northwest",
    "players/mosobp/areas/BATTLE/rooms/b15.c",  "north",
    "players/mosobp/areas/BATTLE/rooms/b16.c",  "northeast",
    "players/mosobp/areas/BATTLE/rooms/b20.c",  "east",
    "players/mosobp/areas/BATTLE/rooms/b24.c",  "southeast",
    "players/mosobp/areas/BATTLE/rooms/b23.c",  "south",
    "players/mosobp/areas/BATTLE/rooms/b22.c",  "southwest",
    "players/mosobp/areas/BATTLE/rooms/b18.c",  "west",
  });
}
