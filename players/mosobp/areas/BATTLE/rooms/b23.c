/*                                       
 *  File:   /players/mosobp/areas/BATTLE/rooms/b23.c    
 *  Function:  room                      
...
reset(arg)
{
  ...
  dest_dir =
  ({
    "players/mosobp/areas/BATTLE/rooms/b22.c",  "west",
    "players/mosobp/areas/BATTLE/rooms/b18.c",  "northwest",
    "players/mosobp/areas/BATTLE/rooms/b19.c",  "north",
    "players/mosobp/areas/BATTLE/rooms/b20.c",  "northeast",
    "players/mosobp/areas/BATTLE/rooms/b24.c",  "east",
  });
}
init()
{
