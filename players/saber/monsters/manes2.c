...
reset(arg) {
   ...
   if (!arg) {
   object ob, ob2;
  ob = clone_object("/players/saber/weapons/dclaws.c");
move_object(ob,this_object());
 ob2 = clone_object("/players/saber/gems/bloodstone.c");
move_object(ob2,this_object());
     set_name( "manes" );
     set_alias("demon");
      set_short("A smallish Manes");
     set_race( "demon");
     set_long("A small demon with sharp claws and a hideous grin.\n"+
  "It looks a bit tougher than the previous manes you fought.\n"+
 "It is evil.\n");
     set_level(3);
     set_ac(4);
     set_wc(7);
