...
"chamber","You are in the common room of Orin's Inn",
 ...
 "/players/saber/ryllian/orin3.c","north",
 "/players/saber/ryllian/orin4.c","east",
 "/players/saber/closed/bards/bardrooms/enterance.c","up",
           });
  }   }
init(){
 ::init();
...
call_other(this_player(), "move_player","south#players/saber/closed/bards/bardrooms/hades_q.c");
