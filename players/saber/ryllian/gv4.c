...
long_desc=
 ...
 "celestial illuminance.  A small cave open here.\n";
...
items=({
 ...
 "cave","This is the enterance to the cave of mist",
 });

  dest_dir=({
 "/players/saber/ryllian/ryllian1.c","west",
 "/players/saber/closed/quest/maze/mz0.c","cave",
           });
  }   }
init(){
 ::init();
