...
if(!present("owlbear")) {
 for(t=0;t<2;t++){
move_object(clone_object("/players/saber/monsters/owlbear.c"),this_object()); }
}
 if(!arg){
  set_light(1);
...
items=({
 ...
 "stains","There are dark crimson stains upon the ground",
  ...
  dest_dir=({
 "/players/saber/ryllian/arena5.c","north",
 "/players/saber/ryllian/arena9.c","east",
 "/players/saber/ryllian/arena3.c","west",
           });
  }   }
init(){
 ::init();
