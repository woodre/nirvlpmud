...
reset(int arg){
if(!present("silvia")) {
move_object(clone_object("/players/saber/monsters/silvia.c"),this_object()); }
if(!present("larie")) {
move_object(clone_object("/players/saber/monsters/larie.c"),this_object()); }
 if(!arg){
  set_light(1);
...
items=({
 ...
 "stains","There are dark crimson stains upon the ground",
  ...
  dest_dir=({
 "/players/saber/ryllian/arena2.c","north",
 "/players/saber/ryllian/arena5.c","east",
 "/players/saber/ryllian/arena3.c","south",
 "/players/saber/ryllian/arena.c","out",
           });
  }   }
init(){
 ::init();
