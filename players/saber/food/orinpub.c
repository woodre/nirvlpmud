...
write("You may order:\n"+
 ...
 "           Dark Ale               : 140 golden coins\n"+
 "           Brandy (warmed)        : 240 golden coins\n"+
 "           Elvish Blossom Wine    : 400 golden coins\n"+
"\n");
}
...
else if (str == "dark ale") {
say("The comely barmaid brings "+tp+" a "+str+".\n");
write("The comely barmaid brings you a "+str+".\n");
   mess = "The dark ale gives you warm sensations town to your toes";
   heal = 10;
   value = 140;
   strength = 10;
}
...
else if (str == "wine" || str == "elvish blossom wine") {
say("The comely barmaid brings "+tp+" a "+str+".\n");
write("The comely barmaid brings you a "+str+".\n");
   mess = "You heart melts as you taste heaven";
   heal = 40;
   value = 400;
   strength = 14;
}
