...
/** Updated by Dragnar **/
  if( environment() == this_player() )
    return "You are a short little dude with a topknot and an impish grin";
  else
    return environment(this_object())->query_name()+" is a short little dude with a topknot and an impish grin";
}
...
taunt(str)      { write("sorry this has been removed.\n       - the Managment\n"); return 1;
                 SPELL->taunt(str); return 1; }
