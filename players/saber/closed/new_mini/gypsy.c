...
/** Updated by Dragnar **/
  if( environment() == this_player() )
    return "You are wearing a silver gypsy medallion";
  else
    return environment(this_object())->query_name()+" is wearing a silver gypsy medallion";
}
...
/*
  removed due to its abuse - Mythos 4-20-2000
curse(str) { SPELL->curse(str); return 1; }
curse(str) {
  write("Removed by Mgmt. due to misuse.\n"); return 1; }
*/
curse() { write("removed due to misuse.\n"); return 1; }
