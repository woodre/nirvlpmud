...
case 4 : command("down"); break;
case 5 : command("up"); break;
case 6 : command("northeast"); break;
case 7 : command("southeast"); break;
case 8 : command("northwest"); break;
case 9 : command("southwest"); break;
case 10: command("out"); break;
case 11: command("enter"); break;
case 12: command("in"); break;
case 13: command("exit"); break;
}
call_out("random_move",MOV_RATE);
  return 1;
}
