...
short() {
  return "The bottom of a towering waterfall";
}

long() {
  write("The bottom of a towering waterfall.\n"+
     "There seems to be some sort of space behind it to the south.\n"+
...
object ob;
  ...
  if(!ob) { write("That is not something to bathe with!\n"); return 1; }
...
south()  {
write("You step behind the waterfall.\n");
call_other(this_player(),"move_player","behind the waterfall#players/saber/closed/quest/maze/mz15.c");
  return 1;
        }
