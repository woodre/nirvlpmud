...
items=({
 ...
 "/players/saber/closed/quest/maze/mz3.c","east",
 "/players/saber/closed/quest/maze/mz5.c","south",
      });
  }   }
init(){
 ::init();
...
if(RANDOM == 0 || RANDOM == 5)  {
  ...
  call_other(TP,"move_player","south#players/saber/closed/quest/maze/mz6.c");
        }
else if(RANDOM == 2 || RANDOM == 3)  {
  call_other(TP,"move_player","south#players/saber/closed/quest/maze/mz9.c");
         }
  return 1;
         }
...
if(RANDOM == 0 || RANDOM == 3)  {
  ...
  call_other(TP,"move_player","north#players/saber/closed/quest/maze/mz7.c");
        }
  return 1;
        }
