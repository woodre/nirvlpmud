...
items=({
 ...
 "light","Actually, its rather dark",
  ...
  dest_dir=({
 "/players/saber/closed/quest/maze/mz12.c","north",
 "/players/saber/closed/quest/maze/mz3.c","east",
 "/players/saber/closed/quest/maze/mz9.c","down",
      });
  }   }
init(){
 ::init();
...
if(RANDOM == 0 || RANDOM == 3)  {
  call_other(TP,"move_player","east#players/saber/closed/quest/maze/mz3.c");
        }
else if(RANDOM == 1 || RANDOM == 2)  {
  call_other(TP,"move_player","east#players/saber/closed/quest/maze/mz12.c");
        }
  return 1;
         }
