...
items=({
 ...
 "/players/saber/closed/quest/maze/mz10.c","east",
 "/players/saber/closed/quest/maze/mz10.c","south",
 "/players/saber/closed/quest/maze/mz8.c","west",
      });
  }   }
init(){
 ::init();
...
if(RANDOM == 0 || RANDOM == 3)  {
  call_other(TP,"move_player","east#players/saber/closed/quest/maze/mz10.c");
        }
else if(RANDOM == 1 || RANDOM == 2)  {
  call_other(TP,"move_player","east#players/saber/closed/quest/maze/mz7.c");
        }
  return 1;
         }
...
if(RANDOM == 0 || RANDOM == 3)  {
  ...
  call_other(TP,"move_player","west#players/saber/closed/quest/maze/mz10.c");
        }
  return 1;
        }
