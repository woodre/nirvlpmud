...
"  CLIFF |          of screaming.  You are on the 78th of the 1313 ledges.\n"+
...
items=({
 ...
 "rift","A rift leading to the realm of nightmares",
 });

dest_dir=({
 "/players/saber/closed/quest/hell/circle5.c","jump",
 "/players/saber/closed/quest/nmare/landing.c","rift",
           });
  }   }
...
rift()  {
  write("\nYou pass through the rift of fire...\n\n");
        }
