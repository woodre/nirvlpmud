...
reset(int arg){
  ...
  if(!present("guard"))  {
  move_object(clone_object("/players/saber/closed/quest/arate/arateheal.c"),
  this_object());        }
...
dest_dir=({
 "/players/saber/closed/quest/arate/arate2.c","north",
 "/players/saber/closed/quest/arate/arate7.c","east",
 "/players/saber/closed/quest/arate/arate5.c","west",
           });
  }   }
