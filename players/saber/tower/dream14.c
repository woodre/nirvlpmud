...
if(!present("dream")) {
 ...
 if(!arg){
  ...
  long_desc=
"You stand in the guild hall of the dopps.\n"+
"There are three figures here involved in\n"+
"what looks like a three stooges routine.\n";

dest_dir=({
 "players/saber/tower/dream15.c","blink",
