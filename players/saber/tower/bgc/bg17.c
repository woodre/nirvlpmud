...
if(!present("boomer"))  {
move_object(clone_object("/players/saber/monsters/boomer.c"),this_object());
        }
...
items=({
 ...
 "riot","The streets here are empty, but you hear the sounds of\n"+
  ...
  dest_dir=({
 "/players/saber/tower/bgc/bg16.c","west",
 "/players/saber/tower/bgc/bg18.c","east",
 "/players/saber/tower/bgc/bg22.c","south",
           });
    }    }
