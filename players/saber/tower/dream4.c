...
if(!present("dream")) {
  ...
  d1->set_short("Alustryx the Kender (dream)");
 ...
 if(!arg){
  ...
  long_desc=
"A single road winding through an ever shifting spectrum of different\n"+
"landscapes, each stranger in form and context than the last.  A small\n"+
"figure can be seen happily trudging along this never ending road,\n"+
"whistling happily.\n";

dest_dir=({
 "players/saber/tower/dream5.c","blink",
