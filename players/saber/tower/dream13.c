...
if(!present("dream")) {
  ...
  d3->set_short("Shamon of Nirvana is Witterquick (dream)");
 ...
 if(!arg){
  ...
  long_desc=
"You are in the hazy blue dream vision local village church.\n"+
"There is a huge pit of smoking crimson fire in the center,\n"+
...
"to the church and pray.  There is a large clock on the wall.\n"+
"There are three figures here.  They seem to be plotting something.\n";

dest_dir=({
 "players/saber/tower/dream14.c","blink",
