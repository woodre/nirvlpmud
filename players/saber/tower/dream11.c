...
if(!present("dream")) {
  ...
  d1->set_short("Saber the Vampire Cult Master (dream)");
  move_object(d1,this_object());
  d2 = clone_object("/players/saber/monsters/dream.c");
  d2->set_short("A horde of faceless neonate vampires (dream)");
 ...
 if(!arg){
  ...
  long_desc=
"This hazy tunnel of dream vision seems to have been cut a lot smoother than\n"+
"the tunnels you've seen earlier.  There's something...organized...even maze\n"+
"like about it.  There is a something etched in the rocks on the left side.\n"+
"Here you see Saber, Cult Master of the Vampires.  He appears to be leading\n"+
"hordes of faceless neonate vampires through a maze of misty vampire tasks.\n";

dest_dir=({
 "players/saber/tower/dream12.c","blink",
