...
load_a_chat("Fastiticalon-F lashes at you, ripping through your skin with its teeth.\n");
...
monster_died()
{
	move_object(clone_object("/players/laera/balamb/beach/obj/fin.c"),
