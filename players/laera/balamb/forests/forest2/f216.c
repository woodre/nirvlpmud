...
reset(arg) {
	...
	if(!present("funguar"))
	move_object(clone_object("/players/laera/balamb/forests/npc/funguar.c"),this_object());
...
long_desc =
	"   Thick silence reigns in the great forest that rises up from the\n" +
	"plains.  The trees grow very close together, making entrance next \n" +
	"to impossible.  An eerie darkness covers the trees, making it hard\n" +
	"to see into the forest.  Young grass tries valiantly to grow in the\n" +
	"hard and oily soil.\n";
