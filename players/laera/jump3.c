...
reset(arg) {
	...
	if(!present("etien"))
	move_object(clone_object("/players/laera/balamb/forests/npc/etien.c"),this_object());
...
cmdAsk(str)
{
	...
	{
		case "about":
			write("Etien asks: What do you want to know about?\n");
			return (1);
			break;
		case "about forest":
		case "forest":
			write("Etien asks: Which forest do you want to know about?\n");
			return (1);
			break;
		case "about chocobo":
		case "about chocobos":
		case "about chocobo forest":
		case "chocobo":
		case "chocobos":
		case "chocobo forest":
