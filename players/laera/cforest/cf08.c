...
reset(arg) {
if(!present("chicobo"))
move_object(clone_object("/players/laera/cforest/NPC/shychic.c"),this_object());
   if(arg) return;
   set_light(1);
...
set_smell("The fragrance of wildflowers is in the air.");
   dest_dir = ({
"/players/laera/cforest/cf13.c","north",
"/players/laera/cforest/cf04.c","south",
"/players/laera/cforest/cf07.c","west",
});
