...
#define DOC_DIR "/players/maledicta/closed/w/doc/knight/"
...
join(){
  ...
  GOB->add_skill_pts(-1);
  GOB->set_knight(1);
write_file("/players/maledicta/closed/log/KNIGHT",
...
/* Prereqs */
    ...
    if(USER->query_attrib("int") < 20 || USER->query_attrib("wil") < 20){
       write("You must have an intelligence and willpower of 20.\n");
       return 1;
       }
