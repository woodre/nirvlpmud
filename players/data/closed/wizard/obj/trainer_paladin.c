...
#define DOC_DIR "/players/maledicta/closed/w/doc/paladin/"
...
choose(str){
 ...
 if(!str){ write("choose <good or evil>\n"); return 1; }
 if(GOB->query_chosen_align()){ write("You have already chosen!\n"); return 1; }
 if(str == "good"){ 
 ...
 else{ write("choose <good or evil>\n"); return 1; }
 return 1;
 }
...
write_file("/players/maledicta/closed/logs/PALADIN",
