...
#define DOC_DIR "/players/maledicta/closed/w/doc/monk/"
...
train(str){
 ...
 if(this_player()->query_ghost()) return;
  if(GOB->query_glvl() < 41){
    write("You do not require a master to train your basic skills.\n");
    return 1;
    }
  if(!str){
    write("The Master says, 'I can train you in any of the following abilities.'\n"+
          "[SKILLS]             [Max Levels]\n"+
          "handtohand              (5)\n"+
          "dodge    (advanced)     (5)\n"+
          "blunt    (advanced)     (5)\n"+
...
/* Prereqs */
    ...
    write("You train Hand-to-Hand, raising it to level "+GOB->query_skills(80)+".\n");
    GOB->add_skill_pts(-1);
    GOB->add_skills(80);
    GOB->silent_save();
    return 1;
...
/* Prereqs */
    ...
    write("You train Dodge, raising it to level "+GOB->query_skills(30)+".\n");
    GOB->add_skill_pts(-1);
    GOB->add_skills(30);
    GOB->silent_save();
    return 1;
...
/* Prereqs */
    ...
    write("You train Blunt, raising it to level "+GOB->query_skills(1)+".\n");
    GOB->add_skill_pts(-1);
    GOB->add_skills(1);
    GOB->silent_save();
    return 1;
...
/* Prereqs */
    ...
    write("You train Polearm, raising it to level "+GOB->query_skills(3)+".\n");
    GOB->add_skill_pts(-1);
    GOB->add_skills(3);
    GOB->silent_save();
    return 1;
...
/* Prereqs */
    ...
    write("You train Touch, raising it to level "+GOB->query_skills(81)+".\n");
    GOB->add_skill_pts(-1);
    GOB->add_skills(81);
    GOB->silent_save();
    return 1;
...
/* Prereqs */
    ...
    write("You train XPunch, raising it to level "+GOB->query_skills(21)+".\n");
    GOB->add_skill_pts(-1);
    GOB->add_skills(21);
    GOB->silent_save();
    return 1;
...
/* Prereqs */
    ...
    write("You train XKick, raising it to level "+GOB->query_skills(22)+".\n");
    GOB->add_skill_pts(-1);
    GOB->add_skills(22);
    GOB->silent_save();
    return 1;
    ...
    write("You train Meditation, raising it to level "+GOB->query_skills(85)+".\n");
    GOB->add_skill_pts(-1);
    GOB->add_skills(85);
    GOB->silent_save();
    return 1;
...
/* Prereqs */
    ...
    write("The Master says, 'I cannot train you in that.'\n");
    return 1;
    }
return 1;
}