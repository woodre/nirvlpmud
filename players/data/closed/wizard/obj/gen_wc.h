...
gen_wc_bonus(){
		...
		if(ob){
			...
			if(wep_type){
				switch(wep_type * random(10) + 1){
					case 95..1000: wep_bonus += 20;        break;
					case 85..94:   wep_bonus += 12;        break;
					case 70..84:   wep_bonus += 10;        break;
					case 50..69:   wep_bonus += 7;         break;
	...
	if(present("stun_object_prof", ATT)) wep_bonus += random(10) + 3;
	if(ATT->pummeled()) wep_bonus += random(10) + 3;
	if(ob && curr_wep)
