	...
	if(set_light(0) > 0 || skills[70]){
		if(skills[32] && offhand){
			if(random(100) < skills[32]*12){
				switch(random(skills[32] * 20) + 1 + random(skills[6] * 2)){
					case 95..1000:
					abonus += random(15);
					break;
					case 85..94:
				...
				if(abonus){
					switch(abonus){
						case 12..1000: m1 = " Perfect"; break;
						case 7..11: m1 = "n excellent"; break;
						case 4..6: m1 = " good"; break;
						case 1..3: m1 = " decent"; break;
		...
		if(skills[31] && USER->query_weapon()){
			if(random(100) < skills[31]*12){
				...
				switch(random(skills[31] * 20) + 1 + random(parryb * 2)){
					case 95..1000:
					bbonus += random(6);
					break;
					case 85..94:
		...
		if(skills[30]){
			if(skills[30] > 5){
				...
				if(USER->query_local_weight() < 25 &&
					random(1500) < (dod2 * 18) - USER->query_local_weight()){
					skill_tier[30] += 30;
					tell_object(USER,
				...
				else if(random(1500) < 90 - USER->query_local_weight()){
					skill_tier[30] += 30;
					tell_object(USER,
						"\n\n     "+HIW+"-   [  "+HIR+"D"+HIW+" - "+HIR+"O "+HIW+"- "+HIR+""+
					"D "+HIW+"-  "+HIR+"G "+HIW+"- "+HIR+"E"+HIW+"  ]  -"+NORM+"\n\n");
				...
				if(random(1500) < (skills[30] * 18) - USER->query_local_weight()){
					skill_tier[30] += 30;
					tell_object(USER,
						"\n\n     "+HIW+"-   [  "+HIR+"D"+HIW+" - "+HIR+"O "+HIW+"- "+HIR+""+
					"D "+HIW+"-  "+HIR+"G "+HIW+"- "+HIR+"E"+HIW+"  ]  -"+NORM+"\n\n");
