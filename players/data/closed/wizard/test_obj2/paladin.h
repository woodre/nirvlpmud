...
release_cmd(str){
   if(!check_align()){
	...
	if(skills[94]){ "/players/maledicta/closed/w/power/release.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
cleanse_cmd(str){
   if(!check_align()){
	...
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[95]){ "/players/maledicta/closed/w/power/cleanse.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
detect_cmd(str){
   if(!check_align()){
	...
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[89]){ "/players/maledicta/closed/w/power/detect.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
holy_bolt_cmd(str){
   if(!check_align()){
	...
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[93]){ "/players/maledicta/closed/w/power/holy_bolt.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
corrupt_cmd(str){
   if(!check_align()){
	...
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[98]){ "/players/maledicta/closed/w/power/corrupt.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
redeem_cmd(str){
   if(!check_align()){
	...
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[96]){ "/players/maledicta/closed/w/power/redeem.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
plague_cmd(str){
   if(!check_align()){
	...
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[99]){ "/players/maledicta/closed/w/power/plague.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
sacrifice_cmd(str){
   if(!check_align()){
	...
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[97]){ "/players/maledicta/closed/w/power/sacrifice.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
