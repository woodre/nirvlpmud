skill_listing(){
	...
	write("  Gauge <item> -or- gauge <item> on <who>\n");
	return 1;
}
...
skill_list2(){
	...
	if(berserker){
		write(
			BOLD+"                         -[ "+HIW+"Berserker Skills"+NORM+BOLD+" ]-\n"+
			" SKILLS"+HIW+"\n"+
			"  Frenzy                "+HIB+skills[124]+"/5"+HIW+"  "+
			"  Rage                  "+HIB+skills[120]+"/5"+HIW+"\n"+
			"  Xcharge               "+HIB+skills[123]+"/5"+HIW+"  "+
			"  Tough                 "+HIB+skills[121]+"/5"+HIW+"\n"+
			"  Advanced Strength     "+HIB+xstr+"/5"+HIW+"  "+
		"  Advanced Stamina      "+HIB+xsta+"/5"+HIW+"\n\n"+NORM);
	}
	if(assassin){
		write(
			BOLD+"                         -[ "+HIR+"Assassin Skills"+NORM+BOLD+" ]-\n"+
			" SKILLS"+HIR+"\n"+
			HIR+"  Move Silently         "+HIW+skills[115]+"/1"+HIW+"  "+
			HIR+"  Hide                  "+HIW+skills[113]+"/3"+HIW+"\n"+
			HIR+"  Backstab              "+HIW+skills[112]+"/5"+HIW+"  "+
			HIR+"  Riposte               "+HIW+skills[114]+"/5"+HIW+"\n"+
			HIR+"  Xthrow                "+HIW+skills[116]+"/5"+HIW+"  "+
			HIR+"  Study                 "+HIW+skills[101]+"/5"+HIW+"\n"+
			HIR+"  Xstrike               "+HIW+skills[103]+"/5"+HIW+"  "+
		HIR+"  Advanced Stealth      "+HIW+xste+"/5"+HIW+"\n\n"+NORM);
	}
	return 1;
}
