...
XSTRIKE:
  Skill lvl         1         2         3          4         5
  Damage         r(22)+11  r(24)+12  r(26)+13   r(28)+14  r(30)+15   
  Cost             22        23        24         25        26
...
main(string str, object gob, object player)
{
   ...
   sklvl = GOB->get_skill(103);
   if(sklvl == 1){ cost = 22; }
   else if(sklvl == 2){ cost = 23; }
   else if(sklvl == 3){ cost = 24; }
   else if(sklvl == 4){ cost = 26; }
   else cost = 30;  
if(present("warrior_strike_bonus", USER)){
	...
	spamount = cost;
   if(sklvl == 1) damage = random(22) + 11;
   else if(sklvl == 2) damage = random(24) + 12;
   else if(sklvl == 3) damage = random(26) + 13;
   else if(sklvl == 4) damage = random(28) + 14; 
...
tell_object(USER,
HIW+"["+NORM+HIR+"XSTRIKE"+HIW+"] "+NORM+""+
BOLD+hm+"You "+hh+" "+ATTN+" in the "+where+"!"+NORM+"\n");   
	msg = "";
	msg2 = "";
	msg3 = "";
   GOB->set_delay(1);
	USER->spell_object(ATT, "XStrike Attack", damage, spamount,
	msg, msg2, msg3);
	return 1;
}
