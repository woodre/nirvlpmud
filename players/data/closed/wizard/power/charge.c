...
main(string str, object gob, object player)
{
   ...
   if(sklvl == 1){ cost = 11; }
   else if(sklvl == 2){ cost = 14; }
   else if(sklvl == 3){ cost = 19; }
   ...
   if(sklvl == 1) damage = random(18) + 2;
   else if(sklvl == 2) damage = random(20) + 4;
   else if(sklvl == 3) damage = random(22) + 8;
   else if(sklvl == 4) damage = random(25) + 12; 
...
if(stun){
   if(!present("stun_object_prof", ATT)){
    move_object(clone_object("/players/maledicta/closed/w/OBJ/stun.c"), ATT);
   ...
   GOB->set_delay(1);
   GOB->ast(19);
	USER->spell_object(ATT, "Charge Attack", damage, spamount,
	msg, msg2, msg3);
	return 1;
}
