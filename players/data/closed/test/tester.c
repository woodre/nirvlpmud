...
short(){
	...
	return "A Defibrillator";
        ...
        long(){
	write("This defibrillator can be used to ressurect your mud child incase of death.\n"+
...
object ob;
  ...
  move_object(clone_object("/players/data/closed/test/tester.c"), ob);
  tell_object(ob, "You receive an kid rezzer.\n");
  write("You give "+str+" an rezzer.\n");
  return 1;
  }