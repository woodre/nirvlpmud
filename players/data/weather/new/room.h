...
// added the following properties, Coogan, 07-Apr-99
...
#define P_ON_TREE               "on_tree"       // Coogan, 12-May-99: For the
                                                // substance-server
...
#define P_NO_INVISIBILITY       "no_invisibility" // Chameloid, 1-Nov-98

#define P_NO_TOOL_MESSAGES      "no_tool_messages"  /* Surak, 18-Nov-98
                                                    prevents message tools to
...
#define P_HERMES                "hermes"  // for teleport proof rooms, where
                                          // H. should help; Coogan, 04-Apr-02
...
#define P_LIQUID_GROUND         "liquid_ground"  // Chameloid, 26-Jun-96
