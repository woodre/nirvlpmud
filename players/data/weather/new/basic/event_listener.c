/****************************************************************************
    basic/event_listener.c -- written by Ugh Feb-17-1998 for Tubmud
      implementing standard event listener behaviour for all of the
      four phases of event-listening:
        - modification
