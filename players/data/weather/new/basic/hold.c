/******************************************************************************
              basic/hold.c -- written by Ugh for Tubmud Jul-1997 
 an interface for objects that can hold other objects like hands, pincers etc.
             this interface depends very much on basic/holdable.c
*******************************************************************************/
#include <prop/item.h>
