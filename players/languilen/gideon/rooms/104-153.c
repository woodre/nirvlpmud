...
reset(arg) {
     ...
     long_desc =
"    The bazaar exit to the north leads out onto first avenue while\n\
to the southwest a collage of brightly colored tents line the road.\n\
...
goods to facilitate sales.  An exit to the north leads out onto first\n\
avenue.  To the southwes the tents continue.\n";
...
to attract the attention and raise the spirits of those passing by",
     ...
     dest_dir = ({
        AREA+"105-153.c","north",
        AREA+"103-152.c","southwest",
