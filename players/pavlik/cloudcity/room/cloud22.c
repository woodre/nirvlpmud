...
reset(arg) {
  ...
  long_desc=
    "[Artisans St. & Iris Ave.]\n"+
    "You are at the intersection on Artisans Street and Iris Avenue.  This\n"+
  ...
  dest_dir=({
	"players/pavlik/cloudcity/room/cloud18", "south",
	"players/pavlik/cloudcity/room/cloud21", "west",
  });
