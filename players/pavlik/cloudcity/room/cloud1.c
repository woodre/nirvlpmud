...
reset(arg) {
  ...
  long_desc=
    "[Stratus St.]\n"+
    "You are at the south end of Stratus St.  The tall spires of the Ariel's\n"+
    "elegant buildings reach out to touch the sky in the north.  Looking any\n"+
  ...
  dest_dir=({
    "/players/pavlik/cloudcity/room/cloud3", "north",
  });
