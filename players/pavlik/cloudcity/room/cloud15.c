...
reset(arg) {
  ...
  long_desc=
    "[Pascal Ln. & Jade St.]\n"+
    "You across the deserted intersection of Jade and Pascal.  The clashing\n"+
  ...
  dest_dir=({
    "/players/pavlik/cloudcity/room/cloud10", "north",
    "/players/pavlik/cloudcity/room/cloud6", "east",
  });
