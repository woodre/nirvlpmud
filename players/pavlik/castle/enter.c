...
long_desc="You are in the main hall of the Tower of Mages.  The walls of\n"+
 ...
 "sell the many strange items the Mages need to casts thier spells.\n"+
 "There is a small bakery to the North, a Shop to the West and the room\n"+
 "to the East is where the Mages Council meets.\n";

dest_dir=({
 "/players/pavlik/mages/rooms/tower.c", "leave",
 "/players/pavlik/mages/rooms/bakery", "north",
 "/players/pavlik/mages/rooms/lil_shop", "west",
 "/players/pavlik/mages/rooms/stairs1", "up",
});

if(!present("jannhi", this_object())){
 ven1 = clone_object("players/pavlik/mages/rooms/vendor1");
 move_object(ven1, this_object());
       }
