...
reset(arg) {
  ...
  move_object(clone_object("players/pavlik/weapons/ilstkarn/quick_dagger"),
  this_object());
...
id(str) {
  return str == "quickling" || str == "quick" || str == "ilstkarn_monster";
}
...
monster_died() {
  ...
  if(this_player()->is_player() && this_player()->query_alignment() > 0)
    this_player()->add_alignment(50+random(50));
