...
monster_died() {
  ...
  i = random(4);
  if(i==0) move_object(clone_object("players/pavlik/items/red_potion"), ob);
  if(i==1) move_object(clone_object("players/pavlik/items/blue_potion"), ob);
  if(i==2) move_object(clone_object("players/pavlik/items/green_potion"), ob);
  if(i==3) move_object(clone_object("players/pavlik/items/clear_potion"), ob);
