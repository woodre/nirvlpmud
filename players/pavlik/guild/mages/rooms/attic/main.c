...
dest_dir=({
 "/players/pavlik/guild/mages/rooms/tower.c", "leave",
 "/players/pavlik/guild/mages/rooms/bakery", "north",
 "/players/pavlik/guild/mages/rooms/lil_shop", "west",
 "/players/pavlik/guild/mages/rooms/stairs1", "up",
});
