...
#define WAR "players/pavlik/guild/mages/room/war_room.c"
...
dest_dir=({
  "/players/pavlik/guild/mages/room/guild_room", "east",
  "/players/pavlik/guild/mages/room/war_room", "south",
  "/players/pavlik/guild/mages/room/mage_bar", "north",
});
...
south(){
  ...
  move_object(this_player(), "players/pavlik/guild/mages/room/war_room");
