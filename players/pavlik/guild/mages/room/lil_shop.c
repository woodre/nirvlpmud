...
dest_dir=({
 "/players/pavlik/guild/mages/room/main", "east",
});
...
push_stone(str){
  if(str == "stone"){
    ...
    move_object(this_player(), "players/pavlik/guild/mages/room/bank_stairs");
    return 1;
    }
}
...
east(){
  ...
  move_object(this_player(), "players/pavlik/guild/mages/room/main");
...
do_sell(ob) {
  ...
  if(do_destroy)
    ...
    call_other("players/pavlik/guild/mages/room/lshop_store", "store", ob);
  return 1;
}
...
value(item) {
 ...
 if(!name_of_item){
  if(call_other("players/pavlik/guild/mages/room/lshop_store", "value", item))
     return 1;
...
buy(item) {
  ...
  if(!item){
    ...
    call_other("players/pavlik/guild/mages/room/lshop_store", "buy", item);
    return 1;
}

list(obj){
  call_other("players/pavlik/guild/mages/room/lshop_store", "inventory", obj);
  return 1;
}
