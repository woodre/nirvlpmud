...
#define NOTES "players/pavlik/guild/mages/obj/gc_notes"
...
long() {
  write(
  "The board is only usable by members of the Mage's Council.\n"+
  "This magical slate provides a means for members of the council\n"+
  "to communicate.\n"+
  "Avaliable commands: post <subject> , read <#> , remove <#>\n");
  if (num_messages == 0) {
    write("The board is empty.\n");
    return;
  }
  write("The board contain "+num_messages);
  if (num_messages == 1)
      write(" posted note:\n\n");
  else
      write(" posted notes:\n\n");
...
short() {
  return "The Council's Board ["+num_messages+"]";
}
