...
reset(arg) {
  ...
  dest_dir=({
	"/players/pavlik/ilstkarn/lake2", "west",
	"/players/pavlik/ilstkarn/lake3", "north",
	"/players/pavlik/ilstkarn/lake4", "east",
	"/players/pavlik/ilstkarn/lake5", "south",
	"/players/pavlik/ilstkarn/null", "up",
  });
  if(!find_living("great_shark")) {
	move_object(clone_object("players/pavlik/ilstkarn/monsters/great_shark"),
	this_object());
  }
}
