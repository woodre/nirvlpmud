...
reset(arg) {
  ...
  move_object(clone_object("players/pavlik/ilstkarn/weapons/vanguard_sword"), this_object());
...
monster_died() {
  ...
  if(tres == 0)
    move_object(clone_object("players/pavlik/ilstkarn/treasure/evil_potion"), ob);
  else if(tres == 1)
    move_object(clone_object("players/pavlik/ilstkarn/armor/thief_boots"), ob);
  else if(tres == 2)
    move_object(clone_object("players/pavlik/ilstkarn/treasure/green_potion.c"), ob);
