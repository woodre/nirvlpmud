...
monster_died() {
  ...
  if(random(4)==2) {
    move_object(clone_object("players/pavlik/ilstkarn/armor/t_ring"), ob);
  }
  else {
    i = random(5);
    if(i==0) move_object(clone_object("players/pavlik/ilstkarn/treasure/blue_potion"), ob);
    if(i==1) move_object(clone_object("players/pavlik/ilstkarn/treasure/clear_potion"), ob);
    if(i==2) move_object(clone_object("players/pavlik/ilstkarn/treasure/red_potion"), ob);
    if(i==3) move_object(clone_object("players/pavlik/ilstkarn/treasure/green_potion"), ob);
    if(i==4) move_object(clone_object("players/pavlik/ilstkarn/treasure/black_potion"), ob);
    move_object(clone_object("players/pavlik/ilstkarn/armor/animal_hide"), ob);
  }
