...
breathe() {
  ...
  if(breath < 0) {
	...
	i = random(5);
	if(i==0)
		tell_object(ENV, YEL+"~ "+HIR+"Your eyes are bulging.\n"+NORM);
	if(i==1)
 		tell_object(ENV, YEL+"~ "+HIR+"Your lungs feel like they are on fire!\n"+NORM);
	if(i==2)
		tell_object(ENV, YEL+"~ "+HIR+"Your body screams for air!\n"+NORM);
	if(i==3)
		tell_object(ENV, YEL+"~ "+HIR+"Your chest feels like it is going to explode!\n"+NORM);
	if(i==4)
		tell_object(ENV, YEL+"~ "+HIR+"Your must get some air soon!\n"+NORM);
