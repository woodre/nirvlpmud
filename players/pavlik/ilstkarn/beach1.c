...
reset(arg) {
  ...
  long_desc=
  "You stand on the western shore of the underground lake.  The coarse black\n"+
  ...
  "The black sand beach surrounds the lake on all sides and a dark narrow\n"+
  "passage descends to the west.\n";
  dest_dir=({
	"/players/pavlik/ilstkarn/corridor1", "west",
	"/players/pavlik/ilstkarn/beach2", "north",
	"/players/pavlik/ilstkarn/beach3", "south",
  });
}

query_ilstkarn(){ return "beach1"; }
realm(){ return "NT"; }
