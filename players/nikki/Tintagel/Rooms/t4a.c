...
items = ({
  "table","The wooden table sits next to the door.  There appears to be a\n"+
          "deck of cards laying on top of it",
  "cards","The cards are crudely made and are tattered on the edges from\n"+
          "extreme use",
...
dest_dir = ( {
    "players/nikki/Tintagel/Rooms/t4.c", "outside",
    "players/nikki/Tintagel/Rooms/t4b.c", "up",
...
outside() {
      ...
      if(dr == 1) { 
        ...
        TP->move_player("the tower#players/nikki/Tintagel/Rooms/t4.c");
        return 1; 
         }
