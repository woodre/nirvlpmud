...
reset(arg) {
   ...
   if(!arg) {
      ...
      set_chat_chance(15);
      load_chat("The insect hisses: I can helpsss yousss.\n");
      load_chat("Insect says: You should not venture past the third circle\n");
      load_chat("The insect begins cleaning the flesh from his pincers\n");
      load_a_chat("Insect says:  you sshall getsss no helpsss now.\n");
      load_chat("The insect judge says:  Where do you wisssh to go human?\n");
