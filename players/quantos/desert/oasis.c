...
/* New, lower prices, except for non-alco /Pell */
    ...
    write("|           -------------------           |\n");
    write("|            Cerveza : 10 coins           |\n");
    write("|         Pin~a Colada : 80 coins         |\n");
    write("|           Mai-tai : 200 coins           |\n");
    write("|            Kahlua : 250 coins           |\n");
    write("|         Tequila shot : 300 coins        |\n");
/*    write("|      (Breathalyzer test : 10 coins)     |\n"); /Pell */
    write("|                                         |\n");
    write("|         Non-alcoholic beverages         |\n");
    write("|         -----------------------         |\n");
    write("|             Water : 60 coins            |\n");
    write("|         Mango juice : 180 coins         |\n");
    write("|           Perrier : 480 coins           |\n");
    write("|         Papaya juice : 800 coins        |\n");
    write("|       Pineapple juice : 1200 coins      |\n");
    write("|         Coconut milk : 2400 coins        |\n");
    write("-------------------------------------------\n");
    return 1;
  }
  else if (str == "dest") {
    ...
    write("The teleportation service costs 55 spell points.\n");
    return 1;
  }
  return 0;
}
...
/* Changed to use spell points instead /Pell */
  if (call_other (this_player(), "query_sp", 0) < 55) { /* Pell */
