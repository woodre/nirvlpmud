...
void reset(int arg)
{
  ...
  set_msg("You drink from the bottle of refreshing "+YEL+"lemonade.\n"+NORM);
  set_msg2(" takes a drink of lemonade.\n");
  set_heal(50,50);
  set_charges(3);
  set_msg_precharges("<");
  set_msg_postcharges(">");
  ...
  set_value(500);
  set_msg_soaked("You feel too full to drink any more lemonade.\n");
  set_empty_msg("You finish off the last of the refreshing " 
    +YEL+"lemonade.\n"+NORM);
}
