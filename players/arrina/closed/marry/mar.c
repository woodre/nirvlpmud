...
reset(arg) {
  if(arg) return;
    set_id("amulet");
    set_short("A small "+BLU+"blue"+NORM+" crystal amulet");
    set_long("The power to 'grant' rings of marriage is hidden\n"+
      "within the depths of this blue crystal.\n");
    set_weight(0);
    set_value(0);
}
init() {
...
string who, spo;
  ...
  tell_room(environment(this_player()),
    ...
    "\n"+
    "Magical crystals engulf "+capitalize(who) +" and "+ capitalize(spo)+"...\n"+
    "The crystals form a magical rainbow of light over everyone,\n"+
