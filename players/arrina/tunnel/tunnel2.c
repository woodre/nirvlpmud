 ...
 reset(arg){
   ...
   if(!present("talker")) {
 move_object(clone_object("/players/arrina/tmon/talkert1.c"),this_object());
 }
    ...
    dest_dir=
    ({
      "players/arrina/tunnel/tunnel4.c","west",
      "players/arrina/tunnel/tunnel3.c","east",
      "players/arrina/tunnel/tunnel1.c","south",
      "players/arrina/tunnel/tunnel5.c","north",
      });
 }
 }
  init()  {
