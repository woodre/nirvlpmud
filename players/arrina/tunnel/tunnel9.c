 ...
 reset(arg){
    ...
    dest_dir=
    ({
      "players/arrina/tunnel/tunnel7.c","west",
      "players/arrina/tunnel/tunnel3.c","south",
      "players/arrina/tunnel/tunnel11.c","north",
      });
 }
 }
  init()  {
  ...
  search_room() {
   write("You search through the room and notice large tracks\n"+
         "leading off to the next room!  You are afraid!.\n");
