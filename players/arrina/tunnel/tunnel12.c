 ...
 reset(arg){
   ...
   if(!present("qurd")) {
 move_object(clone_object("/players/arrina/tmon/qurd4.c"),this_object());
 }
    ...
    ({
      ...
      "players/arrina/tunnel/tunnel11.c","east",
      "players/arrina/tunnel/tunnel5.c","south",
      "players/arrina/tunnel/tunnel13.c","north",
      });
 }
 }
  init()  {
