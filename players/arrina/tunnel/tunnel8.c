 ...
 reset(arg){
    ...
    if(!find_living("qurd mage")) {
 move_object(clone_object("/players/arrina/tmon/qmage.c"),this_object());
 }
    if(!arg){
    set_light(0);
    ...
    dest_dir=
    ({
      "players/arrina/tunnel/tunnel9.c","west",
      "players/arrina/tunnel/tunnel10.c","north",
      "players/arrina/tunnel/tunnel4.c","south",
      "players/arrina/tunnel/tunnel6.c","east",
      });
 }
 }
  init()  {
