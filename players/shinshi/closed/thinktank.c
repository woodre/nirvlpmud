...
catch_tell(string str){
	 tell_room("/players/shinshi/workroom.c", str);
}

block(string str){
if(this_player()->query_real_name() != "shinshi"){ write("You aren't trying hard enough yet.\n"); return 1; }
if(this_player()->query_real_name() == "wicket"){ write("Wicket is stuck. As usual. Teach you to be a fucking smartass!\n"); return 1; } return 0; }
