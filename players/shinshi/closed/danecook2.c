...
reset(arg)
{
    ...
    set_name("dane");
    set_race("human");
    set_alias("shinshi_dane");
    set_short("Dane Cook");
	set_long("\
	This is Dane Cook. He is a tall young man\n\
	with short, spiked up, brown hair. He wears\n\
	a white shirt and faded blue jeans.\n");
    ...
    load_chat("Dane walks in a circle.\n");
    load_chat("Dane laughs at his own joke\n");
    load_chat("Dane points at you and says, \"Dude. You GOTTA try it!\"\n");
    load_chat("Dane says: That's right. I catapulted a -MMMMMM- CASHEW INTO MY GULLET!"); 
 ...
 */
    ...
    set_attribute(ATTRIB_GENEROUSITY, 0);       /* Our % chance of doing something nice to players not attacking us, i.e. healing or coining them. */

    set_monster_guild_level(2);                  /* This is almost archair, i dont know what i am going to do with it */
    set_monster_guild_rank("Beast");              /* This is almost archaic. i dont know what i am going to do with it. */
 ...
 */
    ...
    set_chance_of(CHANCE_EMOTE_ATTACKED, 0);    /* % that we will emote in combat */
    set_chance_of(CHANCE_EMOTE_PANICKED, 90);    /* % that we will emote when something unexpected has occurred */
    set_chance_of(CHANCE_EMOTE_TAUNTING, 95);     /* % that we will emote when taunting someone or trash talk in combat */
    set_chance_of(CHANCE_EMOTE_TRIUMPH, 40);     /* % that we will gloat like bastiges when we defeat something */
    set_chance_of(CHANCE_EMOTE_CASUAL, 5);       /* normal emote chance when just goofing around */
    set_chance_of(CHANCE_EMOTE_SCARED, 35);      /* emote chance when we are freaked out */
    set_chance_of(CHANCE_PELTING_THINGS, 100);    /* the percentile chance that these monsters will throw things at players */
 ...
 * but should have one member if you want to see the emotes, otherwise, nothing is said. */
    ...
    attacked_emotes = ({
		"Dane laughs at your pathetic ass.\n",
    });

	attacked_mchannels = ({
		"This dude has some HUGE balls by attacking me!\n",
        "Haha! He thinks he can kill me!\n",
	});


    panicked_emotes = ({
        "Dane panicks!\n",
        "Dane spins quickly trying to find an exit.\n",
        "Dane screams loudly.\n",
    });
	...
	panicked_mchannels = ({
        ...
        "Where's my backup?!?!\n",
        "WHERE ARE YOU DOOR KICKER? ARE YOU WATCHING?\n",
        "HE TOOK THE BEADS! WHAT THE FUCK IS GOING ON?\n",
	});

    
    hit_hard_emotes = ({
        "Dane slams into the ground.\n",
        "Dane cries like a little girl.\n",
        "Dane tries to crawl away from the beating.\n",
    });
    ...
    taunting_emotes = ({
        "Dane taunts you.\n",
        "Dane comes up to you and starts sputtering mumbo-jumbo.\n",
    });

    taunting_mchannels = ({
        "JUST GONNA EAT FUCKING NOODLES? JUST EAT FUCKING NOODLES?\n",
        "WHO BOUGHT THE NOODLES? JUST TELL ME WHO BOUGHT THE FUCKING NOODLES!\n",
        "THAT'S RIGHT. I BOUGHT THE FUCKING NOODLES. I DID. THEY'RE MY FUCKING NOODLES!\n",
    });


    triumph_emotes = ({
        "Dane dances victoriously.\n",
        "Dane shoots spaghetti out of his fingertips.\n",
    });

    triumph_mchannels = ({
        "Look at that dead d-bag! Ha ha ha!\n",
        "Enjoy your spaghetti 'cause you're rude!\n",
    });


    casual_emotes = ({
        "Dane tells a joke.\n",
        "You laugh at Dane's funny joke.\n",
    });
    ...
    scared_emotes = ({
        "Dane cowers in fear.\n",
        "Dane cries in his corner in fear.\n",
    });
    ...
    death_emotes = ({
        "Dane is NOT happy.\n",
        "Dane just wanted his... ya know.. bigawk!\n",
        "Dane dies after being boo'd.\n",
    });

    death_mchannels = ({
        "How did I die? Shinshi coded me! Worthless fuck...\n",
        "What the hell happened? \n",
        "It's ok.. I got a gazillion more shows this week!\n",
    });
    ...
    balloon_throw_emotes = ({
        "Dane yells, \"SURPRISE BITCH!\"\n",
        "Dane cackles gleefully.\n",
    });

    balloon_throw_mchannels = ({
        "Woo! Water balloon madness!\n",
        "Someone is soaking wet. Ha ha ha!\n",
        "RAPED!\n",
    });
     ...
     * but should have one member if you want to see the emotes, otherwise, nothing is said. */
    arrival_emotes =({
        "Dane comes running from the stage.\n",
        "Dane has arrived.\n",
    });
...
heart_beat()
{
    ...
    {
		switch(random(10)) {
			case 0: str="Boltar"; break;
			case 1: str="Chip"; break;
			case 2: str="Shinshi"; break;
			case 3: str="Fred"; break;
			case 4: str="Mizan"; break;
			case 5: str="Tristian"; break;
			case 6: str="Khrell"; break;
			case 7: str="X"; break;
			case 8: str="Star"; break;
			case 9: str="Angel"; break;
			default: str="Boltar";
	}
		say("Dane looks at you, cocks his leg, slams his foot onto\n"+
			"the ground and says, \"Yeah? Well you're just like "+str+"!\"\n");
		move_object(this_object(), "/players/shinshi/workroom.c");
	}
}
/* eof */
