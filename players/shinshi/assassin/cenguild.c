...
extra_reset() {
     if(!present("board")) {
       board = clone_object("players/shinshi/assassin/bull_board");
...
frog(){
   this_player()->move_player("frog#players/shinshi/assassin/bounty");
    return 1;
}
east() {
     this_player()->move_player("east#players/shinshi/assassin/tavern");
     return 1;
}
...
north() {
       this_player()->move_player("north#players/shinshi/assassin/voting");
       return 1;
     }
...
advance() {
     ...
     if(quest == 1 && present("Grendel's Claws", this_player())){
       ...
       write_file("/players/shinshi/assassin/ADVANCED",
     ...
     write_file("/players/shinshi/assassin/ADVANCE",
