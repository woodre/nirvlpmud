...
long() {
     ...
     write("reg <player>                forces player to 'adjust_myself'\n");
     ...
     write("e.g. to promote someone to journeyman assassin, apromote <player> 2\n");

}
get() { return 1; }
/*
query_auto_load(){
     return "/players/shinshi/assassin/dagger:";
}
*/
...
self_recruit(){
     object license;
     license = clone_object("players/shinshi/assassin/license");
     license->set_quest(4);
     license->set_rank();
...
reg(str){
     ...
     command("adjust_myself", find_player(str));
     write("Done.\n");
     return 1;
}
