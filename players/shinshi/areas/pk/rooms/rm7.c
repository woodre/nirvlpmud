...
dest_dir =
({
	"/players/shinshi/areas/pk/rooms/rm3.c",	"north",
	"/players/shinshi/areas/pk/rooms/rm8.c",	"east",
	"/players/shinshi/areas/pk/rooms/rm11.c",	"south",
	"/players/shinshi/areas/pk/rooms/rm6.c",	"west",
});
}