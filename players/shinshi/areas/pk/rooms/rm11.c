...
dest_dir =
({
	"/players/shinshi/areas/pk/rooms/rm7.c",	"north",
	"/players/shinshi/areas/pk/rooms/rm12.c",	"east",
	"/players/shinshi/areas/pk/rooms/rm15.c",	"south",
	"/players/shinshi/areas/pk/rooms/rm10.c",	"west",
});
}