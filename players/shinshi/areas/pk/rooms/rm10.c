...
dest_dir =
({
	"/players/shinshi/areas/pk/rooms/rm6.c",	"north",
	"/players/shinshi/areas/pk/rooms/rm11.c",	"east",
	"/players/shinshi/areas/pk/rooms/rm14.c",	"south",
	"/players/shinshi/areas/pk/rooms/rm9.c",	"west",
});
}