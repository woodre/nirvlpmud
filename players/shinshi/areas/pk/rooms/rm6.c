...
dest_dir =
({
	"/players/shinshi/areas/pk/rooms/rm2.c",	"north",
	"/players/shinshi/areas/pk/rooms/rm5.c",	"west",
	"/players/shinshi/areas/pk/rooms/rm10.c",	"south",
	"/players/shinshi/areas/pk/rooms/rm7.c",	"east",
});
}