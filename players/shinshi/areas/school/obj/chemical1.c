...
id(str) { return (str == "chemical" || str == "mucosaminoglycharide"); }

short() { return HBMAG+"Mucosaminoglycharide (rare)"+NORM; }
long() {
	write("This very rare chemical bubbles as it moves. It has a\n");
	write("bright magenta color to it and fizzes at random times.\n");
