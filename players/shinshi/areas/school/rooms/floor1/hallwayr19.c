...
reset(arg)
{
   ...
   dest_dir =
   ({
         "/players/shinshi/areas/school/rooms/floor1/hallwayr18.c",	"east",
         "/players/shinshi/areas/school/rooms/floor1/hallwayr20.c",	"west",
	"/players/shinshi/areas/school/rooms/floor1/trecanelli.c", "north",
    });
}
