...
reset(arg)
{
   ...
   dest_dir =
   ({
         "/players/shinshi/areas/school/rooms/floor1/hallwayr14.c",	"east",
         "/players/shinshi/areas/school/rooms/floor1/green.c",	"west",
         "/players/shinshi/areas/school/rooms/floor1/hallwayr16.c",	"north",
    });
}