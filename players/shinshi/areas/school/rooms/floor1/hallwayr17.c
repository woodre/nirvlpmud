...
reset(arg)
{
   ...
   dest_dir =
   ({
         "/players/shinshi/areas/school/rooms/floor1/hallwayr16.c",	"south",
         "/players/shinshi/areas/school/rooms/floor1/somers.c",	"west",
         "/players/shinshi/areas/school/rooms/floor1/hallwayr18.c",	"north",
    });
}