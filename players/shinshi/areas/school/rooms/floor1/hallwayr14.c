...
reset(arg)
{
   ...
   dest_dir =
   ({
         "/players/shinshi/areas/school/rooms/floor1/hallwayr13.c",	"east",
         "/players/shinshi/areas/school/rooms/floor1/hallwayr15.c",	"west",
         "/players/shinshi/areas/school/rooms/floor1/mader.c",	"south",
    });
}