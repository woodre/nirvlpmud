...
reset(arg)
{
   ...
   dest_dir =
   ({
         "/players/shinshi/areas/school/rooms/floor1/hallwayr15.c",	"south",
         "/players/shinshi/areas/school/rooms/floor1/thompson.c",	"east",
         "/players/shinshi/areas/school/rooms/floor1/hallwayr17.c",	"north",
    });
}