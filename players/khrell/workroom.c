...
short() {
  ...
  if(cloak) {
    switch(random(8)) {
      case 0: str="Dark room"; break;
      case 1: str="Village church"; break;
      case 2: str="A large open plain [many exits]"; break;
      case 3: str="Dark room"; break;
      case 4: str="Post office [n,s]"; break;
      case 5: str="The shop"; break;
      case 6: str="The void"; break;
      case 7: str="Prison"; break;
      case 8: str="A road [n,s,e,w]"; break;
