...
"His features are haggard and suspicous.  Hooded eye sockets gaze out\n"+
"and you do not feel all that welcome in his presence.\n");
  set_gender("male");
  set_race("dwarf");
  set_level(20);
...
init_command("wield axe");
  set_wc(35);
move_object(clone_object("/players/khrell/area/dwarf/obj/dwhelm1.c"));
...
set_chat_chance(10);
load_chat("The dwarf fingers his axe blade.\n");
load_chat("The dwarf stares suspicously at you.\n");
load_chat("The dwarf grumbles.\n");
load_chat("You catch the dwarf staring at yor coin purse.\n");
...
add_spell("axe chop",
"The dwarf $HW$hacks$N$ and $HK$cleaves$N$ into you!"\n,
"#MN# $HW$hacks$N$ and $HK$chops$N$ into #TN#!"\n,
25,({25,25}),({"physical","physical"}),1);
