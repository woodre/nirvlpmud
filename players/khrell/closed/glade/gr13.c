...
reset(arg) {
   ...
   items = ({
         "item", "NO/N"});
   dest_dir = ({
         "players/khrell/closed/glade/gr19.c", "south",
         "players/khrell/closed/glade/gr19.c", "north",
         "players/khrell/closed/glade/gr20.c", "east",
         "players/khrell/closed/glade/gr20.c", "west",
         "players/khrell/closed/glade/gr16.c", "northwest",
         "players/khrell/closed/glade/gr14.c", "northeast",
         "players/khrell/closed/glade/gr15.c", "southwest",
