...
if(!arg) {
   ...
   dest_dir=({
      "/players/llew/closed/crystal/crys2.c","north",
      "/players/llew/closed/crystal/crys5.c","east",
      "/players/llew/closed/crystal/crys6.c","south",
      "/players/llew/closed/crystal/crys3.c","west",
      "/players/llew/closed/crystal/crys1.c","up",
      "/players/llew/closed/crystal/crys.c","down",
      });
   items=({
