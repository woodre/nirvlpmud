...
reset(arg) {
   ...
   set_short(GRN+"Fester Peak"+NORM+" ["+CYN+"Temple of the Horned Rat"+NORM+"] ("+HIK+"Bell-tower"+NORM+")");
...
exit_function(string str)
{
    ...
    this_player()->move_player("climbs down the rope#/players/khrell/area/skaven2/hr12.c");
    return 1;
}