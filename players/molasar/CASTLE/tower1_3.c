...
long() {
     write("You have reached the top of the southeastern tower of the castle.\n");
     write("This point serves as a lookout for advance warning of attackers.\n");
    write("Looking out the large window you can see the mountain where you\n");
     write("first entered this realm.\n");
...
down() {
     call_other(this_player(),"move_player",
                    "down#players/molasar/CASTLE/tower1_2");
     return 1;
}
