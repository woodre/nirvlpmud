...
long() {
     write("You have reached the top of the northeastern tower of the castle.\n");
     write("This point serves as a lookout for advance warning of attackers.\n");
    write("Looking out the large window you see a vast forest.\n");
...
down() {
     call_other(this_player(),"move_player",
                    "down#players/molasar/CASTLE/tower2_2");
     return 1;
}
