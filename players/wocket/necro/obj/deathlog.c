...
#define LOGFILE "/players/wocket/necro/log/deathlog"
...
*/
      ...
      while(sscanf(deathlog,"%s\n%s",worktext,deathlog)==2) {
         ...
         string playcolor;
         spar = 0;
         if(sscanf(worktext,"%s 20%d %s %d exp %s gold killed by %s.",deathtime,YEAR,playname,playexp,playgold,playkill)==6) {
