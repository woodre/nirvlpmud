...
reset(arg){
  if(arg) return ;
    ...
    long_desc = ""+
    "   This tunnel is thin and narrow with the walls beening covered in dirt allowing\n"+
    "only a little of the white marble stone to show through. North, as the stones become\n"+
    "cleaner, unvails the Necromacer's stronghold.  South, a non-descript stone wall stands\n"+
    "with a single lever pentrating through it.  Dust filters off the wall as if something has\n"+
    "recently been moved.\n";
