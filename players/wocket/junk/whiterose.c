...
id(str){ return str=="rose" || str=="white rose" || str=="w_whiterose"; }
...
init(){
  ...
  accept_msg = this_player()->query_name()+" whisper to you, \"I'm yours.\"";
  ask_msg = this_player()->query_name()+" whisper to you, \"I want you.\"";
}
