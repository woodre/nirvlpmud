...
poorly.  Next to the house is a long golden horn mounted on a stand.\n";
  items=({
    ...
    "horn","A long golden horn, bolted to a stone pedestal.  You can 'blow' it"
  });
  dest_dir=({
    ROOMDIR+"summhut.c","enter"
  });
}
...
"A huge black dragon, her scales as black as coal, swoops down and lands\n\
amidst the ruins.\n");
