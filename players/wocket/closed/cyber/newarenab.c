...
"to spectate the events.\n";
items = ({
"lines","They are red and mark the boundries for the mat\n",
...
dest_dir = ({
"/players/wocket/closed/cyber/newarena.c","west",
...
exit(){
if(this_player()->is_player()){
if(query_verb() && query_verb() == "west") return 1;
 this_player()->rm_spar();
}
return 1;
}
