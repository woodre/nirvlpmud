...
set_long("He is wearing long black robes with a cross hangning around his neck\n"+
         ...
         "you will be revived or if you wish he will 'marry' you to someone for\n"+
         "a fee of 1000 coins.\n");
set_level(20);
set_hp(500);
set_wc(30);
...
object SO;
  ...
  if(str == "guest"){
    notify_fail(PRIEST+" says: You are not allowed to marry Guest.\n");
    return 0;
  }
  ...
  say("in sickness and in health, for richer or for poorer, through thick and\n"+
