...
set_long("A withered old man.  He is very crippled and has a couple\n"+
         ...
         "though they seem like, at one time they were very distiquished.\n"+
         "A small creast adorns his shirt.  A couple scars mark his face\n"+
...
string first,last;
  ...
  if(first != "felic" && first != "knight"){
    notify_fail("Who would you like to ask what?\n");
    return 0;
  }
  if(str != "felic about the sinja worm" && str != "knight about the sinja worm"){
...
write("Felic says: So you want to know about the Sinja worm eh.  Vicious \n"+
      ...
      "to the worm.  I sure wish I knew that back when I could still fight.\n");
if(quest == 1){
...
write("Oh, I guess I have this sword I no longer use that I could give to you.\n"+
      "Perhaps it do you more good then it did me.\n");
quest = 1;
hero = this_player();
call_out("giveme",4);
return 1;
