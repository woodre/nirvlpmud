...
int spell_chance, mon_spell_dam;
...
heart_beat()
{
	...
	call_other(attacker_ob, "hit_player", random(mon_spell_dam));
      if(attacker_ob->query_real_name() =="boltar") tell_object(attacker_ob, "The spell damage is "+mon_spell_dam+"\n");
    }
    attack();
