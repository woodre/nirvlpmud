...
reset(arg) {
   ...
   dest_dir =
   ({
        "/players/hurtbrain/castello/dag/gaul/gaul19" ,"east" ,
        "/players/hurtbrain/castello/dag/gaul/gaul26" ,"northwest" , 
        "/players/hurtbrain/castello/dag/gaul/gaul15" ,"southwest" 
    }) ;
    num=4+random(4);
        for(k=0;k<num;++k)
                {
