...
reset(arg) {
   ...
   dest_dir =
   ({
        "/players/hurtbrain/castello/dag/gaul/gaul13" ,"east" ,
        "/players/hurtbrain/castello/dag/gaul/gaul8" ,"southwest" , 
        "/players/hurtbrain/castello/dag/gaul/gaul19" ,"northwest" 
    }) ;
