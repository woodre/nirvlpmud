...
reset(arg) {
   ...
   dest_dir =
   ({
        "/players/hurtbrain/castello/dag/gaul/gaul44" ,"north" , 
        "/players/hurtbrain/castello/dag/gaul/gaul32" ,"southeast" ,
        "/players/hurtbrain/castello/dag/gaul/gaul45" ,"northwest"
