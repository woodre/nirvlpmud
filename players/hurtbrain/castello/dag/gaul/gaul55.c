...
reset(arg) {
   ...
   dest_dir =
   ({
        "/players/hurtbrain/castello/dag/gaul/gaul60" ,"northwest" , 
        "/players/hurtbrain/castello/dag/gaul/gaul49" ,"southwest" , 
        "/players/hurtbrain/castello/dag/gaul/gaul48" ,"southeast"
    }) ;
