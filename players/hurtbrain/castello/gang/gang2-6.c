...
reset(arg) {
   ...
   dest_dir =
   ({
    "/players/hurtbrain/castello/gang/gang2-9" ,"south" ,
    "/players/hurtbrain/castello/gang/gang2-5" ,"west" ,
    "/players/hurtbrain/castello/gang/gang2-7" ,"east",
    "/players/hurtbrain/castello/gang/gang2-3" ,"north"
	});
    num=random(3);
    for (k=0 ; k<2+num ; ++k)  {
