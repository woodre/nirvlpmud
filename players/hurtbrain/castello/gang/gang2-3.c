...
reset(arg) {
   ...
   dest_dir =
   ({
    "/players/hurtbrain/castello/gang/gang2-6" ,"south" ,
    "/players/hurtbrain/castello/gang/gang2-2" ,"west" ,
    "/players/hurtbrain/castello/gang/gang2-4" ,"east",
    "/players/hurtbrain/castello/gang/gang2-1" ,"north"
	});
    num=random(3);
    for (k=0 ; k<2+num ; ++k)  {
