...
reset(arg) {
   ...
   dest_dir =
   ({
    "/players/hurtbrain/castello/gang/gang5-3" ,"south" ,
    "/players/hurtbrain/castello/gang/gang5-2" ,"southwest" ,
    "/players/hurtbrain/castello/gang/gang5-4" ,"southeast",
    } ) ;
    num=random(3);
    for (k=0 ; k<2+num ; ++k)  {
    ...
    obj = clone_object("/players/hurtbrain/castello/gang/al.c");
    move_object(obj,this_object());
    set_light(1) ;
}
