...
reset(arg) {
   ...
   dest_dir =
   ({
    "/players/hurtbrain/castello/gang/gang5-6" ,"south" ,
    "/players/hurtbrain/castello/gang/gang5-2" ,"west" ,
    "/players/hurtbrain/castello/gang/gang5-4" ,"east",
    "/players/hurtbrain/castello/gang/gang5-1" ,"north"
	});
    num=random(3);
    for (k=0 ; k<2+num ; ++k)  {
