...
reset(arg) {
   ...
   dest_dir =
   ({
    "/players/hurtbrain/castello/gang/gang3" ,"south" ,
    "/players/hurtbrain/castello/gang/gang3-8" ,"west" ,
    "/players/hurtbrain/castello/gang/gang3-10" ,"east",
    "/players/hurtbrain/castello/gang/gang3-6" ,"north"
	});
    num=random(3);
    for (k=0 ; k<2+num ; ++k)  {
