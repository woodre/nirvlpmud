...
reset(arg) {
   ...
   dest_dir =
   ({
    "/players/hurtbrain/castello/gang/gang1-6" ,"south" ,
    "/players/hurtbrain/castello/gang/gang1-2" ,"west" ,
    "/players/hurtbrain/castello/gang/gang1-4" ,"east",
    "/players/hurtbrain/castello/gang/gang1-1" ,"north"
    });
    num=random(3);
    for (k=0 ; k<2+num ; ++k)  {
