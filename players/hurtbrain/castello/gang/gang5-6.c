...
reset(arg) {
   ...
   dest_dir =
   ({
    "/players/hurtbrain/castello/gang/gang5-9" ,"south" ,
    "/players/hurtbrain/castello/gang/gang5-5" ,"west" ,
    "/players/hurtbrain/castello/gang/gang5-7" ,"east",
    "/players/hurtbrain/castello/gang/gang5-3" ,"north"
	});
    num=random(3);
    for (k=0 ; k<2+num ; ++k)  {
