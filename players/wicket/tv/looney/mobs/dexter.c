...
heart_beat()
{
  ...
  if(this_object()->query_hp() < (this_object()->query_mhp() / 2))
  {
    ...
    move_object(clone_object("/players/wicket/tv/looney/mobs/freakazoid.c"), environment(this_object()));
...
second_life()
{
  ...
  tell_room(environment(),
    "Dexter Douglas screams, \"I'm FREAKIN' OUT!\"\n");
  move_object(clone_object("/players/wicket/tv/looney/mobs/freakazoid.c"), environment());
