...
reset(arg) {
  ...
  set_light(1);
  long_desc=
"The Laboratory of Shared Consciousness is lined with \n"+
...
"proper knowledge you could gaze,escort,scry,lock, and shield",
    "basin",
"A pool of crystal clear water in a marble basin.  If you had the\n"+
...
" Some Walker Percy, Tim Robbins books\n"+
    "bookshelves",
...
cmd_smell(str) {
write("The smell smells vaguely of Nag Champa and fresh spring rain.\n");
  return 1;
}

cmd_listen(str) {
write("Surround sound speakers fill the room with music.\n");
  return 1;
}
...
return str+"Shared Consciousness Laboratories"+NORM;
  }
}
