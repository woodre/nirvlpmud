...
long_desc =
"The line starts here to get into the venue to the north.\n"+
"Trashcans sit here with contraband lying next to them.\n"+
"Security guards are frisking people to the north and checking for tickets.\n"+
