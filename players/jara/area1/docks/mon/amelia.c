...
move_object(ob,this_object());
  ...
  set_long("Amelia has thick black hair that falls in curls halfway down her\n"+
    ...
    "here, you may try "+HIW+"asking"+NORM+" her about some"+HIW+" information"+NORM+".\n");
  set_level(14);
  set_ac(11);
  set_wc(18);
  set_hp(210);
...
string what;
  ...
  return 1;
      case "stablehand":
      write(
    "Amelia blushes a deep red and lowers her eyes...\n");
  return 1;
      case "land": case "pirates":
      write(
    "Amelia giggles softly and says, 'Oh, I don't know much about\n"+
    "that! You need to talk to "+HIW+"Nuri"+NORM+" the "+HIW+"fisherman"+NORM+".\n"+
    "Amelia smiles up at you and continues to wipe down the bar.\n");
  return 1;
  default:
      write("Amelia giggles softly and says, 'Oh, I don't know much about that..'\n");
  return 1;
  }
}
