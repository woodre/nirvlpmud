/* Path 10, Created <5/21/00> by Jara */
...
reset(arg) {
  ...
  long_desc=
    ...
    "spread in all directions. A graveyard begins just to the east of the\n"+
    "path, bordered by a metal fence. A small chapel within the graveyard\n"+
