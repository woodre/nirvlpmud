...
reset(int arg)
{
   ...
   set_long(
      "  Within the confines of the tree light is clearly visible.\n"+
   ...
   add_item("light","Bright sunlight filters through the branches");
   add_touch("trees","The trees bark is rough...Ouch!");
   add_listen("main","Strange sounds float through the air, making you feel uneasy.");
   add_exit("/players/fred/forest/Rooms/forest13.c","down");
   add_exit("/players/fred/forest/Rooms/forest16.c","east");
   add_exit("/players/fred/forest/Rooms/forest15.c","climb"); 
