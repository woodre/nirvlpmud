...
reset(int arg)
{
   ...
   set_long(
     "  This is the edge of the village. The streets are made of hard\n"+
   ...
   add_exit("/players/fred/forest/Rooms/forest1.c","west");
   add_exit("/players/fred/forest/Rooms/vill_2.c","east");
   add_exit("/players/fred/forest/Rooms/entrance.c","leave");
   add_object("/players/fred/forest/Obj/dispenser.c");
}
