...
reset(int arg)
{
   ...
   set_long(
      ...
      "the streets here. There is a heal shop to the north.\n");
   ...
   add_exit("/players/fred/forest/Rooms/vill_3.c","west");
   add_exit("/players/fred/forest/Rooms/vill_5.c","east");
   add_exit("/players/fred/forest/Rooms/hshop.c","north");
}
