...
reset(int arg)
{
   ...
   set_long(
      "  The path is hard to follow now as the forest grows freely\n"+
      "shrouding you in total darkness. The branches on the nearby\n"+ 
      "trees creak from the blowing wind. Something is not right about\n"+
      "this place.\n");
   ...
   add_exit("/players/fred/forest/Rooms/forest26.c","west");
   add_exit("/players/fred/forest/Rooms/forest25.c","north");
   add_exit("/players/fred/forest/Rooms/forest31.c","southeast");
   set_chance(3);
