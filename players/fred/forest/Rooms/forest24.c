...
reset(int arg)
{
   ...
   add_item("branches","Large sturdy branches on a nearby tree");
   ...
   add_exit("/players/fred/forest/Rooms/forest25.c","east");
   add_exit("/players/fred/forest/Rooms/forest7.c","north");
   add_exit("/players/fred/forest/Rooms/forest26.c","south");
   set_chance(3);
