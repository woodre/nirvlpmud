...
reset (arg) {
	set_id("soul");
      set_alias("lost");
	set_short("A Lost "+BOLD+"Soul"+NORM);
	set_long(
         "  This is the soul of a lost spirit. It was left for\n"+
...
free_it(str) {
	if(!str){ write("Free what?\n"); return 1; }
      if(str == "soul" || str =="lost" || str == "lost soul"){
         int money;
         money = 700+random(100); 
         this_player()->add_money(money);
         say(this_player()->query_name()+ " frees a lost soul!\n"); 
         tell_object(this_player(),
         "You mutter a few words of reverance and a lost soul is freed into the air...\n"+
         "The lost soul smiles at you as it disappears.\n"+
...
heal_me(str) {
  ...
  if(str == "soul" || str =="lost" || str == "lost soul"){
    say(this_player()->query_name()+" absorbs a lost soul!\n");
    tell_object(this_player(),
       "You mutter a few words as you hold the lost soul close to your body...\n"+
       "The lost soul "+BOLD+HIY+"Flashes"+NORM+" with light as it is absorbed into your body.\n");
