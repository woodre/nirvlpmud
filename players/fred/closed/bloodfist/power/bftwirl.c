...
status main(string str, object PO, object User)
{
    ...
    && (wep = (object)User->query_weapon()) || (wep = present(str, User)))
  {
    ...
    TOU "You twirl "+nst+" gracefully around your body.\n");
    TRU User->query_name()+" twirls "+nst+
      " gracefully around "+User->POS+" body.\n", ({ User }));
  }
  else
    return (notify_fail("What weapon do you want to twirl?\n"), 0);
  return 1;
}
