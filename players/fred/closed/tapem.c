...
init(){
  ::init();
    ...
    add_action("tellem","whisper");
    add_action("tellem","emto");
...
tellem(){
  write("I'm sorry but the duct tape stops you from talking!\n");
  return 1; }
...
extra_look(){
  return ""+environment()->query_name()+" has a thick piece of duct tape placed over "+tpp+" mouth"; }
