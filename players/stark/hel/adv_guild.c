...
dest_dir=({
"/players/stark/hel/vill_road2", "north",
"/players/stark/hel/info", "west",
"/players/stark/hel/wiz_guild", "south",
"/players/stark/hel/exlv_guild", "up"
});
}
