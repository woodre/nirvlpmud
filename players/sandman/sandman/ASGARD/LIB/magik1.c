...
reset(arg) {
   if(arg) return;
   set_light(1);
   short_desc=("Library room [n,nw,ne,s]");
   long_desc=
      "You enter a room filled with large dusty book shelves, here all the\n"
+     "knowledge of the gods are kept here. To the north, northwest, and\n"
