...
long()
{
  ...
  write("There are " + (11-charge_used) + " sips left.\n");
}
...
if (charge_used == 10) { write("You drink the last sip from your canteen.\n"); }
      else { write("There are " + (10 - charge_used) + " sips left.\n"); }
