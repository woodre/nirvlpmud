...
psi_sword() { MAIN->psi_sword(); return 1; }
...
track(str) {
  object t;
  t= MAIN->track(str,follow);
  if (objectp(t)) { follow= t; return 1; }
  return t;
}
lose(str) { return MAIN->lose(str,follow); }
