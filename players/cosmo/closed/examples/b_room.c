...
reset(int arg) {
   ...
   if(!present("flytrap", this_object())){
      move_object(clone_object("/players/beck/castle/rangers/monsters/flytrap.c"), this_object());
   }
...
walk(arg) {
   ...
   call_other(this_player(),"move_player","walking#/players/beck/castle/rangers/rooms/venus2.c");
   return 1;
}
climb(arg) {
   ...
   call_other(this_player(),"move_player","climb#/players/beck/castle/rangers/rooms/venus3.c");
   return 1;
}
search(arg) {
   if (search_count == 0)  {
      ...
      move_object(clone_object("players/beck/castle/object/shark_tooth.c"),this_player());
...
swim(arg) {
   ...
   call_other(this_player(),"move_player","swiming#/players/beck/castle/rangers/rooms/sea1.c");
   return 1;
}
