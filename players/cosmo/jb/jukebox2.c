...
#include "/players/cosmo/jb/jsongs2.h"
#include "/players/cosmo/jb/jtitles2.h"
...
int n;
  if(arg) return;
  CDs = ARTISTS;    /* ARTISTS is defined in jtitles2.h */
  n = 1;
  bands = ({ });
  while (CDs[n] != "END")  {
...
string *titles, *CDs;
  ...
  sscanf(str, "%d",num);
  switch(num) {
    case 1: titles = CD1; break;  /* CD1 is defined in jtitles2.h */
...
int num;
  ...
  switch(num) {
    case 1:
      switch(letter) {
        case "a": lyrics = song1a; break;  /* song1a is defined in jsongs2.h */
    ...
    case 4:
      switch(letter) {
        ...
        case "k": lyrics = song4k; break;
        case "l": lyrics = song4l; break;
        case "m": lyrics = song4m; break;
        default:
          write("That is not a valid selection.  Please select again.\n");
          return 1;
        break;
    ...
    case 7:
      switch(letter) {
        ...
        case "e": lyrics = song7e; break;
        case "f": lyrics = song7f; break;
        case "g": lyrics = song7g; break;
        case "h": lyrics = song7h; break;
        case "i": lyrics = song7i; break;
        case "j": lyrics = song7j; break;
        case "k": lyrics = song7k; break;
        case "l": lyrics = song7l; break;
        default:
          write("That is not a valid selection.  Please select again.\n");
          return 1;
        break;
    ...
    case 8:
      switch(letter) {
        ...
        case "i": lyrics = song8i; break;
        case "j": lyrics = song8j; break;
        case "k": lyrics = song8k; break;
        case "l": lyrics = song8l; break;
        case "m": lyrics = song8m; break;
        case "n": lyrics = song8n; break;
        default:
          write("That is not a valid selection.  Please select again.\n");
          return 1;
        break;
    ...
    case 11:
      switch(letter) {
        ...
        case "q": lyrics = song11q; break;
        case "r": lyrics = song11r; break;
        default:
          write("That is not a valid selection.  Please select again.\n");
          return 1;
        break;
    ...
    case 14:
      switch(letter) {
        ...
        case "l": lyrics = song14l; break;
        case "m": lyrics = song14m; break;
        default:
          write("That is not a valid selection.  Please select again.\n");
          return 1;
        break;
...
string verb;
  ...
  if (lyrics[1] == "Tori Amos" || lyrics[1] == "LeAnn Rimes")
    { verb = " sings: ";  }
  if (lyrics[x] != "END")  {
  ...
  ROM HIR+BANNER+NORM+"\n");
  if (lyrics[1] == "Tori Amos" || lyrics[1] == "LeAnn Rimes") {
    ROM band+" walks off the virtual stage as she finishes her song.\n");
  }
  else {
