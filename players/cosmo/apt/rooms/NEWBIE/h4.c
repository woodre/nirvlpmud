...
reset(arg) {
   ...
   rat_room_count=0;
   set_light(0);
   set_sound("You hear some movement to the south.");
   set_smell("The mud in this room smells like sulfur.");
   short_desc=BOLD+BLK+"A pathway in the darkness"+NORM;
   long_desc=BOLD+BLK+
   "The narrow tunnel reaches a sharp curve here, with the elbow\n"+
   "heading east and south.  Some of the mud from the walls seems\n"+
   "to have gathered on the ground here, making your footing very\n"+
   "treacherous.  The path to the south leads slightly uphill, but\n"+
   "at least it appears a bit roomier than to the east.\n"+NORM,

   items=
   ({
     "mud",
     "It's wet.  It's thick.  It's dark.  It's mud",
     "tunnel",
