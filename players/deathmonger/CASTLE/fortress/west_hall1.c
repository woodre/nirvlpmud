...
TWO_EXIT("players/deathmonger/CASTLE/fortress/entrance","north",
         "players/deathmonger/CASTLE/fortress/west_hall2","south",
         "Skeleton guards",
         "Skeletons guard the perimeter of the Fortress of the Undead.\n",
         1)
