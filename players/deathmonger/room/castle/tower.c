...
reset(int arg){
if(!present("bandit")) {
move_object(clone_object("/players/saber/closed/monsters/banditguard.c"),this_object());
}
 if(!arg){
  set_light(1);
...
items=({
 ...
 dest_dir=({"/players/saber/closed/tower/tower10+1.c","west",});
 }}

in(){
if(!present("bandit")){
call_other(this_player(),"move_player","in#players/saber/closed/tower/tower10+5.c");
 say(tp+" leaves south\n");
 return 1;}
else
{
