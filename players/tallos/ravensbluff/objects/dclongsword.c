...
reset(arg) {
  ...
  set_alt_name("crystal longsword");
   set_short(HIC+"<><><><><><>"+NORM+""+CYN+")("+HIK+"=="+NORM+""+CYN+"<>"+NORM);
   set_long("Behold the:\n"+
            "                  "+HIW+"DIAMOND"+HIC+" CRYSTAL "+HIB+"LONGSWORD"+HIW+"!"+NORM+"\n"+
            "The "+HIB+"blade"+NORM+" is made of several hundred hard "+HIW+"diamonds"+NORM+" and sharpened\n"+
            "to a razor's edge. It was once the side arm of the mortal avatar\n"+
            "of "+HIB+"L"+HIC+"u"+HIB+"r"+HIC+"u"+HIB+"e."+NORM+"   It "+HIM+"glows"+NORM+" faintly in your hands and grows brighter as\n"+
            "it nears an "+HIR+"evil"+NORM+" foe. It is nearly indestructable.\n");
