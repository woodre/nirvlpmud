...
""+YEL+"gold fabric"+NORM+". It seems very durable.  You may also type\n"+
...
do_special(owner) {
   if(!random(6)) {
      tell_object(owner,
         "Your "+YEL+"Surcoat "+HIC+"g"+HIW+"l"+HIC+"o"+HIW+"w"+HIC+"s"+NORM+" faintly and you feel "+HIB+"better!!!"+NORM+"\n");
       this_player()->add_hit_point(3);
       this_player()->add_spell_points(3);        
      return 1; }
}
