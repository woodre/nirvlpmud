...
yell_it(){
  string yada;
   switch(b){
     ...
     case 4: yada = " "; break; 
     case 5: yada = "            I've got this amulet I got from some guy I used to know"; break;
     case 6: yada = " "; break;
     ...
     case 15: yada = "             Once you have the items I desire bring them back here\n"+
                     "              and give them to me. After that just type 'amulet'"; break;
...
write("Vinni smiles at you and hands you an amulet.\n");
