...
reset(arg) {
  if(arg) return;
short_desc = HIY+"7 Tigers Inn"+NORM+":"+HIC+" Room 340"+NORM;
long_desc = "  "+HIB+"   This is "+HIC+"room 340"+NORM+""+HIB+" on the 3rd floor of the"+HIY+" 7 Tigers\n"+
            ...
            ""+NORM+""+CYN+"drapes"+NORM+""+HIB+" on the windows to the "+NORM+""+CYN+"carpet"+NORM+""+HIB+" and"+NORM+""+CYN+" beding"+NORM+""+NORM+""+HIB+"."+NORM+""+NORM+"\n";
   add_object("/players/tallos/7tigers/mobs/halflingrogue1.c",1);
items = ({
  "table",
