...
reset(arg) {
  if(arg) return;
short_desc = HIY+"7 Tigers Inn"+NORM+":"+HIC+" 2nd Floor Right Hall"+NORM;
long_desc = ""+HIG+"This is the "+HIC+"2nd floor east hallway"+HIG+" of the inn. Several\n"+
...
dest_dir = ({
    PATH+"/room260.c","southeast",
    PATH+"/room250.c","southwest",
    PATH+"/room280.c","northeast",
    PATH+"/room270.c","northwest",
    PATH+"/balcony.c","west",
  });
set_light(1);
}
