...
reset(arg) {
  if(arg) return; 
short_desc = HIY+"7 Tigers Inn"+NORM+": "+HIR+"DEMON"+NORM+""+HIB+" Room 2"+NORM;
long_desc = "    "+HIR+"This is a strange and dark place. It simply is a large\n"+
                  ""+NORM+""+RED+"dirt room"+HIR+" with a "+BLK+"hole"+HIR+" you may go out from. Unusal place for\n"+
                  "a guest of the hotel to stay.\n"+
                  "     A hole \""+NORM+"South"+HIR+"\""+NORM+"\n";
