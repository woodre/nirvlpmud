...
reset(arg) {
  if(arg) return;
short_desc = HIY+"7 Tigers Inn"+NORM+":"+HIC+" 3rd Floor Right Hall"+NORM;
long_desc = ""+HIG+"This is the "+HIC+"3rd floor east hallway"+HIG+" of the inn. Several\n"+
...
dest_dir = ({
    PATH+"/room360.c","southeast",
    PATH+"/room350.c","southwest",
    PATH+"/room380.c","northeast",
    PATH+"/room370.c","northwest",
    PATH+"/3ftopstairs.c","west",
  });
set_light(1);
}
