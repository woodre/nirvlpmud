...
reset(arg) {
  if(arg) return;
short_desc = HIY+"7 Tigers Inn"+NORM+":"+HIC+" "+HIC+" C"+HIB+"e"+HIC+"l"+HIB+"e"+HIC+"s"+HIB+"t"+HIC+"i"+HIB+"a"+HIC+"l"+HIC+" Room 4"+NORM;
long_desc = "    "+NORM+""+MAG+"The best rooms in the hotel for sure.  A marvelous\n"+
    ...
    add_object("/players/tallos/7tigers/mobs/asimar2.c");            
items = ({
  "inn",
