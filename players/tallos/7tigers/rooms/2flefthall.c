...
reset(arg) {
  if(arg) return;
short_desc = HIY+"7 Tigers Inn"+NORM+":"+HIC+" 2nd Floor Left Hall"+NORM;
long_desc = ""+HIG+"This is the "+HIC+"2nd floor west hallway"+HIG+" of the inn. Several\n"+
   ...
   add_exit(PATH+"/room210.c","southeast");
   add_exit(PATH+"/room220.c","southwest");
   add_exit(PATH+"/room230.c","northeast"); 
   add_exit(PATH+"/room240.c","northwest");
   add_exit(PATH+"/balcony.c","east");   
