...
reset(arg) {
 ...
 set_name("enchanted sword");
   ...
   set_value(5000);
   message_hit = ({
    ""+RED+"slashed"+NORM+""," with lethal grace",
    ""+HIY+"zapped"+NORM+""," with tendrils of energy",
    ""+HIR+"stabbed"+NORM+"","",
    ""+HIR+"cut"+NORM+"","",
    ""+RED+"stuck"+NORM+""," with the tip of the blade",
    "pummeled"," with the pommel of the sword",
    "grazed"," with the tip of the blade",
});
...
break;
case 3..5:
say(TPN + " gets a sinister look on " + TPP + " face as the sword slices through flesh!\n");
write("You get a sinister look on your face as the sword slices through flesh!\n");
return 3;
break;
}
}
