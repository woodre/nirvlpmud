...
id(str) { return str=="seraph" || str=="linus_angel_mob" || str=="angel"; }
...
reset(arg) {
 ...
 BOOGALOO = COLOR[x]+"["+HIW+"seraphim"+NORM+COLOR[x]+"]"+NORM;
 ...
 "shoulders.  The angel is wearing a white jacket, and a small badge can\n"+
 "be seen on the right breast pocket which reads: "+BOOGALOO+"\n");
 set_level(22);
 set_wc_bonus(5);
 set_ac_bonus(1);
 set_chat_chance(5);
