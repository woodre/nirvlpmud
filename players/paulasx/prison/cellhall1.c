...
/* Changed from lev. 14 to 12 -Snow */
         ...
         call_other(prison_guard, "set_spell_dam",30);
            call_other(prison_guard, "add_money", 400+random(200));
   ...
   dest_dir =
   ({
       "players/paulasx/prison/cellhall3", "west",
       "players/paulasx/temple/stairway_down", "east",
       "players/paulasx/prison/cell1", "north",
          });
}
