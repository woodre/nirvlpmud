...
/* Changed from lev. 14 to 12 -Snow */
         ...
         call_other(prison_guard, "add_money", 200+50*random(8));
   ...
   dest_dir =
   ({
       "players/paulasx/prison/cellhall4", "east",
       "players/paulasx/temple/stairway_down", "west",
       "players/paulasx/prison/cell2", "north",
          });
}
