...
long(str)
{
      if(str)
      return ::long(str);
   write("In a small dirty cell.\nA heavy steel celldoor leads south. It is open\n ");
   }
...
/* Changed money from 2500 to 200 -Snow */
...
/* Changed level from 19 to 12.  -Snow */
   ...
   dest_dir =
   ({
       "/players/paulasx/prison/cellhall1", "south"
    });
}
