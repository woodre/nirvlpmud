...
reset(arg)
{
   ...
   long_desc = "You are on a long hallway on the second floor.  All that you can see to \n" +
                      ...
                      "what?  You see a strange area about 200 feet ahead.\n\n";
   set_light(1);
   dest_dir = ({ 
                   "players/paulasx/temple/hallway3", "north",
                   "players/paulasx/temple/hallway1", "south",
                   });
}
