...
/* Added by Rumplemintz - 11/24/2007 - They're evil! Make them evil! */
         call_other(evil_monk, "set_al", -250);
   ...
   long_desc = "You are in the west end of the arena.  There is an evil monk here.\n" +
   ...
   dest_dir =
   ({
       "players/paulasx/temple/temple_nw", "north",
       "players/paulasx/temple/temple_sw", "south",
       "players/paulasx/temple/temple_center", "east",
          });
}
