...
The fireling is glowing with "+RED+"F L A M E"+NORM+" and it's scales \n\
are "+RED+"red"+NORM+" and "+HIY+"gold"+NORM+".\n");
    set_level(random(3)+3);
    set_info("This "+RED+"fireling"+NORM+" is called by higher powers to aid in it's bidding.\n");
...
monster_died(){
    ...
    scale->set_long("\
  This little "+RED+"red "+HIW+"scale"+NORM+" is the only thing between a "+RED+"fireling"+NORM+" and a \n\
