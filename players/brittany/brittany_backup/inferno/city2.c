...
short_desc = RED+"DIS"+NORM;
   long_desc =
   "     You have entered the city of Gehenna, a fiery underground.\n"+
   "Arterial conduits carrying bloody mortars crisscross the cities.\n"+
   "Bricks and tissues are layered over huge frameworks.  An array\n"+
   "of different sizes buildings line the city.  A dark cloud over\n"+
   "one building draws your attention.\n";
