...
reset(arg) {
   ...
   long_desc =
   "     The awful vegetable garden continues to grow along the path.\n"+
   "The landscape looks desolate and a strange looking tree is blocking\n"+
   ...
   items = ({
         ...
         "'pick' one",
         "fluid","A substance made out of liquid, with an awful smell",
          });
