...
reset(arg) {
   ...
   "One of the gourds have an extra dimplelike hole on its upper\n"+
...
return 1; }
  ...
  write("The sign reads...\n\n"+
   "  The land of Xanath is a peninsula, which moves around the face\n"+
   "of the Earth.  Xanath is unusual in many ways, the most important\n"+
   "being that it is rich in magic.  Species exist here that have\n"+
   "never been glimpsed or dreamed.  Xanath is a land for the smaller\n"+
