...
reset(arg) {   
   if(!present("caine", this_object())) {
    for(i=0; i < 3; i++) {
      move_object(clone_object("/players/brittany/amber/caine.c"),
      this_object());
    }
  }
   ...
   short_desc = BLU+"Fourth Veil"+NORM;
   long_desc =
   "	You land onto the Fourth Veil.  A familiar pink sand\n"+
   ...
   dest_dir = ({
         "players/brittany/amber/veil5.c","out",
