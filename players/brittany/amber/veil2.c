...
reset(arg) {   
   if(!present("julian", this_object())) {
    for(i=0; i < 3; i++) {
      move_object(clone_object("/players/brittany/amber/julian.c"),
      this_object());
    }
  }
   ...
   short_desc = BLU+"Second Veil"+NORM;
   long_desc =
   "	You come up to the Second Veil.  A familiar pink sand\n"+
   ...
   dest_dir = ({
         "players/brittany/amber/veil3.c","out",
...
out(str){
  tp->move_player("out#/players/brittany/amber/veil3.c");
  return 1; }   
