...
short() {
  return "A Hockey Stick";
}

long() {
  if (this_player()->query_level()<wizard_level) {
  write("This is the Gary's Martini Glass.\n");
...
write("You should really drop this item before it destroys you!\n");
  ...
  write("Gary's Martini Glass.\n");
  write("To get a list of commands type: help_glass.\n");
}
  query_auto_load() { return ("players/hawkeye/closed/gary.c:");}
...
rsummon(str) {
 ...
 say(capitalize(str) + " is summoned to the room by Gary.\n");
...
tell(str) {
 ...
 tell_object(obj, "Someone tells you: "+msg+"\n");
  ...
  tell_object(obj, "Gary tells you: "+msg+"\n");
  write("You tell "+capitalize(who)+": "+msg+"\n");
  return 1;
}
