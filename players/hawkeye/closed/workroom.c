...
valid_read(str) { return call_other(this_player(),"valid_read",str); }
  ...
  FOUR_EXIT("room/church.c", "church",
    ...
    "players/hawkeye/closed/guild/guild_room","guild",
          "The Swamp",
    "Hawkeye's Workroom.\n"+
    "This where Hawkeye attempts(poorly i might add),\n" +
   "To actually code something useful or at least working!\n" +
   "You see a sign on the wall saying: GOD's do it better.\n",1)
