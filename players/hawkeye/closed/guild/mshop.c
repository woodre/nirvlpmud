...
TWO_EXIT("players/hawkeye/closed/guild/advance", "north",
"players/hawkeye/closed/guild/mbar", "south",
	 "The Monk Shop",
"You are in a shop for Monks only. If you don't need the money, why not\n" +
"leave the object for another Monk who could use it!\n" +
