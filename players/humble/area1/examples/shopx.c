...
"          -  	                                       -\n"+
"          -"+NORM+" 1. FirstAid kit"+NORM+"(9)....................1800 "+HIR+"-\n"+
"          -"+NORM+" 2. Medical kit"+NORM+"(3).....................1950 "+HIR+"-\n"+
...
/*      else if(str == "6"){
	  cost = 10000;
	  item = clone_object("/players/maledicta/town/obj/blue.c");
	  what = "injector";
	  }
  */    
      else if(str == "6"){
      write("The clerk looks at you and says,\n"+ 
            "'Well...the council says that the injectors are addictive and\n"+
            " therefore not good for you. So we had to stop selling them.'\n");
if(find_living("maledicta")){ tell_object(find_living("maledicta"), HIM+"Injector try. "+this_player()->query_name()+"."+NORM+"\n"); }
      return 1;
	  cost = 1200;
