...
dest_dir = ( {
"players/pathfinder/detroit/rooms/newbie4", "south",
"players/pathfinder/detroit/rooms/entrance", "east",
"players/pathfinder/detroit/rooms/newbie2", "west",
});
items = ({
...
/*
  if(this_player()->query_level() > 5) {
    write("You are too experienced to go in there!.\n");
    move_object(this_player(),"players/pathfinder/detroit/rooms/entrance");
 }
*/
}
