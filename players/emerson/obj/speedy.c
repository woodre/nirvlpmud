...
bpatt=allocate(10);
if(this_player())
restore_object("players/hurtbrain/obj/spedir/"+lower_case(this_player()->query_name()));
}
...
save_object("players/hurtbrain/obj/spedir/"+lower_case(this_player()->query_name()));
	return 1;
}
