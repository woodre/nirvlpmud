...
set_long("A Pizza Hut vending machine.\n"+
  "You can 'buy' the following items currently:\n"+
  "  Large pizza....................2400 coins\n"+
  "  2 litre Pepsi..................1500 coins\n"+
  "  x-lax pills.....................2400 coins\n");
set_name("machine");
...
buy(str) {
    object xlax,pizza,pepsi;
	if(str=="pizza") {
	if(this_player()->query_money() < 2400) {
	...
	return 1;
     ...
     write("You can't carry that much!\n");
      ...
      this_player()->add_money(-2400);
xlax=clone_object("/players/emerson/heal/x-lax.c");
     move_object(xlax, this_player());
     write("You put your coins in the machine and get a box of xlax.\n");
      say(capitalize(this_player()->query_real_name())+" buys some xlax from the machine.\n");
     return 1;
     }
}
get() { return 0; }
