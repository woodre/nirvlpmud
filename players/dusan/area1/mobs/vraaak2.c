...
set_long(
  ...
  "scales. Its four legs in in six inch long claws, and it looks\n"+
  "at you with small blood red eyes. \n" );
...
monster_died() {
 object skin;
 skin = clone_object("/players/dusan/area1/armors/vskin.c");
 move_object(skin,present("corpse",environment()));
