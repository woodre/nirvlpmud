...
"recklessly all around you.  This is Chigago traffic\n"+
"at it's worst.  You can see a traffic light in front of\n"+
"you.  The Neon sign to the west is impossible to ignore.\n";
items = ({
...
dest_dir = ({
"/players/jenny/bundy/rooms/3e","west",
 "/players/jenny/bundy/rooms/5e","east",
});
}
init() { 
    ::init(); 
