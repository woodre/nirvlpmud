...
realm() { return "NT"; }
reset(arg) {
if(!present("don cherry") && !present("ron maclean"))  {
MOCO("/players/jenny/wings/mobs/other/maclean.c"),TO); 
MOCO("/players/jenny/wings/mobs/other/cherry.c"),TO); }
    if(arg) return;
    set_light(1);
...
dest_dir = ({
"/players/jenny/wings/rooms/hnic","south",
});
}
short() {
