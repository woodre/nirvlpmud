...
MOCO("/players/jenny/wings/mobs/other/mfan.c"),TO); }}
    ...
    set_light(1);
     ...
     set_smell(BOLD+"You can smell food to the south."+NORM+"\n");
long_desc=
...
"endless amount of concession stands.\n";
...
dest_dir = ({
 "/players/jenny/wings/rooms/c7","south",
"/players/jenny/wings/rooms/c1","east",
});
}
short() {
