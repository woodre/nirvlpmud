...
"to provide access to the various media booths.  An out of town\n"+
"television booth is to the east.\n";
...
dest_dir = ({
"/players/jenny/wings/rooms/2h6","south",
"/players/jenny/wings/rooms/hnic","east",
"/players/jenny/wings/rooms/2h8","northeast",
});
}
short() {
