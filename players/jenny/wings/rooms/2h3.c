...
"to provide access to the various media booths.  A camera booth\n"+
"is to the west.\n";
...
dest_dir = ({
"/players/jenny/wings/rooms/2h2","north",
"/players/jenny/wings/rooms/wingscamera","west",
 "/players/jenny/wings/rooms/2h4","southwest",
});
}
short() {
