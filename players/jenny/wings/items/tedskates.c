...
id(str) { return (::id(str) || str == "Hockey Skates" || str == "hockey skates" || str == "skates" || str == "ice skates"); }
reset(arg) {
   ::reset(arg);
   ...
   set_long(
      "This is a pair of hockey skates belonging to Ted Lindsay.  They are black\n"+
     "with a metal blade on the bottom.  These skates may be old, but they served\n"+
     "Ted very well throughout his Hall of Fame career.\n"+
...
{
   if(!ATT) return;
   if(random(200) < USER->query_attrib("ste")) {
     if(ATT->is_npc()) 
