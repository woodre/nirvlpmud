...
id(str) { return ::id(str) ||  str == "championship ring" || str == "stanley cup championship ring" || str == "stanley cup ring" || str == "jennyring1998"; } 
reset(arg) {
   ::reset(arg);
   if(arg) return;
   set_name("ring");
   ...
   set_long(
      "This is a championship ring from the 1998 season.  These beautiful gold rings,\n"+
      "with the diamonds in the shape of a Red Wings logo, were given to each member\n"+
      "of the 1998 Stanley Cup Champion Detroit Red Wings.  Type "+RED+"ring_usage"+NORM+"\n"+
...
write(
        "\n"+
         "This ring may be worn, pawned, cashed, or even combined with the 1997\n"+
...
rings(arg) {
object otherring;
otherring = present("jennyring1997",ENVTO);
