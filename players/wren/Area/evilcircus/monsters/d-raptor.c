...
set_spell_mess2("D-raptor's claw slips through your defenses and pierces your side. \n");    /*attacker*/
 set_aggressive(0); /* til keeper tells us otherwise */
    }
}
...
/*
  if(!present("keeper_mob")) set_aggressive(1);
  stuff
*/
...
status is_aggro_dood() { return 1; }  /* simple mon flag */

void do_aggro(object meat)
{
 tell_object(meat,
query_name()+" ROARS!\n");
 attack_object(meat);
