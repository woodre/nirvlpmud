...
"Big Top 5  \n\
   ...
   \n";
      ...
      dest_dir = ({
          "/players/wren/Area/evilcircus/rooms/bigtop2.c","north",
          "/players/wren/Area/evilcircus/rooms/bigtop3.c","northwest",
          "/players/wren/Area/evilcircus/rooms/bigtop4.c","west",
                 }); 
