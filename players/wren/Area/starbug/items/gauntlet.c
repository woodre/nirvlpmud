...
set_name("gauntlet");
set_alias("glove");
set_short("Time gauntlet");
set_long("The Time Gauntlet of the Inquisitor. This simulant is said to have \n"+
         "survived to the end of time. He concluded that there was no god or \n"+
         "afterlife. He built this time-gauntlet and now goes through history\n"+
         "removing those that did little with their lives and replacing them \n"+
         "with those that never got a chance. A potentially useful device if \n"+
...
switch(W) {
    ...
    case 3:
       say(this_player()->query_name()+" demands you" +HIK+" Justify Your Existence" +NORM+".\n");
