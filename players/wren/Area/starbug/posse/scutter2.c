...
object ob;
    ...
    ob = clone_object("/players/wren/Area/starbug/items/indianheaddress.c");
         move_object(ob,this_object());

    
set_name("scutter2");
set_alt_name("scutter");

set_alias("tom");

set_short("Scutter wearing an indian headdress.");

set_race("robot");

set_long("This is 'Tom' the scutter. He's one of the most useful little robots	\n"+
