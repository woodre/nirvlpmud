...
set_alias(str) { return str == "megalith"; }
...
enter(str) {
	...
	return 0;
      ...
      this_player()->move_player("/players/wren/Area/entrance.c");
      tell_room(environment(this_player()->query_name()),"A flash obscures "+this_player()->query_name()+" and they are gone.\n");
