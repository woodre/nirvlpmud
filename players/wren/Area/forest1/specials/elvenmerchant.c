...
#define ARM_PATH "/players/wren/Area/forest/items/"
#define WEP_PATH "/players/wren/Area/forest/items/"
...
short() {
  return "An elven merchant";
}

long() {
  write(
    "An elven merchant carrying his wares in large leather packs.\n"+
...
cmd_menu() {
  write("The merchant sells the following:\n\n"+
...
cmd_buy(str) {
  ...
  if (!str) {
    write("The merchant asks: What do you want to buy?\n");
    return 1;
  }
  ...
  switch(str) {
    ...
    case "lamp":
      ...
      break;
    default:
      write("The merchant says: I don't sell that.\n");
      return 1;
      break;
  }
