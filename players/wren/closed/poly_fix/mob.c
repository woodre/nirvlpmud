...
id(str)
{
   if(block_magic_tl) return str == "sphere" || str == MORPH_ID || str == "no_spell";
   if(block_armor_tl) return str == "sphere" || str == MORPH_ID || str == "notarmor";
   else return str == "sphere" || str == MORPH_ID;
}
