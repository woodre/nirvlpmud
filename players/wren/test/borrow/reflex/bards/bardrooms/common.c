...
void create() {
  ...
  move_object(
    clone_object("/players/reflex/guilds/bards/boards/bard_news.c"),
  this_object()); }

	::create();
  set_short(HIM+"Uncommonly Common"+NORM);
  set_long(HIM+
  ...
  set_exits(([
    "west" : "/players/reflex/guilds/bards/bardrooms/lore",
    "east" : "/players/reflex/guilds/bards/bardrooms/charity",
    "north" : "/players/reflex/guilds/bards/bardrooms/teleport",
    "south" : "/players/reflex/guilds/bards/bardrooms/enterance",
    "up" : "/players/reflex/guilds/bards/bardrooms/alliance",
    ]));
  set_light(1);
