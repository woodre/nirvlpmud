...
void create() {
  ...
  move_object(
    clone_object("/players/reflex/guilds/bards/boards/storyboard.c"),
  this_object()); }

	::create();
  set_short(HIM+"A Lonely Place of Writing"+NORM);
  set_long(HIM+
  ...
  set_exits(([
    "east" : "/players/reflex/guilds/bards/bardrooms/songs",
    ]));
  set_light(1);
