...
void create() {
  ...
  set_short(HIM+"Where do you want to go today?"+NORM);
  set_long(HIM+
  ...
  set_exits(([
    "north" : "/players/reflex/guilds/bards/bardrooms/songs",
    "south" : "/players/reflex/guilds/bards/bardrooms/common",
    "west" : "/players/reflex/guilds/bards/bardrooms/advance",
    "east" : "/players/reflex/guilds/bards/bardrooms/gcroom",
