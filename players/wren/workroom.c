 ...
 * and the starting workroom.  Aerie or Lair  */
...
dest_dir = ({
	"room/adv_inner.c","up",
	"players/wren/Area/entrance.c","east",
        "players/wren/spareroom.c","south",	
});
...
shakespeare(str)  { 
     if(!str) {
        ...
        write("rift,fetch,cloak,gaze,scry,lock,on,off,church,post. \n");
        return 1;
              }
}
