...
#define ATTRIBS_PER_LEVEL 7         /*changed from 5 by Wren 07-03-03 */
...
/* Customize points have been allocated before joining to fix raise bug - Wren 07-07-03 */   
  
   if(tp->query_total_stats() < TOTAL_FREE_ATTRIB) 
   {
      write("Spuck glorps: You have free customize stat points left. Please spend before joining.\n");     
      return 1;
   }
...
/* Wren adding string and int for the new Illarion code */
  ...
  int totalattrib,totallevel,maxachived,totalmax;
...
/*------ Addition from adv_guild 07-05-03  ------Wren */
 ...
 *     added more code to this 07-05-03 I really hate fixing this --Wren
*/
  ...
  totallevel=this_player()->query_level()+this_player()->query_extra_level();
      ...
      /* Max 7 raises per level - from 5 Wren 07-03-03*/
      ...
      /* Matched proceeding to current adv_guild 07-05-03 --Wren  */
