...
\"Do not offend me. That is an enemy.\"\n");
   ...
   write("Ally is temporarily offline.\n");
   return 1;

   /*Taken offline because Rek added someone to allies to find out where he was so that he could attack them and
   Reflex caught him.  Ally should be changed so that allies have to accept the alliance.  I didn't have time to do
   it so I took it offline for now.  I will fix asap. - Laera*/
