...
that rests deep within the grotto of Shardak.\n");
      ...
      write("\
A tin flask of Nitropyr, an acidic liquid used to expediate\n\
the burning in demonic fires.  Nitropyr is actually\n\
extracted demon's blood.\n");
    else if(type == 3)
      write("\
A piece of blood-red chalk, used for writing ages-old\n\
...
{
    if(type == 1)
      return BOLD + BLK + "a piece of obsidian" + NORM;
    if(type == 2)
      return "A flask of Nitropyr";
    if(type == 3)
