...
get_next_exp (int level)
{
    switch (level)
    {
	  case 1: return 0;
        case 2: return 98384;
        case 3: return 228568*2;
        case 4: return 640000*2;
        case 5: return 1376345*2;
        case 6: return 2554280*2;
        case 7: return 4345672*2;
        case 8: return 6456782*2;
    }
}
...
get_next_title (int level)
{
    switch (level) {
        ...
        case 8: return "the " + HIK + "GateKeeper of the UnderWorld" + NORM;
...
get_next_class_title (int level)
{
  switch (level) {
       ...
       case C_LAW: return "the "+RED+"Law Enforcer of Shardak"+NORM;
