...
emote()
{
   ...
   {
      case 0:
/* corrected following, was mucking up horse hb 2004.02.23 Forbin
      tm = cap_name+" stomps on the ground with one hoof.\n";
*/      
      mm = cap_name+" stomps on the ground with one hoof.\n";
      break;
      case 1:
...
listbag()
{
   ...
   if(!b) { write("Your horse doesn't have a bag (!)\n"); return 1; }
   inv = all_inventory(b);
