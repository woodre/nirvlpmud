...
add_bin() {
  add_action("m_help","mhelp");
  add_action("m_show","mshow");
  add_action("m_rules","mrules");
  add_action("m_mwho","mwho");
  add_action("m_list","mlist");
  add_action("m_mshout","mshout");
  add_action("m_mgive","mgive");
  add_action("m_return","mreturn");
  add_action("m_inventory","minventory");
  add_action("m_buy","mbuy");
  add_action("m_build","mbuild");
  add_action("m_sell","mremove");
  add_action("m_sell","msell");
  add_action("m_mortgage","mortgage");
  add_action("m_unmortgage","unmortgage");
  add_action("m_roll","mroll");
  add_action("m_use","muse");
  add_action("m_look","l");
  add_action("m_look","look");
  add_action("m_exit","exit");
}


reset(x) { if(x) return; houses=({}); }
