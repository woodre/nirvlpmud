...
void extra_look()
{
  ...
  {
    write("You have the "+HIC+"Blessing"+NORM+" of "+HIR+"Vulcan"+NORM+", the smith god.\n");
  }
  else
  {
...
{
  return "/players/vertebraker/prizes/fil:0";
}

status id(string str)
{
  return (str=="fil_prize");
}

void init()
{
  if(environment() && (string)environment()->query_real_name() != "fil")
