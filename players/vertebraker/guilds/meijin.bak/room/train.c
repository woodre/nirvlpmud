...
reset(arg) {
  ...
  dest_dir=({
    "/players/pavlik/guild/room/train_stats", "north",
    "/players/pavlik/guild/room/train_skills", "south",
    "/players/pavlik/guild/room/lowerhall", "east",
    "/players/pavlik/guild/room/practice", "west",
  });
