...
/* are located in: /players/vertebraker/guilds/meijin/npc/tsukeru.c          */
/****************************************************************/
...
reset(arg) {
  ...
  dest_dir=({
    "/players/vertebraker/guilds/meijin/room/village1", "out",
  });
...
out() {
  ...
  this_player()->move_player("out#players/vertebraker/guilds/meijin/room/village1");
  return 1;
}
