...
reset(arg) {
  ...
  dest_dir=({
    "/players/vertebraker/guilds/meijin/room/dine", "east",
    "/players/vertebraker/guilds/meijin/room/quarters", "west",
    "/players/vertebraker/guilds/meijin/room/lowerhall", "down",
  });
