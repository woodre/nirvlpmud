...
#undef SKILLS
#endif
#define SKILLS ({"rsc","ri","ranger","skills","ansi","generate"})

/* Ranger Types */
#ifdef TYPES
#undef TYPES
#endif
#define TYPES ({"Dino","Thunder","Ninja","Zeo","Turbo","Rescue","Space","Galaxy","Time Force","Wild Force","Ninja Storm","Dino Thunder","S.P.D.","Mystic Force",})
