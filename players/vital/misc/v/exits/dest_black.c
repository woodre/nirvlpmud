 ...
 *  File:         dest_black.c
 *
 *  Function:     move a player to Saber's Portal from guild hall
 *
 *  Author(s):    Vital
 *
...
main()
{
  if (TP && PFANGS)
  {
    PFANGS->tell_my_room(capitalize((string)TPN) + "extends " + TPPOS +
      "wings and flies off to the Black Portal.\n");
    write("You extend your wings and fly off to the Black Portal.\n");
    TP->move_player("into the mist#players/saber/ryllian/portal.c");
    return 1;
  }
  return 0;
}
