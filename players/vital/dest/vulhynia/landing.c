...
is concrete and asphalt and covered in cracks, crevises and pits. There \n\
is some kind of wall or superstructure to keep the potential for damage \n\
low. The ticket building is located to the north.\n";
...
items = ({
    ...
    "The crevises are the results of water falling as rain, freezing and expanding in cracks, pushing them farther apart",
    "north",
    "You turn to look north and see a smaller, building with a large flag",
    "structure",
    "You turn to look north and see a smaller, building with a large flag",
    "building",
    "You turn to look north and see a smaller, building with a large flag",
