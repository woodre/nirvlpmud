...
short_desc = "The Finnmark Landing Pad";
long_desc =
  "  "+short_desc+".\n\
...
items = ({
    ...
    "The crevises are the results of water falling as rain, freezing and expanding in cracks, pushing them farther apart",
    "south",
    "You turn to look south and see a smaller, building with a large flag",
    "structure",
    "You turn to look south and see a smaller, building with a large flag",
    "building",
    "You turn to look south and see a smaller, building with a large flag",
    "wall",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the south",
    "walls",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the south",
    "east",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the south",
