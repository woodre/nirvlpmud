...
long_desc =
  "  "+short_desc+".\n\
This is a much smaller version of the N.U.T.S. Spaceport. The landing \n\
pad is similar to all the other landing pads encountered in the \n\
travel between the stars. The ground is concrete and asphalt and \n\
covered in cracks, crevises and pits. There is some kind of wall or \n\
superstructure to keep the potential for damage low. The ticket \n\
building is located to the southeast.\n";
...
items = ({
    ...
    "The crevises are the results of water falling as rain, freezing and expanding in cracks, pushing them farther apart",
    "southeast",
    "You turn to look southeast and see a smaller, building with a large flag",
    "structure",
    "You turn to look southeast and see a smaller, building with a large flag",
    "building",
    "You turn to look southeast and see a smaller, building with a large flag",
    "wall",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the southeast",
    "walls",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the southeast",
    "east",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the southeast",
