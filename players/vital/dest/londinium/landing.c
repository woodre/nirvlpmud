...
short_desc = "The Londinium Landing Pad";
long_desc =
  "  "+short_desc+".\n\
...
building is located to the northwest.\n";
...
items = ({
    ...
    "The crevises are the results of water falling as rain, freezing and expanding in cracks, pushing them farther apart",
    "northwest",
    "You turn to look northwest and see a smaller, building with a large flag",
    "structure",
    "You turn to look northwest and see a smaller, building with a large flag",
    "building",
    "You turn to look northwest and see a smaller, building with a large flag",
    "wall",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the northwest",
    "walls",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the northwest",
    "east",
    "The four meter high wall circles the landing pad in every direction, except for the structure to the northwest",
