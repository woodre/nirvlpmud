...
The fence around the massive structure to the southwest continues \n\
...
items = ({
    ...
    "northwest",
    "To the northwest you can see that the sidewalk curves on around the structure",
    "south",
...
dest_dir = ({
    ACADIE+"room/sidewalk6.c","northwest",
    ACADIE+"room/sidewalk10.c","south"
  });
