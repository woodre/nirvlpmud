...
reset(arg) {
    ...
    long_desc =
    "  A Dark Alleyway\n\
This is a slight, open space between the walls of two buildings. The space overhead has been covered and blocks out any view of the sky. The people of this town have used this alley as a place to throw their trash and worthless junk. There are old piles of junk and trash cans overflowing with refuse and rubish.\n ";
...
items = ({
    ...
    "overhead",
    "The sky is blocked out by some material placed across the gap between the two buildings",
    "sky",
    "The light "+CYN+"blue"+NORM+" sky is hidden from view",
    "people",
    "The stalwart inhabitants of this cold, forboding place don't often come here",
    "alley",
    ...
    "trash",
    "The offcast, material possessions and the packing materials that they came in lay scattered and piled here",
    "junk",
    "The stuff that no one wants has been thrown into this alley",
    "piles",
    "The trash and junk has formed into rough collections that must be navigated around",
    "cans",
    "The trash cans here are overflowing and something will have to be done soon",
    "refuse",
...
move_south() {
    if(!present("vermina",TO) && !present("verminb",TO)) {
      ...
      this_player()->move_player("stumbling out of the darkness#/players/vital/dest/acadie/room/alley8.c");
	return 1;
    }
    write("You can't get past the vermin running around in front of you.\n");
    return 1;
