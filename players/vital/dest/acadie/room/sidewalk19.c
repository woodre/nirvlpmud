...
reset(arg) {
    ...
    long_desc =
    "  The Sidewalk\n\
The concrete sidewalk heads away from the structure to the east \n\
and toward the western edge of town. The low, stone buildings \n\
are crowding the sidewalk here but directly south of this area is an \n\
openings in between. The light blue sky has strands of white clouds \n\
strung across it like ribbons. In the west you can see the horizon \n\
briefly.\n";

items = ({
    "sidewalk",
    "The cold, "+BOLD+BLK+"grey"+NORM+", stone conglomeration provides an easy \n\
surface to travel upon. It travels off to the east and west",
    "structure",
...
looks like the next one from the outside",
    "edge",
    "The lines of buildings eventually come to an end to the west",
    "town",
...
dest_dir = ({
    ACADIE+"room/sidewalk17.c","east",
    ACADIE+"room/sidewalk21.c","west"
  });
...
move_south() {
    ...
    this_player()->move_player("stumbling into darkness#/players/vital/dest/acadie/room/alley13.c");
	return 1;
}
