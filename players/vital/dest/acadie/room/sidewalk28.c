...
reset(arg) {
    ...
    long_desc =
    "  The Sidewalk\n\
The cold, concrete sidewalk has reached the farthest northeast corner \n\
of town and becomes a dead-end. To the far northwest you can faintly \n\
see the shuttles ascending and descending at the landing pad. The \n\
...
dest_dir = ({
    ACADIE+"room/sidewalk24.c","south"
});
...
init() {
    ...
    add_action("move_southwest","southwest");
}
...
move_southwest() {
      ...
      this_player()->move_player("stumbling into the darkness#/players/vital/dest/acadie/room/alley16.c");
	return 1;
}
