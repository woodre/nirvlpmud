...
move_south() {
    ...
    if(!present("vermina") && !present("verminb")) {
      write("You stumble blindly into the dark alley.\n");
      this_player()->move_player("stumbling into darkness#/players/vital/dest/acadie/room/sidewalk20.c");
	return 1;
    }
...
move_northeast() {
    ...
    if(!present("vermina") && !present("verminb")) {
      write("You stumble blindly into the dark alley.\n");
      this_player()->move_player("stumbling into darkness#/players/vital/dest/acadie/room/sidewalk28.c");
	return 1;
    }
    write("You can't get past the vermin running around in front of you.\n");
    return 1;
