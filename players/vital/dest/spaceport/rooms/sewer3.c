...
to the north, west and east. The floor curves up to become \n\
the walls which in turn curve on up to become the ceiling. \n\
The darkness could hide anything down here.\n ";
...
dest_dir = ({
    SPROOM+"sewer2.c","west",
    SPROOM+"sewer4a.c","north",
    SPROOM+"sewer4b.c","east"
  });
...
add_monster() {
    object ob;
    if(!present("stupid_monster",this_object())) {
