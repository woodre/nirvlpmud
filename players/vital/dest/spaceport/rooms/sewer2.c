...
to the east. The floor curves up to become the walls which \n\
in turn curve on up to become the ceiling. The darkness could \n\
...
dest_dir = ({
    SPROOM+"sewer1.c","southwest",
    SPROOM+"sewer3.c","east"
  });
