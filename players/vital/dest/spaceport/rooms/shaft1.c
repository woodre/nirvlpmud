...
reset(arg) {
    ...
    long_desc =
    "  A Maintenance Shaft\n\
This long shaft decends into the darkness below the N.U.T.S. \n\
There are recesses here for lights, but this area was long ago \n\
forgotten and powered down. The ladder here is damp and rusty, \n\
and it is easy to tell that the area has not seen much use in \n\
recent history.\n ";
...
move_up() {
    TP->move_player("up the ladder#"+SPROOM+"backroom.c");
	return 1;
}

move_down() {
    TP->move_player("into the darkness#"+SPROOM+"shaft2.c");
	return 1;
}
