...
to the north and west. The floor curves up to become the walls \n\
which in turn curve on up to become the ceiling. The darkness \n\
...
dest_dir = ({
    SPROOM+"sewer4a.c","west",
    SPROOM+"sewer4b.c","south",
    SPROOM+"dryroom.c","up"
  });
