...
#include "/players/vital/dest/spaceport/shuttles/dest_path.h"
...
reset(arg) {
    ...
    dest_path = ([]);               /*initialize destination mapping*/
    set_dest_path();                /*set up destination locations*/
...
make_shuttle() {
    ...
    shuttle = CO("/players/vital/dest/spaceport/shuttles/css.c");
...
liftoff_timer() {
    ...
    if(!find_object("/players/vital/dest/spaceport/shuttles/css.c")) return 0;
...
shuttle_landing(shuttle) {
    ...
    dest_desc = explode(read_file("/players/vital/dest/spaceport/shuttles/shuttle_dest",20),"#");
