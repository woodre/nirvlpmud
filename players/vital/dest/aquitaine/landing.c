...
building is located to the northeast.\n";
  ...
  items = ({
    ...
    "The crevises are the results of water falling as rain, freezing and expanding in cracks, pushing them farther apart",
    "northeast",
    "You turn to look northeast and see a smaller, building with a large flag",
    "structure",
    "You turn to look northeast and see a smaller, building with a large flag",
    "building",
    "You turn to look northeast and see a smaller, building with a large flag",
...
dest_dir = ({
    "/players/vital/dest/aquitaine/room/landingoffice.c","northeast"
});
