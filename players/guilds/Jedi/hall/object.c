...
#endif
  /** Call the restore function in the guild obj **/
  return (int) call_other( this_object(), "restore_stats" );
...
#endif
  /** Call the save function in the guild obj **/
  call_other( this_object(), "save_stats" );
}
