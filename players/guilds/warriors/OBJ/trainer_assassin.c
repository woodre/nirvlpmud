...
#define DOC_DIR "/players/guilds/warriors/doc/assassin/"
#include <ansi.h>
...
join(){
  ...
  GOB->add_skill_pts(-1);
  GOB->set_assassin(1);
write_file("/players/guilds/warriors/logs/ASSASSIN",
...
/* Prereqs */
    ...
    if(USER->query_attrib("int") < 30){
       write("You must have an intelligence of 30.\n");
       return 1;
       }
    ...
    if(USER->query_attrib("ste") < 30){
       write("You need a stealth of at least 30.\n");
       return 1;
       }
    if(GOB->query_xste() > 8){
