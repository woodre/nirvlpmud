#include "../define.h"
#define DOCS "/players/guilds/warriors/library/"
...
read(str){
  ...
  WRITEIT;
  cat("/players/guilds/warriors/doc/advancement.warrior");
  return 1;
  }
  else if(str == "skills"){
  WRITEIT;
  cat("/players/guilds/warriors/doc/skills.warrior");
  return 1;
  }
  else if(str == "rules"){
  WRITEIT;
  cat("/players/guilds/warriors/doc/rules.warrior");
  return 1;
  }
  else if(str == "miscellaneous"){
  WRITEIT;
  cat("/players/guilds/warriors/doc/miscellaneous.warrior");
  return 1;
  }
  else if(str == "offensive"){
  WRITEIT;
  cat("/players/guilds/warriors/doc/offensive.warrior");
  return 1;
  }
  else if(str == "defensive"){
  WRITEIT;
  cat("/players/guilds/warriors/doc/defensive.warrior");
  return 1;
  }
  else if(str == "weapons"){ 
  WRITEIT;
  cat("/players/guilds/warriors/doc/weapons.warrior");
  return 1;
  }
  else if(str == "join"){ 
  WRITEIT;
