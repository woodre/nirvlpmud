...
if(!present("warrior_smith")){
	owner = clone_object("/players/guilds/warriors/mobs/smith.c");
 ...
 if(!present("warrior_smith", this_object())){
	...
	if(purchase == "1"){
     ...
     item->set_weight(1);
	  ...
	  cost = 400;
	  item = clone_object("/players/guilds/warriors/items/belt.c");
     item->set_ammo(40); 
     }
   else if(purchase == "3"){
	  cost = 25;
	  item = clone_object("/players/guilds/warriors/items/tdagger.c"); 
     }
	else if(purchase == "4"){
	  cost = 125;
     item = clone_object("/players/guilds/warriors/items/shield.c");
	  }
	else if(purchase == "5"){ 
        cost = 100;
        item = clone_object("/players/guilds/warriors/items/helm.c");
	  }
	else if(purchase == "6"){
	  cost = 80;
	  item = clone_object("/players/guilds/warriors/items/sap.c");
	  }
	else if(purchase == "7"){
	  cost = 400;
        item = clone_object("/players/guilds/warriors/items/chainmail.c");	
        }
   else if(purchase == "8"){
	  cost = 550;
	  item = clone_object("/players/guilds/warriors/items/bplate.c");
	  }
  else if(purchase == "9"){
	  cost = 80;
	  item = clone_object("/players/guilds/warriors/items/first_aid_bandages.c");
	  }
  else if(purchase == "10"){
	  cost = 120;
	  item = clone_object("/players/guilds/warriors/items/first_aid_kit.c");
	  }
