...
xthrow_cmd(str){
	...
	if(skills[116]){ "/players/guilds/warriors/power/xthrow.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
riposte_cmd(str){
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[114]){ "/players/guilds/warriors/power/riposte.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
hide_cmd(str){
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[113]){ "/players/guilds/warriors/power/hide.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
backstab_cmd(str){
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[112]){ "/players/guilds/warriors/power/backstab.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}