id(str){
   if(str == "no_spell") return 1; /* verte */
	if(previous_object()){
  ...
  (environment()->query_invis() && skills[115] ? (str == "silent_move_object") : (str == "warrior_object")) ||
  (skills[70] > 1 ? (str == "dark_sight_object") : (str == "warrior_object"));
			}
			else{
				return str == "guild_object" || str == "warrior_gob" || str == "prof_guild_object" ||
				str == "no_pet" || str == "no_mini" || str == "no_spell" || str == "generic_wc_bonus" ||
  ...
  (skills[70] > 1 ? (str == "dark_sight_object") : (str == "warrior_object"));
		...
		if(offhand_name){
			return str == "guild_object" || str == "warrior_gob" || str == "prof_guild_object" ||
			str == "no_pet" || str == "no_mini" || str == "no_spell" || str == "generic_wc_bonus" ||
                        str == offhand_name || str == "guild_monitor" || str == "damage_report_object" || str == "GI" ||
(environment()->query_invis() && skills[115] ? (str == "silent_move_object") : (str == "warrior_object")) ||
(skills[70] > 1 ? (str == "dark_sight_object") : (str == "warrior_object"));
		}
		else{
			return str == "guild_object" || str == "warrior_gob" || str == "prof_guild_object" ||
			str == "no_pet" || str == "no_mini" || str == "no_spell" || str == "generic_wc_bonus" ||
         str == "guild_monitor" || str == "damage_report_object" || str == "GI" ||
(environment()->query_invis() && skills[115] ? (str == "silent_move_object") : (str == "warrior_object")) ||
  (skills[70] > 1 ? (str == "dark_sight_object") : (str == "warrior_object"));
		}
	}
...
if(riposte && ATT && offhand && USER->query_pl_k()){
	    "/players/guilds/warriors/power/riposte_damage.c"->main(this_object(), USER, damage, p);
	}
if(evil_aura){
      if(random(100) < skills[91] * 15){
		"/players/guilds/warriors/power/prot_evil.c"->main(this_object(), USER, damage, p);
      }
    }
if(good_aura){
      if(random(100) < skills[90] * 15){
		"/players/guilds/warriors/power/prot_good.c"->main(this_object(), USER, damage, p);
      }
     }
}
