...
/* Added by Rumplemintz to fix the 'first aid' instead of 'firstaid' typos 
 * Dec-01-2009
 */
        add_action("firstaid_cmd", "first");
/* Also putting in a check in cmds.h to make sure the str after 'first' is 
 * 'aid'
 */
