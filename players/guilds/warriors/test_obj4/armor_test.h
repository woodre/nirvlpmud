shield_bonus(){
	...
	if(set_light(0) > 0 || skills[70]){
		...
		if(skills[30]){
			if(skills[30] > 5){
				if(USER->query_local_weight() < 30 &&
					random(1800) < (skills[30] * 30) - USER->query_local_weight()){
					skill_tier[30] += 30;
					tell_object(USER,
				...
				else if(random(1800) < 95 - USER->query_local_weight()){
					skill_tier[30] += 30;
					tell_object(USER,
						"\n\n     "+HIW+"-   [  "+HIR+"D"+HIW+" - "+HIR+"O "+HIW+"- "+HIR+""+
                                        "D "+HIW+"- "+HIR+"G "+HIW+"- "+HIR+"E"+HIW+"  ]  -"+NORM+"\n\n");
				...
				if(random(1800) < (skills[30] * 19) - USER->query_local_weight()){
					skill_tier[30] += 30;
					tell_object(USER,
						"\n\n     "+HIW+"-   [  "+HIR+"D"+HIW+" - "+HIR+"O "+HIW+"- "+HIR+""+
                                        "D "+HIW+"- "+HIR+"G "+HIW+"- "+HIR+"E"+HIW+"  ]  -"+NORM+"\n\n");
...
if(total < 10000 && total > 5) total = 5; /* A cap to the max they can benefit */
		return total;
	}
	return 0;
}
