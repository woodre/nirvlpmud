...
xstrike_cmd(str){   
	...
	if(skills[103]){ "/players/guilds/warriors/power/xstrike.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
xbash_cmd(str){   
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[102]){ "/players/guilds/warriors/power/xbash.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
bcommand_cmd(str){   
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[104]){ "/players/guilds/warriors/power/bcommand.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
defend_cmd(str){   
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[100]){ "/players/guilds/warriors/power/defend.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
...
study_cmd(str){   
	if(set_light(0) <= 0 && !skills[70]){ write("It is too dark.\n"); return 1; }
	if(skills[101]){ "/players/guilds/warriors/power/study.c"->main(str, TO, USER);
		return 1;
	}
	else return;
}
