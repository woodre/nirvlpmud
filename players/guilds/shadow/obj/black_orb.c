...
#define LOG "/players/guilds/shadow/logs/advance"
#define UNJOIN_LOG "/players/guilds/shadow/logs/UNJOIN"
...
get_free() {
   int free;
   if(LEVEL > 19) {
write("As a Wizard, you must mail/ask Gemini to set your level.\n");
      return 1;
   }
