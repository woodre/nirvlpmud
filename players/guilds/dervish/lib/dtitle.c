...
status main(string str, object PO, object User)
{
	...
	lev = (int)User->query_level();
	
	if(lev > 19) { write("Set your own title.\n"); return 1; }
	
	lev += (int)User->query_extra_level();
	...
	case 16..17: str = "the "+BOLD+"Holder "+OFF+"of "+CYAN+"Madness"+OFF; break;
	case 18    : str = "the "+RED+"Mystic "+OFF+"of "+BOLD+RED+"Chaos"+OFF;	break;
	case 19..23: str = "the "+RED+"Whirling "+BOLD+"Master"+OFF; break;
	case 24..28: str = "the "+BOLD+CYAN+"Master "+OFF+"of"+BOLD+RED+" Winds"+OFF; break;
	case 29..33: str = "the "+BOLD+MAGENTA+"Master "+OFF+"of "+BOLD+RED+"Particles"+OFF; break;
	case 34..39: str = "the "+BOLD+RED+"Soul "+OFF+"of the "+MAGENTA+"Raging "+OFF+BOLD+RED+"Storm"+OFF; break;
