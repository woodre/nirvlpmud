...
#define FLDH "/players/guilds/fallen/fl_demon.c"
...
int n_dir(){ if(FLDH->check_demon(TP)) return 1; }
int s_dir(){ if(FLDH->check_demon(TP)) return 1; }
int e_dir(){ if(FLDH->check_demon(TP)) return 1; }
int w_dir(){ if(FLDH->check_demon(TP)) return 1; }
int nw_dir(){ if(FLDH->check_demon(TP)) return 1; }
int ne_dir(){ if(FLDH->check_demon(TP)) return 1; }
int se_dir(){ if(FLDH->check_demon(TP)) return 1; }
int sw_dir(){ if(FLDH->check_demon(TP)) return 1; }
int u_dir(){ if(FLDH->check_demon(TP)) return 1; }
int d_dir(){ if(FLDH->check_demon(TP)) return 1; }

void init(){
    room::init();
    /*  this_player()->set_fight_area(); */
    add_action("n_dirr", "north");
    add_action("ne_dirr", "northeast");
    add_action("e_dirr", "east");
    add_action("se_dirr", "southeast");
    add_action("s_dirr", "south");
    add_action("sw_dirr", "southwest");
    add_action("w_dirr", "west");
    add_action("nw_dirr", "northwest");
}
...
status ne_dirr()
{
    ...
    if(ne_dir()) return 1;
    TP->MP("northeast#/players/guilds/fallen/rooms/path.c");
    return 1; 
}
...
status e_dirr()
{
    ...
    TP->MP("east#/players/guilds/fallen/rooms/path.c");
    east += 1;
    return 1; 
}
...
status se_dirr()
{
    ...
    if(se_dir()) return 1;
    TP->MP("southeast#/players/guilds/fallen/rooms/path.c");
    return 1; 
}
...
status s_dirr()
{
    ...
    {
	TP->MP("south#/players/guilds/fallen/rooms/ghall.c");
	if(south >= 3)
	    south = 0;
    }
    else 
...
status sw_dirr()
{
    ...
    if(sw_dir()) return 1;
    TP->MP("southwest#/players/guilds/fallen/rooms/path.c");
    return 1; 
}
...
status w_dirr()
{
    ...
    if(w_dir()) return 1;
    TP->MP("west#/players/guilds/fallen/rooms/path.c");
    return 1; 
}
...
status nw_dirr()
{
    ...
    if(nw_dir()) return 1;
    TP->MP("northwest#/players/guilds/fallen/rooms/path.c");
    return 1; 
}
