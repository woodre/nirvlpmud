...
wither_spell(string str) {
  ...
  if((int)GOB->query_guild_exp() < 1000000)
    bonus = 4;
  else if((int)GOB->query_guild_exp() < 2000000)
    bonus = 3;
  else if((int)GOB->query_guild_exp() < 4000000)
    bonus = 2;
  else if((int)GOB->query_guild_exp() < 6000000)
    bonus = 1;
  else
    bonus = 0; 
  if(!corpse2) 
