...
static int num;
string *Skills;
#include "/players/guilds/fallen/power/misc_funcs.h"  /* needs to be after Skills */
...
focus(){
  ...
  if(this_player()->query_ghost()) return 0;
    ...
    if(PO && PO->light_check()) return 1;
    if(User && environment(User) && environment(User)->realm() == "NM") {
...
/*
   Removed - Rumplemintz - was not falling through correctly
