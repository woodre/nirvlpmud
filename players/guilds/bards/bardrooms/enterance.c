...
reset(int arg){
if(!present("guard"))  {
move_object(clone_object("/players/guilds/bards/bardguard.c"),this_object());  }
 if(!arg){
  set_light(1);
short_desc=HIM+"Bard Guild Entrance"+NORM;
long_desc=
...
items=({
 ...
 "stairs","The stairs run up to some sort of door and down to Orin's Inn",
  ...
  dest_dir=({
 "/players/guilds/bards/bardrooms/common.c","north",
 "/players/guilds/bards/bardrooms/lounge.c","south",
 "/players/guilds/bards/bardrooms/object.c","west",
 "/players/guilds/bards/bardrooms/alliance.c","up",
 "/players/guilds/bards/orin/orin2.c","down",
           });
  }   }
