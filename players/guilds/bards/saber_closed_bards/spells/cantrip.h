...
if(spell(-50,1,3,this_object()) == -1)  return 0;
  move_object(clone_object("/players/saber/closed/bards/bauble.c"),this_player());
...
if(spell(-100,3,10,this_object()) == -1)  return 0;
  move_object(clone_object("/players/saber/closed/bards/bubble.c"),this_player());
...
move_object(clone_object("/players/saber/closed/bards/strand.c"),TP);
