...
bard_news()  {
write(HIM+
  "I will be starting soon on the 2nd edition of the bardic guild.\n"+
  "If you have any ideas for it - things you like, don't like, or \n"+
  "want to see changed or expanded, please emial me on it, or mud\n"+
  "mail me.  My email is saber@electriciti.com  -  feel free to use it...\n"+
 "                                       -- Saber\n\n"+NORM);
 write(HIB+
   "Ask me for stories about this new dark coven...\n"+
   "                                       -- Star\n\n"+NORM);
  return 0;
        }
