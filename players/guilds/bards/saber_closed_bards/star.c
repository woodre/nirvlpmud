...
if (!arg){
     ...
     set_long(
       ...
       "cute.  To hear her story, <ask 1-5>.\n");
     set_level(19);
     set_ac(30);
     set_wc(10);
     set_hp(475);
...
number = (TP->query_attrib("int")) + (TP->query_attrib("mag")) + (TP->query_attrib("pie")) + (TP->query_attrib("wil"));

if(temp == number)   { advance(); }
...
new_give(str)  {
object OB, ORB;
  if(str == "orb to star" || str == "ebony orb to star" || str == "orb to girl" || str == "ebony orb to girl")  {
