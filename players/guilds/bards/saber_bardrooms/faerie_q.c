...
reset(int arg){
if(!present("faerie"))  {
move_object(clone_object("/players/saber/closed/bards/f_mark.c"),this_object());  }
  count = 0;
  count2 = 0;
  count3 = 0;
 if(!arg){
...
items=({
 "trees","You are too enchanted by the faerie court to look at trees",
 "boulders","You are too enchanted by the faerie court to look at boulders",
 "crystal","You are too enchanted by the faerie court to look at",
 "towers","You are too enchanted by the faerie court to look at towers",
 "sun","You are too enchanted by the faerie court to look at the sun",
 "castle","You are too enchanted by the faerie court to look at the castle",
 "gateway","You are too enchanted by the faerie court to look at the gateway",
 "dream","You are in a dream",
 "tree","You are too enchanted by the faerie court to look at a tree",
 });

  dest_dir=({
 "/players/saber/ryllian/gv3.c","north",
           });
...
count2 = count2 + 1;
call_out("intro",2);
move_object(clone_object("/players/saber/closed/bards/faerie_h.c"),environment(ACE));
return 1;
         }
         }
...
object MARK;
 ...
 OB->set_bard_level("8");
  ...
  tell_room(environment(ACE),
  "You are Bard Level 8!!!\n\n");
 ROM \"\Fare thy well, Master of Riddles.\n"+
   " We shall see thee again one day...\"\n");
move_object(environment(OB),"/players/saber/closed/bards/bardrooms/lore.c");
