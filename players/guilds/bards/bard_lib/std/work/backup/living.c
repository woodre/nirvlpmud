...
static object	Attacker;	/* Name of player attacking us. */
static object	AltAttacker;	/* Name of other player also attacking us. */
...
hit_player(int dam, mixed zap)
{
	...
	if (Attacker == AltAttacker || !AltAttacker)
