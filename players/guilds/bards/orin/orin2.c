...
reset(int arg){
if(!present("martin")) {
  move_object(clone_object("/players/guilds/bards/martin.c"));
}
if(!present("sign")){
...
"chamber","You are in the common room of Orin's Inn",
 ...
 "fire","A large fire, blazing in the hearth in the room to the east",
  ...
  dest_dir=({
 "/players/guilds/bards/orin/orin1.c","west",
 "/players/guilds/bards/orin/orin3.c","north",
 "/players/guilds/bards/orin/orin4.c","east",
 "/players/guilds/bards/bardrooms/enterance.c","up",
           });
  }   }
init(){
 ::init();
...
call_other(this_player(), "move_player","south#players/guilds/bards/bardrooms/hades_q.c");
