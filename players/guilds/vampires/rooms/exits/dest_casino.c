 ...
 *  File:         dest_casino.c
 *
 *  Function:     move a player to the Casino from guild hall
 *
 *  Author(s):    Vital
 *
...
main()
{
  if (TP && PFANGS)
  {
    PFANGS->tell_my_room(capitalize((string)TPN) + "extends " + TPPOS +
      "wings and flies off to the Casino.\n");
    write("You extend your wings and fly off to the Casino.\n");
    TP->move_player("into the mist#players/boltar/casino/front_desk");
    return 1;
  }
  return 0;
}
