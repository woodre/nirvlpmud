 ...
 *  File:         dest_lockers.c
 *
 *  Function:     move a player to Catwoman's lockers from guild hall
 *
 *  Author(s):    Vital
 *
...
main()
{
  if (TP && PFANGS)
  {
    PFANGS->tell_my_room(capitalize((string)TPN) + "extends " + TPPOS +
      "wings and flies off to the advancement guild.\n");
    write("You extend your wings and fly off to the advancement guild.\n");
