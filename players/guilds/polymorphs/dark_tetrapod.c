...
init()
{
   ...
   add_action("dark_tetrapod_crhit","crhit");
   add_action("dark_tetrapod_roomscan","roomscan");
...
random_emote()
{
   ...
   if(is_tetrapod_cloaked) return 0;
   ...
   if(ENV)
   {
      ...
      if(attacker && !ENV->query_ghost())
      {
         ...
         MASTER_R->multilimb_synchronized_attack(
                ...
                16,          /* The chance of this attack hitting, in this case 1 / x of the time */
         ...
         MASTER_R->multilimb_synchronized_attack(
                ENV,         /* ourselves */
                attacker,    /* our attacker */
                2,           /* The chance of this attack hitting, in this case 1 / x of the time */
                0,
                0,
...
dark_tetrapod_cloak() { return MASTER_R->dark_tetrapod_cloak(); }
dark_tetrapod_vigor(str) { return MASTER_R->dark_tetrapod_vigor(str); }
dark_tetrapod_calm() { return MASTER_R->dark_tetrapod_calm(); }
dark_tetrapod_crhit(str) { return MASTER_R->dark_tetrapod_crhit(str); }
dark_tetrapod_roomscan() { return DARK_R->dark_tetrapod_roomscan(); }
