#define BOARD_NAME "players/rumplemintz/guild/bull_board3"
...
id(str) {
 ...
 long() {
    write("This is the bulletin board that only Hierophants can see.\n"+
...
remove(str) {
if(this_player()->query_real_name()=="rumplemintz"||this_player()->query_real_name()=="dersharp"){
        string hd, body, rest;
      int i, tmp;
   ...
   write("Only Rumplemintz may remove messages.\n");
        return 1;
}
