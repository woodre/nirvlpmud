...
string *pages;
string title, alt_title;
int open, currentpage, save;
...
open_book(str){
    ...
    say(this_player()->query_name()+" opens the book to the first page.\n");
    open = 1;
    currentpage = 0;
    return 1;
}
...
close_book(str){
    ...
    say(this_player()->query_name()+" closes the book shut.\n");
    open = 0;
    return 1;
}
