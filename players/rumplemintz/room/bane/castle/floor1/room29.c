...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room30","east",
                "players/rumplemintz/room/bane/castle/floor1/room36","south",
                "players/rumplemintz/room/bane/castle/floor1/room37","southeast",
                "players/rumplemintz/room/bane/castle/floor1/room23","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room22","north",
        });
        }
}
