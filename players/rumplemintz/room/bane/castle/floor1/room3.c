...
reset(arg){
	...
	move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"),this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room4","east",
                "players/rumplemintz/room/bane/castle/floor1/room2","west",
                "players/rumplemintz/room/bane/castle/floor1/room9","southwest",
                "players/rumplemintz/room/bane/castle/floor1/room10","south",
                "players/rumplemintz/room/bane/castle/floor1/room11","southeast",
        });
        }
}
