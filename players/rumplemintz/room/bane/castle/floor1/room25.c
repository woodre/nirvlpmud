...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
		"players/rumplemintz/room/bane/castle/floor1/room26","east",
                "players/rumplemintz/room/bane/castle/floor1/room11","northwest",
                "players/rumplemintz/room/bane/castle/floor1/room12","north",
                "players/rumplemintz/room/bane/castle/floor1/room19","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room24","west",
                "players/rumplemintz/room/bane/castle/floor1/room31","southwest",
                "players/rumplemintz/room/bane/castle/floor1/room32","south",
                "players/rumplemintz/room/bane/castle/floor1/room33","southeast",
        });
        }
}
