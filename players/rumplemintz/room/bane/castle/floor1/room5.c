...
reset(arg){
	...
	move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room6","east",
                "players/rumplemintz/room/bane/castle/floor1/room4","west",
                "players/rumplemintz/room/bane/castle/floor1/room11","southwest",
                "players/rumplemintz/room/bane/castle/floor1/room12","south",
                "players/rumplemintz/room/bane/castle/floor1/room13","southeast",
        });
        }
}
