...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room34","west",
                "players/rumplemintz/room/bane/castle/floor1/room42","south",
                "players/rumplemintz/room/bane/castle/floor1/room41","southwest",
                "players/rumplemintz/room/bane/castle/floor1/room27","northwest",
                "players/rumplemintz/room/bane/castle/floor1/room28","north",
        });
        }
}
