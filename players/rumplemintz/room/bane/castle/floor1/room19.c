...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                ...
                "players/rumplemintz/room/bane/castle/floor1/room13","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room18","west",
                "players/rumplemintz/room/bane/castle/floor1/room25","southwest",
                "players/rumplemintz/room/bane/castle/floor1/room26","south",
                "players/rumplemintz/room/bane/castle/floor1/room27","southeast",
        });
        }
}
