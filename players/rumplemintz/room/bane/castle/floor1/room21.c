...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room20","west",
                "players/rumplemintz/room/bane/castle/floor1/room28","south",
                "players/rumplemintz/room/bane/castle/floor1/room27","southwest",
                "players/rumplemintz/room/bane/castle/floor1/room13","northwest",
                "players/rumplemintz/room/bane/castle/floor1/room14","north",
        });
        }
}
