...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room40","east",
                "players/rumplemintz/room/bane/castle/floor1/room33","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room32","north",
                "players/rumplemintz/room/bane/castle/floor1/room38","west",
                "players/rumplemintz/room/bane/castle/floor1/room31","northwest",
        });
        }
}
