...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room23","east",
                "players/rumplemintz/room/bane/castle/floor1/room29","south",
                "players/rumplemintz/room/bane/castle/floor1/room30","southeast",
                "players/rumplemintz/room/bane/castle/floor1/room16","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room15","north",
        });
        }
}
