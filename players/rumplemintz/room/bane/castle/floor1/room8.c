...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room9","east",
                "players/rumplemintz/room/bane/castle/floor1/room15","south",
                "players/rumplemintz/room/bane/castle/floor1/room16","southeast",
                "players/rumplemintz/room/bane/castle/floor1/room2","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room1","north",
        });
        }
}
