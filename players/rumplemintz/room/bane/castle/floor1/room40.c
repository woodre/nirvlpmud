...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room41","east",
                "players/rumplemintz/room/bane/castle/floor1/room34","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room33","north",
                "players/rumplemintz/room/bane/castle/floor1/room39","west",
                "players/rumplemintz/room/bane/castle/floor1/room32","northwest",
        });
        }
}
