...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room16","east",
                "players/rumplemintz/room/bane/castle/floor1/room22","south",
                "players/rumplemintz/room/bane/castle/floor1/room23","southeast",
                "players/rumplemintz/room/bane/castle/floor1/room9","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room8","north",
        });
        }
}
