...
reset(arg){
       ...
       move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room38","east",
                "players/rumplemintz/room/bane/castle/floor1/room31","northeast",
                "players/rumplemintz/room/bane/castle/floor1/room30","north",
                "players/rumplemintz/room/bane/castle/floor1/room36","west",
                "players/rumplemintz/room/bane/castle/floor1/room29","northwest",
        });
        }
}
