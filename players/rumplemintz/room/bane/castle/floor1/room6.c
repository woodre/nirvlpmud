...
reset(arg){
	...
	move_object(clone_object("players/rumplemintz/mon/bane/skwarr2"), this_object());
        ...
        dest_dir=({
                "players/rumplemintz/room/bane/castle/floor1/room7","east",
                "players/rumplemintz/room/bane/castle/floor1/room5","west",
                "players/rumplemintz/room/bane/castle/floor1/room12","southwest",
                "players/rumplemintz/room/bane/castle/floor1/room13","south",
                "players/rumplemintz/room/bane/castle/floor1/room14","southeast",
        });
        }
}
