...
move() {
    ...
    call_other(this_player(), "move_player", "west" + "#" +"players/rumplemintz/room/dlords/room22");
        return 1;
}
...
move1() {
        ...
        call_other(this_player(), "move_player", "east" + "#" +"players/rumplemintz/room/dlords/room24");
        return 1;
}
...
move2() {
        ...
        call_other(this_player(), "move_player", "south" + "#" +"players/rumplemintz/room/dlords/room18");
        return 1;
}
...
move3() {
        ...
        call_other(this_player(), "move_player", "southeast" + "#" +"players/rumplemintz/room/dlords/room19"
);
        return 1;
}
...
move4() {
        ...
        call_other(this_player(), "move_player", "southwest" + "#" +"players/rumplemintz/room/dlords/room17"
);
        return 1;
}
long() {
    write("You are in the Dwarven Saloon.\n");
    ...
    write("east, west, south, southeast, and southwest.\n");
}
