...
move() {
    ...
    call_other(this_player(), "move_player", "west" + "#" +"players/rumplemintz/room/kor/room5");
        return 1;
}
...
move1() {
        ...
        call_other(this_player(), "move_player", "southwest" + "#" +"players/rumplemintz/room/kor/room6");
        return 1;
}
