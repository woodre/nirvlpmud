...
"guilty. The stench of body fluids and stale blood permeates the air.\n";
  ...
  dest_dir = ({
    "/players/rumplemintz/room/maxim/dungeon2", "east",
    "/players/rumplemintz/room/maxim/dungeon4", "west",
    "/players/rumplemintz/room/maxim/cell2", "north"
  });
  MAKE_DOORS(
    "/players/rumplemintz/room/maxim/dungeon3", "north",
    "/players/rumplemintz/room/maxim/cell2", "south",
    "silver",
    "m_prison",
    "An iron cell door\n",
    1,
