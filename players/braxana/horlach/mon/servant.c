...
reset(arg)  {
  ...
  set_hp(1500);
  set_al(-1000);
  move_object(clone_object("/players/braxana/horlach/mon/whip2.c"),this_object());
  ...
  set_chance(40);
  set_spell_dam(100);
  set_spell_mess1("The Forbidden shakes around you!\n");
  set_spell_mess2("You feel a sense of DREAD.....\n\n"+BOLD+
                  "  -------------->  P\n"+
                  "                         A  <-------------\n"+
                  " ----------->  I\n"+
                  "                       N  <-------------\n\n"+NORM); 
