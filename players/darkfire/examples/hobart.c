...
set_chat_chance(5);
  ...
  load_chat("Your mind is clowded by the evil of the ways...you are hoplessly lost!\n");
  load_chat("The ways are endless.  All become lost here...lost and alone.\n");
  load_chat("Somewhere in the distance, a bridge succombs to the corruption of the ways and falls.\n");
  ...
  load_chat("A screaching howl of frustration and uncontrolled anger echos through the caverns...\n");
