...
dest_dir = ({
        "/players/catacomb/MF/rooms/Marsh5.c","east",
        "/players/catacomb/MF/rooms/Marsh9.c","southeast",
        "/players/catacomb/MF/rooms/Statue.c","statue",
        "/players/catacomb/MF/rooms/Marsh3.c","west"
	});
