...
dest_dir = ({
        "/players/catacomb/MF/rooms/Marsh4.c","east",
        "/players/catacomb/MF/rooms/Statue.c","southeast",
        "/players/catacomb/MF/rooms/Marsh8.c","southwest",
        "/players/catacomb/MF/rooms/Marsh2.c","west"
	});
