...
dest_dir = ({
	"/players/catacomb/MF/rooms/Marsh6.c","east",
        "/players/catacomb/MF/rooms/Marsh4.c","west",
        "/players/catacomb/MF/rooms/Marsh9.c","south",
	"/players/catacomb/MF/rooms/Forest20.c","forest"
	});
