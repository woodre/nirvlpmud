...
dest_dir = ({
        "/players/catacomb/MF/rooms/Marsh3.c","east",
        "/players/catacomb/MF/rooms/Marsh8.c","south",
        "/players/catacomb/MF/rooms/Marsh1.c","west",
        "/players/catacomb/MF/rooms/Forest19.c","forest"
	});
