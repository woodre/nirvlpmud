...
" has a "+RED+"|"+NORM+BOLD+"~"+NORM+BOLD+BLK+"FOG"+NORM+BOLD+"~"+NORM+RED+"|"+NORM+
" tattoo on "+OWNER->query_possessive()+" neck";
}

long() {
  write(
"This is a tattoo of the |~FOG~| on your neck.  Type 'fog_help'\n"+
"for more information.\n");
}

id(str) { return str=="tattoo" || str==GUILD_ID; }
