...
init()  {
  ...
  add_action("title_set", "color_title_me");
...
title_set() {
   ...
   switch(blah) {
    ...
    case 19:  msg="wanted a real title";break;
    ...
    case 105: msg=" ";break;
 /* New Additions... 7/30/00 */
    case 106: msg="drank too much Mountain Dew!";break;
    case 107: msg="lives on Sesame Street";break;
    case 108: msg="took a _long_ walk in the park";break;
    case 109: msg="still uses Napster";break;
    case 110: msg="thought it would be fun and games";break;
    case 111: msg="hopes to be a Dervish";break;
    case 112: msg="wants to be a _real_ Knight";break;
    case 113: msg="is thinking about joining the Vampires";break;
    case 114: msg="jumped off the roof into a pool of jello";break;
    case 115: msg="was a roadie for Pantera";break;
    case 116: msg="the Designing Woman";break;
    case 117: msg="groks at Cheerios";break;
    case 118: msg="wants to be made bad <KoRn>";break;
    case 120: msg="the interupter of phone calls";break;
    case 121: msg="likes to idle";break;
    case 122: msg="has a grip of mashed potatos";break;
    case 123: msg="growls: Where my dogz at?!?";break;
    case 124: msg="the Creator of Madness";break;
    case 125: msg="walks with justice";break;
    case 126: msg="just reinvented steel";break;
    case 127: msg="was a member of Real World";break;
    case 128: msg="the Jack of All trades, yet Master of none";break;
    case 129: msg="the Unruly, Redheaded Step-Child";break;
    case 130: msg="the Agnostic Catholic";break;
    case 131: msg="the 13th Warrior";break;
    case 132: msg="the Living Dead Girl";break;
   }
choose_color();
...
if(query_verb() == "color_title_me") {
  TP->add_money(-5000);
  /*TP->heal_self(-50);*/
  write(HIW+"Title set to: "+HIR+TP->query_name()+NORM+" "+color+msg+NORM+".\n");
  say(capitalize(TP->query_name())+" checks out "+TP->query_possessive()+" new color title.\n");
  this_player()->set_title(color+msg+NORM);
