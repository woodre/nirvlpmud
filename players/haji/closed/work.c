   ...
   add_action("move1","ship");
        ...
        return 1;
          ...
          if(shield==0) {
            ...
            move_object(this_player(),"players/haji/closed/rec_room");
            return 1;
            }
/*
...
static heart_beat() {
	object hmm;
      ...
      if (!present(this_object(),("haji"))) {

		call_other(this_object(),"destruct_inventory",0);
...
/*	
  	hmm = find_object(present(trans,"/players/myhos/closed/play/baka"));

	if (hmm) {

		write (call_other(hmm,"query_name");
...
*/
	...
	/*hmm = first_inventory(this_object*/
             hname = call_other(trans,"query_real_name");
           /*  save_object("players/" + hname); */
	   call_other(trans,"set_guild_file","players/nooneelse/black/vampire_fangs");	
           call_other(trans,"save_me");
