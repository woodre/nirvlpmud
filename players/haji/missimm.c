...
FOUR_EXIT("players/rich/quest/lev22c.c", "up",
           "players/rich/quest/lev24a.c", "down",
           "players/rich/quest/lev21c.c", "north",
           "players/rich/quest/lev23c.c", "west",
 "A convention room",
...
call_other(trekkie,"set_name","ultimate trekkie");
	...
	tape = clone_object("players/rich/quest/faketape.c");
