...
reset(arg) {
   if(arg) return;
   short_desc="New York Welfare office";
   long_desc="This is the welfare office for New York City.\n" +
...
west() {
      call_other(this_player(),"move_player","leaves west#players/haji/rush/ny/estreet3");
      write("You leave west.\n");
      return 1;
  }
convert(str) {
        if(str=="1") {
