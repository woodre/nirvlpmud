...
move() {
    ...
    call_other(this_player(), "move_player",  "west" + "#" +"players/haji/town/road1.c");
    return 1;
}
...
long() {
    ...
    write("     middle eastern ale  :  15 coins\n");
    write("     Herbal Tea          :  20 coins\n");
    write("     Oriental special    : 100 coins\n");
    write("     Haji surprise       : 300 coins\n\n");
...
mess = "You feel the ale burn as it goes down your throat!!!";
    ...
    else if (str=="special"||str=="oriental special") {
	mess = "A tingling feeling goes through your body";
	heal = 5;
	value = 100;
	strength = 8;
    } else if (str == "haji surprise" || str == "haji") {
