...
short() { int a; a = random(15);
   if (a==0) return ""+HIB+"Park Place"+NORM+"";
   if (a==1) return ""+HIM+"Lollipop Woods"+NORM+"";
   if (a==2) return ""+HIW+"Go To Jail"+NORM+"";
   if (a==3) return ""+HIY+"Martha's Gameroom"+NORM+"";
   if (a==4) return ""+HIG+"Gumdrop Mountain"+NORM+"";
   if (a==5) return ""+HIR+"Kentucky Avenue"+NORM+"";
   if (a==7) return ""+RED+"Royal Peppermint Forest"+NORM+"";
   if (a==8) return ""+GRN+"Pacific Avenue"+NORM+"";
   if (a==9) return ""+YEL+"Ice Cream Sea"+NORM+"";
   if (a==10) return ""+BLU+"Boardwalk"+NORM+"";
   if (a==11) return ""+MAG+"Candy Castle"+NORM+"";
   if (a==12) return ""+CYN+"Oriental Ave"+NORM+"";
   if (a==13) return ""+WHT+"Just Visiting"+NORM+"";
   if (a==16) return ""+HIW+"Free Parking"+NORM+"";
   if (a==14) return ""+HIB+"A jumble of board games"+NORM+"";
if (a==6) return ""+HIC+"Take a ride on the Reading"+NORM+"";
}
