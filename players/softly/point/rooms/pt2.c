...
long_desc ="  Footing is treacherous on the large slick boulders that\n"+
           ...
           "broken only by the crashing surf.  The jetty seems to have\n"+
...
call_other(this_player(),"move_player","west#/players/softly/point/rooms/pt1.c");
  return 1;
}
...
call_other(this_player(),"move_player","east#/players/softly/point/rooms/pt3.c");
  return 1;
}
