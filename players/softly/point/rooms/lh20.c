inherit "/players/softly/point/rooms/std_lh.c";
  ...
  reset(arg) {
  if(!present("blackbeard")) 
  move_object(clone_object("players/softly/point/mobs/blackbeard"),this_object());
  if(arg) return;
  ::reset();
...
dest_dir = ({
  "/players/softly/point/rooms/lh13.c","east",
  "/players/softly/point/rooms/lh19.c","south",
  });
}
