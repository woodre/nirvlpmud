...
reset(arg) {
  ...
  if(!random(3))move_object(clone_object("players/softly/point/mobs/bird.c"),this_object());
  if(arg) return;
set_light(1);
...
dest_dir = ({
  "/players/softly/point/rooms/for12.c","northwest",
  "/players/softly/point/rooms/for18.c","southeast",
