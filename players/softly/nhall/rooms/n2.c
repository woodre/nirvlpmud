...
reset(arg) {
  ...
  dest_dir = ({
    ...
    "/players/softly/nhall/rooms/n1.c","east",
  });
...
"   @                                                          @\n"+
"   @  "+NORM+"[10 hp heals]"+GRN+"	                                      @\n"+
"   @  "+NORM+"1. Healing balm [blue](3).........................160   "+GRN+"@\n"+
"   @  "+NORM+"2. Healing balm [green](3)........................160   "+GRN+"@\n"+
"   @  "+NORM+"3. Decanter of healing(3).........................160   "+GRN+"@\n"+
"   @  "+NORM+"[20 hp heals]                                           "+GRN+"@\n"+
"   @  "+NORM+"4. Healing balm [blue](3).........................320   "+GRN+"@\n"+
"   @  "+NORM+"5. Healing balm [green](3)........................320   "+GRN+"@\n"+
"   @  "+NORM+"6. Decanter of healing(3).........................320   "+GRN+"@\n"+
...
if(str == "1"){
cost = 160;
item = clone_object("/players/softly/nhall/obj/blue1.c");
what = "healing balm";
}
else if(str == "2"){
cost = 160;
item = clone_object("/players/softly/nhall/obj/green1.c");
what = "healing balm";
}
else if(str == "3"){
cost = 160;
item = clone_object("/players/softly/nhall/obj/decant1.c");
what = "decanter";
}
else if(str == "4"){
cost = 320;
item = clone_object("/players/softly/nhall/obj/blue2.c");
what = "healing balm";
}
else if(str == "5"){
cost = 320;
item = clone_object("/players/softly/nhall/obj/green2.c");
what = "healing balm";
}
else if(str == "6"){
cost = 320;
item = clone_object("/players/softly/nhall/obj/decant2.c");
what = "decanter";
}
    
else if(str == "7"){
cost = 720;
item = clone_object("/players/softly/nhall/obj/blue3.c");
what = "healing balm";
}
else if(str == "8"){
cost = 720;
item = clone_object("/players/softly/nhall/obj/green3.c");
what = "healing balm";
}
else if(str == "9"){
cost = 720;
item = clone_object("/players/softly/nhall/obj/decant3.c");
what = "decanter";
}
else{
