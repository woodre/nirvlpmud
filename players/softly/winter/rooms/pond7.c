...
long_desc ="  The blindingly bright frozen lake is surrounded by dying trees\n"+
           "dotted with a few evergreens.  The trees to the east are very\n"+
           "dense and dark.  To the south a jumble of debris blocks passage.\n"+
...
dest_dir = ({
  "/players/softly/winter/rooms/pond8.c","north",
  "/players/softly/winter/rooms/pond6.c","west",
  "/players/softly/winter/rooms/pond9.c","northwest",
  });
}
