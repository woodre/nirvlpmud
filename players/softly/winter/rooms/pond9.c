...
long_desc ="  The blindingly bright frozen lake is surrounded by dying trees\n"+
           ...
           "and debris press against the lake edge to the north.  The\n"+
           "lake surface continues in the other directions.\n";
...
dest_dir = ({
  "/players/softly/winter/rooms/pond8.c","east",
  "/players/softly/winter/rooms/pond7.c","southeast",
  "/players/softly/winter/rooms/pond6.c","south",
  "/players/softly/winter/rooms/pond5.c","southwest",
  "/players/softly/winter/rooms/pond10.c","west",
  });
}
