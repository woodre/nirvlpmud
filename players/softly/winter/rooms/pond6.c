...
long_desc ="  The blindingly bright frozen lake is surrounded by dying trees\n"+
           ...
           "shack is visible to the southwest.  To the north and northeast the\n"+
           "broad lake surface continues.  The edge of a forest can be seen to\n"+
           "the south.\n"; 
...
dest_dir = ({
  "/players/softly/winter/rooms/pond9.c","north",
  "/players/softly/winter/rooms/pond8.c","northeast",
  "/players/softly/winter/rooms/pond7.c","east",
  "/players/softly/winter/rooms/pond1.c","south",
  "/players/softly/winter/rooms/pond5.c","west",
  "/players/softly/winter/rooms/pond10.c","northwest",
  });
}
