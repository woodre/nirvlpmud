...
reset(arg) {
	...
	+ "You hear the sounds of fighting beneath you, perhaps you could\n"
...
dest_dir = ({
	"/players/pain/NEW/lair1", "north",
	"/players/pain/NEW/lair10", "west",
});
if(!present("orc"))
{
...
down() {
  if(!present("orc")) {
    this_player()->move_player("down#/players/pain/NEW/28.c");
    return 1;
  }
  write("The orc maneuvers to block your path!\n");
  say("A orc maneuvers to block "+this_player()->query_name()+"'s path!\n");
  return 1;
}
