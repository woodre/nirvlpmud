...
reset() {
  ...
  dest_dir = ({
	"/players/pain/NEW/flet/grove2", "north",
	"/players/pain/NEW/flet/fpath3", "east",
	"/players/pain/NEW/flet/grove8", "south",
	"/players/pain/NEW/flet/grove7", "southwest",
	"/players/pain/NEW/flet/grove_c", "west",
	"/players/pain/NEW/flet/grove3", "northwest",
	});
  if(!present("guard")) {
