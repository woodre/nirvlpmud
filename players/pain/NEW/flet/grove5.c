...
reset() {
  ...
  dest_dir = ({
	"/players/pain/NEW/flet/grove4", "north",
	"/players/pain/NEW/flet/grove3", "northeast",
	"/players/pain/NEW/flet/grove_c", "east",
	"/players/pain/NEW/flet/grove7", "southeast",
	"/players/pain/NEW/flet/grove6", "south"
	});
