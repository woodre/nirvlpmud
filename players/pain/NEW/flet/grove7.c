...
reset() {
  ...
  dest_dir = ({
	"/players/pain/NEW/flet/grove_c", "north",
	"/players/pain/NEW/flet/grove1", "northeast",
	"/players/pain/NEW/flet/grove8", "east",
	"/players/pain/NEW/flet/grove6", "west",
	"/players/pain/NEW/flet/grove5", "northwest",
	});
  if(!present("guard")) {
