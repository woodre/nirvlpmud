...
reset() {
  ...
  dest_dir = ({
	"/players/pain/NEW/flet/grove2", "east",
	"/players/pain/NEW/flet/grove1", "southeast",
	"/players/pain/NEW/flet/grove_c", "south",
	"/players/pain/NEW/flet/grove5", "southwest",
	"/players/pain/NEW/flet/grove4", "west",
	});
...
int number;
  ...
  if(number == 1) {
	/* noise 2 */
	tell_room(this_object(),
		"A mysterious force surrounds you, beckoning you deeper into the grove.\n");
  }
  if(number == 2) {
	/* noise 3 */
	tell_room(this_object(),
