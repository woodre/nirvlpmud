...
/* inherit "/obj/armor"; */
#include "/players/pain/NEW/Guild/defs.h"
...
long() { 
	write("A tattoo of a skull imposed on a flaming sword.\n"+
	      ...
	      "elite fighting force in the service of Pain.\n"+
...
query_auto_load() { return "players/pain/NEW/Guild/guildob.c:"; }
