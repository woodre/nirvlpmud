...
long()
{
  ...
  write("A small, gold star tattoo above your right inner ankle bone.\n"+
...
remove_object() {
   if( environment() && environment()->is_player() )
     CHAND->remove_channel( CHAN_NAME, environment() );
...
/* verte fixed this to display "You have" etc. */
  if(environment() == this_player())
    str = "You have a small " + YELLOW + "gold star" + END + " tattoo on " +
      "your inside right ankle";
  else 
    str = environment()->query_name() + " has a small " +
