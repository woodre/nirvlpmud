...
reset(arg) {
	...
	+ "You hear the chanting of spell casting below you, perhaps you\n"
	+ "should venture 'down' to see more.\n";
...
dest_dir = ({
	"/players/pain/NEW/lair5", "east",
	"/players/pain/NEW/lair7", "south",
});
if(!present("orc"))
{
...
down() {
  if(!present("orc")) {
    this_player()->move_player("down#/players/pain/NEW/1");
    return 1;
  }
