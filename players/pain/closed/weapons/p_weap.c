...
reset(arg) {
    if (arg)
     return;
    wielded = 0; value = 0;
message_hit=({"CRUSHED"," to bloody bits","crunched"," with a bone crushing force","pummelled"," with great force","smacked"," hard","beat","","with a glancing blow","","tickled"," in the stomach"});
}
