...
backp=allocate(10);
comment=allocate(10);
restore_object("players/pain/closed/guild/speed/"+lower_case(this_player()->query_real_name()));
}
...
comment(str)  {
  ...
  if(!monk_check())  return 0;
        ...
        save_object("players/pain/closed/guild/speed/"+lower_case(this_player()->query_real_name()));
        return 1;
        }
