...
#define BOARD_NAME "players/snow/closed/cyber/boards/ideaboard"
...
id(str) {
  return str == "terminal" || str == "term" || str == "ideaterminal";
}
...
long() {
  ...
  if(!present("implants", this_player())) {
    ...
    return 1; }
  write("Input any ideas you have on this terminal please.\n");
...
short() {
  return "The Idea Terminal ("+msg_num+" entries)";
}
