...
if(!present("snowman")) {
move_object(clone_object("/players/snow/MONSTERS/snowman.c"),this_object());
               }
if(!present("snowman 2")) {
move_object(clone_object("/players/snow/MONSTERS/snowman.c"),this_object());
               }
...
items=({
 ...
 "snowflakes", "Shining snowflakes drift in the breeze. Some seem to be \n"+
  ...
  dest_dir=({
  "/players/snow/newbie/newbie+2.c","south",
  "/players/snow/newbie/mol_bar.c","down",
});
  }   }
