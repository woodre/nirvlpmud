...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo25.c","north");
  add_exit(ROOT+"rms/jibboo10.c","northeast");
  add_exit(ROOT+"rms/jibboo09.c","east");
  add_exit(ROOT+"rms/jibboo08.c","southeast");
  add_exit(ROOT+"rms/jibboo23.c","south");
  add_exit(ROOT+"rms/jibboo15.c","southwest");
  add_exit(ROOT+"rms/jibboo14.c","west");
  add_exit(ROOT+"rms/jibboo13.c","northwest");
}
