...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo21.c","north");
  add_exit(ROOT+"rms/jibboo20.c","northeast");
  add_exit(ROOT+"rms/jibboo10.c","east");
  add_exit(ROOT+"rms/jibboo09.c","southeast");
  add_exit(ROOT+"rms/jibboo24.c","south");
  add_exit(ROOT+"rms/jibboo14.c","southwest");
  add_exit(ROOT+"rms/jibboo13.c","west");
  add_exit(ROOT+"rms/jibboo17.c","northwest");
}
