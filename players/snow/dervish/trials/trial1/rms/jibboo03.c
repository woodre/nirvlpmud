...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo12.c","north");
  add_exit(ROOT+"rms/jibboo13.c","northeast");
  add_exit(ROOT+"rms/jibboo14.c","east");
  add_exit(ROOT+"rms/jibboo15.c","southeast");
  add_exit(ROOT+"rms/jibboo04.c","south");
  add_exit(ROOT+"rms/jibboo01.c","southwest");
  add_exit(ROOT+"rms/jibboo02.c","west");
  add_exit(ROOT+"rms/jibboo11.c","northwest");
}
