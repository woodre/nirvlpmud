...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo03.c","north");
  add_exit(ROOT+"rms/jibboo14.c","northeast");
  add_exit(ROOT+"rms/jibboo15.c","east");
  add_exit(ROOT+"rms/jibboo16.c","southeast");
  add_exit(ROOT+"rms/jibboo05.c","south");
  add_exit(ROOT+"rms/jibboo06.c","southwest");
  add_exit(ROOT+"rms/jibboo01.c","west");
  add_exit(ROOT+"rms/jibboo02.c","northwest");
}
