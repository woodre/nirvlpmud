...
reset(arg) {
  ...
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo24.c","north");
  add_exit(ROOT+"rms/jibboo09.c","northeast");  
  add_exit(ROOT+"rms/jibboo08.c","east");
  add_exit(ROOT+"rms/jibboo07.c","southeast");
  add_exit(ROOT+"rms/jibboo22.c","south");
  add_exit(ROOT+"rms/jibboo16.c","southwest");
  add_exit(ROOT+"rms/jibboo15.c","west");
  add_exit(ROOT+"rms/jibboo14.c","northwest");
}
