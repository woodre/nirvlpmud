...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo16.c","north");
  add_exit(ROOT+"rms/jibboo22.c","northeast");
  add_exit(ROOT+"rms/jibboo21.c","east");
  add_exit(ROOT+"rms/jibboo25.c","southeast");
  add_exit(ROOT+"rms/jibboo13.c","south");
  add_exit(ROOT+"rms/jibboo12.c","southwest");
  add_exit(ROOT+"rms/jibboo18.c","west");
  add_exit(ROOT+"rms/jibboo05.c","northwest");
}
