...
items=({
 ...
 "lichen","A tough rust-red growth on the rock",
  ...
  dest_dir=({
  "/players/snow/ROOMS/tundra/entrance.c","south",
 "/players/snow/ROOMS/tundra/tundra2.c","east",
 "/players/snow/ROOMS/tundra/tundra3.c","west",
 "/players/snow/ROOMS/tundra/tundra4.c","north",
      });
  }   }
