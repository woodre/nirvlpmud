...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/kill/2");
  return 1;
}

south() {
  call_other(this_player(),"move_player", "south#players/catwoman/kill/10");
  return 1;
}

east() {
  call_other(this_player(),"move_player", "east#players/catwoman/kill/7");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/kill/5");
  return 1;
}
block(){
