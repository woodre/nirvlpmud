...
south() {
  call_other(this_player(),"move_player", "south#players/catwoman/kill/6");
  return 1;
}

east() {
  call_other(this_player(),"move_player", "east#players/catwoman/kill/3");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/kill/1");
  return 1;
}
block(){
