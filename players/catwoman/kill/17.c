...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/kill/13");
  return 1;
}

south() {
  call_other(this_player(),"move_player", "south#players/catwoman/kill/17");
  return 1;
}

east() {
  call_other(this_player(),"move_player", "east#players/catwoman/kill/18");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/kill/6");
  return 1;
}
block(){
