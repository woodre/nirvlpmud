...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/kill/3");
  return 1;
}

south() {
  call_other(this_player(),"move_player", "south#players/catwoman/kill/11");
  return 1;
}

east() {
  call_other(this_player(),"move_player", "east#players/catwoman/kill/8");
  return 1;
}
