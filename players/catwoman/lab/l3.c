...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/lab/l4");
  return 1;
}

south() {
  call_other(this_player(),"move_player", "south#players/catwoman/lab/l5");
  return 1;
}

east() {
  call_other(this_player(),"move_player", "east#players/catwoman/lab/l6");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/lab/l7");
  return 1;
}
/*
up() {
