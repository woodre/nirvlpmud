...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/lab/l14");
  return 1;
}

south() {
  call_other(this_player(),"move_player", "south#players/catwoman/lab/l15");
  return 1;
}

east() {
  call_other(this_player(),"move_player", "east#players/catwoman/lab/l16");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/lab/l1");
  return 1;
}
/*
up() {
