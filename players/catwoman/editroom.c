...
if (this_player()->is_invis() > 0 && invader !="catwoman")  {
   this_player()->force_us("vis");
  }
if (secure == 0 && invader !=invited && invader !="catwoman")  {
...
force(str)  {
  ...
  invited =str;
  tell_object(person,"You are brought to Catwomans editing room...\n");
...
TWO_EXIT("/players/catwoman/workroom","workroom",
         "room/well","down",
         "You are in Catwoman's editing room",
         "\n",1)
