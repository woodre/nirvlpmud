...
north() {
    ...
    call_other(this_player(), "move_player",  "north" + "#" +"players/catwoman/tshop");
    return 1;
}
south() {
    object ob;
    call_other(this_player(), "move_player", "south" + "#" +"players/catwoman/tl");
    return 1;
}
long() {
    write("You are in the local thieves pub.\n");
    ...
    write("The only obvious exit is north and south.\n");
}
...
order(str)
{
    ...
    if (str == "beer") {
        ...
        mess = "A cloud of smoke steams out of your ears";
        heal = 20;
        value = 210;
        strength = 14;
