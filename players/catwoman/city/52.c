...
*/
south() {
  call_other(this_player(),"move_player", "south#players/catwoman/city/53");
  return 1;
}

east() {
  call_other(this_player(),"move_player", "east#players/catwoman/city/49");
  return 1;
}
/*
west() {
...
long() {
 ...
 write("to the south You see something shining\n");
 write("     Obvious exits: east, south\n");
}
