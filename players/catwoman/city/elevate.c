...
*/
south() {
  call_other(this_player(),"move_player", "south#players/catwoman/city/18");
  return 1;
}
/*
east() {
...
*/
up() {
  call_other(this_player(),"move_player", "up#players/catwoman/city/28");
  return 1;
}
/*
down() {
...
long() {
 write("The lobby level\n");
 write("To the south to the lobby.\n");
 write("     Obvious exits: south, up\n");
}
