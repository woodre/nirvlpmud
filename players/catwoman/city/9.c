...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/city/24");
  return 1;
}

south() {
  call_other(this_player(),"move_player", "south#players/catwoman/city/8");
  return 1;
}
/*
east() {
...
long() {
 ...
 write("to the south is Main Street\n");
