...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/city/49");
  return 1;
}

south() {
  call_other(this_player(),"move_player", "south#players/catwoman/city/51");
  return 1;
}
/*
east() {
...
long() {
 write("First Street\n");
 write("To the south is a dead end and north is North Ave\n");
