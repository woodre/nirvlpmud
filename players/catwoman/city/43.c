...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/city/44");
  return 1;
}
south() {
  call_other(this_player(),"move_player", "south#players/catwoman/city/17");
  return 1;
}
east() {
  call_other(this_player(),"move_player", "east#players/catwoman/dock1");
  return 1;
}
/*
west() {
  call_other(this_player(),"move_player", "west#players/catwoman/city/45");
  return 1;
}
/*
*/
...
long() {
 ...
 write("     Obvious exits: north, south, east\n");
}
