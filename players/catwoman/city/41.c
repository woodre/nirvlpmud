...
reset(arg) {
	...
	if(!ob1){
		ob1 = clone_object("players/catwoman/monster/spider");
		move_object(ob1, this_object());
		}

	if(!ob2){
		ob2 = clone_object("players/catwoman/armor/ssuit");
		move_object(ob2, ob1);
		}
...
*/
west() {
  call_other(this_player(),"move_player", "west#players/catwoman/city/31");
  return 1;
}
/*
up() {
