...
*/
south() {
  call_other(this_player(),"move_player", "south#players/catwoman/city/14");
  return 1;
}

east() {
  call_other(this_player(),"move_player", "east#players/catwoman/city/15");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/city/11");
  return 1;
}
/*
up() {
