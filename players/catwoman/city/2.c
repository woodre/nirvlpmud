...
*/
east() {
  call_other(this_player(),"move_player", "east#players/catwoman/city/3");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/hall2");
  return 1;
}
/*
up() {
...
long() {
 ...
 write("to the west is a time portal\n");
