...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/city/12");
  return 1;
}
/*
south() {
...
*/
east() {
  call_other(this_player(),"move_player", "east#players/catwoman/city/13");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/city/8");
  return 1;
}
/*
up() {
...
long() {
 ...
 write("To the north is the shop\n");
