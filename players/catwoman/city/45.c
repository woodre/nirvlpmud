...
north() {
  call_other(this_player(),"move_player", "north#players/catwoman/city/46");
  return 1;
}
/*
south() {
...
*/
east() {
  call_other(this_player(),"move_player", "east#players/catwoman/city/44");
  return 1;
}

west() {
  call_other(this_player(),"move_player", "west#players/catwoman/city/47");
  return 1;
}
/*
up() {
...
long() {
 ...
 write("to the north You see construction\n");
 write("     Obvious exits: east, west, north\n");
}
