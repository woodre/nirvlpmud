...
south() {
   call_other(this_player(), "move_player", "leaves#/players/catwoman/tshop");
   return 1;
}
...
reset(arg) {
   ...
   if (!present("torch")) {
	...
	object h;
	object i;
      a = clone_object("/players/catwoman/armor/splint");
      b = clone_object("/players/catwoman/armor/plate");
      c = clone_object("/players/catwoman/armor/shield");
      d = clone_object("/players/catwoman/armor/boots");
      e = clone_object("/players/catwoman/armor/cloak");
      f = clone_object("/players/catwoman/armor/helm");
      g = clone_object("/players/catwoman/weapon/staff");
      h = clone_object("/players/catwoman/weapon/sword");
      i = clone_object("/players/catwoman/weapon/axe");
