...
return;
    ...
    write("This is the island of doom.\n");
    write("There is a lever on the floor.\n");
...
east() {
    if (call_other("players/catwoman/boat", "query_gate", 0) ||
call_other("players/catwoman/boat", "query_level", 0) != 2) {
write("The gate is closed.\n");
return 1;
    }
...
open(str)
{
    if (str != "gate")
return 0;
    if (call_other("players/catwoman/boat", "query_level", 0) != 2) {
