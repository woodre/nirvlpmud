...
query_auto_load() { return "/players/wizardchild/toys/ering:"; }
...
long() {
  write("A beautiful golden band, representing a symbolic occasion.\n");
  write("Inscribed on the inside is the following:\n");
  write(" "+cp(who)+" and "+cp(me)+", 1995.\n");
