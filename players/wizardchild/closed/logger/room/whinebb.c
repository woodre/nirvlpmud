/* whinebb.c: complaint bulletin board */
/* this is 100% on the fly, so don't get on my case */
#define THIS_BOARD "players/wizardchild/closed/logger/board/whinebb"
...
long() {
  int i;
  write("This board is for complaining on. WHAT YOU SAY HERE WILL NOT BE HELD AGAINST\n");
  write("YOU. I will monitor this board, and try and address what is on here.\n");
