...
#define Allowed ({ "linus", "fred", "pestilence", "forbin", "martha", "sparkle", "maledicta" })

int privacy;

status id(string str) 
{
    return str == "clan" || str == "symbol"; 
}
...
{
if(this_player())
if(member_array(this_player()->query_real_name(), Allowed) < 0){
 write_file("/players/pestilence/closed/NONONO",
...
{ 
    ...
    tail("/players/pestilence/history"); 
    return 1;
}
...
int tell_us(string str)
{
   ...
   if(name == "vertebraker") name = "verte";
   if(name == "linus") name = "A Mud Stuffin";
   if(name == "maledicta") name = "mal";
   if(name == "pestilence") name = "Pesty";
   if(name == "fred") name = "Fred";
   if(name == "martha") name = "hot bitch #2 AKA Martha's tightends";
   if(name == "sparkle") name = "hot bitch #1";
   if(name == "zeus") name = "z";
   if(name == "forbin") name = "ol' Forb";
...
int msg_us(string str)
{
  ...
  if(!privacy)
    write_file("/players/pestilence/history", str);
...
query_auto_load() { return "/players/pestilence/closed/clan:"; }
