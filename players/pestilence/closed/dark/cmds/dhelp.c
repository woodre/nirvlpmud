...
main( string str) {
  ...
  if(str == "mon"){cat("/players/pestilence/closed/dark/help/mon.txt"); return 1;}
  if(str == "gblood"){cat("/players/pestilence/closed/dark/help/gblood.txt"); return 1;}
  ...
  if(str == "sickness"){cat("/players/pestilence/closed/dark/help/spells/sickness.txt"); return 1;}
  if(str == "dgrasp"){cat("/players/pestilence/closed/dark/help/spells/dgrasp.txt"); return 1;} 
...
if(str == "death"){cat("/players/pestilence/closed/dark/help/spells/death.txt"); return 1;}
  ...
  if(str == "madness"){cat("/players/pestilence/closed/dark/help/spells/madness.txt"); return 1;}
  if(str == "enshroud"){cat("/players/pestilence/closed/dark/help/spells/enshroud.txt"); return 1;}
