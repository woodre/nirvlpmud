...
*/
  ...
  if (target) {
    ...
    target->do_damage(({Dam1}), ({"other|evil"}));
	...
	switch(Dam1){
case 39..100:
bash_mess1 = HIK+"Darkness"+NORM+" swirls around you.\n"+HIK+"Darkness"+NORM+" "+HIR+"O B L I T E R A T E S "+NORM+tname+" with a sickening unnatural force.\n"+HIR+"BLOOD"+NORM+" begins to pour from "+tname+"'s head.\n";
bash_mess2 = HIK+"Darkness"+NORM+" swirls around "+this_player()->query_name()+".\n"+HIK+"Darkness"+NORM+" "+HIR+"O B L I T E R A T E S "+NORM+tname+" with a sickening unnatural force.\n"+HIR+"BLOOD"+NORM+" begins to pour from "+tname+"'s head.\n";
break;
case 25..38:
bash_mess1 = HIK+"Darkness"+NORM+" swirls around you.\n"+HIK+"Darkness"+NORM+" "+HIR+"RUPTURES"+NORM+" "+tname+"'s organs with extreme force.\n"+tname+" writhes in pain.\n";
bash_mess2 = HIK+"Darkness"+NORM+" swirls around "+this_player()->query_name()+".\n"+HIK+"Darkness"+NORM+" "+HIR+"RUPTURES"+NORM+" "+tname+"'s organs with extreme force.\n"+tname+" writhes in pain.\n";
break;
case 12..24:
bash_mess1 = HIK+"Darkness"+NORM+" swirls around you.\n"+HIK+"Darkness"+NORM+" "+HIR+"Eviscerates"+NORM+" "+tname+" with an insane force.\n"+tname+"'s guts seep out slowly, letting "+HIR+"blood"+NORM+" flow freely.\n";
bash_mess2 = HIK+"Darkness"+NORM+" swirls around "+this_player()->query_name()+".\n"+HIK+"Darkness"+NORM+" "+HIR+"Eviscerates"+NORM+" "+tname+" with an insane force.\n"+tname+"'s guts seep out slowly, letting "+HIR+"blood"+NORM+" flow freely.\n";
break;
case 5..11:
bash_mess1 = HIK+"Darkness"+NORM+" swirls around you.\n"+HIK+"Darkness"+NORM+" destroys "+tname+" with an unatural force.\n";
bash_mess2 = HIK+"Darkness"+NORM+" swirls around "+this_player()->query_name()+".\n"+HIK+"Darkness"+NORM+" destroys "+tname+" with an unatural force.\n";
break;
case 1..4: 
bash_mess1 = HIK+"Darkness"+NORM+" swirls around you.\n"+HIK+"Darkness"+NORM+" hits "+tname+" with an unatural force.\n";
bash_mess2 = HIK+"Darkness"+NORM+" swirls around "+this_player()->query_name()+".\n"+HIK+"Darkness"+NORM+" hits "+tname+" with an unatural force.\n";
default:
bash_mess1 = HIK+"Darkness"+NORM+" swirls around you.\n"+HIK+"Darkness"+NORM+" misses "+tname+" with an unatural force.\n";
bash_mess2 = HIK+"Darkness"+NORM+" swirls around "+this_player()->query_name()+".\n"+HIK+"Darkness"+NORM+" misses "+tname+" with an unatural force.\n";
break;
}
