...
*/
   ...
   */
   ...
   switch(Dam1){
      ...
      bash_mess2 = HIK+this_player()->query_name()+" sneaks around "+NORM+victim->query_name()+" and blindsides them with a sickening crunch.\n";
      break;
      case 7..15:
      bash_mess1 = HIK+"You weakly blindside"+NORM+" "+victim->query_name()+" with a weak hit.\n";
      bash_mess2 = HIK+this_player()->query_name()+" weakly blindsides "+victim->query_name()+" with a weak hit.\n";
      break;
      case 1..6:
      bash_mess1 = HIK+"You"+NORM+" miss "+victim->query_name()+" with a disgusting attempt to blindside.\n";
      bash_mess2 = HIK+this_player()->query_name()+NORM+" misses "+victim->query_name()+" with a distgusting attempt to blindside.\n";
      break;
      default:
      bash_mess1 = HIK+"You"+NORM+" miss "+victim->query_name()+" with a disgusting attempt to blindside.\n";
      bash_mess2 = HIK+this_player()->query_name()+NORM+" misses "+victim->query_name()+" with a distgusting attempt to blindside.\n";
   ...
   say(bash_mess2);
   this_player()->spell_object(victim,"blindside", Dam1,33,
      bash_mess1,
      bash_mess2,
      "");
