...
string ATT_NAME,msg;
  if(attacker_ob)  ATT_NAME = attacker_ob->query_name();
    ...
    say(""+HIK+"Dajerias"+NORM+" unleashes an "+HIW+"INTENSE"+NORM+" amount of "+HIK+"P A I N"+NORM+" into "+ATT_NAME+"'s body.\n"+ATT_NAME+" crumbles under the immense "+HIK+"P A I N\n"+NORM);
...
string ATT_NAME,msg;
  if(attacker_ob)  ATT_NAME = attacker_ob->query_name();
     say(HIK+"T E N D R I L S"+NORM+" of "+RED+"corruption impale"+NORM+" "+ATT_NAME+" with tremendous force.\n"+ATT_NAME+" screams out in Pain.\n");
...
string ATT_NAME,msg;
  if(attacker_ob)  ATT_NAME = attacker_ob->query_name();
    say( HIK+"Darkness"+NORM+" swirls around you.\n"+HIK+"Darkness"+NORM+" "+HIR+"O B L I T E R A T E S "+NORM+ATT_NAME+" with a sickening unnatural force.\n"+HIR+"BLOOD"+NORM+" begins to pour from "+ATT_NAME+"'s head.\n");
