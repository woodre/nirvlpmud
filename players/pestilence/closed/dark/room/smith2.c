...
reset(arg) {
  ...
  short_desc = "The "+HIK+"Blacksmith's"+NORM+" shop";
  long_desc=
"A very large section of the cave that contains the blacksmith\n"+ 
  ...
  dest_dir=({
    "/players/pestilence/closed/dark/room/dhall2.c", "north",
  });  
}
