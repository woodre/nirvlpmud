...
reset(arg) {
        ...
        if (arg) return;
        set_light(0);
        short_desc = "Dark Training Center"+NORM+"";
        long_desc =
"    This is the place where guild members come to train.  The whole\n"+
"room is wall to wall rock.  On the east wall there is a large rock,\n"+
"used to practice fighting.\n"+
        "\n";
        items = ({
                        "door",
...
init(){
        ::init();
if(this_player())
if(present("dknight_ob", this_player())) return;
