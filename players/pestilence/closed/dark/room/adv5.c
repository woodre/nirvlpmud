...
advance(str) {
        ...
        if(!present("order_trainer", this_object())){
...
get_combat_exp(arg) {
        ...
        combatxp[13] = 7400000;
        combatxp[14] = 9400000;
        combatxp[15] = 11900000;
        combatxp[16] = 15000000;
        combatxp[17] = 18500000;
        combatxp[18] = 22500000;
        combatxp[19] = 27000000;
        combatxp[20] = 32000000;
        return combatxp[arg];
}
