dhelp(str) {
  ...
  if(str == "dtitle"){cat("/players/pestilence/closed/dark/help/spells/dtitle.txt"); return 1;}
  ...
  if(str == "fiend"){cat("/players/pestilence/closed/dark/help/spells/fiend.txt"); return 1;}
  if(str == "wolverine"){cat("/players/pestilence/closed/dark/help/spells/wolverine.txt"); return 1;}
  if(str == "rank"){cat("/players/pestilence/closed/dark/help/rank.txt"); return 1;}
  if(str == "ranks"){cat("/players/pestilence/closed/dark/help/rank.txt"); return 1;}
  ...
  if(str == "slash"){cat("/players/pestilence/closed/dark/help/spells/slash.txt"); return 1;}
  ...
  if(str == "dist"){cat("/players/pestilence/closed/dark/help/spells/dist.txt"); return 1;}
  ...
  if(str == "punch"){cat("/players/pestilence/closed/dark/help/spells/punch.txt"); return 1;}
