score(){
        ...
        write(""+USER->query_al_title()+")/n");
        write("Level:");write(""+USER->query_level()+"+");
        write(pad(USER->query_extra_level(),8));
        write(pad(BLU+"HP"+NORM+BOLD+"("+NORM+HIB+USER->query_hp()+NORM+BOLD+"/"+NORM+HIB+USER->query_mhp()+NORM+BOLD+")"+NORM+""),20));
        write(RED+" SP"+NORM+BOLD+" ("+NORM+HIR+USER->query_sp()+NORM+BOLD+"/"+NORM+HIR+USER->query_msp()+NORM+BOLD+")"+NORM+"\t\n");
        write(pad("Experience ["+USER->query_exp()+"]"),20));write("Coins ["+USER->query_money()+"]  \n");
        write(pad("Gxp : "+TP->query_guild_exp()+"),20));write("Glvl: "+TP->query_guild_rank()+"\n");
