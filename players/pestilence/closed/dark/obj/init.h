...
init() {
  ...
  if(tp->query_level() < 20) {
    ...
    tp->set_guild_file(basename( this_object() ));
}
/*
...
write(""+HIK+BLINK+"WE ARE NOW OPEN!!!!!   PART OF THE GUILD HALL IS OPEN AND PK"+NORM+"\n"+
""+HIW+"SO I WOULDN'T SUGGEST IDLING IN THE UPPER PART OF THE GUILD HALL!"+NORM+".\n");
return 1;
}
/*
init_callout();
