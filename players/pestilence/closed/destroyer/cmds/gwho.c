...
main (string str)
{
  ...
  write(HIC+"You pay a small price as your DNA brings thoughts to your mind.\n\n"+NORM);
write("\t"+HIK+"<"+YEL+"P's Army Who"+HIK+">--------------------------------------------->\n\n"+NORM);
 ...
 case "-b":
    ...
    break;
  default:
    write(HIK+"       Name         Level  Guild       Gen   Spouse        Race\n"+NORM);
    cost = 10;
    break;
 }
...
get_gender(obj){
return cutstring(obj->query_gender(),3);
}
...
get_guild(obj){
 ...
 switch(obj->query_guild_name()){
  ...
  case "dervish":          return "Dervish  ";
  case "necromancer":      return "Necro    ";
  case "symbiotes":        return "Symbiote ";
  case "fallen":           return "Fallen   ";
  case "black circle":     return "B C Mage ";
  case "shardak":     return "Shardak  ";
 case ">A.o.P<":     return " >A.o.P< ";
  case "GirlsGoneWild":     return "WildGirlz";
  default:                 return cutstring(obj->query_guild_name(),9);
  }
}
