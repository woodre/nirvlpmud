...
long_desc =
  "    Beads hang down from the dorway of this lap dance room.  A\n"+
...
dest_dir = ({
"/players/pestilence/club/room/pervert.c","west",
});
...
list(){
     write("Usage buy name.\n"+
           "1. Dance with Sandy_____________________500 coins.\n"+
           "2. Dance with Fire _____________________500 coins.\n"+
           "3. Dance with Magic_____________________500 coins.\n");
     return 1;}
 ...
 if (call_other(this_player(), "query_money", 0) < cost) {
    write("I'm sorry, but you don't have enough coins for that.\n");
     return 1;
        ...
        if(str == "sandy"){
          if(DESIRE == 1){ write("Sandy has already danced.\n"); return 1; }
          cost = 500;
          move_object(clone_object("players/pestilence/club/mob/sandy.c"),TO);
          what = "Sandy";
          DESIRE +=1;
          }
        else if(str == "fire"){
          if(KIRSTEN == 1){ write("Fire has already danced.\n"); return 1; }
          cost = 500;
          move_object(clone_object("players/pestilence/club/mob/fire.c"),TO);
          what = "Fire";
          KIRSTEN +=1;
          }
        else if(str == "magic"){
          if(JESSICA == 1){ write("Magic has already danced.\n"); return 1; }
          cost = 500;
          move_object(clone_object("players/pestilence/club/mob/magic.c"),TO);
          what = "Magic";
          JESSICA +=1;
          }
