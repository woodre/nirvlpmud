...
"There is a sign on the wall that you could look at.\n",
  set_light(1);
  items=({
...
\n\tContents from bags will always be sold when selling",
  ...
  dest_dir=({
    "/players/pestilence/amity/room/nmain2.c", "east",
  });
  if( !find_object( "/players/pestilence/amity/rooms/shop.c" ) )
    call_other( "/players/pestilence/amity/rooms/shop.c", "???" );
