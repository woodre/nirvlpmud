...
if (!present("counter")) {
  move_object(clone_object("/players/pestilence/amity/room/counter.c"),
        this_object()); }
...
info_heals(){
   write("FOOD                     HEAL       TOX      COST\n"+
      ...
      "vanilla milkshake        50/50       F     1800 coins.\n"+
...
list(){
   write("1. hamburger____________________________1800 coins.\n"+
      ...
      "6. black berry pie______________________1200 coins.\n"+
      "7. lowfat vanilla milkshake_____________3300 coins.\n"+
      "8. blueberry pie________________________1200 coins.\n");
   return 1;}

buy_it(string str){
   if(!str){ write("Buy 1-8"); return 1; }
   if(str == "1"){
      cost = 1800;
...
if((VSHAKE > 35)  && (str == "2")){ write("They are all sold out right now.\n"); return 1;}
