...
dest_dir = ({
  "/players/pestilence/hospital/room/whall3.c","east",
  "/players/pestilence/hospital/room/whall5.c","west",
});
}
init() {
  ::init();
...
enter(str){
        if(!str){ write("You can only enter rooms 107 or 108.\n"); return 1; }
        if(str == "107"){
        write("You leave into hospital room 107.\n");
        move_object(this_player(), "/players/pestilence/hospital/room/107.c");  
        command("look",this_player());
        return 1;
          }
        if(str == "108"){
        write("You leave into hospital rom 108.\n");
        move_object(this_player(), "/players/pestilence/hospital/room/108.c");  
        command("look",this_player());
        return 1;
          }        
        else if(str == "room 107"){
         write("You leave into hospital room 107.\n");
        move_object(this_player(), "/players/pestilence/hospital/room/107.c"); 
        command("look",this_player());
        return 1;
          }
        else if(str == "room 108"){
        write("You leave into hospital rom 108.\n");
        move_object(this_player(), "/players/pestilence/hospital/room/108.c");
        command("look",this_player());
        return 1;
          ...
          write("You can only enter rooms 107 or 108.\n");
        return 0;
