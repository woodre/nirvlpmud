...
items = ({
  ...
  "up","It appears to be something Elemental.......",
  "u","It appears to be something Elemental.......",
...
"/room/south/sforst7","back",
  ...
  "/players/wicket/guild/hall/rooms/blah.c","up",
...
element(arg) {
   if(arg) { notify_fail("You must be a member of the Elementals to go up.\n");
       return 0;}
  if(!arg){
  if (this_player()->query_guild_name() == "Elementalist") {
     write("You enter the Elementalist Guild Hall.\n");
     TP->move_player("leaves up#//players/wicket/guild/hall/rooms/entrance.c");
     return 1; }
        else
            write("You must be a member of the Elementals to go up.\n");
        return 1;
    }
}
