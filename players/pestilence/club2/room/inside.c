...
"/players/pestilence/club2/room/pervert.c","north",
"/players/pestilence/club2/room/bar.c","west",
});
...
enter(str){
        ...
        move_object(this_player(), "/players/pestilence/club2/room/mens.c");  
        ...
        move_object(this_player(), "/players/pestilence/club2/room/ladies.c");  
        command("look",this_player());
        return 1;
          }
