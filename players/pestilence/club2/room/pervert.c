...
long_desc =
  ...
  "private dance with their favorite stripper.\n";
/*
add_property("NT");
add_property("PK");
*/
...
dest_dir = ({
"/players/pestilence/club2/room/inside.c","south",
"/players/pestilence/club2/room/lap2.c","east",
"/players/pestilence/club2/room/lap1.c","west",
"/players/pestilence/club2/room/lap3.c","northeast",
"/players/pestilence/club2/room/stage.c","north",
});
