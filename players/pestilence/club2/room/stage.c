...
long_desc =
  ...
  "their clothing.  The floor is a hardwood floor with a steel pole\n"+
...
dest_dir = ({
"/players/pestilence/club2/room/pervert.c","south",
"/players/pestilence/club2/room/backstage.c","north",
});
