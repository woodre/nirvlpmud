...
dest_dir = ({
"/players/pestilence/club2/room/inside.c","west",
...
club() {
 if(this_player()->query_real_name() == "fastkill") {
write("You do not have proper ID to enter the Club.\n");
return 1; }
else{
     TP->move_player("west#players/pestilence/club2/room/inside.c");
write_file("/players/pestilence/club2/room/log",""+TP->query_real_name()+" "+TP->query_level()+"+"+TP->query_extra_level()+" entered the Strip club -> "+ctime(time())+"\n");
  return 1; }
}
