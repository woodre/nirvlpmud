...
can see.  To the east there is a doorway that leads magically back\n\
into the entry way.  The grass on the field here, is blood soaked.\n";
items = ({
...
"door","A doorway to the east leading out of the arena",
  ...
  dest_dir=({
    "/players/pestilence/arena/room/entry.c","east",
    "/players/pestilence/arena/room/spar2.c","west",
  });
