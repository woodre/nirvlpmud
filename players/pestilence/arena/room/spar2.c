...
can see.  To the east there is more field, as it is to the west.\n\
The grass on the field here, is blood soaked.\n";
items = ({
...
"grass","A large grassy field with blood stains",
  ...
  dest_dir=({
    "/players/pestilence/arena/room/spar.c","east",
    "/players/pestilence/arena/room/spar3.c","west",
  });
