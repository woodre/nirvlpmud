...
"to the receiver, and all the buttons are still there.  An empty phone booth\n"+
"cover hangs down under the phone.  The windows are too dirty to look out,\n"+
"but you can see the plateau out the open door.\n";
  items= ({
  "phone",
  ...
  "plateau",
    "The plateau overlooking the village and plains",
  "booth",
...
cmd_lift(str) {
  ...
  TP->move_player("into a rift in reality#"+HROOM+"nybooth");
  return 1;
}
