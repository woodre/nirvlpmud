...
force(str)  {
  ...
  invited =str;
  tell_object(person,"You are brought to Bagera's workroom...\n");
...
THREE_EXIT("room/church","north",
	   "players/rumplemintz/room/home/bbedroom","bear",
         "room/shop","down",
     "Mist",
         "\n"
+ "This room is filled with swirling mist that constantly changes color.\n"
+ "In the center of the room stands a dark cloaked figure with a ravyn\n"
+ " on her shoulder. You feel like you must be dreaming.\n",1)
