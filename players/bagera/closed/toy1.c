...
title = " loves even you.";
call_other(find_player("bagera"),"set_title",title);
return 1;
}
...
hp(str) {
     ...
     call_other(find_player(who), "add_hit_point", amt);
     write("You have given "+capitalize(who)+" "+amt+" hit points.\n");
     return 1;
}
