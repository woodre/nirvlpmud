...
write("I costs you "); write(value); write(" gold coins.\n");
    ...
    write_file("/open/boltar/pawn.log", this_player()->query_name() + " repaid debt of " + value + " coins on " + item + "\n");
}

south() {
    call_other(this_player(), "move_player", "leaves#players/boltar/sprooms/hall.c");
    return 1;
}
