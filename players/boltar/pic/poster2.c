...
/*
   cat("/players/boltar/pic/PIC2A");
   cat("/players/boltar/pic/PIC2B");
   while ( x < 20000) {
    x+=1;
   }
   cat("/players/boltar/pic/PIC2C");
*/
call_other("/players/boltar/templar/templar", "more", "/players/boltar/pic/PIC2");
}
