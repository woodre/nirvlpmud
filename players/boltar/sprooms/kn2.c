...
extra_reset() {
   if (!knight || !living(knight)) {
       ...
       call_other(knight, "set_hp",370);
       call_other(knight, "set_wc",35);
...
ONE_EXIT("players/boltar/lv1/kn_ent", "north",
         "Knights room",
    "This room is quite small, the walls are painted the darkest black you \n" +
    "have ever seen.  In the corner there appears to be what must be someone's living quarters, a small bed
"+\n"+
