...
call_other(hamr, "set_id", "hammer");
call_other(hamr, "set_name", "hammer");
call_other(hamr, "set_short", "A small elven hammer");
call_other(hamr, "set_long", "A small elven hammer\n");
...
ONE_EXIT("players/boltar/santaland/wk_shp_ent.c", "north",
 "The toyelf's place",
