...
FOUR_EXIT("players/boltar/test/thingroom", "north",
	  "players/boltar/test/itroom", "south",
	  "players/boltar/test/room3", "west",
	  "players/boltar/test/room1", "east",
	  "The Entrance Hall",
...
starta_yarr() {
    if(!yarr || !living(yarr)) {
	yarr = clone_object("obj/monster_new.c");
...
call_other(yarr, "add_money", 238);
	move_object(yarr, "players/boltar/test/room2");
