...
north() {
  call_other(this_player(),"move_player","north#"+CASINO+"hall3x2");
  return 1;
}
east() { 
  call_other(this_player(),"move_player","east#"+CASINO+"hall3x4");
  return 1;
}
up() { 
...
down() {
  call_other(this_player(),"move_player","down#"+CASINO+"hall2x3");
  return 1;
}
...
long(str) {
  ...
  "corner of the wall reads, 'Rooms 351 - 375'.  Soft track lighting\n"+
  ...
  "To the east is a similarly decorated hallway, the marble plate \n"+
  "on the corner reading, 'Rooms 376 - 399'.  Another hallway lies to\n"+
  "the north, its room numbers obscured from this distance. A well-lit\n"+
  "stairway leading to the other floors of the hotel is tucked away\n"+
...
id(str) {
    return str == "door" || str ==  "plate" || str == "plaque" || 
           ...
           str== "hallway" || str=="stairs" || str=="stairway" ||
