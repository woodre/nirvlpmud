...
north() {
  call_other(this_player(),"move_player","north#"+CASINO+"hall4x2");
  return 1;
}
east() { 
  call_other(this_player(),"move_player","east#"+CASINO+"hall4x4");
  return 1;
}
up() { 
  call_other(this_player(),"move_player","up#"+CASINO+"hall4x3");
  return 1;
}
down() {
  call_other(this_player(),"move_player","down#"+CASINO+"hall3x3");
  return 1;
}
...
long(str) {
  ...
  if (str=="stairway" || str == "stairs")
    write("Light from the stairway alcove spills into the hallway,\n"+
  ...
  "corner of the wall reads, 'Rooms 451 - 475'.  Soft track lighting\n"+
  ...
  "and air conditioning unit.  To the east is a similarly decorated \n"+
  ...
  "distance.  A well-lit stairway to the lower floors of the hotel is\n"+
  "tucked away in an alcove to the west allowing travel downwards.\n");
}
