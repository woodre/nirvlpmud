...
north() {
  call_other(this_player(),"move_player","north#"+CASINO+"hall2x2");
  return 1;
}
east() { 
  call_other(this_player(),"move_player","east#"+CASINO+"hall2x4");
  return 1;
}
up() { 
  call_other(this_player(),"move_player","up#"+CASINO+"hall3x3");
  return 1;
}
down() {
  call_other(this_player(),"move_player","down#"+CASINO+"hall1w1");
  return 1;
}
