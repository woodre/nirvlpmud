...
north() {
  call_other(this_player(),"move_player","north#"+CASINO+"hall3x1");
  return 1;
}
west() { 
  call_other(this_player(),"move_player","west#"+CASINO+"hall3x3");
  return 1;
}
enter(str) {
...
long(str) {
  ...
  "corner of the wall reads, 'Rooms 376 - 399'.  Soft track lighting\n"+
  ...
  "To the west is a similarly decorated hallway, the marble plate \n"+
  "on the corner reading, 'Rooms 351 - 375'.  Another hallway lies to\n"+
  "the north, its room numbers obscured from this distance. \n");
}
