...
east() {
  call_other(this_player(),"move_player","east#"+CASINO+"front_desk");
  return 1;
}
west() { 
/*
  write("The casino is currently blocked by a portable wall, a sign\n"+
   "reads that it is still under construction.\n");
  return 1;
*/
  call_other(this_player(),"move_player","west#"+CASINO+"floor/casinofloor1");
  return 1;
}
...
str=="panel" || str=="panels" || str=="ceiling" || str=="frescoes" ||
str=="flower" || str=="flowers" || str=="ivy" || str=="handrail" ||
str=="handrails" || str=="grecian urn" || str=="urn" ||
str=="chandelier" || str=="floor" || str=="marble" || str=="foyer" ||
str=="lobby" || str=="staircase" || str=="stairs";
}

up() {
    call_other(this_player(),"move_player","up#"+CASINO+"hall2x3");
    return 1;
}
