...
long() {
    write("This is the Guild of Assassin's bulletin board.  Please feel\n");
    write("free to write whatever you want on here.\n");
...
reset(arg) {
    if (arg)
	return;
    restore_object("players/deathmonger/ASSASSIN/board_save");
}
...
get_body(str) {
	...
	new_body = 0;
	new_hd = 0;
        save_object("players/deathmonger/ASSASSIN/board_save");
	write("Ok.\n");
	who = 0;
	return;
    }
