...
string query_real_name() { return "Earwax's Practice Dummy"; }
string 
short()
{
    return HIK+"Shardak, "+HIR+"the Bringer of Death and Destruction"+NORM+NORM;
}

status
id(string s)
{
    return ( s == "knight" || s == "shardak" || s == "dummy" );
}

string
query_name()
{
return HIK+"Shardak,"+HIR+" the Destroyer"+NORM+NORM;
return HIK+"Shardak"+NORM+NORM+" (hunting Jaraxle)";
return "Jaraxle's wife (pissed)";
    return HIK+"Shardak, "+HIR+"the Bringer of Death and Destruction"+NORM+NORM;;
}
