...
{
    ::create();
    set_short(RED+"The stables"+NORM);
    set_long(HIK+"\
An awful smell fills this cramped room. The acrid stench rises from\n\
an iron grating covering a man-sized hole in the middle of the floor.\n\
