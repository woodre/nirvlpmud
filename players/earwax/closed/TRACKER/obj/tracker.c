...
long()
{
  ...
  if (this_player() != environment())
    write("\
If you're level 10, you can get your very own PK Tracker!.  There\n\
are dispensers in Earwax's area (4w,all n,say qtip,3n) and Jareel's\n\
Hall of Legends (4e,3s,e,enter hall).\n");
  else
