 ...
 *                 04/03/14 - Gnar - Added query_land_owner
 * **************************************************************************/
...
/* ***************************************************************************
 * Function Name: query_land_owner
 * Description:   Returns if a player is already a land owner
 * Arguments:     Name of the player
 * Returns:      0 - not owner 1 - is an owner
 * **************************************************************************/
 int
 query_land_owner( string pname ) {
   int index, size;
   
   for( index = 0, size = sizeof(Info); index < size; index++ ) {
     if( LOWNER == pname )
       return 1;
   }
