...
::reset(arg);
  ...
  FileName = "/players/earwax/housing/data/dragnar/room/Dragnar_Wastelands_15_1.c";
  RoomNum = 1;
  ...
  get_master();
  items = ({  });
  dest_dir = ({ "/players/earwax/housing/data/dragnar/room/Dragnar_Wastelands_15_0", "thereisnowayyourgettingoutofthisroomssoyoubetterjustgiveupnowcauseyourdead" });
}
