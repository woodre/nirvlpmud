...
::reset(arg);
  ...
  FileName = "/players/earwax/housing/data/mythos/room/Mythos_Ancient_38_1.c";
  RoomNum = 1;
  BaseFilename = "/players/earwax/housing/data/mythos/room/Mythos_Ancient_38_";
  Entrance = "/players/mythos/aroom/village.c";
  get_master();
  items = ({  });
  dest_dir = ({ "/players/earwax/housing/data/mythos/room/Mythos_Ancient_38_0", "west",
"/players/earwax/housing/data/mythos/room/Mythos_Ancient_38_2", "down" });
}
