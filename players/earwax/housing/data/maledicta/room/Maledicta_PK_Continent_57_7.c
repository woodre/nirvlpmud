...
::reset(arg);
  ...
  FileName = "/players/earwax/housing/data/maledicta/room/Maledicta_PK_Continent_57_7.c";
  RoomNum = 7;
  ...
  get_master();
  items = ({  });
  dest_dir = ({ "/players/earwax/housing/data/maledicta/room/Maledicta_PK_Continent_57_0.c", "back" });
}
