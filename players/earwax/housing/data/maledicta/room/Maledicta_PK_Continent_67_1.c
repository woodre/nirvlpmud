...
::reset(arg);
  ...
  FileName = "/players/earwax/housing/data/maledicta/room/Maledicta_PK_Continent_67_1.c";
  RoomNum = 1;
  ...
  get_master();
  items = ({  });
  dest_dir = ({ "/players/earwax/housing/data/maledicta/room/Maledicta_PK_Continent_67_0.c", "back" });
}
