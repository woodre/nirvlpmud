...
::reset(arg);
  ...
  Short2 = ": )*(THE HIDEOUT)*([2;37;0m[2;37;0m[2;37;0m[2;37;0m";
  long_desc = "This room hasn't been described yet.\nType [1;37mhcommands[2;37;0m[2;37;0m to see available commands.\n";
  FileName = "/players/earwax/housing/data/maledicta/room/Maledicta_PK_Continent_57_1.c";
  RoomNum = 1;
  ...
  get_master();
  items = ({  });
  dest_dir = ({ "/players/earwax/housing/data/maledicta/room/Maledicta_PK_Continent_57_0", "home" });
}
