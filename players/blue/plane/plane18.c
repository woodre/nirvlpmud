...
dest_dir = ({
   "players/blue/plane/plane17","north",
   "players/blue/plane/plane19","south"
});
...
do_move() {
      if(dir==1) {
         ...
         move_object(this_player(), "players/blue/plane/plane17");
      ...
      if(dir==2) {
         say(capitalize(this_player()->query_name()) + " leaps to the north"+
            " and lands on the next plane.\n");
         write("You leap to the next plane.\n");
         move_object(this_player(),"players/blue/plane/plane19");
         command("look", this_player());
         say(capitalize(this_player()->query_name()) + " arrives.\n");
         return 1;
   }
