...
dest_dir = ({
   "players/blue/plane/plane8","east",
   "players/blue/plane/plane6","west"
});
...
do_move() {
      if(dir==3) {
         ...
         move_object(this_player(), "players/blue/plane/plane8");
      ...
      if(dir==4) {
         say(capitalize(this_player()->query_name()) + " leaps to the east"+
            " and lands on the next plane.\n");
         write("You leap to the next plane.\n");
         move_object(this_player(),"players/blue/plane/plane6");
         command("look", this_player());
         say(capitalize(this_player()->query_name()) + " arrives.\n");
         return 1;
   }
