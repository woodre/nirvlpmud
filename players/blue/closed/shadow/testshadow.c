...
#define SAVEPATH "players/blue/closed/shadow/shadows/"
...
promote_me(num) {
   int tmp_shxp;
   tmp_shxp = shxp;
   if(shlevel + num > 12 && TP->query_real_name() != "blue") return 0;
   shlevel += num;
   if(shlevel < 13)
...
update_me(str) {
  object ob;
   ...
   ob = clone_object("/players/blue/closed/shadow/shadow.c");
