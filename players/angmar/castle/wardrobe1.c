...
reset(status arg) {
  ...
  long_desc =
"You are inside a wardrobe. You feel magic forces waiting to be released...\n";
  dest_dir = ({
    "/players/angmar/castle/library", "out"
  });
  items = ({
    "door", "It is closed"
  });
...
move_to_other() {
  ...
  while(ob) {
    ...
    move_object(ob,"players/angmar/castle/wardrobe2");
...
out() {
  ...
  this_player()->move_player("out#players/angmar/castle/library");
  return 1;
}
...
open_door(string str) {
  ...
  "players/angmar/castle/library"->remove_item("wardrobe");
  "players/angmar/castle/library"->add_item("wardrobe",
    "It can take you to fairyland.\nThe door is open");
