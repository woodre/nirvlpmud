...
extra_reset() {
	...
	call_other(kraken, "set_level", 19);
        call_other(kraken, "set_hp", 475);
	call_other(kraken, "set_short", "A kraken");
	call_other(kraken, "set_wc", 28);
	call_other(kraken, "set_ac", 16);
	call_other(kraken, "set_al", -1500);
	call_other(kraken, "set_aggressive", 1);
        call_other(kraken, "set_chance",20);
	...
	call_other(treasure, "set_value", 10000);
