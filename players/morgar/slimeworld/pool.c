...
extra_reset() {
	...
	call_other(slug2, "set_level", 14);
        call_other(slug2, "set_hp", 210);
	call_other(slug2, "set_short", "A puddle of slime");
	call_other(slug2, "set_wc", 18);
	call_other(slug2, "set_ac", 11);
	...
	call_other(slug1, "set_level", 14);
        call_other(slug1, "set_hp", 210);
	call_other(slug1, "set_short", "A slime slug");
	call_other(slug1, "set_wc", 18);
	call_other(slug1, "set_ac", 11);
