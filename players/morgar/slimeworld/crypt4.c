...
extra_reset() {
	...
	call_other(zombie, "set_level", 8);
        call_other(zombie, "set_hp", 1200);
	call_other(zombie, "set_short", "A zombie");
	call_other(zombie, "set_wc", 12);
	call_other(zombie, "set_ac", 7);
    ...
    if (!skeleton || !living(skeleton)) {
        ...
        call_other(skeleton, "set_hp", 120);
        call_other(skeleton, "set_short", "A skeleton");
        call_other(skeleton, "set_wc", 12);
        call_other(skeleton, "set_ac", 7);
