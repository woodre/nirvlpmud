...
extra_reset() {
    if (!paladin || !living(paladin)) {
        ...
        call_other(paladin, "set_hp", 1000);
        call_other(paladin, "set_ac", 18);
	...
	move_object(paladin, this_object());
        ...
        call_other(weapon, "set_name", "holy revenger");
...
/*
	return "miss";
     this causes errors so i have replaced with a return -wc of weapon - mythos <3-3-1999>
*/
   return -20;
    }
    return 0;
