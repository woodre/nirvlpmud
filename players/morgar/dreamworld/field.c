...
extra_reset() {
	...
	call_other(rabbit, "set_hp", 75);
	call_other(rabbit, "set_wc", 9);
	call_other(rabbit, "set_ac", 5);
...
FOUR_EXIT("players/morgar/dreamworld/field","north",
         "players/morgar/dreamworld/field","south",
         "players/morgar/dreamworld/field","east",
         "players/morgar/dreamworld/field","west",
         "Dream field",
