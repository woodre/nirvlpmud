...
TWO_EXIT("players/morgar/hall2", "west",
	 "players/morgar/hall4", "east",
	 "Hall of Gateways",
	 "This is the middle of the Hall of Gateways.\n", 1)
...
extra_reset() {
    if (!mirror) {
        ...
        move_object(mirror, "players/morgar/techworld/entry");
    }
}
