...
force(str)  {
  ...
  invited =str;
  tell_object(person,"You are brought to Doctor's workroom...\n");
...
TWO_EXIT("room/pub2","north",
         "room/post","down",
         "A mess",
         "\n"
+ "This room is filled with swirling mist that constantly changes color.\n"
+ "All around you see spell books lying all over the floor\n"
+ " with crumpled notes hanging out of the covers.\n",1)
