...
e1() {
    if (exit_num == 1)
	call_other(this_player(), "move_player", "forward#/players/doctor/TARDIS/corridor5");
    else
...
e2() {
    if (exit_num == 2)
	call_other(this_player(), "move_player", "left#/players/doctor/TARDIS/corridor6");
    else
	call_other(this_player(), "move_player", "left#/players/doctor/TARDIS/maze1");
    return 1;
}

e3() {
    if (exit_num == 3)
	call_other(this_player(), "move_player", "right#/players/doctor/TARDIS/corridor7");
    else
	call_other(this_player(), "move_player", "right#/players/doctor/TARDIS/maze1");
    return 1;
}
