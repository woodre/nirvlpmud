...
e0() {
    if (exit_num == 0)
	call_other(this_player(), "move_player", "back#/players/doctor/TARDIS/maze4");
    else
...
e1() {
    if (exit_num == 1)
	call_other(this_player(), "move_player", "forward#/players/doctor/TARDIS/maze4");
    else
...
e2() {
    if (exit_num == 2)
	call_other(this_player(), "move_player", "left#/players/doctor/TARDIS/maze4");
    else
...
e3() {
    if (exit_num == 3)
	call_other(this_player(), "move_player", "right#/players/doctor/TARDIS/maze4");
    else
