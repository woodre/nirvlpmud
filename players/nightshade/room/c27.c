 ...
 *
 * Purpose: A room object used for dragon room.
 *
 * History:
 *          
 ******************************************************************************/
...
monster();
   if(arg) return;
     ...
     long_desc =
"This is the lair of Hephaestus, a mighty red dragon. He has now\n"+
"taken up residence here, preventing the noble inhabitants of the\n"+
...
write("It would not be a good idea to try to sneak by Hephaestus.\n"+
