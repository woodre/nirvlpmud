...
"make a decent torch.\n";
      dest_dir = 
      ({ "/players/nightshade/room/forest21", "south",
    "players/nightshade/room/trail5", "east",
 "players/nightshade/room/forest9", "north",
"players/nightshade/room/forest14", "west",
      });
}
monster()
{
...
if(!present("rothe"))
{
blah=clone_object("players/nightshade/mons/rothe");
