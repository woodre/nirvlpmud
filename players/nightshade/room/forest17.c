...
"make a decent torch.\n";
      dest_dir = 
      ({ "/players/nightshade/room/forest23", "south",
    "players/nightshade/room/forest18", "east",
 "players/nightshade/room/forest11", "north",
"players/nightshade/room/forest16", "west",
      });
}
