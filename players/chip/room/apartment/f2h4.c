      /*                                                                    
       *    File: /players/chip/room/apartment/f2h4.c                
       *    Function: room
...
long_desc =
	...
	"destructive. The hall continues back to the east.\n";
...
dest_dir =
({
	"/players/chip/room/apartment/f2h3.c",     "east",
	"/players/chip/room/apartment/apt15.c",     "enter_15",
	"/players/chip/room/apartment/apt16.c",     "enter_16",
	});
