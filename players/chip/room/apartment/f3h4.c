      /*                                                                    
       *    File: /players/chip/room/apartment/f3h4.c                
       *    Function: room
...
long_desc =
	...
	"destructive. The hall continues to the east and the landlord's\n"+
	"suite is unlocked to the west.\n";
...
dest_dir =
({
	"/players/chip/room/apartment/f3h3.c",     "east",
	"/players/chip/room/apartment/apt23.c",     "enter_23",
	"/players/chip/room/apartment/apt24.c",     "enter_24",
	"/players/chip/room/apartment/f3lndlrd.c",     "enter_25",
	});
