      /*                                                                    
       *    File: /players/chip/room/apartment/f2h2.c                
       *    Function: room
...
dest_dir =
({
	"/players/chip/room/apartment/f2h3.c",     "west",
	"/players/chip/room/apartment/f2h1.c",     "east",
	"/players/chip/room/apartment/apt11.c",     "enter_11",
	"/players/chip/room/apartment/apt12.c",     "enter_12",
	});
