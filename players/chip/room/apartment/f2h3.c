      /*                                                                    
       *    File: /players/chip/room/apartment/f2h3.c                
       *    Function: room
...
dest_dir =
({
	"/players/chip/room/apartment/f2h2.c",     "east",
	"/players/chip/room/apartment/f2h4.c",     "west",
	"/players/chip/room/apartment/apt13.c",     "enter_13",
	"/players/chip/room/apartment/apt14.c",     "enter_14",
	});
