      /*                                                                    
       *    File: /players/chip/room/apartment/f1h1.c                
       *    Function: room
...
dest_dir =
({
	"/players/chip/room/apartment/enter.c",     "west",
	"/players/chip/room/apartment/f1h2.c",     "east",
	"/players/chip/room/apartment/apt3.c",     "enter_3",
	"/players/chip/room/apartment/apt4.c",     "enter_4",
	});
