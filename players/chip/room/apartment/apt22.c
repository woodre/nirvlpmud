/*                                                                    
 *    File: /players/chip/room/apartment/apt22.c                
 *    Function: room
...
reset(arg)
{
  ...
  if( !present("man", this_object()) )
    move_object(clone_object("/players/chip/mobs/apartment/hman2.c"),  this_object());
  if(arg) return;
  set_light(1);
  ...
  long_desc =
    ...
    "cans of food amongst all the nastiness. I wouldn't chance trying them though, as\n"+
