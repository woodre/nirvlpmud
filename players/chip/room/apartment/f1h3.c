      /*                                                                    
       *    File: /players/chip/room/apartment/f1h3.c                
       *    Function: room
...
long_desc =
	"You stand in the hallway on the first floor of a long abandoned\n"+
...
dest_dir =
({
	"/players/chip/room/apartment/f1h2.c",     "west",
	"/players/chip/room/apartment/f1stairs.c",     "east",
	"/players/chip/room/apartment/apt7.c",     "enter_7",
	"/players/chip/room/apartment/apt8.c",     "enter_8",
	});
