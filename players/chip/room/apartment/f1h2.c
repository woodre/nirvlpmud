      /*                                                                    
       *    File: /players/chip/room/apartment/f1h2.c                
       *    Function: room
...
dest_dir =
({
	"/players/chip/room/apartment/f1h1.c",     "west",
	"/players/chip/room/apartment/f1h3.c",     "east",
	"/players/chip/room/apartment/apt5.c",     "enter_5",
	"/players/chip/room/apartment/apt6.c",     "enter_6",
	});
