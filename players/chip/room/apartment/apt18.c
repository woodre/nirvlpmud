/*                                                                    
 *    File: /players/chip/room/apartment/apt18.c                
 *    Function: room
...
reset(arg)
{
  ...
  if( !present("dog", this_object()) )
    move_object(clone_object("/players/chip/mobs/apartment/dog2.c"),  this_object());
  if(arg) return;
  set_light(1);
  ...
  dest_dir =
  ({
    "/players/chip/room/apartment/f3h1.c",     "hall",
  });
}