...
"hall continues east and west from here, and it looks like there's more classrooms to\n"+
"the west.\n";
...
({
"doors",
"The doors are labelled as F1 and F2",
"banner",
...
dest_dir =
({
"/players/chip/room/hdgmd/schools/elem/westhall3.c",     "west",
"/players/chip/room/hdgmd/schools/elem/westhall1.c",     "east",
"/players/chip/room/hdgmd/schools/elem/first1.c",     "north",
"/players/chip/room/hdgmd/schools/elem/first2.c",     "south",
});
}
