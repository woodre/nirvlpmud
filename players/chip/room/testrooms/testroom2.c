...
"plain empty. Perhaps if you scream and cry, the walls might hear you.\n";
    move_object(clone_object("/players/trix/castle/primonst/altarboy.c"), this_object());
    move_object(clone_object("/players/trix/castle/primonst/altarboy.c"), this_object());
    move_object(clone_object("/players/trix/castle/primonst/altarboy.c"), this_object());
    move_object(clone_object("/players/trix/castle/primonst/altarboy.c"), this_object());
    move_object(clone_object("/players/trix/castle/primonst/altarboy.c"), this_object());
...
dest_dir =
({
"/players/chip/room/testrooms/testroom1.c",     "west",
"/players/chip/room/testrooms/testroom3.c",     "east",
});
}
