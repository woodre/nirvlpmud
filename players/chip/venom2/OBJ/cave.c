...
short(){
if(!this_player()) return "A NeoSymbiote's Cave"; /* err... that was lame. [7.8.01] by verte */
...
if(environment(this_player()) == this_object()){
  ...
  "covered in living "+HIK+"Dark Matter"+NORM+" which glistens and shifts\n"+
  ...
  if(this_player()->query_real_name() == owner){
    write("As the owner of the cave you may do the following:\n"+
          ""+BOLD+"close crevice"+NORM+"   - block off the entrance and exit\n"+
          ""+BOLD+"open crevice"+NORM+"    - unblock the entrance and exit\n");
          }
