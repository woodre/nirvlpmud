...
attack_tentacles(){
	...
	if(boo > 5 && random(100) < 30){
		switch(random(20) + 1){
			...
			UN+" hovers over the ground on strands of wavering "+HIK+"Dark Matter"+NORM+"...\n");
			break;
			case 19:
			tell_room(ENVU,
			UN+" peers down at "+UP+" opponent from atop "+HIK+"Dark Matter Tentacles"+NORM+".\n");
			break;
			case 18:
			tell_room(ENVU,
			UN+" stands amid waving tentacles of "+HIK+"Dark Matter"+NORM+".\n");
			break;
			case 17:
			tell_room(ENVU,
			...
			case 16:
			tell_room(ENVU,
			"Aloft tentacles of "+HIK+"Dark Matter"+NORM+", "+UN+" stands confident in the face of danger.\n");
			break;
			case 15:
			tell_room(ENVU,
			...
			case 13:
			tell_room(ENVU,
			UN+" points at "+ATTN+" and sends tendrils of "+HIK+"Dark Matter"+NORM+" leaping forward.\n");
			break;
			case 12:
			tell_room(ENVU,
			...
			case 10:
			tell_room(ENVU,
			UN+" raises "+UP+" hands to the sky as "+HIK+"Dark Matter"+NORM+" leaps from his back toward "+ATTN+".\n");
			case 9:
			tell_room(ENVU,
			UN+" clenches "+UP+" fists as "+UPR+" commands "+HIK+"Dark Matter"+NORM+" to lash out at "+ATTN+".\n");
			break;
			case 8:
			tell_room(ENVU,
			UN+" rises into the air on "+HIK+"Dark Matter"+NORM+" tendrils as "+UPR+" glares at "+ATTN+".\n");
			break;
			case 7:
			tell_room(ENVU,
			...
			case 6:
			tell_room(ENVU,
			UN+" glides forward on "+HIK+"Dark Matter"+NORM+" wings.\n");
			break;
			case 5:
			tell_room(ENVU,
			UN+"'s "+HIK+"Dark Matter"+BOLD+" Wings"+NORM+" unfurl and separate into tendrils of charging death.\n");
			break;
			case 4:
			tell_room(ENVU,
			...
			case 3:
			tell_room(ENVU,
			UN+" dances with the rhythm of "+UP+HIK+" dark tendrils"+NORM+" as "+UPR+" moves in on "+ATTN+".\n");
			break;
			case 2:
			tell_room(ENVU,
			UN+"'s "+HIK+"Dark Matter Tentacles"+NORM+" fill the room with chaos and motion.\n");
			break;
			case 1:
			tell_room(ENVU,
			"You watch as "+UN+" calmly glides forward on "+HIK+"Dark Matter"+NORM+" Tendrils...\n", ({USER}));
			break;
		}
	}
	yah = 0;
	...
	switch(random(5) + 1){
		...
		case 4: how = "Annihilate"; how2 = "Annihilated"; break;
		case 3: how = "Demolish"; how2 = "Demolished"; break;
		case 2: how = "Wreck"; how2 = "Wrecked"; break;
		case 1: how = "Slash"; how2 = "Slashed"; break;
	}
	...
	if(!yah) return tot;
		...
		tell_object(ATT,
		"You are "+how2+" by a "+HIK+"Dark Matter"+NORM+" Tentacle from "+UN+"!\n");
	}
	else{
		tell_object(USER,
			COLOR+"["+NORM+BOLD+"Tentacles"+NORM+COLOR+"]"+NORM+""+
		"  "+get_number(yah)+" "+HIK+"Dark Matter Tentacles"+NORM+" lash out and "+how+" "+ATTN+"!\n");
		tell_object(ATT,
...
defense_tentacles(){
	...
	if(boo > 3 && random(100) < 40){
		switch(random(10) + 1){
			case 10:
			tell_room(ENVU,
			UN+"'s Tentacles whip about furiously to defend their Master!\n");
			break;
			case 9:
			tell_room(ENVU,
			UN+"'s "+HIK+"Dark Matter"+NORM+" tentacles wrap around "+ATTN+"'s arms and legs and wrestle with them!\n");
			break;
			case 8:
			tell_room(ENVU,
			...
			case 7:
			tell_room(ENVU,
			UN+"'s "+HIK+"Dark Matter"+NORM+" tendrils fly forward and partially deflect the incoming attack from "+ATTN+"!\n");
			break;
			case 6:
			tell_room(ENVU,
			...
			case 5:
			tell_room(ENVU,
			UN+" stands calm amid a dancing storm of "+HIK+"Dark Matter"+NORM+" Tentacles.\n");
			break;
			case 4:
			tell_room(ENVU,
			UN+" rises into the air atop tentacles of "+HIK+"Dark Matter..."+NORM+"\n");
			break;
			case 3:
			tell_room(ENVU,
	...
	if(yah < 1) return 0;
      ...
      tell_object(USER,
		...
		" A "+HIK+"Dark Matter"+BOLD+" Tentacle"+NORM+" "+h2+" and "+hh2+" "+ATTN+""+hhh+"\n");
      if(ATT)
		tell_room(USER,
      ...
      if(ATT)
		tell_object(USER,
			BOLD+"["+NORM+COLOR+"Defend"+NORM+BOLD+"] "+NORM+""+
		" "+capitalize(get_number(yah))+" "+HIK+"Dark Matter"+BOLD+" Tentacles"+NORM+" "+h+" and "+hh+" "+ATTN+""+hhh+"\n");
      if(ATT)
		tell_room(USER,
    ...
    while(ob)
    {
      if(ob->is_armor())
      {
        if(ob->query_type() == "misc" || ob->query_type() == "boots" ||
           ...
           ob->query_type() == "bracers" || ob->query_type() == "belt" ||
