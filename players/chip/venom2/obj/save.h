...
return "/players/chip/venom2/neo_venom.c:"; }
*/
...
guild_update()
{
  tell_object(USER,       ""+query_color()+"Restoring Symbiotic Link...."+NORM+"\n");
  save_object(SAVE_PATH+NAME);
  tell_object(USER,
  ""+query_color()+"done."+NORM+"\n");
  move_object(clone_object("/players/chip/venom2/neo_venom.c"), USER);
