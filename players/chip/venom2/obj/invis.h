...
new_invis(){
	...
	if(mp < 5){
		write("You lack the "+HIK+"Dark Matter"+NORM+" to perform that.\n");
		return 1;
	}
	...
	tell_room(environment(USER),
		USER->query_name()+" is suddenly covered by "+HIK+"Dark Matter"+NORM+".\n"+
		"It then changes color and matches the background of the room.\n"+
	USER->query_name()+" vanishes from sight.\n", ({USER}));
	tell_object(USER,
		"You are enshrouded in "+HIK+"Dark Matter..."+NORM+"\n"+
