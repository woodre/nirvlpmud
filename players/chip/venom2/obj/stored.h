...
store_coins(int i){
	int moneymoney;
	if(file_name(environment(this_player())) != "players/fred/closed/venom/symb_room"){
		return 0;
	}
	if(!i){
...
if(stored_mon >= 1000000 && stored_mp >= 5000 && stored_sp >= 5000 && !lair &&
	...
	write_file("/players/chip/venom2/log/store_coins2",
...
store_mp(int i){
	...
	mp -= mpmp;
	stored_mp += mpmp;
	write("You expend "+mpmp+" "+HIK+"Dark Matter"+NORM+" into the pool.\n");
...
if(stored_mon >= 1000000 && stored_mp >= 5000 && stored_sp >= 5000 && !lair &&
	...
	write_file("/players/chip/venom2/log/store_mp2",
...
if(stored_mon >= 1000000 && stored_mp >= 5000 && stored_sp >= 5000 && !lair &&
	...
	write_file("/players/chip/venom2/log/store_sp2",
