...
BOLD+"["+HIR+USER->query_hp()+NORM+"/"+HIR+USER->query_mhp()+NORM+BOLD+"] ["+HIG+USER->query_sp()+NORM+"/"+HIG+USER->query_msp()+NORM+BOLD+"] "+
   NORM+"MP "+gcolor+mp+NORM+" "+
	"F: "+gcolor+USER->query_stuffed()*100/(USER->query_max_stuff())+NORM+" "+
	"S: "+gcolor+USER->query_soaked()*100/(USER->query_max_soak())+NORM+" "+
	"I: "+gcolor+USER->query_intoxination()*100/(USER->query_max_intox())+NORM+" "+
   "T: "+gcolor+USER->query_infuse()*100/(USER->query_level()*9)/2+NORM+" "+
   "$$ "+gcolor+USER->query_money()+NORM+" ");
