/*
 *    File: /players/chip/mobs/apartment/bum1.c
 *    Function: NPC
...
reset(arg)
{
  ...
  set_race("human");
  set_alias("bum");
  set_short(""+YEL+"A ragged looking bum"+NORM+"");
  set_long(
  ...
  set_spell_mess2("The bum breaks a 22 oz beer bottle over your head!\n");
  set_spell_mess1("The bum breaks a 22 oz beer bottle over his enemy's head!\n");
