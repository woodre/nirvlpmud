/*
 *    File: /players/chip/mobs/apartment/dog1.c
 *    Function: NPC
...
reset(arg)
{
  ...
  set_race("canine");
  set_alias("dog");
  set_short(""+RED+"A rabid rottweiler"+NORM+"");
  set_long(
  ...
  set_heal(8,2);
  set_chat_chance(10);
  load_chat("The rottweiler growls deeply.\n");
  load_chat("You suddenly become very uncomfortable around the beast.\n");
  load_chat("The rottweiler tears some flesh away from a dead body, and eats it.\n");
  set_chance(20);
