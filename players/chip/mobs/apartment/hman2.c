/*
 *    File: /players/chip/mobs/apartment/hman2.c
 *    Function: NPC
...
reset(arg)
{
  ...
  set_race("human");
  set_alias("man");
  set_short(""+HIY+"A crazy, homeless man"+NORM+"");
  set_long(
  ...
  set_heal(8,2);
  set_chat_chance(10);
  load_chat("The man talks to himself.\n");
  load_chat("The man looks in a mirror and says: \"I wish you would have done things differently...\"\n");
  set_chance(20);
  set_spell_dam(random (15) + 18);
  set_spell_mess2("The dirty man flings a cockroach at you.\n");
  set_spell_mess1("The dirty man flings a cockroach at his attacker.\n");
