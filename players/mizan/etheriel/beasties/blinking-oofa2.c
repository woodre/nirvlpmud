...
reset(arg)
{
    ...
    set_ep(270000);
    set_alias("oofa");
    set_short(BLINK+"A blinking Oofa (loud)"+UNBLINK);
    ...
    what=clone_object("players/mizan/etheriel/items/jacket-stealing.c");
    move_object(clone_object("players/mizan/etheriel/items/flashlight.c"), this_object());
