...
#define LEV_TWO_COST        50000
#define LEV_THREE_COST      300000
#define LEV_FOUR_COST      750000
#define LEV_FIVE_COST      2000000
#define LEV_SIX_COST       4000000
#define LEV_SEVEN_COST    6000000
#define LEV_EIGHT_COST    8000000
#define LEV_NINE_COST     10000000
...
fake_beat() 
{
   ...
   if (environment()) /* 03/20/06 Earwax */
...
join(str) 
{
   ...
   write("  There aren't many rules you need to follow but if you break any one\n"+
...
advance() 
{
   ...
   if(rank == 5) next_exp = LEV_SIX_COST;
   ...
   if(rank == 4) write("Spuck cheers.\nSpuck bobbles: Woooooohaaaaa!!\n");
   if(rank == 5) write("Spuck cheers.\nSpuck gribbles: You are at the highest level in the guild!\n");
