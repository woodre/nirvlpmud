...
load_chat("You hear swirling and slushing sounds coming from the vortex.\n");
   ...
   move_object(this_object(), "/players/mizan/etheriel/ROOMS/lunar");
}
...
dive(str) {
  ...
  log_file("mizan.vo", (this_player()->query_real_name()) + ctime() + "\n");
  write("You dive into the vortex and appear somewhere else...\n\n");
  this_player()->move_player("into the vortex#players/mizan/etheriel/subrealms/watchlar/w1");
  return 1;
}
