...
reset(arg){
   ...
   armor = clone_object("/players/mizan/etheriel/subrealms/mine/crotchguard.c");
...
write("This is a five-headed Hydra.\n"+
      "It appears to be really aggressive.\n"+
      ...
      if(present(attacker_name,environment(this_object()))){
         if(head1 == 0){
            if(1 == random(2)){
               ...
               dam=random(70);
               attacker->hit_player(dam, "other|electric");
            }
            else {
         ...
         if(head4 == 0){
            if(1 == random(2)){
               ...
               dam=random(90);
               attacker->hit_player(dam, "other|fire");
            }
            else {
         ...
         if(head5 == 0)
         {
            if(1 == random(2))
            {
               /* death head has various damage type attacks */
               if(1 == random(3))
               {
               ...
               {
                  tell_room(room,"The head of death spews forth dark flame at "+capitalize(attacker_name)+".\n");
                  dam=random(95);
                  attacker->hit_player(dam, "other|dark");
               }
...
make_random_move()
{
   ...
   /* this version of the hydra is designed to stay in the /room/mine area.
    * it should not go up or down... leaving the mine and slaughtering players!
    */
