...
void reset(int arg) 
{
    ...
    dest_dir = 
    ({
        "/players/mizan/etheriel/subrealms/sockworld/ROOMS/room02.c", "north",
        "/players/mizan/etheriel/subrealms/sockworld/entrance.c", "south",
        "/players/mizan/etheriel/subrealms/sockworld/ROOMS/room03.c", "east",
    });
