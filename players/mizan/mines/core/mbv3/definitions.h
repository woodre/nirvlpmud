...
#define TACTICAL_DM_SAVEFILE    "players/mizan/mines/data/tacticalDM"
#define NEXUS_DM_SAVEFILE       "players/mizan/mines/data/nexusDM"

#define LOCKERS         "/players/mizan/mines/ROOMS/locker.c"
#define LOCKERS_ROOM    "players/mizan/mines/ROOMS/locker.c"
#define LISTENING_ROOM  "players/mizan/mines/ROOMS/observation.c"

#define MAXIMUM_BALANCE 1000000

#define GRAFFITI_RESIDUE "/players/mizan/core/mbv3/graffiti-residue.c"

/* misc */
#define RADIO_ID                   "walkie-talkieV3-on"
#define GOGGLES_ID                 "gogglesV3-on"
