...
*/
    ...
    my_available_pawns = ({
        "/players/mizan/mbv2/beasties/afei.c",
        "/players/mizan/mbv2/beasties/fettdog.c",
        "/players/mizan/mbv2/beasties/goliathbeano.c",
        "/players/mizan/mbv2/beasties/knm.c",
        "/players/mizan/mbv2/beasties/clippy.c",
        "/players/mizan/mbv2/beasties/plu-santa.c",
    });
    ...
    my_available_rooks = ({
        "/players/mizan/mbv2/beasties/domokun.c",
        "/players/mizan/mbv2/beasties/thorgrim.c",
        "/players/mizan/mbv2/beasties/hydra.c",
    });
...
check_population_beano()
{
    if(!my_beano)
    {
        my_beano = clone_object("/players/mizan/mbv2/beasties/beano.c");
...
check_population_hoth()
{
    if(!my_hoth)
    {
        my_hoth = clone_object("/players/mizan/mbv2/beasties/hoth.c");
...
check_population_locker_beano()
{
    ...
    if(!my_locker_beano)
    {
        my_locker_beano = clone_object("/players/mizan/mbv2/beasties/beano.c");
...
check_population_prison_beano()
{
    ...
    if(!my_prison_beano)
    {
        my_prison_beano = clone_object("/players/mizan/mbv2/beasties/beano.c");
