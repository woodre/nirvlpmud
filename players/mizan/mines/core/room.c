...
string convert_dir(string str) { return (string) CELL_DM->convert_dir(str); }
...
string translate_exit(string fullDirection) { return (string) CELL_DM->translate_exit(fullDirection); }
...
string convert_number(int inputNum) { return (string) CELL_DM->convert_number(); }
string * query_numbers() { return (string) CELL_DM->query_numbers(); }
