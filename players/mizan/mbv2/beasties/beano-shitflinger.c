 ...
 */
    ...
    set_chance_of(CHANCE_TAKE_ALL_LOOT, 95);     /* % per round that we will take anything lying around */
    ...
    set_int(VAL_RANDOM_MOVE_FREQUENCY, 2);       /* How many callouts before the monster decides to move randomly */
