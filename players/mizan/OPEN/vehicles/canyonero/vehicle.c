...
reset(arg)
{
    ...
    if(!bin) bin = move_object(clone_object("/players/mizan/closed/stuff/vehicles/canyonero/storage_bin.c"), this_object());
    move_object(clone_object("/players/mizan/closed/stuff/vehicles/canyonero/fuel.c"), bin);
    move_object(clone_object("/players/mizan/closed/stuff/vehicles/canyonero/fuel.c"), bin);
