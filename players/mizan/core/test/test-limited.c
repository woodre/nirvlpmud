inherit "/players/mizan/core/test/object.c";
#include "/obj/ansi.h"
...
reset(arg)
{
   ...
   set_long("This is an ordinary looking water balloon.\n"+
            "It appears you can 'pelt' someone with it, or load it on\n"+
