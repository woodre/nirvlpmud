...
void long()
{
    ...
    else
    {
        write("There are too many instances of this object currently in the game.\n"+
              "However this is still a legitimate copy of '" + short_desc + "'.\n"+
        ...
        write("\n" + short_desc + " is encased in a solid plastic coating.\n"+
...
void reset(int arg)
{
    ...
    tell_room(LISTENING_ROOM, "Weapon.c reports: " + object_name(this_object()) + " has been cloned.\n");
...
void add_move_history()
{
    ...
    /* lets add some weapon-specific info */
    temp += " WC: " + class_of_weapon + " Hits: " + hits + " Misses: " + misses + "\n";

    /* if we have been told to, write to file. */
    if(is_tracking)
    {
        write_file("/players/mizan/logs/weapon." + my_tracking_name + "." + tracking_number, temp);
        tell_room(LISTENING_ROOM, "Weapon.c reports: Log file object." + my_tracking_name + "." + tracking_number + " has updated history.\n");
    }
...
void start_tracking_to_disk(string str)
{
    ...
    tell_room(LISTENING_ROOM, "Weapon.c reports: " + object_name(this_object()) + " is reporting to object." + my_tracking_name + "." + tracking_number + ".\n");
    
    write_file("/players/mizan/logs/weapon." + my_tracking_name + "." + tracking_number, query_move_history());

    /* write our output to the index file too. */
    temp = ctime() + " '" + this_object()->short() + "', weapon." + my_tracking_name + "." + tracking_number + "\n";
