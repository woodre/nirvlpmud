...
void reset(int arg)
{
    ...
    tell_room(LISTENING_ROOM, "Armor.c reports: " + object_name(this_object()) + " has been cloned.\n");
...
/*    temp += " WC: " + class_of_weapon + " Hits: " + hits + " Misses: " + misses + "\n"; */
    ...
    if(is_tracking)
    {
        write_file("/players/mizan/logs/armor." + my_tracking_name + "." + tracking_number, temp);
        tell_room(LISTENING_ROOM, "Armor.c reports: Log file object." + my_tracking_name + "." + tracking_number + " has updated history.\n");
    }
...
void start_tracking_to_disk(string str)
{
    ...
    tell_room(LISTENING_ROOM, "Armor.c reports: " + object_name(this_object()) + " is reporting to object." + my_tracking_name + "." + tracking_number + ".\n");
    
    write_file("/players/mizan/logs/armor." + my_tracking_name + "." + tracking_number, query_move_history());

    /* write our output to the index file too. */
    temp = ctime() + " '" + this_object()->short() + "', armor." + my_tracking_name + "." + tracking_number + "\n";
