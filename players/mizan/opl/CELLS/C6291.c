...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6171", "north",
		"/players/mizan/opl/CELLS/C6411", "south",
		"/players/mizan/opl/CELLS/C6292", "east",
		"/players/mizan/opl/CELLS/C6290", "west",
	});
