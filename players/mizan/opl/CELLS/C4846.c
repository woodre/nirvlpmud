...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4726", "north",
		"/players/mizan/opl/CELLS/C4966", "south",
		"/players/mizan/opl/CELLS/C4847", "east",
		"/players/mizan/opl/CELLS/C4845", "west",
	});
