...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C702", "north",
		"/players/mizan/opl/CELLS/C942", "south",
		"/players/mizan/opl/CELLS/C823", "east",
		"/players/mizan/opl/CELLS/C821", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/medium/beano-agent.c");
...
long()
{
	...
	write("\"'God is big, so don't fuck with him.'\"\n");
