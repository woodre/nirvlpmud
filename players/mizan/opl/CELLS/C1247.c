...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1127", "north",
		"/players/mizan/opl/CELLS/C1248", "east",
		"/players/mizan/opl/CELLS/C1246", "west",
	});
...
long()
{
	...
	write("\"Clark Kent is a transvestite.\"\n");
