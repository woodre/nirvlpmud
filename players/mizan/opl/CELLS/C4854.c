...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4734", "north",
		"/players/mizan/opl/CELLS/C4974", "south",
		"/players/mizan/opl/CELLS/C4855", "east",
		"/players/mizan/opl/CELLS/C4853", "west",
	});
