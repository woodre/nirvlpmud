...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1646", "north",
		"/players/mizan/opl/CELLS/C1886", "south",
		"/players/mizan/opl/CELLS/C1767", "east",
		"/players/mizan/opl/CELLS/C1765", "west",
	});
