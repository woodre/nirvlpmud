...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3848", "north",
		"/players/mizan/opl/CELLS/C4088", "south",
		"/players/mizan/opl/CELLS/C3969", "east",
		"/players/mizan/opl/CELLS/C3967", "west",
	});
