...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4736", "north",
		"/players/mizan/opl/CELLS/C4976", "south",
		"/players/mizan/opl/CELLS/C4857", "east",
		"/players/mizan/opl/CELLS/C4855", "west",
	});
