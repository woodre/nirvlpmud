...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1259", "north",
		"/players/mizan/opl/CELLS/C1499", "south",
		"/players/mizan/opl/CELLS/C1380", "east",
		"/players/mizan/opl/CELLS/C1378", "west",
	});
...
long()
{
	...
	write("\"Statisticians do it with 95% confidence.\"\n");
