...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1633", "north",
		"/players/mizan/opl/CELLS/C1873", "south",
		"/players/mizan/opl/CELLS/C1754", "east",
		"/players/mizan/opl/CELLS/C1752", "west",
	});
