...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2608", "north",
		"/players/mizan/opl/CELLS/C2848", "south",
		"/players/mizan/opl/CELLS/C2729", "east",
		"/players/mizan/opl/CELLS/C2727", "west",
	});
