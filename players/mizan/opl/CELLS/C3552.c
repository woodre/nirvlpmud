...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3432", "north",
		"/players/mizan/opl/CELLS/C3672", "south",
		"/players/mizan/opl/CELLS/C3553", "east",
		"/players/mizan/opl/CELLS/C3551", "west",
	});
