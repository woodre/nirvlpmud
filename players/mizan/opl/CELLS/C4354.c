...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4234", "north",
		"/players/mizan/opl/CELLS/C4474", "south",
		"/players/mizan/opl/CELLS/C4355", "east",
		"/players/mizan/opl/CELLS/C4353", "west",
	});
