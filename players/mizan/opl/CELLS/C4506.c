...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4386", "north",
		"/players/mizan/opl/CELLS/C4626", "south",
		"/players/mizan/opl/CELLS/C4507", "east",
		"/players/mizan/opl/CELLS/C4505", "west",
	});
