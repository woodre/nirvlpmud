...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3608", "north",
		"/players/mizan/opl/CELLS/C3848", "south",
		"/players/mizan/opl/CELLS/C3729", "east",
		"/players/mizan/opl/CELLS/C3727", "west",
	});
