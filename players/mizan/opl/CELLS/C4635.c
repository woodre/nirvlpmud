...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4515", "north",
		"/players/mizan/opl/CELLS/C4755", "south",
		"/players/mizan/opl/CELLS/C4636", "east",
		"/players/mizan/opl/CELLS/C4634", "west",
	});
