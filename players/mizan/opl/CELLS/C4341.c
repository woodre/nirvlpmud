...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4221", "north",
		"/players/mizan/opl/CELLS/C4461", "south",
		"/players/mizan/opl/CELLS/C4342", "east",
		"/players/mizan/opl/CELLS/C4340", "west",
	});
