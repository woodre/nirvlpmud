...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6170", "north",
		"/players/mizan/opl/CELLS/C6410", "south",
		"/players/mizan/opl/CELLS/C6291", "east",
		"/players/mizan/opl/CELLS/C6289", "west",
	});
