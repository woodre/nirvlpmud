...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C709", "north",
		"/players/mizan/opl/CELLS/C949", "south",
		"/players/mizan/opl/CELLS/C830", "east",
		"/players/mizan/opl/CELLS/C828", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/fungus/wookie.c");
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/fungus/wussy_male_vampire.c");
