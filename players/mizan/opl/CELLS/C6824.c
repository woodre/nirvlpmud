...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6704", "north",
		"/players/mizan/opl/CELLS/C6944", "south",
		"/players/mizan/opl/CELLS/C6823", "west",
	});
...
long()
{
	...
	write("\"female, n.:	Life support system for a pussy.\"\n");
