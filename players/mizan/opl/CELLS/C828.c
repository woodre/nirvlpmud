...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C708", "north",
		"/players/mizan/opl/CELLS/C948", "south",
		"/players/mizan/opl/CELLS/C829", "east",
		"/players/mizan/opl/CELLS/C827", "west",
	});
