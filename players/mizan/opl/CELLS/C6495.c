...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6375", "north",
		"/players/mizan/opl/CELLS/C6496", "east",
		"/players/mizan/opl/CELLS/C6494", "west",
	});
...
long()
{
	...
	write("\"Unix programmers do it with pipes.\"\n");
