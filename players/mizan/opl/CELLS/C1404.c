...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1284", "north",
		"/players/mizan/opl/CELLS/C1524", "south",
		"/players/mizan/opl/CELLS/C1405", "east",
		"/players/mizan/opl/CELLS/C1403", "west",
	});
