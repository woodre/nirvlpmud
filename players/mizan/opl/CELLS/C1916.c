...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1796", "north",
		"/players/mizan/opl/CELLS/C2036", "south",
		"/players/mizan/opl/CELLS/C1917", "east",
		"/players/mizan/opl/CELLS/C1915", "west",
	});
