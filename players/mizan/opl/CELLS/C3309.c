...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3189", "north",
		"/players/mizan/opl/CELLS/C3429", "south",
		"/players/mizan/opl/CELLS/C3310", "east",
		"/players/mizan/opl/CELLS/C3308", "west",
	});
...
long()
{
	...
	write("\"Women's Libbers are OK. I just wouldn't want my sister to marry one.\"\n");
