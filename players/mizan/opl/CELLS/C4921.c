...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4801", "north",
		"/players/mizan/opl/CELLS/C5041", "south",
	});
...
long()
{
	...
	write("\"Q:	What's invisible and smells like carrots?A:	Bunny farts.\"\n");
