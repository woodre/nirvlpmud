...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5713", "north",
		"/players/mizan/opl/CELLS/C5953", "south",
		"/players/mizan/opl/CELLS/C5834", "east",
		"/players/mizan/opl/CELLS/C5832", "west",
	});
