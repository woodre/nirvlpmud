...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5218", "north",
		"/players/mizan/opl/CELLS/C5458", "south",
		"/players/mizan/opl/CELLS/C5339", "east",
		"/players/mizan/opl/CELLS/C5337", "west",
	});
