...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3221", "north",
		"/players/mizan/opl/CELLS/C3461", "south",
		"/players/mizan/opl/CELLS/C3342", "east",
		"/players/mizan/opl/CELLS/C3340", "west",
	});
...
long()
{
	...
	write("\"Note to myself: use real bullets next time.\"\n");
