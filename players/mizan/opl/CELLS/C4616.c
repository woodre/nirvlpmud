...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4496", "north",
		"/players/mizan/opl/CELLS/C4736", "south",
		"/players/mizan/opl/CELLS/C4617", "east",
		"/players/mizan/opl/CELLS/C4615", "west",
	});
