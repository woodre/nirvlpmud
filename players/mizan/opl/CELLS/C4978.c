...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4858", "north",
		"/players/mizan/opl/CELLS/C5098", "south",
		"/players/mizan/opl/CELLS/C4979", "east",
		"/players/mizan/opl/CELLS/C4977", "west",
	});
