...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5924", "north",
		"/players/mizan/opl/CELLS/C6164", "south",
		"/players/mizan/opl/CELLS/C6045", "east",
		"/players/mizan/opl/CELLS/C6043", "west",
	});
