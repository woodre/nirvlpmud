...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1525", "north",
		"/players/mizan/opl/CELLS/C1765", "south",
		"/players/mizan/opl/CELLS/C1646", "east",
		"/players/mizan/opl/CELLS/C1644", "west",
	});
