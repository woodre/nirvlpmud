...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5480", "north",
		"/players/mizan/opl/CELLS/C5720", "south",
		"/players/mizan/opl/CELLS/C5601", "east",
		"/players/mizan/opl/CELLS/C5599", "west",
	});
