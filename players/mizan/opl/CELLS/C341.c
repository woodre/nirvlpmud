...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C221", "north",
		"/players/mizan/opl/CELLS/C461", "south",
		"/players/mizan/opl/CELLS/C342", "east",
		"/players/mizan/opl/CELLS/C340", "west",
	});
