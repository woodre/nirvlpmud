...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2516", "east",
		"/players/mizan/opl/CELLS/C2514", "west",
	});
...
long()
{
	...
	write("\"I'm having a RELIGIOUS EXPERIENCE ... and I don't take any DRUGS\"\n");
