...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C766", "north",
		"/players/mizan/opl/CELLS/C1006", "south",
		"/players/mizan/opl/CELLS/C887", "east",
		"/players/mizan/opl/CELLS/C885", "west",
	});
...
long()
{
	...
	write("\"Look! A ladder! Maybe it leads to heaven, or a sandwich!\"\n");
