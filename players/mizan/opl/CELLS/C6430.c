...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6550", "south",
		"/players/mizan/opl/CELLS/C6429", "west",
	});
...
long()
{
	...
	write("\"I'm EMOTIONAL now because I have MERCHANDISING CLOUT!!\"\n");
