...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5579", "north",
		"/players/mizan/opl/CELLS/C5819", "south",
		"/players/mizan/opl/CELLS/C5700", "east",
		"/players/mizan/opl/CELLS/C5698", "west",
	});
