...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1951", "north",
		"/players/mizan/opl/CELLS/C2191", "south",
		"/players/mizan/opl/CELLS/C2072", "east",
		"/players/mizan/opl/CELLS/C2070", "west",
	});
