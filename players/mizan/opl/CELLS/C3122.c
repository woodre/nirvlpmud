...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3002", "north",
		"/players/mizan/opl/CELLS/C3242", "south",
		"/players/mizan/opl/CELLS/C3121", "west",
	});
...
long()
{
	...
	write("\"Now, let's SEND OUT for QUICHE!!\"\n");
