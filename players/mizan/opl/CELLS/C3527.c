...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3407", "north",
		"/players/mizan/opl/CELLS/C3647", "south",
		"/players/mizan/opl/CELLS/C3528", "east",
		"/players/mizan/opl/CELLS/C3526", "west",
	});
