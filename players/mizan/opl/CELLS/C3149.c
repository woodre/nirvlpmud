...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3029", "north",
		"/players/mizan/opl/CELLS/C3269", "south",
		"/players/mizan/opl/CELLS/C3150", "east",
		"/players/mizan/opl/CELLS/C3148", "west",
	});
