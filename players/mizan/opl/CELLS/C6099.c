...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5979", "north",
		"/players/mizan/opl/CELLS/C6219", "south",
		"/players/mizan/opl/CELLS/C6100", "east",
		"/players/mizan/opl/CELLS/C6098", "west",
	});
