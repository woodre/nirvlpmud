...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C821", "north",
		"/players/mizan/opl/CELLS/C1061", "south",
		"/players/mizan/opl/CELLS/C942", "east",
		"/players/mizan/opl/CELLS/C940", "west",
	});
...
long()
{
	...
	write("\"Sixteen'll get you twenty.\"\n");
