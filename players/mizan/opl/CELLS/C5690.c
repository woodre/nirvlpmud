...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5570", "north",
		"/players/mizan/opl/CELLS/C5810", "south",
		"/players/mizan/opl/CELLS/C5691", "east",
		"/players/mizan/opl/CELLS/C5689", "west",
	});
