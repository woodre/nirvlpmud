...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6056", "north",
		"/players/mizan/opl/CELLS/C6296", "south",
		"/players/mizan/opl/CELLS/C6177", "east",
		"/players/mizan/opl/CELLS/C6175", "west",
	});
