...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1938", "north",
		"/players/mizan/opl/CELLS/C2178", "south",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/medium/goblin.c");
...
long()
{
	...
	write("\"Hell's broken loose.		-- Robert Greene\"\n");
