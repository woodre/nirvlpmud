...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1985", "north",
		"/players/mizan/opl/CELLS/C2225", "south",
		"/players/mizan/opl/CELLS/C2106", "east",
		"/players/mizan/opl/CELLS/C2104", "west",
	});
