...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5939", "north",
		"/players/mizan/opl/CELLS/C6179", "south",
		"/players/mizan/opl/CELLS/C6060", "east",
		"/players/mizan/opl/CELLS/C6058", "west",
	});
