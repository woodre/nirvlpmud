...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3858", "north",
		"/players/mizan/opl/CELLS/C4098", "south",
		"/players/mizan/opl/CELLS/C3979", "east",
		"/players/mizan/opl/CELLS/C3977", "west",
	});
