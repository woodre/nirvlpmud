...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6063", "north",
		"/players/mizan/opl/CELLS/C6303", "south",
		"/players/mizan/opl/CELLS/C6184", "east",
		"/players/mizan/opl/CELLS/C6182", "west",
	});
