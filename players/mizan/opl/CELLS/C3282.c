...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3162", "north",
		"/players/mizan/opl/CELLS/C3402", "south",
		"/players/mizan/opl/CELLS/C3283", "east",
		"/players/mizan/opl/CELLS/C3281", "west",
	});
