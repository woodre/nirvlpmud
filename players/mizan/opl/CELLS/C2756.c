...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2636", "north",
		"/players/mizan/opl/CELLS/C2757", "east",
		"/players/mizan/opl/CELLS/C2755", "west",
	});
...
long()
{
	...
	write("\"A.A.A.A.A.:	An organization for drunks who drive.\"\n");
