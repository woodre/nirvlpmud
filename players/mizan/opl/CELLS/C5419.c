...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5299", "north",
		"/players/mizan/opl/CELLS/C5420", "east",
		"/players/mizan/opl/CELLS/C5418", "west",
	});
...
long()
{
	...
	write("\"A man needs a mistress, just to break the monogamy.\"\n");
