...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4256", "north",
		"/players/mizan/opl/CELLS/C4496", "south",
		"/players/mizan/opl/CELLS/C4377", "east",
		"/players/mizan/opl/CELLS/C4375", "west",
	});
