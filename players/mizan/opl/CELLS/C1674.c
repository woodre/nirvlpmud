...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1554", "north",
		"/players/mizan/opl/CELLS/C1794", "south",
		"/players/mizan/opl/CELLS/C1675", "east",
		"/players/mizan/opl/CELLS/C1673", "west",
	});
