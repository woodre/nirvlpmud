...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5800", "north",
		"/players/mizan/opl/CELLS/C6040", "south",
		"/players/mizan/opl/CELLS/C5921", "east",
		"/players/mizan/opl/CELLS/C5919", "west",
	});
