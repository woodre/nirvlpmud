...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4500", "north",
		"/players/mizan/opl/CELLS/C4740", "south",
		"/players/mizan/opl/CELLS/C4621", "east",
		"/players/mizan/opl/CELLS/C4619", "west",
	});
