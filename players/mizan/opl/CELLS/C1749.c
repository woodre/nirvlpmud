...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1629", "north",
		"/players/mizan/opl/CELLS/C1869", "south",
		"/players/mizan/opl/CELLS/C1750", "east",
		"/players/mizan/opl/CELLS/C1748", "west",
	});
