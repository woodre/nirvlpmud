...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4026", "north",
		"/players/mizan/opl/CELLS/C4266", "south",
		"/players/mizan/opl/CELLS/C4147", "east",
		"/players/mizan/opl/CELLS/C4145", "west",
	});
