...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C596", "north",
		"/players/mizan/opl/CELLS/C836", "south",
		"/players/mizan/opl/CELLS/C717", "east",
		"/players/mizan/opl/CELLS/C715", "west",
	});
