...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6176", "north",
		"/players/mizan/opl/CELLS/C6416", "south",
		"/players/mizan/opl/CELLS/C6297", "east",
		"/players/mizan/opl/CELLS/C6295", "west",
	});
