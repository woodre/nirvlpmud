...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3553", "north",
		"/players/mizan/opl/CELLS/C3793", "south",
		"/players/mizan/opl/CELLS/C3674", "east",
		"/players/mizan/opl/CELLS/C3672", "west",
	});
...
long()
{
	...
	write("\"YOW!! The land of the rising SONY!!\"\n");
