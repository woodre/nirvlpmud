...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3131", "north",
		"/players/mizan/opl/CELLS/C3371", "south",
		"/players/mizan/opl/CELLS/C3252", "east",
		"/players/mizan/opl/CELLS/C3250", "west",
	});
