...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5716", "north",
		"/players/mizan/opl/CELLS/C5956", "south",
		"/players/mizan/opl/CELLS/C5837", "east",
		"/players/mizan/opl/CELLS/C5835", "west",
	});
