...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3030", "north",
		"/players/mizan/opl/CELLS/C3270", "south",
		"/players/mizan/opl/CELLS/C3151", "east",
		"/players/mizan/opl/CELLS/C3149", "west",
	});
