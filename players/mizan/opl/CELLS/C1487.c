...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1488", "east",
		"/players/mizan/opl/CELLS/C1486", "west",
	});
...
long()
{
	...
	write("\"Maybe we could paint GOLDIE HAWN a rich PRUSSIAN BLUE --\"\n");
