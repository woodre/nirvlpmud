...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3966", "north",
		"/players/mizan/opl/CELLS/C4206", "south",
		"/players/mizan/opl/CELLS/C4087", "east",
		"/players/mizan/opl/CELLS/C4085", "west",
	});
