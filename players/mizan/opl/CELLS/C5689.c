...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5569", "north",
		"/players/mizan/opl/CELLS/C5809", "south",
		"/players/mizan/opl/CELLS/C5690", "east",
		"/players/mizan/opl/CELLS/C5688", "west",
	});
