...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4025", "north",
		"/players/mizan/opl/CELLS/C4265", "south",
		"/players/mizan/opl/CELLS/C4146", "east",
		"/players/mizan/opl/CELLS/C4144", "west",
	});
