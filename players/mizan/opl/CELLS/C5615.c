...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5495", "north",
		"/players/mizan/opl/CELLS/C5735", "south",
		"/players/mizan/opl/CELLS/C5616", "east",
		"/players/mizan/opl/CELLS/C5614", "west",
	});
