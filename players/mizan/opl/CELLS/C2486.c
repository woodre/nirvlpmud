...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2366", "north",
		"/players/mizan/opl/CELLS/C2606", "south",
		"/players/mizan/opl/CELLS/C2487", "east",
		"/players/mizan/opl/CELLS/C2485", "west",
	});
