...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2414", "north",
		"/players/mizan/opl/CELLS/C2654", "south",
		"/players/mizan/opl/CELLS/C2535", "east",
		"/players/mizan/opl/CELLS/C2533", "west",
	});
