...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3897", "north",
		"/players/mizan/opl/CELLS/C4137", "south",
		"/players/mizan/opl/CELLS/C4018", "east",
		"/players/mizan/opl/CELLS/C4016", "west",
	});
