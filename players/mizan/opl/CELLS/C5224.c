...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5104", "north",
		"/players/mizan/opl/CELLS/C5344", "south",
		"/players/mizan/opl/CELLS/C5225", "east",
		"/players/mizan/opl/CELLS/C5223", "west",
	});
