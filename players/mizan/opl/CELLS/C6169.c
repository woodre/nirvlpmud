...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6049", "north",
		"/players/mizan/opl/CELLS/C6289", "south",
		"/players/mizan/opl/CELLS/C6170", "east",
		"/players/mizan/opl/CELLS/C6168", "west",
	});
