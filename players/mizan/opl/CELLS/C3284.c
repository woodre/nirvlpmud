...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3164", "north",
		"/players/mizan/opl/CELLS/C3404", "south",
		"/players/mizan/opl/CELLS/C3285", "east",
		"/players/mizan/opl/CELLS/C3283", "west",
	});
