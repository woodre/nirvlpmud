...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4331", "north",
		"/players/mizan/opl/CELLS/C4571", "south",
		"/players/mizan/opl/CELLS/C4452", "east",
		"/players/mizan/opl/CELLS/C4450", "west",
	});
