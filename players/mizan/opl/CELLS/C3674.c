...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3554", "north",
		"/players/mizan/opl/CELLS/C3794", "south",
		"/players/mizan/opl/CELLS/C3673", "west",
	});
...
long()
{
	...
	write("\"Today's title:	Creative Violence in Sexual Relationships\"\n");
