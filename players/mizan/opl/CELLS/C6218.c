...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6098", "north",
		"/players/mizan/opl/CELLS/C6338", "south",
		"/players/mizan/opl/CELLS/C6219", "east",
		"/players/mizan/opl/CELLS/C6217", "west",
	});
