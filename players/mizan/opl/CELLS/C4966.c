...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4846", "north",
		"/players/mizan/opl/CELLS/C5086", "south",
		"/players/mizan/opl/CELLS/C4967", "east",
		"/players/mizan/opl/CELLS/C4965", "west",
	});
