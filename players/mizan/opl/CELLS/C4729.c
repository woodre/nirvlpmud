...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4609", "north",
		"/players/mizan/opl/CELLS/C4849", "south",
		"/players/mizan/opl/CELLS/C4730", "east",
		"/players/mizan/opl/CELLS/C4728", "west",
	});
