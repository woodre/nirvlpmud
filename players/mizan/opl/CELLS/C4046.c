...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3926", "north",
		"/players/mizan/opl/CELLS/C4166", "south",
		"/players/mizan/opl/CELLS/C4047", "east",
		"/players/mizan/opl/CELLS/C4045", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/medium/hydra-blocker.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/medium/hydra-blocker.c");
...
long()
{
	...
	write("\"Happy is the child whose father died rich.\"\n");
