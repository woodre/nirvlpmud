...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6102", "north",
		"/players/mizan/opl/CELLS/C6342", "south",
		"/players/mizan/opl/CELLS/C6223", "east",
		"/players/mizan/opl/CELLS/C6221", "west",
	});
