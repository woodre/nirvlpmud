...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4721", "north",
		"/players/mizan/opl/CELLS/C4961", "south",
		"/players/mizan/opl/CELLS/C4842", "east",
		"/players/mizan/opl/CELLS/C4840", "west",
	});
