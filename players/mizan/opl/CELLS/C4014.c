...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3894", "north",
		"/players/mizan/opl/CELLS/C4134", "south",
		"/players/mizan/opl/CELLS/C4015", "east",
		"/players/mizan/opl/CELLS/C4013", "west",
	});
