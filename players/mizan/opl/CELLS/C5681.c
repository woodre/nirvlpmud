...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5561", "north",
		"/players/mizan/opl/CELLS/C5801", "south",
		"/players/mizan/opl/CELLS/C5682", "east",
		"/players/mizan/opl/CELLS/C5680", "west",
	});
