...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5951", "north",
		"/players/mizan/opl/CELLS/C6191", "south",
		"/players/mizan/opl/CELLS/C6072", "east",
		"/players/mizan/opl/CELLS/C6070", "west",
	});
