...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4487", "north",
		"/players/mizan/opl/CELLS/C4727", "south",
		"/players/mizan/opl/CELLS/C4608", "east",
		"/players/mizan/opl/CELLS/C4606", "west",
	});
