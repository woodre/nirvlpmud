...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4203", "north",
		"/players/mizan/opl/CELLS/C4443", "south",
	});
...
long()
{
	...
	write("\"... the MYSTERIANS are in here with my CORDUROY SOAP DISH!!\"\n");
