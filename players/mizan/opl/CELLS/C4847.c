...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4727", "north",
		"/players/mizan/opl/CELLS/C4967", "south",
		"/players/mizan/opl/CELLS/C4848", "east",
		"/players/mizan/opl/CELLS/C4846", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/sea/hugefish.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/sea/hugefish.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/sea/hugefish.c");
