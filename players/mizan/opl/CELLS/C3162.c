...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3042", "north",
		"/players/mizan/opl/CELLS/C3282", "south",
		"/players/mizan/opl/CELLS/C3163", "east",
		"/players/mizan/opl/CELLS/C3161", "west",
	});
