...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3591", "north",
		"/players/mizan/opl/CELLS/C3831", "south",
		"/players/mizan/opl/CELLS/C3712", "east",
		"/players/mizan/opl/CELLS/C3710", "west",
	});
