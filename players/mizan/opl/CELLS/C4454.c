...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4334", "north",
		"/players/mizan/opl/CELLS/C4574", "south",
		"/players/mizan/opl/CELLS/C4455", "east",
		"/players/mizan/opl/CELLS/C4453", "west",
	});
