...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1576", "north",
		"/players/mizan/opl/CELLS/C1816", "south",
		"/players/mizan/opl/CELLS/C1697", "east",
		"/players/mizan/opl/CELLS/C1695", "west",
	});
