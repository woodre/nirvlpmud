...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5089", "north",
		"/players/mizan/opl/CELLS/C5329", "south",
		"/players/mizan/opl/CELLS/C5210", "east",
		"/players/mizan/opl/CELLS/C5208", "west",
	});
