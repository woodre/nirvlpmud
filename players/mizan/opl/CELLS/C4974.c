...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4854", "north",
		"/players/mizan/opl/CELLS/C5094", "south",
		"/players/mizan/opl/CELLS/C4975", "east",
		"/players/mizan/opl/CELLS/C4973", "west",
	});
