...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4878", "north",
		"/players/mizan/opl/CELLS/C5118", "south",
		"/players/mizan/opl/CELLS/C4999", "east",
		"/players/mizan/opl/CELLS/C4997", "west",
	});
