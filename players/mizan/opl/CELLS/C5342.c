...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5222", "north",
		"/players/mizan/opl/CELLS/C5462", "south",
		"/players/mizan/opl/CELLS/C5343", "east",
		"/players/mizan/opl/CELLS/C5341", "west",
	});
