...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1933", "north",
		"/players/mizan/opl/CELLS/C2173", "south",
		"/players/mizan/opl/CELLS/C2054", "east",
	});
...
long()
{
	...
	write("\"Women are nothing but machines for producing children.		-- Napoleon\"\n");
