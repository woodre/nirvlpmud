...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5714", "north",
		"/players/mizan/opl/CELLS/C5954", "south",
		"/players/mizan/opl/CELLS/C5835", "east",
		"/players/mizan/opl/CELLS/C5833", "west",
	});
