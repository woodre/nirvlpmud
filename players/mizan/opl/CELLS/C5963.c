...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5843", "north",
		"/players/mizan/opl/CELLS/C5964", "east",
	});
...
long()
{
	...
	write("\"We aren't what we eat. We are what we don't shit.		-- Hugh Romney\"\n");
