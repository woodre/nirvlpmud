...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1019", "north",
		"/players/mizan/opl/CELLS/C1259", "south",
		"/players/mizan/opl/CELLS/C1140", "east",
		"/players/mizan/opl/CELLS/C1138", "west",
	});
