...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2607", "north",
		"/players/mizan/opl/CELLS/C2847", "south",
		"/players/mizan/opl/CELLS/C2728", "east",
		"/players/mizan/opl/CELLS/C2726", "west",
	});
