...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1860", "north",
		"/players/mizan/opl/CELLS/C2100", "south",
		"/players/mizan/opl/CELLS/C1981", "east",
		"/players/mizan/opl/CELLS/C1979", "west",
	});
