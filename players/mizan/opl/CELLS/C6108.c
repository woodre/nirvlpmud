...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5988", "north",
		"/players/mizan/opl/CELLS/C6228", "south",
		"/players/mizan/opl/CELLS/C6109", "east",
		"/players/mizan/opl/CELLS/C6107", "west",
	});
