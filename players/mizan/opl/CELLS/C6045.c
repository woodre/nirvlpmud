...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5925", "north",
		"/players/mizan/opl/CELLS/C6165", "south",
		"/players/mizan/opl/CELLS/C6046", "east",
		"/players/mizan/opl/CELLS/C6044", "west",
	});
