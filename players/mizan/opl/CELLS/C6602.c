...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6482", "north",
		"/players/mizan/opl/CELLS/C6601", "west",
	});
...
long()
{
	...
	write("\"Girls are like pianos. When they're not upright, they're grand!\"\n");
