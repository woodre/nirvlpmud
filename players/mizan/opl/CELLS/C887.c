...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C767", "north",
		"/players/mizan/opl/CELLS/C1007", "south",
		"/players/mizan/opl/CELLS/C886", "west",
	});
...
long()
{
	...
	write("\"Astrology... just a bunch of Taurus.\"\n");
