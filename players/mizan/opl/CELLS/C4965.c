...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4845", "north",
		"/players/mizan/opl/CELLS/C5085", "south",
		"/players/mizan/opl/CELLS/C4966", "east",
		"/players/mizan/opl/CELLS/C4964", "west",
	});
