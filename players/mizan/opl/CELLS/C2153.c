...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2033", "north",
		"/players/mizan/opl/CELLS/C2273", "south",
		"/players/mizan/opl/CELLS/C2154", "east",
		"/players/mizan/opl/CELLS/C2152", "west",
	});
