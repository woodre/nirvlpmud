...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1356", "north",
		"/players/mizan/opl/CELLS/C1596", "south",
		"/players/mizan/opl/CELLS/C1477", "east",
		"/players/mizan/opl/CELLS/C1475", "west",
	});
