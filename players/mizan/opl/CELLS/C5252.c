...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5132", "north",
		"/players/mizan/opl/CELLS/C5372", "south",
		"/players/mizan/opl/CELLS/C5253", "east",
		"/players/mizan/opl/CELLS/C5251", "west",
	});
