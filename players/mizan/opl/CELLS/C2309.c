...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2189", "north",
		"/players/mizan/opl/CELLS/C2429", "south",
		"/players/mizan/opl/CELLS/C2310", "east",
		"/players/mizan/opl/CELLS/C2308", "west",
	});
