...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2075", "north",
		"/players/mizan/opl/CELLS/C2315", "south",
		"/players/mizan/opl/CELLS/C2196", "east",
		"/players/mizan/opl/CELLS/C2194", "west",
	});
