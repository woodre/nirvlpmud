...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4015", "north",
		"/players/mizan/opl/CELLS/C4255", "south",
		"/players/mizan/opl/CELLS/C4136", "east",
		"/players/mizan/opl/CELLS/C4134", "west",
	});
