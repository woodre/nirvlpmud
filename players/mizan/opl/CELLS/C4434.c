...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4314", "north",
		"/players/mizan/opl/CELLS/C4554", "south",
		"/players/mizan/opl/CELLS/C4435", "east",
		"/players/mizan/opl/CELLS/C4433", "west",
	});
