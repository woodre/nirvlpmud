...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4724", "north",
		"/players/mizan/opl/CELLS/C4964", "south",
		"/players/mizan/opl/CELLS/C4845", "east",
		"/players/mizan/opl/CELLS/C4843", "west",
	});
