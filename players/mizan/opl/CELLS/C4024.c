...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3904", "north",
		"/players/mizan/opl/CELLS/C4144", "south",
		"/players/mizan/opl/CELLS/C4025", "east",
		"/players/mizan/opl/CELLS/C4023", "west",
	});
