...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2006", "north",
		"/players/mizan/opl/CELLS/C2246", "south",
		"/players/mizan/opl/CELLS/C2127", "east",
		"/players/mizan/opl/CELLS/C2125", "west",
	});
