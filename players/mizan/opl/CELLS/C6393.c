...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6513", "south",
		"/players/mizan/opl/CELLS/C6392", "west",
	});
...
long()
{
	...
	write("\"Tonight's piss is tommorrow's Tang.		-- An American astronaut\"\n");
