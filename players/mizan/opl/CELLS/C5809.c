...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5689", "north",
		"/players/mizan/opl/CELLS/C5929", "south",
		"/players/mizan/opl/CELLS/C5810", "east",
		"/players/mizan/opl/CELLS/C5808", "west",
	});
