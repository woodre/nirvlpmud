...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C552", "north",
		"/players/mizan/opl/CELLS/C792", "south",
		"/players/mizan/opl/CELLS/C673", "east",
		"/players/mizan/opl/CELLS/C671", "west",
	});
