...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5107", "north",
		"/players/mizan/opl/CELLS/C5347", "south",
		"/players/mizan/opl/CELLS/C5228", "east",
		"/players/mizan/opl/CELLS/C5226", "west",
	});
