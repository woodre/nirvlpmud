...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1378", "north",
		"/players/mizan/opl/CELLS/C1618", "south",
		"/players/mizan/opl/CELLS/C1499", "east",
		"/players/mizan/opl/CELLS/C1497", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/hard/goldhard.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/hard/domokun.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/hard/weasel.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/domokun.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/lectroid_boss.c");
...
long()
{
	...
	write("\"  'Jesus was a cross dresser'[George Carlin, 'Brain Droppings']\"\n");
