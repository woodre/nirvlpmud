...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5954", "north",
		"/players/mizan/opl/CELLS/C6194", "south",
		"/players/mizan/opl/CELLS/C6075", "east",
		"/players/mizan/opl/CELLS/C6073", "west",
	});
