...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4510", "north",
		"/players/mizan/opl/CELLS/C4750", "south",
		"/players/mizan/opl/CELLS/C4631", "east",
		"/players/mizan/opl/CELLS/C4629", "west",
	});
