...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1109", "north",
		"/players/mizan/opl/CELLS/C1349", "south",
		"/players/mizan/opl/CELLS/C1230", "east",
		"/players/mizan/opl/CELLS/C1228", "west",
	});
