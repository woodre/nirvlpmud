...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5932", "north",
		"/players/mizan/opl/CELLS/C6172", "south",
		"/players/mizan/opl/CELLS/C6053", "east",
		"/players/mizan/opl/CELLS/C6051", "west",
	});
