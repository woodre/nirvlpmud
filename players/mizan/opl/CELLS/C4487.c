...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4367", "north",
		"/players/mizan/opl/CELLS/C4607", "south",
		"/players/mizan/opl/CELLS/C4488", "east",
		"/players/mizan/opl/CELLS/C4486", "west",
	});
