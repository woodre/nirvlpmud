...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1287", "north",
		"/players/mizan/opl/CELLS/C1527", "south",
		"/players/mizan/opl/CELLS/C1408", "east",
		"/players/mizan/opl/CELLS/C1406", "west",
	});
