...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4983", "north",
		"/players/mizan/opl/CELLS/C5223", "south",
		"/players/mizan/opl/CELLS/C5104", "east",
		"/players/mizan/opl/CELLS/C5102", "west",
	});
