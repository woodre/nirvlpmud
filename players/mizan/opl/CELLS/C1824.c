...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1704", "north",
		"/players/mizan/opl/CELLS/C1944", "south",
		"/players/mizan/opl/CELLS/C1825", "east",
		"/players/mizan/opl/CELLS/C1823", "west",
	});
