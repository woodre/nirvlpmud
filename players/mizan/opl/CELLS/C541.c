...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C421", "north",
		"/players/mizan/opl/CELLS/C661", "south",
		"/players/mizan/opl/CELLS/C542", "east",
	});
...
long()
{
	...
	write("\"I love this fucking University, and this University loves fucking me.\"\n");
