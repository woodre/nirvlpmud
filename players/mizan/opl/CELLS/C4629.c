...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4509", "north",
		"/players/mizan/opl/CELLS/C4749", "south",
		"/players/mizan/opl/CELLS/C4630", "east",
		"/players/mizan/opl/CELLS/C4628", "west",
	});
