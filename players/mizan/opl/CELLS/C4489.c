...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4369", "north",
		"/players/mizan/opl/CELLS/C4609", "south",
		"/players/mizan/opl/CELLS/C4490", "east",
		"/players/mizan/opl/CELLS/C4488", "west",
	});
