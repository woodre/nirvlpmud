...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5217", "north",
		"/players/mizan/opl/CELLS/C5457", "south",
		"/players/mizan/opl/CELLS/C5338", "east",
		"/players/mizan/opl/CELLS/C5336", "west",
	});
