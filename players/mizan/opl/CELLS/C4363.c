...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4243", "north",
		"/players/mizan/opl/CELLS/C4483", "south",
		"/players/mizan/opl/CELLS/C4364", "east",
		"/players/mizan/opl/CELLS/C4362", "west",
	});
