...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3404", "north",
		"/players/mizan/opl/CELLS/C3644", "south",
		"/players/mizan/opl/CELLS/C3525", "east",
		"/players/mizan/opl/CELLS/C3523", "west",
	});
