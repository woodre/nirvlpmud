...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6089", "north",
		"/players/mizan/opl/CELLS/C6210", "east",
	});
...
long()
{
	...
	write("\"All Gods were immortal.		-- Stanislaw J. Lem, 'Unkempt Thoughts'\"\n");
