...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5795", "north",
		"/players/mizan/opl/CELLS/C6035", "south",
		"/players/mizan/opl/CELLS/C5916", "east",
		"/players/mizan/opl/CELLS/C5914", "west",
	});
