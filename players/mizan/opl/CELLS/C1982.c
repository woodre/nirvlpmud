...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1862", "north",
		"/players/mizan/opl/CELLS/C2102", "south",
		"/players/mizan/opl/CELLS/C1983", "east",
		"/players/mizan/opl/CELLS/C1981", "west",
	});
