...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2313", "north",
		"/players/mizan/opl/CELLS/C2553", "south",
		"/players/mizan/opl/CELLS/C2434", "east",
		"/players/mizan/opl/CELLS/C2432", "west",
	});
