...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5327", "north",
		"/players/mizan/opl/CELLS/C5567", "south",
		"/players/mizan/opl/CELLS/C5448", "east",
		"/players/mizan/opl/CELLS/C5446", "west",
	});
