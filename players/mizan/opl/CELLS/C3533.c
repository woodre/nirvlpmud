...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3413", "north",
		"/players/mizan/opl/CELLS/C3653", "south",
		"/players/mizan/opl/CELLS/C3534", "east",
		"/players/mizan/opl/CELLS/C3532", "west",
	});
