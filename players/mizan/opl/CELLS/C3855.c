...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3735", "north",
		"/players/mizan/opl/CELLS/C3975", "south",
		"/players/mizan/opl/CELLS/C3856", "east",
		"/players/mizan/opl/CELLS/C3854", "west",
	});
