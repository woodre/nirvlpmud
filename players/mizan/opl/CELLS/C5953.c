...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5833", "north",
		"/players/mizan/opl/CELLS/C6073", "south",
		"/players/mizan/opl/CELLS/C5954", "east",
		"/players/mizan/opl/CELLS/C5952", "west",
	});
