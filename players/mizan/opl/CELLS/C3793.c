...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3673", "north",
		"/players/mizan/opl/CELLS/C3794", "east",
		"/players/mizan/opl/CELLS/C3792", "west",
	});
...
long()
{
	...
	write("\"FOOLED you! Absorb EGO SHATTERING impulse rays, polyester poltroon!!\"\n");
