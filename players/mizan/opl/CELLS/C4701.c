...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4581", "north",
		"/players/mizan/opl/CELLS/C4821", "south",
		"/players/mizan/opl/CELLS/C4702", "east",
		"/players/mizan/opl/CELLS/C4700", "west",
	});
