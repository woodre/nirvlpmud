...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1694", "north",
		"/players/mizan/opl/CELLS/C1934", "south",
		"/players/mizan/opl/CELLS/C1815", "east",
		"/players/mizan/opl/CELLS/C1813", "west",
	});
...
long()
{
	...
	write("\"I think I'll snatch a kiss and flee.		-- Shakespeare\"\n");
