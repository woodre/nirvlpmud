...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1553", "north",
		"/players/mizan/opl/CELLS/C1793", "south",
		"/players/mizan/opl/CELLS/C1674", "east",
		"/players/mizan/opl/CELLS/C1672", "west",
	});
