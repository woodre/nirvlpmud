...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3709", "north",
		"/players/mizan/opl/CELLS/C3949", "south",
		"/players/mizan/opl/CELLS/C3830", "east",
		"/players/mizan/opl/CELLS/C3828", "west",
	});
