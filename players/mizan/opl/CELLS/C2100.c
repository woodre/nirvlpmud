...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1980", "north",
		"/players/mizan/opl/CELLS/C2220", "south",
		"/players/mizan/opl/CELLS/C2101", "east",
		"/players/mizan/opl/CELLS/C2099", "west",
	});
