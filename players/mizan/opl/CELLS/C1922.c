...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1802", "north",
		"/players/mizan/opl/CELLS/C2042", "south",
		"/players/mizan/opl/CELLS/C1923", "east",
		"/players/mizan/opl/CELLS/C1921", "west",
	});
