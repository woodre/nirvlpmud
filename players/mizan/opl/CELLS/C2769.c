...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2768", "west",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/hard/ogress.c");
...
long()
{
	...
	write("\"Theology: The study of elaborate verbal disguises for non-ideas.\"\n");
