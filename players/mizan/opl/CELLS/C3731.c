...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3611", "north",
		"/players/mizan/opl/CELLS/C3851", "south",
		"/players/mizan/opl/CELLS/C3732", "east",
		"/players/mizan/opl/CELLS/C3730", "west",
	});
