...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1815", "north",
		"/players/mizan/opl/CELLS/C2055", "south",
		"/players/mizan/opl/CELLS/C1936", "east",
		"/players/mizan/opl/CELLS/C1934", "west",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/medium/guard_turkey.c");
...
long()
{
	...
	write("\"Don't cook tonight -- starve a rat today!\"\n");
