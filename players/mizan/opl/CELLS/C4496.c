...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4376", "north",
		"/players/mizan/opl/CELLS/C4616", "south",
		"/players/mizan/opl/CELLS/C4497", "east",
		"/players/mizan/opl/CELLS/C4495", "west",
	});
