...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5340", "north",
		"/players/mizan/opl/CELLS/C5580", "south",
		"/players/mizan/opl/CELLS/C5461", "east",
		"/players/mizan/opl/CELLS/C5459", "west",
	});
