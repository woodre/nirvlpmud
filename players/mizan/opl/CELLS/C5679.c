...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5559", "north",
		"/players/mizan/opl/CELLS/C5799", "south",
		"/players/mizan/opl/CELLS/C5680", "east",
		"/players/mizan/opl/CELLS/C5678", "west",
	});
