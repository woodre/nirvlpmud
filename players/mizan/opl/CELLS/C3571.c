...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3691", "south",
		"/players/mizan/opl/CELLS/C3572", "east",
		"/players/mizan/opl/CELLS/C3570", "west",
	});
...
long()
{
	...
	write("\"Adultery:	Putting yourself in someone else's position.\"\n");
