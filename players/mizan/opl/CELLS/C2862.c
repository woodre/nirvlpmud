...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2742", "north",
		"/players/mizan/opl/CELLS/C2982", "south",
		"/players/mizan/opl/CELLS/C2863", "east",
		"/players/mizan/opl/CELLS/C2861", "west",
	});
