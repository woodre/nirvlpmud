...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C942", "north",
		"/players/mizan/opl/CELLS/C1182", "south",
		"/players/mizan/opl/CELLS/C1063", "east",
		"/players/mizan/opl/CELLS/C1061", "west",
	});
...
long()
{
	...
	write("\"Make war not sex. (It's safer.)\"\n");
