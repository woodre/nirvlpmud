...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2278", "north",
		"/players/mizan/opl/CELLS/C2518", "south",
	});
...
long()
{
	...
	write("\"A figure with curves always offers a lot of interesting angles.\"\n");
