...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1944", "north",
		"/players/mizan/opl/CELLS/C2184", "south",
		"/players/mizan/opl/CELLS/C2065", "east",
		"/players/mizan/opl/CELLS/C2063", "west",
	});
