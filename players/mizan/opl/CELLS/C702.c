...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C582", "north",
		"/players/mizan/opl/CELLS/C822", "south",
		"/players/mizan/opl/CELLS/C703", "east",
		"/players/mizan/opl/CELLS/C701", "west",
	});
