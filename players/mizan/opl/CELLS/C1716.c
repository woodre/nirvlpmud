...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1596", "north",
		"/players/mizan/opl/CELLS/C1836", "south",
		"/players/mizan/opl/CELLS/C1717", "east",
		"/players/mizan/opl/CELLS/C1715", "west",
	});
