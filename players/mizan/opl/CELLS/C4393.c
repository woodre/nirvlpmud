...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4273", "north",
		"/players/mizan/opl/CELLS/C4513", "south",
		"/players/mizan/opl/CELLS/C4394", "east",
		"/players/mizan/opl/CELLS/C4392", "west",
	});
