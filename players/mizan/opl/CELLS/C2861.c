...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2981", "south",
		"/players/mizan/opl/CELLS/C2862", "east",
		"/players/mizan/opl/CELLS/C2860", "west",
	});
...
long()
{
	...
	write("\"MMM-MM!! So THIS is BIO-NEBULATION!\"\n");
