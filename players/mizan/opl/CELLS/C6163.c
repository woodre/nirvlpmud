...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6043", "north",
		"/players/mizan/opl/CELLS/C6283", "south",
		"/players/mizan/opl/CELLS/C6164", "east",
		"/players/mizan/opl/CELLS/C6162", "west",
	});
