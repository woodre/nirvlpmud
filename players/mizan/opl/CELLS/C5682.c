...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5562", "north",
		"/players/mizan/opl/CELLS/C5802", "south",
		"/players/mizan/opl/CELLS/C5683", "east",
		"/players/mizan/opl/CELLS/C5681", "west",
	});
