...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5621", "north",
		"/players/mizan/opl/CELLS/C5861", "south",
		"/players/mizan/opl/CELLS/C5742", "east",
		"/players/mizan/opl/CELLS/C5740", "west",
	});
