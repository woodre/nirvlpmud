...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4859", "north",
		"/players/mizan/opl/CELLS/C5099", "south",
		"/players/mizan/opl/CELLS/C4980", "east",
		"/players/mizan/opl/CELLS/C4978", "west",
	});
