...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1765", "north",
		"/players/mizan/opl/CELLS/C2005", "south",
		"/players/mizan/opl/CELLS/C1886", "east",
		"/players/mizan/opl/CELLS/C1884", "west",
	});
