...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5108", "north",
		"/players/mizan/opl/CELLS/C5348", "south",
		"/players/mizan/opl/CELLS/C5229", "east",
		"/players/mizan/opl/CELLS/C5227", "west",
	});
