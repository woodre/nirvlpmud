...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1714", "north",
		"/players/mizan/opl/CELLS/C1954", "south",
		"/players/mizan/opl/CELLS/C1835", "east",
		"/players/mizan/opl/CELLS/C1833", "west",
	});
