...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2837", "north",
		"/players/mizan/opl/CELLS/C3077", "south",
	});
...
long()
{
	...
	write("\"Better a sister in a whorehouse than a brother on a Honda.\"\n");
