...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2596", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C2595");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I2595");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I2595");
...
long()
{
	...
	write("\"FUN is never having to say you're SUSHI!!\"\n");
