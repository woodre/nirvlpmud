...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5572", "north",
		"/players/mizan/opl/CELLS/C5812", "south",
		"/players/mizan/opl/CELLS/C5693", "east",
		"/players/mizan/opl/CELLS/C5691", "west",
	});
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/fungus/wookie.c");
