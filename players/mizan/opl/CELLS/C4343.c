...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4223", "north",
		"/players/mizan/opl/CELLS/C4463", "south",
		"/players/mizan/opl/CELLS/C4344", "east",
		"/players/mizan/opl/CELLS/C4342", "west",
	});
