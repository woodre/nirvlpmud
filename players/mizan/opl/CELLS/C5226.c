...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5106", "north",
		"/players/mizan/opl/CELLS/C5346", "south",
		"/players/mizan/opl/CELLS/C5227", "east",
		"/players/mizan/opl/CELLS/C5225", "west",
	});
