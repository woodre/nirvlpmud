...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1150", "north",
		"/players/mizan/opl/CELLS/C1390", "south",
		"/players/mizan/opl/CELLS/C1271", "east",
		"/players/mizan/opl/CELLS/C1269", "west",
	});
