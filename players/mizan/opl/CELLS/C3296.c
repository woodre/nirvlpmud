...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3176", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3296");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3296");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3296");
