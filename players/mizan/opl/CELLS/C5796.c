...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5676", "north",
		"/players/mizan/opl/CELLS/C5916", "south",
		"/players/mizan/opl/CELLS/C5797", "east",
		"/players/mizan/opl/CELLS/C5795", "west",
	});
