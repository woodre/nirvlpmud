...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5950", "north",
		"/players/mizan/opl/CELLS/C6190", "south",
		"/players/mizan/opl/CELLS/C6071", "east",
		"/players/mizan/opl/CELLS/C6069", "west",
	});
