...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1912", "north",
		"/players/mizan/opl/CELLS/C2152", "south",
		"/players/mizan/opl/CELLS/C2033", "east",
		"/players/mizan/opl/CELLS/C2031", "west",
	});
