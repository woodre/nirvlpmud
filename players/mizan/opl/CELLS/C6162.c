...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6042", "north",
		"/players/mizan/opl/CELLS/C6282", "south",
		"/players/mizan/opl/CELLS/C6163", "east",
		"/players/mizan/opl/CELLS/C6161", "west",
	});
