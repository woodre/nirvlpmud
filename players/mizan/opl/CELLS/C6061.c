...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5941", "north",
		"/players/mizan/opl/CELLS/C6181", "south",
		"/players/mizan/opl/CELLS/C6062", "east",
		"/players/mizan/opl/CELLS/C6060", "west",
	});
