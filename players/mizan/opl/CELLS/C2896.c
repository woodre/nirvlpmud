...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2776", "north",
		"/players/mizan/opl/CELLS/C2897", "east",
	});
...
long()
{
	...
	write("\"Q:	What can you use used tampons for?A:	Tea bags for vampires.\"\n");
