...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5203", "north",
		"/players/mizan/opl/CELLS/C5443", "south",
		"/players/mizan/opl/CELLS/C5324", "east",
		"/players/mizan/opl/CELLS/C5322", "west",
	});
