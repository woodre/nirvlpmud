...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4193", "north",
		"/players/mizan/opl/CELLS/C4433", "south",
		"/players/mizan/opl/CELLS/C4314", "east",
		"/players/mizan/opl/CELLS/C4312", "west",
	});
