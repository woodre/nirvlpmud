...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3251", "north",
		"/players/mizan/opl/CELLS/C3491", "south",
		"/players/mizan/opl/CELLS/C3372", "east",
		"/players/mizan/opl/CELLS/C3370", "west",
	});
