...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5824", "north",
		"/players/mizan/opl/CELLS/C6064", "south",
		"/players/mizan/opl/CELLS/C5945", "east",
		"/players/mizan/opl/CELLS/C5943", "west",
	});
