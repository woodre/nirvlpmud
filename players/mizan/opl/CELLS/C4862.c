...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4742", "north",
		"/players/mizan/opl/CELLS/C4982", "south",
		"/players/mizan/opl/CELLS/C4863", "east",
		"/players/mizan/opl/CELLS/C4861", "west",
	});
