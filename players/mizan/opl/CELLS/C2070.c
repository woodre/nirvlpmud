...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1950", "north",
		"/players/mizan/opl/CELLS/C2190", "south",
		"/players/mizan/opl/CELLS/C2071", "east",
		"/players/mizan/opl/CELLS/C2069", "west",
	});
