...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5309", "south",
		"/players/mizan/opl/CELLS/C5190", "east",
	});
...
long()
{
	...
	write("\"Of course, you UNDERSTAND about the PLAIDS in the SPIN CYCLE --\"\n");
