...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2253", "north",
		"/players/mizan/opl/CELLS/C2493", "south",
		"/players/mizan/opl/CELLS/C2374", "east",
		"/players/mizan/opl/CELLS/C2372", "west",
	});
