...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1906", "north",
		"/players/mizan/opl/CELLS/C2027", "east",
		"/players/mizan/opl/CELLS/C2025", "west",
	});
...
long()
{
	...
	write("\"'I own my own body, but I share'\"\n");
