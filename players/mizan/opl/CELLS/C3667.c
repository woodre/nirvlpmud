...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3547", "north",
		"/players/mizan/opl/CELLS/C3668", "east",
		"/players/mizan/opl/CELLS/C3666", "west",
	});
...
long()
{
	...
	write("\"I go the way that Providence dictates.		-- Adolf Hitler\"\n");
