...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1741", "north",
		"/players/mizan/opl/CELLS/C1981", "south",
		"/players/mizan/opl/CELLS/C1862", "east",
		"/players/mizan/opl/CELLS/C1860", "west",
	});
