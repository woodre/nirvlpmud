...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5383", "east",
		"/players/mizan/opl/CELLS/C5381", "west",
	});
...
long()
{
	...
	write("\"Will the third world war keep 'Bosom Buddies' off the air?\"\n");
