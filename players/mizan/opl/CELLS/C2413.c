...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2293", "north",
		"/players/mizan/opl/CELLS/C2533", "south",
		"/players/mizan/opl/CELLS/C2414", "east",
	});
...
long()
{
	...
	write("\"We just joined the civil hair patrol!\"\n");
