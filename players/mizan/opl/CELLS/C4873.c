...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4753", "north",
		"/players/mizan/opl/CELLS/C4993", "south",
		"/players/mizan/opl/CELLS/C4874", "east",
		"/players/mizan/opl/CELLS/C4872", "west",
	});
