...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3609", "north",
		"/players/mizan/opl/CELLS/C3849", "south",
		"/players/mizan/opl/CELLS/C3730", "east",
		"/players/mizan/opl/CELLS/C3728", "west",
	});
