...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4785", "south",
		"/players/mizan/opl/CELLS/C4666", "east",
		"/players/mizan/opl/CELLS/C4664", "west",
	});
...
long()
{
	...
	write("\"I want the presidency so bad I can already taste the hors d'oeuvres.\"\n");
