...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1982", "north",
		"/players/mizan/opl/CELLS/C2222", "south",
		"/players/mizan/opl/CELLS/C2103", "east",
		"/players/mizan/opl/CELLS/C2101", "west",
	});
