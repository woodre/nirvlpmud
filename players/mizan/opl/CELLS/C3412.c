...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3292", "north",
		"/players/mizan/opl/CELLS/C3532", "south",
		"/players/mizan/opl/CELLS/C3413", "east",
		"/players/mizan/opl/CELLS/C3411", "west",
	});
