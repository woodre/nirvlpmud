...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2764", "south",
		"/players/mizan/opl/CELLS/C2645", "east",
		"/players/mizan/opl/CELLS/C2643", "west",
	});
...
long()
{
	...
	write("\"impotent loser, n.:	Someone who can't even get his hopes up.\"\n");
