...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2133", "north",
		"/players/mizan/opl/CELLS/C2373", "south",
		"/players/mizan/opl/CELLS/C2254", "east",
		"/players/mizan/opl/CELLS/C2252", "west",
	});
