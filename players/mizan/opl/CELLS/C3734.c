...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3614", "north",
		"/players/mizan/opl/CELLS/C3854", "south",
		"/players/mizan/opl/CELLS/C3735", "east",
		"/players/mizan/opl/CELLS/C3733", "west",
	});
