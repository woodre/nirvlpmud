...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2174", "north",
		"/players/mizan/opl/CELLS/C2414", "south",
		"/players/mizan/opl/CELLS/C2295", "east",
		"/players/mizan/opl/CELLS/C2293", "west",
	});
...
long()
{
	...
	write("\"I just had my entire INTESTINAL TRACT coated with TEFLON!\"\n");
