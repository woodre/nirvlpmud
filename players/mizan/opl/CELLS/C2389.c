...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2269", "north",
		"/players/mizan/opl/CELLS/C2509", "south",
		"/players/mizan/opl/CELLS/C2390", "east",
		"/players/mizan/opl/CELLS/C2388", "west",
	});
