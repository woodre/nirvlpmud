...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4507", "north",
		"/players/mizan/opl/CELLS/C4747", "south",
		"/players/mizan/opl/CELLS/C4628", "east",
		"/players/mizan/opl/CELLS/C4626", "west",
	});
