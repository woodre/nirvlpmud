...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1451", "north",
		"/players/mizan/opl/CELLS/C1691", "south",
		"/players/mizan/opl/CELLS/C1572", "east",
	});
...
long()
{
	...
	write("\"Non Illegitimus Carborundum.	[Don't let the bastards wear you down.]\"\n");
