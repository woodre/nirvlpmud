...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4996", "north",
		"/players/mizan/opl/CELLS/C5236", "south",
		"/players/mizan/opl/CELLS/C5117", "east",
		"/players/mizan/opl/CELLS/C5115", "west",
	});
