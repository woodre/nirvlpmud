...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4866", "north",
		"/players/mizan/opl/CELLS/C5106", "south",
		"/players/mizan/opl/CELLS/C4987", "east",
		"/players/mizan/opl/CELLS/C4985", "west",
	});
