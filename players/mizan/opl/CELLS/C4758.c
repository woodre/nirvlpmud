...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4638", "north",
		"/players/mizan/opl/CELLS/C4878", "south",
		"/players/mizan/opl/CELLS/C4759", "east",
		"/players/mizan/opl/CELLS/C4757", "west",
	});
