...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C580", "north",
		"/players/mizan/opl/CELLS/C820", "south",
		"/players/mizan/opl/CELLS/C701", "east",
		"/players/mizan/opl/CELLS/C699", "west",
	});
