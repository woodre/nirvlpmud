...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1500", "north",
		"/players/mizan/opl/CELLS/C1740", "south",
		"/players/mizan/opl/CELLS/C1621", "east",
		"/players/mizan/opl/CELLS/C1619", "west",
	});
