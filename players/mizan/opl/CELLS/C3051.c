...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2931", "north",
		"/players/mizan/opl/CELLS/C3171", "south",
		"/players/mizan/opl/CELLS/C3052", "east",
		"/players/mizan/opl/CELLS/C3050", "west",
	});
