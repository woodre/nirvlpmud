...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4371", "north",
		"/players/mizan/opl/CELLS/C4611", "south",
		"/players/mizan/opl/CELLS/C4492", "east",
		"/players/mizan/opl/CELLS/C4490", "west",
	});
