...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2002", "north",
		"/players/mizan/opl/CELLS/C2242", "south",
		"/players/mizan/opl/CELLS/C2123", "east",
		"/players/mizan/opl/CELLS/C2121", "west",
	});
