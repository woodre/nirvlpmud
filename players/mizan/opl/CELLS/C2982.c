...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2862", "north",
		"/players/mizan/opl/CELLS/C3102", "south",
		"/players/mizan/opl/CELLS/C2983", "east",
		"/players/mizan/opl/CELLS/C2981", "west",
	});
