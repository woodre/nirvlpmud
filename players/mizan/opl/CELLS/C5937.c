...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5817", "north",
		"/players/mizan/opl/CELLS/C6057", "south",
		"/players/mizan/opl/CELLS/C5938", "east",
		"/players/mizan/opl/CELLS/C5936", "west",
	});
