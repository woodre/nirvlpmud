...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1512", "north",
		"/players/mizan/opl/CELLS/C1752", "south",
		"/players/mizan/opl/CELLS/C1633", "east",
		"/players/mizan/opl/CELLS/C1631", "west",
	});
