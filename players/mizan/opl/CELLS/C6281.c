...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6161", "north",
		"/players/mizan/opl/CELLS/C6401", "south",
		"/players/mizan/opl/CELLS/C6282", "east",
		"/players/mizan/opl/CELLS/C6280", "west",
	});
