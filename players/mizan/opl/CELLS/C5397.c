...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5277", "north",
		"/players/mizan/opl/CELLS/C5398", "east",
		"/players/mizan/opl/CELLS/C5396", "west",
	});
...
long()
{
	...
	write("\"Acid -- better living through chemistry.\"\n");
