...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5344", "north",
		"/players/mizan/opl/CELLS/C5584", "south",
		"/players/mizan/opl/CELLS/C5465", "east",
		"/players/mizan/opl/CELLS/C5463", "west",
	});
