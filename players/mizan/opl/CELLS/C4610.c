...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4490", "north",
		"/players/mizan/opl/CELLS/C4730", "south",
		"/players/mizan/opl/CELLS/C4611", "east",
		"/players/mizan/opl/CELLS/C4609", "west",
	});
