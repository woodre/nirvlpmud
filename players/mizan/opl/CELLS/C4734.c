...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4614", "north",
		"/players/mizan/opl/CELLS/C4854", "south",
		"/players/mizan/opl/CELLS/C4735", "east",
		"/players/mizan/opl/CELLS/C4733", "west",
	});
