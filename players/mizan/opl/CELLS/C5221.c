...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5101", "north",
		"/players/mizan/opl/CELLS/C5341", "south",
		"/players/mizan/opl/CELLS/C5222", "east",
		"/players/mizan/opl/CELLS/C5220", "west",
	});
