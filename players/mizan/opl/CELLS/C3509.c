...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3508", "west",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3509");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3509");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3509");
...
long()
{
	...
	write("\"In San Francisco, Halloween is redundant.		-- Will Durst\"\n");
