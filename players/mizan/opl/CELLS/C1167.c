...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1047", "north",
		"/players/mizan/opl/CELLS/C1287", "south",
		"/players/mizan/opl/CELLS/C1168", "east",
		"/players/mizan/opl/CELLS/C1166", "west",
	});
