...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3616", "north",
		"/players/mizan/opl/CELLS/C3856", "south",
		"/players/mizan/opl/CELLS/C3737", "east",
		"/players/mizan/opl/CELLS/C3735", "west",
	});
