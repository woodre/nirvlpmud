...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6485", "north",
		"/players/mizan/opl/CELLS/C6725", "south",
		"/players/mizan/opl/CELLS/C6606", "east",
		"/players/mizan/opl/CELLS/C6604", "west",
	});
...
long()
{
	...
	write("\"GET OFF THE FUCKING SYSTEM THIS INSTANT, YOU ASSHOLE!!!!\"\n");
