...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2485", "north",
		"/players/mizan/opl/CELLS/C2725", "south",
		"/players/mizan/opl/CELLS/C2606", "east",
		"/players/mizan/opl/CELLS/C2604", "west",
	});
