...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5336", "north",
		"/players/mizan/opl/CELLS/C5576", "south",
		"/players/mizan/opl/CELLS/C5457", "east",
		"/players/mizan/opl/CELLS/C5455", "west",
	});
