...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C534", "north",
		"/players/mizan/opl/CELLS/C774", "south",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/easy/neocon-blocker.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/easy/giraffe.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/easy/cobold.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/easy/cobold.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/easy/cobold.c");
		move_object(mob4, this_object());
	}


	custom_exits = 1;
	terrain_icon = HBGRN + BLK + "#" + NORM;
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/environs/uranium-puddle.c");
...
long()
{
	...
	write("\"This PIZZA symbolizes my COMPLETE EMOTIONAL RECOVERY!!\"\n");
