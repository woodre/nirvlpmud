...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4390", "north",
		"/players/mizan/opl/CELLS/C4630", "south",
		"/players/mizan/opl/CELLS/C4511", "east",
		"/players/mizan/opl/CELLS/C4509", "west",
	});
