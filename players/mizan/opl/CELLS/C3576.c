...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3456", "north",
		"/players/mizan/opl/CELLS/C3577", "east",
	});
...
long()
{
	...
	write("\"Q:	Why do men marry women?A:	You can't teach sheep to do housework.\"\n");
