...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3171", "north",
		"/players/mizan/opl/CELLS/C3411", "south",
		"/players/mizan/opl/CELLS/C3292", "east",
		"/players/mizan/opl/CELLS/C3290", "west",
	});
