...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3505", "east",
		"/players/mizan/opl/CELLS/C3503", "west",
	});
...
long()
{
	...
	write("\"What this department needs is a really good inflatable doll.\"\n");
