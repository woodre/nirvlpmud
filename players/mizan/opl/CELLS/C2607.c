...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2487", "north",
		"/players/mizan/opl/CELLS/C2727", "south",
		"/players/mizan/opl/CELLS/C2608", "east",
		"/players/mizan/opl/CELLS/C2606", "west",
	});
