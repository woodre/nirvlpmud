...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C547", "south",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/easy/gold.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/easy/gonk.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/easy/guido.c");
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C427");
		door1->set_type("normal-security");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I427");
		door2->set_type("normal-security");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I427");
...
long()
{
	...
	write("\"So you fucked up... you trusted us!		-- Animal House\"\n");
