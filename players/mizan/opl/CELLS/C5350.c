...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5230", "north",
		"/players/mizan/opl/CELLS/C5470", "south",
		"/players/mizan/opl/CELLS/C5351", "east",
		"/players/mizan/opl/CELLS/C5349", "west",
	});
