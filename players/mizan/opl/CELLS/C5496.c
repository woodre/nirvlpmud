...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5376", "north",
		"/players/mizan/opl/CELLS/C5616", "south",
		"/players/mizan/opl/CELLS/C5497", "east",
		"/players/mizan/opl/CELLS/C5495", "west",
	});
