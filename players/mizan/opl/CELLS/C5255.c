...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5135", "north",
		"/players/mizan/opl/CELLS/C5375", "south",
		"/players/mizan/opl/CELLS/C5256", "east",
		"/players/mizan/opl/CELLS/C5254", "west",
	});
