...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5443", "north",
		"/players/mizan/opl/CELLS/C5683", "south",
		"/players/mizan/opl/CELLS/C5564", "east",
		"/players/mizan/opl/CELLS/C5562", "west",
	});
