...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5577", "north",
		"/players/mizan/opl/CELLS/C5817", "south",
		"/players/mizan/opl/CELLS/C5698", "east",
		"/players/mizan/opl/CELLS/C5696", "west",
	});
