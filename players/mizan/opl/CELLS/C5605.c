...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5485", "north",
		"/players/mizan/opl/CELLS/C5725", "south",
		"/players/mizan/opl/CELLS/C5606", "east",
		"/players/mizan/opl/CELLS/C5604", "west",
	});
