...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1498", "north",
		"/players/mizan/opl/CELLS/C1738", "south",
		"/players/mizan/opl/CELLS/C1619", "east",
		"/players/mizan/opl/CELLS/C1617", "west",
	});
