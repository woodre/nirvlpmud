...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3290", "north",
		"/players/mizan/opl/CELLS/C3530", "south",
		"/players/mizan/opl/CELLS/C3411", "east",
		"/players/mizan/opl/CELLS/C3409", "west",
	});
