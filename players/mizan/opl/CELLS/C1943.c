...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1823", "north",
		"/players/mizan/opl/CELLS/C2063", "south",
		"/players/mizan/opl/CELLS/C1944", "east",
		"/players/mizan/opl/CELLS/C1942", "west",
	});
