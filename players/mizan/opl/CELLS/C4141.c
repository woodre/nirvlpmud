...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4021", "north",
		"/players/mizan/opl/CELLS/C4261", "south",
		"/players/mizan/opl/CELLS/C4142", "east",
		"/players/mizan/opl/CELLS/C4140", "west",
	});
