...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1138", "north",
		"/players/mizan/opl/CELLS/C1378", "south",
		"/players/mizan/opl/CELLS/C1259", "east",
		"/players/mizan/opl/CELLS/C1257", "west",
	});
