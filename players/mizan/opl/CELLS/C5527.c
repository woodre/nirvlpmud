...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5528", "east",
		"/players/mizan/opl/CELLS/C5526", "west",
	});
...
long()
{
	...
	write("\"My sex life hasn't been so good; either fist or famine.\"\n");
