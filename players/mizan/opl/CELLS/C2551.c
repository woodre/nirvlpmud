...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2431", "north",
		"/players/mizan/opl/CELLS/C2671", "south",
		"/players/mizan/opl/CELLS/C2552", "east",
		"/players/mizan/opl/CELLS/C2550", "west",
	});
