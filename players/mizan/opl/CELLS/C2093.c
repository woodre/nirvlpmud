...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1973", "north",
		"/players/mizan/opl/CELLS/C2213", "south",
		"/players/mizan/opl/CELLS/C2094", "east",
		"/players/mizan/opl/CELLS/C2092", "west",
	});
