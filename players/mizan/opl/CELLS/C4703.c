...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4583", "north",
		"/players/mizan/opl/CELLS/C4823", "south",
		"/players/mizan/opl/CELLS/C4704", "east",
		"/players/mizan/opl/CELLS/C4702", "west",
	});
