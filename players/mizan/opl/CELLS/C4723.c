...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4603", "north",
		"/players/mizan/opl/CELLS/C4843", "south",
		"/players/mizan/opl/CELLS/C4724", "east",
		"/players/mizan/opl/CELLS/C4722", "west",
	});
