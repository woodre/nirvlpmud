...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6362", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6361");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6361");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6361");
...
long()
{
	...
	write("\"He who hesitates is a damned fool.		-- Mae West\"\n");
