...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6970", "east",
		"/players/mizan/opl/CELLS/C6968", "west",
	});
...
long()
{
	...
	write("\"If you could get an erection, you would have no need for Emacs.\"\n");
