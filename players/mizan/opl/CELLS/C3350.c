...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3351", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3350");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3350");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3350");
...
long()
{
	...
	write("\"Never hit a man with glasses; hit him with a baseball bat.\"\n");
