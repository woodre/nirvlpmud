...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1861", "north",
		"/players/mizan/opl/CELLS/C2101", "south",
		"/players/mizan/opl/CELLS/C1982", "east",
		"/players/mizan/opl/CELLS/C1980", "west",
	});
