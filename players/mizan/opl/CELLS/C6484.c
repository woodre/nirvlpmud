...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6364", "north",
		"/players/mizan/opl/CELLS/C6604", "south",
		"/players/mizan/opl/CELLS/C6485", "east",
		"/players/mizan/opl/CELLS/C6483", "west",
	});
...
long()
{
	...
	write("\"Here we are in America ... when do we collect unemployment?\"\n");
