...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5253", "north",
		"/players/mizan/opl/CELLS/C5493", "south",
		"/players/mizan/opl/CELLS/C5374", "east",
		"/players/mizan/opl/CELLS/C5372", "west",
	});
