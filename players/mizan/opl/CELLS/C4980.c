...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4860", "north",
		"/players/mizan/opl/CELLS/C5100", "south",
		"/players/mizan/opl/CELLS/C4981", "east",
		"/players/mizan/opl/CELLS/C4979", "west",
	});
