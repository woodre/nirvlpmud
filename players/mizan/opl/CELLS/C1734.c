...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1614", "north",
		"/players/mizan/opl/CELLS/C1854", "south",
		"/players/mizan/opl/CELLS/C1735", "east",
		"/players/mizan/opl/CELLS/C1733", "west",
	});
