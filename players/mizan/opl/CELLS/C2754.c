...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2874", "south",
		"/players/mizan/opl/CELLS/C2755", "east",
		"/players/mizan/opl/CELLS/C2753", "west",
	});
...
long()
{
	...
	write("\"trust, n.:	Two cannibals having oral sex.\"\n");
