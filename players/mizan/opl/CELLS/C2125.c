...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2005", "north",
		"/players/mizan/opl/CELLS/C2245", "south",
		"/players/mizan/opl/CELLS/C2126", "east",
		"/players/mizan/opl/CELLS/C2124", "west",
	});
