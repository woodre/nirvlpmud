...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4125", "north",
		"/players/mizan/opl/CELLS/C4365", "south",
		"/players/mizan/opl/CELLS/C4246", "east",
		"/players/mizan/opl/CELLS/C4244", "west",
	});
