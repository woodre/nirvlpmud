...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2515", "east",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/rare/batty.c");
...
long()
{
	...
	write("\"I feel like I am sharing a ``CORN-DOG'' with NIKITA KHRUSCHEV ...\"\n");
