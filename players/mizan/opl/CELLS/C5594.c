...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5474", "north",
		"/players/mizan/opl/CELLS/C5714", "south",
		"/players/mizan/opl/CELLS/C5595", "east",
		"/players/mizan/opl/CELLS/C5593", "west",
	});
