...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5866", "north",
		"/players/mizan/opl/CELLS/C6106", "south",
		"/players/mizan/opl/CELLS/C5987", "east",
		"/players/mizan/opl/CELLS/C5985", "west",
	});
