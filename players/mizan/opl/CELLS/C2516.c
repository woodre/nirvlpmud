...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2636", "south",
		"/players/mizan/opl/CELLS/C2517", "east",
		"/players/mizan/opl/CELLS/C2515", "west",
	});
...
long()
{
	...
	write("\"Jesus Saves,Moses Invests,But only Buddha pays Dividends.\"\n");
