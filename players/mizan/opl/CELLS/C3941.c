...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3942", "east",
		"/players/mizan/opl/CELLS/C3940", "west",
	});
...
long()
{
	...
	write("\"A truly wise woman never plays leapfrog with a unicorn.\"\n");
