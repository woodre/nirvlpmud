...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4482", "north",
		"/players/mizan/opl/CELLS/C4722", "south",
		"/players/mizan/opl/CELLS/C4603", "east",
		"/players/mizan/opl/CELLS/C4601", "west",
	});
