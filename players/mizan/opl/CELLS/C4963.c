...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4843", "north",
		"/players/mizan/opl/CELLS/C5083", "south",
		"/players/mizan/opl/CELLS/C4964", "east",
		"/players/mizan/opl/CELLS/C4962", "west",
	});
