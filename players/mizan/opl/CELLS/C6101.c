...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5981", "north",
		"/players/mizan/opl/CELLS/C6221", "south",
		"/players/mizan/opl/CELLS/C6102", "east",
		"/players/mizan/opl/CELLS/C6100", "west",
	});
