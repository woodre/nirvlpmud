...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6286", "north",
		"/players/mizan/opl/CELLS/C6526", "south",
		"/players/mizan/opl/CELLS/C6407", "east",
		"/players/mizan/opl/CELLS/C6405", "west",
	});
