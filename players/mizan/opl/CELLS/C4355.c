...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4235", "north",
		"/players/mizan/opl/CELLS/C4475", "south",
		"/players/mizan/opl/CELLS/C4356", "east",
		"/players/mizan/opl/CELLS/C4354", "west",
	});
