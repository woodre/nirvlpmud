...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1076", "north",
		"/players/mizan/opl/CELLS/C1316", "south",
	});
...
long()
{
	...
	write("\"NEWARK has been REZONED!! DES MOINES has been REZONED!!\"\n");
