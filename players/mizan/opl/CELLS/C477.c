...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C357", "north",
		"/players/mizan/opl/CELLS/C597", "south",
		"/players/mizan/opl/CELLS/C478", "east",
		"/players/mizan/opl/CELLS/C476", "west",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/vehicles/m113.c");
		move_object(bonus, this_object());
	}

	if(!bonus2)
	{
		bonus2 = clone_object("/players/mizan/opl/vehicles/m113/key.c");
		move_object(bonus2, this_object());
	}

	if(!bonus3)
	{
		bonus3 = clone_object("/players/mizan/opl/vehicles/m113/ignition_key.c");
		move_object(bonus3, this_object());
	}
...
long()
{
	...
	write("\"I wouldn't fuck her with your prick.\"\n");
