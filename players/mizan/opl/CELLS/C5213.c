...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5093", "north",
		"/players/mizan/opl/CELLS/C5333", "south",
		"/players/mizan/opl/CELLS/C5214", "east",
		"/players/mizan/opl/CELLS/C5212", "west",
	});
