...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3381", "east",
		"/players/mizan/opl/CELLS/C3379", "west",
	});
...
long()
{
	...
	write("\"Marriage has driven more than one man to sex.		-- Peter De Vries\"\n");
