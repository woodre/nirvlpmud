...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1886", "north",
		"/players/mizan/opl/CELLS/C2126", "south",
		"/players/mizan/opl/CELLS/C2007", "east",
		"/players/mizan/opl/CELLS/C2005", "west",
	});
