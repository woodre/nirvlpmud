...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4022", "north",
		"/players/mizan/opl/CELLS/C4262", "south",
		"/players/mizan/opl/CELLS/C4143", "east",
		"/players/mizan/opl/CELLS/C4141", "west",
	});
