...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3428", "south",
		"/players/mizan/opl/CELLS/C3309", "east",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/medium/lectroid.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/medium/hydra.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/medium/sheep.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/medium/hydra.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/medium/hydra.c");
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/environs/vending-machine-junkfood.c");
...
long()
{
	...
	write("\"Q:	Why did God invent booze?A:	So ugly men could get laid too.\"\n");
