...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3628", "south",
		"/players/mizan/opl/CELLS/C3509", "east",
		"/players/mizan/opl/CELLS/C3507", "west",
	});
...
long()
{
	...
	write("\"Religion is fine, Churchianity sucks.\"\n");
