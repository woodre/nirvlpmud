...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4621", "north",
		"/players/mizan/opl/CELLS/C4861", "south",
		"/players/mizan/opl/CELLS/C4742", "east",
		"/players/mizan/opl/CELLS/C4740", "west",
	});
