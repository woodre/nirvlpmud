...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4526", "north",
		"/players/mizan/opl/CELLS/C4766", "south",
		"/players/mizan/opl/CELLS/C4645", "west",
	});
