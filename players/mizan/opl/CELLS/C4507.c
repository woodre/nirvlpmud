...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4387", "north",
		"/players/mizan/opl/CELLS/C4627", "south",
		"/players/mizan/opl/CELLS/C4508", "east",
		"/players/mizan/opl/CELLS/C4506", "west",
	});
