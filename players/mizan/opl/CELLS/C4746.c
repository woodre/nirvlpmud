...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4626", "north",
		"/players/mizan/opl/CELLS/C4866", "south",
		"/players/mizan/opl/CELLS/C4747", "east",
		"/players/mizan/opl/CELLS/C4745", "west",
	});
