...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2003", "north",
		"/players/mizan/opl/CELLS/C2243", "south",
		"/players/mizan/opl/CELLS/C2124", "east",
		"/players/mizan/opl/CELLS/C2122", "west",
	});
