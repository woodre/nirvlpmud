...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5366", "north",
		"/players/mizan/opl/CELLS/C5606", "south",
		"/players/mizan/opl/CELLS/C5487", "east",
		"/players/mizan/opl/CELLS/C5485", "west",
	});
