...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C143", "north",
		"/players/mizan/opl/CELLS/C383", "south",
		"/players/mizan/opl/CELLS/C264", "east",
	});
...
long()
{
	...
	write("\"lagnaf, n.:	Let's All Get Naked And Fuck!\"\n");
