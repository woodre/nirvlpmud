...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1593", "north",
		"/players/mizan/opl/CELLS/C1833", "south",
		"/players/mizan/opl/CELLS/C1714", "east",
		"/players/mizan/opl/CELLS/C1712", "west",
	});
