...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4340", "north",
		"/players/mizan/opl/CELLS/C4580", "south",
		"/players/mizan/opl/CELLS/C4461", "east",
		"/players/mizan/opl/CELLS/C4459", "west",
	});
