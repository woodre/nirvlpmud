...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6425", "north",
		"/players/mizan/opl/CELLS/C6665", "south",
		"/players/mizan/opl/CELLS/C6546", "east",
		"/players/mizan/opl/CELLS/C6544", "west",
	});
