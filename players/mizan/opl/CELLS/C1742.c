...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1622", "north",
		"/players/mizan/opl/CELLS/C1862", "south",
		"/players/mizan/opl/CELLS/C1743", "east",
		"/players/mizan/opl/CELLS/C1741", "west",
	});
