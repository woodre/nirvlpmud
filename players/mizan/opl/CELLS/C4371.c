...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4251", "north",
		"/players/mizan/opl/CELLS/C4491", "south",
		"/players/mizan/opl/CELLS/C4372", "east",
		"/players/mizan/opl/CELLS/C4370", "west",
	});
