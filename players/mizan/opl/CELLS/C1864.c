...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1744", "north",
		"/players/mizan/opl/CELLS/C1984", "south",
		"/players/mizan/opl/CELLS/C1865", "east",
		"/players/mizan/opl/CELLS/C1863", "west",
	});
