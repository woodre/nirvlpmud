...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6613", "north",
		"/players/mizan/opl/CELLS/C6853", "south",
		"/players/mizan/opl/CELLS/C6734", "east",
		"/players/mizan/opl/CELLS/C6732", "west",
	});
...
long()
{
	...
	write("\"happiness, n.:	Finding the owner of a lost bikini.\"\n");
