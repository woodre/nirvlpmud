...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5585", "north",
		"/players/mizan/opl/CELLS/C5825", "south",
		"/players/mizan/opl/CELLS/C5706", "east",
		"/players/mizan/opl/CELLS/C5704", "west",
	});
