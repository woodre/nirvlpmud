...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2980", "south",
		"/players/mizan/opl/CELLS/C2861", "east",
		"/players/mizan/opl/CELLS/C2859", "west",
	});
...
long()
{
	...
	write("\"'He could be a poster child for retroactive birth control.'\"\n");
