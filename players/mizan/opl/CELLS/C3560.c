...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3440", "north",
		"/players/mizan/opl/CELLS/C3561", "east",
		"/players/mizan/opl/CELLS/C3559", "west",
	});
...
long()
{
	...
	write("\"Elliptical, n.:	The feel of a kiss.\"\n");
