...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4965", "north",
		"/players/mizan/opl/CELLS/C5205", "south",
		"/players/mizan/opl/CELLS/C5086", "east",
		"/players/mizan/opl/CELLS/C5084", "west",
	});
