...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2789", "north",
		"/players/mizan/opl/CELLS/C3029", "south",
		"/players/mizan/opl/CELLS/C2910", "east",
		"/players/mizan/opl/CELLS/C2908", "west",
	});
