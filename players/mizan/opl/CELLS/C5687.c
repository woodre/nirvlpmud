...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5567", "north",
		"/players/mizan/opl/CELLS/C5807", "south",
		"/players/mizan/opl/CELLS/C5688", "east",
		"/players/mizan/opl/CELLS/C5686", "west",
	});
