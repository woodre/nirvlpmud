...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4337", "north",
		"/players/mizan/opl/CELLS/C4577", "south",
		"/players/mizan/opl/CELLS/C4458", "east",
		"/players/mizan/opl/CELLS/C4456", "west",
	});
