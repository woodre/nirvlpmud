...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C635", "north",
		"/players/mizan/opl/CELLS/C875", "south",
		"/players/mizan/opl/CELLS/C756", "east",
		"/players/mizan/opl/CELLS/C754", "west",
	});
