...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C811", "north",
		"/players/mizan/opl/CELLS/C1051", "south",
		"/players/mizan/opl/CELLS/C932", "east",
		"/players/mizan/opl/CELLS/C930", "west",
	});
