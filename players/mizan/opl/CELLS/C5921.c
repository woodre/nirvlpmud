...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5801", "north",
		"/players/mizan/opl/CELLS/C6041", "south",
		"/players/mizan/opl/CELLS/C5922", "east",
		"/players/mizan/opl/CELLS/C5920", "west",
	});
