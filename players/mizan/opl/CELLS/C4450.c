...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4330", "north",
		"/players/mizan/opl/CELLS/C4570", "south",
		"/players/mizan/opl/CELLS/C4451", "east",
		"/players/mizan/opl/CELLS/C4449", "west",
	});
