...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5631", "north",
		"/players/mizan/opl/CELLS/C5871", "south",
		"/players/mizan/opl/CELLS/C5752", "east",
		"/players/mizan/opl/CELLS/C5750", "west",
	});
