...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1526", "north",
		"/players/mizan/opl/CELLS/C1766", "south",
		"/players/mizan/opl/CELLS/C1647", "east",
		"/players/mizan/opl/CELLS/C1645", "west",
	});
