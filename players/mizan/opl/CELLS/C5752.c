...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5632", "north",
		"/players/mizan/opl/CELLS/C5872", "south",
		"/players/mizan/opl/CELLS/C5753", "east",
		"/players/mizan/opl/CELLS/C5751", "west",
	});
