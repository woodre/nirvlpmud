...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4342", "north",
		"/players/mizan/opl/CELLS/C4582", "south",
		"/players/mizan/opl/CELLS/C4463", "east",
		"/players/mizan/opl/CELLS/C4461", "west",
	});
