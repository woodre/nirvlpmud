...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5325", "north",
		"/players/mizan/opl/CELLS/C5565", "south",
		"/players/mizan/opl/CELLS/C5446", "east",
		"/players/mizan/opl/CELLS/C5444", "west",
	});
