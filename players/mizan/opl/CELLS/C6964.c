...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6844", "north",
		"/players/mizan/opl/CELLS/C6965", "east",
		"/players/mizan/opl/CELLS/C6963", "west",
	});
...
long()
{
	...
	write("\"If Jesus loves me, why doesn't he ever send me flowers?\"\n");
