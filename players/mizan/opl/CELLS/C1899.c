...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1779", "north",
		"/players/mizan/opl/CELLS/C2019", "south",
		"/players/mizan/opl/CELLS/C1900", "east",
		"/players/mizan/opl/CELLS/C1898", "west",
	});
