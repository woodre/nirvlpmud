...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2013", "north",
		"/players/mizan/opl/CELLS/C2253", "south",
		"/players/mizan/opl/CELLS/C2134", "east",
		"/players/mizan/opl/CELLS/C2132", "west",
	});
