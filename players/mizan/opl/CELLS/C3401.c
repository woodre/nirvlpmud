...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3281", "north",
		"/players/mizan/opl/CELLS/C3521", "south",
		"/players/mizan/opl/CELLS/C3402", "east",
		"/players/mizan/opl/CELLS/C3400", "west",
	});
