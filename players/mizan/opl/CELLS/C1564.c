...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1444", "north",
		"/players/mizan/opl/CELLS/C1565", "east",
	});
...
long()
{
	...
	write("\"A truly wise man never plays leapfrog with a unicorn.\"\n");
