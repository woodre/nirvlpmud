...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3291", "north",
		"/players/mizan/opl/CELLS/C3531", "south",
		"/players/mizan/opl/CELLS/C3412", "east",
		"/players/mizan/opl/CELLS/C3410", "west",
	});
