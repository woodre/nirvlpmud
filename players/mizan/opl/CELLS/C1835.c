...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1715", "north",
		"/players/mizan/opl/CELLS/C1955", "south",
		"/players/mizan/opl/CELLS/C1836", "east",
		"/players/mizan/opl/CELLS/C1834", "west",
	});
