...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2910", "north",
		"/players/mizan/opl/CELLS/C3150", "south",
		"/players/mizan/opl/CELLS/C3031", "east",
		"/players/mizan/opl/CELLS/C3029", "west",
	});
