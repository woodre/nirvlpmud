...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5346", "north",
		"/players/mizan/opl/CELLS/C5586", "south",
		"/players/mizan/opl/CELLS/C5467", "east",
		"/players/mizan/opl/CELLS/C5465", "west",
	});
