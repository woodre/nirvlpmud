...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3312", "north",
		"/players/mizan/opl/CELLS/C3552", "south",
		"/players/mizan/opl/CELLS/C3433", "east",
		"/players/mizan/opl/CELLS/C3431", "west",
	});
...
long()
{
	...
	write("\"Q:	What is the sound of one cat napping?A:	Mu.\"\n");
