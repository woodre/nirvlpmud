...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2860", "north",
		"/players/mizan/opl/CELLS/C3100", "south",
		"/players/mizan/opl/CELLS/C2981", "east",
		"/players/mizan/opl/CELLS/C2979", "west",
	});
...
long()
{
	...
	write("\"Sex is the mathematics urge sublimated.		-- M. C. Reed\"\n");
