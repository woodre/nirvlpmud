...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C690", "north",
		"/players/mizan/opl/CELLS/C930", "south",
		"/players/mizan/opl/CELLS/C811", "east",
		"/players/mizan/opl/CELLS/C809", "west",
	});
