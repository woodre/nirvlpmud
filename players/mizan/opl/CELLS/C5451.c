...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5331", "north",
		"/players/mizan/opl/CELLS/C5571", "south",
		"/players/mizan/opl/CELLS/C5452", "east",
		"/players/mizan/opl/CELLS/C5450", "west",
	});
