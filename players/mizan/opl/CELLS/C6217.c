...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6097", "north",
		"/players/mizan/opl/CELLS/C6337", "south",
		"/players/mizan/opl/CELLS/C6218", "east",
		"/players/mizan/opl/CELLS/C6216", "west",
	});
