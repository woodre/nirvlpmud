...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6609", "east",
		"/players/mizan/opl/CELLS/C6607", "west",
	});
...
long()
{
	...
	write("\"These PRESERVES should be FORCE-FED to PENTAGON OFFICIALS!!\"\n");
