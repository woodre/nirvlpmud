...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6613", "south",
		"/players/mizan/opl/CELLS/C6494", "east",
		"/players/mizan/opl/CELLS/C6492", "west",
	});
...
long()
{
	...
	write("\"She's fine, upstanding, and wonderful laying down.\"\n");
