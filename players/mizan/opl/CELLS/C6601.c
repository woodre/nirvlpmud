...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6602", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6601");
		door1->set_type("secpass-n");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6601");
		door2->set_type("secpass-n");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6601");
