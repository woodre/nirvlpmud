...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3846", "north",
		"/players/mizan/opl/CELLS/C4086", "south",
		"/players/mizan/opl/CELLS/C3967", "east",
		"/players/mizan/opl/CELLS/C3965", "west",
	});
