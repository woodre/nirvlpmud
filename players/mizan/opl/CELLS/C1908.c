...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1788", "north",
		"/players/mizan/opl/CELLS/C2028", "south",
	});
...
long()
{
	...
	write("\"Yow! Those people look exactly like Donnie and Marie Osmond!!\"\n");
