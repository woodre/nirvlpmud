...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1357", "north",
		"/players/mizan/opl/CELLS/C1597", "south",
		"/players/mizan/opl/CELLS/C1478", "east",
		"/players/mizan/opl/CELLS/C1476", "west",
	});
