...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6182", "north",
		"/players/mizan/opl/CELLS/C6422", "south",
		"/players/mizan/opl/CELLS/C6303", "east",
		"/players/mizan/opl/CELLS/C6301", "west",
	});
