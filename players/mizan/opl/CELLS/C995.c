...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C875", "north",
		"/players/mizan/opl/CELLS/C1115", "south",
		"/players/mizan/opl/CELLS/C996", "east",
		"/players/mizan/opl/CELLS/C994", "west",
	});
