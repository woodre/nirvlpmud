...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1792", "north",
		"/players/mizan/opl/CELLS/C2032", "south",
		"/players/mizan/opl/CELLS/C1913", "east",
		"/players/mizan/opl/CELLS/C1911", "west",
	});
