...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6573", "west",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6574");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6574");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6574");
...
long()
{
	...
	write("\"My pants just went to high school in the Carlsbad Caverns!!!\"\n");
