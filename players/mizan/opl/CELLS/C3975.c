...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3855", "north",
		"/players/mizan/opl/CELLS/C4095", "south",
		"/players/mizan/opl/CELLS/C3976", "east",
		"/players/mizan/opl/CELLS/C3974", "west",
	});
