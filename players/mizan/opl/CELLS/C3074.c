...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3075", "east",
		"/players/mizan/opl/CELLS/C3073", "west",
	});
...
long()
{
	...
	write("\"People who live in glass houses should ball in the basement.\"\n");
