...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5204", "north",
		"/players/mizan/opl/CELLS/C5444", "south",
		"/players/mizan/opl/CELLS/C5325", "east",
		"/players/mizan/opl/CELLS/C5323", "west",
	});
