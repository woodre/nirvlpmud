...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4494", "north",
		"/players/mizan/opl/CELLS/C4734", "south",
		"/players/mizan/opl/CELLS/C4615", "east",
		"/players/mizan/opl/CELLS/C4613", "west",
	});
