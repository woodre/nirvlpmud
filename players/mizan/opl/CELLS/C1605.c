...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1485", "north",
		"/players/mizan/opl/CELLS/C1725", "south",
	});
...
long()
{
	...
	write("\"Nuke them till they glow, then shoot them in the dark.\"\n");
