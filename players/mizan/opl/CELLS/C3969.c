...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3849", "north",
		"/players/mizan/opl/CELLS/C4089", "south",
		"/players/mizan/opl/CELLS/C3970", "east",
		"/players/mizan/opl/CELLS/C3968", "west",
	});
