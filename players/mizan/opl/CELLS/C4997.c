...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4877", "north",
		"/players/mizan/opl/CELLS/C5117", "south",
		"/players/mizan/opl/CELLS/C4998", "east",
		"/players/mizan/opl/CELLS/C4996", "west",
	});
