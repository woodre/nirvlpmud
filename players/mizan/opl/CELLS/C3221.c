...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3101", "north",
		"/players/mizan/opl/CELLS/C3341", "south",
		"/players/mizan/opl/CELLS/C3222", "east",
		"/players/mizan/opl/CELLS/C3220", "west",
	});
...
long()
{
	...
	write("\"I'm ZIPPY the PINHEAD and I'm totally committed to the festive mode.\"\n");
