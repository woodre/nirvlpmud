...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5956", "north",
		"/players/mizan/opl/CELLS/C6196", "south",
		"/players/mizan/opl/CELLS/C6077", "east",
		"/players/mizan/opl/CELLS/C6075", "west",
	});
