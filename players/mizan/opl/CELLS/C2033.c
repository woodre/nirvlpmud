...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1913", "north",
		"/players/mizan/opl/CELLS/C2153", "south",
		"/players/mizan/opl/CELLS/C2034", "east",
		"/players/mizan/opl/CELLS/C2032", "west",
	});
