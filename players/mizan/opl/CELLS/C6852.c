...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6732", "north",
		"/players/mizan/opl/CELLS/C6972", "south",
		"/players/mizan/opl/CELLS/C6853", "east",
	});
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/shoop.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/shoop.c");
