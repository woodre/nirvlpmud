...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5952", "north",
		"/players/mizan/opl/CELLS/C6192", "south",
		"/players/mizan/opl/CELLS/C6073", "east",
		"/players/mizan/opl/CELLS/C6071", "west",
	});
