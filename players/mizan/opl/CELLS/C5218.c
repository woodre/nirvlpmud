...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5098", "north",
		"/players/mizan/opl/CELLS/C5338", "south",
		"/players/mizan/opl/CELLS/C5219", "east",
		"/players/mizan/opl/CELLS/C5217", "west",
	});
