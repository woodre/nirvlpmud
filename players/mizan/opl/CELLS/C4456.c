...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4336", "north",
		"/players/mizan/opl/CELLS/C4576", "south",
		"/players/mizan/opl/CELLS/C4457", "east",
		"/players/mizan/opl/CELLS/C4455", "west",
	});
