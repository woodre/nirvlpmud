...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5460", "north",
		"/players/mizan/opl/CELLS/C5700", "south",
		"/players/mizan/opl/CELLS/C5581", "east",
		"/players/mizan/opl/CELLS/C5579", "west",
	});
