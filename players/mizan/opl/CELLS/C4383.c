...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4263", "north",
		"/players/mizan/opl/CELLS/C4503", "south",
		"/players/mizan/opl/CELLS/C4384", "east",
		"/players/mizan/opl/CELLS/C4382", "west",
	});
