...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C689", "north",
		"/players/mizan/opl/CELLS/C929", "south",
		"/players/mizan/opl/CELLS/C810", "east",
		"/players/mizan/opl/CELLS/C808", "west",
	});
