...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3674", "north",
		"/players/mizan/opl/CELLS/C3795", "east",
		"/players/mizan/opl/CELLS/C3793", "west",
	});
...
long()
{
	...
	write("\"Humanity's first sin was faith; the first virtue was doubt.\"\n");
