...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2071", "north",
		"/players/mizan/opl/CELLS/C2311", "south",
		"/players/mizan/opl/CELLS/C2192", "east",
		"/players/mizan/opl/CELLS/C2190", "west",
	});
