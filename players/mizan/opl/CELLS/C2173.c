...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2053", "north",
		"/players/mizan/opl/CELLS/C2293", "south",
		"/players/mizan/opl/CELLS/C2174", "east",
		"/players/mizan/opl/CELLS/C2172", "west",
	});
