...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C756", "north",
		"/players/mizan/opl/CELLS/C996", "south",
		"/players/mizan/opl/CELLS/C877", "east",
		"/players/mizan/opl/CELLS/C875", "west",
	});
