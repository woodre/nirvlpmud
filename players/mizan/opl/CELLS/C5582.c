...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5462", "north",
		"/players/mizan/opl/CELLS/C5702", "south",
		"/players/mizan/opl/CELLS/C5583", "east",
		"/players/mizan/opl/CELLS/C5581", "west",
	});
