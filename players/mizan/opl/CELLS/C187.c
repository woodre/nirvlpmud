...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C188", "east",
		"/players/mizan/opl/CELLS/C186", "west",
	});
...
long()
{
	...
	write("\"Here I sit, my cheeks a flexin',Just gave birth to another Texan.\"\n");
