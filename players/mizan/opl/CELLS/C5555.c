...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5435", "north",
		"/players/mizan/opl/CELLS/C5675", "south",
		"/players/mizan/opl/CELLS/C5556", "east",
		"/players/mizan/opl/CELLS/C5554", "west",
	});
