...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5402", "north",
		"/players/mizan/opl/CELLS/C5642", "south",
		"/players/mizan/opl/CELLS/C5523", "east",
	});
...
long()
{
	...
	write("\"Moody bitch with attitude, seeks nice, good-looking guy to dump on.\"\n");
