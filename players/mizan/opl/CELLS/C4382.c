...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4262", "north",
		"/players/mizan/opl/CELLS/C4502", "south",
		"/players/mizan/opl/CELLS/C4383", "east",
		"/players/mizan/opl/CELLS/C4381", "west",
	});
