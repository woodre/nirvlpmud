...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6404", "north",
		"/players/mizan/opl/CELLS/C6644", "south",
		"/players/mizan/opl/CELLS/C6525", "east",
		"/players/mizan/opl/CELLS/C6523", "west",
	});
