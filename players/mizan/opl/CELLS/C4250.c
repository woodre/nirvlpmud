...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4130", "north",
		"/players/mizan/opl/CELLS/C4370", "south",
		"/players/mizan/opl/CELLS/C4251", "east",
		"/players/mizan/opl/CELLS/C4249", "west",
	});
