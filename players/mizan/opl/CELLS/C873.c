...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C753", "north",
		"/players/mizan/opl/CELLS/C993", "south",
		"/players/mizan/opl/CELLS/C874", "east",
		"/players/mizan/opl/CELLS/C872", "west",
	});
