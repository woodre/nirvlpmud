...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1273", "north",
		"/players/mizan/opl/CELLS/C1513", "south",
		"/players/mizan/opl/CELLS/C1394", "east",
		"/players/mizan/opl/CELLS/C1392", "west",
	});
