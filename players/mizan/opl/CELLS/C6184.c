...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6064", "north",
		"/players/mizan/opl/CELLS/C6304", "south",
		"/players/mizan/opl/CELLS/C6185", "east",
		"/players/mizan/opl/CELLS/C6183", "west",
	});
