...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6160", "north",
		"/players/mizan/opl/CELLS/C6400", "south",
		"/players/mizan/opl/CELLS/C6281", "east",
		"/players/mizan/opl/CELLS/C6279", "west",
	});
