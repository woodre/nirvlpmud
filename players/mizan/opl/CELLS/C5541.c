...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5421", "north",
		"/players/mizan/opl/CELLS/C5661", "south",
	});
...
long()
{
	...
	write("\"Obscenity is the crutch of inarticulate motherfuckers.\"\n");
