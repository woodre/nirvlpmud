...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5580", "north",
		"/players/mizan/opl/CELLS/C5820", "south",
		"/players/mizan/opl/CELLS/C5701", "east",
		"/players/mizan/opl/CELLS/C5699", "west",
	});
