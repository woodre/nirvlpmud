...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5112", "north",
		"/players/mizan/opl/CELLS/C5352", "south",
		"/players/mizan/opl/CELLS/C5233", "east",
		"/players/mizan/opl/CELLS/C5231", "west",
	});
