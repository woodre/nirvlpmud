...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6178", "north",
		"/players/mizan/opl/CELLS/C6418", "south",
		"/players/mizan/opl/CELLS/C6299", "east",
		"/players/mizan/opl/CELLS/C6297", "west",
	});
