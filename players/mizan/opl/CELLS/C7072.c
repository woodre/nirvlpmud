...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C7073", "east",
		"/players/mizan/opl/CELLS/C7071", "west",
	});
...
long()
{
	...
	write("\"Women Unite! Make *___him* sleep in the wet spot tonight!\"\n");
