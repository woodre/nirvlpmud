...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5945", "north",
		"/players/mizan/opl/CELLS/C6185", "south",
		"/players/mizan/opl/CELLS/C6066", "east",
		"/players/mizan/opl/CELLS/C6064", "west",
	});
