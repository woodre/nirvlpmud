...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5454", "north",
		"/players/mizan/opl/CELLS/C5694", "south",
		"/players/mizan/opl/CELLS/C5575", "east",
		"/players/mizan/opl/CELLS/C5573", "west",
	});
