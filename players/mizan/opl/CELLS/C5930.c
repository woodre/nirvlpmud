...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5810", "north",
		"/players/mizan/opl/CELLS/C6050", "south",
		"/players/mizan/opl/CELLS/C5931", "east",
		"/players/mizan/opl/CELLS/C5929", "west",
	});
