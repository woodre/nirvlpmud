...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4464", "north",
		"/players/mizan/opl/CELLS/C4704", "south",
		"/players/mizan/opl/CELLS/C4585", "east",
		"/players/mizan/opl/CELLS/C4583", "west",
	});
