...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C646", "south",
		"/players/mizan/opl/CELLS/C527", "east",
		"/players/mizan/opl/CELLS/C525", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/hard/lectroid_boss.c");
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/goldhard.c");
...
long()
{
	...
	write("\"sadism, n.:	A sadist refusing to whip a masochist.\"\n");
