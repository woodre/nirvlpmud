...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4608", "north",
		"/players/mizan/opl/CELLS/C4848", "south",
		"/players/mizan/opl/CELLS/C4729", "east",
		"/players/mizan/opl/CELLS/C4727", "west",
	});
