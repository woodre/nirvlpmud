...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2716", "north",
		"/players/mizan/opl/CELLS/C2837", "east",
		"/players/mizan/opl/CELLS/C2835", "west",
	});
...
long()
{
	...
	write("\"Did you know that Spiro Agnew is an anagram of 'Grow a Penis'?\"\n");
