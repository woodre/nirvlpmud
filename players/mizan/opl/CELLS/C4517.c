...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4397", "north",
		"/players/mizan/opl/CELLS/C4637", "south",
		"/players/mizan/opl/CELLS/C4518", "east",
		"/players/mizan/opl/CELLS/C4516", "west",
	});
