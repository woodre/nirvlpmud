...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1474", "north",
		"/players/mizan/opl/CELLS/C1714", "south",
		"/players/mizan/opl/CELLS/C1595", "east",
		"/players/mizan/opl/CELLS/C1593", "west",
	});
