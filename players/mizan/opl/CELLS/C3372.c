...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3252", "north",
		"/players/mizan/opl/CELLS/C3492", "south",
		"/players/mizan/opl/CELLS/C3373", "east",
		"/players/mizan/opl/CELLS/C3371", "west",
	});
