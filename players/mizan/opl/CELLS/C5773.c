...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5774", "east",
		"/players/mizan/opl/CELLS/C5772", "west",
	});
...
long()
{
	...
	write("\"I'm having a tax-deductible experience! I need an energy crunch!!\"\n");
