...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4220", "north",
		"/players/mizan/opl/CELLS/C4460", "south",
		"/players/mizan/opl/CELLS/C4341", "east",
		"/players/mizan/opl/CELLS/C4339", "west",
	});
