...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5102", "north",
		"/players/mizan/opl/CELLS/C5342", "south",
		"/players/mizan/opl/CELLS/C5223", "east",
		"/players/mizan/opl/CELLS/C5221", "west",
	});
