...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5798", "north",
		"/players/mizan/opl/CELLS/C6038", "south",
		"/players/mizan/opl/CELLS/C5919", "east",
		"/players/mizan/opl/CELLS/C5917", "west",
	});
