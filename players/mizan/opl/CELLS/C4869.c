...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4749", "north",
		"/players/mizan/opl/CELLS/C4989", "south",
		"/players/mizan/opl/CELLS/C4870", "east",
		"/players/mizan/opl/CELLS/C4868", "west",
	});
