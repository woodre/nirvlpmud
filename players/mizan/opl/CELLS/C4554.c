...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4434", "north",
		"/players/mizan/opl/CELLS/C4674", "south",
		"/players/mizan/opl/CELLS/C4555", "east",
		"/players/mizan/opl/CELLS/C4553", "west",
	});
