...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5254", "north",
		"/players/mizan/opl/CELLS/C5494", "south",
		"/players/mizan/opl/CELLS/C5375", "east",
		"/players/mizan/opl/CELLS/C5373", "west",
	});
