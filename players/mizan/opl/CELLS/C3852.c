...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3732", "north",
		"/players/mizan/opl/CELLS/C3972", "south",
		"/players/mizan/opl/CELLS/C3853", "east",
		"/players/mizan/opl/CELLS/C3851", "west",
	});
