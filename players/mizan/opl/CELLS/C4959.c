...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4839", "north",
		"/players/mizan/opl/CELLS/C5079", "south",
		"/players/mizan/opl/CELLS/C4960", "east",
		"/players/mizan/opl/CELLS/C4958", "west",
	});
