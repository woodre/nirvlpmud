...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1949", "north",
		"/players/mizan/opl/CELLS/C2189", "south",
		"/players/mizan/opl/CELLS/C2070", "east",
		"/players/mizan/opl/CELLS/C2068", "west",
	});
