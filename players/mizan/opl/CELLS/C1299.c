...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1419", "south",
		"/players/mizan/opl/CELLS/C1298", "west",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/easy/giraffe.c");
...
long()
{
	...
	write("\"This is National Smokers-Are-Shits Week.\"\n");
