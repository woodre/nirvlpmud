...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3951", "north",
		"/players/mizan/opl/CELLS/C4191", "south",
		"/players/mizan/opl/CELLS/C4072", "east",
		"/players/mizan/opl/CELLS/C4070", "west",
	});
