...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5933", "north",
		"/players/mizan/opl/CELLS/C6173", "south",
		"/players/mizan/opl/CELLS/C6054", "east",
		"/players/mizan/opl/CELLS/C6052", "west",
	});
