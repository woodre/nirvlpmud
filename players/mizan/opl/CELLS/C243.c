...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C123", "north",
		"/players/mizan/opl/CELLS/C363", "south",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/easy/gold.c");
...
long()
{
	...
	write("\"I know things about TROY DONAHUE that can't even be PRINTED!!\"\n");
