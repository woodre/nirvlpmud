...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3866", "north",
		"/players/mizan/opl/CELLS/C4106", "south",
		"/players/mizan/opl/CELLS/C3985", "west",
	});
...
long()
{
	...
	write("\"Q:	Where does virgin wool come from?A:	Ugly sheep.\"\n");
