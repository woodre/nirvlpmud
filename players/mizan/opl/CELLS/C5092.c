...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4972", "north",
		"/players/mizan/opl/CELLS/C5212", "south",
		"/players/mizan/opl/CELLS/C5093", "east",
		"/players/mizan/opl/CELLS/C5091", "west",
	});
