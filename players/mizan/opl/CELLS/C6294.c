...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6174", "north",
		"/players/mizan/opl/CELLS/C6414", "south",
		"/players/mizan/opl/CELLS/C6295", "east",
		"/players/mizan/opl/CELLS/C6293", "west",
	});
