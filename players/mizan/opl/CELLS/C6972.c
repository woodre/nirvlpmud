...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6852", "north",
		"/players/mizan/opl/CELLS/C6973", "east",
		"/players/mizan/opl/CELLS/C6971", "west",
	});
