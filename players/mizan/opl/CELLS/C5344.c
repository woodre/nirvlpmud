...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5224", "north",
		"/players/mizan/opl/CELLS/C5464", "south",
		"/players/mizan/opl/CELLS/C5345", "east",
		"/players/mizan/opl/CELLS/C5343", "west",
	});
