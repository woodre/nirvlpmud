...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C222", "north",
		"/players/mizan/opl/CELLS/C462", "south",
		"/players/mizan/opl/CELLS/C343", "east",
		"/players/mizan/opl/CELLS/C341", "west",
	});
