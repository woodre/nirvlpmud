...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5105", "north",
		"/players/mizan/opl/CELLS/C5345", "south",
		"/players/mizan/opl/CELLS/C5226", "east",
		"/players/mizan/opl/CELLS/C5224", "west",
	});
