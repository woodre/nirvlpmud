...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4966", "north",
		"/players/mizan/opl/CELLS/C5206", "south",
		"/players/mizan/opl/CELLS/C5087", "east",
		"/players/mizan/opl/CELLS/C5085", "west",
	});
