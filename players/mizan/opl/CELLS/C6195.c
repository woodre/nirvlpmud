...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6075", "north",
		"/players/mizan/opl/CELLS/C6315", "south",
		"/players/mizan/opl/CELLS/C6196", "east",
		"/players/mizan/opl/CELLS/C6194", "west",
	});
