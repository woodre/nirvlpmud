...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3408", "north",
		"/players/mizan/opl/CELLS/C3648", "south",
		"/players/mizan/opl/CELLS/C3529", "east",
		"/players/mizan/opl/CELLS/C3527", "west",
	});
