...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5820", "north",
		"/players/mizan/opl/CELLS/C6060", "south",
		"/players/mizan/opl/CELLS/C5941", "east",
		"/players/mizan/opl/CELLS/C5939", "west",
	});
