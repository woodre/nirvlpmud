...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1791", "north",
		"/players/mizan/opl/CELLS/C2031", "south",
		"/players/mizan/opl/CELLS/C1912", "east",
		"/players/mizan/opl/CELLS/C1910", "west",
	});
