...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2522", "south",
		"/players/mizan/opl/CELLS/C2403", "east",
		"/players/mizan/opl/CELLS/C2401", "west",
	});
...
long()
{
	...
	write("\"Where the hell is Wall Drug?\"\n");
