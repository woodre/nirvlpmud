...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5829", "north",
		"/players/mizan/opl/CELLS/C6069", "south",
		"/players/mizan/opl/CELLS/C5950", "east",
		"/players/mizan/opl/CELLS/C5948", "west",
	});
