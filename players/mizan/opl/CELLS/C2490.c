...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2370", "north",
		"/players/mizan/opl/CELLS/C2610", "south",
		"/players/mizan/opl/CELLS/C2491", "east",
		"/players/mizan/opl/CELLS/C2489", "west",
	});
