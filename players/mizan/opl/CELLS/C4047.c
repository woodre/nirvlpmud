...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3927", "north",
		"/players/mizan/opl/CELLS/C4167", "south",
		"/players/mizan/opl/CELLS/C4048", "east",
		"/players/mizan/opl/CELLS/C4046", "west",
	});
...
long()
{
	...
	write("\"HELLO KITTY gang terrorizes town, family STICKERED to death!\"\n");
