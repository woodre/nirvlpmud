...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5119", "north",
		"/players/mizan/opl/CELLS/C5359", "south",
		"/players/mizan/opl/CELLS/C5240", "east",
		"/players/mizan/opl/CELLS/C5238", "west",
	});
