...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4260", "north",
		"/players/mizan/opl/CELLS/C4500", "south",
		"/players/mizan/opl/CELLS/C4381", "east",
		"/players/mizan/opl/CELLS/C4379", "west",
	});
