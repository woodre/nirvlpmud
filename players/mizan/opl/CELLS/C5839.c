...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5719", "north",
		"/players/mizan/opl/CELLS/C5959", "south",
		"/players/mizan/opl/CELLS/C5840", "east",
		"/players/mizan/opl/CELLS/C5838", "west",
	});
