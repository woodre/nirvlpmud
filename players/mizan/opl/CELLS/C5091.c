...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4971", "north",
		"/players/mizan/opl/CELLS/C5211", "south",
		"/players/mizan/opl/CELLS/C5092", "east",
		"/players/mizan/opl/CELLS/C5090", "west",
	});
