...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2668", "north",
		"/players/mizan/opl/CELLS/C2908", "south",
		"/players/mizan/opl/CELLS/C2789", "east",
		"/players/mizan/opl/CELLS/C2787", "west",
	});
