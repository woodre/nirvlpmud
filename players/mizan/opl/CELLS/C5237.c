...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5117", "north",
		"/players/mizan/opl/CELLS/C5357", "south",
		"/players/mizan/opl/CELLS/C5238", "east",
		"/players/mizan/opl/CELLS/C5236", "west",
	});
