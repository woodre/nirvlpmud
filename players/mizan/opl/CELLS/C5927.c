...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5807", "north",
		"/players/mizan/opl/CELLS/C6047", "south",
		"/players/mizan/opl/CELLS/C5928", "east",
		"/players/mizan/opl/CELLS/C5926", "west",
	});
