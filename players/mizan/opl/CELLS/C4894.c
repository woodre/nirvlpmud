...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4774", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C4894");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I4894");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I4894");
...
long()
{
	...
	write("\"Dial 911. Make a cop come.\"\n");
