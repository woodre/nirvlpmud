...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6868", "north",
		"/players/mizan/opl/CELLS/C6989", "east",
	});
...
long()
{
	...
	write("\"I wish I was on a Cincinnati street corner holding a clean dog!\"\n");
