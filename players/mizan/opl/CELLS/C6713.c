...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6714", "east",
		"/players/mizan/opl/CELLS/C6712", "west",
	});
...
long()
{
	...
	write("\"Jack an Jill went up the hill.Jill went down,Jack came.\"\n");
