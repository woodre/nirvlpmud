...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6853", "north",
		"/players/mizan/opl/CELLS/C6974", "east",
		"/players/mizan/opl/CELLS/C6972", "west",
	});
...
long()
{
	...
	write("\"The difference between graffiti and philosophy is the word 'fuck'.\"\n");
