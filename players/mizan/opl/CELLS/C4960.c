...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4840", "north",
		"/players/mizan/opl/CELLS/C5080", "south",
		"/players/mizan/opl/CELLS/C4961", "east",
		"/players/mizan/opl/CELLS/C4959", "west",
	});
