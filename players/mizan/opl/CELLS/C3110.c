...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3111", "east",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/environs/ublood_processor.c");
...
long()
{
	...
	write("\"An air of FRENCH FRIES permeates my nostrils!!\"\n");
