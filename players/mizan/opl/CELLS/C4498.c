...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4378", "north",
		"/players/mizan/opl/CELLS/C4618", "south",
		"/players/mizan/opl/CELLS/C4499", "east",
		"/players/mizan/opl/CELLS/C4497", "west",
	});
