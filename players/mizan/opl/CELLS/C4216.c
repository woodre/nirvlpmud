...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4096", "north",
		"/players/mizan/opl/CELLS/C4336", "south",
		"/players/mizan/opl/CELLS/C4217", "east",
		"/players/mizan/opl/CELLS/C4215", "west",
	});
