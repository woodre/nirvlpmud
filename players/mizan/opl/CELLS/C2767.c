...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2647", "north",
		"/players/mizan/opl/CELLS/C2768", "east",
	});
...
long()
{
	...
	write("\"... I want to perform cranial activities with Tuesday Weld!!\"\n");
