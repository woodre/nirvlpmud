...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5231", "north",
		"/players/mizan/opl/CELLS/C5471", "south",
		"/players/mizan/opl/CELLS/C5352", "east",
		"/players/mizan/opl/CELLS/C5350", "west",
	});
