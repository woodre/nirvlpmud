...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2294", "north",
		"/players/mizan/opl/CELLS/C2534", "south",
		"/players/mizan/opl/CELLS/C2415", "east",
		"/players/mizan/opl/CELLS/C2413", "west",
	});
