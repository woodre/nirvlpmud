...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5771", "north",
		"/players/mizan/opl/CELLS/C5890", "west",
	});
...
long()
{
	...
	write("\"Such evil deeds could religion prompt.		-- Titus Lucretius Carus\"\n");
