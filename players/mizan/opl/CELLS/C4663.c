...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4664", "east",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/easy/knobgoblin.c");
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C4663");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I4663");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I4663");
...
long()
{
	...
	write("\"A toast to the kisses you've snatched and vice-versa.\"\n");
