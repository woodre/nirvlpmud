...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4047", "north",
		"/players/mizan/opl/CELLS/C4287", "south",
		"/players/mizan/opl/CELLS/C4168", "east",
		"/players/mizan/opl/CELLS/C4166", "west",
	});
...
long()
{
	...
	write("\"Man who keep money in jockstrap has financial matters all balled up.\"\n");
