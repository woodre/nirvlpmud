...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3832", "north",
		"/players/mizan/opl/CELLS/C4072", "south",
		"/players/mizan/opl/CELLS/C3953", "east",
		"/players/mizan/opl/CELLS/C3951", "west",
	});
