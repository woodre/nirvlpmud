...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6291", "north",
		"/players/mizan/opl/CELLS/C6531", "south",
		"/players/mizan/opl/CELLS/C6412", "east",
		"/players/mizan/opl/CELLS/C6410", "west",
	});
