...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C299", "south",
		"/players/mizan/opl/CELLS/C178", "west",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/vehicles/fuel/diesel_can.c");
...
long()
{
	...
	write("\"You should be a hemorrhoid, you're such a pain in the ass.\"\n");
