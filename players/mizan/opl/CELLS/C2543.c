...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2663", "south",
		"/players/mizan/opl/CELLS/C2544", "east",
	});
...
long()
{
	...
	write("\"QOTD:	'You might as well say 'yes', the sheets are messy already.'\"\n");
