...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5239", "north",
		"/players/mizan/opl/CELLS/C5479", "south",
		"/players/mizan/opl/CELLS/C5360", "east",
		"/players/mizan/opl/CELLS/C5358", "west",
	});
