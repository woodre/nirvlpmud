...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4024", "north",
		"/players/mizan/opl/CELLS/C4264", "south",
		"/players/mizan/opl/CELLS/C4145", "east",
		"/players/mizan/opl/CELLS/C4143", "west",
	});
