...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C218", "north",
		"/players/mizan/opl/CELLS/C458", "south",
	});
...
long()
{
	...
	write("\"Corrupt, adj.:	In politics, holding an office of trust or profit.\"\n");
