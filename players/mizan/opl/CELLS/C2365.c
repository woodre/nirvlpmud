...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2245", "north",
		"/players/mizan/opl/CELLS/C2485", "south",
		"/players/mizan/opl/CELLS/C2366", "east",
		"/players/mizan/opl/CELLS/C2364", "west",
	});
