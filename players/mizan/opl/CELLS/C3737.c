...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3617", "north",
		"/players/mizan/opl/CELLS/C3857", "south",
		"/players/mizan/opl/CELLS/C3738", "east",
		"/players/mizan/opl/CELLS/C3736", "west",
	});
