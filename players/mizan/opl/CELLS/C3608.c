...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3488", "north",
		"/players/mizan/opl/CELLS/C3728", "south",
		"/players/mizan/opl/CELLS/C3609", "east",
		"/players/mizan/opl/CELLS/C3607", "west",
	});
