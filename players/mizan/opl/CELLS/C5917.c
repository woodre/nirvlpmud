...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5797", "north",
		"/players/mizan/opl/CELLS/C6037", "south",
		"/players/mizan/opl/CELLS/C5918", "east",
		"/players/mizan/opl/CELLS/C5916", "west",
	});
