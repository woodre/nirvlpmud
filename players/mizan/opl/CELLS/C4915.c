...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4795", "north",
		"/players/mizan/opl/CELLS/C5035", "south",
		"/players/mizan/opl/CELLS/C4916", "east",
		"/players/mizan/opl/CELLS/C4914", "west",
	});
