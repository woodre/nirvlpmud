...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2490", "north",
		"/players/mizan/opl/CELLS/C2730", "south",
		"/players/mizan/opl/CELLS/C2611", "east",
		"/players/mizan/opl/CELLS/C2609", "west",
	});
