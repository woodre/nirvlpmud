...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1456", "north",
		"/players/mizan/opl/CELLS/C1696", "south",
		"/players/mizan/opl/CELLS/C1577", "east",
		"/players/mizan/opl/CELLS/C1575", "west",
	});
...
long()
{
	...
	write("\"HOORAY, Ronald!! Now YOU can marry LINDA RONSTADT too!!\"\n");
