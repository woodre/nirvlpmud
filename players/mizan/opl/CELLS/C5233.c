...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5113", "north",
		"/players/mizan/opl/CELLS/C5353", "south",
		"/players/mizan/opl/CELLS/C5234", "east",
		"/players/mizan/opl/CELLS/C5232", "west",
	});
