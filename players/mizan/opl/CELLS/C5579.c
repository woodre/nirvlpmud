...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5459", "north",
		"/players/mizan/opl/CELLS/C5699", "south",
		"/players/mizan/opl/CELLS/C5580", "east",
		"/players/mizan/opl/CELLS/C5578", "west",
	});
