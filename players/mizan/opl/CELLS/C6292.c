...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6172", "north",
		"/players/mizan/opl/CELLS/C6412", "south",
		"/players/mizan/opl/CELLS/C6293", "east",
		"/players/mizan/opl/CELLS/C6291", "west",
	});
