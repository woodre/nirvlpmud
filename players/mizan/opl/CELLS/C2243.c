...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2123", "north",
		"/players/mizan/opl/CELLS/C2363", "south",
		"/players/mizan/opl/CELLS/C2244", "east",
		"/players/mizan/opl/CELLS/C2242", "west",
	});
