...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5703", "north",
		"/players/mizan/opl/CELLS/C5943", "south",
		"/players/mizan/opl/CELLS/C5824", "east",
		"/players/mizan/opl/CELLS/C5822", "west",
	});
