...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5356", "north",
		"/players/mizan/opl/CELLS/C5596", "south",
		"/players/mizan/opl/CELLS/C5477", "east",
		"/players/mizan/opl/CELLS/C5475", "west",
	});
