...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5799", "north",
		"/players/mizan/opl/CELLS/C6039", "south",
		"/players/mizan/opl/CELLS/C5920", "east",
		"/players/mizan/opl/CELLS/C5918", "west",
	});
