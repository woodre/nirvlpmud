...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2387", "north",
		"/players/mizan/opl/CELLS/C2627", "south",
		"/players/mizan/opl/CELLS/C2508", "east",
		"/players/mizan/opl/CELLS/C2506", "west",
	});
