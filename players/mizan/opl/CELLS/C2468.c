...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2469", "east",
		"/players/mizan/opl/CELLS/C2467", "west",
	});
...
long()
{
	...
	write("\"What luck for the rulers that men do not think.		-- Adolph Hitler\"\n");
