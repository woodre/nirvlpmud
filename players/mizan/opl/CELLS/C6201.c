...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6081", "north",
		"/players/mizan/opl/CELLS/C6321", "south",
		"/players/mizan/opl/CELLS/C6202", "east",
		"/players/mizan/opl/CELLS/C6200", "west",
	});
