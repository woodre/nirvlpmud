...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5442", "north",
		"/players/mizan/opl/CELLS/C5682", "south",
		"/players/mizan/opl/CELLS/C5563", "east",
		"/players/mizan/opl/CELLS/C5561", "west",
	});
