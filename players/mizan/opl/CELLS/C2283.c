...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2163", "north",
		"/players/mizan/opl/CELLS/C2403", "south",
	});
...
long()
{
	...
	write("\"Hey, waiter! I want a NEW SHIRT and a PONY TAIL with lemon sauce!\"\n");
