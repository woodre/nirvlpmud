...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1228", "north",
		"/players/mizan/opl/CELLS/C1468", "south",
		"/players/mizan/opl/CELLS/C1349", "east",
		"/players/mizan/opl/CELLS/C1347", "west",
	});
