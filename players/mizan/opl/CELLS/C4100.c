...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3980", "north",
		"/players/mizan/opl/CELLS/C4220", "south",
		"/players/mizan/opl/CELLS/C4101", "east",
		"/players/mizan/opl/CELLS/C4099", "west",
	});
