...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4379", "north",
		"/players/mizan/opl/CELLS/C4619", "south",
		"/players/mizan/opl/CELLS/C4500", "east",
		"/players/mizan/opl/CELLS/C4498", "west",
	});
