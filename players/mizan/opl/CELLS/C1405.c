...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1285", "north",
		"/players/mizan/opl/CELLS/C1525", "south",
		"/players/mizan/opl/CELLS/C1406", "east",
		"/players/mizan/opl/CELLS/C1404", "west",
	});
