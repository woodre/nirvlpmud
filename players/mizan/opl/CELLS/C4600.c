...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4480", "north",
		"/players/mizan/opl/CELLS/C4720", "south",
		"/players/mizan/opl/CELLS/C4601", "east",
		"/players/mizan/opl/CELLS/C4599", "west",
	});
