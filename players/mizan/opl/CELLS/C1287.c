...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1167", "north",
		"/players/mizan/opl/CELLS/C1407", "south",
		"/players/mizan/opl/CELLS/C1288", "east",
		"/players/mizan/opl/CELLS/C1286", "west",
	});
