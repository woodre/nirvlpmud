...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5682", "north",
		"/players/mizan/opl/CELLS/C5922", "south",
		"/players/mizan/opl/CELLS/C5803", "east",
		"/players/mizan/opl/CELLS/C5801", "west",
	});
