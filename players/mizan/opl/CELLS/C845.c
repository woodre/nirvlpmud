...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C725", "north",
		"/players/mizan/opl/CELLS/C965", "south",
		"/players/mizan/opl/CELLS/C846", "east",
		"/players/mizan/opl/CELLS/C844", "west",
	});
