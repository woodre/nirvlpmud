...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4244", "north",
		"/players/mizan/opl/CELLS/C4484", "south",
		"/players/mizan/opl/CELLS/C4365", "east",
		"/players/mizan/opl/CELLS/C4363", "west",
	});
