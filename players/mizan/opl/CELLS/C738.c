...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C618", "north",
		"/players/mizan/opl/CELLS/C858", "south",
		"/players/mizan/opl/CELLS/C739", "east",
		"/players/mizan/opl/CELLS/C737", "west",
	});
...
long()
{
	...
	write("\"You might get caught holding the bag. Say she's your sister.\"\n");
