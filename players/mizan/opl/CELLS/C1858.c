...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1738", "north",
		"/players/mizan/opl/CELLS/C1978", "south",
		"/players/mizan/opl/CELLS/C1859", "east",
		"/players/mizan/opl/CELLS/C1857", "west",
	});
