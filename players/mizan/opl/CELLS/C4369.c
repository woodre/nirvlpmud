...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4249", "north",
		"/players/mizan/opl/CELLS/C4489", "south",
		"/players/mizan/opl/CELLS/C4370", "east",
		"/players/mizan/opl/CELLS/C4368", "west",
	});
