...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5470", "north",
		"/players/mizan/opl/CELLS/C5710", "south",
		"/players/mizan/opl/CELLS/C5591", "east",
		"/players/mizan/opl/CELLS/C5589", "west",
	});
