...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1986", "north",
		"/players/mizan/opl/CELLS/C2226", "south",
		"/players/mizan/opl/CELLS/C2107", "east",
		"/players/mizan/opl/CELLS/C2105", "west",
	});
