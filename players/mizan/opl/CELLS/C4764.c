...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4644", "north",
		"/players/mizan/opl/CELLS/C4884", "south",
		"/players/mizan/opl/CELLS/C4765", "east",
	});
...
long()
{
	...
	write("\"The real trouble with women is that they have *all* the pussy.\"\n");
