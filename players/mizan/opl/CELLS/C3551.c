...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3431", "north",
		"/players/mizan/opl/CELLS/C3671", "south",
		"/players/mizan/opl/CELLS/C3552", "east",
		"/players/mizan/opl/CELLS/C3550", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/medium/gundroid_hard.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/medium/karate_normal_man.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/medium/gundroid_hard.c");
...
long()
{
	...
	write("\"Why does the Vatican have lightning rods?\"\n");
