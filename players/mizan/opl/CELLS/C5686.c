...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5566", "north",
		"/players/mizan/opl/CELLS/C5806", "south",
		"/players/mizan/opl/CELLS/C5687", "east",
		"/players/mizan/opl/CELLS/C5685", "west",
	});
