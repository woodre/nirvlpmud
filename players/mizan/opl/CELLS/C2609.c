...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2489", "north",
		"/players/mizan/opl/CELLS/C2729", "south",
		"/players/mizan/opl/CELLS/C2610", "east",
		"/players/mizan/opl/CELLS/C2608", "west",
	});
