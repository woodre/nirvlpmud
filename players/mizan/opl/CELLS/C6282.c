...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6162", "north",
		"/players/mizan/opl/CELLS/C6402", "south",
		"/players/mizan/opl/CELLS/C6283", "east",
		"/players/mizan/opl/CELLS/C6281", "west",
	});
