...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C755", "north",
		"/players/mizan/opl/CELLS/C995", "south",
		"/players/mizan/opl/CELLS/C876", "east",
		"/players/mizan/opl/CELLS/C874", "west",
	});
