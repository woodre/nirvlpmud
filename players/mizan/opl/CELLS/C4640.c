...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4520", "north",
		"/players/mizan/opl/CELLS/C4760", "south",
		"/players/mizan/opl/CELLS/C4641", "east",
		"/players/mizan/opl/CELLS/C4639", "west",
	});
