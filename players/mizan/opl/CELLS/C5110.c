...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4990", "north",
		"/players/mizan/opl/CELLS/C5230", "south",
		"/players/mizan/opl/CELLS/C5111", "east",
		"/players/mizan/opl/CELLS/C5109", "west",
	});
