...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5642", "north",
		"/players/mizan/opl/CELLS/C5882", "south",
		"/players/mizan/opl/CELLS/C5763", "east",
	});
...
long()
{
	...
	write("\"Were there no women, men might live like gods.		-- Thomas Dekker\"\n");
