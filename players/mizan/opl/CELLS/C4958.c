...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4838", "north",
		"/players/mizan/opl/CELLS/C5078", "south",
		"/players/mizan/opl/CELLS/C4959", "east",
		"/players/mizan/opl/CELLS/C4957", "west",
	});
