...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5847", "north",
		"/players/mizan/opl/CELLS/C6087", "south",
	});
...
long()
{
	...
	write("\"Kotex, n.:	Not the best thing on earth, but next to the best.\"\n");
