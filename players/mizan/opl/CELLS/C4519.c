...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4399", "north",
		"/players/mizan/opl/CELLS/C4639", "south",
		"/players/mizan/opl/CELLS/C4520", "east",
		"/players/mizan/opl/CELLS/C4518", "west",
	});
