...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1984", "north",
		"/players/mizan/opl/CELLS/C2224", "south",
		"/players/mizan/opl/CELLS/C2105", "east",
		"/players/mizan/opl/CELLS/C2103", "west",
	});
