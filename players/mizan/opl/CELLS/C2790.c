...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2670", "north",
		"/players/mizan/opl/CELLS/C2910", "south",
		"/players/mizan/opl/CELLS/C2791", "east",
		"/players/mizan/opl/CELLS/C2789", "west",
	});
