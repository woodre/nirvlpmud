...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2211", "north",
		"/players/mizan/opl/CELLS/C2451", "south",
		"/players/mizan/opl/CELLS/C2330", "west",
	});
...
long()
{
	...
	write("\"That girl could suck the chrome off a bumper.\"\n");
