...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4258", "north",
		"/players/mizan/opl/CELLS/C4498", "south",
		"/players/mizan/opl/CELLS/C4379", "east",
		"/players/mizan/opl/CELLS/C4377", "west",
	});
