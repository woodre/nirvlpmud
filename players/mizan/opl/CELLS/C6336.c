...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6216", "north",
		"/players/mizan/opl/CELLS/C6456", "south",
		"/players/mizan/opl/CELLS/C6337", "east",
		"/players/mizan/opl/CELLS/C6335", "west",
	});
