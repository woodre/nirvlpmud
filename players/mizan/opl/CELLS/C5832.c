...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5712", "north",
		"/players/mizan/opl/CELLS/C5952", "south",
		"/players/mizan/opl/CELLS/C5833", "east",
		"/players/mizan/opl/CELLS/C5831", "west",
	});
