...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3310", "north",
		"/players/mizan/opl/CELLS/C3550", "south",
		"/players/mizan/opl/CELLS/C3431", "east",
		"/players/mizan/opl/CELLS/C3429", "west",
	});
...
long()
{
	...
	write("\"Does it rape elephants?		-- Brent Byer\"\n");
