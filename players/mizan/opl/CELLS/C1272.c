...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1152", "north",
		"/players/mizan/opl/CELLS/C1392", "south",
		"/players/mizan/opl/CELLS/C1273", "east",
		"/players/mizan/opl/CELLS/C1271", "west",
	});
