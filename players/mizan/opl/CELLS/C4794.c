...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4674", "north",
		"/players/mizan/opl/CELLS/C4914", "south",
		"/players/mizan/opl/CELLS/C4795", "east",
		"/players/mizan/opl/CELLS/C4793", "west",
	});
