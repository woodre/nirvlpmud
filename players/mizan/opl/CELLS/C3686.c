...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3806", "south",
		"/players/mizan/opl/CELLS/C3687", "east",
	});
...
long()
{
	...
	write("\"What the hell, go ahead and put all your eggs in one basket.\"\n");
