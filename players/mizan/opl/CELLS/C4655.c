...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4535", "north",
		"/players/mizan/opl/CELLS/C4775", "south",
		"/players/mizan/opl/CELLS/C4656", "east",
		"/players/mizan/opl/CELLS/C4654", "west",
	});
...
long()
{
	...
	write("\"Confucious say:	man who make love on ground have piece on Earth.\"\n");
