...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5321", "north",
		"/players/mizan/opl/CELLS/C5561", "south",
		"/players/mizan/opl/CELLS/C5442", "east",
		"/players/mizan/opl/CELLS/C5440", "west",
	});
