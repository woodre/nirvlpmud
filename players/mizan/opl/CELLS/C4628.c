...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4508", "north",
		"/players/mizan/opl/CELLS/C4748", "south",
		"/players/mizan/opl/CELLS/C4629", "east",
		"/players/mizan/opl/CELLS/C4627", "west",
	});
