...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6062", "north",
		"/players/mizan/opl/CELLS/C6302", "south",
		"/players/mizan/opl/CELLS/C6183", "east",
		"/players/mizan/opl/CELLS/C6181", "west",
	});
