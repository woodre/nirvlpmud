...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C285", "east",
		"/players/mizan/opl/CELLS/C283", "west",
	});
...
long()
{
	...
	write("\"I'm continually AMAZED at th'breathtaking effects of WIND EROSION!!\"\n");
