...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5646", "south",
		"/players/mizan/opl/CELLS/C5527", "east",
		"/players/mizan/opl/CELLS/C5525", "west",
	});
...
long()
{
	...
	write("\"I guess you guys got BIG MUSCLES from doing too much STUDYING!\"\n");
