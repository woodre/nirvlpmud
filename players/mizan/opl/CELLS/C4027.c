...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3907", "north",
		"/players/mizan/opl/CELLS/C4147", "south",
		"/players/mizan/opl/CELLS/C4028", "east",
		"/players/mizan/opl/CELLS/C4026", "west",
	});
