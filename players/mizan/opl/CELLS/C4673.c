...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4553", "north",
		"/players/mizan/opl/CELLS/C4793", "south",
		"/players/mizan/opl/CELLS/C4674", "east",
		"/players/mizan/opl/CELLS/C4672", "west",
	});
