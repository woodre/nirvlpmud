...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1082", "north",
		"/players/mizan/opl/CELLS/C1203", "east",
		"/players/mizan/opl/CELLS/C1201", "west",
	});
...
long()
{
	...
	write("\"I hope the ``Eurythmics'' practice birth control ...\"\n");
