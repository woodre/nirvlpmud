...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4013", "north",
		"/players/mizan/opl/CELLS/C4253", "south",
		"/players/mizan/opl/CELLS/C4134", "east",
		"/players/mizan/opl/CELLS/C4132", "west",
	});
