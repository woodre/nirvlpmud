...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5742", "north",
		"/players/mizan/opl/CELLS/C5982", "south",
		"/players/mizan/opl/CELLS/C5863", "east",
		"/players/mizan/opl/CELLS/C5861", "west",
	});
