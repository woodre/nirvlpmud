...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3487", "north",
		"/players/mizan/opl/CELLS/C3727", "south",
		"/players/mizan/opl/CELLS/C3608", "east",
		"/players/mizan/opl/CELLS/C3606", "west",
	});
