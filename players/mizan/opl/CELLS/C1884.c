...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1764", "north",
		"/players/mizan/opl/CELLS/C2004", "south",
		"/players/mizan/opl/CELLS/C1885", "east",
		"/players/mizan/opl/CELLS/C1883", "west",
	});
