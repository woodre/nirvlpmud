...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1859", "north",
		"/players/mizan/opl/CELLS/C2099", "south",
		"/players/mizan/opl/CELLS/C1980", "east",
		"/players/mizan/opl/CELLS/C1978", "west",
	});
