...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2407", "east",
		"/players/mizan/opl/CELLS/C2405", "west",
	});
...
long()
{
	...
	write("\"Nine out of ten priests who have tried Camels, prefer young boys.\"\n");
