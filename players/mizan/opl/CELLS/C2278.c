...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2158", "north",
		"/players/mizan/opl/CELLS/C2398", "south",
		"/players/mizan/opl/CELLS/C2277", "west",
	});
...
long()
{
	...
	write("\"Yow! Did something bad happen or am I in a drive-in movie??\"\n");
