...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3102", "north",
		"/players/mizan/opl/CELLS/C3342", "south",
		"/players/mizan/opl/CELLS/C3223", "east",
		"/players/mizan/opl/CELLS/C3221", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/hard/domokun.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/hard/narci.c");
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/weasel.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/domokun.c");
...
long()
{
	...
	write("\"Couples in motion have moments.\"\n");
