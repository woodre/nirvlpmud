...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2054", "north",
		"/players/mizan/opl/CELLS/C2294", "south",
		"/players/mizan/opl/CELLS/C2175", "east",
		"/players/mizan/opl/CELLS/C2173", "west",
	});
...
long()
{
	...
	write("\"If you don't ride a camel to work, you ain't Sheeite.\"\n");
