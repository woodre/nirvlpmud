...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5685", "north",
		"/players/mizan/opl/CELLS/C5925", "south",
		"/players/mizan/opl/CELLS/C5806", "east",
		"/players/mizan/opl/CELLS/C5804", "west",
	});
