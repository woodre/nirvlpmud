...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C728", "north",
		"/players/mizan/opl/CELLS/C968", "south",
		"/players/mizan/opl/CELLS/C849", "east",
		"/players/mizan/opl/CELLS/C847", "west",
	});
