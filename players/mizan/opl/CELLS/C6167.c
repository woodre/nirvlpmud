...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6047", "north",
		"/players/mizan/opl/CELLS/C6287", "south",
		"/players/mizan/opl/CELLS/C6168", "east",
		"/players/mizan/opl/CELLS/C6166", "west",
	});
