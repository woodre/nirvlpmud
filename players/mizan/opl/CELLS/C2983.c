...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2863", "north",
		"/players/mizan/opl/CELLS/C3103", "south",
		"/players/mizan/opl/CELLS/C2982", "west",
	});
...
long()
{
	...
	write("\"I was making donuts and now I'm on a bus!\"\n");
