...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5590", "north",
		"/players/mizan/opl/CELLS/C5830", "south",
		"/players/mizan/opl/CELLS/C5711", "east",
		"/players/mizan/opl/CELLS/C5709", "west",
	});
