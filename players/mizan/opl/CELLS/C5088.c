...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4968", "north",
		"/players/mizan/opl/CELLS/C5208", "south",
		"/players/mizan/opl/CELLS/C5089", "east",
		"/players/mizan/opl/CELLS/C5087", "west",
	});
