...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4953", "north",
		"/players/mizan/opl/CELLS/C5193", "south",
		"/players/mizan/opl/CELLS/C5074", "east",
	});
...
long()
{
	...
	write("\"A nymph hits you and steals your virginity.\"\n");
