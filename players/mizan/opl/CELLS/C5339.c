...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5219", "north",
		"/players/mizan/opl/CELLS/C5459", "south",
		"/players/mizan/opl/CELLS/C5340", "east",
		"/players/mizan/opl/CELLS/C5338", "west",
	});
