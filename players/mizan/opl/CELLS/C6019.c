...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6020", "east",
		"/players/mizan/opl/CELLS/C6018", "west",
	});
...
long()
{
	...
	write("\"Being a BALD HERO is almost as FESTIVE as a TATTOOED KNOCKWURST.\"\n");
