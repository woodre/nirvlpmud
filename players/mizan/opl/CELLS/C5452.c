...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5332", "north",
		"/players/mizan/opl/CELLS/C5572", "south",
		"/players/mizan/opl/CELLS/C5453", "east",
		"/players/mizan/opl/CELLS/C5451", "west",
	});
