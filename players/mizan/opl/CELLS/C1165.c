...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1045", "north",
		"/players/mizan/opl/CELLS/C1285", "south",
		"/players/mizan/opl/CELLS/C1166", "east",
		"/players/mizan/opl/CELLS/C1164", "west",
	});
