...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5451", "north",
		"/players/mizan/opl/CELLS/C5691", "south",
		"/players/mizan/opl/CELLS/C5572", "east",
		"/players/mizan/opl/CELLS/C5570", "west",
	});
