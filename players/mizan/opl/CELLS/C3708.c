...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3588", "north",
		"/players/mizan/opl/CELLS/C3828", "south",
		"/players/mizan/opl/CELLS/C3709", "east",
		"/players/mizan/opl/CELLS/C3707", "west",
	});
