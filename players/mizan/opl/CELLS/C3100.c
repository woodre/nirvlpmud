...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2980", "north",
		"/players/mizan/opl/CELLS/C3220", "south",
		"/players/mizan/opl/CELLS/C3101", "east",
		"/players/mizan/opl/CELLS/C3099", "west",
	});
...
long()
{
	...
	write("\"Jesus Saves!(And Esposito scores on the rebound!)\"\n");
