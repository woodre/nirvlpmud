...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5921", "north",
		"/players/mizan/opl/CELLS/C6161", "south",
		"/players/mizan/opl/CELLS/C6042", "east",
		"/players/mizan/opl/CELLS/C6040", "west",
	});
