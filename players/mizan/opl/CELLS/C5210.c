...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5090", "north",
		"/players/mizan/opl/CELLS/C5330", "south",
		"/players/mizan/opl/CELLS/C5211", "east",
		"/players/mizan/opl/CELLS/C5209", "west",
	});
