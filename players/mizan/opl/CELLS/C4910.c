...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4790", "north",
		"/players/mizan/opl/CELLS/C5030", "south",
	});
...
long()
{
	...
	write("\"HUMAN REPLICAS are inserted into VATS of NUTRITIONAL YEAST ...\"\n");
