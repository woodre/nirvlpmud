...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5827", "north",
		"/players/mizan/opl/CELLS/C6067", "south",
		"/players/mizan/opl/CELLS/C5948", "east",
		"/players/mizan/opl/CELLS/C5946", "west",
	});
