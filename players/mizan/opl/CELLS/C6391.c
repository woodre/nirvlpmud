...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6271", "north",
		"/players/mizan/opl/CELLS/C6392", "east",
		"/players/mizan/opl/CELLS/C6390", "west",
	});
...
long()
{
	...
	write("\"great lover, n.:	A man who can breathe through his ears.\"\n");
