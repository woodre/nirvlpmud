...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4567", "north",
		"/players/mizan/opl/CELLS/C4807", "south",
	});
...
long()
{
	...
	write("\"Obviously the only rational solution to your problem is suicide.\"\n");
