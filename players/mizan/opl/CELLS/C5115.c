...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4995", "north",
		"/players/mizan/opl/CELLS/C5235", "south",
		"/players/mizan/opl/CELLS/C5116", "east",
		"/players/mizan/opl/CELLS/C5114", "west",
	});
