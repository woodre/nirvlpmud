...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2728", "north",
		"/players/mizan/opl/CELLS/C2968", "south",
		"/players/mizan/opl/CELLS/C2849", "east",
		"/players/mizan/opl/CELLS/C2847", "west",
	});
