...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4009", "north",
		"/players/mizan/opl/CELLS/C4249", "south",
		"/players/mizan/opl/CELLS/C4130", "east",
		"/players/mizan/opl/CELLS/C4128", "west",
	});
