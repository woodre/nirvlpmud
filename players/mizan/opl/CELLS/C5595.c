...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5475", "north",
		"/players/mizan/opl/CELLS/C5715", "south",
		"/players/mizan/opl/CELLS/C5596", "east",
		"/players/mizan/opl/CELLS/C5594", "west",
	});
