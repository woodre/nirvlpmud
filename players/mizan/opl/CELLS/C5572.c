...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5452", "north",
		"/players/mizan/opl/CELLS/C5692", "south",
		"/players/mizan/opl/CELLS/C5573", "east",
		"/players/mizan/opl/CELLS/C5571", "west",
	});
