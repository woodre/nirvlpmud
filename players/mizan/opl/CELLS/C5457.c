...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5337", "north",
		"/players/mizan/opl/CELLS/C5577", "south",
		"/players/mizan/opl/CELLS/C5458", "east",
		"/players/mizan/opl/CELLS/C5456", "west",
	});
