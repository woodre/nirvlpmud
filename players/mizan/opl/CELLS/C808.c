...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C688", "north",
		"/players/mizan/opl/CELLS/C928", "south",
		"/players/mizan/opl/CELLS/C809", "east",
		"/players/mizan/opl/CELLS/C807", "west",
	});
