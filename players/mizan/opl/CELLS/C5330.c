...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5210", "north",
		"/players/mizan/opl/CELLS/C5450", "south",
		"/players/mizan/opl/CELLS/C5331", "east",
		"/players/mizan/opl/CELLS/C5329", "west",
	});
