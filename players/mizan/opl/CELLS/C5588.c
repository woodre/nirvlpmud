...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5468", "north",
		"/players/mizan/opl/CELLS/C5708", "south",
		"/players/mizan/opl/CELLS/C5589", "east",
		"/players/mizan/opl/CELLS/C5587", "west",
	});
