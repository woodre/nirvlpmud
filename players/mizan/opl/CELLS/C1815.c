...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1695", "north",
		"/players/mizan/opl/CELLS/C1935", "south",
		"/players/mizan/opl/CELLS/C1816", "east",
		"/players/mizan/opl/CELLS/C1814", "west",
	});
...
long()
{
	...
	write("\"I was born in a Hostess Cupcake factory before the sexual revolution!\"\n");
