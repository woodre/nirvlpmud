...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6059", "north",
		"/players/mizan/opl/CELLS/C6299", "south",
		"/players/mizan/opl/CELLS/C6180", "east",
		"/players/mizan/opl/CELLS/C6178", "west",
	});
