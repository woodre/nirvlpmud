...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5255", "north",
		"/players/mizan/opl/CELLS/C5495", "south",
		"/players/mizan/opl/CELLS/C5376", "east",
		"/players/mizan/opl/CELLS/C5374", "west",
	});
