...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1767", "north",
		"/players/mizan/opl/CELLS/C2007", "south",
		"/players/mizan/opl/CELLS/C1888", "east",
		"/players/mizan/opl/CELLS/C1886", "west",
	});
