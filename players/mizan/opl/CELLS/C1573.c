...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1693", "south",
		"/players/mizan/opl/CELLS/C1574", "east",
		"/players/mizan/opl/CELLS/C1572", "west",
	});
...
long()
{
	...
	write("\"Come home America.		-- George McGovern, 1972\"\n");
