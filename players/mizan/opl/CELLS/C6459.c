...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6339", "north",
		"/players/mizan/opl/CELLS/C6579", "south",
		"/players/mizan/opl/CELLS/C6460", "east",
		"/players/mizan/opl/CELLS/C6458", "west",
	});
