...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4672", "north",
		"/players/mizan/opl/CELLS/C4912", "south",
		"/players/mizan/opl/CELLS/C4793", "east",
		"/players/mizan/opl/CELLS/C4791", "west",
	});
