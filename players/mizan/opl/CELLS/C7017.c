...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6897", "north",
		"/players/mizan/opl/CELLS/C7018", "east",
		"/players/mizan/opl/CELLS/C7016", "west",
	});
...
long()
{
	...
	write("\"rejection, n.:	When you're masturbating and your hand falls asleep.\"\n");
