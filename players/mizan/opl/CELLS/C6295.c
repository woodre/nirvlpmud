...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6175", "north",
		"/players/mizan/opl/CELLS/C6415", "south",
		"/players/mizan/opl/CELLS/C6296", "east",
		"/players/mizan/opl/CELLS/C6294", "west",
	});
