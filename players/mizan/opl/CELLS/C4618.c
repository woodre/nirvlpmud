...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4498", "north",
		"/players/mizan/opl/CELLS/C4738", "south",
		"/players/mizan/opl/CELLS/C4619", "east",
		"/players/mizan/opl/CELLS/C4617", "west",
	});
