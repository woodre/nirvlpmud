...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5918", "north",
		"/players/mizan/opl/CELLS/C6158", "south",
		"/players/mizan/opl/CELLS/C6039", "east",
		"/players/mizan/opl/CELLS/C6037", "west",
	});
