...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4514", "north",
		"/players/mizan/opl/CELLS/C4754", "south",
		"/players/mizan/opl/CELLS/C4635", "east",
		"/players/mizan/opl/CELLS/C4633", "west",
	});
