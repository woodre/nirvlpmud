...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1824", "north",
		"/players/mizan/opl/CELLS/C2064", "south",
		"/players/mizan/opl/CELLS/C1945", "east",
		"/players/mizan/opl/CELLS/C1943", "west",
	});
