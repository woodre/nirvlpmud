...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3946", "north",
		"/players/mizan/opl/CELLS/C4186", "south",
		"/players/mizan/opl/CELLS/C4067", "east",
		"/players/mizan/opl/CELLS/C4065", "west",
	});
