...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4391", "north",
		"/players/mizan/opl/CELLS/C4631", "south",
		"/players/mizan/opl/CELLS/C4512", "east",
		"/players/mizan/opl/CELLS/C4510", "west",
	});
