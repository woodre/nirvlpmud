...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2314", "north",
		"/players/mizan/opl/CELLS/C2554", "south",
		"/players/mizan/opl/CELLS/C2435", "east",
		"/players/mizan/opl/CELLS/C2433", "west",
	});
