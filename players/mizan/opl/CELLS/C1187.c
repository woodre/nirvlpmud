...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1067", "north",
		"/players/mizan/opl/CELLS/C1307", "south",
		"/players/mizan/opl/CELLS/C1188", "east",
		"/players/mizan/opl/CELLS/C1186", "west",
	});
