...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5082", "north",
		"/players/mizan/opl/CELLS/C5322", "south",
		"/players/mizan/opl/CELLS/C5203", "east",
		"/players/mizan/opl/CELLS/C5201", "west",
	});
