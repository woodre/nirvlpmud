...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6283", "north",
		"/players/mizan/opl/CELLS/C6523", "south",
		"/players/mizan/opl/CELLS/C6404", "east",
		"/players/mizan/opl/CELLS/C6402", "west",
	});
