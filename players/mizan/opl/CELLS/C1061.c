...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C941", "north",
		"/players/mizan/opl/CELLS/C1181", "south",
		"/players/mizan/opl/CELLS/C1062", "east",
		"/players/mizan/opl/CELLS/C1060", "west",
	});
