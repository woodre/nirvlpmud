...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4758", "north",
		"/players/mizan/opl/CELLS/C4998", "south",
		"/players/mizan/opl/CELLS/C4879", "east",
		"/players/mizan/opl/CELLS/C4877", "west",
	});
