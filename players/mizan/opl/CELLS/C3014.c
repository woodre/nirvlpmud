...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2894", "north",
		"/players/mizan/opl/CELLS/C3134", "south",
	});
...
long()
{
	...
	write("\"I'm dressing up in an ill-fitting IVY-LEAGUE SUIT!! Too late...\"\n");
