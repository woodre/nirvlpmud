...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4127", "north",
		"/players/mizan/opl/CELLS/C4367", "south",
		"/players/mizan/opl/CELLS/C4248", "east",
		"/players/mizan/opl/CELLS/C4246", "west",
	});
