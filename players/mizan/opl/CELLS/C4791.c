...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4671", "north",
		"/players/mizan/opl/CELLS/C4792", "east",
		"/players/mizan/opl/CELLS/C4790", "west",
	});
...
long()
{
	...
	write("\"Jesus Christ: Imaginary Playmate to Millions of Adults!\"\n");
