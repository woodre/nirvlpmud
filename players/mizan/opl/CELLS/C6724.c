...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6604", "north",
		"/players/mizan/opl/CELLS/C6844", "south",
		"/players/mizan/opl/CELLS/C6725", "east",
	});
...
long()
{
	...
	write("\"Q:	What's the difference between a hold-up and a stick-up?A:	Age.\"\n");
