...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C258", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C138");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I138");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I138");
...
long()
{
	...
	write("\"Yow! Now we can become alcoholics!\"\n");
