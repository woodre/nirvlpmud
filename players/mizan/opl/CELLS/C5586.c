...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5466", "north",
		"/players/mizan/opl/CELLS/C5706", "south",
		"/players/mizan/opl/CELLS/C5587", "east",
		"/players/mizan/opl/CELLS/C5585", "west",
	});
