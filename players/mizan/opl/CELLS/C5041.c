...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4921", "north",
		"/players/mizan/opl/CELLS/C5161", "south",
		"/players/mizan/opl/CELLS/C5042", "east",
	});
...
long()
{
	...
	write("\"Pregnancy begins with a single sell.\"\n");
