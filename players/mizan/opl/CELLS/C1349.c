...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1229", "north",
		"/players/mizan/opl/CELLS/C1469", "south",
		"/players/mizan/opl/CELLS/C1350", "east",
		"/players/mizan/opl/CELLS/C1348", "west",
	});
