...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4861", "north",
		"/players/mizan/opl/CELLS/C5101", "south",
		"/players/mizan/opl/CELLS/C4982", "east",
		"/players/mizan/opl/CELLS/C4980", "west",
	});
