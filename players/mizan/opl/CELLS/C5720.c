...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5600", "north",
		"/players/mizan/opl/CELLS/C5840", "south",
		"/players/mizan/opl/CELLS/C5721", "east",
		"/players/mizan/opl/CELLS/C5719", "west",
	});
