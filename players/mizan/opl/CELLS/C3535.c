...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3536", "east",
		"/players/mizan/opl/CELLS/C3534", "west",
	});
...
long()
{
	...
	write("\"ARCHDUKE FERDINAND FOUND ALIVE -- FIRST WORLD WAR A MISTAKE\"\n");
