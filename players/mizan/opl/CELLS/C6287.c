...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6167", "north",
		"/players/mizan/opl/CELLS/C6407", "south",
		"/players/mizan/opl/CELLS/C6288", "east",
		"/players/mizan/opl/CELLS/C6286", "west",
	});
