...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C301", "north",
		"/players/mizan/opl/CELLS/C541", "south",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/medium/guard_turkey.c");
...
long()
{
	...
	write("\"What a f iend we have in Jesus!\"\n");
