...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1126", "north",
		"/players/mizan/opl/CELLS/C1247", "east",
		"/players/mizan/opl/CELLS/C1245", "west",
	});
...
long()
{
	...
	write("\"They ought to make butt-flavored cat food.		-- Gallagher\"\n");
