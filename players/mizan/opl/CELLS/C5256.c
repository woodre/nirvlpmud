...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5136", "north",
		"/players/mizan/opl/CELLS/C5376", "south",
		"/players/mizan/opl/CELLS/C5257", "east",
		"/players/mizan/opl/CELLS/C5255", "west",
	});
