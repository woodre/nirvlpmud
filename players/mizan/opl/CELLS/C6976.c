...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6975", "west",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6976");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6976");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6976");
...
long()
{
	...
	write("\"There is always more hell that needs raising.		-- Lauren Leveut\"\n");
