...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4443", "north",
		"/players/mizan/opl/CELLS/C4564", "east",
		"/players/mizan/opl/CELLS/C4562", "west",
	});
...
long()
{
	...
	write("\"Q:	What's red and covered with little dents?A:	Snow White's cherry.\"\n");
