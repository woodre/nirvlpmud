...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4332", "north",
		"/players/mizan/opl/CELLS/C4572", "south",
		"/players/mizan/opl/CELLS/C4453", "east",
		"/players/mizan/opl/CELLS/C4451", "west",
	});
