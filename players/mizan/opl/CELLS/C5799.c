...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5679", "north",
		"/players/mizan/opl/CELLS/C5919", "south",
		"/players/mizan/opl/CELLS/C5800", "east",
		"/players/mizan/opl/CELLS/C5798", "west",
	});
