...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6065", "north",
		"/players/mizan/opl/CELLS/C6305", "south",
		"/players/mizan/opl/CELLS/C6186", "east",
		"/players/mizan/opl/CELLS/C6184", "west",
	});
