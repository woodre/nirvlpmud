...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1261", "north",
		"/players/mizan/opl/CELLS/C1501", "south",
		"/players/mizan/opl/CELLS/C1382", "east",
		"/players/mizan/opl/CELLS/C1380", "west",
	});
