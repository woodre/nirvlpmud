...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1358", "north",
		"/players/mizan/opl/CELLS/C1598", "south",
		"/players/mizan/opl/CELLS/C1479", "east",
		"/players/mizan/opl/CELLS/C1477", "west",
	});
