...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1577", "north",
		"/players/mizan/opl/CELLS/C1817", "south",
		"/players/mizan/opl/CELLS/C1698", "east",
		"/players/mizan/opl/CELLS/C1696", "west",
	});
...
long()
{
	...
	write("\"A bisexual is a man who likes girls as well as the next fellow.\"\n");
