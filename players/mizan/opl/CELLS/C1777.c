...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1657", "north",
		"/players/mizan/opl/CELLS/C1897", "south",
		"/players/mizan/opl/CELLS/C1776", "west",
	});
...
long()
{
	...
	write("\"Ya know, Quaker Oats make you feel good twice!\"\n");
