...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C342", "north",
		"/players/mizan/opl/CELLS/C582", "south",
		"/players/mizan/opl/CELLS/C463", "east",
		"/players/mizan/opl/CELLS/C461", "west",
	});
