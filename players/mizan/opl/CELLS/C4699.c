...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4579", "north",
		"/players/mizan/opl/CELLS/C4819", "south",
		"/players/mizan/opl/CELLS/C4700", "east",
		"/players/mizan/opl/CELLS/C4698", "west",
	});
