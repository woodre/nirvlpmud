...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4844", "north",
		"/players/mizan/opl/CELLS/C5084", "south",
		"/players/mizan/opl/CELLS/C4965", "east",
		"/players/mizan/opl/CELLS/C4963", "west",
	});
