...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2390", "north",
		"/players/mizan/opl/CELLS/C2630", "south",
		"/players/mizan/opl/CELLS/C2511", "east",
		"/players/mizan/opl/CELLS/C2509", "west",
	});
