...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5831", "north",
		"/players/mizan/opl/CELLS/C6071", "south",
		"/players/mizan/opl/CELLS/C5952", "east",
		"/players/mizan/opl/CELLS/C5950", "west",
	});
