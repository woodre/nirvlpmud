...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2604", "north",
		"/players/mizan/opl/CELLS/C2844", "south",
		"/players/mizan/opl/CELLS/C2725", "east",
		"/players/mizan/opl/CELLS/C2723", "west",
	});
