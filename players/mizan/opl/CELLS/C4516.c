...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4396", "north",
		"/players/mizan/opl/CELLS/C4636", "south",
		"/players/mizan/opl/CELLS/C4517", "east",
		"/players/mizan/opl/CELLS/C4515", "west",
	});
