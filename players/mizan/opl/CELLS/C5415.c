...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5416", "east",
		"/players/mizan/opl/CELLS/C5414", "west",
	});
...
long()
{
	...
	write("\"I'm a bisexual; I get it maybe twice a year.		-- Rodney Dangerfield\"\n");
