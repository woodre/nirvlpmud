...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C886", "north",
		"/players/mizan/opl/CELLS/C1126", "south",
		"/players/mizan/opl/CELLS/C1007", "east",
	});
...
long()
{
	...
	write("\"'Without doubt you are not sane.'   [Tage Danielsson]\"\n");
