...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5953", "north",
		"/players/mizan/opl/CELLS/C6193", "south",
		"/players/mizan/opl/CELLS/C6074", "east",
		"/players/mizan/opl/CELLS/C6072", "west",
	});
