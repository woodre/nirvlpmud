...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3288", "north",
		"/players/mizan/opl/CELLS/C3528", "south",
		"/players/mizan/opl/CELLS/C3409", "east",
		"/players/mizan/opl/CELLS/C3407", "west",
	});
