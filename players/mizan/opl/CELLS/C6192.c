...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6072", "north",
		"/players/mizan/opl/CELLS/C6312", "south",
		"/players/mizan/opl/CELLS/C6193", "east",
		"/players/mizan/opl/CELLS/C6191", "west",
	});
