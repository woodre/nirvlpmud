...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3403", "north",
		"/players/mizan/opl/CELLS/C3643", "south",
		"/players/mizan/opl/CELLS/C3524", "east",
		"/players/mizan/opl/CELLS/C3522", "west",
	});
