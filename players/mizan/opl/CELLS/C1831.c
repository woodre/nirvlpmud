...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1711", "north",
		"/players/mizan/opl/CELLS/C1951", "south",
		"/players/mizan/opl/CELLS/C1832", "east",
		"/players/mizan/opl/CELLS/C1830", "west",
	});
