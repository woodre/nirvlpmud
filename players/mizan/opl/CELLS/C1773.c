...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1774", "east",
		"/players/mizan/opl/CELLS/C1772", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/hard/ogress.c");
...
long()
{
	...
	write("\"Never settle with words what you can accomplish with a flame thrower.\"\n");
