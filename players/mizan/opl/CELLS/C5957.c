...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5837", "north",
		"/players/mizan/opl/CELLS/C6077", "south",
		"/players/mizan/opl/CELLS/C5958", "east",
		"/players/mizan/opl/CELLS/C5956", "west",
	});
