...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5227", "north",
		"/players/mizan/opl/CELLS/C5467", "south",
		"/players/mizan/opl/CELLS/C5348", "east",
		"/players/mizan/opl/CELLS/C5346", "west",
	});
