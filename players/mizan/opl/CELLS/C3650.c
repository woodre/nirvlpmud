...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3530", "north",
		"/players/mizan/opl/CELLS/C3770", "south",
		"/players/mizan/opl/CELLS/C3651", "east",
		"/players/mizan/opl/CELLS/C3649", "west",
	});
