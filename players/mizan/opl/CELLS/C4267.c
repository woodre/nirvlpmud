...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4147", "north",
		"/players/mizan/opl/CELLS/C4387", "south",
		"/players/mizan/opl/CELLS/C4268", "east",
		"/players/mizan/opl/CELLS/C4266", "west",
	});
