...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6303", "north",
		"/players/mizan/opl/CELLS/C6543", "south",
		"/players/mizan/opl/CELLS/C6424", "east",
		"/players/mizan/opl/CELLS/C6422", "west",
	});
