...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5563", "north",
		"/players/mizan/opl/CELLS/C5803", "south",
		"/players/mizan/opl/CELLS/C5684", "east",
		"/players/mizan/opl/CELLS/C5682", "west",
	});
