...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2973", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C2972");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I2972");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I2972");
...
long()
{
	...
	write("\"A proctologist is a doctor who puts in a hard day at the orifice.\"\n");
