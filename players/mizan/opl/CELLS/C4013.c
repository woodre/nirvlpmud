...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3893", "north",
		"/players/mizan/opl/CELLS/C4133", "south",
		"/players/mizan/opl/CELLS/C4014", "east",
		"/players/mizan/opl/CELLS/C4012", "west",
	});
