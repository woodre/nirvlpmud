...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2552", "north",
		"/players/mizan/opl/CELLS/C2792", "south",
		"/players/mizan/opl/CELLS/C2673", "east",
		"/players/mizan/opl/CELLS/C2671", "west",
	});
