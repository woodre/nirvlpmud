...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3646", "north",
		"/players/mizan/opl/CELLS/C3886", "south",
		"/players/mizan/opl/CELLS/C3767", "east",
		"/players/mizan/opl/CELLS/C3765", "west",
	});
