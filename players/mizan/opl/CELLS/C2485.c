...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2365", "north",
		"/players/mizan/opl/CELLS/C2605", "south",
		"/players/mizan/opl/CELLS/C2486", "east",
		"/players/mizan/opl/CELLS/C2484", "west",
	});
