...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C754", "north",
		"/players/mizan/opl/CELLS/C994", "south",
		"/players/mizan/opl/CELLS/C875", "east",
		"/players/mizan/opl/CELLS/C873", "west",
	});
