...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1935", "north",
		"/players/mizan/opl/CELLS/C2175", "south",
		"/players/mizan/opl/CELLS/C2056", "east",
		"/players/mizan/opl/CELLS/C2054", "west",
	});
...
long()
{
	...
	write("\"I feel better about world problems now!\"\n");
