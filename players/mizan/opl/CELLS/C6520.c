...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6400", "north",
		"/players/mizan/opl/CELLS/C6640", "south",
		"/players/mizan/opl/CELLS/C6521", "east",
		"/players/mizan/opl/CELLS/C6519", "west",
	});
