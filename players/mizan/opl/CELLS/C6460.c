...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6340", "north",
		"/players/mizan/opl/CELLS/C6580", "south",
		"/players/mizan/opl/CELLS/C6461", "east",
		"/players/mizan/opl/CELLS/C6459", "west",
	});
