...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3051", "north",
		"/players/mizan/opl/CELLS/C3291", "south",
		"/players/mizan/opl/CELLS/C3172", "east",
		"/players/mizan/opl/CELLS/C3170", "west",
	});
