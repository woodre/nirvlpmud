...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3372", "north",
		"/players/mizan/opl/CELLS/C3612", "south",
		"/players/mizan/opl/CELLS/C3493", "east",
		"/players/mizan/opl/CELLS/C3491", "west",
	});
