...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4146", "north",
		"/players/mizan/opl/CELLS/C4386", "south",
		"/players/mizan/opl/CELLS/C4267", "east",
		"/players/mizan/opl/CELLS/C4265", "west",
	});
