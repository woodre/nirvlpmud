...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5937", "north",
		"/players/mizan/opl/CELLS/C6177", "south",
		"/players/mizan/opl/CELLS/C6058", "east",
		"/players/mizan/opl/CELLS/C6056", "west",
	});
