...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4435", "north",
		"/players/mizan/opl/CELLS/C4675", "south",
		"/players/mizan/opl/CELLS/C4556", "east",
		"/players/mizan/opl/CELLS/C4554", "west",
	});
