...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5328", "north",
		"/players/mizan/opl/CELLS/C5568", "south",
		"/players/mizan/opl/CELLS/C5449", "east",
		"/players/mizan/opl/CELLS/C5447", "west",
	});
