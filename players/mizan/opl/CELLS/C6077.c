...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5957", "north",
		"/players/mizan/opl/CELLS/C6197", "south",
		"/players/mizan/opl/CELLS/C6078", "east",
		"/players/mizan/opl/CELLS/C6076", "west",
	});
