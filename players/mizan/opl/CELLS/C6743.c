...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6744", "east",
		"/players/mizan/opl/CELLS/C6742", "west",
	});
...
long()
{
	...
	write("\"God made the world in six days, and was arrested on the seventh.\"\n");
