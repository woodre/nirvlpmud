...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2882", "north",
		"/players/mizan/opl/CELLS/C3122", "south",
	});
...
long()
{
	...
	write("\"The PILLSBURY DOUGHBOY is CRYING for an END to BURT REYNOLDS movies!!\"\n");
