...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3289", "north",
		"/players/mizan/opl/CELLS/C3529", "south",
		"/players/mizan/opl/CELLS/C3410", "east",
		"/players/mizan/opl/CELLS/C3408", "west",
	});
