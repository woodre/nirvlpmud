...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3429", "north",
		"/players/mizan/opl/CELLS/C3669", "south",
		"/players/mizan/opl/CELLS/C3550", "east",
		"/players/mizan/opl/CELLS/C3548", "west",
	});
...
long()
{
	...
	write("\"hypocrite, n.:	A man who says he likes cats, but won't eat pussy.\"\n");
