...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4521", "north",
		"/players/mizan/opl/CELLS/C4761", "south",
		"/players/mizan/opl/CELLS/C4642", "east",
		"/players/mizan/opl/CELLS/C4640", "west",
	});
