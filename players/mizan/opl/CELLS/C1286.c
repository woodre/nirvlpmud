...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1166", "north",
		"/players/mizan/opl/CELLS/C1406", "south",
		"/players/mizan/opl/CELLS/C1287", "east",
		"/players/mizan/opl/CELLS/C1285", "west",
	});
