...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C608", "north",
		"/players/mizan/opl/CELLS/C848", "south",
		"/players/mizan/opl/CELLS/C729", "east",
		"/players/mizan/opl/CELLS/C727", "west",
	});
