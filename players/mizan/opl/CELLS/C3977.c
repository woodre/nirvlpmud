...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3857", "north",
		"/players/mizan/opl/CELLS/C4097", "south",
		"/players/mizan/opl/CELLS/C3978", "east",
		"/players/mizan/opl/CELLS/C3976", "west",
	});
