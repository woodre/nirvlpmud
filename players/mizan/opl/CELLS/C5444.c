...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5324", "north",
		"/players/mizan/opl/CELLS/C5564", "south",
		"/players/mizan/opl/CELLS/C5445", "east",
		"/players/mizan/opl/CELLS/C5443", "west",
	});
