...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5088", "north",
		"/players/mizan/opl/CELLS/C5328", "south",
		"/players/mizan/opl/CELLS/C5209", "east",
		"/players/mizan/opl/CELLS/C5207", "west",
	});
