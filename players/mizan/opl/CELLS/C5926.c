...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5806", "north",
		"/players/mizan/opl/CELLS/C6046", "south",
		"/players/mizan/opl/CELLS/C5927", "east",
		"/players/mizan/opl/CELLS/C5925", "west",
	});
