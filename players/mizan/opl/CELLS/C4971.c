...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4851", "north",
		"/players/mizan/opl/CELLS/C5091", "south",
		"/players/mizan/opl/CELLS/C4972", "east",
		"/players/mizan/opl/CELLS/C4970", "west",
	});
