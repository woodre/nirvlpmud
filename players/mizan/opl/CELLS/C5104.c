...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4984", "north",
		"/players/mizan/opl/CELLS/C5224", "south",
		"/players/mizan/opl/CELLS/C5105", "east",
		"/players/mizan/opl/CELLS/C5103", "west",
	});
