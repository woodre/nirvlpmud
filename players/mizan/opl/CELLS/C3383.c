...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3263", "north",
		"/players/mizan/opl/CELLS/C3503", "south",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/medium/hydra-blocker.c");
...
long()
{
	...
	write("\"What I need is a MATURE RELATIONSHIP with a FLOPPY DISK ...\"\n");
