...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6054", "north",
		"/players/mizan/opl/CELLS/C6294", "south",
		"/players/mizan/opl/CELLS/C6175", "east",
		"/players/mizan/opl/CELLS/C6173", "west",
	});
