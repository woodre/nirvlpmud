...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5680", "north",
		"/players/mizan/opl/CELLS/C5920", "south",
		"/players/mizan/opl/CELLS/C5801", "east",
		"/players/mizan/opl/CELLS/C5799", "west",
	});
