...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4554", "north",
		"/players/mizan/opl/CELLS/C4794", "south",
		"/players/mizan/opl/CELLS/C4675", "east",
		"/players/mizan/opl/CELLS/C4673", "west",
	});
