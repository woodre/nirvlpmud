...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6041", "north",
		"/players/mizan/opl/CELLS/C6281", "south",
		"/players/mizan/opl/CELLS/C6162", "east",
		"/players/mizan/opl/CELLS/C6160", "west",
	});
