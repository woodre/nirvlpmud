...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2368", "north",
		"/players/mizan/opl/CELLS/C2608", "south",
		"/players/mizan/opl/CELLS/C2489", "east",
		"/players/mizan/opl/CELLS/C2487", "west",
	});
