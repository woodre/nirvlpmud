...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5752", "north",
		"/players/mizan/opl/CELLS/C5992", "south",
		"/players/mizan/opl/CELLS/C5873", "east",
		"/players/mizan/opl/CELLS/C5871", "west",
	});
