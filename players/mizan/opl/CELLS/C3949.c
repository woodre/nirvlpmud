...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3829", "north",
		"/players/mizan/opl/CELLS/C4069", "south",
		"/players/mizan/opl/CELLS/C3950", "east",
		"/players/mizan/opl/CELLS/C3948", "west",
	});
...
long()
{
	...
	write("\"I had a lease on an OEDIPUS COMPLEX back in '81 ...\"\n");
