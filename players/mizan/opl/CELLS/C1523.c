...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1403", "north",
		"/players/mizan/opl/CELLS/C1643", "south",
		"/players/mizan/opl/CELLS/C1524", "east",
		"/players/mizan/opl/CELLS/C1522", "west",
	});
