...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4625", "north",
		"/players/mizan/opl/CELLS/C4865", "south",
		"/players/mizan/opl/CELLS/C4746", "east",
		"/players/mizan/opl/CELLS/C4744", "west",
	});
