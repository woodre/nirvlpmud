...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6305", "north",
		"/players/mizan/opl/CELLS/C6545", "south",
		"/players/mizan/opl/CELLS/C6426", "east",
		"/players/mizan/opl/CELLS/C6424", "west",
	});
