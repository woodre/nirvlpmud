...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4374", "north",
		"/players/mizan/opl/CELLS/C4614", "south",
		"/players/mizan/opl/CELLS/C4495", "east",
		"/players/mizan/opl/CELLS/C4493", "west",
	});
