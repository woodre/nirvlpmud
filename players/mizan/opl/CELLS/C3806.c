...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3686", "north",
		"/players/mizan/opl/CELLS/C3926", "south",
		"/players/mizan/opl/CELLS/C3807", "east",
		"/players/mizan/opl/CELLS/C3805", "west",
	});
...
long()
{
	...
	write("\"There isn't room enough in this dress for both of us!\"\n");
