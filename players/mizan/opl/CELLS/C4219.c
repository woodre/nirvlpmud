...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4099", "north",
		"/players/mizan/opl/CELLS/C4339", "south",
		"/players/mizan/opl/CELLS/C4220", "east",
		"/players/mizan/opl/CELLS/C4218", "west",
	});
