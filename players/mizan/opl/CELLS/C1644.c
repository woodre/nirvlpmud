...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1524", "north",
		"/players/mizan/opl/CELLS/C1764", "south",
		"/players/mizan/opl/CELLS/C1645", "east",
		"/players/mizan/opl/CELLS/C1643", "west",
	});
