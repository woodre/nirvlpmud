...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4619", "north",
		"/players/mizan/opl/CELLS/C4859", "south",
		"/players/mizan/opl/CELLS/C4740", "east",
		"/players/mizan/opl/CELLS/C4738", "west",
	});
