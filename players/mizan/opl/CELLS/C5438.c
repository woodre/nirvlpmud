...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5318", "north",
		"/players/mizan/opl/CELLS/C5558", "south",
		"/players/mizan/opl/CELLS/C5439", "east",
		"/players/mizan/opl/CELLS/C5437", "west",
	});
