...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4718", "north",
		"/players/mizan/opl/CELLS/C4958", "south",
		"/players/mizan/opl/CELLS/C4839", "east",
		"/players/mizan/opl/CELLS/C4837", "west",
	});
