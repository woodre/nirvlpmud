...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5322", "north",
		"/players/mizan/opl/CELLS/C5562", "south",
		"/players/mizan/opl/CELLS/C5443", "east",
		"/players/mizan/opl/CELLS/C5441", "west",
	});
