...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4261", "north",
		"/players/mizan/opl/CELLS/C4501", "south",
		"/players/mizan/opl/CELLS/C4382", "east",
		"/players/mizan/opl/CELLS/C4380", "west",
	});
