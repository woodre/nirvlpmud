...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6477", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6476");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6476");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6476");
...
long()
{
	...
	write("\"I'm gliding over a NUCLEAR WASTE DUMP near ATLANTA, Georgia!!\"\n");
