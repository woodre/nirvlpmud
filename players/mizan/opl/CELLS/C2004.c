...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1884", "north",
		"/players/mizan/opl/CELLS/C2124", "south",
		"/players/mizan/opl/CELLS/C2005", "east",
		"/players/mizan/opl/CELLS/C2003", "west",
	});
