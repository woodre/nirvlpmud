...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6061", "north",
		"/players/mizan/opl/CELLS/C6301", "south",
		"/players/mizan/opl/CELLS/C6182", "east",
		"/players/mizan/opl/CELLS/C6180", "west",
	});
