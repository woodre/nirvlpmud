...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4245", "north",
		"/players/mizan/opl/CELLS/C4485", "south",
		"/players/mizan/opl/CELLS/C4366", "east",
		"/players/mizan/opl/CELLS/C4364", "west",
	});
