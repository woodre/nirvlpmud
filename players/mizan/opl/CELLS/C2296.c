...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2176", "north",
		"/players/mizan/opl/CELLS/C2416", "south",
		"/players/mizan/opl/CELLS/C2295", "west",
	});
...
long()
{
	...
	write("\"Adolescence, n.:	The stage between puberty and adultery.\"\n");
