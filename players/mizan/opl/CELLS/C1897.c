...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1777", "north",
		"/players/mizan/opl/CELLS/C2017", "south",
		"/players/mizan/opl/CELLS/C1898", "east",
	});
...
long()
{
	...
	write("\"I don't care who you are, Fatso. Get those reindeer off my roof.\"\n");
