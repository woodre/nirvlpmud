...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5557", "north",
		"/players/mizan/opl/CELLS/C5797", "south",
		"/players/mizan/opl/CELLS/C5678", "east",
		"/players/mizan/opl/CELLS/C5676", "west",
	});
