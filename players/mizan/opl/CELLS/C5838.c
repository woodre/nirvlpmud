...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5718", "north",
		"/players/mizan/opl/CELLS/C5958", "south",
		"/players/mizan/opl/CELLS/C5839", "east",
		"/players/mizan/opl/CELLS/C5837", "west",
	});
