...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5671", "south",
		"/players/mizan/opl/CELLS/C5552", "east",
	});
...
long()
{
	...
	write("\"FROZEN ENTREES may be flung by members of opposing SWANSON SECTS ...\"\n");
