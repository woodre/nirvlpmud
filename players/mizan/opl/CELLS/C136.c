...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C256", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C136");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I136");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I136");
...
long()
{
	...
	write("\"For a gay time, call 555-9483. Ask for Brucie.\"\n");
