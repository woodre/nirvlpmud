...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4270", "north",
		"/players/mizan/opl/CELLS/C4510", "south",
		"/players/mizan/opl/CELLS/C4391", "east",
		"/players/mizan/opl/CELLS/C4389", "west",
	});
