...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2752", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C2872");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I2872");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I2872");
...
long()
{
	...
	write("\"'All flesh is grass'		-- Isaiah		Smoke a friend today!\"\n");
