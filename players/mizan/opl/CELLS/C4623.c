...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4503", "north",
		"/players/mizan/opl/CELLS/C4743", "south",
		"/players/mizan/opl/CELLS/C4624", "east",
		"/players/mizan/opl/CELLS/C4622", "west",
	});
