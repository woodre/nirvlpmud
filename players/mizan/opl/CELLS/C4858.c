...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4738", "north",
		"/players/mizan/opl/CELLS/C4978", "south",
		"/players/mizan/opl/CELLS/C4859", "east",
		"/players/mizan/opl/CELLS/C4857", "west",
	});
