...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3250", "north",
		"/players/mizan/opl/CELLS/C3490", "south",
		"/players/mizan/opl/CELLS/C3371", "east",
		"/players/mizan/opl/CELLS/C3369", "west",
	});
