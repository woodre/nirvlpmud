...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4667", "north",
		"/players/mizan/opl/CELLS/C4907", "south",
		"/players/mizan/opl/CELLS/C4788", "east",
		"/players/mizan/opl/CELLS/C4786", "west",
	});
...
long()
{
	...
	write("\"Are the STEWED PRUNES still in the HAIR DRYER?\"\n");
