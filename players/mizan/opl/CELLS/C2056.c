...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1936", "north",
		"/players/mizan/opl/CELLS/C2176", "south",
		"/players/mizan/opl/CELLS/C2055", "west",
	});
...
long()
{
	...
	write("\"Masturbation! The amazing availability of it!		-- James Joyce\"\n");
