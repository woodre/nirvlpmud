...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3970", "north",
		"/players/mizan/opl/CELLS/C4210", "south",
		"/players/mizan/opl/CELLS/C4091", "east",
		"/players/mizan/opl/CELLS/C4089", "west",
	});
