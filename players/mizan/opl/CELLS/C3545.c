...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3425", "north",
		"/players/mizan/opl/CELLS/C3665", "south",
		"/players/mizan/opl/CELLS/C3546", "east",
	});
...
long()
{
	...
	write("\"VICARIOUSLY experience some reason to LIVE!!\"\n");
