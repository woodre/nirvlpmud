...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3854", "north",
		"/players/mizan/opl/CELLS/C4094", "south",
		"/players/mizan/opl/CELLS/C3975", "east",
		"/players/mizan/opl/CELLS/C3973", "west",
	});
