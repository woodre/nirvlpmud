...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4030", "north",
		"/players/mizan/opl/CELLS/C4270", "south",
		"/players/mizan/opl/CELLS/C4151", "east",
		"/players/mizan/opl/CELLS/C4149", "west",
	});
