...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4362", "north",
		"/players/mizan/opl/CELLS/C4602", "south",
		"/players/mizan/opl/CELLS/C4483", "east",
		"/players/mizan/opl/CELLS/C4481", "west",
	});
