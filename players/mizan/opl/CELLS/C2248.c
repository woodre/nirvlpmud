...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2128", "north",
		"/players/mizan/opl/CELLS/C2368", "south",
		"/players/mizan/opl/CELLS/C2249", "east",
		"/players/mizan/opl/CELLS/C2247", "west",
	});
