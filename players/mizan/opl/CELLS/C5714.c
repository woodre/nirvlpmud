...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5594", "north",
		"/players/mizan/opl/CELLS/C5834", "south",
		"/players/mizan/opl/CELLS/C5715", "east",
		"/players/mizan/opl/CELLS/C5713", "west",
	});
