...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6116", "north",
		"/players/mizan/opl/CELLS/C6237", "east",
		"/players/mizan/opl/CELLS/C6235", "west",
	});
...
long()
{
	...
	write("\"I was toilet-trained at gunpoint.		-- Billy Braver\"\n");
