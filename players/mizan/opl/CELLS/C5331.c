...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5211", "north",
		"/players/mizan/opl/CELLS/C5451", "south",
		"/players/mizan/opl/CELLS/C5332", "east",
		"/players/mizan/opl/CELLS/C5330", "west",
	});
