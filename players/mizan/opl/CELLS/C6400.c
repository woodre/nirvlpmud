...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6280", "north",
		"/players/mizan/opl/CELLS/C6520", "south",
		"/players/mizan/opl/CELLS/C6401", "east",
		"/players/mizan/opl/CELLS/C6399", "west",
	});
