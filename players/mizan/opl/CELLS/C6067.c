...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5947", "north",
		"/players/mizan/opl/CELLS/C6187", "south",
		"/players/mizan/opl/CELLS/C6068", "east",
		"/players/mizan/opl/CELLS/C6066", "west",
	});
