...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5118", "north",
		"/players/mizan/opl/CELLS/C5358", "south",
		"/players/mizan/opl/CELLS/C5239", "east",
		"/players/mizan/opl/CELLS/C5237", "west",
	});
