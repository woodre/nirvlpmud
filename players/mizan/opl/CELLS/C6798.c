...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6678", "north",
		"/players/mizan/opl/CELLS/C6918", "south",
	});
...
long()
{
	...
	write("\"Here I am in 53 B.C. and all I want is a dill pickle!!\"\n");
