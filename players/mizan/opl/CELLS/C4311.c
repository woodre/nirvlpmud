...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4191", "north",
		"/players/mizan/opl/CELLS/C4431", "south",
		"/players/mizan/opl/CELLS/C4312", "east",
		"/players/mizan/opl/CELLS/C4310", "west",
	});
