...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4212", "north",
		"/players/mizan/opl/CELLS/C4452", "south",
		"/players/mizan/opl/CELLS/C4333", "east",
		"/players/mizan/opl/CELLS/C4331", "west",
	});
