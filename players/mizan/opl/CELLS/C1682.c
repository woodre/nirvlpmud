...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1562", "north",
		"/players/mizan/opl/CELLS/C1802", "south",
		"/players/mizan/opl/CELLS/C1681", "west",
	});
...
long()
{
	...
	write("\"A vasectomy means never having to say you're sorry.\"\n");
