...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4033", "north",
		"/players/mizan/opl/CELLS/C4273", "south",
		"/players/mizan/opl/CELLS/C4154", "east",
		"/players/mizan/opl/CELLS/C4152", "west",
	});
