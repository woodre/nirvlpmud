...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C409", "north",
		"/players/mizan/opl/CELLS/C649", "south",
		"/players/mizan/opl/CELLS/C530", "east",
		"/players/mizan/opl/CELLS/C528", "west",
	});
...
long()
{
	...
	write("\"The yankees, son, are up north. The damnyankees are down here.\"\n");
