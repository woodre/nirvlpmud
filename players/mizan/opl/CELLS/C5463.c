...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5343", "north",
		"/players/mizan/opl/CELLS/C5583", "south",
		"/players/mizan/opl/CELLS/C5464", "east",
		"/players/mizan/opl/CELLS/C5462", "west",
	});
