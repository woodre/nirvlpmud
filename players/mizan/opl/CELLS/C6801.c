...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6681", "north",
		"/players/mizan/opl/CELLS/C6921", "south",
	});
...
long()
{
	...
	write("\"Mistress, n.:	Something between a mister and a mattress.\"\n");
