...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6338", "north",
		"/players/mizan/opl/CELLS/C6578", "south",
		"/players/mizan/opl/CELLS/C6459", "east",
		"/players/mizan/opl/CELLS/C6457", "west",
	});
