...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4973", "north",
		"/players/mizan/opl/CELLS/C5213", "south",
		"/players/mizan/opl/CELLS/C5094", "east",
		"/players/mizan/opl/CELLS/C5092", "west",
	});
