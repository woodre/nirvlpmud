...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5436", "north",
		"/players/mizan/opl/CELLS/C5676", "south",
		"/players/mizan/opl/CELLS/C5557", "east",
		"/players/mizan/opl/CELLS/C5555", "west",
	});
