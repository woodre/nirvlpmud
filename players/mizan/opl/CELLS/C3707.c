...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3587", "north",
		"/players/mizan/opl/CELLS/C3827", "south",
		"/players/mizan/opl/CELLS/C3708", "east",
		"/players/mizan/opl/CELLS/C3706", "west",
	});
