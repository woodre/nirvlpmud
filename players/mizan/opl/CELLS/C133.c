...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C253", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C133");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I133");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I133");
...
long()
{
	...
	write("\"Hello, GORRY-O!! I'm a GENIUS from HARVARD!!\"\n");
