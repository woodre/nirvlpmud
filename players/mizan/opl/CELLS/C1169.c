...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1049", "north",
		"/players/mizan/opl/CELLS/C1289", "south",
		"/players/mizan/opl/CELLS/C1170", "east",
		"/players/mizan/opl/CELLS/C1168", "west",
	});
