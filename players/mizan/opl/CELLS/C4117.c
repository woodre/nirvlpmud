...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3997", "north",
		"/players/mizan/opl/CELLS/C4237", "south",
		"/players/mizan/opl/CELLS/C4118", "east",
		"/players/mizan/opl/CELLS/C4116", "west",
	});
