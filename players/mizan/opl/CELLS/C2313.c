...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2193", "north",
		"/players/mizan/opl/CELLS/C2433", "south",
		"/players/mizan/opl/CELLS/C2314", "east",
		"/players/mizan/opl/CELLS/C2312", "west",
	});
