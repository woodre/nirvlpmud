...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5746", "north",
		"/players/mizan/opl/CELLS/C5986", "south",
		"/players/mizan/opl/CELLS/C5867", "east",
		"/players/mizan/opl/CELLS/C5865", "west",
	});
