...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6733", "north",
		"/players/mizan/opl/CELLS/C6973", "south",
		"/players/mizan/opl/CELLS/C6854", "east",
		"/players/mizan/opl/CELLS/C6852", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/hard/ogre.c");
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/hard/soldierboss-blocker.c");
...
long()
{
	...
	write("\"New book out from Gary Hart; 'Six Inches from the White House'.\"\n");
