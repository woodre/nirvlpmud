...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3878", "north",
		"/players/mizan/opl/CELLS/C4118", "south",
		"/players/mizan/opl/CELLS/C3999", "east",
		"/players/mizan/opl/CELLS/C3997", "west",
	});
