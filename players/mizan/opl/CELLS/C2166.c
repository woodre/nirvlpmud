...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2046", "north",
		"/players/mizan/opl/CELLS/C2167", "east",
		"/players/mizan/opl/CELLS/C2165", "west",
	});
...
long()
{
	...
	write("\"Dallas still lives. God MUST be dead.\"\n");
