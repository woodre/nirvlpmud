...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6845", "north",
		"/players/mizan/opl/CELLS/C6966", "east",
		"/players/mizan/opl/CELLS/C6964", "west",
	});
...
long()
{
	...
	write("\"menage a trois, n.:	Using both hands to masturbate.\"\n");
