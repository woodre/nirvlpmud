...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4029", "north",
		"/players/mizan/opl/CELLS/C4269", "south",
		"/players/mizan/opl/CELLS/C4150", "east",
		"/players/mizan/opl/CELLS/C4148", "west",
	});
