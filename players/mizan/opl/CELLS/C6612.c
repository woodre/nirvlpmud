...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6492", "north",
		"/players/mizan/opl/CELLS/C6732", "south",
		"/players/mizan/opl/CELLS/C6613", "east",
		"/players/mizan/opl/CELLS/C6611", "west",
	});
...
long()
{
	...
	write("\"Psychics will soon lead dogs to your body.\"\n");
