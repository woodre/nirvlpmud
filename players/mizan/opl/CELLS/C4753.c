...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4633", "north",
		"/players/mizan/opl/CELLS/C4873", "south",
		"/players/mizan/opl/CELLS/C4754", "east",
		"/players/mizan/opl/CELLS/C4752", "west",
	});
