...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3892", "north",
		"/players/mizan/opl/CELLS/C4132", "south",
		"/players/mizan/opl/CELLS/C4013", "east",
		"/players/mizan/opl/CELLS/C4011", "west",
	});
