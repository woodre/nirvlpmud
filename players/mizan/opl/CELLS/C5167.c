...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5047", "north",
		"/players/mizan/opl/CELLS/C5287", "south",
	});
...
long()
{
	...
	write("\"Religion is a crutch, but that's okay... humanity is a cripple.\"\n");
