...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6035", "north",
		"/players/mizan/opl/CELLS/C6275", "south",
		"/players/mizan/opl/CELLS/C6156", "east",
		"/players/mizan/opl/CELLS/C6154", "west",
	});
