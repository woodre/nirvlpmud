...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3806", "north",
		"/players/mizan/opl/CELLS/C4046", "south",
		"/players/mizan/opl/CELLS/C3927", "east",
		"/players/mizan/opl/CELLS/C3925", "west",
	});
...
long()
{
	...
	write("\"Save Soviet Jewry -- Win Valuable Prizes!!!!\"\n");
