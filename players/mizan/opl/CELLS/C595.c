...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C475", "north",
		"/players/mizan/opl/CELLS/C715", "south",
		"/players/mizan/opl/CELLS/C596", "east",
		"/players/mizan/opl/CELLS/C594", "west",
	});
