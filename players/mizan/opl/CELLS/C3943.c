...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3944", "east",
		"/players/mizan/opl/CELLS/C3942", "west",
	});
...
long()
{
	...
	write("\"Confucious say:	man who pull out too fast leave rubber.\"\n");
