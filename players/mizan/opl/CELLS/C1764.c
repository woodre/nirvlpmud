...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1644", "north",
		"/players/mizan/opl/CELLS/C1884", "south",
		"/players/mizan/opl/CELLS/C1765", "east",
		"/players/mizan/opl/CELLS/C1763", "west",
	});
