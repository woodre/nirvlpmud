...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3570", "south",
		"/players/mizan/opl/CELLS/C3449", "west",
	});
...
long()
{
	...
	write("\"A shapely CATHOLIC SCHOOLGIRL is FIDGETING inside my costume..\"\n");
