...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4373", "north",
		"/players/mizan/opl/CELLS/C4613", "south",
		"/players/mizan/opl/CELLS/C4494", "east",
		"/players/mizan/opl/CELLS/C4492", "west",
	});
