...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5986", "north",
		"/players/mizan/opl/CELLS/C6226", "south",
		"/players/mizan/opl/CELLS/C6107", "east",
		"/players/mizan/opl/CELLS/C6105", "west",
	});
