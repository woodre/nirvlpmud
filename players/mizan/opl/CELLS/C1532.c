...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1412", "north",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/easy/zombie.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/easy/gummybear.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/easy/gonk.c");
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C1532");
		door1->set_type("medium-security");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I1532");
		door2->set_type("medium-security");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I1532");
...
long()
{
	...
	write("\"If sex is a pain in the ass, you may be doing it wrong.\"\n");
