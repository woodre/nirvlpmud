...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6231", "west",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6232");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6232");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6232");
...
long()
{
	...
	write("\"The three faithful things in life are money, a dog and an old woman.\"\n");
