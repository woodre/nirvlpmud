...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3527", "north",
		"/players/mizan/opl/CELLS/C3767", "south",
		"/players/mizan/opl/CELLS/C3648", "east",
		"/players/mizan/opl/CELLS/C3646", "west",
	});
