...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1749", "north",
		"/players/mizan/opl/CELLS/C1989", "south",
		"/players/mizan/opl/CELLS/C1870", "east",
		"/players/mizan/opl/CELLS/C1868", "west",
	});
