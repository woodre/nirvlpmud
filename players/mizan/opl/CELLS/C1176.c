...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1056", "north",
		"/players/mizan/opl/CELLS/C1296", "south",
	});
...
long()
{
	...
	write("\"Close the door, let me give you what you've been waiting for!!\"\n");
