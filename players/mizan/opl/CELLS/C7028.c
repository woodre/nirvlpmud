...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6908", "north",
		"/players/mizan/opl/CELLS/C7029", "east",
		"/players/mizan/opl/CELLS/C7027", "west",
	});
...
long()
{
	...
	write("\"Ashes to ashes, dust to dust,If God won't have you, the devil must.\"\n");
