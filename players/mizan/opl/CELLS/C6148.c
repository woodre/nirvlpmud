...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6268", "south",
		"/players/mizan/opl/CELLS/C6149", "east",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/fusion_octotron.c");
...
long()
{
	...
	write("\"Not everyone has a one-track mind.		-- From a Bisexuality 101 talk\"\n");
