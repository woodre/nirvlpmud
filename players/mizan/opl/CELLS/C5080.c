...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4960", "north",
		"/players/mizan/opl/CELLS/C5200", "south",
		"/players/mizan/opl/CELLS/C5081", "east",
		"/players/mizan/opl/CELLS/C5079", "west",
	});
