...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4575", "north",
		"/players/mizan/opl/CELLS/C4815", "south",
		"/players/mizan/opl/CELLS/C4696", "east",
		"/players/mizan/opl/CELLS/C4694", "west",
	});
