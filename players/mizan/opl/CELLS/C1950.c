...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1830", "north",
		"/players/mizan/opl/CELLS/C2070", "south",
		"/players/mizan/opl/CELLS/C1951", "east",
		"/players/mizan/opl/CELLS/C1949", "west",
	});
