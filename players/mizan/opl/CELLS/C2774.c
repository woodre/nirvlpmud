...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2654", "north",
		"/players/mizan/opl/CELLS/C2894", "south",
	});
...
long()
{
	...
	write("\"QOTD:	Sex is the most fun you can have without laughing.\"\n");
