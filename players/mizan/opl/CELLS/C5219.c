...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5099", "north",
		"/players/mizan/opl/CELLS/C5339", "south",
		"/players/mizan/opl/CELLS/C5220", "east",
		"/players/mizan/opl/CELLS/C5218", "west",
	});
