...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3739", "north",
		"/players/mizan/opl/CELLS/C3979", "south",
		"/players/mizan/opl/CELLS/C3860", "east",
		"/players/mizan/opl/CELLS/C3858", "west",
	});
