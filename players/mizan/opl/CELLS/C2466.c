...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2467", "east",
		"/players/mizan/opl/CELLS/C2465", "west",
	});
...
long()
{
	...
	write("\"Confucious say:	Kotex not best thing on earth, but next to best.\"\n");
