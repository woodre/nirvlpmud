...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4617", "north",
		"/players/mizan/opl/CELLS/C4857", "south",
		"/players/mizan/opl/CELLS/C4738", "east",
		"/players/mizan/opl/CELLS/C4736", "west",
	});
