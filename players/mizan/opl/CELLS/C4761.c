...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4641", "north",
		"/players/mizan/opl/CELLS/C4881", "south",
		"/players/mizan/opl/CELLS/C4762", "east",
		"/players/mizan/opl/CELLS/C4760", "west",
	});
