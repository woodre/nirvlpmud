...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2034", "north",
		"/players/mizan/opl/CELLS/C2274", "south",
		"/players/mizan/opl/CELLS/C2155", "east",
		"/players/mizan/opl/CELLS/C2153", "west",
	});
