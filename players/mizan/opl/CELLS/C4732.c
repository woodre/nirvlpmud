...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4612", "north",
		"/players/mizan/opl/CELLS/C4852", "south",
		"/players/mizan/opl/CELLS/C4733", "east",
		"/players/mizan/opl/CELLS/C4731", "west",
	});
