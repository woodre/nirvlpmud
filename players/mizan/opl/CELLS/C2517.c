...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2518", "east",
		"/players/mizan/opl/CELLS/C2516", "west",
	});
...
long()
{
	...
	write("\"Love does not make the world go around, just up and down a bit.\"\n");
