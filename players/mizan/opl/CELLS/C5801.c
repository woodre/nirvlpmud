...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5681", "north",
		"/players/mizan/opl/CELLS/C5921", "south",
		"/players/mizan/opl/CELLS/C5802", "east",
		"/players/mizan/opl/CELLS/C5800", "west",
	});
