...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1390", "north",
		"/players/mizan/opl/CELLS/C1630", "south",
		"/players/mizan/opl/CELLS/C1511", "east",
		"/players/mizan/opl/CELLS/C1509", "west",
	});
