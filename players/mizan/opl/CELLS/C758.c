...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C638", "north",
		"/players/mizan/opl/CELLS/C878", "south",
		"/players/mizan/opl/CELLS/C759", "east",
		"/players/mizan/opl/CELLS/C757", "west",
	});
