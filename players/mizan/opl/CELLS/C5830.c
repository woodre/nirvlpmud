...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5710", "north",
		"/players/mizan/opl/CELLS/C5950", "south",
		"/players/mizan/opl/CELLS/C5831", "east",
		"/players/mizan/opl/CELLS/C5829", "west",
	});
