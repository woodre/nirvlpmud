...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3140", "east",
		"/players/mizan/opl/CELLS/C3138", "west",
	});
...
long()
{
	...
	write("\"Confucious say:	man with head up ass have shitty outlook on life.\"\n");
