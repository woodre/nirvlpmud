...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5812", "north",
		"/players/mizan/opl/CELLS/C6052", "south",
		"/players/mizan/opl/CELLS/C5933", "east",
		"/players/mizan/opl/CELLS/C5931", "west",
	});
