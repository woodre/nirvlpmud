...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6039", "north",
		"/players/mizan/opl/CELLS/C6279", "south",
		"/players/mizan/opl/CELLS/C6160", "east",
		"/players/mizan/opl/CELLS/C6158", "west",
	});
