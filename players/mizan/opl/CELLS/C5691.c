...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5571", "north",
		"/players/mizan/opl/CELLS/C5811", "south",
		"/players/mizan/opl/CELLS/C5692", "east",
		"/players/mizan/opl/CELLS/C5690", "west",
	});
