...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5744", "north",
		"/players/mizan/opl/CELLS/C5984", "south",
		"/players/mizan/opl/CELLS/C5865", "east",
		"/players/mizan/opl/CELLS/C5863", "west",
	});
