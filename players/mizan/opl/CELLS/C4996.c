...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4876", "north",
		"/players/mizan/opl/CELLS/C5116", "south",
		"/players/mizan/opl/CELLS/C4997", "east",
		"/players/mizan/opl/CELLS/C4995", "west",
	});
