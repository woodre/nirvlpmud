...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5822", "north",
		"/players/mizan/opl/CELLS/C6062", "south",
		"/players/mizan/opl/CELLS/C5943", "east",
		"/players/mizan/opl/CELLS/C5941", "west",
	});
