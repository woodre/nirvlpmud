...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4698", "north",
		"/players/mizan/opl/CELLS/C4938", "south",
		"/players/mizan/opl/CELLS/C4819", "east",
		"/players/mizan/opl/CELLS/C4817", "west",
	});
