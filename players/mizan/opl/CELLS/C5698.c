...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5578", "north",
		"/players/mizan/opl/CELLS/C5818", "south",
		"/players/mizan/opl/CELLS/C5699", "east",
		"/players/mizan/opl/CELLS/C5697", "west",
	});
