...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4335", "north",
		"/players/mizan/opl/CELLS/C4575", "south",
		"/players/mizan/opl/CELLS/C4456", "east",
		"/players/mizan/opl/CELLS/C4454", "west",
	});
