...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5357", "north",
		"/players/mizan/opl/CELLS/C5597", "south",
		"/players/mizan/opl/CELLS/C5478", "east",
		"/players/mizan/opl/CELLS/C5476", "west",
	});
