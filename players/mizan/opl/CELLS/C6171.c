...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6051", "north",
		"/players/mizan/opl/CELLS/C6291", "south",
		"/players/mizan/opl/CELLS/C6172", "east",
		"/players/mizan/opl/CELLS/C6170", "west",
	});
