...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5200", "north",
		"/players/mizan/opl/CELLS/C5440", "south",
		"/players/mizan/opl/CELLS/C5321", "east",
		"/players/mizan/opl/CELLS/C5319", "west",
	});
