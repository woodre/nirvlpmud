...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3522", "north",
		"/players/mizan/opl/CELLS/C3762", "south",
		"/players/mizan/opl/CELLS/C3643", "east",
		"/players/mizan/opl/CELLS/C3641", "west",
	});
