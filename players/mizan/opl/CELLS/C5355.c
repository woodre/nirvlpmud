...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5235", "north",
		"/players/mizan/opl/CELLS/C5475", "south",
		"/players/mizan/opl/CELLS/C5356", "east",
		"/players/mizan/opl/CELLS/C5354", "west",
	});
