...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4700", "north",
		"/players/mizan/opl/CELLS/C4940", "south",
		"/players/mizan/opl/CELLS/C4821", "east",
		"/players/mizan/opl/CELLS/C4819", "west",
	});
