...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4381", "north",
		"/players/mizan/opl/CELLS/C4621", "south",
		"/players/mizan/opl/CELLS/C4502", "east",
		"/players/mizan/opl/CELLS/C4500", "west",
	});
