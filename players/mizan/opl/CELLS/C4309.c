...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4189", "north",
		"/players/mizan/opl/CELLS/C4429", "south",
		"/players/mizan/opl/CELLS/C4310", "east",
		"/players/mizan/opl/CELLS/C4308", "west",
	});
