...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5926", "north",
		"/players/mizan/opl/CELLS/C6166", "south",
		"/players/mizan/opl/CELLS/C6047", "east",
		"/players/mizan/opl/CELLS/C6045", "west",
	});
