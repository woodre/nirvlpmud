...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1751", "north",
		"/players/mizan/opl/CELLS/C1991", "south",
		"/players/mizan/opl/CELLS/C1872", "east",
		"/players/mizan/opl/CELLS/C1870", "west",
	});
