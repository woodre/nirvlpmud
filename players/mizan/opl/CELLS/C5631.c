...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5511", "north",
		"/players/mizan/opl/CELLS/C5751", "south",
		"/players/mizan/opl/CELLS/C5632", "east",
		"/players/mizan/opl/CELLS/C5630", "west",
	});
