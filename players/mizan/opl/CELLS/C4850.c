...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4730", "north",
		"/players/mizan/opl/CELLS/C4970", "south",
		"/players/mizan/opl/CELLS/C4851", "east",
		"/players/mizan/opl/CELLS/C4849", "west",
	});
