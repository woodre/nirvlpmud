...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4963", "north",
		"/players/mizan/opl/CELLS/C5203", "south",
		"/players/mizan/opl/CELLS/C5084", "east",
		"/players/mizan/opl/CELLS/C5082", "west",
	});
