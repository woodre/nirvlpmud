...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4491", "north",
		"/players/mizan/opl/CELLS/C4731", "south",
		"/players/mizan/opl/CELLS/C4612", "east",
		"/players/mizan/opl/CELLS/C4610", "west",
	});
