...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4999", "north",
		"/players/mizan/opl/CELLS/C5239", "south",
		"/players/mizan/opl/CELLS/C5120", "east",
		"/players/mizan/opl/CELLS/C5118", "west",
	});
