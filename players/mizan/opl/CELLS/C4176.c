...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4056", "north",
		"/players/mizan/opl/CELLS/C4296", "south",
	});
...
long()
{
	...
	write("\"I have a VISION! It's a RANCID double-FISHWICH on an ENRICHED BUN!!\"\n");
