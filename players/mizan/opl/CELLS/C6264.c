...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6144", "north",
		"/players/mizan/opl/CELLS/C6265", "east",
		"/players/mizan/opl/CELLS/C6263", "west",
	});
...
long()
{
	...
	write("\"It's NO USE ... I've gone to 'CLUB MED'!!\"\n");
