...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3971", "north",
		"/players/mizan/opl/CELLS/C4211", "south",
		"/players/mizan/opl/CELLS/C4092", "east",
		"/players/mizan/opl/CELLS/C4090", "west",
	});
