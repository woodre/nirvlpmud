...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4210", "north",
		"/players/mizan/opl/CELLS/C4450", "south",
		"/players/mizan/opl/CELLS/C4331", "east",
		"/players/mizan/opl/CELLS/C4329", "west",
	});
