...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5212", "north",
		"/players/mizan/opl/CELLS/C5452", "south",
		"/players/mizan/opl/CELLS/C5333", "east",
		"/players/mizan/opl/CELLS/C5331", "west",
	});
