...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C408", "north",
		"/players/mizan/opl/CELLS/C648", "south",
		"/players/mizan/opl/CELLS/C529", "east",
		"/players/mizan/opl/CELLS/C527", "west",
	});
...
long()
{
	...
	write("\"Could I have a drug overdose?\"\n");
