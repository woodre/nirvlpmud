...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2628", "north",
		"/players/mizan/opl/CELLS/C2868", "south",
		"/players/mizan/opl/CELLS/C2749", "east",
		"/players/mizan/opl/CELLS/C2747", "west",
	});
