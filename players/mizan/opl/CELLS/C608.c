...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C488", "north",
		"/players/mizan/opl/CELLS/C728", "south",
		"/players/mizan/opl/CELLS/C609", "east",
		"/players/mizan/opl/CELLS/C607", "west",
	});
