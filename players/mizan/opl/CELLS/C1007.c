...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C887", "north",
		"/players/mizan/opl/CELLS/C1127", "south",
		"/players/mizan/opl/CELLS/C1006", "west",
	});
...
long()
{
	...
	write("\"PPRB -- Pillage, plunder, rape and burn.\"\n");
