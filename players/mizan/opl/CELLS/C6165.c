...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6045", "north",
		"/players/mizan/opl/CELLS/C6285", "south",
		"/players/mizan/opl/CELLS/C6166", "east",
		"/players/mizan/opl/CELLS/C6164", "west",
	});
