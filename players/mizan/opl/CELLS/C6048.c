...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5928", "north",
		"/players/mizan/opl/CELLS/C6168", "south",
		"/players/mizan/opl/CELLS/C6049", "east",
		"/players/mizan/opl/CELLS/C6047", "west",
	});
