...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C823", "north",
		"/players/mizan/opl/CELLS/C1063", "south",
		"/players/mizan/opl/CELLS/C942", "west",
	});
...
long()
{
	...
	write("\"Sex is great,Sex is grand,Sex around here,Is mostly by hand.\"\n");
