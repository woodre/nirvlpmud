...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5626", "north",
		"/players/mizan/opl/CELLS/C5866", "south",
		"/players/mizan/opl/CELLS/C5747", "east",
		"/players/mizan/opl/CELLS/C5745", "west",
	});
