...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5814", "north",
		"/players/mizan/opl/CELLS/C6054", "south",
		"/players/mizan/opl/CELLS/C5935", "east",
		"/players/mizan/opl/CELLS/C5933", "west",
	});
