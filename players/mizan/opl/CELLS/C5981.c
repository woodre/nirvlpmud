...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5861", "north",
		"/players/mizan/opl/CELLS/C6101", "south",
		"/players/mizan/opl/CELLS/C5982", "east",
		"/players/mizan/opl/CELLS/C5980", "west",
	});
