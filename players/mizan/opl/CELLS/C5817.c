...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5697", "north",
		"/players/mizan/opl/CELLS/C5937", "south",
		"/players/mizan/opl/CELLS/C5818", "east",
		"/players/mizan/opl/CELLS/C5816", "west",
	});
