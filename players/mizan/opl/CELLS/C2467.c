...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2587", "south",
		"/players/mizan/opl/CELLS/C2468", "east",
		"/players/mizan/opl/CELLS/C2466", "west",
	});
...
long()
{
	...
	write("\"Do not stoop to tie your laces in your neighbor's melon patch.\"\n");
