...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4341", "north",
		"/players/mizan/opl/CELLS/C4581", "south",
		"/players/mizan/opl/CELLS/C4462", "east",
		"/players/mizan/opl/CELLS/C4460", "west",
	});
