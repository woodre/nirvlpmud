...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4732", "north",
		"/players/mizan/opl/CELLS/C4972", "south",
		"/players/mizan/opl/CELLS/C4853", "east",
		"/players/mizan/opl/CELLS/C4851", "west",
	});
