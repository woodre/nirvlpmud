...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1513", "north",
		"/players/mizan/opl/CELLS/C1753", "south",
		"/players/mizan/opl/CELLS/C1634", "east",
		"/players/mizan/opl/CELLS/C1632", "west",
	});
