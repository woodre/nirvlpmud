...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5556", "north",
		"/players/mizan/opl/CELLS/C5796", "south",
		"/players/mizan/opl/CELLS/C5677", "east",
		"/players/mizan/opl/CELLS/C5675", "west",
	});
