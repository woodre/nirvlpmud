...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1271", "north",
		"/players/mizan/opl/CELLS/C1511", "south",
		"/players/mizan/opl/CELLS/C1392", "east",
		"/players/mizan/opl/CELLS/C1390", "west",
	});
