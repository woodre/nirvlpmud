...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3687", "north",
		"/players/mizan/opl/CELLS/C3927", "south",
		"/players/mizan/opl/CELLS/C3808", "east",
		"/players/mizan/opl/CELLS/C3806", "west",
	});
...
long()
{
	...
	write("\"Where do your SOCKS go when you lose them in th' WASHER?\"\n");
