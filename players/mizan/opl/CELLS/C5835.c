...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5715", "north",
		"/players/mizan/opl/CELLS/C5955", "south",
		"/players/mizan/opl/CELLS/C5836", "east",
		"/players/mizan/opl/CELLS/C5834", "west",
	});
