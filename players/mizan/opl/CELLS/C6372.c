...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6252", "north",
		"/players/mizan/opl/CELLS/C6492", "south",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/potentato.c");
...
long()
{
	...
	write("\"I think my career is ruined!\"\n");
