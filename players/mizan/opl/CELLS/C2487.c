...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2367", "north",
		"/players/mizan/opl/CELLS/C2607", "south",
		"/players/mizan/opl/CELLS/C2488", "east",
		"/players/mizan/opl/CELLS/C2486", "west",
	});
