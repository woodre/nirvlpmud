...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1969", "north",
		"/players/mizan/opl/CELLS/C2209", "south",
		"/players/mizan/opl/CELLS/C2088", "west",
	});
...
long()
{
	...
	write("\"QOTD:	'I treat her like a throughbred, and she's STILL a nag!'\"\n");
