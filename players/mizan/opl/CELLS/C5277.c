...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5157", "north",
		"/players/mizan/opl/CELLS/C5397", "south",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/easy/neocon-blocker.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/easy/neocon-blocker.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/easy/neocon-blocker.c");
...
long()
{
	...
	write("\"The only excuse for God is that he doesn't exist.		-- Stendhal\"\n");
