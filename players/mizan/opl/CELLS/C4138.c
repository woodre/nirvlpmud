...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4018", "north",
		"/players/mizan/opl/CELLS/C4258", "south",
		"/players/mizan/opl/CELLS/C4139", "east",
		"/players/mizan/opl/CELLS/C4137", "west",
	});
