...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4868", "north",
		"/players/mizan/opl/CELLS/C5108", "south",
		"/players/mizan/opl/CELLS/C4989", "east",
		"/players/mizan/opl/CELLS/C4987", "west",
	});
