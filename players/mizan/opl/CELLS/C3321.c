...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3320", "west",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3321");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3321");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3321");
...
long()
{
	...
	write("\"A genius is a queer who can whistle while he works.		-- Bobby Knight\"\n");
