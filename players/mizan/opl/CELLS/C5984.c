...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5864", "north",
		"/players/mizan/opl/CELLS/C6104", "south",
		"/players/mizan/opl/CELLS/C5985", "east",
		"/players/mizan/opl/CELLS/C5983", "west",
	});
