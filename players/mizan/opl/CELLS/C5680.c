...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5560", "north",
		"/players/mizan/opl/CELLS/C5800", "south",
		"/players/mizan/opl/CELLS/C5681", "east",
		"/players/mizan/opl/CELLS/C5679", "west",
	});
