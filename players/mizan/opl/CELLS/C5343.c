...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5223", "north",
		"/players/mizan/opl/CELLS/C5463", "south",
		"/players/mizan/opl/CELLS/C5344", "east",
		"/players/mizan/opl/CELLS/C5342", "west",
	});
