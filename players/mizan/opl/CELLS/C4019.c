...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3899", "north",
		"/players/mizan/opl/CELLS/C4139", "south",
		"/players/mizan/opl/CELLS/C4020", "east",
		"/players/mizan/opl/CELLS/C4018", "west",
	});
