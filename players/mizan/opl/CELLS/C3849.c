...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3729", "north",
		"/players/mizan/opl/CELLS/C3969", "south",
		"/players/mizan/opl/CELLS/C3850", "east",
		"/players/mizan/opl/CELLS/C3848", "west",
	});
