...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5935", "north",
		"/players/mizan/opl/CELLS/C6175", "south",
		"/players/mizan/opl/CELLS/C6056", "east",
		"/players/mizan/opl/CELLS/C6054", "west",
	});
