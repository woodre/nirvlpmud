...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1865", "north",
		"/players/mizan/opl/CELLS/C2105", "south",
		"/players/mizan/opl/CELLS/C1986", "east",
		"/players/mizan/opl/CELLS/C1984", "west",
	});
