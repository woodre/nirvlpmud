...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4462", "north",
		"/players/mizan/opl/CELLS/C4702", "south",
		"/players/mizan/opl/CELLS/C4583", "east",
		"/players/mizan/opl/CELLS/C4581", "west",
	});
