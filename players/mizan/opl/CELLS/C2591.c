...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2471", "north",
		"/players/mizan/opl/CELLS/C2592", "east",
	});
...
long()
{
	...
	write("\"We call our dog Egypt, because in every room he leaves a pyramid.\"\n");
