...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3665", "east",
		"/players/mizan/opl/CELLS/C3663", "west",
	});
...
long()
{
	...
	write("\"A lover without indiscretion is no lover at all.		-- Thomas Hardy\"\n");
