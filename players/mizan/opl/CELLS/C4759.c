...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4639", "north",
		"/players/mizan/opl/CELLS/C4879", "south",
		"/players/mizan/opl/CELLS/C4760", "east",
		"/players/mizan/opl/CELLS/C4758", "west",
	});
