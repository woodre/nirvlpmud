...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4675", "north",
		"/players/mizan/opl/CELLS/C4915", "south",
		"/players/mizan/opl/CELLS/C4796", "east",
		"/players/mizan/opl/CELLS/C4794", "west",
	});
