...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1260", "north",
		"/players/mizan/opl/CELLS/C1500", "south",
		"/players/mizan/opl/CELLS/C1381", "east",
		"/players/mizan/opl/CELLS/C1379", "west",
	});
