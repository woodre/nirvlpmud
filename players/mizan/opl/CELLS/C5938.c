...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5818", "north",
		"/players/mizan/opl/CELLS/C6058", "south",
		"/players/mizan/opl/CELLS/C5939", "east",
		"/players/mizan/opl/CELLS/C5937", "west",
	});
