...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6292", "north",
		"/players/mizan/opl/CELLS/C6532", "south",
		"/players/mizan/opl/CELLS/C6413", "east",
		"/players/mizan/opl/CELLS/C6411", "west",
	});
