...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5944", "north",
		"/players/mizan/opl/CELLS/C6184", "south",
		"/players/mizan/opl/CELLS/C6065", "east",
		"/players/mizan/opl/CELLS/C6063", "west",
	});
