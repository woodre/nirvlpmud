...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4616", "north",
		"/players/mizan/opl/CELLS/C4856", "south",
		"/players/mizan/opl/CELLS/C4737", "east",
		"/players/mizan/opl/CELLS/C4735", "west",
	});
