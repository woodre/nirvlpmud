...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2191", "north",
		"/players/mizan/opl/CELLS/C2431", "south",
		"/players/mizan/opl/CELLS/C2312", "east",
		"/players/mizan/opl/CELLS/C2310", "west",
	});
