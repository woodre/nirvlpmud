...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C392", "south",
		"/players/mizan/opl/CELLS/C273", "east",
		"/players/mizan/opl/CELLS/C271", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/easy/cobold.c");
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/easy/gundroid.c");
...
long()
{
	...
	write("\"Are we THERE yet? My MIND is a SUBMARINE!!\"\n");
