...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3900", "north",
		"/players/mizan/opl/CELLS/C4140", "south",
		"/players/mizan/opl/CELLS/C4021", "east",
		"/players/mizan/opl/CELLS/C4019", "west",
	});
