...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4994", "north",
		"/players/mizan/opl/CELLS/C5234", "south",
		"/players/mizan/opl/CELLS/C5115", "east",
		"/players/mizan/opl/CELLS/C5113", "west",
	});
