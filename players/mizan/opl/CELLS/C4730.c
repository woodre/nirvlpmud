...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4610", "north",
		"/players/mizan/opl/CELLS/C4850", "south",
		"/players/mizan/opl/CELLS/C4731", "east",
		"/players/mizan/opl/CELLS/C4729", "west",
	});
