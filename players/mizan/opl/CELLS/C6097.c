...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5977", "north",
		"/players/mizan/opl/CELLS/C6217", "south",
		"/players/mizan/opl/CELLS/C6098", "east",
		"/players/mizan/opl/CELLS/C6096", "west",
	});
