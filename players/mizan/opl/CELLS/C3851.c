...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3731", "north",
		"/players/mizan/opl/CELLS/C3971", "south",
		"/players/mizan/opl/CELLS/C3852", "east",
		"/players/mizan/opl/CELLS/C3850", "west",
	});
