...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1672", "north",
		"/players/mizan/opl/CELLS/C1912", "south",
		"/players/mizan/opl/CELLS/C1793", "east",
		"/players/mizan/opl/CELLS/C1791", "west",
	});
