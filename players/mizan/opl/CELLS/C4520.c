...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4400", "north",
		"/players/mizan/opl/CELLS/C4640", "south",
		"/players/mizan/opl/CELLS/C4521", "east",
		"/players/mizan/opl/CELLS/C4519", "west",
	});
