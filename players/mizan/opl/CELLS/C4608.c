...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4488", "north",
		"/players/mizan/opl/CELLS/C4728", "south",
		"/players/mizan/opl/CELLS/C4609", "east",
		"/players/mizan/opl/CELLS/C4607", "west",
	});
