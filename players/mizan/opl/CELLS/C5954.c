...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5834", "north",
		"/players/mizan/opl/CELLS/C6074", "south",
		"/players/mizan/opl/CELLS/C5955", "east",
		"/players/mizan/opl/CELLS/C5953", "west",
	});
