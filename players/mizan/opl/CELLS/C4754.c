...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4634", "north",
		"/players/mizan/opl/CELLS/C4874", "south",
		"/players/mizan/opl/CELLS/C4755", "east",
		"/players/mizan/opl/CELLS/C4753", "west",
	});
