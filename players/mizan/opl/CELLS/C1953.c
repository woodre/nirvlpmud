...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1833", "north",
		"/players/mizan/opl/CELLS/C2073", "south",
		"/players/mizan/opl/CELLS/C1954", "east",
		"/players/mizan/opl/CELLS/C1952", "west",
	});
