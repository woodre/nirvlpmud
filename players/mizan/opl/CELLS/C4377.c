...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4257", "north",
		"/players/mizan/opl/CELLS/C4497", "south",
		"/players/mizan/opl/CELLS/C4378", "east",
		"/players/mizan/opl/CELLS/C4376", "west",
	});
