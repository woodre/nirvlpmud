...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C663", "north",
		"/players/mizan/opl/CELLS/C903", "south",
	});
...
long()
{
	...
	write("\"Cocaine is nature's way of telling you you have too much money.\"\n");
