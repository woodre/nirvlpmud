...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3220", "north",
		"/players/mizan/opl/CELLS/C3460", "south",
		"/players/mizan/opl/CELLS/C3341", "east",
		"/players/mizan/opl/CELLS/C3339", "west",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/medium/knobgoblin-bully.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/medium/beano-agent.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/medium/knobgoblin-bully.c");
...
long()
{
	...
	write("\"Warning: Trespassers will be shot. Survivors will be shot again.\"\n");
