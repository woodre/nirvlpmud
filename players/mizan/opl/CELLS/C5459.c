...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5339", "north",
		"/players/mizan/opl/CELLS/C5579", "south",
		"/players/mizan/opl/CELLS/C5460", "east",
		"/players/mizan/opl/CELLS/C5458", "west",
	});
