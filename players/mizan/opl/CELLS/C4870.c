...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4750", "north",
		"/players/mizan/opl/CELLS/C4990", "south",
		"/players/mizan/opl/CELLS/C4871", "east",
		"/players/mizan/opl/CELLS/C4869", "west",
	});
