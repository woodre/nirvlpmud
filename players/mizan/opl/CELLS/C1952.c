...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1832", "north",
		"/players/mizan/opl/CELLS/C2072", "south",
		"/players/mizan/opl/CELLS/C1953", "east",
		"/players/mizan/opl/CELLS/C1951", "west",
	});
