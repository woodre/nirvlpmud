...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5565", "north",
		"/players/mizan/opl/CELLS/C5805", "south",
		"/players/mizan/opl/CELLS/C5686", "east",
		"/players/mizan/opl/CELLS/C5684", "west",
	});
