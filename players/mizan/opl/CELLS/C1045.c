...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C925", "north",
		"/players/mizan/opl/CELLS/C1165", "south",
		"/players/mizan/opl/CELLS/C1046", "east",
		"/players/mizan/opl/CELLS/C1044", "west",
	});
