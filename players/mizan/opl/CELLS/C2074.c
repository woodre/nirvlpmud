...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1954", "north",
		"/players/mizan/opl/CELLS/C2194", "south",
		"/players/mizan/opl/CELLS/C2075", "east",
		"/players/mizan/opl/CELLS/C2073", "west",
	});
