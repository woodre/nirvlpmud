...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3642", "north",
		"/players/mizan/opl/CELLS/C3882", "south",
		"/players/mizan/opl/CELLS/C3763", "east",
		"/players/mizan/opl/CELLS/C3761", "west",
	});
