...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4967", "north",
		"/players/mizan/opl/CELLS/C5207", "south",
		"/players/mizan/opl/CELLS/C5088", "east",
		"/players/mizan/opl/CELLS/C5086", "west",
	});
