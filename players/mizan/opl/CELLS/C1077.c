...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1078", "east",
		"/players/mizan/opl/CELLS/C1076", "west",
	});
...
long()
{
	...
	write("\"I own seven-eighths of all the artists in downtown Burbank!\"\n");
