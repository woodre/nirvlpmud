...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6490", "north",
		"/players/mizan/opl/CELLS/C6611", "east",
		"/players/mizan/opl/CELLS/C6609", "west",
	});
...
long()
{
	...
	write("\"Now that I have my 'APPLE', I comprehend COST ACCOUNTING!!\"\n");
