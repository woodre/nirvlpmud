...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C526", "north",
		"/players/mizan/opl/CELLS/C766", "south",
		"/players/mizan/opl/CELLS/C647", "east",
		"/players/mizan/opl/CELLS/C645", "west",
	});
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/lectroid_boss.c");
...
long()
{
	...
	write("\"Yow! And then we could sit on the hoods of cars at stop lights!\"\n");
