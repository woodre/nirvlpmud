...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2251", "north",
		"/players/mizan/opl/CELLS/C2491", "south",
		"/players/mizan/opl/CELLS/C2372", "east",
		"/players/mizan/opl/CELLS/C2370", "west",
	});
