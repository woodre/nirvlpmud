...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6197", "north",
		"/players/mizan/opl/CELLS/C6437", "south",
		"/players/mizan/opl/CELLS/C6318", "east",
		"/players/mizan/opl/CELLS/C6316", "west",
	});
