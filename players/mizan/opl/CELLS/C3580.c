...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3460", "north",
		"/players/mizan/opl/CELLS/C3700", "south",
	});
...
long()
{
	...
	write("\"'Ignorance is the mother of devotion.'    [Dean Henry Cole]\"\n");
