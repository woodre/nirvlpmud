...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6401", "north",
		"/players/mizan/opl/CELLS/C6641", "south",
		"/players/mizan/opl/CELLS/C6522", "east",
		"/players/mizan/opl/CELLS/C6520", "west",
	});
