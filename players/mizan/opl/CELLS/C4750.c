...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4630", "north",
		"/players/mizan/opl/CELLS/C4870", "south",
		"/players/mizan/opl/CELLS/C4751", "east",
		"/players/mizan/opl/CELLS/C4749", "west",
	});
