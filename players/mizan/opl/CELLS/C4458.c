...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4338", "north",
		"/players/mizan/opl/CELLS/C4578", "south",
		"/players/mizan/opl/CELLS/C4459", "east",
		"/players/mizan/opl/CELLS/C4457", "west",
	});
