...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3546", "south",
		"/players/mizan/opl/CELLS/C3427", "east",
		"/players/mizan/opl/CELLS/C3425", "west",
	});
...
long()
{
	...
	write("\"Eat shit -- billions of flies can't be wrong.\"\n");
