...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1794", "north",
		"/players/mizan/opl/CELLS/C2034", "south",
		"/players/mizan/opl/CELLS/C1915", "east",
		"/players/mizan/opl/CELLS/C1913", "west",
	});
