...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5922", "north",
		"/players/mizan/opl/CELLS/C6162", "south",
		"/players/mizan/opl/CELLS/C6043", "east",
		"/players/mizan/opl/CELLS/C6041", "west",
	});
