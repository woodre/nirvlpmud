...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4505", "north",
		"/players/mizan/opl/CELLS/C4745", "south",
		"/players/mizan/opl/CELLS/C4626", "east",
		"/players/mizan/opl/CELLS/C4624", "west",
	});
