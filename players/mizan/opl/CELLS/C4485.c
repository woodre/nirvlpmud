...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4365", "north",
		"/players/mizan/opl/CELLS/C4605", "south",
		"/players/mizan/opl/CELLS/C4486", "east",
		"/players/mizan/opl/CELLS/C4484", "west",
	});
