...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5858", "north",
		"/players/mizan/opl/CELLS/C6098", "south",
		"/players/mizan/opl/CELLS/C5979", "east",
		"/players/mizan/opl/CELLS/C5977", "west",
	});
