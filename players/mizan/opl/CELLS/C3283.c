...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3163", "north",
		"/players/mizan/opl/CELLS/C3403", "south",
		"/players/mizan/opl/CELLS/C3284", "east",
		"/players/mizan/opl/CELLS/C3282", "west",
	});
