...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4473", "north",
		"/players/mizan/opl/CELLS/C4713", "south",
		"/players/mizan/opl/CELLS/C4594", "east",
		"/players/mizan/opl/CELLS/C4592", "west",
	});
