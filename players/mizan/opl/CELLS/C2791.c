...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2671", "north",
		"/players/mizan/opl/CELLS/C2911", "south",
		"/players/mizan/opl/CELLS/C2792", "east",
		"/players/mizan/opl/CELLS/C2790", "west",
	});
