...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3738", "north",
		"/players/mizan/opl/CELLS/C3978", "south",
		"/players/mizan/opl/CELLS/C3859", "east",
		"/players/mizan/opl/CELLS/C3857", "west",
	});
