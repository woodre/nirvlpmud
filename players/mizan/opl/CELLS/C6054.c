...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5934", "north",
		"/players/mizan/opl/CELLS/C6174", "south",
		"/players/mizan/opl/CELLS/C6055", "east",
		"/players/mizan/opl/CELLS/C6053", "west",
	});
