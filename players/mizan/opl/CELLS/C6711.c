...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6712", "east",
		"/players/mizan/opl/CELLS/C6710", "west",
	});
...
long()
{
	...
	write("\"	'Do you smoke after sex?'	'Why, do you know, I've never looked!'\"\n");
