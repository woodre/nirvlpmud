...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5114", "north",
		"/players/mizan/opl/CELLS/C5354", "south",
		"/players/mizan/opl/CELLS/C5235", "east",
		"/players/mizan/opl/CELLS/C5233", "west",
	});
