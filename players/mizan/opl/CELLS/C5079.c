...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4959", "north",
		"/players/mizan/opl/CELLS/C5199", "south",
		"/players/mizan/opl/CELLS/C5080", "east",
		"/players/mizan/opl/CELLS/C5078", "west",
	});
