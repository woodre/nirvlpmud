...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5808", "north",
		"/players/mizan/opl/CELLS/C6048", "south",
		"/players/mizan/opl/CELLS/C5929", "east",
		"/players/mizan/opl/CELLS/C5927", "west",
	});
