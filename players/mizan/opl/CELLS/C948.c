...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C828", "north",
		"/players/mizan/opl/CELLS/C1068", "south",
		"/players/mizan/opl/CELLS/C949", "east",
		"/players/mizan/opl/CELLS/C947", "west",
	});
