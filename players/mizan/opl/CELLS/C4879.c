...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4759", "north",
		"/players/mizan/opl/CELLS/C4999", "south",
		"/players/mizan/opl/CELLS/C4880", "east",
		"/players/mizan/opl/CELLS/C4878", "west",
	});
