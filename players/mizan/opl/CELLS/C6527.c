...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6407", "north",
		"/players/mizan/opl/CELLS/C6647", "south",
		"/players/mizan/opl/CELLS/C6528", "east",
		"/players/mizan/opl/CELLS/C6526", "west",
	});
