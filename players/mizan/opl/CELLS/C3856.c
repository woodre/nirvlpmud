...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3736", "north",
		"/players/mizan/opl/CELLS/C3976", "south",
		"/players/mizan/opl/CELLS/C3857", "east",
		"/players/mizan/opl/CELLS/C3855", "west",
	});
