...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4593", "north",
		"/players/mizan/opl/CELLS/C4833", "south",
		"/players/mizan/opl/CELLS/C4714", "east",
		"/players/mizan/opl/CELLS/C4712", "west",
	});
