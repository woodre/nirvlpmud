...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6157", "north",
		"/players/mizan/opl/CELLS/C6397", "south",
		"/players/mizan/opl/CELLS/C6278", "east",
		"/players/mizan/opl/CELLS/C6276", "west",
	});
