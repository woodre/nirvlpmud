...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6218", "north",
		"/players/mizan/opl/CELLS/C6458", "south",
		"/players/mizan/opl/CELLS/C6339", "east",
		"/players/mizan/opl/CELLS/C6337", "west",
	});
