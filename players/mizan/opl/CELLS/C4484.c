...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4364", "north",
		"/players/mizan/opl/CELLS/C4604", "south",
		"/players/mizan/opl/CELLS/C4485", "east",
		"/players/mizan/opl/CELLS/C4483", "west",
	});
