...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4248", "north",
		"/players/mizan/opl/CELLS/C4488", "south",
		"/players/mizan/opl/CELLS/C4369", "east",
		"/players/mizan/opl/CELLS/C4367", "west",
	});
