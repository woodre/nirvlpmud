...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4699", "north",
		"/players/mizan/opl/CELLS/C4939", "south",
		"/players/mizan/opl/CELLS/C4820", "east",
		"/players/mizan/opl/CELLS/C4818", "west",
	});
