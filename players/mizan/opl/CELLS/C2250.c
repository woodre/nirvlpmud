...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2130", "north",
		"/players/mizan/opl/CELLS/C2370", "south",
		"/players/mizan/opl/CELLS/C2251", "east",
		"/players/mizan/opl/CELLS/C2249", "west",
	});
