...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4087", "north",
		"/players/mizan/opl/CELLS/C4327", "south",
		"/players/mizan/opl/CELLS/C4208", "east",
		"/players/mizan/opl/CELLS/C4206", "west",
	});
