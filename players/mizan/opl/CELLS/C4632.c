...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4512", "north",
		"/players/mizan/opl/CELLS/C4752", "south",
		"/players/mizan/opl/CELLS/C4633", "east",
		"/players/mizan/opl/CELLS/C4631", "west",
	});
