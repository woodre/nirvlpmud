...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6066", "north",
		"/players/mizan/opl/CELLS/C6306", "south",
		"/players/mizan/opl/CELLS/C6187", "east",
		"/players/mizan/opl/CELLS/C6185", "west",
	});
