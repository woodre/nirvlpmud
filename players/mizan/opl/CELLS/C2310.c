...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2190", "north",
		"/players/mizan/opl/CELLS/C2430", "south",
		"/players/mizan/opl/CELLS/C2311", "east",
		"/players/mizan/opl/CELLS/C2309", "west",
	});
