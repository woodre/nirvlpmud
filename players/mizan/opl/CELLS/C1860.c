...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1740", "north",
		"/players/mizan/opl/CELLS/C1980", "south",
		"/players/mizan/opl/CELLS/C1861", "east",
		"/players/mizan/opl/CELLS/C1859", "west",
	});
