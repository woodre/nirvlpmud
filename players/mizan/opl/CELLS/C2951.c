...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2831", "north",
		"/players/mizan/opl/CELLS/C3071", "south",
		"/players/mizan/opl/CELLS/C2950", "west",
	});
...
long()
{
	...
	write("\"Confucious say:	a smart man knows on which side his broad is better.\"\n");
