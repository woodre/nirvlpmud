...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4250", "north",
		"/players/mizan/opl/CELLS/C4490", "south",
		"/players/mizan/opl/CELLS/C4371", "east",
		"/players/mizan/opl/CELLS/C4369", "west",
	});
