...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5980", "north",
		"/players/mizan/opl/CELLS/C6220", "south",
		"/players/mizan/opl/CELLS/C6101", "east",
		"/players/mizan/opl/CELLS/C6099", "west",
	});
