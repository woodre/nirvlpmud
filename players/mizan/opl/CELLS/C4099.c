...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3979", "north",
		"/players/mizan/opl/CELLS/C4219", "south",
		"/players/mizan/opl/CELLS/C4100", "east",
		"/players/mizan/opl/CELLS/C4098", "west",
	});
