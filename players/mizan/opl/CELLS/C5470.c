...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5350", "north",
		"/players/mizan/opl/CELLS/C5590", "south",
		"/players/mizan/opl/CELLS/C5471", "east",
		"/players/mizan/opl/CELLS/C5469", "west",
	});
