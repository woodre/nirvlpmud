...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3688", "north",
		"/players/mizan/opl/CELLS/C3928", "south",
		"/players/mizan/opl/CELLS/C3809", "east",
		"/players/mizan/opl/CELLS/C3807", "west",
	});
