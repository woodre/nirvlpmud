...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4155", "north",
		"/players/mizan/opl/CELLS/C4395", "south",
		"/players/mizan/opl/CELLS/C4276", "east",
		"/players/mizan/opl/CELLS/C4274", "west",
	});
