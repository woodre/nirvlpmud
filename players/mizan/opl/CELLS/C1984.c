...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1864", "north",
		"/players/mizan/opl/CELLS/C2104", "south",
		"/players/mizan/opl/CELLS/C1985", "east",
		"/players/mizan/opl/CELLS/C1983", "west",
	});
