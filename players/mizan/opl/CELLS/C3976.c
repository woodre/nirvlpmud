...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3856", "north",
		"/players/mizan/opl/CELLS/C4096", "south",
		"/players/mizan/opl/CELLS/C3977", "east",
		"/players/mizan/opl/CELLS/C3975", "west",
	});
