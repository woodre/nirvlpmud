...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3928", "north",
		"/players/mizan/opl/CELLS/C4168", "south",
		"/players/mizan/opl/CELLS/C4049", "east",
		"/players/mizan/opl/CELLS/C4047", "west",
	});
...
long()
{
	...
	write("\"A little bit of rape is good for a man's soul.		-- Norman Mailer\"\n");
