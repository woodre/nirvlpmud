...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1139", "north",
		"/players/mizan/opl/CELLS/C1379", "south",
		"/players/mizan/opl/CELLS/C1260", "east",
		"/players/mizan/opl/CELLS/C1258", "west",
	});
...
long()
{
	...
	write("\"navel, n.:	A place to stash your gum on the way down.\"\n");
