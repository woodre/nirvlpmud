...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C874", "north",
		"/players/mizan/opl/CELLS/C1114", "south",
		"/players/mizan/opl/CELLS/C995", "east",
		"/players/mizan/opl/CELLS/C993", "west",
	});
