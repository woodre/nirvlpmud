...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1733", "north",
		"/players/mizan/opl/CELLS/C1973", "south",
		"/players/mizan/opl/CELLS/C1854", "east",
		"/players/mizan/opl/CELLS/C1852", "west",
	});
