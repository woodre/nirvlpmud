...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3801", "east",
		"/players/mizan/opl/CELLS/C3799", "west",
	});
...
long()
{
	...
	write("\"If they sent one man to the moon, why can't they send them all?\"\n");
