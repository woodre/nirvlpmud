...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5412", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C5532");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I5532");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I5532");
...
long()
{
	...
	write("\"Doin' it in the dark, down in Rock Creek Park.\"\n");
