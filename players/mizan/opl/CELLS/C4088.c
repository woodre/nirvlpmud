...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3968", "north",
		"/players/mizan/opl/CELLS/C4208", "south",
		"/players/mizan/opl/CELLS/C4089", "east",
		"/players/mizan/opl/CELLS/C4087", "west",
	});
