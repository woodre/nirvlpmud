...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4145", "north",
		"/players/mizan/opl/CELLS/C4385", "south",
		"/players/mizan/opl/CELLS/C4266", "east",
		"/players/mizan/opl/CELLS/C4264", "west",
	});
