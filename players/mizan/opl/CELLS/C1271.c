...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1151", "north",
		"/players/mizan/opl/CELLS/C1391", "south",
		"/players/mizan/opl/CELLS/C1272", "east",
		"/players/mizan/opl/CELLS/C1270", "west",
	});
