...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5707", "north",
		"/players/mizan/opl/CELLS/C5947", "south",
		"/players/mizan/opl/CELLS/C5828", "east",
		"/players/mizan/opl/CELLS/C5826", "west",
	});
