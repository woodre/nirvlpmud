...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4927", "north",
		"/players/mizan/opl/CELLS/C5167", "south",
		"/players/mizan/opl/CELLS/C5048", "east",
		"/players/mizan/opl/CELLS/C5046", "west",
	});
...
long()
{
	...
	write("\"Am I in GRADUATE SCHOOL yet?\"\n");
