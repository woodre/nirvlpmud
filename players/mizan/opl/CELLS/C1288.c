...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1168", "north",
		"/players/mizan/opl/CELLS/C1408", "south",
		"/players/mizan/opl/CELLS/C1289", "east",
		"/players/mizan/opl/CELLS/C1287", "west",
	});
