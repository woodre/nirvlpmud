...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4134", "north",
		"/players/mizan/opl/CELLS/C4374", "south",
		"/players/mizan/opl/CELLS/C4255", "east",
		"/players/mizan/opl/CELLS/C4253", "west",
	});
