...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3733", "north",
		"/players/mizan/opl/CELLS/C3973", "south",
		"/players/mizan/opl/CELLS/C3854", "east",
		"/players/mizan/opl/CELLS/C3852", "west",
	});
