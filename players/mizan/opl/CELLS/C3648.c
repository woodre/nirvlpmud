...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3528", "north",
		"/players/mizan/opl/CELLS/C3768", "south",
		"/players/mizan/opl/CELLS/C3649", "east",
		"/players/mizan/opl/CELLS/C3647", "west",
	});
