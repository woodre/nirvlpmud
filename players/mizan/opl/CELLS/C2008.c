...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1888", "north",
		"/players/mizan/opl/CELLS/C2128", "south",
		"/players/mizan/opl/CELLS/C2009", "east",
		"/players/mizan/opl/CELLS/C2007", "west",
	});
