...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C928", "north",
		"/players/mizan/opl/CELLS/C1168", "south",
		"/players/mizan/opl/CELLS/C1049", "east",
		"/players/mizan/opl/CELLS/C1047", "west",
	});
