...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3100", "north",
		"/players/mizan/opl/CELLS/C3340", "south",
		"/players/mizan/opl/CELLS/C3221", "east",
		"/players/mizan/opl/CELLS/C3219", "west",
	});
