...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2089", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C1969");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I1969");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I1969");
...
long()
{
	...
	write("\"There is no ox so dumb as the orthodox.		-- George Francis Gillette\"\n");
