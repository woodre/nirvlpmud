...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3644", "north",
		"/players/mizan/opl/CELLS/C3884", "south",
		"/players/mizan/opl/CELLS/C3765", "east",
		"/players/mizan/opl/CELLS/C3763", "west",
	});
