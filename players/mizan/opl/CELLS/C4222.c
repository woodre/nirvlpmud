...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4102", "north",
		"/players/mizan/opl/CELLS/C4342", "south",
		"/players/mizan/opl/CELLS/C4223", "east",
		"/players/mizan/opl/CELLS/C4221", "west",
	});
