...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1814", "north",
		"/players/mizan/opl/CELLS/C2054", "south",
		"/players/mizan/opl/CELLS/C1935", "east",
		"/players/mizan/opl/CELLS/C1933", "west",
	});
...
long()
{
	...
	write("\"The religion of one age is the literary entertainment of the next.\"\n");
