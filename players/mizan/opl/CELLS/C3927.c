...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3807", "north",
		"/players/mizan/opl/CELLS/C4047", "south",
		"/players/mizan/opl/CELLS/C3928", "east",
		"/players/mizan/opl/CELLS/C3926", "west",
	});
...
long()
{
	...
	write("\"Q:	What do you call a truck load of vibrators?A:	Toys for twats.\"\n");
