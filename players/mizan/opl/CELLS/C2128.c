...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2008", "north",
		"/players/mizan/opl/CELLS/C2248", "south",
		"/players/mizan/opl/CELLS/C2129", "east",
		"/players/mizan/opl/CELLS/C2127", "west",
	});
