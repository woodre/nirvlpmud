...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1631", "north",
		"/players/mizan/opl/CELLS/C1871", "south",
		"/players/mizan/opl/CELLS/C1752", "east",
		"/players/mizan/opl/CELLS/C1750", "west",
	});
