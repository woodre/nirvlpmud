...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5237", "north",
		"/players/mizan/opl/CELLS/C5477", "south",
		"/players/mizan/opl/CELLS/C5358", "east",
		"/players/mizan/opl/CELLS/C5356", "west",
	});
