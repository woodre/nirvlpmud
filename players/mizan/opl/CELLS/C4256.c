...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4136", "north",
		"/players/mizan/opl/CELLS/C4376", "south",
		"/players/mizan/opl/CELLS/C4257", "east",
		"/players/mizan/opl/CELLS/C4255", "west",
	});
