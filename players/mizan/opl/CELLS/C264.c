...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C265", "east",
		"/players/mizan/opl/CELLS/C263", "west",
	});
...
long()
{
	...
	write("\"Rugby is a game played by men with peculiarly shaped balls.\"\n");
