...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C933", "east",
		"/players/mizan/opl/CELLS/C931", "west",
	});
...
long()
{
	...
	write("\"It's a happy bishop who hasn't got a saint in his diocese.\"\n");
