...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5418", "north",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/rare/afei.c");
...
long()
{
	...
	write("\"I am a traffic light, and Alan Ginzberg kidnapped my laundry in 1927!\"\n");
