...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5599", "north",
		"/players/mizan/opl/CELLS/C5839", "south",
		"/players/mizan/opl/CELLS/C5720", "east",
		"/players/mizan/opl/CELLS/C5718", "west",
	});
