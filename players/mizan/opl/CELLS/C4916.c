...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4796", "north",
		"/players/mizan/opl/CELLS/C5036", "south",
		"/players/mizan/opl/CELLS/C4917", "east",
		"/players/mizan/opl/CELLS/C4915", "west",
	});
