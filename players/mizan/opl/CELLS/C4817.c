...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4697", "north",
		"/players/mizan/opl/CELLS/C4937", "south",
		"/players/mizan/opl/CELLS/C4818", "east",
		"/players/mizan/opl/CELLS/C4816", "west",
	});
