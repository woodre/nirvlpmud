...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1673", "north",
		"/players/mizan/opl/CELLS/C1913", "south",
		"/players/mizan/opl/CELLS/C1794", "east",
		"/players/mizan/opl/CELLS/C1792", "west",
	});
