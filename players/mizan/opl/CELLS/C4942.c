...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4822", "north",
		"/players/mizan/opl/CELLS/C5062", "south",
		"/players/mizan/opl/CELLS/C4943", "east",
		"/players/mizan/opl/CELLS/C4941", "west",
	});
