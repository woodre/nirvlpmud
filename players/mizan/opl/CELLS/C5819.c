...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5699", "north",
		"/players/mizan/opl/CELLS/C5939", "south",
		"/players/mizan/opl/CELLS/C5820", "east",
		"/players/mizan/opl/CELLS/C5818", "west",
	});
