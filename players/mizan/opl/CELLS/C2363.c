...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2243", "north",
		"/players/mizan/opl/CELLS/C2483", "south",
		"/players/mizan/opl/CELLS/C2364", "east",
		"/players/mizan/opl/CELLS/C2362", "west",
	});
