...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C460", "north",
		"/players/mizan/opl/CELLS/C700", "south",
		"/players/mizan/opl/CELLS/C581", "east",
		"/players/mizan/opl/CELLS/C579", "west",
	});
