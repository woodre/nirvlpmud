...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1452", "north",
		"/players/mizan/opl/CELLS/C1692", "south",
		"/players/mizan/opl/CELLS/C1573", "east",
		"/players/mizan/opl/CELLS/C1571", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/medium/sheep.c");
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/medium/knobgoblin-bully.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/medium/goblin.c");
...
long()
{
	...
	write("\"I once decorated my apartment entirely in ten foot salad forks!!\"\n");
