...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3193", "north",
		"/players/mizan/opl/CELLS/C3433", "south",
		"/players/mizan/opl/CELLS/C3312", "west",
	});
...
long()
{
	...
	write("\"QOTD:	'To hell with patience, I'm gonna kill me something!'\"\n");
