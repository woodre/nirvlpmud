...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3501", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3621");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3621");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3621");
...
long()
{
	...
	write("\"Christ:	A man who was born at least 5,000 years ahead of his time.\"\n");
