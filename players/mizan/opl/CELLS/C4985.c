...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4865", "north",
		"/players/mizan/opl/CELLS/C5105", "south",
		"/players/mizan/opl/CELLS/C4986", "east",
		"/players/mizan/opl/CELLS/C4984", "west",
	});
