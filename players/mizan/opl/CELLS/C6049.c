...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5929", "north",
		"/players/mizan/opl/CELLS/C6169", "south",
		"/players/mizan/opl/CELLS/C6050", "east",
		"/players/mizan/opl/CELLS/C6048", "west",
	});
