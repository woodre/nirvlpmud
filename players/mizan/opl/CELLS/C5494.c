...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5374", "north",
		"/players/mizan/opl/CELLS/C5614", "south",
		"/players/mizan/opl/CELLS/C5495", "east",
		"/players/mizan/opl/CELLS/C5493", "west",
	});
