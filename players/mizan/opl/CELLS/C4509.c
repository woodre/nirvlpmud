...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4389", "north",
		"/players/mizan/opl/CELLS/C4629", "south",
		"/players/mizan/opl/CELLS/C4510", "east",
		"/players/mizan/opl/CELLS/C4508", "west",
	});
