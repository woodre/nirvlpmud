...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6408", "north",
		"/players/mizan/opl/CELLS/C6648", "south",
		"/players/mizan/opl/CELLS/C6529", "east",
		"/players/mizan/opl/CELLS/C6527", "west",
	});
