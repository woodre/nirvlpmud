...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4023", "north",
		"/players/mizan/opl/CELLS/C4263", "south",
		"/players/mizan/opl/CELLS/C4144", "east",
		"/players/mizan/opl/CELLS/C4142", "west",
	});
