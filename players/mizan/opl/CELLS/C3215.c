...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3095", "north",
		"/players/mizan/opl/CELLS/C3335", "south",
	});
...
long()
{
	...
	write("\"ignoranus, n.:	A person who's both stupid and an asshole.\"\n");
