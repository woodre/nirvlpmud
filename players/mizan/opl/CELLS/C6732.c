...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6612", "north",
		"/players/mizan/opl/CELLS/C6852", "south",
		"/players/mizan/opl/CELLS/C6733", "east",
	});
...
long()
{
	...
	write("\"While not actually a sailor, I certainly enjoy getting blown ashore.\"\n");
