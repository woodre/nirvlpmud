...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C943", "north",
		"/players/mizan/opl/CELLS/C1183", "south",
		"/players/mizan/opl/CELLS/C1062", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/medium/soldier.c");
...
long()
{
	...
	write("\"Christianity: Safer than a lobotomy, but just as effective.\"\n");
