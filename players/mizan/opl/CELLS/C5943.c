...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5823", "north",
		"/players/mizan/opl/CELLS/C6063", "south",
		"/players/mizan/opl/CELLS/C5944", "east",
		"/players/mizan/opl/CELLS/C5942", "west",
	});
