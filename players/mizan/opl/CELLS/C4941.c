...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4821", "north",
		"/players/mizan/opl/CELLS/C5061", "south",
		"/players/mizan/opl/CELLS/C4942", "east",
		"/players/mizan/opl/CELLS/C4940", "west",
	});
