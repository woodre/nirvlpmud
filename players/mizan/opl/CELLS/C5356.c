...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5236", "north",
		"/players/mizan/opl/CELLS/C5476", "south",
		"/players/mizan/opl/CELLS/C5357", "east",
		"/players/mizan/opl/CELLS/C5355", "west",
	});
