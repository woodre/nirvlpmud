...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3730", "north",
		"/players/mizan/opl/CELLS/C3970", "south",
		"/players/mizan/opl/CELLS/C3851", "east",
		"/players/mizan/opl/CELLS/C3849", "west",
	});
