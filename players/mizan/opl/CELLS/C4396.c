...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4276", "north",
		"/players/mizan/opl/CELLS/C4516", "south",
		"/players/mizan/opl/CELLS/C4397", "east",
		"/players/mizan/opl/CELLS/C4395", "west",
	});
