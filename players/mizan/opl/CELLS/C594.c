...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C474", "north",
		"/players/mizan/opl/CELLS/C714", "south",
		"/players/mizan/opl/CELLS/C595", "east",
		"/players/mizan/opl/CELLS/C593", "west",
	});
