...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4388", "north",
		"/players/mizan/opl/CELLS/C4628", "south",
		"/players/mizan/opl/CELLS/C4509", "east",
		"/players/mizan/opl/CELLS/C4507", "west",
	});
