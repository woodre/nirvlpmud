...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4265", "north",
		"/players/mizan/opl/CELLS/C4505", "south",
		"/players/mizan/opl/CELLS/C4386", "east",
		"/players/mizan/opl/CELLS/C4384", "west",
	});
