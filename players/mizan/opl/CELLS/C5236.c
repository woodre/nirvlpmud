...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5116", "north",
		"/players/mizan/opl/CELLS/C5356", "south",
		"/players/mizan/opl/CELLS/C5237", "east",
		"/players/mizan/opl/CELLS/C5235", "west",
	});
