...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4094", "north",
		"/players/mizan/opl/CELLS/C4334", "south",
		"/players/mizan/opl/CELLS/C4215", "east",
		"/players/mizan/opl/CELLS/C4213", "west",
	});
