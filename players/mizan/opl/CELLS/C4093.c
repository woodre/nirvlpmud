...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3973", "north",
		"/players/mizan/opl/CELLS/C4213", "south",
		"/players/mizan/opl/CELLS/C4094", "east",
		"/players/mizan/opl/CELLS/C4092", "west",
	});
