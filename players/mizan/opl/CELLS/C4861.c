...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4741", "north",
		"/players/mizan/opl/CELLS/C4981", "south",
		"/players/mizan/opl/CELLS/C4862", "east",
		"/players/mizan/opl/CELLS/C4860", "west",
	});
