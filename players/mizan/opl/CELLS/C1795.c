...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1675", "north",
		"/players/mizan/opl/CELLS/C1915", "south",
		"/players/mizan/opl/CELLS/C1796", "east",
		"/players/mizan/opl/CELLS/C1794", "west",
	});
