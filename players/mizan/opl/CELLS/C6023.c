...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5903", "north",
		"/players/mizan/opl/CELLS/C6024", "east",
	});
...
long()
{
	...
	write("\"I'm pretending I'm pulling in a TROUT! Am I doing it correctly??\"\n");
