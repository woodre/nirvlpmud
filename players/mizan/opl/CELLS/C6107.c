...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5987", "north",
		"/players/mizan/opl/CELLS/C6227", "south",
		"/players/mizan/opl/CELLS/C6108", "east",
		"/players/mizan/opl/CELLS/C6106", "west",
	});
