...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2371", "north",
		"/players/mizan/opl/CELLS/C2611", "south",
		"/players/mizan/opl/CELLS/C2492", "east",
		"/players/mizan/opl/CELLS/C2490", "west",
	});
