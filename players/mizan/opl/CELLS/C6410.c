...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6290", "north",
		"/players/mizan/opl/CELLS/C6530", "south",
		"/players/mizan/opl/CELLS/C6411", "east",
		"/players/mizan/opl/CELLS/C6409", "west",
	});
