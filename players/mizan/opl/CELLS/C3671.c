...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3551", "north",
		"/players/mizan/opl/CELLS/C3791", "south",
		"/players/mizan/opl/CELLS/C3672", "east",
		"/players/mizan/opl/CELLS/C3670", "west",
	});
