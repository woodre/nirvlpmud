...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5473", "north",
		"/players/mizan/opl/CELLS/C5713", "south",
		"/players/mizan/opl/CELLS/C5594", "east",
		"/players/mizan/opl/CELLS/C5592", "west",
	});
