...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5704", "north",
		"/players/mizan/opl/CELLS/C5944", "south",
		"/players/mizan/opl/CELLS/C5825", "east",
		"/players/mizan/opl/CELLS/C5823", "west",
	});
