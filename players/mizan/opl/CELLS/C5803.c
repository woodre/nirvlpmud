...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5683", "north",
		"/players/mizan/opl/CELLS/C5923", "south",
		"/players/mizan/opl/CELLS/C5804", "east",
		"/players/mizan/opl/CELLS/C5802", "west",
	});
