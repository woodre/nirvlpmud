...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6106", "north",
		"/players/mizan/opl/CELLS/C6346", "south",
		"/players/mizan/opl/CELLS/C6227", "east",
		"/players/mizan/opl/CELLS/C6225", "west",
	});
