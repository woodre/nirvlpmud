...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6078", "north",
		"/players/mizan/opl/CELLS/C6318", "south",
		"/players/mizan/opl/CELLS/C6199", "east",
		"/players/mizan/opl/CELLS/C6197", "west",
	});
