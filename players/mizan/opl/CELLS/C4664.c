...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4784", "south",
		"/players/mizan/opl/CELLS/C4665", "east",
		"/players/mizan/opl/CELLS/C4663", "west",
	});
...
long()
{
	...
	write("\"Either CONFESS now or we go to 'PEOPLE'S COURT'!!\"\n");
