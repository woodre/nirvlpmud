...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4969", "north",
		"/players/mizan/opl/CELLS/C5209", "south",
		"/players/mizan/opl/CELLS/C5090", "east",
		"/players/mizan/opl/CELLS/C5088", "west",
	});
