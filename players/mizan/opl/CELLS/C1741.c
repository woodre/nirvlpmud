...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1621", "north",
		"/players/mizan/opl/CELLS/C1861", "south",
		"/players/mizan/opl/CELLS/C1742", "east",
		"/players/mizan/opl/CELLS/C1740", "west",
	});
