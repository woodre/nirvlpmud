...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6393", "east",
		"/players/mizan/opl/CELLS/C6391", "west",
	});
...
long()
{
	...
	write("\"Did you move a lot of KOREAN STEAK KNIVES this trip, Dingy?\"\n");
