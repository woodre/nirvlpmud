...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3293", "north",
		"/players/mizan/opl/CELLS/C3533", "south",
		"/players/mizan/opl/CELLS/C3414", "east",
		"/players/mizan/opl/CELLS/C3412", "west",
	});
