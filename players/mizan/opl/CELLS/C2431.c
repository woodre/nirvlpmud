...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2311", "north",
		"/players/mizan/opl/CELLS/C2551", "south",
		"/players/mizan/opl/CELLS/C2432", "east",
		"/players/mizan/opl/CELLS/C2430", "west",
	});
