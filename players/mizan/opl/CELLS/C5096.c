...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4976", "north",
		"/players/mizan/opl/CELLS/C5216", "south",
		"/players/mizan/opl/CELLS/C5097", "east",
		"/players/mizan/opl/CELLS/C5095", "west",
	});
