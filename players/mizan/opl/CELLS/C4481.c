...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4361", "north",
		"/players/mizan/opl/CELLS/C4601", "south",
		"/players/mizan/opl/CELLS/C4482", "east",
		"/players/mizan/opl/CELLS/C4480", "west",
	});
