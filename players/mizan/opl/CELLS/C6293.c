...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6173", "north",
		"/players/mizan/opl/CELLS/C6413", "south",
		"/players/mizan/opl/CELLS/C6294", "east",
		"/players/mizan/opl/CELLS/C6292", "west",
	});
