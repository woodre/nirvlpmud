...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3643", "north",
		"/players/mizan/opl/CELLS/C3883", "south",
		"/players/mizan/opl/CELLS/C3764", "east",
		"/players/mizan/opl/CELLS/C3762", "west",
	});
