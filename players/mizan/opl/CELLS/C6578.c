...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6458", "north",
		"/players/mizan/opl/CELLS/C6698", "south",
		"/players/mizan/opl/CELLS/C6579", "east",
		"/players/mizan/opl/CELLS/C6577", "west",
	});
