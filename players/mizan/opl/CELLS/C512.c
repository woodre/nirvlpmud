...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C392", "north",
		"/players/mizan/opl/CELLS/C511", "west",
	});
...
long()
{
	...
	write("\"Bankers do it with interest (penalty for early withdrawal).\"\n");
