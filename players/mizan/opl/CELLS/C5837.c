...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5717", "north",
		"/players/mizan/opl/CELLS/C5957", "south",
		"/players/mizan/opl/CELLS/C5838", "east",
		"/players/mizan/opl/CELLS/C5836", "west",
	});
