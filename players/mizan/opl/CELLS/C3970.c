...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3850", "north",
		"/players/mizan/opl/CELLS/C4090", "south",
		"/players/mizan/opl/CELLS/C3971", "east",
		"/players/mizan/opl/CELLS/C3969", "west",
	});
