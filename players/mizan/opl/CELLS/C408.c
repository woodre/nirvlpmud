...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C288", "north",
		"/players/mizan/opl/CELLS/C528", "south",
		"/players/mizan/opl/CELLS/C409", "east",
		"/players/mizan/opl/CELLS/C407", "west",
	});
...
long()
{
	...
	write("\"She's the kind of woman you could fall madly in bed with.\"\n");
