...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1729", "east",
		"/players/mizan/opl/CELLS/C1727", "west",
	});
...
long()
{
	...
	write("\"Love is eating her even when she's not having her period.\"\n");
