...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4640", "north",
		"/players/mizan/opl/CELLS/C4880", "south",
		"/players/mizan/opl/CELLS/C4761", "east",
		"/players/mizan/opl/CELLS/C4759", "west",
	});
