...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C757", "north",
		"/players/mizan/opl/CELLS/C997", "south",
		"/players/mizan/opl/CELLS/C878", "east",
		"/players/mizan/opl/CELLS/C876", "west",
	});
