...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C290", "south",
		"/players/mizan/opl/CELLS/C171", "east",
		"/players/mizan/opl/CELLS/C169", "west",
	});
...
long()
{
	...
	write("\"diaphragm, n:	A childproof cap.\"\n");
