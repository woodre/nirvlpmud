...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3950", "north",
		"/players/mizan/opl/CELLS/C4190", "south",
		"/players/mizan/opl/CELLS/C4071", "east",
		"/players/mizan/opl/CELLS/C4069", "west",
	});
...
long()
{
	...
	write("\"QOTD:	'I was a fifty-four-year-old virgin, but I'm all right now.'\"\n");
