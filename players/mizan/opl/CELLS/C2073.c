...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1953", "north",
		"/players/mizan/opl/CELLS/C2193", "south",
		"/players/mizan/opl/CELLS/C2074", "east",
		"/players/mizan/opl/CELLS/C2072", "west",
	});
