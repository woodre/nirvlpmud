...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5198", "north",
		"/players/mizan/opl/CELLS/C5438", "south",
		"/players/mizan/opl/CELLS/C5319", "east",
		"/players/mizan/opl/CELLS/C5317", "west",
	});
