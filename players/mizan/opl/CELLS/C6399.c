...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6279", "north",
		"/players/mizan/opl/CELLS/C6519", "south",
		"/players/mizan/opl/CELLS/C6400", "east",
		"/players/mizan/opl/CELLS/C6398", "west",
	});
