...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4375", "north",
		"/players/mizan/opl/CELLS/C4615", "south",
		"/players/mizan/opl/CELLS/C4496", "east",
		"/players/mizan/opl/CELLS/C4494", "west",
	});
