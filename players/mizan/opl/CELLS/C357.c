...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C237", "north",
		"/players/mizan/opl/CELLS/C477", "south",
		"/players/mizan/opl/CELLS/C358", "east",
		"/players/mizan/opl/CELLS/C356", "west",
	});
