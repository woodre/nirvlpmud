...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6080", "north",
		"/players/mizan/opl/CELLS/C6320", "south",
		"/players/mizan/opl/CELLS/C6201", "east",
		"/players/mizan/opl/CELLS/C6199", "west",
	});
