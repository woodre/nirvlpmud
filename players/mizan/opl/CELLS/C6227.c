...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6107", "north",
		"/players/mizan/opl/CELLS/C6347", "south",
		"/players/mizan/opl/CELLS/C6228", "east",
		"/players/mizan/opl/CELLS/C6226", "west",
	});
