...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5923", "north",
		"/players/mizan/opl/CELLS/C6163", "south",
		"/players/mizan/opl/CELLS/C6044", "east",
		"/players/mizan/opl/CELLS/C6042", "west",
	});
