...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4017", "north",
		"/players/mizan/opl/CELLS/C4257", "south",
		"/players/mizan/opl/CELLS/C4138", "east",
		"/players/mizan/opl/CELLS/C4136", "west",
	});
