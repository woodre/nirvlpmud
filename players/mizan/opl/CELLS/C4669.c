...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4789", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C4669");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I4669");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I4669");
...
long()
{
	...
	write("\"Eisenhower was very nice,Nixon was his only vice.		-- C. Degen\"\n");
