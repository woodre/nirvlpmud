...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1902", "north",
		"/players/mizan/opl/CELLS/C2142", "south",
		"/players/mizan/opl/CELLS/C2023", "east",
		"/players/mizan/opl/CELLS/C2021", "west",
	});
