...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5805", "north",
		"/players/mizan/opl/CELLS/C6045", "south",
		"/players/mizan/opl/CELLS/C5926", "east",
		"/players/mizan/opl/CELLS/C5924", "west",
	});
