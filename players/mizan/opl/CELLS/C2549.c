...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2429", "north",
		"/players/mizan/opl/CELLS/C2669", "south",
		"/players/mizan/opl/CELLS/C2550", "east",
		"/players/mizan/opl/CELLS/C2548", "west",
	});
