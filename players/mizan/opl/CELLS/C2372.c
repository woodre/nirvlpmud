...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2252", "north",
		"/players/mizan/opl/CELLS/C2492", "south",
		"/players/mizan/opl/CELLS/C2373", "east",
		"/players/mizan/opl/CELLS/C2371", "west",
	});
