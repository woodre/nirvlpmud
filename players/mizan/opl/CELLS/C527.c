...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C407", "north",
		"/players/mizan/opl/CELLS/C647", "south",
		"/players/mizan/opl/CELLS/C528", "east",
		"/players/mizan/opl/CELLS/C526", "west",
	});
...
long()
{
	...
	write("\"The good news is that the horse is dead, but your mother's pregnant.\"\n");
