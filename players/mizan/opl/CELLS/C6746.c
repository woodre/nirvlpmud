...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6626", "north",
		"/players/mizan/opl/CELLS/C6866", "south",
	});
...
long()
{
	...
	write("\"QOTD:	'He's so egotistical he yells his own name when he comes.'\"\n");
