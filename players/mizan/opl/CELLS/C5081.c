...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4961", "north",
		"/players/mizan/opl/CELLS/C5201", "south",
		"/players/mizan/opl/CELLS/C5082", "east",
		"/players/mizan/opl/CELLS/C5080", "west",
	});
