...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3901", "north",
		"/players/mizan/opl/CELLS/C4141", "south",
		"/players/mizan/opl/CELLS/C4022", "east",
		"/players/mizan/opl/CELLS/C4020", "west",
	});
