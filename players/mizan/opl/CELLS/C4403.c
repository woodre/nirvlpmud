...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4283", "north",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/rare/austrian_death_machine.c");
...
long()
{
	...
	write("\"It's easier to be a liberal a long way from home.		-- Don Price\"\n");
