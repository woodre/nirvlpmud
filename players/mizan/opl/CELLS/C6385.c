...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6265", "north",
		"/players/mizan/opl/CELLS/C6505", "south",
	});
...
long()
{
	...
	write("\"I have the power to HALT PRODUCTION on all TEENAGE SEX COMEDIES!!\"\n");
