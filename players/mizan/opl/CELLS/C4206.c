...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4086", "north",
		"/players/mizan/opl/CELLS/C4326", "south",
		"/players/mizan/opl/CELLS/C4207", "east",
		"/players/mizan/opl/CELLS/C4205", "west",
	});
