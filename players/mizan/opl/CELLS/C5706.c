...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5586", "north",
		"/players/mizan/opl/CELLS/C5826", "south",
		"/players/mizan/opl/CELLS/C5707", "east",
		"/players/mizan/opl/CELLS/C5705", "west",
	});
