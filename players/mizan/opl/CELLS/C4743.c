...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4623", "north",
		"/players/mizan/opl/CELLS/C4863", "south",
		"/players/mizan/opl/CELLS/C4744", "east",
		"/players/mizan/opl/CELLS/C4742", "west",
	});
