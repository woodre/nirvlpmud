...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4269", "north",
		"/players/mizan/opl/CELLS/C4509", "south",
		"/players/mizan/opl/CELLS/C4390", "east",
		"/players/mizan/opl/CELLS/C4388", "west",
	});
