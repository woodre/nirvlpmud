...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2551", "north",
		"/players/mizan/opl/CELLS/C2791", "south",
		"/players/mizan/opl/CELLS/C2672", "east",
		"/players/mizan/opl/CELLS/C2670", "west",
	});
