...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5862", "north",
		"/players/mizan/opl/CELLS/C6102", "south",
		"/players/mizan/opl/CELLS/C5983", "east",
		"/players/mizan/opl/CELLS/C5981", "west",
	});
