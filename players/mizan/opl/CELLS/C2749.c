...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2629", "north",
		"/players/mizan/opl/CELLS/C2869", "south",
		"/players/mizan/opl/CELLS/C2750", "east",
		"/players/mizan/opl/CELLS/C2748", "west",
	});
