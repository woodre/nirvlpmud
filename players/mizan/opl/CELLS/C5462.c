...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5342", "north",
		"/players/mizan/opl/CELLS/C5582", "south",
		"/players/mizan/opl/CELLS/C5463", "east",
		"/players/mizan/opl/CELLS/C5461", "west",
	});
