...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1967", "north",
		"/players/mizan/opl/CELLS/C2088", "east",
		"/players/mizan/opl/CELLS/C2086", "west",
	});
...
long()
{
	...
	write("\"'Eve was framed.' [Annie Laurie Gaylor]\"\n");
