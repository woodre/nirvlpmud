...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6132", "north",
		"/players/mizan/opl/CELLS/C6372", "south",
		"/players/mizan/opl/CELLS/C6253", "east",
	});
...
long()
{
	...
	write("\"... this must be what it's like to be a COLLEGE GRADUATE!!\"\n");
