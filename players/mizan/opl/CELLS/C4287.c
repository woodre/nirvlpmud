...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4167", "north",
		"/players/mizan/opl/CELLS/C4407", "south",
		"/players/mizan/opl/CELLS/C4288", "east",
		"/players/mizan/opl/CELLS/C4286", "west",
	});
