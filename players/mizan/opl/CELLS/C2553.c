...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2433", "north",
		"/players/mizan/opl/CELLS/C2673", "south",
		"/players/mizan/opl/CELLS/C2554", "east",
		"/players/mizan/opl/CELLS/C2552", "west",
	});
