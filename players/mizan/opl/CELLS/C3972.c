...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3852", "north",
		"/players/mizan/opl/CELLS/C4092", "south",
		"/players/mizan/opl/CELLS/C3973", "east",
		"/players/mizan/opl/CELLS/C3971", "west",
	});
