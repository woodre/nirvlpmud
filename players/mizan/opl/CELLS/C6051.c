...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5931", "north",
		"/players/mizan/opl/CELLS/C6171", "south",
		"/players/mizan/opl/CELLS/C6052", "east",
		"/players/mizan/opl/CELLS/C6050", "west",
	});
