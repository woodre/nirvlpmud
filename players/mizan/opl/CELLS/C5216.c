...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5096", "north",
		"/players/mizan/opl/CELLS/C5336", "south",
		"/players/mizan/opl/CELLS/C5217", "east",
		"/players/mizan/opl/CELLS/C5215", "west",
	});
