...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3831", "north",
		"/players/mizan/opl/CELLS/C4071", "south",
		"/players/mizan/opl/CELLS/C3952", "east",
		"/players/mizan/opl/CELLS/C3950", "west",
	});
