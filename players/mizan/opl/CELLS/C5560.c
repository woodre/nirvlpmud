...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5440", "north",
		"/players/mizan/opl/CELLS/C5680", "south",
		"/players/mizan/opl/CELLS/C5561", "east",
		"/players/mizan/opl/CELLS/C5559", "west",
	});
