...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C414", "north",
		"/players/mizan/opl/CELLS/C654", "south",
		"/players/mizan/opl/CELLS/C533", "west",
	});
...
long()
{
	...
	write("\"I didn't order any WOO-WOO ... Maybe a YUBBA ... But no WOO-WOO!\"\n");
