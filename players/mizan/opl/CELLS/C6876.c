...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6756", "north",
		"/players/mizan/opl/CELLS/C6996", "south",
		"/players/mizan/opl/CELLS/C6877", "east",
		"/players/mizan/opl/CELLS/C6875", "west",
	});
