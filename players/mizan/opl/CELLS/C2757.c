...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2758", "east",
		"/players/mizan/opl/CELLS/C2756", "west",
	});
...
long()
{
	...
	write("\"transvestite, n.:	Someone who likes to eat, drink, and be Mary.\"\n");
