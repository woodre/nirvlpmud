...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3758", "north",
		"/players/mizan/opl/CELLS/C3998", "south",
		"/players/mizan/opl/CELLS/C3879", "east",
		"/players/mizan/opl/CELLS/C3877", "west",
	});
