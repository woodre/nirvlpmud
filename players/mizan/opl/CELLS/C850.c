...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C730", "north",
		"/players/mizan/opl/CELLS/C970", "south",
		"/players/mizan/opl/CELLS/C851", "east",
		"/players/mizan/opl/CELLS/C849", "west",
	});
