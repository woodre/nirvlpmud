...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4793", "north",
		"/players/mizan/opl/CELLS/C5033", "south",
		"/players/mizan/opl/CELLS/C4914", "east",
		"/players/mizan/opl/CELLS/C4912", "west",
	});
