...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1164", "north",
		"/players/mizan/opl/CELLS/C1404", "south",
		"/players/mizan/opl/CELLS/C1285", "east",
		"/players/mizan/opl/CELLS/C1283", "west",
	});
