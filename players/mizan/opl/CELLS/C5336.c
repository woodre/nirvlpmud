...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5216", "north",
		"/players/mizan/opl/CELLS/C5456", "south",
		"/players/mizan/opl/CELLS/C5337", "east",
		"/players/mizan/opl/CELLS/C5335", "west",
	});
