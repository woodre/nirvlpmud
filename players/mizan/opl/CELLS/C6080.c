...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5960", "north",
		"/players/mizan/opl/CELLS/C6200", "south",
		"/players/mizan/opl/CELLS/C6081", "east",
		"/players/mizan/opl/CELLS/C6079", "west",
	});
