...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4020", "north",
		"/players/mizan/opl/CELLS/C4260", "south",
		"/players/mizan/opl/CELLS/C4141", "east",
		"/players/mizan/opl/CELLS/C4139", "west",
	});
