...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4856", "north",
		"/players/mizan/opl/CELLS/C5096", "south",
		"/players/mizan/opl/CELLS/C4977", "east",
		"/players/mizan/opl/CELLS/C4975", "west",
	});
