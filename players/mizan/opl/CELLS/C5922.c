...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5802", "north",
		"/players/mizan/opl/CELLS/C6042", "south",
		"/players/mizan/opl/CELLS/C5923", "east",
		"/players/mizan/opl/CELLS/C5921", "west",
	});
