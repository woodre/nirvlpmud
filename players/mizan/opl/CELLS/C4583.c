...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4463", "north",
		"/players/mizan/opl/CELLS/C4703", "south",
		"/players/mizan/opl/CELLS/C4584", "east",
		"/players/mizan/opl/CELLS/C4582", "west",
	});
