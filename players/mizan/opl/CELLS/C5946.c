...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5826", "north",
		"/players/mizan/opl/CELLS/C6066", "south",
		"/players/mizan/opl/CELLS/C5947", "east",
		"/players/mizan/opl/CELLS/C5945", "west",
	});
