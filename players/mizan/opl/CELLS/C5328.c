...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5208", "north",
		"/players/mizan/opl/CELLS/C5448", "south",
		"/players/mizan/opl/CELLS/C5329", "east",
		"/players/mizan/opl/CELLS/C5327", "west",
	});
