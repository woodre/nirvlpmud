...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2548", "north",
		"/players/mizan/opl/CELLS/C2788", "south",
		"/players/mizan/opl/CELLS/C2669", "east",
		"/players/mizan/opl/CELLS/C2667", "west",
	});
