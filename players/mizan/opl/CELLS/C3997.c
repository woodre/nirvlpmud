...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3877", "north",
		"/players/mizan/opl/CELLS/C4117", "south",
		"/players/mizan/opl/CELLS/C3998", "east",
		"/players/mizan/opl/CELLS/C3996", "west",
	});
