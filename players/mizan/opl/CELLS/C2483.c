...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2363", "north",
		"/players/mizan/opl/CELLS/C2603", "south",
		"/players/mizan/opl/CELLS/C2484", "east",
		"/players/mizan/opl/CELLS/C2482", "west",
	});
