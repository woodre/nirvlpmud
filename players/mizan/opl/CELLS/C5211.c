...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5091", "north",
		"/players/mizan/opl/CELLS/C5331", "south",
		"/players/mizan/opl/CELLS/C5212", "east",
		"/players/mizan/opl/CELLS/C5210", "west",
	});
