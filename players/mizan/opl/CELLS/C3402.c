...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3282", "north",
		"/players/mizan/opl/CELLS/C3522", "south",
		"/players/mizan/opl/CELLS/C3403", "east",
		"/players/mizan/opl/CELLS/C3401", "west",
	});
