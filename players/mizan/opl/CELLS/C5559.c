...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5439", "north",
		"/players/mizan/opl/CELLS/C5679", "south",
		"/players/mizan/opl/CELLS/C5560", "east",
		"/players/mizan/opl/CELLS/C5558", "west",
	});
