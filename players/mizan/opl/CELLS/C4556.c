...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4436", "north",
		"/players/mizan/opl/CELLS/C4676", "south",
		"/players/mizan/opl/CELLS/C4557", "east",
		"/players/mizan/opl/CELLS/C4555", "west",
	});
