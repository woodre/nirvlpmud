...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3567", "north",
		"/players/mizan/opl/CELLS/C3807", "south",
		"/players/mizan/opl/CELLS/C3688", "east",
		"/players/mizan/opl/CELLS/C3686", "west",
	});
...
long()
{
	...
	write("\"HUGH BEAUMONT died in 1982!!\"\n");
