...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4143", "north",
		"/players/mizan/opl/CELLS/C4383", "south",
		"/players/mizan/opl/CELLS/C4264", "east",
		"/players/mizan/opl/CELLS/C4262", "west",
	});
