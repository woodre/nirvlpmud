...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4019", "north",
		"/players/mizan/opl/CELLS/C4259", "south",
		"/players/mizan/opl/CELLS/C4140", "east",
		"/players/mizan/opl/CELLS/C4138", "west",
	});
