...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5915", "north",
		"/players/mizan/opl/CELLS/C6155", "south",
		"/players/mizan/opl/CELLS/C6036", "east",
		"/players/mizan/opl/CELLS/C6034", "west",
	});
