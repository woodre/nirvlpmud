...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1583", "north",
		"/players/mizan/opl/CELLS/C1823", "south",
		"/players/mizan/opl/CELLS/C1704", "east",
		"/players/mizan/opl/CELLS/C1702", "west",
	});
