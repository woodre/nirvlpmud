...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1863", "north",
		"/players/mizan/opl/CELLS/C2103", "south",
		"/players/mizan/opl/CELLS/C1984", "east",
		"/players/mizan/opl/CELLS/C1982", "west",
	});
