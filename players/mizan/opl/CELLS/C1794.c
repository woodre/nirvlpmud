...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1674", "north",
		"/players/mizan/opl/CELLS/C1914", "south",
		"/players/mizan/opl/CELLS/C1795", "east",
		"/players/mizan/opl/CELLS/C1793", "west",
	});
