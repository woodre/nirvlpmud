...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2328", "east",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/rare/phantom_shitter.c");
...
long()
{
	...
	write("\"If you think sex is a pain in the ass, try a different position.\"\n");
