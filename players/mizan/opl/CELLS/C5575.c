...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5455", "north",
		"/players/mizan/opl/CELLS/C5695", "south",
		"/players/mizan/opl/CELLS/C5576", "east",
		"/players/mizan/opl/CELLS/C5574", "west",
	});
