...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6284", "north",
		"/players/mizan/opl/CELLS/C6524", "south",
		"/players/mizan/opl/CELLS/C6405", "east",
		"/players/mizan/opl/CELLS/C6403", "west",
	});
