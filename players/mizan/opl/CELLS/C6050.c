...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5930", "north",
		"/players/mizan/opl/CELLS/C6170", "south",
		"/players/mizan/opl/CELLS/C6051", "east",
		"/players/mizan/opl/CELLS/C6049", "west",
	});
