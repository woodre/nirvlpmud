...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6281", "north",
		"/players/mizan/opl/CELLS/C6521", "south",
		"/players/mizan/opl/CELLS/C6402", "east",
		"/players/mizan/opl/CELLS/C6400", "west",
	});
