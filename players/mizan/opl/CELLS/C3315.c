...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3195", "north",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/easy/knobgoblin.c");
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3315");
		door1->set_type("mild-security");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3315");
		door2->set_type("mild-security");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3315");
...
long()
{
	...
	write("\"Is this an out-take from the 'BRADY BUNCH'?\"\n");
