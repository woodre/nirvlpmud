...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5338", "north",
		"/players/mizan/opl/CELLS/C5578", "south",
		"/players/mizan/opl/CELLS/C5459", "east",
		"/players/mizan/opl/CELLS/C5457", "west",
	});
