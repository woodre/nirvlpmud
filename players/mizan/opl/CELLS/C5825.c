...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5705", "north",
		"/players/mizan/opl/CELLS/C5945", "south",
		"/players/mizan/opl/CELLS/C5826", "east",
		"/players/mizan/opl/CELLS/C5824", "west",
	});
