...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3430", "north",
		"/players/mizan/opl/CELLS/C3670", "south",
		"/players/mizan/opl/CELLS/C3551", "east",
		"/players/mizan/opl/CELLS/C3549", "west",
	});
