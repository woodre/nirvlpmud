...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4479", "north",
		"/players/mizan/opl/CELLS/C4719", "south",
		"/players/mizan/opl/CELLS/C4600", "east",
		"/players/mizan/opl/CELLS/C4598", "west",
	});
