...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5134", "north",
		"/players/mizan/opl/CELLS/C5374", "south",
		"/players/mizan/opl/CELLS/C5255", "east",
		"/players/mizan/opl/CELLS/C5253", "west",
	});
