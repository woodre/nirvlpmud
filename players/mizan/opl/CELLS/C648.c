...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C528", "north",
		"/players/mizan/opl/CELLS/C649", "east",
		"/players/mizan/opl/CELLS/C647", "west",
	});
...
long()
{
	...
	write("\"pubic hair, n.:	Organic dental floss.\"\n");
