...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1575", "north",
		"/players/mizan/opl/CELLS/C1815", "south",
		"/players/mizan/opl/CELLS/C1696", "east",
		"/players/mizan/opl/CELLS/C1694", "west",
	});
...
long()
{
	...
	write("\"I left my WALLET in the BATHROOM!!\"\n");
