...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5700", "north",
		"/players/mizan/opl/CELLS/C5940", "south",
		"/players/mizan/opl/CELLS/C5821", "east",
		"/players/mizan/opl/CELLS/C5819", "west",
	});
