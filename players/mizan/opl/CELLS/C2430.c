...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2310", "north",
		"/players/mizan/opl/CELLS/C2550", "south",
		"/players/mizan/opl/CELLS/C2431", "east",
		"/players/mizan/opl/CELLS/C2429", "west",
	});
