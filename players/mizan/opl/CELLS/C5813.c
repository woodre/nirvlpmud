...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5693", "north",
		"/players/mizan/opl/CELLS/C5933", "south",
		"/players/mizan/opl/CELLS/C5814", "east",
		"/players/mizan/opl/CELLS/C5812", "west",
	});
