...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4849", "north",
		"/players/mizan/opl/CELLS/C5089", "south",
		"/players/mizan/opl/CELLS/C4970", "east",
		"/players/mizan/opl/CELLS/C4968", "west",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/sea/octopus.c");
