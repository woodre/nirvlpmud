...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C525", "north",
		"/players/mizan/opl/CELLS/C765", "south",
		"/players/mizan/opl/CELLS/C646", "east",
		"/players/mizan/opl/CELLS/C644", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/hard/weasel.c");
...
long()
{
	...
	write("\"Boys, you have ALL been selected to LEAVE th' PLANET in 15 minutes!!\"\n");
