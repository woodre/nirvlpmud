...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5373", "north",
		"/players/mizan/opl/CELLS/C5613", "south",
		"/players/mizan/opl/CELLS/C5494", "east",
		"/players/mizan/opl/CELLS/C5492", "west",
	});
