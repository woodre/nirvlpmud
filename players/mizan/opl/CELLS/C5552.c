...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5432", "north",
		"/players/mizan/opl/CELLS/C5551", "west",
	});
...
long()
{
	...
	write("\"Most women look for a man who is tall, dark and hung some.\"\n");
