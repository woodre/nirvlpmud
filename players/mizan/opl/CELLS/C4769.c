...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4649", "north",
		"/players/mizan/opl/CELLS/C4889", "south",
		"/players/mizan/opl/CELLS/C4770", "east",
		"/players/mizan/opl/CELLS/C4768", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/medium/knobgoblin-bully.c");
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/medium/soldier.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/medium/soldier.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/medium/lectroid.c");
...
long()
{
	...
	write("\"It's the sighs that count.\"\n");
