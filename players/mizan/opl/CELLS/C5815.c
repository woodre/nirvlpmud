...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5695", "north",
		"/players/mizan/opl/CELLS/C5935", "south",
		"/players/mizan/opl/CELLS/C5816", "east",
		"/players/mizan/opl/CELLS/C5814", "west",
	});
