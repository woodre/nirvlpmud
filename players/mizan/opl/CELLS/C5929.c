...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5809", "north",
		"/players/mizan/opl/CELLS/C6049", "south",
		"/players/mizan/opl/CELLS/C5930", "east",
		"/players/mizan/opl/CELLS/C5928", "west",
	});
