...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1793", "north",
		"/players/mizan/opl/CELLS/C2033", "south",
		"/players/mizan/opl/CELLS/C1914", "east",
		"/players/mizan/opl/CELLS/C1912", "west",
	});
