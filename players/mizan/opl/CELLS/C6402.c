...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6282", "north",
		"/players/mizan/opl/CELLS/C6522", "south",
		"/players/mizan/opl/CELLS/C6403", "east",
		"/players/mizan/opl/CELLS/C6401", "west",
	});
