...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4875", "north",
		"/players/mizan/opl/CELLS/C5115", "south",
		"/players/mizan/opl/CELLS/C4996", "east",
		"/players/mizan/opl/CELLS/C4994", "west",
	});
