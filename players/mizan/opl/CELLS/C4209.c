...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4089", "north",
		"/players/mizan/opl/CELLS/C4329", "south",
		"/players/mizan/opl/CELLS/C4210", "east",
		"/players/mizan/opl/CELLS/C4208", "west",
	});
