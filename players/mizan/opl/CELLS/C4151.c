...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4031", "north",
		"/players/mizan/opl/CELLS/C4271", "south",
		"/players/mizan/opl/CELLS/C4152", "east",
		"/players/mizan/opl/CELLS/C4150", "west",
	});
