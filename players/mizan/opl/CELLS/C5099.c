...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4979", "north",
		"/players/mizan/opl/CELLS/C5219", "south",
		"/players/mizan/opl/CELLS/C5100", "east",
		"/players/mizan/opl/CELLS/C5098", "west",
	});
