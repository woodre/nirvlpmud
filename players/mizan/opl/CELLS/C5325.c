...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5205", "north",
		"/players/mizan/opl/CELLS/C5445", "south",
		"/players/mizan/opl/CELLS/C5326", "east",
		"/players/mizan/opl/CELLS/C5324", "west",
	});
