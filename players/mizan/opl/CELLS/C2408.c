...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2407", "west",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C2408");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I2408");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I2408");
...
long()
{
	...
	write("\"He was not only a great swordsman, but also a cunning linguist.\"\n");
