...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6046", "north",
		"/players/mizan/opl/CELLS/C6286", "south",
		"/players/mizan/opl/CELLS/C6167", "east",
		"/players/mizan/opl/CELLS/C6165", "west",
	});
