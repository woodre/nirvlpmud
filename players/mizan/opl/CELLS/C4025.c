...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3905", "north",
		"/players/mizan/opl/CELLS/C4145", "south",
		"/players/mizan/opl/CELLS/C4026", "east",
		"/players/mizan/opl/CELLS/C4024", "west",
	});
