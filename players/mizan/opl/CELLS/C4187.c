...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4067", "north",
		"/players/mizan/opl/CELLS/C4307", "south",
		"/players/mizan/opl/CELLS/C4188", "east",
		"/players/mizan/opl/CELLS/C4186", "west",
	});
