...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5256", "north",
		"/players/mizan/opl/CELLS/C5496", "south",
		"/players/mizan/opl/CELLS/C5377", "east",
		"/players/mizan/opl/CELLS/C5375", "west",
	});
