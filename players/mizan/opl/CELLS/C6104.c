...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5984", "north",
		"/players/mizan/opl/CELLS/C6224", "south",
		"/players/mizan/opl/CELLS/C6105", "east",
		"/players/mizan/opl/CELLS/C6103", "west",
	});
