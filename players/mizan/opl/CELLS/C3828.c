...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3708", "north",
		"/players/mizan/opl/CELLS/C3948", "south",
		"/players/mizan/opl/CELLS/C3829", "east",
		"/players/mizan/opl/CELLS/C3827", "west",
	});
