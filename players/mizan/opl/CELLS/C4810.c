...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4811", "east",
		"/players/mizan/opl/CELLS/C4809", "west",
	});
...
long()
{
	...
	write("\"She was only a mortician's daughter but anyone cadaver.\"\n");
