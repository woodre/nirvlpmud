...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5706", "north",
		"/players/mizan/opl/CELLS/C5946", "south",
		"/players/mizan/opl/CELLS/C5827", "east",
		"/players/mizan/opl/CELLS/C5825", "west",
	});
