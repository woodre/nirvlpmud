...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4153", "north",
		"/players/mizan/opl/CELLS/C4393", "south",
		"/players/mizan/opl/CELLS/C4274", "east",
		"/players/mizan/opl/CELLS/C4272", "west",
	});
