...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2074", "north",
		"/players/mizan/opl/CELLS/C2314", "south",
		"/players/mizan/opl/CELLS/C2195", "east",
		"/players/mizan/opl/CELLS/C2193", "west",
	});
