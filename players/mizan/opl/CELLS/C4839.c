...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4719", "north",
		"/players/mizan/opl/CELLS/C4959", "south",
		"/players/mizan/opl/CELLS/C4840", "east",
		"/players/mizan/opl/CELLS/C4838", "west",
	});
