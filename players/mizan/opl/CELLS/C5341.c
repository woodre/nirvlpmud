...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5221", "north",
		"/players/mizan/opl/CELLS/C5461", "south",
		"/players/mizan/opl/CELLS/C5342", "east",
		"/players/mizan/opl/CELLS/C5340", "west",
	});
