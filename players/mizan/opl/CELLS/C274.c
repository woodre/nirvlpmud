...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C275", "east",
		"/players/mizan/opl/CELLS/C273", "west",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/medium/soldier.c");
...
long()
{
	...
	write("\"Nybble me... Byte me... Unsigned long int me...\"\n");
