...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C814", "north",
		"/players/mizan/opl/CELLS/C1054", "south",
		"/players/mizan/opl/CELLS/C933", "west",
	});
...
long()
{
	...
	write("\"hubub, hubub, HUBUB, hubub, hubub, hubub, HUBUB, hubub, hubub, hubub.\"\n");
