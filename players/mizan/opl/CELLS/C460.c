...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C340", "north",
		"/players/mizan/opl/CELLS/C580", "south",
		"/players/mizan/opl/CELLS/C461", "east",
		"/players/mizan/opl/CELLS/C459", "west",
	});
