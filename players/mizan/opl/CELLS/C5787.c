...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5788", "east",
		"/players/mizan/opl/CELLS/C5786", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/hard/fusion_octotron.c");
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/hard/ogress.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/soldierboss-blocker.c");
		move_object(mob3, this_object());
	}

	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/soldierboss-blocker.c");
...
long()
{
	...
	write("\"Confucious say:	boy who play with himself pulls boner.\"\n");
