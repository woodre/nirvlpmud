...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5234", "north",
		"/players/mizan/opl/CELLS/C5474", "south",
		"/players/mizan/opl/CELLS/C5355", "east",
		"/players/mizan/opl/CELLS/C5353", "west",
	});
