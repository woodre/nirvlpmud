...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1703", "north",
		"/players/mizan/opl/CELLS/C1943", "south",
		"/players/mizan/opl/CELLS/C1824", "east",
		"/players/mizan/opl/CELLS/C1822", "west",
	});
