...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4908", "south",
		"/players/mizan/opl/CELLS/C4789", "east",
		"/players/mizan/opl/CELLS/C4787", "west",
	});
...
long()
{
	...
	write("\"macho, adj.:	Jogging home from your vasectomy.\"\n");
