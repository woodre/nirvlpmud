...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6826", "west",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/environs/catapult.c");
		move_object(bonus, this_object());
		move_object(clone_object("/players/mizan/etheriel/items/shit.c"), this_object());
...
long()
{
	...
	write("\"The time has come for kicking ass and taking names.\"\n");
