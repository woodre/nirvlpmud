...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6459", "north",
		"/players/mizan/opl/CELLS/C6699", "south",
		"/players/mizan/opl/CELLS/C6580", "east",
		"/players/mizan/opl/CELLS/C6578", "west",
	});
