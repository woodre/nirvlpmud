...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5214", "north",
		"/players/mizan/opl/CELLS/C5454", "south",
		"/players/mizan/opl/CELLS/C5335", "east",
		"/players/mizan/opl/CELLS/C5333", "west",
	});
