...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6805", "north",
		"/players/mizan/opl/CELLS/C7045", "south",
		"/players/mizan/opl/CELLS/C6924", "west",
	});
...
long()
{
	...
	write("\"If I had a Q-TIP, I could prevent th' collapse of NEGOTIATIONS!!\"\n");
