...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5448", "north",
		"/players/mizan/opl/CELLS/C5688", "south",
		"/players/mizan/opl/CELLS/C5569", "east",
		"/players/mizan/opl/CELLS/C5567", "west",
	});
