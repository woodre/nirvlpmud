...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5985", "north",
		"/players/mizan/opl/CELLS/C6225", "south",
		"/players/mizan/opl/CELLS/C6106", "east",
		"/players/mizan/opl/CELLS/C6104", "west",
	});
