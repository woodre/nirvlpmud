...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2137", "north",
		"/players/mizan/opl/CELLS/C2258", "east",
	});
...
long()
{
	...
	write("\"An atheist is a man with no invisible means of support.\"\n");
