...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4666", "north",
		"/players/mizan/opl/CELLS/C4906", "south",
		"/players/mizan/opl/CELLS/C4787", "east",
		"/players/mizan/opl/CELLS/C4785", "west",
	});
