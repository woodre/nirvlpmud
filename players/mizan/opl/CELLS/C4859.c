...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4739", "north",
		"/players/mizan/opl/CELLS/C4979", "south",
		"/players/mizan/opl/CELLS/C4860", "east",
		"/players/mizan/opl/CELLS/C4858", "west",
	});
