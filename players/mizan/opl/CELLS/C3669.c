...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3549", "north",
		"/players/mizan/opl/CELLS/C3670", "east",
		"/players/mizan/opl/CELLS/C3668", "west",
	});
