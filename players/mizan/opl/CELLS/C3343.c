...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3223", "north",
		"/players/mizan/opl/CELLS/C3342", "west",
	});
...
long()
{
	...
	write("\"CHUBBY CHECKER just had a CHICKEN SANDWICH in downtown DULUTH!\"\n");
