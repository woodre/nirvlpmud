...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5959", "north",
		"/players/mizan/opl/CELLS/C6199", "south",
		"/players/mizan/opl/CELLS/C6080", "east",
		"/players/mizan/opl/CELLS/C6078", "west",
	});
