...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4247", "north",
		"/players/mizan/opl/CELLS/C4487", "south",
		"/players/mizan/opl/CELLS/C4368", "east",
		"/players/mizan/opl/CELLS/C4366", "west",
	});
