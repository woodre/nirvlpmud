...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5512", "north",
		"/players/mizan/opl/CELLS/C5752", "south",
		"/players/mizan/opl/CELLS/C5633", "east",
		"/players/mizan/opl/CELLS/C5631", "west",
	});
