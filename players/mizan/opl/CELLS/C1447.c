...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1327", "north",
		"/players/mizan/opl/CELLS/C1567", "south",
	});
...
long()
{
	...
	write("\"What did Mickey Mouse get for Christmas?A Dan Quayle watch.\"\n");
