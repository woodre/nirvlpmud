...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3952", "north",
		"/players/mizan/opl/CELLS/C4192", "south",
		"/players/mizan/opl/CELLS/C4073", "east",
		"/players/mizan/opl/CELLS/C4071", "west",
	});
