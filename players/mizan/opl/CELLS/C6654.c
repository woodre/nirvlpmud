...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6774", "south",
		"/players/mizan/opl/CELLS/C6655", "east",
	});
...
long()
{
	...
	write("\"There are a couple of things about her I greatly admire.\"\n");
