...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6493", "north",
		"/players/mizan/opl/CELLS/C6733", "south",
		"/players/mizan/opl/CELLS/C6612", "west",
	});
...
long()
{
	...
	write("\"Are you selling NYLON OIL WELLS?? If so, we can use TWO DOZEN!!\"\n");
