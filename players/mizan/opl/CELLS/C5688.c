...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5568", "north",
		"/players/mizan/opl/CELLS/C5808", "south",
		"/players/mizan/opl/CELLS/C5689", "east",
		"/players/mizan/opl/CELLS/C5687", "west",
	});
