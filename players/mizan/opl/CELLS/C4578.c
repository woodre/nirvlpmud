...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4458", "north",
		"/players/mizan/opl/CELLS/C4698", "south",
		"/players/mizan/opl/CELLS/C4579", "east",
		"/players/mizan/opl/CELLS/C4577", "west",
	});
