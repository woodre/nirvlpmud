...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3183", "north",
		"/players/mizan/opl/CELLS/C3423", "south",
	});
...
long()
{
	...
	write("\"We came, we saw, we kicked its ass!		-- Bill Murray, 'Ghostbusters'\"\n");
