...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5678", "north",
		"/players/mizan/opl/CELLS/C5918", "south",
		"/players/mizan/opl/CELLS/C5799", "east",
		"/players/mizan/opl/CELLS/C5797", "west",
	});
