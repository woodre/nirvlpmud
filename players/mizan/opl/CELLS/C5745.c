...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5625", "north",
		"/players/mizan/opl/CELLS/C5865", "south",
		"/players/mizan/opl/CELLS/C5746", "east",
		"/players/mizan/opl/CELLS/C5744", "west",
	});
