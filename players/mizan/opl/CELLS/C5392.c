...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5272", "north",
		"/players/mizan/opl/CELLS/C5512", "south",
		"/players/mizan/opl/CELLS/C5393", "east",
		"/players/mizan/opl/CELLS/C5391", "west",
	});
