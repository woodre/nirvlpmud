...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2943", "north",
		"/players/mizan/opl/CELLS/C3183", "south",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/hard/lectroid_boss.c");
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/hard/goldhard.c");
...
long()
{
	...
	write("\"Psychoanalysis?? I thought this was a nude rap session!!!\"\n");
