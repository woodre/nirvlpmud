...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6185", "north",
		"/players/mizan/opl/CELLS/C6425", "south",
		"/players/mizan/opl/CELLS/C6306", "east",
		"/players/mizan/opl/CELLS/C6304", "west",
	});
