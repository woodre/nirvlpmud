...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3222", "north",
		"/players/mizan/opl/CELLS/C3462", "south",
		"/players/mizan/opl/CELLS/C3343", "east",
		"/players/mizan/opl/CELLS/C3341", "west",
	});
...
long()
{
	...
	write("\"Chicago, n.:	Where the dead still vote ... early and often!\"\n");
