...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C607", "north",
		"/players/mizan/opl/CELLS/C847", "south",
		"/players/mizan/opl/CELLS/C728", "east",
		"/players/mizan/opl/CELLS/C726", "west",
	});
