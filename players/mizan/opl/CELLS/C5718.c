...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5598", "north",
		"/players/mizan/opl/CELLS/C5838", "south",
		"/players/mizan/opl/CELLS/C5719", "east",
		"/players/mizan/opl/CELLS/C5717", "west",
	});
