...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6226", "north",
		"/players/mizan/opl/CELLS/C6466", "south",
		"/players/mizan/opl/CELLS/C6347", "east",
		"/players/mizan/opl/CELLS/C6345", "west",
	});
