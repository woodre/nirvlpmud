...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4132", "north",
		"/players/mizan/opl/CELLS/C4372", "south",
		"/players/mizan/opl/CELLS/C4253", "east",
		"/players/mizan/opl/CELLS/C4251", "west",
	});
