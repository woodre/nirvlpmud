...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5360", "north",
		"/players/mizan/opl/CELLS/C5600", "south",
		"/players/mizan/opl/CELLS/C5481", "east",
		"/players/mizan/opl/CELLS/C5479", "west",
	});
