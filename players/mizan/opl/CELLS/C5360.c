...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5240", "north",
		"/players/mizan/opl/CELLS/C5480", "south",
		"/players/mizan/opl/CELLS/C5361", "east",
		"/players/mizan/opl/CELLS/C5359", "west",
	});
