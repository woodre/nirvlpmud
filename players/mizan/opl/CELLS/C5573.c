...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5453", "north",
		"/players/mizan/opl/CELLS/C5693", "south",
		"/players/mizan/opl/CELLS/C5574", "east",
		"/players/mizan/opl/CELLS/C5572", "west",
	});
