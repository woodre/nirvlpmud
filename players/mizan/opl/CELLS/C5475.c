...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5355", "north",
		"/players/mizan/opl/CELLS/C5595", "south",
		"/players/mizan/opl/CELLS/C5476", "east",
		"/players/mizan/opl/CELLS/C5474", "west",
	});
