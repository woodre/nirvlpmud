...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6263", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6262");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6262");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6262");
...
long()
{
	...
	write("\"It don't mean a THING if you ain't got that SWING!!\"\n");
