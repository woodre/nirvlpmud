...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3284", "north",
		"/players/mizan/opl/CELLS/C3524", "south",
		"/players/mizan/opl/CELLS/C3405", "east",
		"/players/mizan/opl/CELLS/C3403", "west",
	});
