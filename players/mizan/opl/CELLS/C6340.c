...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6220", "north",
		"/players/mizan/opl/CELLS/C6460", "south",
		"/players/mizan/opl/CELLS/C6341", "east",
		"/players/mizan/opl/CELLS/C6339", "west",
	});
