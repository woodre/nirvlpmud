...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4880", "north",
		"/players/mizan/opl/CELLS/C5120", "south",
		"/players/mizan/opl/CELLS/C5001", "east",
		"/players/mizan/opl/CELLS/C4999", "west",
	});
