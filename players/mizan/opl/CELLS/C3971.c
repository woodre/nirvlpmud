...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3851", "north",
		"/players/mizan/opl/CELLS/C4091", "south",
		"/players/mizan/opl/CELLS/C3972", "east",
		"/players/mizan/opl/CELLS/C3970", "west",
	});
