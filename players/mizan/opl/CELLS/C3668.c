...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3548", "north",
		"/players/mizan/opl/CELLS/C3669", "east",
		"/players/mizan/opl/CELLS/C3667", "west",
	});
...
long()
{
	...
	write("\"continental breakfast, n:	A roll in bed with some honey.\"\n");
