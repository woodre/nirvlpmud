...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6301", "north",
		"/players/mizan/opl/CELLS/C6541", "south",
		"/players/mizan/opl/CELLS/C6422", "east",
		"/players/mizan/opl/CELLS/C6420", "west",
	});
