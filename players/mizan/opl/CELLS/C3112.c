...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3232", "south",
		"/players/mizan/opl/CELLS/C3111", "west",
	});
...
long()
{
	...
	write("\"Were these parsnips CORRECTLY MARINATED in TACO SAUCE?\"\n");
