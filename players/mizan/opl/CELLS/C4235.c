...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4115", "north",
		"/players/mizan/opl/CELLS/C4355", "south",
		"/players/mizan/opl/CELLS/C4236", "east",
		"/players/mizan/opl/CELLS/C4234", "west",
	});
