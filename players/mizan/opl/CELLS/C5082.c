...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4962", "north",
		"/players/mizan/opl/CELLS/C5202", "south",
		"/players/mizan/opl/CELLS/C5083", "east",
		"/players/mizan/opl/CELLS/C5081", "west",
	});
