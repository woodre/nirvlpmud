...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C829", "north",
		"/players/mizan/opl/CELLS/C1069", "south",
		"/players/mizan/opl/CELLS/C950", "east",
		"/players/mizan/opl/CELLS/C948", "west",
	});
