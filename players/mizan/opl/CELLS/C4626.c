...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4506", "north",
		"/players/mizan/opl/CELLS/C4746", "south",
		"/players/mizan/opl/CELLS/C4627", "east",
		"/players/mizan/opl/CELLS/C4625", "west",
	});
