...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2362", "north",
		"/players/mizan/opl/CELLS/C2602", "south",
		"/players/mizan/opl/CELLS/C2483", "east",
		"/players/mizan/opl/CELLS/C2481", "west",
	});
