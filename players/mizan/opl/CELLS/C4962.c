...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4842", "north",
		"/players/mizan/opl/CELLS/C5082", "south",
		"/players/mizan/opl/CELLS/C4963", "east",
		"/players/mizan/opl/CELLS/C4961", "west",
	});
