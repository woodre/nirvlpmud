...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6304", "north",
		"/players/mizan/opl/CELLS/C6544", "south",
		"/players/mizan/opl/CELLS/C6425", "east",
		"/players/mizan/opl/CELLS/C6423", "west",
	});
