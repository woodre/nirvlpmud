...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4785", "north",
		"/players/mizan/opl/CELLS/C4906", "east",
		"/players/mizan/opl/CELLS/C4904", "west",
	});
...
long()
{
	...
	write("\"A midget had a date with a very tall girl. It was a quiff-hanger.\"\n");
