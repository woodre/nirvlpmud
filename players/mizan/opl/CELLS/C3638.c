...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3518", "north",
		"/players/mizan/opl/CELLS/C3758", "south",
		"/players/mizan/opl/CELLS/C3639", "east",
		"/players/mizan/opl/CELLS/C3637", "west",
	});
