...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5867", "north",
		"/players/mizan/opl/CELLS/C6107", "south",
		"/players/mizan/opl/CELLS/C5988", "east",
		"/players/mizan/opl/CELLS/C5986", "west",
	});
