...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2070", "north",
		"/players/mizan/opl/CELLS/C2310", "south",
		"/players/mizan/opl/CELLS/C2191", "east",
		"/players/mizan/opl/CELLS/C2189", "west",
	});
