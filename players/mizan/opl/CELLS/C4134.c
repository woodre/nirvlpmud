...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4014", "north",
		"/players/mizan/opl/CELLS/C4254", "south",
		"/players/mizan/opl/CELLS/C4135", "east",
		"/players/mizan/opl/CELLS/C4133", "west",
	});
