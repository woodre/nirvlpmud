...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6169", "north",
		"/players/mizan/opl/CELLS/C6409", "south",
		"/players/mizan/opl/CELLS/C6290", "east",
		"/players/mizan/opl/CELLS/C6288", "west",
	});
