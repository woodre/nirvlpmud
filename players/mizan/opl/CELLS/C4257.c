...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4137", "north",
		"/players/mizan/opl/CELLS/C4377", "south",
		"/players/mizan/opl/CELLS/C4258", "east",
		"/players/mizan/opl/CELLS/C4256", "west",
	});
