...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2244", "north",
		"/players/mizan/opl/CELLS/C2484", "south",
		"/players/mizan/opl/CELLS/C2365", "east",
		"/players/mizan/opl/CELLS/C2363", "west",
	});
