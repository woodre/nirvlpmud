...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4266", "north",
		"/players/mizan/opl/CELLS/C4506", "south",
		"/players/mizan/opl/CELLS/C4387", "east",
		"/players/mizan/opl/CELLS/C4385", "west",
	});
