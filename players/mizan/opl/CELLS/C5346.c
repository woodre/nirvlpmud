...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5226", "north",
		"/players/mizan/opl/CELLS/C5466", "south",
		"/players/mizan/opl/CELLS/C5347", "east",
		"/players/mizan/opl/CELLS/C5345", "west",
	});
