...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6302", "north",
		"/players/mizan/opl/CELLS/C6542", "south",
		"/players/mizan/opl/CELLS/C6423", "east",
		"/players/mizan/opl/CELLS/C6421", "west",
	});
