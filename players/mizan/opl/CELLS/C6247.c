...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6127", "north",
		"/players/mizan/opl/CELLS/C6367", "south",
		"/players/mizan/opl/CELLS/C6246", "west",
	});
