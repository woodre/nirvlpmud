...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C163", "north",
		"/players/mizan/opl/CELLS/C284", "east",
		"/players/mizan/opl/CELLS/C282", "west",
	});
...
long()
{
	...
	write("\"There are many ways to say 'I love you', but fucking is the fastest.\"\n");
