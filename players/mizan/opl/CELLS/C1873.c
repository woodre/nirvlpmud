...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1753", "north",
		"/players/mizan/opl/CELLS/C1993", "south",
		"/players/mizan/opl/CELLS/C1874", "east",
		"/players/mizan/opl/CELLS/C1872", "west",
	});
