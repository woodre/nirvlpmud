...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4453", "north",
		"/players/mizan/opl/CELLS/C4693", "south",
		"/players/mizan/opl/CELLS/C4574", "east",
		"/players/mizan/opl/CELLS/C4572", "west",
	});
