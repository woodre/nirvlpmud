...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2194", "north",
		"/players/mizan/opl/CELLS/C2434", "south",
		"/players/mizan/opl/CELLS/C2315", "east",
		"/players/mizan/opl/CELLS/C2313", "west",
	});
