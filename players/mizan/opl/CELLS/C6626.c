...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6506", "north",
		"/players/mizan/opl/CELLS/C6746", "south",
	});
...
long()
{
	...
	write("\"If I am elected no one will ever have to do their laundry again!\"\n");
