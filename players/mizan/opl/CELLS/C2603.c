...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2483", "north",
		"/players/mizan/opl/CELLS/C2723", "south",
		"/players/mizan/opl/CELLS/C2604", "east",
		"/players/mizan/opl/CELLS/C2602", "west",
	});
