...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6405", "north",
		"/players/mizan/opl/CELLS/C6645", "south",
		"/players/mizan/opl/CELLS/C6526", "east",
		"/players/mizan/opl/CELLS/C6524", "west",
	});
