...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3700", "east",
		"/players/mizan/opl/CELLS/C3698", "west",
	});
...
long()
{
	...
	write("\"Confucious say:	woman who bathe in vinegar have sour puss.\"\n");
