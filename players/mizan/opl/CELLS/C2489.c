...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2369", "north",
		"/players/mizan/opl/CELLS/C2609", "south",
		"/players/mizan/opl/CELLS/C2490", "east",
		"/players/mizan/opl/CELLS/C2488", "west",
	});
