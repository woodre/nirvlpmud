...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5317", "north",
		"/players/mizan/opl/CELLS/C5557", "south",
		"/players/mizan/opl/CELLS/C5438", "east",
		"/players/mizan/opl/CELLS/C5436", "west",
	});
