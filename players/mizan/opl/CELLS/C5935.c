...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5815", "north",
		"/players/mizan/opl/CELLS/C6055", "south",
		"/players/mizan/opl/CELLS/C5936", "east",
		"/players/mizan/opl/CELLS/C5934", "west",
	});
