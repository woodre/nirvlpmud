...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C947", "north",
		"/players/mizan/opl/CELLS/C1187", "south",
		"/players/mizan/opl/CELLS/C1068", "east",
		"/players/mizan/opl/CELLS/C1066", "west",
	});
