...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4980", "north",
		"/players/mizan/opl/CELLS/C5220", "south",
		"/players/mizan/opl/CELLS/C5101", "east",
		"/players/mizan/opl/CELLS/C5099", "west",
	});
