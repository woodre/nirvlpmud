...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4611", "north",
		"/players/mizan/opl/CELLS/C4851", "south",
		"/players/mizan/opl/CELLS/C4732", "east",
		"/players/mizan/opl/CELLS/C4730", "west",
	});
