...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6670", "north",
		"/players/mizan/opl/CELLS/C6791", "east",
	});
...
long()
{
	...
	write("\"Was my SOY LOAF left out in th'RAIN? It tastes REAL GOOD!!\"\n");
