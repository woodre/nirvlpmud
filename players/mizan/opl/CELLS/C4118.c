...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3998", "north",
		"/players/mizan/opl/CELLS/C4238", "south",
		"/players/mizan/opl/CELLS/C4119", "east",
		"/players/mizan/opl/CELLS/C4117", "west",
	});
