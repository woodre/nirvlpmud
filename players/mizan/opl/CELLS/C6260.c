...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6140", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6260");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6260");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6260");
...
long()
{
	...
	write("\"Yesterday is a memory,	Tomorrow is a vision,		Today is a bitch!\"\n");
