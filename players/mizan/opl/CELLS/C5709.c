...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5589", "north",
		"/players/mizan/opl/CELLS/C5829", "south",
		"/players/mizan/opl/CELLS/C5710", "east",
		"/players/mizan/opl/CELLS/C5708", "west",
	});
