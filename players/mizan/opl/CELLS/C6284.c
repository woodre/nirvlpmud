...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6164", "north",
		"/players/mizan/opl/CELLS/C6404", "south",
		"/players/mizan/opl/CELLS/C6285", "east",
		"/players/mizan/opl/CELLS/C6283", "west",
	});
