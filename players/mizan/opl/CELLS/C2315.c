...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2195", "north",
		"/players/mizan/opl/CELLS/C2435", "south",
		"/players/mizan/opl/CELLS/C2316", "east",
		"/players/mizan/opl/CELLS/C2314", "west",
	});
