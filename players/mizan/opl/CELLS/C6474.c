...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6354", "north",
		"/players/mizan/opl/CELLS/C6473", "west",
	});
...
long()
{
	...
	write("\"Religious reasons do not excuse violence: they accuse religion.\"\n");
