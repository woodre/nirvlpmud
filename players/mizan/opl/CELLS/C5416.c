...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5296", "north",
		"/players/mizan/opl/CELLS/C5536", "south",
		"/players/mizan/opl/CELLS/C5417", "east",
		"/players/mizan/opl/CELLS/C5415", "west",
	});
...
long()
{
	...
	write("\"clitoris, n:	A haired trigger.\"\n");
