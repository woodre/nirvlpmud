...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4392", "north",
		"/players/mizan/opl/CELLS/C4632", "south",
		"/players/mizan/opl/CELLS/C4513", "east",
		"/players/mizan/opl/CELLS/C4511", "west",
	});
