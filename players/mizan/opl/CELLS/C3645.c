...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3525", "north",
		"/players/mizan/opl/CELLS/C3765", "south",
		"/players/mizan/opl/CELLS/C3646", "east",
		"/players/mizan/opl/CELLS/C3644", "west",
	});
