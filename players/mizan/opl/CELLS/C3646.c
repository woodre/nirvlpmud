...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3526", "north",
		"/players/mizan/opl/CELLS/C3766", "south",
		"/players/mizan/opl/CELLS/C3647", "east",
		"/players/mizan/opl/CELLS/C3645", "west",
	});
