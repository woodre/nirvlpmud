...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3283", "north",
		"/players/mizan/opl/CELLS/C3523", "south",
		"/players/mizan/opl/CELLS/C3404", "east",
		"/players/mizan/opl/CELLS/C3402", "west",
	});
