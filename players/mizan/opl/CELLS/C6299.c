...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6179", "north",
		"/players/mizan/opl/CELLS/C6419", "south",
		"/players/mizan/opl/CELLS/C6300", "east",
		"/players/mizan/opl/CELLS/C6298", "west",
	});
