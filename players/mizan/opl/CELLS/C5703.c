...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5583", "north",
		"/players/mizan/opl/CELLS/C5823", "south",
		"/players/mizan/opl/CELLS/C5704", "east",
		"/players/mizan/opl/CELLS/C5702", "west",
	});
