...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1393", "north",
		"/players/mizan/opl/CELLS/C1633", "south",
		"/players/mizan/opl/CELLS/C1514", "east",
		"/players/mizan/opl/CELLS/C1512", "west",
	});
