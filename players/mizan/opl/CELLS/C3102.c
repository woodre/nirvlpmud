...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2982", "north",
		"/players/mizan/opl/CELLS/C3222", "south",
		"/players/mizan/opl/CELLS/C3103", "east",
		"/players/mizan/opl/CELLS/C3101", "west",
	});
