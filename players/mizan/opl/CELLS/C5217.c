...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5097", "north",
		"/players/mizan/opl/CELLS/C5337", "south",
		"/players/mizan/opl/CELLS/C5218", "east",
		"/players/mizan/opl/CELLS/C5216", "west",
	});
