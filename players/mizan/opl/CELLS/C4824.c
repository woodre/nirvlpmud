...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4704", "north",
		"/players/mizan/opl/CELLS/C4944", "south",
		"/players/mizan/opl/CELLS/C4825", "east",
		"/players/mizan/opl/CELLS/C4823", "west",
	});
