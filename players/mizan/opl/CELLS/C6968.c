...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6969", "east",
		"/players/mizan/opl/CELLS/C6967", "west",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/hard/postal_worker.c");
...
long()
{
	...
	write("\"If coke is a joke, I'm waiting around for the next line.\"\n");
