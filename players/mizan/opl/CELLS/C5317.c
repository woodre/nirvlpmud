...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5197", "north",
		"/players/mizan/opl/CELLS/C5437", "south",
		"/players/mizan/opl/CELLS/C5318", "east",
		"/players/mizan/opl/CELLS/C5316", "west",
	});
