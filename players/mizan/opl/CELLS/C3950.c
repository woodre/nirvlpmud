...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3830", "north",
		"/players/mizan/opl/CELLS/C4070", "south",
		"/players/mizan/opl/CELLS/C3951", "east",
		"/players/mizan/opl/CELLS/C3949", "west",
	});
