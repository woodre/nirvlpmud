...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2432", "north",
		"/players/mizan/opl/CELLS/C2672", "south",
		"/players/mizan/opl/CELLS/C2553", "east",
		"/players/mizan/opl/CELLS/C2551", "west",
	});
