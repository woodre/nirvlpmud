...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2979", "north",
		"/players/mizan/opl/CELLS/C3219", "south",
		"/players/mizan/opl/CELLS/C3100", "east",
	});
...
long()
{
	...
	write("\"Call for Ms. Lingus, Ms. Connie Lingus...\"\n");
