...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6268", "north",
		"/players/mizan/opl/CELLS/C6508", "south",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/narci.c");
...
long()
{
	...
	write("\"Law of the Yukon:	Only the lead dog gets a change of scenery.\"\n");
