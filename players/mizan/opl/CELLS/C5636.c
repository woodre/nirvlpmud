...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5516", "north",
		"/players/mizan/opl/CELLS/C5637", "east",
		"/players/mizan/opl/CELLS/C5635", "west",
	});
...
long()
{
	...
	write("\"Lisp programmers do it deeper and deeper and deeper.\"\n");
