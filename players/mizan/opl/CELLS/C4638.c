...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4518", "north",
		"/players/mizan/opl/CELLS/C4758", "south",
		"/players/mizan/opl/CELLS/C4639", "east",
		"/players/mizan/opl/CELLS/C4637", "west",
	});
