...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5836", "north",
		"/players/mizan/opl/CELLS/C6076", "south",
		"/players/mizan/opl/CELLS/C5957", "east",
		"/players/mizan/opl/CELLS/C5955", "west",
	});
