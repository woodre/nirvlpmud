...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1922", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C1921");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I1921");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I1921");
...
long()
{
	...
	write("\"Do infants have as much fun in infancy as adults do in adultery?\"\n");
