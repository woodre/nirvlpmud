...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6402", "north",
		"/players/mizan/opl/CELLS/C6642", "south",
		"/players/mizan/opl/CELLS/C6523", "east",
		"/players/mizan/opl/CELLS/C6521", "west",
	});
