...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4702", "north",
		"/players/mizan/opl/CELLS/C4942", "south",
		"/players/mizan/opl/CELLS/C4823", "east",
		"/players/mizan/opl/CELLS/C4821", "west",
	});
