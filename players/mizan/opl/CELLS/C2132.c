...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2012", "north",
		"/players/mizan/opl/CELLS/C2252", "south",
		"/players/mizan/opl/CELLS/C2133", "east",
		"/players/mizan/opl/CELLS/C2131", "west",
	});
