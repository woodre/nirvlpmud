...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2309", "north",
		"/players/mizan/opl/CELLS/C2549", "south",
		"/players/mizan/opl/CELLS/C2430", "east",
		"/players/mizan/opl/CELLS/C2428", "west",
	});
