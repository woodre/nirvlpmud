...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C850", "north",
		"/players/mizan/opl/CELLS/C1090", "south",
		"/players/mizan/opl/CELLS/C971", "east",
		"/players/mizan/opl/CELLS/C969", "west",
	});
