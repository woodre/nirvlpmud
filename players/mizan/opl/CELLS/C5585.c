...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5465", "north",
		"/players/mizan/opl/CELLS/C5705", "south",
		"/players/mizan/opl/CELLS/C5586", "east",
		"/players/mizan/opl/CELLS/C5584", "west",
	});
