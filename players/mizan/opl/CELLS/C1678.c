...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1558", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C1678");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I1678");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I1678");
...
long()
{
	...
	write("\"It's the RINSE CYCLE!! They've ALL IGNORED the RINSE CYCLE!!\"\n");
