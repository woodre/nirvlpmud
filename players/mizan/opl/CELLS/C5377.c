...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5257", "north",
		"/players/mizan/opl/CELLS/C5497", "south",
		"/players/mizan/opl/CELLS/C5378", "east",
		"/players/mizan/opl/CELLS/C5376", "west",
	});
