...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1499", "north",
		"/players/mizan/opl/CELLS/C1739", "south",
		"/players/mizan/opl/CELLS/C1620", "east",
		"/players/mizan/opl/CELLS/C1618", "west",
	});
