...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4275", "north",
		"/players/mizan/opl/CELLS/C4515", "south",
		"/players/mizan/opl/CELLS/C4396", "east",
		"/players/mizan/opl/CELLS/C4394", "west",
	});
