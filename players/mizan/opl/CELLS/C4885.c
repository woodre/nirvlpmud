...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4765", "north",
		"/players/mizan/opl/CELLS/C5005", "south",
		"/players/mizan/opl/CELLS/C4886", "east",
		"/players/mizan/opl/CELLS/C4884", "west",
	});
