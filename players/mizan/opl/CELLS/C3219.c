...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3099", "north",
		"/players/mizan/opl/CELLS/C3339", "south",
		"/players/mizan/opl/CELLS/C3220", "east",
	});
...
long()
{
	...
	write("\"Jesus is my POSTMASTER GENERAL ...\"\n");
