...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6228", "north",
		"/players/mizan/opl/CELLS/C6468", "south",
		"/players/mizan/opl/CELLS/C6349", "east",
		"/players/mizan/opl/CELLS/C6347", "west",
	});
