...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1475", "north",
		"/players/mizan/opl/CELLS/C1715", "south",
		"/players/mizan/opl/CELLS/C1596", "east",
		"/players/mizan/opl/CELLS/C1594", "west",
	});
