...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5587", "north",
		"/players/mizan/opl/CELLS/C5827", "south",
		"/players/mizan/opl/CELLS/C5708", "east",
		"/players/mizan/opl/CELLS/C5706", "west",
	});
