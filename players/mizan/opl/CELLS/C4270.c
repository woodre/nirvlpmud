...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4150", "north",
		"/players/mizan/opl/CELLS/C4390", "south",
		"/players/mizan/opl/CELLS/C4271", "east",
		"/players/mizan/opl/CELLS/C4269", "west",
	});
