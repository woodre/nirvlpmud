...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5469", "north",
		"/players/mizan/opl/CELLS/C5709", "south",
		"/players/mizan/opl/CELLS/C5590", "east",
		"/players/mizan/opl/CELLS/C5588", "west",
	});
