...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5486", "north",
		"/players/mizan/opl/CELLS/C5726", "south",
		"/players/mizan/opl/CELLS/C5607", "east",
		"/players/mizan/opl/CELLS/C5605", "west",
	});
