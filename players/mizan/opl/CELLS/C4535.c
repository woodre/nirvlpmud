...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4415", "north",
		"/players/mizan/opl/CELLS/C4655", "south",
		"/players/mizan/opl/CELLS/C4536", "east",
		"/players/mizan/opl/CELLS/C4534", "west",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/hard/domokun.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/powerpig.c");
...
long()
{
	...
	write("\"Sometime in 1993 NANCY SINATRA will lead a BLOODLESS COUP on GUAM!!\"\n");
