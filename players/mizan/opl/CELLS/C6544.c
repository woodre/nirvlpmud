...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6424", "north",
		"/players/mizan/opl/CELLS/C6664", "south",
		"/players/mizan/opl/CELLS/C6545", "east",
		"/players/mizan/opl/CELLS/C6543", "west",
	});
