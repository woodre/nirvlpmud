...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C476", "north",
		"/players/mizan/opl/CELLS/C716", "south",
		"/players/mizan/opl/CELLS/C597", "east",
		"/players/mizan/opl/CELLS/C595", "west",
	});
