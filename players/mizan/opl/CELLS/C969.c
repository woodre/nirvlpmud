...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C849", "north",
		"/players/mizan/opl/CELLS/C1089", "south",
		"/players/mizan/opl/CELLS/C970", "east",
		"/players/mizan/opl/CELLS/C968", "west",
	});
