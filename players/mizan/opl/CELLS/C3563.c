...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3683", "south",
		"/players/mizan/opl/CELLS/C3564", "east",
		"/players/mizan/opl/CELLS/C3562", "west",
	});
...
long()
{
	...
	write("\"Ignorance is the Mother of Devotion.		-- Robert Burton\"\n");
