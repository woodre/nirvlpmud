...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6372", "north",
		"/players/mizan/opl/CELLS/C6612", "south",
		"/players/mizan/opl/CELLS/C6493", "east",
		"/players/mizan/opl/CELLS/C6491", "west",
	});
...
long()
{
	...
	write("\"This is a NO-FRILLS flight -- hold th' CANADIAN BACON!!\"\n");
