...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2126", "north",
		"/players/mizan/opl/CELLS/C2366", "south",
		"/players/mizan/opl/CELLS/C2247", "east",
		"/players/mizan/opl/CELLS/C2245", "west",
	});
