...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C121", "north",
		"/players/mizan/opl/CELLS/C361", "south",
	});
...
long()
{
	...
	write("\"Overheard:	'How do I feel? Great! And I kiss pretty good, too!'\"\n");
