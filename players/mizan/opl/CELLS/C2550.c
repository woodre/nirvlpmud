...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2430", "north",
		"/players/mizan/opl/CELLS/C2670", "south",
		"/players/mizan/opl/CELLS/C2551", "east",
		"/players/mizan/opl/CELLS/C2549", "west",
	});
