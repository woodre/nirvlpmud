...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1645", "north",
		"/players/mizan/opl/CELLS/C1885", "south",
		"/players/mizan/opl/CELLS/C1766", "east",
		"/players/mizan/opl/CELLS/C1764", "west",
	});
