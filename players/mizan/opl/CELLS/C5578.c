...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5458", "north",
		"/players/mizan/opl/CELLS/C5698", "south",
		"/players/mizan/opl/CELLS/C5579", "east",
		"/players/mizan/opl/CELLS/C5577", "west",
	});
