...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3287", "north",
		"/players/mizan/opl/CELLS/C3527", "south",
		"/players/mizan/opl/CELLS/C3408", "east",
		"/players/mizan/opl/CELLS/C3406", "west",
	});
