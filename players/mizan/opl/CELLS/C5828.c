...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5708", "north",
		"/players/mizan/opl/CELLS/C5948", "south",
		"/players/mizan/opl/CELLS/C5829", "east",
		"/players/mizan/opl/CELLS/C5827", "west",
	});
