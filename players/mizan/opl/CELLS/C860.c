...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C740", "north",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/easy/gummybear.c");
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/rare/barney.c");
