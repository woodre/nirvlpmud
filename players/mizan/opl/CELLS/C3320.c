...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3440", "south",
		"/players/mizan/opl/CELLS/C3321", "east",
		"/players/mizan/opl/CELLS/C3319", "west",
	});
...
long()
{
	...
	write("\"I hope I bought the right relish ... zzzzzzzzz ...\"\n");
