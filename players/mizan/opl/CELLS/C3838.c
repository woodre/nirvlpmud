...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3958", "south",
		"/players/mizan/opl/CELLS/C3837", "west",
	});
...
long()
{
	...
	write("\"If girls are all sugar and spice, why do they taste like anchovies?\"\n");
