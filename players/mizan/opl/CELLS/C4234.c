...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4114", "north",
		"/players/mizan/opl/CELLS/C4354", "south",
		"/players/mizan/opl/CELLS/C4235", "east",
		"/players/mizan/opl/CELLS/C4233", "west",
	});
