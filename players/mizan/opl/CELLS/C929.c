...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C809", "north",
		"/players/mizan/opl/CELLS/C1049", "south",
		"/players/mizan/opl/CELLS/C930", "east",
		"/players/mizan/opl/CELLS/C928", "west",
	});
