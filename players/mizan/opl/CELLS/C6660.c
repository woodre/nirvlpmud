...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6540", "north",
		"/players/mizan/opl/CELLS/C6780", "south",
		"/players/mizan/opl/CELLS/C6661", "east",
		"/players/mizan/opl/CELLS/C6659", "west",
	});
