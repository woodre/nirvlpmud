...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4525", "north",
		"/players/mizan/opl/CELLS/C4765", "south",
		"/players/mizan/opl/CELLS/C4646", "east",
		"/players/mizan/opl/CELLS/C4644", "west",
	});
...
long()
{
	...
	write("\"Please do not look directly into laser with remaining eye.\"\n");
