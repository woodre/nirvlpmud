...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3999", "north",
		"/players/mizan/opl/CELLS/C4239", "south",
		"/players/mizan/opl/CELLS/C4120", "east",
		"/players/mizan/opl/CELLS/C4118", "west",
	});
