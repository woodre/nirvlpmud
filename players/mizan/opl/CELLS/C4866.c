...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4746", "north",
		"/players/mizan/opl/CELLS/C4986", "south",
		"/players/mizan/opl/CELLS/C4867", "east",
		"/players/mizan/opl/CELLS/C4865", "west",
	});
