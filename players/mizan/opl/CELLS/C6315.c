...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6195", "north",
		"/players/mizan/opl/CELLS/C6435", "south",
		"/players/mizan/opl/CELLS/C6316", "east",
		"/players/mizan/opl/CELLS/C6314", "west",
	});
