...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4455", "north",
		"/players/mizan/opl/CELLS/C4695", "south",
		"/players/mizan/opl/CELLS/C4576", "east",
		"/players/mizan/opl/CELLS/C4574", "west",
	});
