...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3859", "north",
		"/players/mizan/opl/CELLS/C4099", "south",
		"/players/mizan/opl/CELLS/C3980", "east",
		"/players/mizan/opl/CELLS/C3978", "west",
	});
