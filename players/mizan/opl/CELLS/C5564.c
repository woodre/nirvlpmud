...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5444", "north",
		"/players/mizan/opl/CELLS/C5684", "south",
		"/players/mizan/opl/CELLS/C5565", "east",
		"/players/mizan/opl/CELLS/C5563", "west",
	});
