...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6685", "north",
		"/players/mizan/opl/CELLS/C6925", "south",
	});
...
long()
{
	...
	write("\"FOR SALE:	Parachute. Used once. Never opened. Slightly Stained.\"\n");
