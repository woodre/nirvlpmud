...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C930", "north",
		"/players/mizan/opl/CELLS/C1170", "south",
		"/players/mizan/opl/CELLS/C1051", "east",
		"/players/mizan/opl/CELLS/C1049", "west",
	});
