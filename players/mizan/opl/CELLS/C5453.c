...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5333", "north",
		"/players/mizan/opl/CELLS/C5573", "south",
		"/players/mizan/opl/CELLS/C5454", "east",
		"/players/mizan/opl/CELLS/C5452", "west",
	});
