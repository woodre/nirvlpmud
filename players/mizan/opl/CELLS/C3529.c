...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3409", "north",
		"/players/mizan/opl/CELLS/C3649", "south",
		"/players/mizan/opl/CELLS/C3530", "east",
		"/players/mizan/opl/CELLS/C3528", "west",
	});
