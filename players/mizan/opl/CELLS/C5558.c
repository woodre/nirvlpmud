...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5438", "north",
		"/players/mizan/opl/CELLS/C5678", "south",
		"/players/mizan/opl/CELLS/C5559", "east",
		"/players/mizan/opl/CELLS/C5557", "west",
	});
