...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5819", "north",
		"/players/mizan/opl/CELLS/C6059", "south",
		"/players/mizan/opl/CELLS/C5940", "east",
		"/players/mizan/opl/CELLS/C5938", "west",
	});
