...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3975", "north",
		"/players/mizan/opl/CELLS/C4215", "south",
		"/players/mizan/opl/CELLS/C4096", "east",
		"/players/mizan/opl/CELLS/C4094", "west",
	});
