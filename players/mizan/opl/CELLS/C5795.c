...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5675", "north",
		"/players/mizan/opl/CELLS/C5915", "south",
		"/players/mizan/opl/CELLS/C5796", "east",
		"/players/mizan/opl/CELLS/C5794", "west",
	});
