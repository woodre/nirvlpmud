...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2829", "north",
		"/players/mizan/opl/CELLS/C3069", "south",
		"/players/mizan/opl/CELLS/C2950", "east",
	});
