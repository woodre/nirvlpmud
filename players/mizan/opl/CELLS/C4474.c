...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4354", "north",
		"/players/mizan/opl/CELLS/C4594", "south",
		"/players/mizan/opl/CELLS/C4475", "east",
		"/players/mizan/opl/CELLS/C4473", "west",
	});
