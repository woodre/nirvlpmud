...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5078", "north",
		"/players/mizan/opl/CELLS/C5318", "south",
		"/players/mizan/opl/CELLS/C5199", "east",
		"/players/mizan/opl/CELLS/C5197", "west",
	});
