...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3710", "north",
		"/players/mizan/opl/CELLS/C3950", "south",
		"/players/mizan/opl/CELLS/C3831", "east",
		"/players/mizan/opl/CELLS/C3829", "west",
	});
