...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1477", "north",
		"/players/mizan/opl/CELLS/C1717", "south",
		"/players/mizan/opl/CELLS/C1598", "east",
		"/players/mizan/opl/CELLS/C1596", "west",
	});
