...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4584", "north",
		"/players/mizan/opl/CELLS/C4824", "south",
		"/players/mizan/opl/CELLS/C4705", "east",
		"/players/mizan/opl/CELLS/C4703", "west",
	});
