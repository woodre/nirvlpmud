...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3618", "north",
		"/players/mizan/opl/CELLS/C3858", "south",
		"/players/mizan/opl/CELLS/C3739", "east",
		"/players/mizan/opl/CELLS/C3737", "west",
	});
