...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4011", "north",
		"/players/mizan/opl/CELLS/C4251", "south",
		"/players/mizan/opl/CELLS/C4132", "east",
		"/players/mizan/opl/CELLS/C4130", "west",
	});
