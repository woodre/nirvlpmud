...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4253", "north",
		"/players/mizan/opl/CELLS/C4493", "south",
		"/players/mizan/opl/CELLS/C4374", "east",
		"/players/mizan/opl/CELLS/C4372", "west",
	});
