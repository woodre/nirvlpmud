...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4975", "north",
		"/players/mizan/opl/CELLS/C5215", "south",
		"/players/mizan/opl/CELLS/C5096", "east",
		"/players/mizan/opl/CELLS/C5094", "west",
	});
