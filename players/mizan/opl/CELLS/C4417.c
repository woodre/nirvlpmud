...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4297", "north",
		"/players/mizan/opl/CELLS/C4537", "south",
		"/players/mizan/opl/CELLS/C4418", "east",
		"/players/mizan/opl/CELLS/C4416", "west",
	});
