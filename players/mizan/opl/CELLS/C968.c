...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C848", "north",
		"/players/mizan/opl/CELLS/C1088", "south",
		"/players/mizan/opl/CELLS/C969", "east",
		"/players/mizan/opl/CELLS/C967", "west",
	});
