...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1386", "east",
		"/players/mizan/opl/CELLS/C1384", "west",
	});
...
long()
{
	...
	write("\"Justice is incidental to law and order.		-- J. Edgar Hoover\"\n");
