...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6933", "south",
		"/players/mizan/opl/CELLS/C6814", "east",
		"/players/mizan/opl/CELLS/C6812", "west",
	});
...
long()
{
	...
	write("\"Dance is the vertical expression of a horizontal intention.\"\n");
