...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5581", "north",
		"/players/mizan/opl/CELLS/C5821", "south",
		"/players/mizan/opl/CELLS/C5702", "east",
		"/players/mizan/opl/CELLS/C5700", "west",
	});
