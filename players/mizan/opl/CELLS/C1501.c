...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1381", "north",
		"/players/mizan/opl/CELLS/C1621", "south",
		"/players/mizan/opl/CELLS/C1502", "east",
		"/players/mizan/opl/CELLS/C1500", "west",
	});
