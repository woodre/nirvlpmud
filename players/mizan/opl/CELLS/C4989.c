...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4869", "north",
		"/players/mizan/opl/CELLS/C5109", "south",
		"/players/mizan/opl/CELLS/C4990", "east",
		"/players/mizan/opl/CELLS/C4988", "west",
	});
