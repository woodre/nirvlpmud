...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6798", "north",
		"/players/mizan/opl/CELLS/C7038", "south",
		"/players/mizan/opl/CELLS/C6919", "east",
	});
...
long()
{
	...
	write("\"Am I accompanied by a PARENT or GUARDIAN?\"\n");
