...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5464", "north",
		"/players/mizan/opl/CELLS/C5704", "south",
		"/players/mizan/opl/CELLS/C5585", "east",
		"/players/mizan/opl/CELLS/C5583", "west",
	});
