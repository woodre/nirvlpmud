...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3557", "east",
		"/players/mizan/opl/CELLS/C3555", "west",
	});
...
long()
{
	...
	write("\"Religion is a major weapon in the war against reality.\"\n");
