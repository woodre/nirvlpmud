...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4701", "north",
		"/players/mizan/opl/CELLS/C4941", "south",
		"/players/mizan/opl/CELLS/C4822", "east",
		"/players/mizan/opl/CELLS/C4820", "west",
	});
