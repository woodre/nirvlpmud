...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6422", "north",
		"/players/mizan/opl/CELLS/C6662", "south",
		"/players/mizan/opl/CELLS/C6543", "east",
		"/players/mizan/opl/CELLS/C6541", "west",
	});
