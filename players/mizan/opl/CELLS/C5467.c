...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5347", "north",
		"/players/mizan/opl/CELLS/C5587", "south",
		"/players/mizan/opl/CELLS/C5468", "east",
		"/players/mizan/opl/CELLS/C5466", "west",
	});
