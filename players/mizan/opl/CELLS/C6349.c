...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6229", "north",
		"/players/mizan/opl/CELLS/C6469", "south",
		"/players/mizan/opl/CELLS/C6348", "west",
	});
...
long()
{
	...
	write("\"Civilization is fun! Anyway, it keeps me busy!!\"\n");
