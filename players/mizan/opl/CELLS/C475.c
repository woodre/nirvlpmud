...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C355", "north",
		"/players/mizan/opl/CELLS/C595", "south",
		"/players/mizan/opl/CELLS/C476", "east",
		"/players/mizan/opl/CELLS/C474", "west",
	});
