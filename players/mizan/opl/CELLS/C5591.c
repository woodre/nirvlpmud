...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5471", "north",
		"/players/mizan/opl/CELLS/C5711", "south",
		"/players/mizan/opl/CELLS/C5592", "east",
		"/players/mizan/opl/CELLS/C5590", "west",
	});
