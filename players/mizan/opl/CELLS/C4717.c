...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4597", "north",
		"/players/mizan/opl/CELLS/C4837", "south",
		"/players/mizan/opl/CELLS/C4718", "east",
		"/players/mizan/opl/CELLS/C4716", "west",
	});
