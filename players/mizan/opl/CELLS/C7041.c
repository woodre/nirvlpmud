...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6921", "north",
		"/players/mizan/opl/CELLS/C7042", "east",
	});
...
long()
{
	...
	write("\"Dames lie about anything -- just for practice.		-- Raymond Chandler\"\n");
