...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6611", "south",
		"/players/mizan/opl/CELLS/C6492", "east",
		"/players/mizan/opl/CELLS/C6490", "west",
	});
...
long()
{
	...
	write("\"It's OKAY -- I'm an INTELLECTUAL, too.\"\n");
