...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1501", "north",
		"/players/mizan/opl/CELLS/C1741", "south",
		"/players/mizan/opl/CELLS/C1622", "east",
		"/players/mizan/opl/CELLS/C1620", "west",
	});
