...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4383", "north",
		"/players/mizan/opl/CELLS/C4623", "south",
		"/players/mizan/opl/CELLS/C4504", "east",
		"/players/mizan/opl/CELLS/C4502", "west",
	});
