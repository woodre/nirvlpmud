...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4636", "north",
		"/players/mizan/opl/CELLS/C4876", "south",
		"/players/mizan/opl/CELLS/C4757", "east",
		"/players/mizan/opl/CELLS/C4755", "west",
	});
