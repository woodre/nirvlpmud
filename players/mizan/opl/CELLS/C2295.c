...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2175", "north",
		"/players/mizan/opl/CELLS/C2415", "south",
		"/players/mizan/opl/CELLS/C2296", "east",
		"/players/mizan/opl/CELLS/C2294", "west",
	});
