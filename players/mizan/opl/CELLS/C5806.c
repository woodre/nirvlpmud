...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5686", "north",
		"/players/mizan/opl/CELLS/C5926", "south",
		"/players/mizan/opl/CELLS/C5807", "east",
		"/players/mizan/opl/CELLS/C5805", "west",
	});
