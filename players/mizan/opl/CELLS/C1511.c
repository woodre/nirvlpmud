...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1391", "north",
		"/players/mizan/opl/CELLS/C1631", "south",
		"/players/mizan/opl/CELLS/C1512", "east",
		"/players/mizan/opl/CELLS/C1510", "west",
	});
