...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5688", "north",
		"/players/mizan/opl/CELLS/C5928", "south",
		"/players/mizan/opl/CELLS/C5809", "east",
		"/players/mizan/opl/CELLS/C5807", "west",
	});
