...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5592", "north",
		"/players/mizan/opl/CELLS/C5832", "south",
		"/players/mizan/opl/CELLS/C5713", "east",
		"/players/mizan/opl/CELLS/C5711", "west",
	});
