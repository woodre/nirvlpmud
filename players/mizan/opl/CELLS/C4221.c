...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4101", "north",
		"/players/mizan/opl/CELLS/C4341", "south",
		"/players/mizan/opl/CELLS/C4222", "east",
		"/players/mizan/opl/CELLS/C4220", "west",
	});
