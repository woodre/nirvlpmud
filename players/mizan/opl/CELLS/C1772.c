...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1773", "east",
		"/players/mizan/opl/CELLS/C1771", "west",
	});
...
long()
{
	...
	write("\"It's not the ups and downs of love, it's the ins and outs.\"\n");
