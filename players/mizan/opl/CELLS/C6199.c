...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6079", "north",
		"/players/mizan/opl/CELLS/C6319", "south",
		"/players/mizan/opl/CELLS/C6200", "east",
		"/players/mizan/opl/CELLS/C6198", "west",
	});
