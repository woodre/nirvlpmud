...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6199", "north",
		"/players/mizan/opl/CELLS/C6439", "south",
		"/players/mizan/opl/CELLS/C6320", "east",
		"/players/mizan/opl/CELLS/C6318", "west",
	});
