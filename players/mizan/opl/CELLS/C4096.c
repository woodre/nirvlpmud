...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3976", "north",
		"/players/mizan/opl/CELLS/C4216", "south",
		"/players/mizan/opl/CELLS/C4097", "east",
		"/players/mizan/opl/CELLS/C4095", "west",
	});
