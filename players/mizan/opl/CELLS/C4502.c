...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4382", "north",
		"/players/mizan/opl/CELLS/C4622", "south",
		"/players/mizan/opl/CELLS/C4503", "east",
		"/players/mizan/opl/CELLS/C4501", "west",
	});
