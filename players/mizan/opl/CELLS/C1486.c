...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1487", "east",
		"/players/mizan/opl/CELLS/C1485", "west",
	});
...
long()
{
	...
	write("\"Don't crush that dwarf, hand me the pliers!		-- Firesign Theatre\"\n");
