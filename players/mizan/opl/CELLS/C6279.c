...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6159", "north",
		"/players/mizan/opl/CELLS/C6399", "south",
		"/players/mizan/opl/CELLS/C6280", "east",
		"/players/mizan/opl/CELLS/C6278", "west",
	});
