...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1766", "north",
		"/players/mizan/opl/CELLS/C2006", "south",
		"/players/mizan/opl/CELLS/C1887", "east",
		"/players/mizan/opl/CELLS/C1885", "west",
	});
