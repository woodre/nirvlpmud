...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C356", "north",
		"/players/mizan/opl/CELLS/C596", "south",
		"/players/mizan/opl/CELLS/C477", "east",
		"/players/mizan/opl/CELLS/C475", "west",
	});
