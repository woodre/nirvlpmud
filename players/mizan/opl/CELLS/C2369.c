...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2249", "north",
		"/players/mizan/opl/CELLS/C2489", "south",
		"/players/mizan/opl/CELLS/C2370", "east",
		"/players/mizan/opl/CELLS/C2368", "west",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/fungus/wussy_male_vampire.c");
