...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C759", "north",
		"/players/mizan/opl/CELLS/C999", "south",
		"/players/mizan/opl/CELLS/C880", "east",
		"/players/mizan/opl/CELLS/C878", "west",
	});
