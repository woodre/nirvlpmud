...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5684", "north",
		"/players/mizan/opl/CELLS/C5924", "south",
		"/players/mizan/opl/CELLS/C5805", "east",
		"/players/mizan/opl/CELLS/C5803", "west",
	});
