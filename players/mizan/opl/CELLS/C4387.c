...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4267", "north",
		"/players/mizan/opl/CELLS/C4507", "south",
		"/players/mizan/opl/CELLS/C4388", "east",
		"/players/mizan/opl/CELLS/C4386", "west",
	});
