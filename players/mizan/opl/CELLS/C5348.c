...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5228", "north",
		"/players/mizan/opl/CELLS/C5468", "south",
		"/players/mizan/opl/CELLS/C5349", "east",
		"/players/mizan/opl/CELLS/C5347", "west",
	});
