...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5100", "north",
		"/players/mizan/opl/CELLS/C5340", "south",
		"/players/mizan/opl/CELLS/C5221", "east",
		"/players/mizan/opl/CELLS/C5219", "west",
	});
