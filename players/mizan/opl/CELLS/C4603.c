...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4483", "north",
		"/players/mizan/opl/CELLS/C4723", "south",
		"/players/mizan/opl/CELLS/C4604", "east",
		"/players/mizan/opl/CELLS/C4602", "west",
	});
