...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2901", "south",
		"/players/mizan/opl/CELLS/C2780", "west",
	});
...
long()
{
	...
	write("\"All this time I've been VIEWING a RUSSIAN MIDGET SODOMIZE a HOUSECAT!\"\n");
