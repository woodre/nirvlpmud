...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2389", "north",
		"/players/mizan/opl/CELLS/C2629", "south",
		"/players/mizan/opl/CELLS/C2510", "east",
		"/players/mizan/opl/CELLS/C2508", "west",
	});
