...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6421", "north",
		"/players/mizan/opl/CELLS/C6661", "south",
		"/players/mizan/opl/CELLS/C6542", "east",
		"/players/mizan/opl/CELLS/C6540", "west",
	});
