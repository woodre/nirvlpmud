...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5083", "north",
		"/players/mizan/opl/CELLS/C5323", "south",
		"/players/mizan/opl/CELLS/C5204", "east",
		"/players/mizan/opl/CELLS/C5202", "west",
	});
