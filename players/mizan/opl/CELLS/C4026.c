...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3906", "north",
		"/players/mizan/opl/CELLS/C4146", "south",
		"/players/mizan/opl/CELLS/C4027", "east",
		"/players/mizan/opl/CELLS/C4025", "west",
	});
