...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5201", "north",
		"/players/mizan/opl/CELLS/C5441", "south",
		"/players/mizan/opl/CELLS/C5322", "east",
		"/players/mizan/opl/CELLS/C5320", "west",
	});
