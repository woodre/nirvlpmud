...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4133", "north",
		"/players/mizan/opl/CELLS/C4373", "south",
		"/players/mizan/opl/CELLS/C4254", "east",
		"/players/mizan/opl/CELLS/C4252", "west",
	});
