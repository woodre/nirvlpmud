...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C169", "north",
		"/players/mizan/opl/CELLS/C409", "south",
		"/players/mizan/opl/CELLS/C290", "east",
		"/players/mizan/opl/CELLS/C288", "west",
	});
...
long()
{
	...
	write("\"Give me the Luxuries, and the Hell with the Necessities!\"\n");
