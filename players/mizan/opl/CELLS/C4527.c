...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4407", "north",
		"/players/mizan/opl/CELLS/C4528", "east",
		"/players/mizan/opl/CELLS/C4526", "west",
	});
...
long()
{
	...
	write("\"Joan of Arc is alive and medium well.\"\n");
