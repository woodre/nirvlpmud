...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C738", "north",
		"/players/mizan/opl/CELLS/C978", "south",
	});
...
long()
{
	...
	write("\"Social interaction can be fatal. Come to Irvine and live forever.\"\n");
