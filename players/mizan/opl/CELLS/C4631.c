...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4511", "north",
		"/players/mizan/opl/CELLS/C4751", "south",
		"/players/mizan/opl/CELLS/C4632", "east",
		"/players/mizan/opl/CELLS/C4630", "west",
	});
