...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2296", "north",
		"/players/mizan/opl/CELLS/C2536", "south",
		"/players/mizan/opl/CELLS/C2417", "east",
		"/players/mizan/opl/CELLS/C2415", "west",
	});
...
long()
{
	...
	write("\"So, how's your love life? Still holding your own?\"\n");
