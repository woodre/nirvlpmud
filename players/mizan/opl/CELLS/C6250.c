...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6130", "north",
		"/players/mizan/opl/CELLS/C6370", "south",
		"/players/mizan/opl/CELLS/C6249", "west",
	});
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/potentato.c");
...
long()
{
	...
	write("\"Christ died for our sins, so let's not disappoint Him.\"\n");
