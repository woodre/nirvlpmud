...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4385", "north",
		"/players/mizan/opl/CELLS/C4625", "south",
		"/players/mizan/opl/CELLS/C4506", "east",
		"/players/mizan/opl/CELLS/C4504", "west",
	});
