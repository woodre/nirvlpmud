...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4098", "north",
		"/players/mizan/opl/CELLS/C4338", "south",
		"/players/mizan/opl/CELLS/C4219", "east",
		"/players/mizan/opl/CELLS/C4217", "west",
	});
