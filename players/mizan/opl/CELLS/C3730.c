...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3610", "north",
		"/players/mizan/opl/CELLS/C3850", "south",
		"/players/mizan/opl/CELLS/C3731", "east",
		"/players/mizan/opl/CELLS/C3729", "west",
	});
