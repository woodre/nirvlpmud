...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3486", "north",
		"/players/mizan/opl/CELLS/C3726", "south",
		"/players/mizan/opl/CELLS/C3607", "east",
		"/players/mizan/opl/CELLS/C3605", "west",
	});
