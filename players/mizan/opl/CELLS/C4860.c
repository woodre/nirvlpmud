...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4740", "north",
		"/players/mizan/opl/CELLS/C4980", "south",
		"/players/mizan/opl/CELLS/C4861", "east",
		"/players/mizan/opl/CELLS/C4859", "west",
	});
