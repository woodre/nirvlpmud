...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4416", "north",
		"/players/mizan/opl/CELLS/C4656", "south",
		"/players/mizan/opl/CELLS/C4537", "east",
		"/players/mizan/opl/CELLS/C4535", "west",
	});
...
long()
{
	...
	write("\"VYARZERZOMANIMORORSEZASSEZANSERAREORSES?\"\n");
