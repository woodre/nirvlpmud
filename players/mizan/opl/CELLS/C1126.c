...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1006", "north",
		"/players/mizan/opl/CELLS/C1246", "south",
		"/players/mizan/opl/CELLS/C1127", "east",
	});
...
long()
{
	...
	write("\"Do something big -- fuck a giant.\"\n");
