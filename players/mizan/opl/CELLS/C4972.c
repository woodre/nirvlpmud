...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4852", "north",
		"/players/mizan/opl/CELLS/C5092", "south",
		"/players/mizan/opl/CELLS/C4973", "east",
		"/players/mizan/opl/CELLS/C4971", "west",
	});
