...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C912", "north",
		"/players/mizan/opl/CELLS/C1152", "south",
		"/players/mizan/opl/CELLS/C1033", "east",
		"/players/mizan/opl/CELLS/C1031", "west",
	});
