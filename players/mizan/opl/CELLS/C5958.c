...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5838", "north",
		"/players/mizan/opl/CELLS/C6078", "south",
		"/players/mizan/opl/CELLS/C5959", "east",
		"/players/mizan/opl/CELLS/C5957", "west",
	});
