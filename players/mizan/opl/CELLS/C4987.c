...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4867", "north",
		"/players/mizan/opl/CELLS/C5107", "south",
		"/players/mizan/opl/CELLS/C4988", "east",
		"/players/mizan/opl/CELLS/C4986", "west",
	});
