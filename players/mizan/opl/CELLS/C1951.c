...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1831", "north",
		"/players/mizan/opl/CELLS/C2071", "south",
		"/players/mizan/opl/CELLS/C1952", "east",
		"/players/mizan/opl/CELLS/C1950", "west",
	});
