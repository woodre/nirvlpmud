...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5555", "north",
		"/players/mizan/opl/CELLS/C5795", "south",
		"/players/mizan/opl/CELLS/C5676", "east",
		"/players/mizan/opl/CELLS/C5674", "west",
	});
