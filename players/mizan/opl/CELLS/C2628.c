...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2508", "north",
		"/players/mizan/opl/CELLS/C2748", "south",
		"/players/mizan/opl/CELLS/C2629", "east",
		"/players/mizan/opl/CELLS/C2627", "west",
	});
