...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5886", "west",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C5887");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I5887");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I5887");
