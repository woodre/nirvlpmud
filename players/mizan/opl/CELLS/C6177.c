...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6057", "north",
		"/players/mizan/opl/CELLS/C6297", "south",
		"/players/mizan/opl/CELLS/C6178", "east",
		"/players/mizan/opl/CELLS/C6176", "west",
	});
