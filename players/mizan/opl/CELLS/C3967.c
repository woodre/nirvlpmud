...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3847", "north",
		"/players/mizan/opl/CELLS/C4087", "south",
		"/players/mizan/opl/CELLS/C3968", "east",
		"/players/mizan/opl/CELLS/C3966", "west",
	});
