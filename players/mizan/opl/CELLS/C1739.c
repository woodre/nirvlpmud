...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1619", "north",
		"/players/mizan/opl/CELLS/C1859", "south",
		"/players/mizan/opl/CELLS/C1740", "east",
		"/players/mizan/opl/CELLS/C1738", "west",
	});
...
long()
{
	...
	write("\"My life is a patio of fun!\"\n");
