...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3626", "north",
		"/players/mizan/opl/CELLS/C3866", "south",
		"/players/mizan/opl/CELLS/C3745", "west",
	});
...
long()
{
	...
	write("\"My Aunt MAUREEN was a military advisor to IKE & TINA TURNER!!\"\n");
