...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C305", "south",
		"/players/mizan/opl/CELLS/C186", "east",
	});
...
long()
{
	...
	write("\"Never count your chickens before they rip your lips off.\"\n");
