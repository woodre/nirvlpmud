...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2703", "north",
		"/players/mizan/opl/CELLS/C2943", "south",
		"/players/mizan/opl/CELLS/C2824", "east",
		"/players/mizan/opl/CELLS/C2822", "west",
	});
