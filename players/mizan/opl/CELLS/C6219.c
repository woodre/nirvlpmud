...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6099", "north",
		"/players/mizan/opl/CELLS/C6339", "south",
		"/players/mizan/opl/CELLS/C6220", "east",
		"/players/mizan/opl/CELLS/C6218", "west",
	});
