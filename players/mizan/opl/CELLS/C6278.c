...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6158", "north",
		"/players/mizan/opl/CELLS/C6398", "south",
		"/players/mizan/opl/CELLS/C6279", "east",
		"/players/mizan/opl/CELLS/C6277", "west",
	});
