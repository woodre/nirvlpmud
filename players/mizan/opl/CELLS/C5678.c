...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5558", "north",
		"/players/mizan/opl/CELLS/C5798", "south",
		"/players/mizan/opl/CELLS/C5679", "east",
		"/players/mizan/opl/CELLS/C5677", "west",
	});
