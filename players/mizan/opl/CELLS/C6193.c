...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6073", "north",
		"/players/mizan/opl/CELLS/C6313", "south",
		"/players/mizan/opl/CELLS/C6194", "east",
		"/players/mizan/opl/CELLS/C6192", "west",
	});
