...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4069", "north",
		"/players/mizan/opl/CELLS/C4309", "south",
		"/players/mizan/opl/CELLS/C4190", "east",
		"/players/mizan/opl/CELLS/C4188", "west",
	});
