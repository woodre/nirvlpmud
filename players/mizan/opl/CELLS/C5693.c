...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5573", "north",
		"/players/mizan/opl/CELLS/C5813", "south",
		"/players/mizan/opl/CELLS/C5694", "east",
		"/players/mizan/opl/CELLS/C5692", "west",
	});
