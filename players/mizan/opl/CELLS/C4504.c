...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4384", "north",
		"/players/mizan/opl/CELLS/C4624", "south",
		"/players/mizan/opl/CELLS/C4505", "east",
		"/players/mizan/opl/CELLS/C4503", "west",
	});
