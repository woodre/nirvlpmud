...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4985", "north",
		"/players/mizan/opl/CELLS/C5225", "south",
		"/players/mizan/opl/CELLS/C5106", "east",
		"/players/mizan/opl/CELLS/C5104", "west",
	});
