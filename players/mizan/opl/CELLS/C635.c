...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C515", "north",
		"/players/mizan/opl/CELLS/C755", "south",
		"/players/mizan/opl/CELLS/C636", "east",
		"/players/mizan/opl/CELLS/C634", "west",
	});
