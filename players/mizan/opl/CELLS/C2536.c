...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2416", "north",
		"/players/mizan/opl/CELLS/C2656", "south",
		"/players/mizan/opl/CELLS/C2535", "west",
	});
...
long()
{
	...
	write("\"To Hell With the Baptists, I'm Going to Disney Land\"\n");
