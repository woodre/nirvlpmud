...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3060", "west",
	});
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/easy/knobgoblin.c");
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3061");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3061");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3061");
