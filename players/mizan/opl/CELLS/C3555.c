...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3556", "east",
		"/players/mizan/opl/CELLS/C3554", "west",
	});
...
long()
{
	...
	write("\"Other than that, Mrs. Lincoln, how did you like the play?\"\n");
