...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C637", "north",
		"/players/mizan/opl/CELLS/C877", "south",
		"/players/mizan/opl/CELLS/C758", "east",
		"/players/mizan/opl/CELLS/C756", "west",
	});
