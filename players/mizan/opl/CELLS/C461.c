...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C341", "north",
		"/players/mizan/opl/CELLS/C581", "south",
		"/players/mizan/opl/CELLS/C462", "east",
		"/players/mizan/opl/CELLS/C460", "west",
	});
