...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1632", "north",
		"/players/mizan/opl/CELLS/C1872", "south",
		"/players/mizan/opl/CELLS/C1753", "east",
		"/players/mizan/opl/CELLS/C1751", "west",
	});
