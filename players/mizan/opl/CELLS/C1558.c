...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1438", "north",
		"/players/mizan/opl/CELLS/C1678", "south",
		"/players/mizan/opl/CELLS/C1557", "west",
	});
...
long()
{
	...
	write("\"I am having FUN... I wonder if it's NET FUN or GROSS FUN?\"\n");
