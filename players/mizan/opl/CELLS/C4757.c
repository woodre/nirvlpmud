...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4637", "north",
		"/players/mizan/opl/CELLS/C4877", "south",
		"/players/mizan/opl/CELLS/C4758", "east",
		"/players/mizan/opl/CELLS/C4756", "west",
	});
