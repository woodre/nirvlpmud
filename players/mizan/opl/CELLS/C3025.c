...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2905", "north",
		"/players/mizan/opl/CELLS/C3145", "south",
		"/players/mizan/opl/CELLS/C3026", "east",
		"/players/mizan/opl/CELLS/C3024", "west",
	});
