...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3412", "north",
		"/players/mizan/opl/CELLS/C3652", "south",
		"/players/mizan/opl/CELLS/C3533", "east",
		"/players/mizan/opl/CELLS/C3531", "west",
	});
