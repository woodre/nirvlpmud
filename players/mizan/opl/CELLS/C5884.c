...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5764", "north",
		"/players/mizan/opl/CELLS/C6004", "south",
		"/players/mizan/opl/CELLS/C5885", "east",
	});
...
long()
{
	...
	write("\"The plural of spouse is spice.		-- R. A. Heinlein\"\n");
