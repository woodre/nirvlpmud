...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4977", "north",
		"/players/mizan/opl/CELLS/C5217", "south",
		"/players/mizan/opl/CELLS/C5098", "east",
		"/players/mizan/opl/CELLS/C5096", "west",
	});
