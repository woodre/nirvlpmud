...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5115", "north",
		"/players/mizan/opl/CELLS/C5355", "south",
		"/players/mizan/opl/CELLS/C5236", "east",
		"/players/mizan/opl/CELLS/C5234", "west",
	});
