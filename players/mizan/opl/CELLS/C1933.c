...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1813", "north",
		"/players/mizan/opl/CELLS/C2053", "south",
		"/players/mizan/opl/CELLS/C1934", "east",
		"/players/mizan/opl/CELLS/C1932", "west",
	});
