...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6166", "north",
		"/players/mizan/opl/CELLS/C6406", "south",
		"/players/mizan/opl/CELLS/C6287", "east",
		"/players/mizan/opl/CELLS/C6285", "west",
	});
