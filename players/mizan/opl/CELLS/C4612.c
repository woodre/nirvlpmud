...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4492", "north",
		"/players/mizan/opl/CELLS/C4732", "south",
		"/players/mizan/opl/CELLS/C4613", "east",
		"/players/mizan/opl/CELLS/C4611", "west",
	});
