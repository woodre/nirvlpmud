...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5564", "north",
		"/players/mizan/opl/CELLS/C5804", "south",
		"/players/mizan/opl/CELLS/C5685", "east",
		"/players/mizan/opl/CELLS/C5683", "west",
	});
