...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5479", "north",
		"/players/mizan/opl/CELLS/C5719", "south",
		"/players/mizan/opl/CELLS/C5600", "east",
		"/players/mizan/opl/CELLS/C5598", "west",
	});
