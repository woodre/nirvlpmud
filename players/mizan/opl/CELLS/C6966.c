...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6846", "north",
		"/players/mizan/opl/CELLS/C6967", "east",
		"/players/mizan/opl/CELLS/C6965", "west",
	});
