...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5942", "north",
		"/players/mizan/opl/CELLS/C6182", "south",
		"/players/mizan/opl/CELLS/C6063", "east",
		"/players/mizan/opl/CELLS/C6061", "west",
	});
