...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C847", "north",
		"/players/mizan/opl/CELLS/C1087", "south",
		"/players/mizan/opl/CELLS/C968", "east",
		"/players/mizan/opl/CELLS/C966", "west",
	});
