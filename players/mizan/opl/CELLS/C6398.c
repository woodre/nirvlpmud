...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6278", "north",
		"/players/mizan/opl/CELLS/C6518", "south",
		"/players/mizan/opl/CELLS/C6399", "east",
		"/players/mizan/opl/CELLS/C6397", "west",
	});
