...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4645", "south",
		"/players/mizan/opl/CELLS/C4526", "east",
	});
...
long()
{
	...
	write("\"tacky, adj.:	Serving grape kool-aid at religious functions.\"\n");
