...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4602", "north",
		"/players/mizan/opl/CELLS/C4842", "south",
		"/players/mizan/opl/CELLS/C4723", "east",
		"/players/mizan/opl/CELLS/C4721", "west",
	});
