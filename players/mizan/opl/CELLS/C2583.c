...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2463", "north",
		"/players/mizan/opl/CELLS/C2703", "south",
		"/players/mizan/opl/CELLS/C2582", "west",
	});
...
long()
{
	...
	write("\"Hear about...	the new German microwave oven?	Seats 500.\"\n");
