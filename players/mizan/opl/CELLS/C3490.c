...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3370", "north",
		"/players/mizan/opl/CELLS/C3610", "south",
		"/players/mizan/opl/CELLS/C3491", "east",
		"/players/mizan/opl/CELLS/C3489", "west",
	});
