...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6050", "north",
		"/players/mizan/opl/CELLS/C6290", "south",
		"/players/mizan/opl/CELLS/C6171", "east",
		"/players/mizan/opl/CELLS/C6169", "west",
	});
