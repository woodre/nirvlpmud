...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4495", "north",
		"/players/mizan/opl/CELLS/C4735", "south",
		"/players/mizan/opl/CELLS/C4616", "east",
		"/players/mizan/opl/CELLS/C4614", "west",
	});
