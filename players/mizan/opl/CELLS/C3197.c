...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3077", "north",
		"/players/mizan/opl/CELLS/C3317", "south",
	});
...
long()
{
	...
	write("\"YOW!! I'm in a very clever and adorable INSANE ASYLUM!!\"\n");
