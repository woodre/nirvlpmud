...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5825", "north",
		"/players/mizan/opl/CELLS/C6065", "south",
		"/players/mizan/opl/CELLS/C5946", "east",
		"/players/mizan/opl/CELLS/C5944", "west",
	});
