...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4733", "north",
		"/players/mizan/opl/CELLS/C4973", "south",
		"/players/mizan/opl/CELLS/C4854", "east",
		"/players/mizan/opl/CELLS/C4852", "west",
	});
