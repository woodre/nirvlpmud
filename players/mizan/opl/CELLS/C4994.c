...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4874", "north",
		"/players/mizan/opl/CELLS/C5114", "south",
		"/players/mizan/opl/CELLS/C4995", "east",
		"/players/mizan/opl/CELLS/C4993", "west",
	});
