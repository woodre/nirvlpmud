...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3523", "north",
		"/players/mizan/opl/CELLS/C3763", "south",
		"/players/mizan/opl/CELLS/C3644", "east",
		"/players/mizan/opl/CELLS/C3642", "west",
	});
