...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4737", "north",
		"/players/mizan/opl/CELLS/C4977", "south",
		"/players/mizan/opl/CELLS/C4858", "east",
		"/players/mizan/opl/CELLS/C4856", "west",
	});
