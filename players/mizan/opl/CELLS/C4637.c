...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4517", "north",
		"/players/mizan/opl/CELLS/C4757", "south",
		"/players/mizan/opl/CELLS/C4638", "east",
		"/players/mizan/opl/CELLS/C4636", "west",
	});
