...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C517", "north",
		"/players/mizan/opl/CELLS/C757", "south",
		"/players/mizan/opl/CELLS/C638", "east",
		"/players/mizan/opl/CELLS/C636", "west",
	});
