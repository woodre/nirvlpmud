...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C666", "south",
		"/players/mizan/opl/CELLS/C547", "east",
		"/players/mizan/opl/CELLS/C545", "west",
	});
...
long()
{
	...
	write("\"My polyvinyl cowboy wallet was made in Hong Kong by Montgomery Clift!\"\n");
