...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5916", "north",
		"/players/mizan/opl/CELLS/C6156", "south",
		"/players/mizan/opl/CELLS/C6037", "east",
		"/players/mizan/opl/CELLS/C6035", "west",
	});
