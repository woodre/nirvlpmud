...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4504", "north",
		"/players/mizan/opl/CELLS/C4744", "south",
		"/players/mizan/opl/CELLS/C4625", "east",
		"/players/mizan/opl/CELLS/C4623", "west",
	});
