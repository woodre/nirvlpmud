...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4268", "north",
		"/players/mizan/opl/CELLS/C4508", "south",
		"/players/mizan/opl/CELLS/C4389", "east",
		"/players/mizan/opl/CELLS/C4387", "west",
	});
