...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5202", "north",
		"/players/mizan/opl/CELLS/C5442", "south",
		"/players/mizan/opl/CELLS/C5323", "east",
		"/players/mizan/opl/CELLS/C5321", "west",
	});
