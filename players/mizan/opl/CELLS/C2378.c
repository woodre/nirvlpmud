...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2258", "north",
		"/players/mizan/opl/CELLS/C2498", "south",
	});
...
long()
{
	...
	write("\"embarrassment, n.:	Finding out your German Shepherd has the clap.\"\n");
