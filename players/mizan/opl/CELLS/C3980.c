...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3860", "north",
		"/players/mizan/opl/CELLS/C4100", "south",
		"/players/mizan/opl/CELLS/C3981", "east",
		"/players/mizan/opl/CELLS/C3979", "west",
	});
