...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4213", "north",
		"/players/mizan/opl/CELLS/C4453", "south",
		"/players/mizan/opl/CELLS/C4334", "east",
		"/players/mizan/opl/CELLS/C4332", "west",
	});
