...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4295", "north",
		"/players/mizan/opl/CELLS/C4535", "south",
		"/players/mizan/opl/CELLS/C4416", "east",
		"/players/mizan/opl/CELLS/C4414", "west",
	});
