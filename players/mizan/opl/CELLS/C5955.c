...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5835", "north",
		"/players/mizan/opl/CELLS/C6075", "south",
		"/players/mizan/opl/CELLS/C5956", "east",
		"/players/mizan/opl/CELLS/C5954", "west",
	});
