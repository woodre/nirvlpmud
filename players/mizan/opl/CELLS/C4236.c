...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4116", "north",
		"/players/mizan/opl/CELLS/C4356", "south",
		"/players/mizan/opl/CELLS/C4237", "east",
		"/players/mizan/opl/CELLS/C4235", "west",
	});
