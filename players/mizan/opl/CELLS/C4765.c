...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4645", "north",
		"/players/mizan/opl/CELLS/C4885", "south",
		"/players/mizan/opl/CELLS/C4766", "east",
		"/players/mizan/opl/CELLS/C4764", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/medium/knobgoblin-bully.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/medium/beano-agent.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/medium/lectroid.c");
...
long()
{
	...
	write("\"Every dog has its day, but the nights belong to the pussycats.\"\n");
