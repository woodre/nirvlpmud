...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6177", "north",
		"/players/mizan/opl/CELLS/C6417", "south",
		"/players/mizan/opl/CELLS/C6298", "east",
		"/players/mizan/opl/CELLS/C6296", "west",
	});
