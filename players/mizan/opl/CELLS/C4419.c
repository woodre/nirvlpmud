...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4299", "north",
		"/players/mizan/opl/CELLS/C4539", "south",
		"/players/mizan/opl/CELLS/C4420", "east",
		"/players/mizan/opl/CELLS/C4418", "west",
	});
