...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5447", "north",
		"/players/mizan/opl/CELLS/C5687", "south",
		"/players/mizan/opl/CELLS/C5568", "east",
		"/players/mizan/opl/CELLS/C5566", "west",
	});
