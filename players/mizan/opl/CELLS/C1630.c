...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1510", "north",
		"/players/mizan/opl/CELLS/C1750", "south",
		"/players/mizan/opl/CELLS/C1631", "east",
		"/players/mizan/opl/CELLS/C1629", "west",
	});
