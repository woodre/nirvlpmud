...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1257", "north",
		"/players/mizan/opl/CELLS/C1497", "south",
		"/players/mizan/opl/CELLS/C1378", "east",
		"/players/mizan/opl/CELLS/C1376", "west",
	});
