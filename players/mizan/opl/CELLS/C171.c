...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C291", "south",
		"/players/mizan/opl/CELLS/C172", "east",
		"/players/mizan/opl/CELLS/C170", "west",
	});
...
long()
{
	...
	write("\"Jesus is coming! Wear your rubbers!\"\n");
