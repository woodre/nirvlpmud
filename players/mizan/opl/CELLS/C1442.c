...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1562", "south",
		"/players/mizan/opl/CELLS/C1443", "east",
		"/players/mizan/opl/CELLS/C1441", "west",
	});
...
long()
{
	...
	write("\"Watch out for a cold wave this week. (Or maybe a warm WAC.)\"\n");
