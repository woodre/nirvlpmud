...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3052", "north",
		"/players/mizan/opl/CELLS/C3292", "south",
		"/players/mizan/opl/CELLS/C3173", "east",
		"/players/mizan/opl/CELLS/C3171", "west",
	});
