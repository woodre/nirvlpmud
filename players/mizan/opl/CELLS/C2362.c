...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2242", "north",
		"/players/mizan/opl/CELLS/C2482", "south",
		"/players/mizan/opl/CELLS/C2363", "east",
		"/players/mizan/opl/CELLS/C2361", "west",
	});
