...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4460", "north",
		"/players/mizan/opl/CELLS/C4700", "south",
		"/players/mizan/opl/CELLS/C4581", "east",
		"/players/mizan/opl/CELLS/C4579", "west",
	});
