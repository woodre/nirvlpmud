...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C225", "north",
		"/players/mizan/opl/CELLS/C465", "south",
		"/players/mizan/opl/CELLS/C346", "east",
	});
...
long()
{
	...
	write("\"Yow! Are we laid back yet?\"\n");
