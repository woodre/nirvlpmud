...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4139", "north",
		"/players/mizan/opl/CELLS/C4379", "south",
		"/players/mizan/opl/CELLS/C4260", "east",
		"/players/mizan/opl/CELLS/C4258", "west",
	});
