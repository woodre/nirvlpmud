...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4219", "north",
		"/players/mizan/opl/CELLS/C4459", "south",
		"/players/mizan/opl/CELLS/C4340", "east",
		"/players/mizan/opl/CELLS/C4338", "west",
	});
