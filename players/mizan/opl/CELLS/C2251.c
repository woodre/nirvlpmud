...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2131", "north",
		"/players/mizan/opl/CELLS/C2371", "south",
		"/players/mizan/opl/CELLS/C2252", "east",
		"/players/mizan/opl/CELLS/C2250", "west",
	});
