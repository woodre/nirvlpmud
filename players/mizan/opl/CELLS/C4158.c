...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4038", "north",
		"/players/mizan/opl/CELLS/C4159", "east",
	});
...
long()
{
	...
	write("\"Acid absorbs 47 times its own weight in excess Reality.\"\n");
