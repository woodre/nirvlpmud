...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4152", "north",
		"/players/mizan/opl/CELLS/C4392", "south",
		"/players/mizan/opl/CELLS/C4273", "east",
		"/players/mizan/opl/CELLS/C4271", "west",
	});
