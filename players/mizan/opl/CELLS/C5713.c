...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5593", "north",
		"/players/mizan/opl/CELLS/C5833", "south",
		"/players/mizan/opl/CELLS/C5714", "east",
		"/players/mizan/opl/CELLS/C5712", "west",
	});
