...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2973", "north",
		"/players/mizan/opl/CELLS/C3213", "south",
	});
...
long()
{
	...
	write("\"Many a bachelor feels the need to insert his masculinity.\"\n");
