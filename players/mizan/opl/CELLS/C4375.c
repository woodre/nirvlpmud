...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4255", "north",
		"/players/mizan/opl/CELLS/C4495", "south",
		"/players/mizan/opl/CELLS/C4376", "east",
		"/players/mizan/opl/CELLS/C4374", "west",
	});
