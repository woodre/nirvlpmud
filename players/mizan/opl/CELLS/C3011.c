...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2891", "north",
		"/players/mizan/opl/CELLS/C3131", "south",
		"/players/mizan/opl/CELLS/C3012", "east",
		"/players/mizan/opl/CELLS/C3010", "west",
	});
