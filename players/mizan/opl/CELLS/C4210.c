...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4090", "north",
		"/players/mizan/opl/CELLS/C4330", "south",
		"/players/mizan/opl/CELLS/C4211", "east",
		"/players/mizan/opl/CELLS/C4209", "west",
	});
