...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3590", "north",
		"/players/mizan/opl/CELLS/C3830", "south",
		"/players/mizan/opl/CELLS/C3711", "east",
		"/players/mizan/opl/CELLS/C3709", "west",
	});
