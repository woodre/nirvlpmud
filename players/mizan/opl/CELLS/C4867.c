...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4747", "north",
		"/players/mizan/opl/CELLS/C4987", "south",
		"/players/mizan/opl/CELLS/C4868", "east",
		"/players/mizan/opl/CELLS/C4866", "west",
	});
