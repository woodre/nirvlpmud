...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6289", "north",
		"/players/mizan/opl/CELLS/C6529", "south",
		"/players/mizan/opl/CELLS/C6410", "east",
		"/players/mizan/opl/CELLS/C6408", "west",
	});
