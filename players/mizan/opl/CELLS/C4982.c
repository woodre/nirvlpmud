...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4862", "north",
		"/players/mizan/opl/CELLS/C5102", "south",
		"/players/mizan/opl/CELLS/C4983", "east",
		"/players/mizan/opl/CELLS/C4981", "west",
	});
