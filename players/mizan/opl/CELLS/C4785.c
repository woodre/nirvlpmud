...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4665", "north",
		"/players/mizan/opl/CELLS/C4905", "south",
		"/players/mizan/opl/CELLS/C4786", "east",
		"/players/mizan/opl/CELLS/C4784", "west",
	});
...
long()
{
	...
	write("\"Didn't I buy a 1951 Packard from you last March in Cairo?\"\n");
