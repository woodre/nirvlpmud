...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3373", "north",
		"/players/mizan/opl/CELLS/C3613", "south",
		"/players/mizan/opl/CELLS/C3494", "east",
		"/players/mizan/opl/CELLS/C3492", "west",
	});
