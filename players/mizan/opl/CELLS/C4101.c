...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3981", "north",
		"/players/mizan/opl/CELLS/C4221", "south",
		"/players/mizan/opl/CELLS/C4102", "east",
		"/players/mizan/opl/CELLS/C4100", "west",
	});
