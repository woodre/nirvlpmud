...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5446", "north",
		"/players/mizan/opl/CELLS/C5686", "south",
		"/players/mizan/opl/CELLS/C5567", "east",
		"/players/mizan/opl/CELLS/C5565", "west",
	});
