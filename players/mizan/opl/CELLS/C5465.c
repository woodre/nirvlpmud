...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5345", "north",
		"/players/mizan/opl/CELLS/C5585", "south",
		"/players/mizan/opl/CELLS/C5466", "east",
		"/players/mizan/opl/CELLS/C5464", "west",
	});
