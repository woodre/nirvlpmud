...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C636", "north",
		"/players/mizan/opl/CELLS/C876", "south",
		"/players/mizan/opl/CELLS/C757", "east",
		"/players/mizan/opl/CELLS/C755", "west",
	});
