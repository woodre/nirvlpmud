...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6200", "north",
		"/players/mizan/opl/CELLS/C6440", "south",
		"/players/mizan/opl/CELLS/C6321", "east",
		"/players/mizan/opl/CELLS/C6319", "west",
	});
