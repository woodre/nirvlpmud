...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4163", "north",
		"/players/mizan/opl/CELLS/C4403", "south",
		"/players/mizan/opl/CELLS/C4284", "east",
	});
...
long()
{
	...
	write("\"'NO proof. NO god. NO problem.'     [Kamian]\"\n");
