...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6529", "north",
		"/players/mizan/opl/CELLS/C6769", "south",
		"/players/mizan/opl/CELLS/C6650", "east",
		"/players/mizan/opl/CELLS/C6648", "west",
	});
