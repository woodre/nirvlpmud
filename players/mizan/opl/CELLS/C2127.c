...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2007", "north",
		"/players/mizan/opl/CELLS/C2247", "south",
		"/players/mizan/opl/CELLS/C2128", "east",
		"/players/mizan/opl/CELLS/C2126", "west",
	});
