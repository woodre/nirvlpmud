...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5341", "north",
		"/players/mizan/opl/CELLS/C5581", "south",
		"/players/mizan/opl/CELLS/C5462", "east",
		"/players/mizan/opl/CELLS/C5460", "west",
	});
