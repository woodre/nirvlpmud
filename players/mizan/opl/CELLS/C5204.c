...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5084", "north",
		"/players/mizan/opl/CELLS/C5324", "south",
		"/players/mizan/opl/CELLS/C5205", "east",
		"/players/mizan/opl/CELLS/C5203", "west",
	});
