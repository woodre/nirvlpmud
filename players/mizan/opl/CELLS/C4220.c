...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4100", "north",
		"/players/mizan/opl/CELLS/C4340", "south",
		"/players/mizan/opl/CELLS/C4221", "east",
		"/players/mizan/opl/CELLS/C4219", "west",
	});
