...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5804", "north",
		"/players/mizan/opl/CELLS/C6044", "south",
		"/players/mizan/opl/CELLS/C5925", "east",
		"/players/mizan/opl/CELLS/C5923", "west",
	});
