...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6393", "north",
		"/players/mizan/opl/CELLS/C6633", "south",
	});
...
long()
{
	...
	write("\"Sex is a biological function; kissing is a committment.\"\n");
