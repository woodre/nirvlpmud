...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4864", "north",
		"/players/mizan/opl/CELLS/C5104", "south",
		"/players/mizan/opl/CELLS/C4985", "east",
		"/players/mizan/opl/CELLS/C4983", "west",
	});
