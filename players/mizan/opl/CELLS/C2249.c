...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2129", "north",
		"/players/mizan/opl/CELLS/C2369", "south",
		"/players/mizan/opl/CELLS/C2250", "east",
		"/players/mizan/opl/CELLS/C2248", "west",
	});
