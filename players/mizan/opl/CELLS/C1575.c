...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1455", "north",
		"/players/mizan/opl/CELLS/C1695", "south",
		"/players/mizan/opl/CELLS/C1576", "east",
		"/players/mizan/opl/CELLS/C1574", "west",
	});
