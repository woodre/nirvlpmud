...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5803", "north",
		"/players/mizan/opl/CELLS/C6043", "south",
		"/players/mizan/opl/CELLS/C5924", "east",
		"/players/mizan/opl/CELLS/C5922", "west",
	});
