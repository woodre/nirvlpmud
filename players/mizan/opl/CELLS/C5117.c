...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4997", "north",
		"/players/mizan/opl/CELLS/C5237", "south",
		"/players/mizan/opl/CELLS/C5118", "east",
		"/players/mizan/opl/CELLS/C5116", "west",
	});
