...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3524", "north",
		"/players/mizan/opl/CELLS/C3764", "south",
		"/players/mizan/opl/CELLS/C3645", "east",
		"/players/mizan/opl/CELLS/C3643", "west",
	});
