...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C876", "north",
		"/players/mizan/opl/CELLS/C1116", "south",
		"/players/mizan/opl/CELLS/C997", "east",
		"/players/mizan/opl/CELLS/C995", "west",
	});
