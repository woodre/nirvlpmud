...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5377", "north",
		"/players/mizan/opl/CELLS/C5617", "south",
		"/players/mizan/opl/CELLS/C5498", "east",
		"/players/mizan/opl/CELLS/C5496", "west",
	});
