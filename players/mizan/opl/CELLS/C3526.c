...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3406", "north",
		"/players/mizan/opl/CELLS/C3646", "south",
		"/players/mizan/opl/CELLS/C3527", "east",
		"/players/mizan/opl/CELLS/C3525", "west",
	});
