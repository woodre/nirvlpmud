...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1952", "north",
		"/players/mizan/opl/CELLS/C2192", "south",
		"/players/mizan/opl/CELLS/C2073", "east",
		"/players/mizan/opl/CELLS/C2071", "west",
	});
