...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4513", "north",
		"/players/mizan/opl/CELLS/C4753", "south",
		"/players/mizan/opl/CELLS/C4634", "east",
		"/players/mizan/opl/CELLS/C4632", "west",
	});
