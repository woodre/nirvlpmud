...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5811", "north",
		"/players/mizan/opl/CELLS/C6051", "south",
		"/players/mizan/opl/CELLS/C5932", "east",
		"/players/mizan/opl/CELLS/C5930", "west",
	});
