...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3828", "north",
		"/players/mizan/opl/CELLS/C4068", "south",
		"/players/mizan/opl/CELLS/C3949", "east",
		"/players/mizan/opl/CELLS/C3947", "west",
	});
