...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1048", "north",
		"/players/mizan/opl/CELLS/C1288", "south",
		"/players/mizan/opl/CELLS/C1169", "east",
		"/players/mizan/opl/CELLS/C1167", "west",
	});
