...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1066", "north",
		"/players/mizan/opl/CELLS/C1306", "south",
		"/players/mizan/opl/CELLS/C1187", "east",
		"/players/mizan/opl/CELLS/C1185", "west",
	});
