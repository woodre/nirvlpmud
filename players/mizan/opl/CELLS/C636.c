...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C516", "north",
		"/players/mizan/opl/CELLS/C756", "south",
		"/players/mizan/opl/CELLS/C637", "east",
		"/players/mizan/opl/CELLS/C635", "west",
	});
