...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4622", "north",
		"/players/mizan/opl/CELLS/C4862", "south",
		"/players/mizan/opl/CELLS/C4743", "east",
		"/players/mizan/opl/CELLS/C4741", "west",
	});
