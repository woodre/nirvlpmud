...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6036", "north",
		"/players/mizan/opl/CELLS/C6276", "south",
		"/players/mizan/opl/CELLS/C6157", "east",
		"/players/mizan/opl/CELLS/C6155", "west",
	});
