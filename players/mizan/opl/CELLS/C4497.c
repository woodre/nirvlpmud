...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4377", "north",
		"/players/mizan/opl/CELLS/C4617", "south",
		"/players/mizan/opl/CELLS/C4498", "east",
		"/players/mizan/opl/CELLS/C4496", "west",
	});
