...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3589", "north",
		"/players/mizan/opl/CELLS/C3829", "south",
		"/players/mizan/opl/CELLS/C3710", "east",
		"/players/mizan/opl/CELLS/C3708", "west",
	});
