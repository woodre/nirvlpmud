...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4294", "north",
		"/players/mizan/opl/CELLS/C4534", "south",
		"/players/mizan/opl/CELLS/C4415", "east",
		"/players/mizan/opl/CELLS/C4413", "west",
	});
