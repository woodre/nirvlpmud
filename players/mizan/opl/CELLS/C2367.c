...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2247", "north",
		"/players/mizan/opl/CELLS/C2487", "south",
		"/players/mizan/opl/CELLS/C2368", "east",
		"/players/mizan/opl/CELLS/C2366", "west",
	});
