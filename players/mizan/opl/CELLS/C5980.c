...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5860", "north",
		"/players/mizan/opl/CELLS/C6100", "south",
		"/players/mizan/opl/CELLS/C5981", "east",
		"/players/mizan/opl/CELLS/C5979", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/sea/octopus.c");
