...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C172", "north",
		"/players/mizan/opl/CELLS/C412", "south",
		"/players/mizan/opl/CELLS/C291", "west",
	});
...
long()
{
	...
	write("\"QOTD:	'I say, and without apology, hang the bitch.'\"\n");
