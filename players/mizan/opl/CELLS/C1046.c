...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C926", "north",
		"/players/mizan/opl/CELLS/C1166", "south",
		"/players/mizan/opl/CELLS/C1047", "east",
		"/players/mizan/opl/CELLS/C1045", "west",
	});
