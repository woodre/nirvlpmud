...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1763", "north",
		"/players/mizan/opl/CELLS/C2003", "south",
		"/players/mizan/opl/CELLS/C1884", "east",
		"/players/mizan/opl/CELLS/C1882", "west",
	});
