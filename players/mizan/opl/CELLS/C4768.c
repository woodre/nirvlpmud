...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4648", "north",
		"/players/mizan/opl/CELLS/C4888", "south",
		"/players/mizan/opl/CELLS/C4769", "east",
	});
...
long()
{
	...
	write("\"Let me do my TRIBUTE to FISHNET STOCKINGS ...\"\n");
