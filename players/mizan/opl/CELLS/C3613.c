...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3493", "north",
		"/players/mizan/opl/CELLS/C3733", "south",
		"/players/mizan/opl/CELLS/C3614", "east",
		"/players/mizan/opl/CELLS/C3612", "west",
	});
