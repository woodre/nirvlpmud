...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4129", "north",
		"/players/mizan/opl/CELLS/C4369", "south",
		"/players/mizan/opl/CELLS/C4250", "east",
		"/players/mizan/opl/CELLS/C4248", "west",
	});
