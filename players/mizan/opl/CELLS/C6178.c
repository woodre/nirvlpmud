...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6058", "north",
		"/players/mizan/opl/CELLS/C6298", "south",
		"/players/mizan/opl/CELLS/C6179", "east",
		"/players/mizan/opl/CELLS/C6177", "west",
	});
