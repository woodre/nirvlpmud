...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4142", "north",
		"/players/mizan/opl/CELLS/C4382", "south",
		"/players/mizan/opl/CELLS/C4263", "east",
		"/players/mizan/opl/CELLS/C4261", "west",
	});
