...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3473", "south",
		"/players/mizan/opl/CELLS/C3354", "east",
		"/players/mizan/opl/CELLS/C3352", "west",
	});
...
long()
{
	...
	write("\"I have accepted Provolone into my life!\"\n");
