...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6406", "north",
		"/players/mizan/opl/CELLS/C6646", "south",
		"/players/mizan/opl/CELLS/C6527", "east",
		"/players/mizan/opl/CELLS/C6525", "west",
	});
