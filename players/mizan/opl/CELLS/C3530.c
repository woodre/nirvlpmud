...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3410", "north",
		"/players/mizan/opl/CELLS/C3650", "south",
		"/players/mizan/opl/CELLS/C3531", "east",
		"/players/mizan/opl/CELLS/C3529", "west",
	});
