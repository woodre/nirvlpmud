...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C238", "north",
		"/players/mizan/opl/CELLS/C478", "south",
		"/players/mizan/opl/CELLS/C357", "west",
	});
...
long()
{
	...
	write("\"'I don't object to sex before marriage, but two minutes before?!?'\"\n");
