...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5238", "north",
		"/players/mizan/opl/CELLS/C5478", "south",
		"/players/mizan/opl/CELLS/C5359", "east",
		"/players/mizan/opl/CELLS/C5357", "west",
	});
