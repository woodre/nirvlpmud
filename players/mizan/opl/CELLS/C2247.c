...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2127", "north",
		"/players/mizan/opl/CELLS/C2367", "south",
		"/players/mizan/opl/CELLS/C2248", "east",
		"/players/mizan/opl/CELLS/C2246", "west",
	});
