...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4481", "north",
		"/players/mizan/opl/CELLS/C4721", "south",
		"/players/mizan/opl/CELLS/C4602", "east",
		"/players/mizan/opl/CELLS/C4600", "west",
	});
