...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4272", "north",
		"/players/mizan/opl/CELLS/C4512", "south",
		"/players/mizan/opl/CELLS/C4393", "east",
		"/players/mizan/opl/CELLS/C4391", "west",
	});
