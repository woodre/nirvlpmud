...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5938", "north",
		"/players/mizan/opl/CELLS/C6178", "south",
		"/players/mizan/opl/CELLS/C6059", "east",
		"/players/mizan/opl/CELLS/C6057", "west",
	});
