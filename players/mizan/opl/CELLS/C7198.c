...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C7078", "north",
	});
	...
	if(!boss)
	{
		boss = clone_object("/players/mizan/opl/beasties/hard/gurkha.c");
...
long()
{
	...
	write("This block seems unique from the others in that it is cleaner and not as\n");
	write("scored and worn as the others. Additionally, it seems to be marked as one of\n");
	write("the end points of this maze. From here, one can proceed forward no further.\n");
