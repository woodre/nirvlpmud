...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1712", "north",
		"/players/mizan/opl/CELLS/C1952", "south",
		"/players/mizan/opl/CELLS/C1833", "east",
		"/players/mizan/opl/CELLS/C1831", "west",
	});
