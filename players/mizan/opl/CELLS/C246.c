...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C126", "north",
		"/players/mizan/opl/CELLS/C366", "south",
		"/players/mizan/opl/CELLS/C247", "east",
		"/players/mizan/opl/CELLS/C245", "west",
	});
