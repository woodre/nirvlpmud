...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5821", "north",
		"/players/mizan/opl/CELLS/C6061", "south",
		"/players/mizan/opl/CELLS/C5942", "east",
		"/players/mizan/opl/CELLS/C5940", "west",
	});
