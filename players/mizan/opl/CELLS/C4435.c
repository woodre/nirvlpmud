...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4315", "north",
		"/players/mizan/opl/CELLS/C4555", "south",
		"/players/mizan/opl/CELLS/C4436", "east",
		"/players/mizan/opl/CELLS/C4434", "west",
	});
