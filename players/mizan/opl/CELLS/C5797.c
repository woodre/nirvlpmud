...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5677", "north",
		"/players/mizan/opl/CELLS/C5917", "south",
		"/players/mizan/opl/CELLS/C5798", "east",
		"/players/mizan/opl/CELLS/C5796", "west",
	});
