...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5213", "north",
		"/players/mizan/opl/CELLS/C5453", "south",
		"/players/mizan/opl/CELLS/C5334", "east",
		"/players/mizan/opl/CELLS/C5332", "west",
	});
