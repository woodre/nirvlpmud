...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3494", "north",
		"/players/mizan/opl/CELLS/C3734", "south",
		"/players/mizan/opl/CELLS/C3615", "east",
		"/players/mizan/opl/CELLS/C3613", "west",
	});
