...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1140", "north",
		"/players/mizan/opl/CELLS/C1380", "south",
		"/players/mizan/opl/CELLS/C1261", "east",
		"/players/mizan/opl/CELLS/C1259", "west",
	});
