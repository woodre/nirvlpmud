...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5232", "north",
		"/players/mizan/opl/CELLS/C5472", "south",
		"/players/mizan/opl/CELLS/C5353", "east",
		"/players/mizan/opl/CELLS/C5351", "west",
	});
