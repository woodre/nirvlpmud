...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4632", "north",
		"/players/mizan/opl/CELLS/C4872", "south",
		"/players/mizan/opl/CELLS/C4753", "east",
		"/players/mizan/opl/CELLS/C4751", "west",
	});
