...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5472", "north",
		"/players/mizan/opl/CELLS/C5712", "south",
		"/players/mizan/opl/CELLS/C5593", "east",
		"/players/mizan/opl/CELLS/C5591", "west",
	});
