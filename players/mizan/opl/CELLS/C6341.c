...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6221", "north",
		"/players/mizan/opl/CELLS/C6461", "south",
		"/players/mizan/opl/CELLS/C6342", "east",
		"/players/mizan/opl/CELLS/C6340", "west",
	});
