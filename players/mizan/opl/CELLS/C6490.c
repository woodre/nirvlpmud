...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6370", "north",
		"/players/mizan/opl/CELLS/C6610", "south",
		"/players/mizan/opl/CELLS/C6491", "east",
		"/players/mizan/opl/CELLS/C6489", "west",
	});
