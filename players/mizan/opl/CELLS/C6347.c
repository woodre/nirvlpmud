...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6227", "north",
		"/players/mizan/opl/CELLS/C6467", "south",
		"/players/mizan/opl/CELLS/C6348", "east",
		"/players/mizan/opl/CELLS/C6346", "west",
	});
