...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4931", "south",
		"/players/mizan/opl/CELLS/C4810", "west",
	});
...
long()
{
	...
	write("\"Girls would never stay out late if guys didn't make them.\"\n");
