...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6337", "north",
		"/players/mizan/opl/CELLS/C6577", "south",
		"/players/mizan/opl/CELLS/C6458", "east",
		"/players/mizan/opl/CELLS/C6456", "west",
	});
