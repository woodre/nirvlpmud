...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3762", "north",
		"/players/mizan/opl/CELLS/C4002", "south",
		"/players/mizan/opl/CELLS/C3883", "east",
		"/players/mizan/opl/CELLS/C3881", "west",
	});
