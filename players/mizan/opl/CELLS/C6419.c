...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6299", "north",
		"/players/mizan/opl/CELLS/C6539", "south",
		"/players/mizan/opl/CELLS/C6420", "east",
		"/players/mizan/opl/CELLS/C6418", "west",
	});
