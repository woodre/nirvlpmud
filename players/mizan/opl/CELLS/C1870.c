...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1750", "north",
		"/players/mizan/opl/CELLS/C1990", "south",
		"/players/mizan/opl/CELLS/C1871", "east",
		"/players/mizan/opl/CELLS/C1869", "west",
	});
