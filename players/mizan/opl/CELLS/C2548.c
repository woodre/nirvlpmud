...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2428", "north",
		"/players/mizan/opl/CELLS/C2668", "south",
		"/players/mizan/opl/CELLS/C2549", "east",
		"/players/mizan/opl/CELLS/C2547", "west",
	});
