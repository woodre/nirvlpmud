...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6247", "north",
		"/players/mizan/opl/CELLS/C6487", "south",
	});
...
long()
{
	...
	write("\"Confucious say:	man who sleep in road wake up with run-down feeling.\"\n");
