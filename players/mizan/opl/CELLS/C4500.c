...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4380", "north",
		"/players/mizan/opl/CELLS/C4620", "south",
		"/players/mizan/opl/CELLS/C4501", "east",
		"/players/mizan/opl/CELLS/C4499", "west",
	});
