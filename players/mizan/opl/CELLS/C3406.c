...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3286", "north",
		"/players/mizan/opl/CELLS/C3526", "south",
		"/players/mizan/opl/CELLS/C3407", "east",
		"/players/mizan/opl/CELLS/C3405", "west",
	});
