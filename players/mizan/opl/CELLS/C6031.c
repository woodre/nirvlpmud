...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6151", "south",
		"/players/mizan/opl/CELLS/C6032", "east",
	});
...
long()
{
	...
	write("\"Never try to keep up with the Joneses; they might be newlyweds.\"\n");
