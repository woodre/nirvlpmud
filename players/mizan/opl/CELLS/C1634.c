...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1514", "north",
		"/players/mizan/opl/CELLS/C1754", "south",
		"/players/mizan/opl/CELLS/C1635", "east",
		"/players/mizan/opl/CELLS/C1633", "west",
	});
