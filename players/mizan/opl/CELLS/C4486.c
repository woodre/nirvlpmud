...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4366", "north",
		"/players/mizan/opl/CELLS/C4606", "south",
		"/players/mizan/opl/CELLS/C4487", "east",
		"/players/mizan/opl/CELLS/C4485", "west",
	});
