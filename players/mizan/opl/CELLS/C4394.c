...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4274", "north",
		"/players/mizan/opl/CELLS/C4514", "south",
		"/players/mizan/opl/CELLS/C4395", "east",
		"/players/mizan/opl/CELLS/C4393", "west",
	});
