...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5353", "north",
		"/players/mizan/opl/CELLS/C5593", "south",
		"/players/mizan/opl/CELLS/C5474", "east",
		"/players/mizan/opl/CELLS/C5472", "west",
	});
