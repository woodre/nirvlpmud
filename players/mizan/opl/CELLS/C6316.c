...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6196", "north",
		"/players/mizan/opl/CELLS/C6436", "south",
		"/players/mizan/opl/CELLS/C6317", "east",
		"/players/mizan/opl/CELLS/C6315", "west",
	});
