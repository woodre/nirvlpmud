...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4140", "north",
		"/players/mizan/opl/CELLS/C4380", "south",
		"/players/mizan/opl/CELLS/C4261", "east",
		"/players/mizan/opl/CELLS/C4259", "west",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/fungus/wookie.c");
