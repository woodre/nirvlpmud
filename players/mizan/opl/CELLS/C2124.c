...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2004", "north",
		"/players/mizan/opl/CELLS/C2244", "south",
		"/players/mizan/opl/CELLS/C2125", "east",
		"/players/mizan/opl/CELLS/C2123", "west",
	});
