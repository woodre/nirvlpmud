...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2009", "north",
		"/players/mizan/opl/CELLS/C2249", "south",
		"/players/mizan/opl/CELLS/C2130", "east",
		"/players/mizan/opl/CELLS/C2128", "west",
	});
