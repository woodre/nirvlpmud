...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4088", "north",
		"/players/mizan/opl/CELLS/C4328", "south",
		"/players/mizan/opl/CELLS/C4209", "east",
		"/players/mizan/opl/CELLS/C4207", "west",
	});
