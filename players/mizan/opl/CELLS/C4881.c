...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4761", "north",
		"/players/mizan/opl/CELLS/C5001", "south",
		"/players/mizan/opl/CELLS/C4882", "east",
		"/players/mizan/opl/CELLS/C4880", "west",
	});
