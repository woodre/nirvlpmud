...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C817", "north",
		"/players/mizan/opl/CELLS/C1057", "south",
	});
...
long()
{
	...
	write("\"Fine day to throw a party. Throw him as far as you can.\"\n");
