...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2011", "north",
		"/players/mizan/opl/CELLS/C2251", "south",
		"/players/mizan/opl/CELLS/C2132", "east",
		"/players/mizan/opl/CELLS/C2130", "west",
	});
