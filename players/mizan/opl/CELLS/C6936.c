...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C7056", "south",
		"/players/mizan/opl/CELLS/C6935", "west",
	});
...
long()
{
	...
	write("\"No one born with a mouth and a need is 'innocent'.		-- Greg Bear\"\n");
