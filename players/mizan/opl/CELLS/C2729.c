...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2609", "north",
		"/players/mizan/opl/CELLS/C2849", "south",
		"/players/mizan/opl/CELLS/C2730", "east",
		"/players/mizan/opl/CELLS/C2728", "west",
	});
