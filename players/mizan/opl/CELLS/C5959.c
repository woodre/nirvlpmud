...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5839", "north",
		"/players/mizan/opl/CELLS/C6079", "south",
		"/players/mizan/opl/CELLS/C5960", "east",
		"/players/mizan/opl/CELLS/C5958", "west",
	});
