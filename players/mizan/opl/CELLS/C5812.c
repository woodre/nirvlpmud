...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5692", "north",
		"/players/mizan/opl/CELLS/C5932", "south",
		"/players/mizan/opl/CELLS/C5813", "east",
		"/players/mizan/opl/CELLS/C5811", "west",
	});
