...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4574", "north",
		"/players/mizan/opl/CELLS/C4814", "south",
		"/players/mizan/opl/CELLS/C4695", "east",
		"/players/mizan/opl/CELLS/C4693", "west",
	});
