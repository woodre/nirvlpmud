...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2246", "north",
		"/players/mizan/opl/CELLS/C2486", "south",
		"/players/mizan/opl/CELLS/C2367", "east",
		"/players/mizan/opl/CELLS/C2365", "west",
	});
