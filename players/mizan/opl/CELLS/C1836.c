...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1716", "north",
		"/players/mizan/opl/CELLS/C1956", "south",
		"/players/mizan/opl/CELLS/C1837", "east",
		"/players/mizan/opl/CELLS/C1835", "west",
	});
