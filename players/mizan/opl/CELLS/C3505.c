...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3506", "east",
		"/players/mizan/opl/CELLS/C3504", "west",
	});
...
long()
{
	...
	write("\"The nearer to the church, the further from God.		-- John Heywood\"\n");
