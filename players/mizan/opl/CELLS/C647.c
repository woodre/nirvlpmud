...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C527", "north",
		"/players/mizan/opl/CELLS/C767", "south",
		"/players/mizan/opl/CELLS/C648", "east",
		"/players/mizan/opl/CELLS/C646", "west",
	});
