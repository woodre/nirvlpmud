...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4414", "north",
		"/players/mizan/opl/CELLS/C4654", "south",
		"/players/mizan/opl/CELLS/C4535", "east",
		"/players/mizan/opl/CELLS/C4533", "west",
	});
