...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5087", "north",
		"/players/mizan/opl/CELLS/C5327", "south",
		"/players/mizan/opl/CELLS/C5208", "east",
		"/players/mizan/opl/CELLS/C5206", "west",
	});
