...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1454", "north",
		"/players/mizan/opl/CELLS/C1694", "south",
		"/players/mizan/opl/CELLS/C1575", "east",
		"/players/mizan/opl/CELLS/C1573", "west",
	});
...
long()
{
	...
	write("\"If it's not one thing, it's a mother.\"\n");
