...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4757", "north",
		"/players/mizan/opl/CELLS/C4997", "south",
		"/players/mizan/opl/CELLS/C4878", "east",
		"/players/mizan/opl/CELLS/C4876", "west",
	});
