...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C807", "north",
		"/players/mizan/opl/CELLS/C1047", "south",
		"/players/mizan/opl/CELLS/C928", "east",
		"/players/mizan/opl/CELLS/C926", "west",
	});
