...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5576", "north",
		"/players/mizan/opl/CELLS/C5816", "south",
		"/players/mizan/opl/CELLS/C5697", "east",
		"/players/mizan/opl/CELLS/C5695", "west",
	});
