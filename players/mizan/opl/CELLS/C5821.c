...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5701", "north",
		"/players/mizan/opl/CELLS/C5941", "south",
		"/players/mizan/opl/CELLS/C5822", "east",
		"/players/mizan/opl/CELLS/C5820", "west",
	});
