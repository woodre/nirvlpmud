...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C646", "north",
		"/players/mizan/opl/CELLS/C886", "south",
		"/players/mizan/opl/CELLS/C767", "east",
		"/players/mizan/opl/CELLS/C765", "west",
	});
...
long()
{
	...
	write("\"Have a coke and a smile!		-- John DeLorean\"\n");
