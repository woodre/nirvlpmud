...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6040", "north",
		"/players/mizan/opl/CELLS/C6280", "south",
		"/players/mizan/opl/CELLS/C6161", "east",
		"/players/mizan/opl/CELLS/C6159", "west",
	});
