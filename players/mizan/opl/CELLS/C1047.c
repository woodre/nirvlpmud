...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C927", "north",
		"/players/mizan/opl/CELLS/C1167", "south",
		"/players/mizan/opl/CELLS/C1048", "east",
		"/players/mizan/opl/CELLS/C1046", "west",
	});
