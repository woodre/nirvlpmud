...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4126", "north",
		"/players/mizan/opl/CELLS/C4366", "south",
		"/players/mizan/opl/CELLS/C4247", "east",
		"/players/mizan/opl/CELLS/C4245", "west",
	});
