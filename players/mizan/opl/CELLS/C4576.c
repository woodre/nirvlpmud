...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4456", "north",
		"/players/mizan/opl/CELLS/C4696", "south",
		"/players/mizan/opl/CELLS/C4577", "east",
		"/players/mizan/opl/CELLS/C4575", "west",
	});
