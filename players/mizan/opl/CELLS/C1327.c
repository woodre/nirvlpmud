...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1447", "south",
		"/players/mizan/opl/CELLS/C1328", "east",
	});
...
long()
{
	...
	write("\"Sometimes, you just gotta say 'What the fuck.'		-- Risky Business\"\n");
