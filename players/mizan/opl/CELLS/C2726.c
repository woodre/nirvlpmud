...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2606", "north",
		"/players/mizan/opl/CELLS/C2846", "south",
		"/players/mizan/opl/CELLS/C2727", "east",
		"/players/mizan/opl/CELLS/C2725", "west",
	});
