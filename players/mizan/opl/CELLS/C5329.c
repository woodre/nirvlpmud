...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5209", "north",
		"/players/mizan/opl/CELLS/C5449", "south",
		"/players/mizan/opl/CELLS/C5330", "east",
		"/players/mizan/opl/CELLS/C5328", "west",
	});
