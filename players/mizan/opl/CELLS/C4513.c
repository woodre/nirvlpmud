...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4393", "north",
		"/players/mizan/opl/CELLS/C4633", "south",
		"/players/mizan/opl/CELLS/C4514", "east",
		"/players/mizan/opl/CELLS/C4512", "west",
	});
