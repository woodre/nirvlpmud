...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3725", "north",
		"/players/mizan/opl/CELLS/C3965", "south",
		"/players/mizan/opl/CELLS/C3846", "east",
		"/players/mizan/opl/CELLS/C3844", "west",
	});
