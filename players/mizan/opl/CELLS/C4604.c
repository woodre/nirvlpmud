...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4484", "north",
		"/players/mizan/opl/CELLS/C4724", "south",
		"/players/mizan/opl/CELLS/C4605", "east",
		"/players/mizan/opl/CELLS/C4603", "west",
	});
