...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4070", "north",
		"/players/mizan/opl/CELLS/C4310", "south",
		"/players/mizan/opl/CELLS/C4191", "east",
		"/players/mizan/opl/CELLS/C4189", "west",
	});
