...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3734", "north",
		"/players/mizan/opl/CELLS/C3974", "south",
		"/players/mizan/opl/CELLS/C3855", "east",
		"/players/mizan/opl/CELLS/C3853", "west",
	});
