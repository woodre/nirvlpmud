...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6183", "north",
		"/players/mizan/opl/CELLS/C6423", "south",
		"/players/mizan/opl/CELLS/C6304", "east",
		"/players/mizan/opl/CELLS/C6302", "west",
	});
