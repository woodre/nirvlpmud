...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C878", "north",
		"/players/mizan/opl/CELLS/C1118", "south",
		"/players/mizan/opl/CELLS/C999", "east",
		"/players/mizan/opl/CELLS/C997", "west",
	});
