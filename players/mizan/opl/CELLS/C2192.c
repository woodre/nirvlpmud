...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2072", "north",
		"/players/mizan/opl/CELLS/C2312", "south",
		"/players/mizan/opl/CELLS/C2193", "east",
		"/players/mizan/opl/CELLS/C2191", "west",
	});
