...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5461", "north",
		"/players/mizan/opl/CELLS/C5701", "south",
		"/players/mizan/opl/CELLS/C5582", "east",
		"/players/mizan/opl/CELLS/C5580", "west",
	});
