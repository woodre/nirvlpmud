...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2488", "north",
		"/players/mizan/opl/CELLS/C2728", "south",
		"/players/mizan/opl/CELLS/C2609", "east",
		"/players/mizan/opl/CELLS/C2607", "west",
	});
