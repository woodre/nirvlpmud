...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6738", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C6737");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I6737");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I6737");
...
long()
{
	...
	write("\"'Where knowledge ends, religion begins.'    [Benjamin Disraeli]\"\n");
