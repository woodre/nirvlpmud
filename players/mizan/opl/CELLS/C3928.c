...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3808", "north",
		"/players/mizan/opl/CELLS/C4048", "south",
		"/players/mizan/opl/CELLS/C3929", "east",
		"/players/mizan/opl/CELLS/C3927", "west",
	});
