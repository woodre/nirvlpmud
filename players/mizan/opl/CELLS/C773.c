...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C893", "south",
		"/players/mizan/opl/CELLS/C774", "east",
		"/players/mizan/opl/CELLS/C772", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/medium/soldier.c");
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/medium/guard_turkey.c");
...
long()
{
	...
	write("\"You mean you don't want to watch WRESTLING from ATLANTA?\"\n");
