...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5109", "north",
		"/players/mizan/opl/CELLS/C5349", "south",
		"/players/mizan/opl/CELLS/C5230", "east",
		"/players/mizan/opl/CELLS/C5228", "west",
	});
