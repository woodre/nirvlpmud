...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4168", "north",
		"/players/mizan/opl/CELLS/C4408", "south",
		"/players/mizan/opl/CELLS/C4287", "west",
	});
