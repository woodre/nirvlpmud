...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6198", "north",
		"/players/mizan/opl/CELLS/C6438", "south",
		"/players/mizan/opl/CELLS/C6319", "east",
		"/players/mizan/opl/CELLS/C6317", "west",
	});
