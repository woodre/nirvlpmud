...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1630", "north",
		"/players/mizan/opl/CELLS/C1870", "south",
		"/players/mizan/opl/CELLS/C1751", "east",
		"/players/mizan/opl/CELLS/C1749", "west",
	});
