...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3898", "north",
		"/players/mizan/opl/CELLS/C4138", "south",
		"/players/mizan/opl/CELLS/C4019", "east",
		"/players/mizan/opl/CELLS/C4017", "west",
	});
