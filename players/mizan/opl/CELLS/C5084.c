...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4964", "north",
		"/players/mizan/opl/CELLS/C5204", "south",
		"/players/mizan/opl/CELLS/C5085", "east",
		"/players/mizan/opl/CELLS/C5083", "west",
	});
