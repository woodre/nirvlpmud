...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5463", "north",
		"/players/mizan/opl/CELLS/C5703", "south",
		"/players/mizan/opl/CELLS/C5584", "east",
		"/players/mizan/opl/CELLS/C5582", "west",
	});
