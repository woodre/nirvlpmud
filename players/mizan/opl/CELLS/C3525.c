...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3405", "north",
		"/players/mizan/opl/CELLS/C3645", "south",
		"/players/mizan/opl/CELLS/C3526", "east",
		"/players/mizan/opl/CELLS/C3524", "west",
	});
