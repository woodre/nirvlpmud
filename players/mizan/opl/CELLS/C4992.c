...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4872", "north",
		"/players/mizan/opl/CELLS/C5112", "south",
		"/players/mizan/opl/CELLS/C4993", "east",
		"/players/mizan/opl/CELLS/C4991", "west",
	});
