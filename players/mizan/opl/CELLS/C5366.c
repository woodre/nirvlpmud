...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5246", "north",
		"/players/mizan/opl/CELLS/C5486", "south",
		"/players/mizan/opl/CELLS/C5367", "east",
		"/players/mizan/opl/CELLS/C5365", "west",
	});
