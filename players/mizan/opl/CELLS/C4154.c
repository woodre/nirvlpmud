...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4034", "north",
		"/players/mizan/opl/CELLS/C4274", "south",
		"/players/mizan/opl/CELLS/C4155", "east",
		"/players/mizan/opl/CELLS/C4153", "west",
	});
