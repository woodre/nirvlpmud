...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5720", "north",
		"/players/mizan/opl/CELLS/C5960", "south",
		"/players/mizan/opl/CELLS/C5841", "east",
		"/players/mizan/opl/CELLS/C5839", "west",
	});
