...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C929", "north",
		"/players/mizan/opl/CELLS/C1169", "south",
		"/players/mizan/opl/CELLS/C1050", "east",
		"/players/mizan/opl/CELLS/C1048", "west",
	});
