...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4624", "north",
		"/players/mizan/opl/CELLS/C4864", "south",
		"/players/mizan/opl/CELLS/C4745", "east",
		"/players/mizan/opl/CELLS/C4743", "west",
	});
