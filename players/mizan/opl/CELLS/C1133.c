...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1013", "north",
		"/players/mizan/opl/CELLS/C1253", "south",
	});
...
long()
{
	...
	write("\"If you were attacked by a homosexual, would you beat him off?\"\n");
