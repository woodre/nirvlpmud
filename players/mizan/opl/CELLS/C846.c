...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C726", "north",
		"/players/mizan/opl/CELLS/C966", "south",
		"/players/mizan/opl/CELLS/C847", "east",
		"/players/mizan/opl/CELLS/C845", "west",
	});
