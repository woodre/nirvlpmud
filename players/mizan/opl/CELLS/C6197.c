...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6077", "north",
		"/players/mizan/opl/CELLS/C6317", "south",
		"/players/mizan/opl/CELLS/C6198", "east",
		"/players/mizan/opl/CELLS/C6196", "west",
	});
