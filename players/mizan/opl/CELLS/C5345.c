...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5225", "north",
		"/players/mizan/opl/CELLS/C5465", "south",
		"/players/mizan/opl/CELLS/C5346", "east",
		"/players/mizan/opl/CELLS/C5344", "west",
	});
