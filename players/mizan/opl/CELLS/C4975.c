...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4855", "north",
		"/players/mizan/opl/CELLS/C5095", "south",
		"/players/mizan/opl/CELLS/C4976", "east",
		"/players/mizan/opl/CELLS/C4974", "west",
	});
