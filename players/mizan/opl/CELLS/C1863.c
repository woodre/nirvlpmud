...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1743", "north",
		"/players/mizan/opl/CELLS/C1983", "south",
		"/players/mizan/opl/CELLS/C1864", "east",
		"/players/mizan/opl/CELLS/C1862", "west",
	});
