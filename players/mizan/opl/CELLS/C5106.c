...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4986", "north",
		"/players/mizan/opl/CELLS/C5226", "south",
		"/players/mizan/opl/CELLS/C5107", "east",
		"/players/mizan/opl/CELLS/C5105", "west",
	});
