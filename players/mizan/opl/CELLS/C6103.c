...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5983", "north",
		"/players/mizan/opl/CELLS/C6223", "south",
		"/players/mizan/opl/CELLS/C6104", "east",
		"/players/mizan/opl/CELLS/C6102", "west",
	});
