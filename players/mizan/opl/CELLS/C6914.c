...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6915", "east",
		"/players/mizan/opl/CELLS/C6913", "west",
	});
...
long()
{
	...
	write("\"You are witty, charming, handsome and above average in length.\"\n");
