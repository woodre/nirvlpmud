...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4502", "north",
		"/players/mizan/opl/CELLS/C4742", "south",
		"/players/mizan/opl/CELLS/C4623", "east",
		"/players/mizan/opl/CELLS/C4621", "west",
	});
