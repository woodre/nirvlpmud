...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6181", "north",
		"/players/mizan/opl/CELLS/C6421", "south",
		"/players/mizan/opl/CELLS/C6302", "east",
		"/players/mizan/opl/CELLS/C6300", "west",
	});
