...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1643", "north",
		"/players/mizan/opl/CELLS/C1883", "south",
		"/players/mizan/opl/CELLS/C1764", "east",
		"/players/mizan/opl/CELLS/C1762", "west",
	});
