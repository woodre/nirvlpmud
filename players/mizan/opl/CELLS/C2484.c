...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2364", "north",
		"/players/mizan/opl/CELLS/C2604", "south",
		"/players/mizan/opl/CELLS/C2485", "east",
		"/players/mizan/opl/CELLS/C2483", "west",
	});
