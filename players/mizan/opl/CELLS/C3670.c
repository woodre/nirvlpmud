...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3550", "north",
		"/players/mizan/opl/CELLS/C3671", "east",
		"/players/mizan/opl/CELLS/C3669", "west",
	});
...
long()
{
	...
	write("\"Spend extra time on hobby. Get plenty of rolling papers.\"\n");
