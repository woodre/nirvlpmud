...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4787", "north",
		"/players/mizan/opl/CELLS/C4908", "east",
		"/players/mizan/opl/CELLS/C4906", "west",
	});
...
long()
{
	...
	write("\"So... how come the Corinthians never wrote back?\"\n");
