...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3173", "north",
		"/players/mizan/opl/CELLS/C3413", "south",
		"/players/mizan/opl/CELLS/C3294", "east",
		"/players/mizan/opl/CELLS/C3292", "west",
	});
