...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3908", "north",
		"/players/mizan/opl/CELLS/C4148", "south",
		"/players/mizan/opl/CELLS/C4029", "east",
		"/players/mizan/opl/CELLS/C4027", "west",
	});
