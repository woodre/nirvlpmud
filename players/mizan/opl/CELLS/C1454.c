...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1574", "south",
		"/players/mizan/opl/CELLS/C1455", "east",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/medium/beano-agent.c");
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/environs/vending-machine-hotfood.c");
...
long()
{
	...
	write("\"This system goes down more often than a two-dollar whore.\"\n");
