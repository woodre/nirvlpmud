...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5943", "north",
		"/players/mizan/opl/CELLS/C6183", "south",
		"/players/mizan/opl/CELLS/C6064", "east",
		"/players/mizan/opl/CELLS/C6062", "west",
	});
