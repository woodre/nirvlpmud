...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5702", "north",
		"/players/mizan/opl/CELLS/C5942", "south",
		"/players/mizan/opl/CELLS/C5823", "east",
		"/players/mizan/opl/CELLS/C5821", "west",
	});
