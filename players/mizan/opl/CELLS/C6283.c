...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6163", "north",
		"/players/mizan/opl/CELLS/C6403", "south",
		"/players/mizan/opl/CELLS/C6284", "east",
		"/players/mizan/opl/CELLS/C6282", "west",
	});
