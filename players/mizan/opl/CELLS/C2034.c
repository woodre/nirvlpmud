...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1914", "north",
		"/players/mizan/opl/CELLS/C2154", "south",
		"/players/mizan/opl/CELLS/C2035", "east",
		"/players/mizan/opl/CELLS/C2033", "west",
	});
