...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4459", "north",
		"/players/mizan/opl/CELLS/C4699", "south",
		"/players/mizan/opl/CELLS/C4580", "east",
		"/players/mizan/opl/CELLS/C4578", "west",
	});
