...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C808", "north",
		"/players/mizan/opl/CELLS/C1048", "south",
		"/players/mizan/opl/CELLS/C929", "east",
		"/players/mizan/opl/CELLS/C927", "west",
	});
