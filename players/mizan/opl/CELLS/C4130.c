...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4010", "north",
		"/players/mizan/opl/CELLS/C4250", "south",
		"/players/mizan/opl/CELLS/C4131", "east",
		"/players/mizan/opl/CELLS/C4129", "west",
	});
