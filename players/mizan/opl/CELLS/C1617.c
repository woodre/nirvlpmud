...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1497", "north",
		"/players/mizan/opl/CELLS/C1737", "south",
		"/players/mizan/opl/CELLS/C1618", "east",
		"/players/mizan/opl/CELLS/C1616", "west",
	});
