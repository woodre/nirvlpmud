...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5456", "north",
		"/players/mizan/opl/CELLS/C5696", "south",
		"/players/mizan/opl/CELLS/C5577", "east",
		"/players/mizan/opl/CELLS/C5575", "west",
	});
