...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5319", "north",
		"/players/mizan/opl/CELLS/C5559", "south",
		"/players/mizan/opl/CELLS/C5440", "east",
		"/players/mizan/opl/CELLS/C5438", "west",
	});
