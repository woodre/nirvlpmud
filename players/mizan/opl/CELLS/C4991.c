...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4871", "north",
		"/players/mizan/opl/CELLS/C5111", "south",
		"/players/mizan/opl/CELLS/C4992", "east",
		"/players/mizan/opl/CELLS/C4990", "west",
	});
