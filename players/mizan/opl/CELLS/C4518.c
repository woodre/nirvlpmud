...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4398", "north",
		"/players/mizan/opl/CELLS/C4638", "south",
		"/players/mizan/opl/CELLS/C4519", "east",
		"/players/mizan/opl/CELLS/C4517", "west",
	});
