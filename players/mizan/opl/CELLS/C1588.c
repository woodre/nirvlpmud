...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1468", "north",
		"/players/mizan/opl/CELLS/C1708", "south",
		"/players/mizan/opl/CELLS/C1589", "east",
		"/players/mizan/opl/CELLS/C1587", "west",
	});
