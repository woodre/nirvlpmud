...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C851", "north",
		"/players/mizan/opl/CELLS/C1091", "south",
		"/players/mizan/opl/CELLS/C972", "east",
		"/players/mizan/opl/CELLS/C970", "west",
	});
