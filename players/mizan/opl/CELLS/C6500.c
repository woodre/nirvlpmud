...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6620", "south",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/hard/soldierboss-blocker.c");
...
long()
{
	...
	write("\"Campus crusade for Cthulhu -- it found me.\"\n");
