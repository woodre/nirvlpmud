...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C595", "north",
		"/players/mizan/opl/CELLS/C835", "south",
		"/players/mizan/opl/CELLS/C716", "east",
		"/players/mizan/opl/CELLS/C714", "west",
	});
