...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2981", "north",
		"/players/mizan/opl/CELLS/C3221", "south",
		"/players/mizan/opl/CELLS/C3102", "east",
		"/players/mizan/opl/CELLS/C3100", "west",
	});
