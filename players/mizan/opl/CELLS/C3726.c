...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3606", "north",
		"/players/mizan/opl/CELLS/C3846", "south",
		"/players/mizan/opl/CELLS/C3727", "east",
		"/players/mizan/opl/CELLS/C3725", "west",
	});
