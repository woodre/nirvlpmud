...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5326", "north",
		"/players/mizan/opl/CELLS/C5566", "south",
		"/players/mizan/opl/CELLS/C5447", "east",
		"/players/mizan/opl/CELLS/C5445", "west",
	});
