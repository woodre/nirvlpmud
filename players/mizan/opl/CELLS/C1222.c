...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1102", "north",
		"/players/mizan/opl/CELLS/C1342", "south",
		"/players/mizan/opl/CELLS/C1223", "east",
		"/players/mizan/opl/CELLS/C1221", "west",
	});
