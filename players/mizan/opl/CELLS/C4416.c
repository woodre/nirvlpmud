...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4296", "north",
		"/players/mizan/opl/CELLS/C4536", "south",
		"/players/mizan/opl/CELLS/C4417", "east",
		"/players/mizan/opl/CELLS/C4415", "west",
	});
...
long()
{
	...
	write("\"After I run your program, let's make love like crazed weasels, OK?\"\n");
