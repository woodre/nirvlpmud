...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1379", "north",
		"/players/mizan/opl/CELLS/C1619", "south",
		"/players/mizan/opl/CELLS/C1500", "east",
		"/players/mizan/opl/CELLS/C1498", "west",
	});
