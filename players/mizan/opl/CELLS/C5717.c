...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5597", "north",
		"/players/mizan/opl/CELLS/C5837", "south",
		"/players/mizan/opl/CELLS/C5718", "east",
		"/players/mizan/opl/CELLS/C5716", "west",
	});
