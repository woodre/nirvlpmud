...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2486", "north",
		"/players/mizan/opl/CELLS/C2726", "south",
		"/players/mizan/opl/CELLS/C2607", "east",
		"/players/mizan/opl/CELLS/C2605", "west",
	});
