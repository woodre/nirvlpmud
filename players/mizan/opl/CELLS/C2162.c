...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2042", "north",
		"/players/mizan/opl/CELLS/C2163", "east",
		"/players/mizan/opl/CELLS/C2161", "west",
	});
...
long()
{
	...
	write("\"'Man created God, not God, man'  [Guiseppi Garibaldi]\"\n");
