...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1983", "north",
		"/players/mizan/opl/CELLS/C2223", "south",
		"/players/mizan/opl/CELLS/C2104", "east",
		"/players/mizan/opl/CELLS/C2102", "west",
	});
