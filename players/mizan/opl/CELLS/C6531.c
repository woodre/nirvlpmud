...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6411", "north",
		"/players/mizan/opl/CELLS/C6651", "south",
		"/players/mizan/opl/CELLS/C6532", "east",
		"/players/mizan/opl/CELLS/C6530", "west",
	});
