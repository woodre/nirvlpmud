...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6101", "north",
		"/players/mizan/opl/CELLS/C6341", "south",
		"/players/mizan/opl/CELLS/C6222", "east",
		"/players/mizan/opl/CELLS/C6220", "west",
	});
