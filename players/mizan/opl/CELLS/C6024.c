...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6144", "south",
		"/players/mizan/opl/CELLS/C6025", "east",
		"/players/mizan/opl/CELLS/C6023", "west",
	});
...
long()
{
	...
	write("\"Hackers do it with all sorts of characters.\"\n");
