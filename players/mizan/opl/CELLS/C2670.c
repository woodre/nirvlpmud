...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2550", "north",
		"/players/mizan/opl/CELLS/C2790", "south",
		"/players/mizan/opl/CELLS/C2671", "east",
		"/players/mizan/opl/CELLS/C2669", "west",
	});
