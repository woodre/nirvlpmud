...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1807", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C1806");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I1806");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I1806");
...
long()
{
	...
	write("\"APL hackers take all they want.\"\n");
