...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4188", "north",
		"/players/mizan/opl/CELLS/C4428", "south",
		"/players/mizan/opl/CELLS/C4309", "east",
		"/players/mizan/opl/CELLS/C4307", "west",
	});
