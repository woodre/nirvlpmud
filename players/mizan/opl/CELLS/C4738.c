...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4618", "north",
		"/players/mizan/opl/CELLS/C4858", "south",
		"/players/mizan/opl/CELLS/C4739", "east",
		"/players/mizan/opl/CELLS/C4737", "west",
	});
