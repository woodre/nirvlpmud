...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5206", "north",
		"/players/mizan/opl/CELLS/C5446", "south",
		"/players/mizan/opl/CELLS/C5327", "east",
		"/players/mizan/opl/CELLS/C5325", "west",
	});
