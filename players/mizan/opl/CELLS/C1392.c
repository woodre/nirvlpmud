...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1272", "north",
		"/players/mizan/opl/CELLS/C1512", "south",
		"/players/mizan/opl/CELLS/C1393", "east",
		"/players/mizan/opl/CELLS/C1391", "west",
	});
