...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5595", "north",
		"/players/mizan/opl/CELLS/C5835", "south",
		"/players/mizan/opl/CELLS/C5716", "east",
		"/players/mizan/opl/CELLS/C5714", "west",
	});
