...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3529", "north",
		"/players/mizan/opl/CELLS/C3769", "south",
		"/players/mizan/opl/CELLS/C3650", "east",
		"/players/mizan/opl/CELLS/C3648", "west",
	});
