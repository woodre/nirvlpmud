...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6777", "north",
		"/players/mizan/opl/CELLS/C7017", "south",
	});
...
long()
{
	...
	write("\"A clash of doctrine is not a disaster - it is an opportunity.\"\n");
