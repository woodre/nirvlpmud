...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1404", "north",
		"/players/mizan/opl/CELLS/C1644", "south",
		"/players/mizan/opl/CELLS/C1525", "east",
		"/players/mizan/opl/CELLS/C1523", "west",
	});
