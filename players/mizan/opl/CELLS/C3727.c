...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3607", "north",
		"/players/mizan/opl/CELLS/C3847", "south",
		"/players/mizan/opl/CELLS/C3728", "east",
		"/players/mizan/opl/CELLS/C3726", "west",
	});
