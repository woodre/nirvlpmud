...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5320", "north",
		"/players/mizan/opl/CELLS/C5560", "south",
		"/players/mizan/opl/CELLS/C5441", "east",
		"/players/mizan/opl/CELLS/C5439", "west",
	});
