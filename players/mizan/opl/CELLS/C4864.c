...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4744", "north",
		"/players/mizan/opl/CELLS/C4984", "south",
		"/players/mizan/opl/CELLS/C4865", "east",
		"/players/mizan/opl/CELLS/C4863", "west",
	});
