...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3468", "north",
		"/players/mizan/opl/CELLS/C3708", "south",
		"/players/mizan/opl/CELLS/C3589", "east",
		"/players/mizan/opl/CELLS/C3587", "west",
	});
