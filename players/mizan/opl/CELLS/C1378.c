...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1258", "north",
		"/players/mizan/opl/CELLS/C1498", "south",
		"/players/mizan/opl/CELLS/C1379", "east",
		"/players/mizan/opl/CELLS/C1377", "west",
	});
...
long()
{
	...
	write("\"strapless evening gown, n.:	Bust truster.\"\n");
