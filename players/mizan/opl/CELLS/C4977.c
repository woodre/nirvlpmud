...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4857", "north",
		"/players/mizan/opl/CELLS/C5097", "south",
		"/players/mizan/opl/CELLS/C4978", "east",
		"/players/mizan/opl/CELLS/C4976", "west",
	});
