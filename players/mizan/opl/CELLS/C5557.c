...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5437", "north",
		"/players/mizan/opl/CELLS/C5677", "south",
		"/players/mizan/opl/CELLS/C5558", "east",
		"/players/mizan/opl/CELLS/C5556", "west",
	});
