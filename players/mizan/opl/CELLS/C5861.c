...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5741", "north",
		"/players/mizan/opl/CELLS/C5981", "south",
		"/players/mizan/opl/CELLS/C5862", "east",
		"/players/mizan/opl/CELLS/C5860", "west",
	});
