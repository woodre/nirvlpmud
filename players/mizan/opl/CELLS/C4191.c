...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4071", "north",
		"/players/mizan/opl/CELLS/C4311", "south",
		"/players/mizan/opl/CELLS/C4192", "east",
		"/players/mizan/opl/CELLS/C4190", "west",
	});
