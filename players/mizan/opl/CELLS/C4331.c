...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4211", "north",
		"/players/mizan/opl/CELLS/C4451", "south",
		"/players/mizan/opl/CELLS/C4332", "east",
		"/players/mizan/opl/CELLS/C4330", "west",
	});
