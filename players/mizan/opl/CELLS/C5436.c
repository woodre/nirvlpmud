...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5316", "north",
		"/players/mizan/opl/CELLS/C5556", "south",
		"/players/mizan/opl/CELLS/C5437", "east",
		"/players/mizan/opl/CELLS/C5435", "west",
	});
