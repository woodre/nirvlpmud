...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6300", "north",
		"/players/mizan/opl/CELLS/C6540", "south",
		"/players/mizan/opl/CELLS/C6421", "east",
		"/players/mizan/opl/CELLS/C6419", "west",
	});
