...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4599", "north",
		"/players/mizan/opl/CELLS/C4839", "south",
		"/players/mizan/opl/CELLS/C4720", "east",
		"/players/mizan/opl/CELLS/C4718", "west",
	});
