...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6285", "north",
		"/players/mizan/opl/CELLS/C6525", "south",
		"/players/mizan/opl/CELLS/C6406", "east",
		"/players/mizan/opl/CELLS/C6404", "west",
	});
