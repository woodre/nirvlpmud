...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4873", "north",
		"/players/mizan/opl/CELLS/C5113", "south",
		"/players/mizan/opl/CELLS/C4994", "east",
		"/players/mizan/opl/CELLS/C4992", "west",
	});
