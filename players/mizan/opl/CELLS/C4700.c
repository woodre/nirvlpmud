...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4580", "north",
		"/players/mizan/opl/CELLS/C4820", "south",
		"/players/mizan/opl/CELLS/C4701", "east",
		"/players/mizan/opl/CELLS/C4699", "west",
	});
