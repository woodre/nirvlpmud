...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6242", "north",
		"/players/mizan/opl/CELLS/C6482", "south",
		"/players/mizan/opl/CELLS/C6361", "west",
	});
...
long()
{
	...
	write("\"innunendo, n.:	Italian enema.\"\n");
