...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4745", "north",
		"/players/mizan/opl/CELLS/C4985", "south",
		"/players/mizan/opl/CELLS/C4866", "east",
		"/players/mizan/opl/CELLS/C4864", "west",
	});
