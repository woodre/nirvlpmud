...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3308", "north",
		"/players/mizan/opl/CELLS/C3548", "south",
		"/players/mizan/opl/CELLS/C3429", "east",
		"/players/mizan/opl/CELLS/C3427", "west",
	});
