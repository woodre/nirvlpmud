...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4870", "north",
		"/players/mizan/opl/CELLS/C5110", "south",
		"/players/mizan/opl/CELLS/C4991", "east",
		"/players/mizan/opl/CELLS/C4989", "west",
	});
