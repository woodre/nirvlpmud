...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1795", "north",
		"/players/mizan/opl/CELLS/C2035", "south",
		"/players/mizan/opl/CELLS/C1916", "east",
		"/players/mizan/opl/CELLS/C1914", "west",
	});
