...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4998", "north",
		"/players/mizan/opl/CELLS/C5238", "south",
		"/players/mizan/opl/CELLS/C5119", "east",
		"/players/mizan/opl/CELLS/C5117", "west",
	});
