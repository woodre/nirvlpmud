...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C634", "north",
		"/players/mizan/opl/CELLS/C874", "south",
		"/players/mizan/opl/CELLS/C755", "east",
		"/players/mizan/opl/CELLS/C753", "west",
	});
