...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4519", "north",
		"/players/mizan/opl/CELLS/C4759", "south",
		"/players/mizan/opl/CELLS/C4640", "east",
		"/players/mizan/opl/CELLS/C4638", "west",
	});
