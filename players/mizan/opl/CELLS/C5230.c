...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5110", "north",
		"/players/mizan/opl/CELLS/C5350", "south",
		"/players/mizan/opl/CELLS/C5231", "east",
		"/players/mizan/opl/CELLS/C5229", "west",
	});
