...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6854", "south",
		"/players/mizan/opl/CELLS/C6735", "east",
		"/players/mizan/opl/CELLS/C6733", "west",
	});
...
long()
{
	...
	write("\"Do you guys know we just passed thru a BLACK HOLE in space?\"\n");
