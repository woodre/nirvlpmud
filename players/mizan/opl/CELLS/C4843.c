...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4723", "north",
		"/players/mizan/opl/CELLS/C4963", "south",
		"/players/mizan/opl/CELLS/C4844", "east",
		"/players/mizan/opl/CELLS/C4842", "west",
	});
