...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4394", "north",
		"/players/mizan/opl/CELLS/C4634", "south",
		"/players/mizan/opl/CELLS/C4515", "east",
		"/players/mizan/opl/CELLS/C4513", "west",
	});
