...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4982", "north",
		"/players/mizan/opl/CELLS/C5222", "south",
		"/players/mizan/opl/CELLS/C5103", "east",
		"/players/mizan/opl/CELLS/C5101", "west",
	});
