...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3481", "north",
		"/players/mizan/opl/CELLS/C3721", "south",
	});
...
long()
{
	...
	write("\"Q:	How does a mink get babies?A:	The same way babes get minks.\"\n");
