...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4138", "north",
		"/players/mizan/opl/CELLS/C4378", "south",
		"/players/mizan/opl/CELLS/C4259", "east",
		"/players/mizan/opl/CELLS/C4257", "west",
	});
