...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4027", "north",
		"/players/mizan/opl/CELLS/C4267", "south",
		"/players/mizan/opl/CELLS/C4148", "east",
		"/players/mizan/opl/CELLS/C4146", "west",
	});
