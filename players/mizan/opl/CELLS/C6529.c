...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6409", "north",
		"/players/mizan/opl/CELLS/C6649", "south",
		"/players/mizan/opl/CELLS/C6530", "east",
		"/players/mizan/opl/CELLS/C6528", "west",
	});
