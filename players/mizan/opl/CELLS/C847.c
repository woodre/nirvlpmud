...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C727", "north",
		"/players/mizan/opl/CELLS/C967", "south",
		"/players/mizan/opl/CELLS/C848", "east",
		"/players/mizan/opl/CELLS/C846", "west",
	});
