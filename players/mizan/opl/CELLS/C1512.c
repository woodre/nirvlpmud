...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1392", "north",
		"/players/mizan/opl/CELLS/C1632", "south",
		"/players/mizan/opl/CELLS/C1513", "east",
		"/players/mizan/opl/CELLS/C1511", "west",
	});
