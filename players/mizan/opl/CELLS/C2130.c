...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2010", "north",
		"/players/mizan/opl/CELLS/C2250", "south",
		"/players/mizan/opl/CELLS/C2131", "east",
		"/players/mizan/opl/CELLS/C2129", "west",
	});
