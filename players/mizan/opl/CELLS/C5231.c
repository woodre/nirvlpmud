...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5111", "north",
		"/players/mizan/opl/CELLS/C5351", "south",
		"/players/mizan/opl/CELLS/C5232", "east",
		"/players/mizan/opl/CELLS/C5230", "west",
	});
