...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4363", "north",
		"/players/mizan/opl/CELLS/C4603", "south",
		"/players/mizan/opl/CELLS/C4484", "east",
		"/players/mizan/opl/CELLS/C4482", "west",
	});
