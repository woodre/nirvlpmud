...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3340", "north",
		"/players/mizan/opl/CELLS/C3580", "south",
		"/players/mizan/opl/CELLS/C3461", "east",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/hard/shoop.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/hard/shoop.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/postal_worker.c");
...
long()
{
	...
	write("\"Old mercenaries never die. They go to hell and regroup.\"\n");
