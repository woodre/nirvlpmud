...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3715", "east",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/easy/neocon.c");
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/easy/goliathbeano.c");
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3714");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3714");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3714");
...
long()
{
	...
	write("\"Eat shit and die a virgin!\"\n");
