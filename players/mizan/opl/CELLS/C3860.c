...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3740", "north",
		"/players/mizan/opl/CELLS/C3980", "south",
		"/players/mizan/opl/CELLS/C3861", "east",
		"/players/mizan/opl/CELLS/C3859", "west",
	});
