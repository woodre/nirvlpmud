...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6410", "north",
		"/players/mizan/opl/CELLS/C6650", "south",
		"/players/mizan/opl/CELLS/C6531", "east",
		"/players/mizan/opl/CELLS/C6529", "west",
	});
