...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1911", "north",
		"/players/mizan/opl/CELLS/C2151", "south",
		"/players/mizan/opl/CELLS/C2032", "east",
		"/players/mizan/opl/CELLS/C2030", "west",
	});
