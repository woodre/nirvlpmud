...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6528", "north",
		"/players/mizan/opl/CELLS/C6768", "south",
		"/players/mizan/opl/CELLS/C6649", "east",
		"/players/mizan/opl/CELLS/C6647", "west",
	});
