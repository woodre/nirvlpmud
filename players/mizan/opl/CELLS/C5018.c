...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4898", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C5018");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I5018");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I5018");
...
long()
{
	...
	write("\"The more I learn about women, the more I love my dog.\"\n");
