...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2295", "north",
		"/players/mizan/opl/CELLS/C2535", "south",
		"/players/mizan/opl/CELLS/C2416", "east",
		"/players/mizan/opl/CELLS/C2414", "west",
	});
