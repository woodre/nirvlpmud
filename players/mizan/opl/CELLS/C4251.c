...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4131", "north",
		"/players/mizan/opl/CELLS/C4371", "south",
		"/players/mizan/opl/CELLS/C4252", "east",
		"/players/mizan/opl/CELLS/C4250", "west",
	});
