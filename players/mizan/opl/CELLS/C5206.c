...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5086", "north",
		"/players/mizan/opl/CELLS/C5326", "south",
		"/players/mizan/opl/CELLS/C5207", "east",
		"/players/mizan/opl/CELLS/C5205", "west",
	});
