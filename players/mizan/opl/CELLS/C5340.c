...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5220", "north",
		"/players/mizan/opl/CELLS/C5460", "south",
		"/players/mizan/opl/CELLS/C5341", "east",
		"/players/mizan/opl/CELLS/C5339", "west",
	});
