...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2073", "north",
		"/players/mizan/opl/CELLS/C2313", "south",
		"/players/mizan/opl/CELLS/C2194", "east",
		"/players/mizan/opl/CELLS/C2192", "west",
	});
