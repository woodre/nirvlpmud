...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C434", "north",
		"/players/mizan/opl/CELLS/C674", "south",
		"/players/mizan/opl/CELLS/C555", "east",
		"/players/mizan/opl/CELLS/C553", "west",
	});
