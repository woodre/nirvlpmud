...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5574", "north",
		"/players/mizan/opl/CELLS/C5814", "south",
		"/players/mizan/opl/CELLS/C5695", "east",
		"/players/mizan/opl/CELLS/C5693", "west",
	});
