...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1376", "north",
		"/players/mizan/opl/CELLS/C1616", "south",
		"/players/mizan/opl/CELLS/C1497", "east",
		"/players/mizan/opl/CELLS/C1495", "west",
	});
