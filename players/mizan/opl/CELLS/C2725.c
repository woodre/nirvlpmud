...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2605", "north",
		"/players/mizan/opl/CELLS/C2845", "south",
		"/players/mizan/opl/CELLS/C2726", "east",
		"/players/mizan/opl/CELLS/C2724", "west",
	});
