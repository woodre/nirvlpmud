...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5863", "north",
		"/players/mizan/opl/CELLS/C6103", "south",
		"/players/mizan/opl/CELLS/C5984", "east",
		"/players/mizan/opl/CELLS/C5982", "west",
	});
