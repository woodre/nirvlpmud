...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1835", "north",
		"/players/mizan/opl/CELLS/C2075", "south",
		"/players/mizan/opl/CELLS/C1956", "east",
		"/players/mizan/opl/CELLS/C1954", "west",
	});
