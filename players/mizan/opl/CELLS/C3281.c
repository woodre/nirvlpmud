...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3161", "north",
		"/players/mizan/opl/CELLS/C3401", "south",
		"/players/mizan/opl/CELLS/C3282", "east",
		"/players/mizan/opl/CELLS/C3280", "west",
	});
