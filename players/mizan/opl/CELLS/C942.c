...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C822", "north",
		"/players/mizan/opl/CELLS/C1062", "south",
		"/players/mizan/opl/CELLS/C943", "east",
		"/players/mizan/opl/CELLS/C941", "west",
	});
...
long()
{
	...
	write("\"felt tip, v.:	Past tense for a breast examination!\"\n");
