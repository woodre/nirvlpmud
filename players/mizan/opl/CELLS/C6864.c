...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6744", "north",
		"/players/mizan/opl/CELLS/C6984", "south",
		"/players/mizan/opl/CELLS/C6865", "east",
	});
...
long()
{
	...
	write("\"This PORCUPINE knows his ZIPCODE ... And he has 'VISA'!!\"\n");
