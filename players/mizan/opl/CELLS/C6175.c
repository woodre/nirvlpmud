...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6055", "north",
		"/players/mizan/opl/CELLS/C6295", "south",
		"/players/mizan/opl/CELLS/C6176", "east",
		"/players/mizan/opl/CELLS/C6174", "west",
	});
