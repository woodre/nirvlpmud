...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5516", "south",
		"/players/mizan/opl/CELLS/C5397", "east",
		"/players/mizan/opl/CELLS/C5395", "west",
	});
...
long()
{
	...
	write("\"oral sex, n.:	The taste of things to come.\"\n");
