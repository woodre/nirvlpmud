...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3645", "north",
		"/players/mizan/opl/CELLS/C3885", "south",
		"/players/mizan/opl/CELLS/C3766", "east",
		"/players/mizan/opl/CELLS/C3764", "west",
	});
