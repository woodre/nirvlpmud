...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1573", "north",
		"/players/mizan/opl/CELLS/C1813", "south",
		"/players/mizan/opl/CELLS/C1694", "east",
		"/players/mizan/opl/CELLS/C1692", "west",
	});
