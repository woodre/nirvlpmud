...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2861", "north",
		"/players/mizan/opl/CELLS/C3101", "south",
		"/players/mizan/opl/CELLS/C2982", "east",
		"/players/mizan/opl/CELLS/C2980", "west",
	});
