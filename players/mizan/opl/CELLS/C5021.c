...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4901", "north",
		"/players/mizan/opl/CELLS/C5022", "east",
		"/players/mizan/opl/CELLS/C5020", "west",
	});
...
long()
{
	...
	write("\"BARBARA STANWYCK makes me nervous!!\"\n");
