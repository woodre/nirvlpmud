...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6473", "east",
		"/players/mizan/opl/CELLS/C6471", "west",
	});
...
long()
{
	...
	write("\"'The hell with the prime directive! Let's kill something!'\"\n");
