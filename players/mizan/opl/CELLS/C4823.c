...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4703", "north",
		"/players/mizan/opl/CELLS/C4943", "south",
		"/players/mizan/opl/CELLS/C4824", "east",
		"/players/mizan/opl/CELLS/C4822", "west",
	});
