...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4705", "north",
		"/players/mizan/opl/CELLS/C4945", "south",
		"/players/mizan/opl/CELLS/C4826", "east",
		"/players/mizan/opl/CELLS/C4824", "west",
	});
