...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5920", "north",
		"/players/mizan/opl/CELLS/C6160", "south",
		"/players/mizan/opl/CELLS/C6041", "east",
		"/players/mizan/opl/CELLS/C6039", "west",
	});
