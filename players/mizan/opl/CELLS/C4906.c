...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4786", "north",
		"/players/mizan/opl/CELLS/C4907", "east",
		"/players/mizan/opl/CELLS/C4905", "west",
	});
...
long()
{
	...
	write("\"Lawyers do it to everyone.\"\n");
