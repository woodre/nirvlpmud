...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2122", "north",
		"/players/mizan/opl/CELLS/C2362", "south",
		"/players/mizan/opl/CELLS/C2243", "east",
		"/players/mizan/opl/CELLS/C2241", "west",
	});
