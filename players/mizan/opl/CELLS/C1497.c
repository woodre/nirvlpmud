...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1377", "north",
		"/players/mizan/opl/CELLS/C1617", "south",
		"/players/mizan/opl/CELLS/C1498", "east",
		"/players/mizan/opl/CELLS/C1496", "west",
	});
