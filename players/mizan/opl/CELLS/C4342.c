...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4222", "north",
		"/players/mizan/opl/CELLS/C4462", "south",
		"/players/mizan/opl/CELLS/C4343", "east",
		"/players/mizan/opl/CELLS/C4341", "west",
	});
