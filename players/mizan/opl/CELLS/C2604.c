...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2484", "north",
		"/players/mizan/opl/CELLS/C2724", "south",
		"/players/mizan/opl/CELLS/C2605", "east",
		"/players/mizan/opl/CELLS/C2603", "west",
	});
