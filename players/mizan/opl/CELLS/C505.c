...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C625", "south",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/vehicles/tiger1.c");
...
long()
{
	...
	write("\"computerfirm nymphomaniac, n:	Hot Apple pie.\"\n");
