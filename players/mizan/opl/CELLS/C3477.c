...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3357", "north",
		"/players/mizan/opl/CELLS/C3597", "south",
		"/players/mizan/opl/CELLS/C3478", "east",
		"/players/mizan/opl/CELLS/C3476", "west",
	});
