...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4853", "north",
		"/players/mizan/opl/CELLS/C5093", "south",
		"/players/mizan/opl/CELLS/C4974", "east",
		"/players/mizan/opl/CELLS/C4972", "west",
	});
