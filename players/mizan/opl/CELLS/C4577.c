...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4457", "north",
		"/players/mizan/opl/CELLS/C4697", "south",
		"/players/mizan/opl/CELLS/C4578", "east",
		"/players/mizan/opl/CELLS/C4576", "west",
	});
