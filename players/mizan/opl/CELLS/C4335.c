...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4215", "north",
		"/players/mizan/opl/CELLS/C4455", "south",
		"/players/mizan/opl/CELLS/C4336", "east",
		"/players/mizan/opl/CELLS/C4334", "west",
	});
