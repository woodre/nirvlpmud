...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1046", "north",
		"/players/mizan/opl/CELLS/C1286", "south",
		"/players/mizan/opl/CELLS/C1167", "east",
		"/players/mizan/opl/CELLS/C1165", "west",
	});
