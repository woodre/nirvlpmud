...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4720", "north",
		"/players/mizan/opl/CELLS/C4960", "south",
		"/players/mizan/opl/CELLS/C4841", "east",
		"/players/mizan/opl/CELLS/C4839", "west",
	});
