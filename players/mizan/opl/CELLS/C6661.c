...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6541", "north",
		"/players/mizan/opl/CELLS/C6781", "south",
		"/players/mizan/opl/CELLS/C6662", "east",
		"/players/mizan/opl/CELLS/C6660", "west",
	});
