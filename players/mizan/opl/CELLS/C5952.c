...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5832", "north",
		"/players/mizan/opl/CELLS/C6072", "south",
		"/players/mizan/opl/CELLS/C5953", "east",
		"/players/mizan/opl/CELLS/C5951", "west",
	});
