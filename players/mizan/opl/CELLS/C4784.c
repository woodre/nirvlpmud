...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4664", "north",
		"/players/mizan/opl/CELLS/C4904", "south",
		"/players/mizan/opl/CELLS/C4785", "east",
	});
...
long()
{
	...
	write("\"David was just a shepherd who liked to get his rocks off in leather.\"\n");
