...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3880", "north",
		"/players/mizan/opl/CELLS/C4120", "south",
		"/players/mizan/opl/CELLS/C4001", "east",
		"/players/mizan/opl/CELLS/C3999", "west",
	});
