...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5351", "north",
		"/players/mizan/opl/CELLS/C5591", "south",
		"/players/mizan/opl/CELLS/C5472", "east",
		"/players/mizan/opl/CELLS/C5470", "west",
	});
