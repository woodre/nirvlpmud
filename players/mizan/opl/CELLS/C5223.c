...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5103", "north",
		"/players/mizan/opl/CELLS/C5343", "south",
		"/players/mizan/opl/CELLS/C5224", "east",
		"/players/mizan/opl/CELLS/C5222", "west",
	});
