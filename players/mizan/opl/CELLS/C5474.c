...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5354", "north",
		"/players/mizan/opl/CELLS/C5594", "south",
		"/players/mizan/opl/CELLS/C5475", "east",
		"/players/mizan/opl/CELLS/C5473", "west",
	});
