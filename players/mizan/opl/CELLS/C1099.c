...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1098", "west",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C1099");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I1099");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I1099");
...
long()
{
	...
	write("\"I am a jelly donut. I am a jelly donut.\"\n");
