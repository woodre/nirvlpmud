...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3311", "north",
		"/players/mizan/opl/CELLS/C3551", "south",
		"/players/mizan/opl/CELLS/C3432", "east",
		"/players/mizan/opl/CELLS/C3430", "west",
	});
...
long()
{
	...
	write("\"Most men would never get laid if it weren't for the pity fuck.\"\n");
