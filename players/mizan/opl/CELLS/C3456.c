...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3576", "south",
		"/players/mizan/opl/CELLS/C3455", "west",
	});
...
long()
{
	...
	write("\"Ah spring, when a fancy young man lightly turns his lover over.\"\n");
