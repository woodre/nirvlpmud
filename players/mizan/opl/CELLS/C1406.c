...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1286", "north",
		"/players/mizan/opl/CELLS/C1526", "south",
		"/players/mizan/opl/CELLS/C1407", "east",
		"/players/mizan/opl/CELLS/C1405", "west",
	});
