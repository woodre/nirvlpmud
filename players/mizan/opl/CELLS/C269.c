...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C149", "north",
		"/players/mizan/opl/CELLS/C389", "south",
		"/players/mizan/opl/CELLS/C268", "west",
	});
...
long()
{
	...
	write("\"TONY RANDALL! Is YOUR life a PATIO of FUN??\"\n");
