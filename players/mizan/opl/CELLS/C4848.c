...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4728", "north",
		"/players/mizan/opl/CELLS/C4968", "south",
		"/players/mizan/opl/CELLS/C4849", "east",
		"/players/mizan/opl/CELLS/C4847", "west",
	});
