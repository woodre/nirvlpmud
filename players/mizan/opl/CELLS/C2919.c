...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2799", "north",
		"/players/mizan/opl/CELLS/C3039", "south",
		"/players/mizan/opl/CELLS/C2920", "east",
		"/players/mizan/opl/CELLS/C2918", "west",
	});
