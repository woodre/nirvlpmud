...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5865", "north",
		"/players/mizan/opl/CELLS/C6105", "south",
		"/players/mizan/opl/CELLS/C5986", "east",
		"/players/mizan/opl/CELLS/C5984", "west",
	});
