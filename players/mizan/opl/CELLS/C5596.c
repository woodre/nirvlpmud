...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5476", "north",
		"/players/mizan/opl/CELLS/C5716", "south",
		"/players/mizan/opl/CELLS/C5597", "east",
		"/players/mizan/opl/CELLS/C5595", "west",
	});
