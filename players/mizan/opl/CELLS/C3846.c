...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3726", "north",
		"/players/mizan/opl/CELLS/C3966", "south",
		"/players/mizan/opl/CELLS/C3847", "east",
		"/players/mizan/opl/CELLS/C3845", "west",
	});
