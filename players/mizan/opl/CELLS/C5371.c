...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5251", "north",
		"/players/mizan/opl/CELLS/C5491", "south",
		"/players/mizan/opl/CELLS/C5372", "east",
		"/players/mizan/opl/CELLS/C5370", "west",
	});
