...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5522", "north",
		"/players/mizan/opl/CELLS/C5762", "south",
		"/players/mizan/opl/CELLS/C5641", "west",
	});
...
long()
{
	...
	write("\"Negotiate, my ass! Let's kill something!\"\n");
