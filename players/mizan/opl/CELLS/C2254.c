...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2134", "north",
		"/players/mizan/opl/CELLS/C2374", "south",
		"/players/mizan/opl/CELLS/C2255", "east",
		"/players/mizan/opl/CELLS/C2253", "west",
	});
