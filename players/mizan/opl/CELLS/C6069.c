...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5949", "north",
		"/players/mizan/opl/CELLS/C6189", "south",
		"/players/mizan/opl/CELLS/C6070", "east",
		"/players/mizan/opl/CELLS/C6068", "west",
	});
