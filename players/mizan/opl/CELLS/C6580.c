...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6460", "north",
		"/players/mizan/opl/CELLS/C6700", "south",
		"/players/mizan/opl/CELLS/C6581", "east",
		"/players/mizan/opl/CELLS/C6579", "west",
	});
