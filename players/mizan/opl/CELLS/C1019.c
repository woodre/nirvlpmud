...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C899", "north",
		"/players/mizan/opl/CELLS/C1139", "south",
	});
...
long()
{
	...
	write("\"If men couldn't fuck there'd be a bounty on their heads.\"\n");
