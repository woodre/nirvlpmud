...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6180", "north",
		"/players/mizan/opl/CELLS/C6420", "south",
		"/players/mizan/opl/CELLS/C6301", "east",
		"/players/mizan/opl/CELLS/C6299", "west",
	});
