...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4203", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C4083");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I4083");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I4083");
...
long()
{
	...
	write("\"The world is an 8000 mile in diameter spherical pile of shit.\"\n");
