...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5958", "north",
		"/players/mizan/opl/CELLS/C6198", "south",
		"/players/mizan/opl/CELLS/C6079", "east",
		"/players/mizan/opl/CELLS/C6077", "west",
	});
