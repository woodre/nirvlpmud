...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4604", "north",
		"/players/mizan/opl/CELLS/C4844", "south",
		"/players/mizan/opl/CELLS/C4725", "east",
		"/players/mizan/opl/CELLS/C4723", "west",
	});
