...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6423", "north",
		"/players/mizan/opl/CELLS/C6663", "south",
		"/players/mizan/opl/CELLS/C6544", "east",
		"/players/mizan/opl/CELLS/C6542", "west",
	});
