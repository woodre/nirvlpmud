...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5575", "north",
		"/players/mizan/opl/CELLS/C5815", "south",
		"/players/mizan/opl/CELLS/C5696", "east",
		"/players/mizan/opl/CELLS/C5694", "west",
	});
