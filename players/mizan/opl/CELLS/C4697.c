...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4577", "north",
		"/players/mizan/opl/CELLS/C4817", "south",
		"/players/mizan/opl/CELLS/C4698", "east",
		"/players/mizan/opl/CELLS/C4696", "west",
	});
