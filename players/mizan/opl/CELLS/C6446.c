...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6326", "north",
		"/players/mizan/opl/CELLS/C6447", "east",
		"/players/mizan/opl/CELLS/C6445", "west",
	});
...
long()
{
	...
	write("\"Marijuana is nature's way of saying, 'Hi!'.\"\n");
