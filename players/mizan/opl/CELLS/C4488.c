...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4368", "north",
		"/players/mizan/opl/CELLS/C4608", "south",
		"/players/mizan/opl/CELLS/C4489", "east",
		"/players/mizan/opl/CELLS/C4487", "west",
	});
