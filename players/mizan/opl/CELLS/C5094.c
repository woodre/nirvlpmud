...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4974", "north",
		"/players/mizan/opl/CELLS/C5214", "south",
		"/players/mizan/opl/CELLS/C5095", "east",
		"/players/mizan/opl/CELLS/C5093", "west",
	});
