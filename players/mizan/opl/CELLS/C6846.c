...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6726", "north",
		"/players/mizan/opl/CELLS/C6966", "south",
		"/players/mizan/opl/CELLS/C6845", "west",
	});
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/ogre.c");
...
long()
{
	...
	write("\"I want another RE-WRITE on my CEASAR SALAD!!\"\n");
