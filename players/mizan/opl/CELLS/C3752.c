...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3632", "north",
		"/players/mizan/opl/CELLS/C3872", "south",
		"/players/mizan/opl/CELLS/C3753", "east",
		"/players/mizan/opl/CELLS/C3751", "west",
	});
