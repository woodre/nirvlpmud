...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5233", "north",
		"/players/mizan/opl/CELLS/C5473", "south",
		"/players/mizan/opl/CELLS/C5354", "east",
		"/players/mizan/opl/CELLS/C5352", "west",
	});
