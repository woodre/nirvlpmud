...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1955", "north",
		"/players/mizan/opl/CELLS/C2195", "south",
		"/players/mizan/opl/CELLS/C2076", "east",
		"/players/mizan/opl/CELLS/C2074", "west",
	});
