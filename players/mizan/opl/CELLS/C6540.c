...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6420", "north",
		"/players/mizan/opl/CELLS/C6660", "south",
		"/players/mizan/opl/CELLS/C6541", "east",
		"/players/mizan/opl/CELLS/C6539", "west",
	});
