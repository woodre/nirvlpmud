...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1900", "north",
		"/players/mizan/opl/CELLS/C2140", "south",
		"/players/mizan/opl/CELLS/C2021", "east",
		"/players/mizan/opl/CELLS/C2019", "west",
	});
