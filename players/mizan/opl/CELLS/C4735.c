...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4615", "north",
		"/players/mizan/opl/CELLS/C4855", "south",
		"/players/mizan/opl/CELLS/C4736", "east",
		"/players/mizan/opl/CELLS/C4734", "west",
	});
