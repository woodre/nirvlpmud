...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3977", "north",
		"/players/mizan/opl/CELLS/C4217", "south",
		"/players/mizan/opl/CELLS/C4098", "east",
		"/players/mizan/opl/CELLS/C4096", "west",
	});
