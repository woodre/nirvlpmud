...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3902", "north",
		"/players/mizan/opl/CELLS/C4142", "south",
		"/players/mizan/opl/CELLS/C4023", "east",
		"/players/mizan/opl/CELLS/C4021", "west",
	});
