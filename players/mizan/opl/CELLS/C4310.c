...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4190", "north",
		"/players/mizan/opl/CELLS/C4430", "south",
		"/players/mizan/opl/CELLS/C4311", "east",
		"/players/mizan/opl/CELLS/C4309", "west",
	});
