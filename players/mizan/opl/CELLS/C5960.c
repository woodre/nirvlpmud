...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5840", "north",
		"/players/mizan/opl/CELLS/C6080", "south",
		"/players/mizan/opl/CELLS/C5961", "east",
		"/players/mizan/opl/CELLS/C5959", "west",
	});
