...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5596", "north",
		"/players/mizan/opl/CELLS/C5836", "south",
		"/players/mizan/opl/CELLS/C5717", "east",
		"/players/mizan/opl/CELLS/C5715", "west",
	});
