...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2388", "north",
		"/players/mizan/opl/CELLS/C2628", "south",
		"/players/mizan/opl/CELLS/C2509", "east",
		"/players/mizan/opl/CELLS/C2507", "west",
	});
