...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6038", "north",
		"/players/mizan/opl/CELLS/C6278", "south",
		"/players/mizan/opl/CELLS/C6159", "east",
		"/players/mizan/opl/CELLS/C6157", "west",
	});
