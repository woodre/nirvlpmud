...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3342", "north",
		"/players/mizan/opl/CELLS/C3582", "south",
		"/players/mizan/opl/CELLS/C3461", "west",
	});
...
long()
{
	...
	write("\"Hell hath no fury like a bureaucrat scorned.		-- Milton Friedman\"\n");
