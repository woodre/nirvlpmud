...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6854", "north",
		"/players/mizan/opl/CELLS/C6975", "east",
		"/players/mizan/opl/CELLS/C6973", "west",
	});
...
long()
{
	...
	write("\"What PROGRAM are they watching?\"\n");
