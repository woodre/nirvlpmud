...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3428", "north",
		"/players/mizan/opl/CELLS/C3668", "south",
		"/players/mizan/opl/CELLS/C3549", "east",
		"/players/mizan/opl/CELLS/C3547", "west",
	});
...
long()
{
	...
	write("\"Bumper sticker seen:  Geez if you believe in Honkus.\"\n");
