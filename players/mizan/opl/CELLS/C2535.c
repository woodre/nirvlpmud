...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2415", "north",
		"/players/mizan/opl/CELLS/C2536", "east",
		"/players/mizan/opl/CELLS/C2534", "west",
	});
...
long()
{
	...
	write("\"A man without a God is like a fish without a bicycle.\"\n");
