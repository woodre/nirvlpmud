...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1816", "north",
		"/players/mizan/opl/CELLS/C2056", "south",
		"/players/mizan/opl/CELLS/C1937", "east",
		"/players/mizan/opl/CELLS/C1935", "west",
	});
...
long()
{
	...
	write("\"WASP, n.:	Someone who gets out of the shower to take a piss.\"\n");
