...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5917", "north",
		"/players/mizan/opl/CELLS/C6157", "south",
		"/players/mizan/opl/CELLS/C6038", "east",
		"/players/mizan/opl/CELLS/C6036", "west",
	});
