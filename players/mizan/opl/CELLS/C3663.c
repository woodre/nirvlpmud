...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3664", "east",
		"/players/mizan/opl/CELLS/C3662", "west",
	});
...
long()
{
	...
	write("\"Systems people do it with a small, but clean, interface.\"\n");
