...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2669", "north",
		"/players/mizan/opl/CELLS/C2909", "south",
		"/players/mizan/opl/CELLS/C2790", "east",
		"/players/mizan/opl/CELLS/C2788", "west",
	});
