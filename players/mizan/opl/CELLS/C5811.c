...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5691", "north",
		"/players/mizan/opl/CELLS/C5931", "south",
		"/players/mizan/opl/CELLS/C5812", "east",
		"/players/mizan/opl/CELLS/C5810", "west",
	});
