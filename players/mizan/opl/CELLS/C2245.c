...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2125", "north",
		"/players/mizan/opl/CELLS/C2365", "south",
		"/players/mizan/opl/CELLS/C2246", "east",
		"/players/mizan/opl/CELLS/C2244", "west",
	});
