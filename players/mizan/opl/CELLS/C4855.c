...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4735", "north",
		"/players/mizan/opl/CELLS/C4975", "south",
		"/players/mizan/opl/CELLS/C4856", "east",
		"/players/mizan/opl/CELLS/C4854", "west",
	});
