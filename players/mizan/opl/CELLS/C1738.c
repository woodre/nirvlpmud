...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1618", "north",
		"/players/mizan/opl/CELLS/C1858", "south",
		"/players/mizan/opl/CELLS/C1739", "east",
		"/players/mizan/opl/CELLS/C1737", "west",
	});
