...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4850", "north",
		"/players/mizan/opl/CELLS/C5090", "south",
		"/players/mizan/opl/CELLS/C4971", "east",
		"/players/mizan/opl/CELLS/C4969", "west",
	});
