...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4149", "north",
		"/players/mizan/opl/CELLS/C4389", "south",
		"/players/mizan/opl/CELLS/C4270", "east",
		"/players/mizan/opl/CELLS/C4268", "west",
	});
