...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6913", "north",
		"/players/mizan/opl/CELLS/C7032", "west",
	});
...
long()
{
	...
	write("\"Yow! It's some people inside the wall! This is better than mopping!\"\n");
