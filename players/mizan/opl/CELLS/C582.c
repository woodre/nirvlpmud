...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C462", "north",
		"/players/mizan/opl/CELLS/C702", "south",
		"/players/mizan/opl/CELLS/C583", "east",
		"/players/mizan/opl/CELLS/C581", "west",
	});
