...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4627", "north",
		"/players/mizan/opl/CELLS/C4867", "south",
		"/players/mizan/opl/CELLS/C4748", "east",
		"/players/mizan/opl/CELLS/C4746", "west",
	});
