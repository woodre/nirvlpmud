...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3545", "south",
		"/players/mizan/opl/CELLS/C3426", "east",
		"/players/mizan/opl/CELLS/C3424", "west",
	});
...
long()
{
	...
	write("\"I wonder if I could ever get started in the credit world?\"\n");
