...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4958", "north",
		"/players/mizan/opl/CELLS/C5198", "south",
		"/players/mizan/opl/CELLS/C5079", "east",
		"/players/mizan/opl/CELLS/C5077", "west",
	});
