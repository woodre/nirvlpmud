...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4092", "north",
		"/players/mizan/opl/CELLS/C4332", "south",
		"/players/mizan/opl/CELLS/C4213", "east",
		"/players/mizan/opl/CELLS/C4211", "west",
	});
