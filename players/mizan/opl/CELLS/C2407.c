...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2527", "south",
		"/players/mizan/opl/CELLS/C2408", "east",
		"/players/mizan/opl/CELLS/C2406", "west",
	});
...
long()
{
	...
	write("\"I am not a crook.		-- Richard Nixon\"\n");
