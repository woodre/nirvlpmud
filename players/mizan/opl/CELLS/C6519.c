...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6399", "north",
		"/players/mizan/opl/CELLS/C6639", "south",
		"/players/mizan/opl/CELLS/C6520", "east",
		"/players/mizan/opl/CELLS/C6518", "west",
	});
