...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5252", "north",
		"/players/mizan/opl/CELLS/C5492", "south",
		"/players/mizan/opl/CELLS/C5373", "east",
		"/players/mizan/opl/CELLS/C5371", "west",
	});
