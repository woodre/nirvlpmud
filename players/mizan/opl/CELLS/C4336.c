...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4216", "north",
		"/players/mizan/opl/CELLS/C4456", "south",
		"/players/mizan/opl/CELLS/C4337", "east",
		"/players/mizan/opl/CELLS/C4335", "west",
	});
