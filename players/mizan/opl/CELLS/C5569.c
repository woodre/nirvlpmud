...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5449", "north",
		"/players/mizan/opl/CELLS/C5689", "south",
		"/players/mizan/opl/CELLS/C5570", "east",
		"/players/mizan/opl/CELLS/C5568", "west",
	});
