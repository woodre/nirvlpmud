...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5816", "north",
		"/players/mizan/opl/CELLS/C6056", "south",
		"/players/mizan/opl/CELLS/C5937", "east",
		"/players/mizan/opl/CELLS/C5935", "west",
	});
