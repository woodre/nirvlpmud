...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3761", "north",
		"/players/mizan/opl/CELLS/C4001", "south",
		"/players/mizan/opl/CELLS/C3882", "east",
		"/players/mizan/opl/CELLS/C3880", "west",
	});
