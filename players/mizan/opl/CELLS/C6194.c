...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6074", "north",
		"/players/mizan/opl/CELLS/C6314", "south",
		"/players/mizan/opl/CELLS/C6195", "east",
		"/players/mizan/opl/CELLS/C6193", "west",
	});
