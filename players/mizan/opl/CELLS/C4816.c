...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4696", "north",
		"/players/mizan/opl/CELLS/C4936", "south",
		"/players/mizan/opl/CELLS/C4817", "east",
		"/players/mizan/opl/CELLS/C4815", "west",
	});
