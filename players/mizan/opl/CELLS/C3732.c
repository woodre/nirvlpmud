...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3612", "north",
		"/players/mizan/opl/CELLS/C3852", "south",
		"/players/mizan/opl/CELLS/C3733", "east",
		"/players/mizan/opl/CELLS/C3731", "west",
	});
