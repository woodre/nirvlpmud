...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1584", "north",
		"/players/mizan/opl/CELLS/C1824", "south",
		"/players/mizan/opl/CELLS/C1705", "east",
		"/players/mizan/opl/CELLS/C1703", "west",
	});
