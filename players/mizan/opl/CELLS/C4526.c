...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4406", "north",
		"/players/mizan/opl/CELLS/C4646", "south",
		"/players/mizan/opl/CELLS/C4527", "east",
		"/players/mizan/opl/CELLS/C4525", "west",
	});
...
long()
{
	...
	write("\"In outer space, nobody can hear you fart.\"\n");
