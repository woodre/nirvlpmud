...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3491", "north",
		"/players/mizan/opl/CELLS/C3731", "south",
		"/players/mizan/opl/CELLS/C3612", "east",
		"/players/mizan/opl/CELLS/C3610", "west",
	});
