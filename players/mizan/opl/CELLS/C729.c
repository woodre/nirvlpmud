...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C609", "north",
		"/players/mizan/opl/CELLS/C849", "south",
		"/players/mizan/opl/CELLS/C730", "east",
		"/players/mizan/opl/CELLS/C728", "west",
	});
