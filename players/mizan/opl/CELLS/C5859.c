...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5739", "north",
		"/players/mizan/opl/CELLS/C5979", "south",
		"/players/mizan/opl/CELLS/C5860", "east",
		"/players/mizan/opl/CELLS/C5858", "west",
	});
