...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2909", "north",
		"/players/mizan/opl/CELLS/C3149", "south",
		"/players/mizan/opl/CELLS/C3030", "east",
		"/players/mizan/opl/CELLS/C3028", "west",
	});
