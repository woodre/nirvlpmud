...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6725", "north",
		"/players/mizan/opl/CELLS/C6965", "south",
		"/players/mizan/opl/CELLS/C6846", "east",
		"/players/mizan/opl/CELLS/C6844", "west",
	});
...
long()
{
	...
	write("\"vagina, n.:	The box a penis comes in.\"\n");
