...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C118", "north",
		"/players/mizan/opl/CELLS/C358", "south",
		"/players/mizan/opl/CELLS/C237", "west",
	});
...
long()
{
	...
	write("\"tearing off a quicky:	Gunning the jump.\"\n");
