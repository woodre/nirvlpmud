...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1380", "north",
		"/players/mizan/opl/CELLS/C1620", "south",
		"/players/mizan/opl/CELLS/C1501", "east",
		"/players/mizan/opl/CELLS/C1499", "west",
	});
