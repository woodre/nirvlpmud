...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5094", "north",
		"/players/mizan/opl/CELLS/C5334", "south",
		"/players/mizan/opl/CELLS/C5215", "east",
		"/players/mizan/opl/CELLS/C5213", "west",
	});
