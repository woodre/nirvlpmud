...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2032", "north",
		"/players/mizan/opl/CELLS/C2272", "south",
		"/players/mizan/opl/CELLS/C2153", "east",
		"/players/mizan/opl/CELLS/C2151", "west",
	});
