...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4755", "north",
		"/players/mizan/opl/CELLS/C4995", "south",
		"/players/mizan/opl/CELLS/C4876", "east",
		"/players/mizan/opl/CELLS/C4874", "west",
	});
