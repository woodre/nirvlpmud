...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5080", "north",
		"/players/mizan/opl/CELLS/C5320", "south",
		"/players/mizan/opl/CELLS/C5201", "east",
		"/players/mizan/opl/CELLS/C5199", "west",
	});
