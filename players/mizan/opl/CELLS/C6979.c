...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6980", "east",
		"/players/mizan/opl/CELLS/C6978", "west",
	});
...
long()
{
	...
	write("\"Short man who dance with tall woman gets bust in mouth.\"\n");
