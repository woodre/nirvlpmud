...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1887", "north",
		"/players/mizan/opl/CELLS/C2127", "south",
		"/players/mizan/opl/CELLS/C2008", "east",
		"/players/mizan/opl/CELLS/C2006", "west",
	});
