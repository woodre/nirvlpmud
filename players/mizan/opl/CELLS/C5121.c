...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5001", "north",
		"/players/mizan/opl/CELLS/C5241", "south",
		"/players/mizan/opl/CELLS/C5122", "east",
		"/players/mizan/opl/CELLS/C5120", "west",
	});
