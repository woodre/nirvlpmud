...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4286", "north",
		"/players/mizan/opl/CELLS/C4526", "south",
		"/players/mizan/opl/CELLS/C4407", "east",
	});
...
long()
{
	...
	write("\"Man created God in his own image.\"\n");
