...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4992", "north",
		"/players/mizan/opl/CELLS/C5232", "south",
		"/players/mizan/opl/CELLS/C5113", "east",
		"/players/mizan/opl/CELLS/C5111", "west",
	});
