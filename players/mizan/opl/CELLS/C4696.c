...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4576", "north",
		"/players/mizan/opl/CELLS/C4816", "south",
		"/players/mizan/opl/CELLS/C4697", "east",
		"/players/mizan/opl/CELLS/C4695", "west",
	});
