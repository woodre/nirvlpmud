...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C345", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C225");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I225");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I225");
...
long()
{
	...
	write("\"Flirt, n.:	A girl whose favorite man is the next one.\"\n");
