...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4012", "north",
		"/players/mizan/opl/CELLS/C4252", "south",
		"/players/mizan/opl/CELLS/C4133", "east",
		"/players/mizan/opl/CELLS/C4131", "west",
	});
