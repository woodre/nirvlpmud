...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4419", "north",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C4539");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I4539");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I4539");
...
long()
{
	...
	write("\"Q:	What do WASPs do instead of making love?A:	Rule the country.\"\n");
