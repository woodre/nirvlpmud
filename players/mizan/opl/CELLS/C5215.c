...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5095", "north",
		"/players/mizan/opl/CELLS/C5335", "south",
		"/players/mizan/opl/CELLS/C5216", "east",
		"/players/mizan/opl/CELLS/C5214", "west",
	});
