...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4607", "north",
		"/players/mizan/opl/CELLS/C4847", "south",
		"/players/mizan/opl/CELLS/C4728", "east",
		"/players/mizan/opl/CELLS/C4726", "west",
	});
