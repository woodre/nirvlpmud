...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4989", "north",
		"/players/mizan/opl/CELLS/C5229", "south",
		"/players/mizan/opl/CELLS/C5110", "east",
		"/players/mizan/opl/CELLS/C5108", "west",
	});
