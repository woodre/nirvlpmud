...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5696", "north",
		"/players/mizan/opl/CELLS/C5936", "south",
		"/players/mizan/opl/CELLS/C5817", "east",
		"/players/mizan/opl/CELLS/C5815", "west",
	});
