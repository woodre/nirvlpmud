...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C461", "north",
		"/players/mizan/opl/CELLS/C701", "south",
		"/players/mizan/opl/CELLS/C582", "east",
		"/players/mizan/opl/CELLS/C580", "west",
	});
