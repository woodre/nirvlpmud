...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C806", "north",
		"/players/mizan/opl/CELLS/C1046", "south",
		"/players/mizan/opl/CELLS/C927", "east",
		"/players/mizan/opl/CELLS/C925", "west",
	});
