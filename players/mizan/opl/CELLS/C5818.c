...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5698", "north",
		"/players/mizan/opl/CELLS/C5938", "south",
		"/players/mizan/opl/CELLS/C5819", "east",
		"/players/mizan/opl/CELLS/C5817", "west",
	});
