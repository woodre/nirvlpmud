...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5687", "north",
		"/players/mizan/opl/CELLS/C5927", "south",
		"/players/mizan/opl/CELLS/C5808", "east",
		"/players/mizan/opl/CELLS/C5806", "west",
	});
