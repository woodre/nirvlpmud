...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1901", "north",
		"/players/mizan/opl/CELLS/C2141", "south",
		"/players/mizan/opl/CELLS/C2022", "east",
		"/players/mizan/opl/CELLS/C2020", "west",
	});
...
long()
{
	...
	write("\"Murray's Rule:	Any country with 'democratic' in the title isn't.\"\n");
