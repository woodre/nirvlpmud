...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6385", "south",
		"/players/mizan/opl/CELLS/C6266", "east",
		"/players/mizan/opl/CELLS/C6264", "west",
	});
...
long()
{
	...
	write("\"Reality is for people who can't deal with drugs.		-- Lily Tomlin\"\n");
