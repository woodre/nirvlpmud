...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C605", "north",
		"/players/mizan/opl/CELLS/C845", "south",
		"/players/mizan/opl/CELLS/C726", "east",
		"/players/mizan/opl/CELLS/C724", "west",
	});
