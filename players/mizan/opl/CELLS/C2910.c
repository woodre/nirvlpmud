...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2790", "north",
		"/players/mizan/opl/CELLS/C3030", "south",
		"/players/mizan/opl/CELLS/C2911", "east",
		"/players/mizan/opl/CELLS/C2909", "west",
	});
