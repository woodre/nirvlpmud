...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1071", "north",
		"/players/mizan/opl/CELLS/C1311", "south",
	});
...
long()
{
	...
	write("\"Re: God...1) The emperor has no clothes.2) There is no emperor.\"\n");
