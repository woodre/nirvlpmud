...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3978", "north",
		"/players/mizan/opl/CELLS/C4218", "south",
		"/players/mizan/opl/CELLS/C4099", "east",
		"/players/mizan/opl/CELLS/C4097", "west",
	});
