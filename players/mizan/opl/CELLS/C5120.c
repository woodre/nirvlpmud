...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5000", "north",
		"/players/mizan/opl/CELLS/C5240", "south",
		"/players/mizan/opl/CELLS/C5121", "east",
		"/players/mizan/opl/CELLS/C5119", "west",
	});
