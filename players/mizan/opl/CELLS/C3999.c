...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3879", "north",
		"/players/mizan/opl/CELLS/C4119", "south",
		"/players/mizan/opl/CELLS/C4000", "east",
		"/players/mizan/opl/CELLS/C3998", "west",
	});
