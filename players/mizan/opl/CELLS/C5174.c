...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5054", "north",
		"/players/mizan/opl/CELLS/C5294", "south",
	});
...
long()
{
	...
	write("\"Civilization and profits go hand in hand.		-- Calvin Coolidge\"\n");
