...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2418", "north",
		"/players/mizan/opl/CELLS/C2658", "south",
	});
...
long()
{
	...
	write("\"Her kisses left something to be desired: the rest of her.\"\n");
