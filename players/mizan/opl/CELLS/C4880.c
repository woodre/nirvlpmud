...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4760", "north",
		"/players/mizan/opl/CELLS/C5000", "south",
		"/players/mizan/opl/CELLS/C4881", "east",
		"/players/mizan/opl/CELLS/C4879", "west",
	});
