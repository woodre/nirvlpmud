...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4598", "north",
		"/players/mizan/opl/CELLS/C4838", "south",
		"/players/mizan/opl/CELLS/C4719", "east",
		"/players/mizan/opl/CELLS/C4717", "west",
	});
