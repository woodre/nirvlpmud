...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4794", "north",
		"/players/mizan/opl/CELLS/C5034", "south",
		"/players/mizan/opl/CELLS/C4915", "east",
		"/players/mizan/opl/CELLS/C4913", "west",
	});
