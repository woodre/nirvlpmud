...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6288", "north",
		"/players/mizan/opl/CELLS/C6528", "south",
		"/players/mizan/opl/CELLS/C6409", "east",
		"/players/mizan/opl/CELLS/C6407", "west",
	});
