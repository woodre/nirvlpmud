...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4489", "north",
		"/players/mizan/opl/CELLS/C4729", "south",
		"/players/mizan/opl/CELLS/C4610", "east",
		"/players/mizan/opl/CELLS/C4608", "west",
	});
