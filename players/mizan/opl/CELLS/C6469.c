...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6349", "north",
		"/players/mizan/opl/CELLS/C6589", "south",
		"/players/mizan/opl/CELLS/C6468", "west",
	});
...
long()
{
	...
	write("\"Eisenhower!! Your mimeograph machine upsets my stomach!!\"\n");
