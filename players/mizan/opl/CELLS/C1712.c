...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1592", "north",
		"/players/mizan/opl/CELLS/C1832", "south",
		"/players/mizan/opl/CELLS/C1713", "east",
		"/players/mizan/opl/CELLS/C1711", "west",
	});
