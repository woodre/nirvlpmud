...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5348", "north",
		"/players/mizan/opl/CELLS/C5588", "south",
		"/players/mizan/opl/CELLS/C5469", "east",
		"/players/mizan/opl/CELLS/C5467", "west",
	});
