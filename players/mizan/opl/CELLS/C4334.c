...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4214", "north",
		"/players/mizan/opl/CELLS/C4454", "south",
		"/players/mizan/opl/CELLS/C4335", "east",
		"/players/mizan/opl/CELLS/C4333", "west",
	});
