...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3746", "north",
		"/players/mizan/opl/CELLS/C3986", "south",
		"/players/mizan/opl/CELLS/C3867", "east",
	});
...
long()
{
	...
	write("\"Are you still an ALCOHOLIC?\"\n");
