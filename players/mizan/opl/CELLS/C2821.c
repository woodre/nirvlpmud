...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2822", "east",
		"/players/mizan/opl/CELLS/C2820", "west",
	});
...
long()
{
	...
	write("\"Jesus loves you, but everybody else thinks you're a dork.\"\n");
