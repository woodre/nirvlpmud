...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3490", "north",
		"/players/mizan/opl/CELLS/C3730", "south",
		"/players/mizan/opl/CELLS/C3611", "east",
		"/players/mizan/opl/CELLS/C3609", "west",
	});
