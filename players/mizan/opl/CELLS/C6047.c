...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5927", "north",
		"/players/mizan/opl/CELLS/C6167", "south",
		"/players/mizan/opl/CELLS/C6048", "east",
		"/players/mizan/opl/CELLS/C6046", "west",
	});
