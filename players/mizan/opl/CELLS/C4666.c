...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4786", "south",
		"/players/mizan/opl/CELLS/C4667", "east",
		"/players/mizan/opl/CELLS/C4665", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/medium/guard_turkey.c");
