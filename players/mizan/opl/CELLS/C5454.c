...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5334", "north",
		"/players/mizan/opl/CELLS/C5574", "south",
		"/players/mizan/opl/CELLS/C5455", "east",
		"/players/mizan/opl/CELLS/C5453", "west",
	});
