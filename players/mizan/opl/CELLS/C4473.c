...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4353", "north",
		"/players/mizan/opl/CELLS/C4593", "south",
		"/players/mizan/opl/CELLS/C4474", "east",
		"/players/mizan/opl/CELLS/C4472", "west",
	});
