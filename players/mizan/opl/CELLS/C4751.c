...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4631", "north",
		"/players/mizan/opl/CELLS/C4871", "south",
		"/players/mizan/opl/CELLS/C4752", "east",
		"/players/mizan/opl/CELLS/C4750", "west",
	});
