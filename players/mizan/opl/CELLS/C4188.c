...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4068", "north",
		"/players/mizan/opl/CELLS/C4308", "south",
		"/players/mizan/opl/CELLS/C4189", "east",
		"/players/mizan/opl/CELLS/C4187", "west",
	});
