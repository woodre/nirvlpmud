...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5709", "north",
		"/players/mizan/opl/CELLS/C5949", "south",
		"/players/mizan/opl/CELLS/C5830", "east",
		"/players/mizan/opl/CELLS/C5828", "west",
	});
