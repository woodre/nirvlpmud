...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C700", "north",
		"/players/mizan/opl/CELLS/C940", "south",
		"/players/mizan/opl/CELLS/C821", "east",
		"/players/mizan/opl/CELLS/C819", "west",
	});
