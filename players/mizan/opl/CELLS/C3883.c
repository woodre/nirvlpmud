...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3763", "north",
		"/players/mizan/opl/CELLS/C4003", "south",
		"/players/mizan/opl/CELLS/C3884", "east",
		"/players/mizan/opl/CELLS/C3882", "west",
	});
