...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1620", "north",
		"/players/mizan/opl/CELLS/C1860", "south",
		"/players/mizan/opl/CELLS/C1741", "east",
		"/players/mizan/opl/CELLS/C1739", "west",
	});
