...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3285", "north",
		"/players/mizan/opl/CELLS/C3525", "south",
		"/players/mizan/opl/CELLS/C3406", "east",
		"/players/mizan/opl/CELLS/C3404", "west",
	});
