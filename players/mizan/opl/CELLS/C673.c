...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C553", "north",
		"/players/mizan/opl/CELLS/C793", "south",
		"/players/mizan/opl/CELLS/C674", "east",
		"/players/mizan/opl/CELLS/C672", "west",
	});
