...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3508", "east",
		"/players/mizan/opl/CELLS/C3506", "west",
	});
...
long()
{
	...
	write("\"But was he mature enough last night at the lesbian masquerade?\"\n");
