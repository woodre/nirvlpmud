...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4988", "north",
		"/players/mizan/opl/CELLS/C5228", "south",
		"/players/mizan/opl/CELLS/C5109", "east",
		"/players/mizan/opl/CELLS/C5107", "west",
	});
