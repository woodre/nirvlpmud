...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5445", "north",
		"/players/mizan/opl/CELLS/C5685", "south",
		"/players/mizan/opl/CELLS/C5566", "east",
		"/players/mizan/opl/CELLS/C5564", "west",
	});
