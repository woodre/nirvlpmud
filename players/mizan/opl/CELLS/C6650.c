...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6530", "north",
		"/players/mizan/opl/CELLS/C6770", "south",
		"/players/mizan/opl/CELLS/C6651", "east",
		"/players/mizan/opl/CELLS/C6649", "west",
	});
