...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3402", "north",
		"/players/mizan/opl/CELLS/C3642", "south",
		"/players/mizan/opl/CELLS/C3523", "east",
		"/players/mizan/opl/CELLS/C3521", "west",
	});
