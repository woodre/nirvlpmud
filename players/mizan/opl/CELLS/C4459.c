...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4339", "north",
		"/players/mizan/opl/CELLS/C4579", "south",
		"/players/mizan/opl/CELLS/C4460", "east",
		"/players/mizan/opl/CELLS/C4458", "west",
	});
