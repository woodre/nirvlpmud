...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5392", "north",
		"/players/mizan/opl/CELLS/C5632", "south",
		"/players/mizan/opl/CELLS/C5513", "east",
		"/players/mizan/opl/CELLS/C5511", "west",
	});
