...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3737", "north",
		"/players/mizan/opl/CELLS/C3977", "south",
		"/players/mizan/opl/CELLS/C3858", "east",
		"/players/mizan/opl/CELLS/C3856", "west",
	});
