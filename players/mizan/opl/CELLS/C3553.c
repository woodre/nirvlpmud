...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3433", "north",
		"/players/mizan/opl/CELLS/C3673", "south",
		"/players/mizan/opl/CELLS/C3554", "east",
		"/players/mizan/opl/CELLS/C3552", "west",
	});
...
long()
{
	...
	write("\"Catsup and Mustard all over the place! It's the Human Hamburger!\"\n");
