...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6052", "north",
		"/players/mizan/opl/CELLS/C6292", "south",
		"/players/mizan/opl/CELLS/C6173", "east",
		"/players/mizan/opl/CELLS/C6171", "west",
	});
