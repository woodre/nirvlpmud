...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2862", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C2742");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I2742");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I2742");
...
long()
{
	...
	write("\"Yow! We're going to a new disco!\"\n");
