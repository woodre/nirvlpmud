...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4848", "north",
		"/players/mizan/opl/CELLS/C5088", "south",
		"/players/mizan/opl/CELLS/C4969", "east",
		"/players/mizan/opl/CELLS/C4967", "west",
	});
