...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1696", "north",
		"/players/mizan/opl/CELLS/C1936", "south",
		"/players/mizan/opl/CELLS/C1817", "east",
		"/players/mizan/opl/CELLS/C1815", "west",
	});
