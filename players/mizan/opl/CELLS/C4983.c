...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4863", "north",
		"/players/mizan/opl/CELLS/C5103", "south",
		"/players/mizan/opl/CELLS/C4984", "east",
		"/players/mizan/opl/CELLS/C4982", "west",
	});
