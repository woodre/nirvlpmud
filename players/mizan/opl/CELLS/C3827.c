...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3707", "north",
		"/players/mizan/opl/CELLS/C3947", "south",
		"/players/mizan/opl/CELLS/C3828", "east",
		"/players/mizan/opl/CELLS/C3826", "west",
	});
