...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6809", "north",
		"/players/mizan/opl/CELLS/C7049", "south",
	});
...
long()
{
	...
	write("\"Yow! I want to mail a bronzed artichoke to Nicaragua!\"\n");
