...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4151", "north",
		"/players/mizan/opl/CELLS/C4391", "south",
		"/players/mizan/opl/CELLS/C4272", "east",
		"/players/mizan/opl/CELLS/C4270", "west",
	});
