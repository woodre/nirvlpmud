...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4091", "north",
		"/players/mizan/opl/CELLS/C4331", "south",
		"/players/mizan/opl/CELLS/C4212", "east",
		"/players/mizan/opl/CELLS/C4210", "west",
	});
