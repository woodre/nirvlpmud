...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5588", "north",
		"/players/mizan/opl/CELLS/C5828", "south",
		"/players/mizan/opl/CELLS/C5709", "east",
		"/players/mizan/opl/CELLS/C5707", "west",
	});
