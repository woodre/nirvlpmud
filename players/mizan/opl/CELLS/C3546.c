...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3426", "north",
		"/players/mizan/opl/CELLS/C3666", "south",
		"/players/mizan/opl/CELLS/C3547", "east",
		"/players/mizan/opl/CELLS/C3545", "west",
	});
