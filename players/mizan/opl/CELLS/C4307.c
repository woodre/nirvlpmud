...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4187", "north",
		"/players/mizan/opl/CELLS/C4427", "south",
		"/players/mizan/opl/CELLS/C4308", "east",
		"/players/mizan/opl/CELLS/C4306", "west",
	});
