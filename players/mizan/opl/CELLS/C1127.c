...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1007", "north",
		"/players/mizan/opl/CELLS/C1247", "south",
		"/players/mizan/opl/CELLS/C1126", "west",
	});
...
long()
{
	...
	write("\"Smile, Cthulhu Loathes You.\"\n");
