...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4673", "north",
		"/players/mizan/opl/CELLS/C4913", "south",
		"/players/mizan/opl/CELLS/C4794", "east",
		"/players/mizan/opl/CELLS/C4792", "west",
	});
