...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4287", "north",
		"/players/mizan/opl/CELLS/C4527", "south",
		"/players/mizan/opl/CELLS/C4408", "east",
		"/players/mizan/opl/CELLS/C4406", "west",
	});
...
long()
{
	...
	write("\"My nose feels like a bad Ronald Reagan movie ...\"\n");
