...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4722", "north",
		"/players/mizan/opl/CELLS/C4962", "south",
		"/players/mizan/opl/CELLS/C4843", "east",
		"/players/mizan/opl/CELLS/C4841", "west",
	});
