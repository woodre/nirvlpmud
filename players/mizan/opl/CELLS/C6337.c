...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6217", "north",
		"/players/mizan/opl/CELLS/C6457", "south",
		"/players/mizan/opl/CELLS/C6338", "east",
		"/players/mizan/opl/CELLS/C6336", "west",
	});
