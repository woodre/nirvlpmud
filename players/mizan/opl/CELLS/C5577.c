...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5457", "north",
		"/players/mizan/opl/CELLS/C5697", "south",
		"/players/mizan/opl/CELLS/C5578", "east",
		"/players/mizan/opl/CELLS/C5576", "west",
	});
