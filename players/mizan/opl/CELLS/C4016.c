...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3896", "north",
		"/players/mizan/opl/CELLS/C4136", "south",
		"/players/mizan/opl/CELLS/C4017", "east",
		"/players/mizan/opl/CELLS/C4015", "west",
	});
