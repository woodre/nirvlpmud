...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C701", "north",
		"/players/mizan/opl/CELLS/C941", "south",
		"/players/mizan/opl/CELLS/C822", "east",
		"/players/mizan/opl/CELLS/C820", "west",
	});
