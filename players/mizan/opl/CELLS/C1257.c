...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1137", "north",
		"/players/mizan/opl/CELLS/C1377", "south",
		"/players/mizan/opl/CELLS/C1258", "east",
		"/players/mizan/opl/CELLS/C1256", "west",
	});
