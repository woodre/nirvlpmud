...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4516", "north",
		"/players/mizan/opl/CELLS/C4756", "south",
		"/players/mizan/opl/CELLS/C4637", "east",
		"/players/mizan/opl/CELLS/C4635", "west",
	});
