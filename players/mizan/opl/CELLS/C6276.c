...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6156", "north",
		"/players/mizan/opl/CELLS/C6396", "south",
		"/players/mizan/opl/CELLS/C6277", "east",
		"/players/mizan/opl/CELLS/C6275", "west",
	});
