...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6531", "north",
		"/players/mizan/opl/CELLS/C6771", "south",
		"/players/mizan/opl/CELLS/C6652", "east",
		"/players/mizan/opl/CELLS/C6650", "west",
	});
