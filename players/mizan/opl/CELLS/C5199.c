...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5079", "north",
		"/players/mizan/opl/CELLS/C5319", "south",
		"/players/mizan/opl/CELLS/C5200", "east",
		"/players/mizan/opl/CELLS/C5198", "west",
	});
