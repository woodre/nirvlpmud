...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1511", "north",
		"/players/mizan/opl/CELLS/C1751", "south",
		"/players/mizan/opl/CELLS/C1632", "east",
		"/players/mizan/opl/CELLS/C1630", "west",
	});
