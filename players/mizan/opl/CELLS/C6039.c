...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5919", "north",
		"/players/mizan/opl/CELLS/C6159", "south",
		"/players/mizan/opl/CELLS/C6040", "east",
		"/players/mizan/opl/CELLS/C6038", "west",
	});
