...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4259", "north",
		"/players/mizan/opl/CELLS/C4499", "south",
		"/players/mizan/opl/CELLS/C4380", "east",
		"/players/mizan/opl/CELLS/C4378", "west",
	});
