...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2509", "north",
		"/players/mizan/opl/CELLS/C2749", "south",
		"/players/mizan/opl/CELLS/C2630", "east",
		"/players/mizan/opl/CELLS/C2628", "west",
	});
