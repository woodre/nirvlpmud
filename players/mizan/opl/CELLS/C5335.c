...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5215", "north",
		"/players/mizan/opl/CELLS/C5455", "south",
		"/players/mizan/opl/CELLS/C5336", "east",
		"/players/mizan/opl/CELLS/C5334", "west",
	});
