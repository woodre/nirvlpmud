...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3934", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C3933");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I3933");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I3933");
...
long()
{
	...
	write("\"There was a young lady from DrewWho ended her verse at line two.\"\n");
