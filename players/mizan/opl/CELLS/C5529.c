...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5649", "south",
		"/players/mizan/opl/CELLS/C5530", "east",
		"/players/mizan/opl/CELLS/C5528", "west",
	});
...
long()
{
	...
	write("\"If I pull this SWITCH I'll be RITA HAYWORTH!! Or a SCIENTOLOGIST!\"\n");
