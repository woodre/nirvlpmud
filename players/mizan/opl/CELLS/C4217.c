...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4097", "north",
		"/players/mizan/opl/CELLS/C4337", "south",
		"/players/mizan/opl/CELLS/C4218", "east",
		"/players/mizan/opl/CELLS/C4216", "west",
	});
