...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3371", "north",
		"/players/mizan/opl/CELLS/C3611", "south",
		"/players/mizan/opl/CELLS/C3492", "east",
		"/players/mizan/opl/CELLS/C3490", "west",
	});
