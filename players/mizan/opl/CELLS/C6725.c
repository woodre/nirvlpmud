...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6605", "north",
		"/players/mizan/opl/CELLS/C6845", "south",
		"/players/mizan/opl/CELLS/C6726", "east",
		"/players/mizan/opl/CELLS/C6724", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/hard/shoop.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/hard/postal_worker.c");
...
long()
{
	...
	write("\"Sex is an emotion in motion.		-- Mae West\"\n");
