...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6096", "north",
		"/players/mizan/opl/CELLS/C6336", "south",
		"/players/mizan/opl/CELLS/C6217", "east",
		"/players/mizan/opl/CELLS/C6215", "west",
	});
