...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C820", "north",
		"/players/mizan/opl/CELLS/C1060", "south",
		"/players/mizan/opl/CELLS/C941", "east",
		"/players/mizan/opl/CELLS/C939", "west",
	});
