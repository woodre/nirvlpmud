...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1187", "north",
		"/players/mizan/opl/CELLS/C1427", "south",
		"/players/mizan/opl/CELLS/C1308", "east",
		"/players/mizan/opl/CELLS/C1306", "west",
	});
