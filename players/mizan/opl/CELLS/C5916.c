...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5796", "north",
		"/players/mizan/opl/CELLS/C6036", "south",
		"/players/mizan/opl/CELLS/C5917", "east",
		"/players/mizan/opl/CELLS/C5915", "west",
	});
