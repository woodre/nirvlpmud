...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4461", "north",
		"/players/mizan/opl/CELLS/C4701", "south",
		"/players/mizan/opl/CELLS/C4582", "east",
		"/players/mizan/opl/CELLS/C4580", "west",
	});
