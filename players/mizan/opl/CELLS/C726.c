...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C606", "north",
		"/players/mizan/opl/CELLS/C846", "south",
		"/players/mizan/opl/CELLS/C727", "east",
		"/players/mizan/opl/CELLS/C725", "west",
	});
