...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C810", "north",
		"/players/mizan/opl/CELLS/C1050", "south",
		"/players/mizan/opl/CELLS/C931", "east",
		"/players/mizan/opl/CELLS/C929", "west",
	});
