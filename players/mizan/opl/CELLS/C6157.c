...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6037", "north",
		"/players/mizan/opl/CELLS/C6277", "south",
		"/players/mizan/opl/CELLS/C6158", "east",
		"/players/mizan/opl/CELLS/C6156", "west",
	});
