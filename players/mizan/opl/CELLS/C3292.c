...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3172", "north",
		"/players/mizan/opl/CELLS/C3412", "south",
		"/players/mizan/opl/CELLS/C3293", "east",
		"/players/mizan/opl/CELLS/C3291", "west",
	});
