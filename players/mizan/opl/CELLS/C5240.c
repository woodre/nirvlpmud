...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5120", "north",
		"/players/mizan/opl/CELLS/C5360", "south",
		"/players/mizan/opl/CELLS/C5241", "east",
		"/players/mizan/opl/CELLS/C5239", "west",
	});
