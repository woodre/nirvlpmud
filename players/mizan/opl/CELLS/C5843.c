...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5963", "south",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/easy/goliathbeano.c");
		move_object(mob0, this_object());
	}

	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/easy/zombie.c");
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C5843");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I5843");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I5843");
...
long()
{
	...
	write("\"'Skepticism... is the agent of truth.'     [Joseph Conrad]\"\n");
