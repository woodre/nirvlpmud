...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6048", "north",
		"/players/mizan/opl/CELLS/C6288", "south",
		"/players/mizan/opl/CELLS/C6169", "east",
		"/players/mizan/opl/CELLS/C6167", "west",
	});
