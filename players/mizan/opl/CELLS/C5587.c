...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5467", "north",
		"/players/mizan/opl/CELLS/C5707", "south",
		"/players/mizan/opl/CELLS/C5588", "east",
		"/players/mizan/opl/CELLS/C5586", "west",
	});
