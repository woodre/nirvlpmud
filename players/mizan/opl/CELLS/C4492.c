...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4372", "north",
		"/players/mizan/opl/CELLS/C4612", "south",
		"/players/mizan/opl/CELLS/C4493", "east",
		"/players/mizan/opl/CELLS/C4491", "west",
	});
