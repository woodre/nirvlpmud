...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C581", "north",
		"/players/mizan/opl/CELLS/C821", "south",
		"/players/mizan/opl/CELLS/C702", "east",
		"/players/mizan/opl/CELLS/C700", "west",
	});
