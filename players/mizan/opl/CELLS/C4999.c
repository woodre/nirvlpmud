...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4879", "north",
		"/players/mizan/opl/CELLS/C5119", "south",
		"/players/mizan/opl/CELLS/C5000", "east",
		"/players/mizan/opl/CELLS/C4998", "west",
	});
