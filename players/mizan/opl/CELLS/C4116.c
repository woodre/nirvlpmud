...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3996", "north",
		"/players/mizan/opl/CELLS/C4236", "south",
		"/players/mizan/opl/CELLS/C4117", "east",
		"/players/mizan/opl/CELLS/C4115", "west",
	});
