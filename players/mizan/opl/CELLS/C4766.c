...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4646", "north",
		"/players/mizan/opl/CELLS/C4886", "south",
		"/players/mizan/opl/CELLS/C4765", "west",
	});
...
long()
{
	...
	write("\"Q:	How do you get a woman to stop having sex with you?A:	Propose.\"\n");
