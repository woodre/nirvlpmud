...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C191", "north",
		"/players/mizan/opl/CELLS/C431", "south",
		"/players/mizan/opl/CELLS/C312", "east",
		"/players/mizan/opl/CELLS/C310", "west",
	});
