...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1303", "north",
		"/players/mizan/opl/CELLS/C1543", "south",
	});
...
long()
{
	...
	write("\"Someone in DAYTON, Ohio is selling USED CARPETS to a SERBO-CROATIAN\"\n");
