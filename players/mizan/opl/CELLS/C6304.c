...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6184", "north",
		"/players/mizan/opl/CELLS/C6424", "south",
		"/players/mizan/opl/CELLS/C6305", "east",
		"/players/mizan/opl/CELLS/C6303", "west",
	});
