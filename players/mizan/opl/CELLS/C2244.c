...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2124", "north",
		"/players/mizan/opl/CELLS/C2364", "south",
		"/players/mizan/opl/CELLS/C2245", "east",
		"/players/mizan/opl/CELLS/C2243", "west",
	});
