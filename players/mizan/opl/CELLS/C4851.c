...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4731", "north",
		"/players/mizan/opl/CELLS/C4971", "south",
		"/players/mizan/opl/CELLS/C4852", "east",
		"/players/mizan/opl/CELLS/C4850", "west",
	});
