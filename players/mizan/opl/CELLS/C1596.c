...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1476", "north",
		"/players/mizan/opl/CELLS/C1716", "south",
		"/players/mizan/opl/CELLS/C1597", "east",
		"/players/mizan/opl/CELLS/C1595", "west",
	});
