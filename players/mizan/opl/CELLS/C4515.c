...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4395", "north",
		"/players/mizan/opl/CELLS/C4635", "south",
		"/players/mizan/opl/CELLS/C4516", "east",
		"/players/mizan/opl/CELLS/C4514", "west",
	});
