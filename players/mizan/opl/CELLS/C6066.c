...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5946", "north",
		"/players/mizan/opl/CELLS/C6186", "south",
		"/players/mizan/opl/CELLS/C6067", "east",
		"/players/mizan/opl/CELLS/C6065", "west",
	});
