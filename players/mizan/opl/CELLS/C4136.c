...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4016", "north",
		"/players/mizan/opl/CELLS/C4256", "south",
		"/players/mizan/opl/CELLS/C4137", "east",
		"/players/mizan/opl/CELLS/C4135", "west",
	});
