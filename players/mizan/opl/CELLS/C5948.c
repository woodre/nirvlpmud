...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5828", "north",
		"/players/mizan/opl/CELLS/C6068", "south",
		"/players/mizan/opl/CELLS/C5949", "east",
		"/players/mizan/opl/CELLS/C5947", "west",
	});
