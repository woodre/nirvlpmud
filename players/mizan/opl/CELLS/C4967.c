...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4847", "north",
		"/players/mizan/opl/CELLS/C5087", "south",
		"/players/mizan/opl/CELLS/C4968", "east",
		"/players/mizan/opl/CELLS/C4966", "west",
	});
