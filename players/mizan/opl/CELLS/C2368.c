...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2248", "north",
		"/players/mizan/opl/CELLS/C2488", "south",
		"/players/mizan/opl/CELLS/C2369", "east",
		"/players/mizan/opl/CELLS/C2367", "west",
	});
