...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C518", "north",
		"/players/mizan/opl/CELLS/C758", "south",
		"/players/mizan/opl/CELLS/C639", "east",
		"/players/mizan/opl/CELLS/C637", "west",
	});
