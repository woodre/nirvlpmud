...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6108", "north",
		"/players/mizan/opl/CELLS/C6348", "south",
		"/players/mizan/opl/CELLS/C6229", "east",
		"/players/mizan/opl/CELLS/C6227", "west",
	});
