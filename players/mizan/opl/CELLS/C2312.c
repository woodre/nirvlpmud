...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2192", "north",
		"/players/mizan/opl/CELLS/C2432", "south",
		"/players/mizan/opl/CELLS/C2313", "east",
		"/players/mizan/opl/CELLS/C2311", "west",
	});
