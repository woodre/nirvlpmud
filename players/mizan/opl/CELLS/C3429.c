...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3309", "north",
		"/players/mizan/opl/CELLS/C3549", "south",
		"/players/mizan/opl/CELLS/C3430", "east",
		"/players/mizan/opl/CELLS/C3428", "west",
	});
...
long()
{
	...
	write("\"Some women should be beaten regularly, like gongs.		-- Noel Coward\"\n");
