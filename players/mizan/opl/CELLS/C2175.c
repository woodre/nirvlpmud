...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2055", "north",
		"/players/mizan/opl/CELLS/C2295", "south",
		"/players/mizan/opl/CELLS/C2176", "east",
		"/players/mizan/opl/CELLS/C2174", "west",
	});
...
long()
{
	...
	write("\"War is menstruation envy.\"\n");
