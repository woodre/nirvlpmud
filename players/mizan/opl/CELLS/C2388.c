...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2268", "north",
		"/players/mizan/opl/CELLS/C2508", "south",
		"/players/mizan/opl/CELLS/C2389", "east",
		"/players/mizan/opl/CELLS/C2387", "west",
	});
