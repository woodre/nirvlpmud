...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3925", "south",
		"/players/mizan/opl/CELLS/C3806", "east",
	});
...
long()
{
	...
	write("\"Crucifixes are sexy because there's a naked man on them.		-- Madonna\"\n");
