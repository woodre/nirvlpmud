...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2308", "north",
		"/players/mizan/opl/CELLS/C2548", "south",
		"/players/mizan/opl/CELLS/C2429", "east",
		"/players/mizan/opl/CELLS/C2427", "west",
	});
