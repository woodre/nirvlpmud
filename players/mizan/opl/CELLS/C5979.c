...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5859", "north",
		"/players/mizan/opl/CELLS/C6099", "south",
		"/players/mizan/opl/CELLS/C5980", "east",
		"/players/mizan/opl/CELLS/C5978", "west",
	});
