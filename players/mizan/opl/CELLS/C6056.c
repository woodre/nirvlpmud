...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5936", "north",
		"/players/mizan/opl/CELLS/C6176", "south",
		"/players/mizan/opl/CELLS/C6057", "east",
		"/players/mizan/opl/CELLS/C6055", "west",
	});
