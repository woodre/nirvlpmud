...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2549", "north",
		"/players/mizan/opl/CELLS/C2789", "south",
		"/players/mizan/opl/CELLS/C2670", "east",
		"/players/mizan/opl/CELLS/C2668", "west",
	});
