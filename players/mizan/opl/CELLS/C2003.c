...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1883", "north",
		"/players/mizan/opl/CELLS/C2123", "south",
		"/players/mizan/opl/CELLS/C2004", "east",
		"/players/mizan/opl/CELLS/C2002", "west",
	});
