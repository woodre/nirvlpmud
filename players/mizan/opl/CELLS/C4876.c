...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4756", "north",
		"/players/mizan/opl/CELLS/C4996", "south",
		"/players/mizan/opl/CELLS/C4877", "east",
		"/players/mizan/opl/CELLS/C4875", "west",
	});
