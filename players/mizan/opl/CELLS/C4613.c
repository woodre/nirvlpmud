...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4493", "north",
		"/players/mizan/opl/CELLS/C4733", "south",
		"/players/mizan/opl/CELLS/C4614", "east",
		"/players/mizan/opl/CELLS/C4612", "west",
	});
