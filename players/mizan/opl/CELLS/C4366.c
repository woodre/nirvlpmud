...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4246", "north",
		"/players/mizan/opl/CELLS/C4486", "south",
		"/players/mizan/opl/CELLS/C4367", "east",
		"/players/mizan/opl/CELLS/C4365", "west",
	});
