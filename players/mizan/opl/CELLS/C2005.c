...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1885", "north",
		"/players/mizan/opl/CELLS/C2125", "south",
		"/players/mizan/opl/CELLS/C2006", "east",
		"/players/mizan/opl/CELLS/C2004", "west",
	});
