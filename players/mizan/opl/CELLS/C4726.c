...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4606", "north",
		"/players/mizan/opl/CELLS/C4846", "south",
		"/players/mizan/opl/CELLS/C4727", "east",
		"/players/mizan/opl/CELLS/C4725", "west",
	});
