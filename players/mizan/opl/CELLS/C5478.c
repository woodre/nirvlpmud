...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5358", "north",
		"/players/mizan/opl/CELLS/C5598", "south",
		"/players/mizan/opl/CELLS/C5479", "east",
		"/players/mizan/opl/CELLS/C5477", "west",
	});
