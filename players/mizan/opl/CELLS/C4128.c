...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4008", "north",
		"/players/mizan/opl/CELLS/C4248", "south",
		"/players/mizan/opl/CELLS/C4129", "east",
		"/players/mizan/opl/CELLS/C4127", "west",
	});
