...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C489", "north",
		"/players/mizan/opl/CELLS/C729", "south",
		"/players/mizan/opl/CELLS/C610", "east",
		"/players/mizan/opl/CELLS/C608", "west",
	});
