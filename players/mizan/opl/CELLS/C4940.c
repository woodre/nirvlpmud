...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4820", "north",
		"/players/mizan/opl/CELLS/C5060", "south",
		"/players/mizan/opl/CELLS/C4941", "east",
		"/players/mizan/opl/CELLS/C4939", "west",
	});
