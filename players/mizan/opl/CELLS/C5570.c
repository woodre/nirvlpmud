...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5450", "north",
		"/players/mizan/opl/CELLS/C5690", "south",
		"/players/mizan/opl/CELLS/C5571", "east",
		"/players/mizan/opl/CELLS/C5569", "west",
	});
