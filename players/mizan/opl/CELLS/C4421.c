...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4301", "north",
		"/players/mizan/opl/CELLS/C4541", "south",
		"/players/mizan/opl/CELLS/C4420", "west",
	});
...
long()
{
	...
	write("\"'Religions change; beer and wine remain'     [Harvey Allen]\"\n");
