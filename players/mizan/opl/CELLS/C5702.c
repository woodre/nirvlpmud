...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5582", "north",
		"/players/mizan/opl/CELLS/C5822", "south",
		"/players/mizan/opl/CELLS/C5703", "east",
		"/players/mizan/opl/CELLS/C5701", "west",
	});
