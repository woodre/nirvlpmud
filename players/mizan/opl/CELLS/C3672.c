...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3552", "north",
		"/players/mizan/opl/CELLS/C3792", "south",
		"/players/mizan/opl/CELLS/C3673", "east",
		"/players/mizan/opl/CELLS/C3671", "west",
	});
...
long()
{
	...
	write("\"Kansas:	Where the men are men and so are the women!\"\n");
