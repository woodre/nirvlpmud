...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1739", "north",
		"/players/mizan/opl/CELLS/C1979", "south",
		"/players/mizan/opl/CELLS/C1860", "east",
		"/players/mizan/opl/CELLS/C1858", "west",
	});
