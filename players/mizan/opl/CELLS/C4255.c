...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4135", "north",
		"/players/mizan/opl/CELLS/C4375", "south",
		"/players/mizan/opl/CELLS/C4256", "east",
		"/players/mizan/opl/CELLS/C4254", "west",
	});
