...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4497", "north",
		"/players/mizan/opl/CELLS/C4737", "south",
		"/players/mizan/opl/CELLS/C4618", "east",
		"/players/mizan/opl/CELLS/C4616", "west",
	});
