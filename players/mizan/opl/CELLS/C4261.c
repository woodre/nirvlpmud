...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4141", "north",
		"/players/mizan/opl/CELLS/C4381", "south",
		"/players/mizan/opl/CELLS/C4262", "east",
		"/players/mizan/opl/CELLS/C4260", "west",
	});
