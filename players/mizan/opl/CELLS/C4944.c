...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4824", "north",
		"/players/mizan/opl/CELLS/C5064", "south",
		"/players/mizan/opl/CELLS/C4945", "east",
		"/players/mizan/opl/CELLS/C4943", "west",
	});
