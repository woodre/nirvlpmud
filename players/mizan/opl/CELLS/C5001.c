...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4881", "north",
		"/players/mizan/opl/CELLS/C5121", "south",
		"/players/mizan/opl/CELLS/C5002", "east",
		"/players/mizan/opl/CELLS/C5000", "west",
	});
