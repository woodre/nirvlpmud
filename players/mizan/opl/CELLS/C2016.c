...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2017", "east",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C2016");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I2016");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I2016");
...
long()
{
	...
	write("\"Printers do it without wrinkling the sheets.\"\n");
