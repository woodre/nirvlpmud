...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3895", "north",
		"/players/mizan/opl/CELLS/C4135", "south",
		"/players/mizan/opl/CELLS/C4016", "east",
		"/players/mizan/opl/CELLS/C4014", "west",
	});
