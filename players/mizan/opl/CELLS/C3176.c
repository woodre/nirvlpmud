...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3296", "south",
		"/players/mizan/opl/CELLS/C3177", "east",
	});
...
long()
{
	...
	write("\"I guess it was all a DREAM ... or an episode of HAWAII FIVE-O ...\"\n");
