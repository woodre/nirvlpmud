...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4613", "north",
		"/players/mizan/opl/CELLS/C4853", "south",
		"/players/mizan/opl/CELLS/C4734", "east",
		"/players/mizan/opl/CELLS/C4732", "west",
	});
