...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6076", "north",
		"/players/mizan/opl/CELLS/C6316", "south",
		"/players/mizan/opl/CELLS/C6197", "east",
		"/players/mizan/opl/CELLS/C6195", "west",
	});
