...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5330", "north",
		"/players/mizan/opl/CELLS/C5570", "south",
		"/players/mizan/opl/CELLS/C5451", "east",
		"/players/mizan/opl/CELLS/C5449", "west",
	});
