...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5711", "north",
		"/players/mizan/opl/CELLS/C5951", "south",
		"/players/mizan/opl/CELLS/C5832", "east",
		"/players/mizan/opl/CELLS/C5830", "west",
	});
