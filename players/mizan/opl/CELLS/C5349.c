...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5229", "north",
		"/players/mizan/opl/CELLS/C5469", "south",
		"/players/mizan/opl/CELLS/C5350", "east",
		"/players/mizan/opl/CELLS/C5348", "west",
	});
