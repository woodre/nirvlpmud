...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3369", "north",
		"/players/mizan/opl/CELLS/C3609", "south",
		"/players/mizan/opl/CELLS/C3490", "east",
		"/players/mizan/opl/CELLS/C3488", "west",
	});
