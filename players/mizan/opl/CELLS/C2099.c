...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1979", "north",
		"/players/mizan/opl/CELLS/C2219", "south",
		"/players/mizan/opl/CELLS/C2100", "east",
		"/players/mizan/opl/CELLS/C2098", "west",
	});
