...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4128", "north",
		"/players/mizan/opl/CELLS/C4368", "south",
		"/players/mizan/opl/CELLS/C4249", "east",
		"/players/mizan/opl/CELLS/C4247", "west",
	});
