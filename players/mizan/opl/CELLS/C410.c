...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C290", "north",
		"/players/mizan/opl/CELLS/C530", "south",
		"/players/mizan/opl/CELLS/C409", "west",
	});
...
long()
{
	...
	write("\"Eat the rich -- the poor are tough and stringy.\"\n");
