...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2250", "north",
		"/players/mizan/opl/CELLS/C2490", "south",
		"/players/mizan/opl/CELLS/C2371", "east",
		"/players/mizan/opl/CELLS/C2369", "west",
	});
