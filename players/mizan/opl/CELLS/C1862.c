...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1742", "north",
		"/players/mizan/opl/CELLS/C1982", "south",
		"/players/mizan/opl/CELLS/C1863", "east",
		"/players/mizan/opl/CELLS/C1861", "west",
	});
