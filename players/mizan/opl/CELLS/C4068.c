...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3948", "north",
		"/players/mizan/opl/CELLS/C4188", "south",
		"/players/mizan/opl/CELLS/C4069", "east",
		"/players/mizan/opl/CELLS/C4067", "west",
	});
