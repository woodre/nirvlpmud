...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1165", "north",
		"/players/mizan/opl/CELLS/C1405", "south",
		"/players/mizan/opl/CELLS/C1286", "east",
		"/players/mizan/opl/CELLS/C1284", "west",
	});
