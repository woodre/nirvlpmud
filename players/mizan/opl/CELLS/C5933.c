...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5813", "north",
		"/players/mizan/opl/CELLS/C6053", "south",
		"/players/mizan/opl/CELLS/C5934", "east",
		"/players/mizan/opl/CELLS/C5932", "west",
	});
