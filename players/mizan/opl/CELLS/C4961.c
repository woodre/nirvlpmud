...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4841", "north",
		"/players/mizan/opl/CELLS/C5081", "south",
		"/players/mizan/opl/CELLS/C4962", "east",
		"/players/mizan/opl/CELLS/C4960", "west",
	});
