...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6060", "north",
		"/players/mizan/opl/CELLS/C6300", "south",
		"/players/mizan/opl/CELLS/C6181", "east",
		"/players/mizan/opl/CELLS/C6179", "west",
	});
