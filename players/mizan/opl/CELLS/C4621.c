...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4501", "north",
		"/players/mizan/opl/CELLS/C4741", "south",
		"/players/mizan/opl/CELLS/C4622", "east",
		"/players/mizan/opl/CELLS/C4620", "west",
	});
