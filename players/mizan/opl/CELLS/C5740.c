...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5620", "north",
		"/players/mizan/opl/CELLS/C5860", "south",
		"/players/mizan/opl/CELLS/C5741", "east",
		"/players/mizan/opl/CELLS/C5739", "west",
	});
