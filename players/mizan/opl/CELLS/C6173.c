...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6053", "north",
		"/players/mizan/opl/CELLS/C6293", "south",
		"/players/mizan/opl/CELLS/C6174", "east",
		"/players/mizan/opl/CELLS/C6172", "west",
	});
