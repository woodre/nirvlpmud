...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4154", "north",
		"/players/mizan/opl/CELLS/C4394", "south",
		"/players/mizan/opl/CELLS/C4275", "east",
		"/players/mizan/opl/CELLS/C4273", "west",
	});
