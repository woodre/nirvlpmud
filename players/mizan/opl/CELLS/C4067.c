...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3947", "north",
		"/players/mizan/opl/CELLS/C4187", "south",
		"/players/mizan/opl/CELLS/C4068", "east",
		"/players/mizan/opl/CELLS/C4066", "west",
	});
