...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4981", "north",
		"/players/mizan/opl/CELLS/C5221", "south",
		"/players/mizan/opl/CELLS/C5102", "east",
		"/players/mizan/opl/CELLS/C5100", "west",
	});
