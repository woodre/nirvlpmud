...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3903", "north",
		"/players/mizan/opl/CELLS/C4143", "south",
		"/players/mizan/opl/CELLS/C4024", "east",
		"/players/mizan/opl/CELLS/C4022", "west",
	});
