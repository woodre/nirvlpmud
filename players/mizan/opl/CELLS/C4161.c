...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4041", "north",
		"/players/mizan/opl/CELLS/C4162", "east",
		"/players/mizan/opl/CELLS/C4160", "west",
	});
...
long()
{
	...
	write("\"The white race is the cancer of history.		-- Susan Sontag\"\n");
