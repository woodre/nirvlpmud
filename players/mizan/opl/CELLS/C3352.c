...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3232", "north",
		"/players/mizan/opl/CELLS/C3353", "east",
		"/players/mizan/opl/CELLS/C3351", "west",
	});
...
long()
{
	...
	write("\"My LESLIE GORE record is BROKEN ...\"\n");
