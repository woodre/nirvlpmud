...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4993", "north",
		"/players/mizan/opl/CELLS/C5233", "south",
		"/players/mizan/opl/CELLS/C5114", "east",
		"/players/mizan/opl/CELLS/C5112", "west",
	});
