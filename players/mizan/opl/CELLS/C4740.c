...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4620", "north",
		"/players/mizan/opl/CELLS/C4860", "south",
		"/players/mizan/opl/CELLS/C4741", "east",
		"/players/mizan/opl/CELLS/C4739", "west",
	});
