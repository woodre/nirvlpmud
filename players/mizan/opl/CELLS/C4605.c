...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4485", "north",
		"/players/mizan/opl/CELLS/C4725", "south",
		"/players/mizan/opl/CELLS/C4606", "east",
		"/players/mizan/opl/CELLS/C4604", "west",
	});
