...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4408", "north",
		"/players/mizan/opl/CELLS/C4648", "south",
		"/players/mizan/opl/CELLS/C4529", "east",
		"/players/mizan/opl/CELLS/C4527", "west",
	});
