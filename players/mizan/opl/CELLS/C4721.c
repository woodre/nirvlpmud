...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4601", "north",
		"/players/mizan/opl/CELLS/C4841", "south",
		"/players/mizan/opl/CELLS/C4722", "east",
		"/players/mizan/opl/CELLS/C4720", "west",
	});
