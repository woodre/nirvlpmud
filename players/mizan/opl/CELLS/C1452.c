...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1332", "north",
		"/players/mizan/opl/CELLS/C1572", "south",
		"/players/mizan/opl/CELLS/C1451", "west",
	});
...
long()
{
	...
	write("\"When God created man, She was only testing.\"\n");
