...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C147", "north",
		"/players/mizan/opl/CELLS/C387", "south",
		"/players/mizan/opl/CELLS/C268", "east",
	});
...
long()
{
	...
	write("\"Baltimore:	A wharf-rat stealing Diogenes' lamp.\"\n");
