...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4454", "north",
		"/players/mizan/opl/CELLS/C4694", "south",
		"/players/mizan/opl/CELLS/C4575", "east",
		"/players/mizan/opl/CELLS/C4573", "west",
	});
