...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4991", "north",
		"/players/mizan/opl/CELLS/C5231", "south",
		"/players/mizan/opl/CELLS/C5112", "east",
		"/players/mizan/opl/CELLS/C5110", "west",
	});
