...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1336", "north",
		"/players/mizan/opl/CELLS/C1576", "south",
		"/players/mizan/opl/CELLS/C1455", "west",
	});
...
long()
{
	...
	write("\"Where does it go when you flush?\"\n");
