...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1594", "north",
		"/players/mizan/opl/CELLS/C1834", "south",
		"/players/mizan/opl/CELLS/C1715", "east",
		"/players/mizan/opl/CELLS/C1713", "west",
	});
