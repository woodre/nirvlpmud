...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3613", "north",
		"/players/mizan/opl/CELLS/C3853", "south",
		"/players/mizan/opl/CELLS/C3734", "east",
		"/players/mizan/opl/CELLS/C3732", "west",
	});
