...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4195", "north",
		"/players/mizan/opl/CELLS/C4435", "south",
		"/players/mizan/opl/CELLS/C4316", "east",
		"/players/mizan/opl/CELLS/C4314", "west",
	});
