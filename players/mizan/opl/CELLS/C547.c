...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C427", "north",
		"/players/mizan/opl/CELLS/C546", "west",
	});
...
long()
{
	...
	write("\"A zealot's stones will break my bones, but gods will never hurt me.\"\n");
