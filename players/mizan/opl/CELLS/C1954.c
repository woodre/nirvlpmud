...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1834", "north",
		"/players/mizan/opl/CELLS/C2074", "south",
		"/players/mizan/opl/CELLS/C1955", "east",
		"/players/mizan/opl/CELLS/C1953", "west",
	});
