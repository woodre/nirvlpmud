...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4528", "north",
		"/players/mizan/opl/CELLS/C4768", "south",
		"/players/mizan/opl/CELLS/C4649", "east",
	});
...
long()
{
	...
	write("\"B4 I4Q, RU/18 QT 3.1415926535?\"\n");
