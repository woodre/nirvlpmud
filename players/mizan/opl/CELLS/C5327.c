...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5207", "north",
		"/players/mizan/opl/CELLS/C5447", "south",
		"/players/mizan/opl/CELLS/C5328", "east",
		"/players/mizan/opl/CELLS/C5326", "west",
	});
