...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1734", "north",
		"/players/mizan/opl/CELLS/C1974", "south",
		"/players/mizan/opl/CELLS/C1855", "east",
		"/players/mizan/opl/CELLS/C1853", "west",
	});
