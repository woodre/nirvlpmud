...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3170", "north",
		"/players/mizan/opl/CELLS/C3410", "south",
		"/players/mizan/opl/CELLS/C3291", "east",
		"/players/mizan/opl/CELLS/C3289", "west",
	});
