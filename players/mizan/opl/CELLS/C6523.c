...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6403", "north",
		"/players/mizan/opl/CELLS/C6643", "south",
		"/players/mizan/opl/CELLS/C6524", "east",
		"/players/mizan/opl/CELLS/C6522", "west",
	});
