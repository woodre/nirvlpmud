...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3432", "south",
		"/players/mizan/opl/CELLS/C3313", "east",
		"/players/mizan/opl/CELLS/C3311", "west",
	});
...
long()
{
	...
	write("\"Roses on your piano isn't nearly as good as tulips on your organ.\"\n");
