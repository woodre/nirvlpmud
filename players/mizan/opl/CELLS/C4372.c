...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4252", "north",
		"/players/mizan/opl/CELLS/C4492", "south",
		"/players/mizan/opl/CELLS/C4373", "east",
		"/players/mizan/opl/CELLS/C4371", "west",
	});
