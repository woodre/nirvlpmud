...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4144", "north",
		"/players/mizan/opl/CELLS/C4384", "south",
		"/players/mizan/opl/CELLS/C4265", "east",
		"/players/mizan/opl/CELLS/C4263", "west",
	});
