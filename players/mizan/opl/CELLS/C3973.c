...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3853", "north",
		"/players/mizan/opl/CELLS/C4093", "south",
		"/players/mizan/opl/CELLS/C3974", "east",
		"/players/mizan/opl/CELLS/C3972", "west",
	});
