...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4582", "north",
		"/players/mizan/opl/CELLS/C4822", "south",
		"/players/mizan/opl/CELLS/C4703", "east",
		"/players/mizan/opl/CELLS/C4701", "west",
	});
