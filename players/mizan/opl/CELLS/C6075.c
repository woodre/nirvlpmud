...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5955", "north",
		"/players/mizan/opl/CELLS/C6195", "south",
		"/players/mizan/opl/CELLS/C6076", "east",
		"/players/mizan/opl/CELLS/C6074", "west",
	});
