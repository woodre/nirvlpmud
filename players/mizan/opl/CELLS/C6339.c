...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6219", "north",
		"/players/mizan/opl/CELLS/C6459", "south",
		"/players/mizan/opl/CELLS/C6340", "east",
		"/players/mizan/opl/CELLS/C6338", "west",
	});
