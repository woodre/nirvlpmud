...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5352", "north",
		"/players/mizan/opl/CELLS/C5592", "south",
		"/players/mizan/opl/CELLS/C5473", "east",
		"/players/mizan/opl/CELLS/C5471", "west",
	});
