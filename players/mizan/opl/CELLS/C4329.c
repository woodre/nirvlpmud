...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4209", "north",
		"/players/mizan/opl/CELLS/C4449", "south",
		"/players/mizan/opl/CELLS/C4330", "east",
		"/players/mizan/opl/CELLS/C4328", "west",
	});
