...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C571", "north",
		"/players/mizan/opl/CELLS/C811", "south",
		"/players/mizan/opl/CELLS/C692", "east",
		"/players/mizan/opl/CELLS/C690", "west",
	});
