...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2351", "south",
		"/players/mizan/opl/CELLS/C2230", "west",
	});
...
long()
{
	...
	write("\"'I think sex is better than logic, but I can't prove it.'\"\n");
