...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C170", "north",
		"/players/mizan/opl/CELLS/C410", "south",
		"/players/mizan/opl/CELLS/C291", "east",
		"/players/mizan/opl/CELLS/C289", "west",
	});
...
long()
{
	...
	write("\"Vegetarians for oral sex -- 'The only meat that's fit to eat'\"\n");
