...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5940", "north",
		"/players/mizan/opl/CELLS/C6180", "south",
		"/players/mizan/opl/CELLS/C6061", "east",
		"/players/mizan/opl/CELLS/C6059", "west",
	});
