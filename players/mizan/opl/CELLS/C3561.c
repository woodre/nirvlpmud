...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3562", "east",
		"/players/mizan/opl/CELLS/C3560", "west",
	});
...
long()
{
	...
	write("\"The FALAFEL SANDWICH lands on my HEAD and I become a VEGETARIAN ...\"\n");
