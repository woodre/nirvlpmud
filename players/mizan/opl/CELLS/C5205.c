...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5085", "north",
		"/players/mizan/opl/CELLS/C5325", "south",
		"/players/mizan/opl/CELLS/C5206", "east",
		"/players/mizan/opl/CELLS/C5204", "west",
	});
