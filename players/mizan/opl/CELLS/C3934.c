...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3814", "north",
		"/players/mizan/opl/CELLS/C4054", "south",
		"/players/mizan/opl/CELLS/C3935", "east",
		"/players/mizan/opl/CELLS/C3933", "west",
	});
