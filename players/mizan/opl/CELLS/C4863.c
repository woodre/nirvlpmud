...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4743", "north",
		"/players/mizan/opl/CELLS/C4983", "south",
		"/players/mizan/opl/CELLS/C4864", "east",
		"/players/mizan/opl/CELLS/C4862", "west",
	});
