...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2351", "north",
		"/players/mizan/opl/CELLS/C2591", "south",
	});
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/easy/gundroid.c");
...
long()
{
	...
	write("\"Even God cannot change the past.		-- Joseph Stalin\"\n");
