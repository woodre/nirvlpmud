...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3727", "north",
		"/players/mizan/opl/CELLS/C3967", "south",
		"/players/mizan/opl/CELLS/C3848", "east",
		"/players/mizan/opl/CELLS/C3846", "west",
	});
