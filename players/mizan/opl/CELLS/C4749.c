...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4629", "north",
		"/players/mizan/opl/CELLS/C4869", "south",
		"/players/mizan/opl/CELLS/C4750", "east",
		"/players/mizan/opl/CELLS/C4748", "west",
	});
