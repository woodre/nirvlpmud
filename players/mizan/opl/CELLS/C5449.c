...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5329", "north",
		"/players/mizan/opl/CELLS/C5569", "south",
		"/players/mizan/opl/CELLS/C5450", "east",
		"/players/mizan/opl/CELLS/C5448", "west",
	});
