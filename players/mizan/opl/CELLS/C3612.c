...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3492", "north",
		"/players/mizan/opl/CELLS/C3732", "south",
		"/players/mizan/opl/CELLS/C3613", "east",
		"/players/mizan/opl/CELLS/C3611", "west",
	});
