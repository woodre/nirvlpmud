...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1934", "north",
		"/players/mizan/opl/CELLS/C2174", "south",
		"/players/mizan/opl/CELLS/C2055", "east",
		"/players/mizan/opl/CELLS/C2053", "west",
	});
...
long()
{
	...
	write("\"I belong to no organized party. I am a Democrat.		-- Will Rogers\"\n");
