...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4254", "north",
		"/players/mizan/opl/CELLS/C4494", "south",
		"/players/mizan/opl/CELLS/C4375", "east",
		"/players/mizan/opl/CELLS/C4373", "west",
	});
