...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4176", "north",
		"/players/mizan/opl/CELLS/C4416", "south",
		"/players/mizan/opl/CELLS/C4297", "east",
		"/players/mizan/opl/CELLS/C4295", "west",
	});
...
long()
{
	...
	write("\"Confucius say too damn much!\"\n");
