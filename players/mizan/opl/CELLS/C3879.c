...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3759", "north",
		"/players/mizan/opl/CELLS/C3999", "south",
		"/players/mizan/opl/CELLS/C3880", "east",
		"/players/mizan/opl/CELLS/C3878", "west",
	});
