...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C285", "south",
	});
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C165");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I165");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I165");
...
long()
{
	...
	write("\"Hire the handicapped -- they're fun to watch!\"\n");
