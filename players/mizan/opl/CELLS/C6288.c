...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6168", "north",
		"/players/mizan/opl/CELLS/C6408", "south",
		"/players/mizan/opl/CELLS/C6289", "east",
		"/players/mizan/opl/CELLS/C6287", "west",
	});
