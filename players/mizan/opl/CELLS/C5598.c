...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5478", "north",
		"/players/mizan/opl/CELLS/C5718", "south",
		"/players/mizan/opl/CELLS/C5599", "east",
		"/players/mizan/opl/CELLS/C5597", "west",
	});
