...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5481", "north",
		"/players/mizan/opl/CELLS/C5721", "south",
		"/players/mizan/opl/CELLS/C5602", "east",
		"/players/mizan/opl/CELLS/C5600", "west",
	});
