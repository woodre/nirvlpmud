...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4628", "north",
		"/players/mizan/opl/CELLS/C4868", "south",
		"/players/mizan/opl/CELLS/C4749", "east",
		"/players/mizan/opl/CELLS/C4747", "west",
	});
