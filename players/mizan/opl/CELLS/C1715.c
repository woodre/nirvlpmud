...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1595", "north",
		"/players/mizan/opl/CELLS/C1835", "south",
		"/players/mizan/opl/CELLS/C1716", "east",
		"/players/mizan/opl/CELLS/C1714", "west",
	});
