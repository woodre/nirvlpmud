...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2312", "north",
		"/players/mizan/opl/CELLS/C2552", "south",
		"/players/mizan/opl/CELLS/C2433", "east",
		"/players/mizan/opl/CELLS/C2431", "west",
	});
