...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5365", "north",
		"/players/mizan/opl/CELLS/C5605", "south",
		"/players/mizan/opl/CELLS/C5486", "east",
		"/players/mizan/opl/CELLS/C5484", "west",
	});
