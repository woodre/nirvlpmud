...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4605", "north",
		"/players/mizan/opl/CELLS/C4845", "south",
		"/players/mizan/opl/CELLS/C4726", "east",
		"/players/mizan/opl/CELLS/C4724", "west",
	});
