...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5335", "north",
		"/players/mizan/opl/CELLS/C5575", "south",
		"/players/mizan/opl/CELLS/C5456", "east",
		"/players/mizan/opl/CELLS/C5454", "west",
	});
