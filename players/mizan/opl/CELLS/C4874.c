...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4754", "north",
		"/players/mizan/opl/CELLS/C4994", "south",
		"/players/mizan/opl/CELLS/C4875", "east",
		"/players/mizan/opl/CELLS/C4873", "west",
	});
