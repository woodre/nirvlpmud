...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1479", "north",
		"/players/mizan/opl/CELLS/C1719", "south",
		"/players/mizan/opl/CELLS/C1600", "east",
		"/players/mizan/opl/CELLS/C1598", "west",
	});
