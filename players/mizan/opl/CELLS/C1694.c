...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1574", "north",
		"/players/mizan/opl/CELLS/C1814", "south",
		"/players/mizan/opl/CELLS/C1695", "east",
		"/players/mizan/opl/CELLS/C1693", "west",
	});
