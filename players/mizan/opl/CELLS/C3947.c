...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3827", "north",
		"/players/mizan/opl/CELLS/C4067", "south",
		"/players/mizan/opl/CELLS/C3948", "east",
		"/players/mizan/opl/CELLS/C3946", "west",
	});
