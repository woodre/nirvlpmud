...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4486", "north",
		"/players/mizan/opl/CELLS/C4726", "south",
		"/players/mizan/opl/CELLS/C4607", "east",
		"/players/mizan/opl/CELLS/C4605", "west",
	});
