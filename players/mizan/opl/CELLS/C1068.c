...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C948", "north",
		"/players/mizan/opl/CELLS/C1188", "south",
		"/players/mizan/opl/CELLS/C1069", "east",
		"/players/mizan/opl/CELLS/C1067", "west",
	});
