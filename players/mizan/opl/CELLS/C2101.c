...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1981", "north",
		"/players/mizan/opl/CELLS/C2221", "south",
		"/players/mizan/opl/CELLS/C2102", "east",
		"/players/mizan/opl/CELLS/C2100", "west",
	});
