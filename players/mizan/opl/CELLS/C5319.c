...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5199", "north",
		"/players/mizan/opl/CELLS/C5439", "south",
		"/players/mizan/opl/CELLS/C5320", "east",
		"/players/mizan/opl/CELLS/C5318", "west",
	});
