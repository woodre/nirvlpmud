...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C729", "north",
		"/players/mizan/opl/CELLS/C969", "south",
		"/players/mizan/opl/CELLS/C850", "east",
		"/players/mizan/opl/CELLS/C848", "west",
	});
