...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1915", "north",
		"/players/mizan/opl/CELLS/C2155", "south",
		"/players/mizan/opl/CELLS/C2036", "east",
		"/players/mizan/opl/CELLS/C2034", "west",
	});
