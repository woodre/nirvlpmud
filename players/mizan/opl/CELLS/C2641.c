...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2642", "east",
	});
	...
	if(!bonus)
	{
		bonus = clone_object("/players/mizan/opl/beasties/hard/shoop.c");
...
long()
{
	...
	write("\"It's hard to keep a good girl down -- but lots of fun trying.\"\n");
