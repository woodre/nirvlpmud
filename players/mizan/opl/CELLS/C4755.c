...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4635", "north",
		"/players/mizan/opl/CELLS/C4875", "south",
		"/players/mizan/opl/CELLS/C4756", "east",
		"/players/mizan/opl/CELLS/C4754", "west",
	});
