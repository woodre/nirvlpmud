...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C673", "north",
		"/players/mizan/opl/CELLS/C913", "south",
		"/players/mizan/opl/CELLS/C794", "east",
		"/players/mizan/opl/CELLS/C792", "west",
	});
