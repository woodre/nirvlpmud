...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2507", "north",
		"/players/mizan/opl/CELLS/C2747", "south",
		"/players/mizan/opl/CELLS/C2628", "east",
		"/players/mizan/opl/CELLS/C2626", "west",
	});
