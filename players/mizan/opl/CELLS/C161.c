...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C281", "south",
		"/players/mizan/opl/CELLS/C160", "west",
	});
...
long()
{
	...
	write("\"When a girl admits she's had a checkered career, it's your move.\"\n");
