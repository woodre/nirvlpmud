...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5584", "north",
		"/players/mizan/opl/CELLS/C5824", "south",
		"/players/mizan/opl/CELLS/C5705", "east",
		"/players/mizan/opl/CELLS/C5703", "west",
	});
