...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5978", "north",
		"/players/mizan/opl/CELLS/C6218", "south",
		"/players/mizan/opl/CELLS/C6099", "east",
		"/players/mizan/opl/CELLS/C6097", "west",
	});
