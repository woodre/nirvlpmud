...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3063", "north",
		"/players/mizan/opl/CELLS/C3303", "south",
	});
	...
	if(!mob4)
	{
		mob4 = clone_object("/players/mizan/opl/beasties/hard/ogress.c");
...
long()
{
	...
	write("\"Zippy's brain cells are straining to bridge synapses ...\"\n");
