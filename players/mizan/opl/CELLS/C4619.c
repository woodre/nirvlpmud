...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4499", "north",
		"/players/mizan/opl/CELLS/C4739", "south",
		"/players/mizan/opl/CELLS/C4620", "east",
		"/players/mizan/opl/CELLS/C4618", "west",
	});
