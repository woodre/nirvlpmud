...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4117", "north",
		"/players/mizan/opl/CELLS/C4357", "south",
		"/players/mizan/opl/CELLS/C4238", "east",
		"/players/mizan/opl/CELLS/C4236", "west",
	});
