...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5830", "north",
		"/players/mizan/opl/CELLS/C6070", "south",
		"/players/mizan/opl/CELLS/C5951", "east",
		"/players/mizan/opl/CELLS/C5949", "west",
	});
