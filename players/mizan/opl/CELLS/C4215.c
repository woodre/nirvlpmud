...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4095", "north",
		"/players/mizan/opl/CELLS/C4335", "south",
		"/players/mizan/opl/CELLS/C4216", "east",
		"/players/mizan/opl/CELLS/C4214", "west",
	});
