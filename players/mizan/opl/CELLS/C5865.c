...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5745", "north",
		"/players/mizan/opl/CELLS/C5985", "south",
		"/players/mizan/opl/CELLS/C5866", "east",
		"/players/mizan/opl/CELLS/C5864", "west",
	});
