...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4536", "north",
		"/players/mizan/opl/CELLS/C4776", "south",
		"/players/mizan/opl/CELLS/C4655", "west",
	});
...
long()
{
	...
	write("\"Beat me, bite me, whip me, fuck me, make me write bad checks!\"\n");
