...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5982", "north",
		"/players/mizan/opl/CELLS/C6222", "south",
		"/players/mizan/opl/CELLS/C6103", "east",
		"/players/mizan/opl/CELLS/C6101", "west",
	});
