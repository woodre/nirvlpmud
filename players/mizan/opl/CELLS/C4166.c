...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4046", "north",
		"/players/mizan/opl/CELLS/C4286", "south",
		"/players/mizan/opl/CELLS/C4167", "east",
	});
...
long()
{
	...
	write("\"Sir Francis Drake circumcised the world with a 100 foot clipper.\"\n");
