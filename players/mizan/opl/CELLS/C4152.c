...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4032", "north",
		"/players/mizan/opl/CELLS/C4272", "south",
		"/players/mizan/opl/CELLS/C4153", "east",
		"/players/mizan/opl/CELLS/C4151", "west",
	});
