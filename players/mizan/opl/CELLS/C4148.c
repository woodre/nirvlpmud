...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4028", "north",
		"/players/mizan/opl/CELLS/C4268", "south",
		"/players/mizan/opl/CELLS/C4149", "east",
		"/players/mizan/opl/CELLS/C4147", "west",
	});
