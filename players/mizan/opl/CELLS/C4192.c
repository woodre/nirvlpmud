...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4072", "north",
		"/players/mizan/opl/CELLS/C4312", "south",
		"/players/mizan/opl/CELLS/C4193", "east",
		"/players/mizan/opl/CELLS/C4191", "west",
	});
