...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C758", "north",
		"/players/mizan/opl/CELLS/C998", "south",
		"/players/mizan/opl/CELLS/C879", "east",
		"/players/mizan/opl/CELLS/C877", "west",
	});
