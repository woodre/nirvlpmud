...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4600", "north",
		"/players/mizan/opl/CELLS/C4840", "south",
		"/players/mizan/opl/CELLS/C4721", "east",
		"/players/mizan/opl/CELLS/C4719", "west",
	});
