...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3967", "north",
		"/players/mizan/opl/CELLS/C4207", "south",
		"/players/mizan/opl/CELLS/C4088", "east",
		"/players/mizan/opl/CELLS/C4086", "west",
	});
