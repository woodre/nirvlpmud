...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1571", "north",
		"/players/mizan/opl/CELLS/C1692", "east",
		"/players/mizan/opl/CELLS/C1690", "west",
	});
...
long()
{
	...
	write("\"DIDI ... is that a MARTIAN name, or, are we in ISRAEL?\"\n");
