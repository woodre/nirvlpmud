...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6606", "north",
		"/players/mizan/opl/CELLS/C6846", "south",
		"/players/mizan/opl/CELLS/C6725", "west",
	});

	/* Our monster list */
	if(!mob0)
	{
		mob0 = clone_object("/players/mizan/opl/beasties/hard/weasel.c");
	...
	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/hard/lectroid_boss.c");
		move_object(mob2, this_object());
	}

	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/hard/goldhard.c");
...
long()
{
	...
	write("\"QOTD:	'She was so tough she rolled her own tampons.'\"\n");
