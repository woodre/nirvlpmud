...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3969", "north",
		"/players/mizan/opl/CELLS/C4209", "south",
		"/players/mizan/opl/CELLS/C4090", "east",
		"/players/mizan/opl/CELLS/C4088", "west",
	});
