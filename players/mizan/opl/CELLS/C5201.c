...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5081", "north",
		"/players/mizan/opl/CELLS/C5321", "south",
		"/players/mizan/opl/CELLS/C5202", "east",
		"/players/mizan/opl/CELLS/C5200", "west",
	});
