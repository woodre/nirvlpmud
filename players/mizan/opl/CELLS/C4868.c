...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4748", "north",
		"/players/mizan/opl/CELLS/C4988", "south",
		"/players/mizan/opl/CELLS/C4869", "east",
		"/players/mizan/opl/CELLS/C4867", "west",
	});
