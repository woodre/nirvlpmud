...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5694", "north",
		"/players/mizan/opl/CELLS/C5934", "south",
		"/players/mizan/opl/CELLS/C5815", "east",
		"/players/mizan/opl/CELLS/C5813", "west",
	});
