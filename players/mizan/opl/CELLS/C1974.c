...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1854", "north",
		"/players/mizan/opl/CELLS/C2094", "south",
		"/players/mizan/opl/CELLS/C1973", "west",
	});
...
long()
{
	...
	write("\"If God had meant for Texans to ski he would have made bullshit white.\"\n");
