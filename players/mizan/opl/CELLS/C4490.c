...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4370", "north",
		"/players/mizan/opl/CELLS/C4610", "south",
		"/players/mizan/opl/CELLS/C4491", "east",
		"/players/mizan/opl/CELLS/C4489", "west",
	});
