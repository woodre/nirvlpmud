...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3489", "north",
		"/players/mizan/opl/CELLS/C3729", "south",
		"/players/mizan/opl/CELLS/C3610", "east",
		"/players/mizan/opl/CELLS/C3608", "west",
	});
