...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5359", "north",
		"/players/mizan/opl/CELLS/C5599", "south",
		"/players/mizan/opl/CELLS/C5480", "east",
		"/players/mizan/opl/CELLS/C5478", "west",
	});
