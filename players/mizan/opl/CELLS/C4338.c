...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4218", "north",
		"/players/mizan/opl/CELLS/C4458", "south",
		"/players/mizan/opl/CELLS/C4339", "east",
		"/players/mizan/opl/CELLS/C4337", "west",
	});
