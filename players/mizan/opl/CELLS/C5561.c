...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5441", "north",
		"/players/mizan/opl/CELLS/C5681", "south",
		"/players/mizan/opl/CELLS/C5562", "east",
		"/players/mizan/opl/CELLS/C5560", "west",
	});
