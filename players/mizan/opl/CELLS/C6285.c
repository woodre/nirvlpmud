...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6165", "north",
		"/players/mizan/opl/CELLS/C6405", "south",
		"/players/mizan/opl/CELLS/C6286", "east",
		"/players/mizan/opl/CELLS/C6284", "west",
	});
