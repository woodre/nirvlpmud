...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1406", "north",
		"/players/mizan/opl/CELLS/C1646", "south",
		"/players/mizan/opl/CELLS/C1527", "east",
		"/players/mizan/opl/CELLS/C1525", "west",
	});
