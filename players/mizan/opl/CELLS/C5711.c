...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5591", "north",
		"/players/mizan/opl/CELLS/C5831", "south",
		"/players/mizan/opl/CELLS/C5712", "east",
		"/players/mizan/opl/CELLS/C5710", "west",
	});
