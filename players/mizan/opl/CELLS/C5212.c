...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5092", "north",
		"/players/mizan/opl/CELLS/C5332", "south",
		"/players/mizan/opl/CELLS/C5213", "east",
		"/players/mizan/opl/CELLS/C5211", "west",
	});
