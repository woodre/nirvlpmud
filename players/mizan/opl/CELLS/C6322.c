...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6202", "north",
		"/players/mizan/opl/CELLS/C6442", "south",
		"/players/mizan/opl/CELLS/C6323", "east",
		"/players/mizan/opl/CELLS/C6321", "west",
	});
