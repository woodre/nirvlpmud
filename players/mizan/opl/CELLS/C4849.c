...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4729", "north",
		"/players/mizan/opl/CELLS/C4969", "south",
		"/players/mizan/opl/CELLS/C4850", "east",
		"/players/mizan/opl/CELLS/C4848", "west",
	});
