...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3411", "north",
		"/players/mizan/opl/CELLS/C3651", "south",
		"/players/mizan/opl/CELLS/C3532", "east",
		"/players/mizan/opl/CELLS/C3530", "west",
	});
