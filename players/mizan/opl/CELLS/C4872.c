...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4752", "north",
		"/players/mizan/opl/CELLS/C4992", "south",
		"/players/mizan/opl/CELLS/C4873", "east",
		"/players/mizan/opl/CELLS/C4871", "west",
	});
