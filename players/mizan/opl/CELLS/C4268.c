...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4148", "north",
		"/players/mizan/opl/CELLS/C4388", "south",
		"/players/mizan/opl/CELLS/C4269", "east",
		"/players/mizan/opl/CELLS/C4267", "west",
	});
