...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5349", "north",
		"/players/mizan/opl/CELLS/C5589", "south",
		"/players/mizan/opl/CELLS/C5470", "east",
		"/players/mizan/opl/CELLS/C5468", "west",
	});
