...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2283", "south",
		"/players/mizan/opl/CELLS/C2162", "west",
	});
...
long()
{
	...
	write("\"Q:	What's black and white and red all over?A:	Half a nun.\"\n");
