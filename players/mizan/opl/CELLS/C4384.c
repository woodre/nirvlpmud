...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4264", "north",
		"/players/mizan/opl/CELLS/C4504", "south",
		"/players/mizan/opl/CELLS/C4385", "east",
		"/players/mizan/opl/CELLS/C4383", "west",
	});
