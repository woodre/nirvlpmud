...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5690", "north",
		"/players/mizan/opl/CELLS/C5930", "south",
		"/players/mizan/opl/CELLS/C5811", "east",
		"/players/mizan/opl/CELLS/C5809", "west",
	});
