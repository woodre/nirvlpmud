...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4093", "north",
		"/players/mizan/opl/CELLS/C4333", "south",
		"/players/mizan/opl/CELLS/C4214", "east",
		"/players/mizan/opl/CELLS/C4212", "west",
	});
