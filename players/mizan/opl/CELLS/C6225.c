...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6105", "north",
		"/players/mizan/opl/CELLS/C6345", "south",
		"/players/mizan/opl/CELLS/C6226", "east",
		"/players/mizan/opl/CELLS/C6224", "west",
	});
