...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6287", "north",
		"/players/mizan/opl/CELLS/C6527", "south",
		"/players/mizan/opl/CELLS/C6408", "east",
		"/players/mizan/opl/CELLS/C6406", "west",
	});
