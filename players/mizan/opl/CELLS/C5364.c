...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5244", "north",
		"/players/mizan/opl/CELLS/C5484", "south",
		"/players/mizan/opl/CELLS/C5365", "east",
		"/players/mizan/opl/CELLS/C5363", "west",
	});
