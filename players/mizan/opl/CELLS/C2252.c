...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C2132", "north",
		"/players/mizan/opl/CELLS/C2372", "south",
		"/players/mizan/opl/CELLS/C2253", "east",
		"/players/mizan/opl/CELLS/C2251", "west",
	});
