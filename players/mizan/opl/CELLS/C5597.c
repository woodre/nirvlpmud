...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5477", "north",
		"/players/mizan/opl/CELLS/C5717", "south",
		"/players/mizan/opl/CELLS/C5598", "east",
		"/players/mizan/opl/CELLS/C5596", "west",
	});
