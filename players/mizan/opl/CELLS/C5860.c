...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5740", "north",
		"/players/mizan/opl/CELLS/C5980", "south",
		"/players/mizan/opl/CELLS/C5861", "east",
		"/players/mizan/opl/CELLS/C5859", "west",
	});
