...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4978", "north",
		"/players/mizan/opl/CELLS/C5218", "south",
		"/players/mizan/opl/CELLS/C5099", "east",
		"/players/mizan/opl/CELLS/C5097", "west",
	});
