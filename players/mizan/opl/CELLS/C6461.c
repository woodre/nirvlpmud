...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6341", "north",
		"/players/mizan/opl/CELLS/C6581", "south",
		"/players/mizan/opl/CELLS/C6462", "east",
		"/players/mizan/opl/CELLS/C6460", "west",
	});
