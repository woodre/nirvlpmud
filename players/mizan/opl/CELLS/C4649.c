...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4529", "north",
		"/players/mizan/opl/CELLS/C4769", "south",
		"/players/mizan/opl/CELLS/C4650", "east",
		"/players/mizan/opl/CELLS/C4648", "west",
	});
