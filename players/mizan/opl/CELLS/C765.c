...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C645", "north",
		"/players/mizan/opl/CELLS/C885", "south",
		"/players/mizan/opl/CELLS/C766", "east",
		"/players/mizan/opl/CELLS/C764", "west",
	});
