...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4217", "north",
		"/players/mizan/opl/CELLS/C4457", "south",
		"/players/mizan/opl/CELLS/C4338", "east",
		"/players/mizan/opl/CELLS/C4336", "west",
	});
