...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1728", "west",
	});
	...
	if(!mob1)
	{
		mob1 = clone_object("/players/mizan/opl/beasties/easy/guido.c");
		move_object(mob1, this_object());
	}

	if(!mob2)
	{
		mob2 = clone_object("/players/mizan/opl/beasties/easy/neocon.c");
	...
	if (!door1)
	{
		...
		door1->set_dir("down");
		door1->set_door_room("/players/mizan/opl/CELLS/C1729");
		door1->set_type("secpass-b");
		...
		door2->set_dir("up");
		door2->set_door_room("/players/mizan/opl/CELLS/I1729");
		door2->set_type("secpass-b");
		...
		move_object(door2, "/players/mizan/opl/CELLS/I1729");
...
long()
{
	...
	write("\"No is no negative in a woman's mouth.		-- Sidney\"\n");
