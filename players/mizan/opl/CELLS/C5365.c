...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5245", "north",
		"/players/mizan/opl/CELLS/C5485", "south",
		"/players/mizan/opl/CELLS/C5366", "east",
		"/players/mizan/opl/CELLS/C5364", "west",
	});
