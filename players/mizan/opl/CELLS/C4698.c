...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4578", "north",
		"/players/mizan/opl/CELLS/C4818", "south",
		"/players/mizan/opl/CELLS/C4699", "east",
		"/players/mizan/opl/CELLS/C4697", "west",
	});
