...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4316", "north",
		"/players/mizan/opl/CELLS/C4556", "south",
		"/players/mizan/opl/CELLS/C4437", "east",
		"/players/mizan/opl/CELLS/C4435", "west",
	});
