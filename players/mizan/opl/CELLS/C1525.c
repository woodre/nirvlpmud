...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1405", "north",
		"/players/mizan/opl/CELLS/C1645", "south",
		"/players/mizan/opl/CELLS/C1526", "east",
		"/players/mizan/opl/CELLS/C1524", "west",
	});
