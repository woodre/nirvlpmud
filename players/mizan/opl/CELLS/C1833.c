...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1713", "north",
		"/players/mizan/opl/CELLS/C1953", "south",
		"/players/mizan/opl/CELLS/C1834", "east",
		"/players/mizan/opl/CELLS/C1832", "west",
	});
