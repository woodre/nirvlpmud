...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1186", "north",
		"/players/mizan/opl/CELLS/C1426", "south",
		"/players/mizan/opl/CELLS/C1307", "east",
		"/players/mizan/opl/CELLS/C1305", "west",
	});
