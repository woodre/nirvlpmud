...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4751", "north",
		"/players/mizan/opl/CELLS/C4991", "south",
		"/players/mizan/opl/CELLS/C4872", "east",
		"/players/mizan/opl/CELLS/C4870", "west",
	});
