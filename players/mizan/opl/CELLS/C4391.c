...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4271", "north",
		"/players/mizan/opl/CELLS/C4511", "south",
		"/players/mizan/opl/CELLS/C4392", "east",
		"/players/mizan/opl/CELLS/C4390", "west",
	});
