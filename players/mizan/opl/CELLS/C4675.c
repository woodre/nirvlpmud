...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4555", "north",
		"/players/mizan/opl/CELLS/C4795", "south",
		"/players/mizan/opl/CELLS/C4676", "east",
		"/players/mizan/opl/CELLS/C4674", "west",
	});
