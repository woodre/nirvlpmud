...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4333", "north",
		"/players/mizan/opl/CELLS/C4573", "south",
		"/players/mizan/opl/CELLS/C4454", "east",
		"/players/mizan/opl/CELLS/C4452", "west",
	});
