...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6044", "north",
		"/players/mizan/opl/CELLS/C6284", "south",
		"/players/mizan/opl/CELLS/C6165", "east",
		"/players/mizan/opl/CELLS/C6163", "west",
	});
