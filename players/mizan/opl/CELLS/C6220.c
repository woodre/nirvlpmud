...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C6100", "north",
		"/players/mizan/opl/CELLS/C6340", "south",
		"/players/mizan/opl/CELLS/C6221", "east",
		"/players/mizan/opl/CELLS/C6219", "west",
	});
