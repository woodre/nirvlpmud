...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C3972", "north",
		"/players/mizan/opl/CELLS/C4212", "south",
		"/players/mizan/opl/CELLS/C4093", "east",
		"/players/mizan/opl/CELLS/C4091", "west",
	});
