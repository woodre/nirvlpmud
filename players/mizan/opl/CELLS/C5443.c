...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5323", "north",
		"/players/mizan/opl/CELLS/C5563", "south",
		"/players/mizan/opl/CELLS/C5444", "east",
		"/players/mizan/opl/CELLS/C5442", "west",
	});
