...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4970", "north",
		"/players/mizan/opl/CELLS/C5210", "south",
		"/players/mizan/opl/CELLS/C5091", "east",
		"/players/mizan/opl/CELLS/C5089", "west",
	});
