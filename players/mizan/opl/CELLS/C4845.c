...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4725", "north",
		"/players/mizan/opl/CELLS/C4965", "south",
		"/players/mizan/opl/CELLS/C4846", "east",
		"/players/mizan/opl/CELLS/C4844", "west",
	});
