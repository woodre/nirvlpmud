...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5948", "north",
		"/players/mizan/opl/CELLS/C6188", "south",
		"/players/mizan/opl/CELLS/C6069", "east",
		"/players/mizan/opl/CELLS/C6067", "west",
	});
