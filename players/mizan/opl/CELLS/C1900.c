...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C1780", "north",
		"/players/mizan/opl/CELLS/C2020", "south",
		"/players/mizan/opl/CELLS/C1901", "east",
		"/players/mizan/opl/CELLS/C1899", "west",
	});
