...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C4769", "north",
		"/players/mizan/opl/CELLS/C5009", "south",
		"/players/mizan/opl/CELLS/C4890", "east",
		"/players/mizan/opl/CELLS/C4888", "west",
	});
...
long()
{
	...
	write("\"You'll never find a dead Christianin a foxhole who didn't pray.\"\n");
