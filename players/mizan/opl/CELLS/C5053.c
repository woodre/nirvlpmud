...
reset(int arg)
{
	...
	dest_dir =
	({
		"/players/mizan/opl/CELLS/C5054", "east",
		"/players/mizan/opl/CELLS/C5052", "west",
	});
	...
	if(!mob3)
	{
		mob3 = clone_object("/players/mizan/opl/beasties/medium/sheep.c");
...
long()
{
	...
	write("\"Uh-oh!! I'm having TOO MUCH FUN!!\"\n");
