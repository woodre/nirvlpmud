 ...
 *
 */
inherit "/players/mizan/opl/core/monster";
#include "/obj/ansi.h"
...
heart_beat()
{
    ...
    /* we do our chat */
    if(idle_chat_chance > random(100) && sizeof(arr_idle_chat_mess) > 0)
    {
        a = random(sizeof(arr_idle_chat_mess));
        tell_outside(arr_idle_chat_mess[a] + "\n");
    }
    else if(engine_chat_chance > random(100) && is_engine_running == 1 && sizeof(arr_engine_chat_mess) > 0)
    {
    ...
    /* permit this to act like a normal monster */
    ::heart_beat();
