...
query_snap_misc() {
    return snaps_misc[random(sizeof(snaps_misc))];
}
query_snap_nasty() {
    return snaps_nasty[random(sizeof(snaps_nasty))];
}
query_snap_stupid() {
    return snaps_stupid[random(sizeof(snaps_stupid))];
}
query_snap_ugly() {
    return snaps_ugly[random(sizeof(snaps_ugly))];
}
query_snap_old() {
    return snaps_old[random(sizeof(snaps_old))];
}
query_snap_poor() {
    return snaps_poor[random(sizeof(snaps_poor))];
}
