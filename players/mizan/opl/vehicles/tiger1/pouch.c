...
reset(arg)
{
    ...
    if (!key1) key1 = move_object(clone_object("/players/mizan/opl/vehicles/tiger1/key.c"), this_object());
    if (!key2) key2 = move_object(clone_object("/players/mizan/opl/vehicles/tiger1/ignition_key.c"), this_object());
    if (!manual) manual = move_object(clone_object("/players/mizan/opl/vehicles/tiger1/manual2.c"), this_object());
