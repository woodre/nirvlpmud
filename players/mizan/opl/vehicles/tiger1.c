...
reset(arg)
{
    ...
    if (!bin) bin = move_object(clone_object("/players/mizan/opl/vehicles/tiger1/storage_bin.c"), this_object());
    if (!bin02) bin02 = move_object(clone_object("/players/mizan/opl/vehicles/tiger1/storage_bin02.c"), this_object());


    if (bin)
    {
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell.c"), bin);
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell.c"), bin);
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell.c"), bin);
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell.c"), bin);
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell.c"), bin);
        ...
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell-paint.c"), bin);
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell-paint.c"), bin);
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell-paint.c"), bin);
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell-paint.c"), bin);
        move_object(clone_object("/players/mizan/opl/vehicles/tiger1/shell-paint.c"), bin);
    ...
    move_object(clone_object("/players/mizan/opl/vehicles/fuel/gasoline_drum.c"), this_object());
    move_object(clone_object("/players/mizan/opl/vehicles/fuel/gasoline_drum.c"), this_object());
...
{
    ::delayed_reset();
    move_object(clone_object("/players/mizan/opl/vehicles/tiger1/cannon.c"), this_object());
