...
short()
{
   return "A 9.64mm clip (Dactrol hollow point) [" + toast + "]"; 
}

long() 
{
   write("This is a clip of Dactrol [tm] 9.64mm hollow point ammunition.\n" +
      "Perfect for punching holes in kevlar class armor, or leaving shrapnel traces\n"+
      "of twisted metal inside your victim.\n");
...
query_ammo_name()
{
   return "Dactrol hollow point 9.64mm rounds";
}
...
{
   return "a hollow point 9.64mm round";
}
...
{
   return "hollow point 9.64mm rounds";
}
