/*****************************************************************************
 *      File:                   beano-agent.c
 *      Function:               Weak monster which mutates into stronger one
...
reset(arg)
{
    ...
    if(1 == random(3))
        what2 = clone_object("players/mizan/mbv3/items/balance.c");
    else if(1 == random(20))
        what2 = clone_object("players/mizan/mbv3/items/walkie-talkie.c");
    else
        what2 = clone_object("players/mizan/mbv3/items/pda.c");
...
mutate_into_agent()
{
    ...
    if(room)
    {
        ...
        tell_room(room, HIY + "Sweet Baby James Brown in a handbasket... the Beano has been taken\n"+
