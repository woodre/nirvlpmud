/*****************************************************************************
 *      File:                   neocon-blocker.c
 *      Function:               Restricts player traffic within maze
...
reset(arg)
{
    ...
    set_al(-999);
    set_wc(STATS_DM->get_wc_easy() + random(30));
    ...
    /* blocker monster bonus*/
    set_hp_bonus(STATS_DM->get_hp_bonus_easy() + 500);

    set_heal(40,10);

    set_chance(25);
    set_spell_dam(102);
    set_spell_mess1(short() + " cries: " + HIY + "You will not cross my picket line!\n" + NORM);
    set_spell_mess2(short() + " cries: " + HIY + "You shall not pass! FOX NEWS! FOX NEWS! FOX NEWS!\n" + NORM);
