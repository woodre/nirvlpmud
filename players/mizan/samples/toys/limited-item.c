...
reset(arg)
{
    ...
    set_short(HIW + "A black slimline Strenesse [tm] purse" + NORM);
    set_long("This is an elegant evening purse, made of a smooth black leather that\n"+
    ...
    set_read(HIW + "A label on the handbags reads:\n\nStrenesse AG. Proudly handmade in Nordlingen, Germany.\n" + NORM);
    set_smell(HIW + "The purse smells like luxurious schwarzer Konig leather. Ahh!\n" + NORM);
    set_taste(HIW + "Don't do that. You look silly.\n" + NORM);
}
