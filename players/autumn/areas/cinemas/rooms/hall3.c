...
"several ushers nearby working.  Theaters 1-2 are to the west and theaters 4-5 are to the\n"+
"east.  Theater 3 is right across the hall.\n"+NORM+HIK;  
...
dest_dir = ({
  "/players/autumn/cinemas/rooms/theater3.c","theater",
  "/players/autumn/cinemas/rooms/hall2.c","west",
  "/players/autumn/cinemas/rooms/hall4.c","east",
  "/players/autumn/cinemas/rooms/lobby.c","lobby"
