...
"several ushers nearby working.  Theater 1 is to the west and theaters 3-5 are to the\n"+
"east.  Theater 2 is right across the hall.\n"+NORM+HIK;   
...
dest_dir = ({
  "/players/autumn/cinemas/rooms/theater2.c","theater",
  "/players/autumn/cinemas/rooms/hall1.c","west",
  "/players/autumn/cinemas/rooms/hall3.c","east"
