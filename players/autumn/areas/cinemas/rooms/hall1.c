...
"several ushers nearby working.  Theaters 2-5 are to the east. Theater 1 is right across\n"+
"the hall.\n"+NORM+HIK;  
...
dest_dir = ({
  "/players/autumn/cinemas/rooms/theater1.c","theater",
  "/players/autumn/cinemas/rooms/hall2.c","east"
