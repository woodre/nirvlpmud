...
short_desc=(HIB+"ESC Cinemas: "+NORM+YEL+"Movie Theater #1"+NORM);
...
"|!!!!!!!!!!}"+NORM+"         "+NORM+HIW+"|                             |"+
"          "+NORM+BRED+CYN+"{!!!!!!!!!!|\n"+
"|!!!!!!!!!}"+NORM+"          "+NORM+HIW+"|   "+NORM+YEL+"Check back later"+HIW+
"          | "+NORM+"          "+BRED+CYN+"{!!!!!!!!!|\n"+
"|!!!!!!!!}"+NORM+"           "+NORM+HIW+"|                             |"+
"            "+NORM+BRED+CYN+"{!!!!!!!!|\n"+
"|!!!!!!!}"+NORM+"            "+NORM+HIW+"|        "+NORM+YEL+"for more movies"+HIW+
"      |"+NORM+"             "+NORM+BRED+CYN+"{!!!!!!!|\n"+
"|!!!!!!}"+NORM+"            "+NORM+HIW+" |                             |"+
"              "+NORM+BRED+CYN+"{!!!!!!|\n"+
"|!!!!!!}"+NORM+"            "+NORM+HIW+" |                             | "+
...
dest_dir = ({
  "/players/autumn/cinemas/rooms/hall1.c","exit",
