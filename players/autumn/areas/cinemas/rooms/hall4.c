...
"several ushers nearby working.  Theaters 1-3 are to the west and theaters 5 is to the\n"+
"east.  Theater 4 is right across the hall.\n"+NORM+HIK;   
...
dest_dir = ({
  "/players/autumn/cinemas/rooms/theater4.c","theater",
  "/players/autumn/cinemas/rooms/hall3.c","west",
  "/players/autumn/cinemas/rooms/hall5.c","east"
