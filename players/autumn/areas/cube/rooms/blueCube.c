...
short_desc=(HIK+"A "+HIB+"Blue "+HIK+"cube");

long_desc=
HIB+"      __________________\n"+
"     /\\   ______________ \\\n"+      
"   /:/\\.\\ \\        /:/\\:\\ \\ \n"+   
"  /:/Z/\\:\\ \\      /:/Z/\\:\\ \\ \n"+  
" /:/Z/__\\:\\ \\____/:/Z/  \\:\\ \\ \n"+  
...
"illuminated panels which create an appearance that the room is "+HIB+"blue"+NORM+".\n"+
...
"walls, ceiling, and floor are identical, with exception for a \n"+
...
"near motionless; a sense fear and panic lingers. It is impossible to \n"+
