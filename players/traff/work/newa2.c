/*  ARENA.C - The arena in Delnoch is a place where players of any level
   ...
   As of 2-10-00 used random numbers to add a great deal of
   control as to the levels of monsters cloned.  Simple
   editing can change the percentages.  See notes below.
*/
...
/*  This give players level 1-5
    a 75% chance of getting monsters level 1-5
    a 25% chance of getting monsters level 6-10
*/
      if(this_player()->query_level()<6)  {
        if(g < 75)  {call_out("make_glad1",1); }
        if(g > 74)  { call_out("make_glad2",1); }
      return 1;  }

/*  This gives players level 6 - 10 an even chance of getting
    monsters level 1-5, or
    monsters level 6-10, or
    monsters level 11-15
*/
      if(this_player()->query_level()<11)  {
        if(g < 33)  {call_out("make_glad1",1); }
        if(g > 32 && g < 66)  { call_out("make_glad2",1); }
        if(g > 65)  { call_out("make_glad3",1); }
      return 1;  }

/*  This gives players level 11 - 15 an even chance of getting
    monsters level 1-5, or
    monsters level 6-10, or
    monsters level 11-15
*/
...
/*  This gives players level 16-20
    a 5% chance of getting monsters level 16-20
    a 65% chance of getting monsters level 11-15
    a 30% chance of getting monsters level 6-10
*/
      if(this_player()->query_level()>15)  {
        if(g < 30)  {call_out("make_glad2",1); }
        if(g > 29 && g < 95)  { call_out("make_glad3",1); }
...
make_glad1()  {
  ...
  while(!present("gladiator 6"))  {
    ...
    write("\nA Gladiator strides onto the field.\n");
    write_file("/players/traff/work/log/GONG","Cloned monsters level 1 to 5\n");
...
make_glad2()  {
  ...
  while(!present("gladiator 6"))  {
    ...
    write_file("/players/traff/work/log/GONG",ctime()+" "+tp+"Cloned monsters level 6 to 10\n");
return 1;
}
...
make_glad3()  {
  ...
  while(!present("gladiator 6"))  {
    ...
    write_file("/players/traff/work/log/GONG",ctime()+" "+tp+"Cloned monsters level 11 to 15\n");
return 1;
}
...
make_glad4()  {
  ...
  while(!present("gladiator 6"))  {
    ...
    write_file("/players/traff/work/log/GONG",ctime()+" "+tp+"Cloned monsters level 16 to 20\n");
return 1;
}
