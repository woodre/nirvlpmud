...
if(!vict) { write("Not here, madam.\n"); return 1;}
tell_object(vict,BOLD+"\tYOU ARE A BAD CHILD!\n"+NORM);
...
trans(str) {
  ...
  tell_room(there,capitalize(str)+" is enguled by Dark crystals... then it all disappears...\n");
