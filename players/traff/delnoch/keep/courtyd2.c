/*  COURTYD2.C - Part of Delnoch Keep.  This room is a near
    duplicate of COURTYD.C, however this room may only be entered
    from SCULLERY.C and this room will contain the door to the
    Halfling pens. (High level monsters, yet to be coded.)
...
short() { return HIB+"Courtyard"+NORM;}
