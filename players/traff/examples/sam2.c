...
if(!present("guard"))  {
move_object(clone_object("/players/traff/kguard.c"),this_object());  }
...
"mountains","The mountains rise stedily to the north.  You see snow capped peaks",
"walls","Between sheer cliffs, 6 walls span the pass and controlling access",
"plains","Beyond the walls simi-arrid plains strech as far as you can see",
