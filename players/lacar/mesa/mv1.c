...
reset(arg) {
  ...
  if(arg) return;
     ...
     long_desc =
         "  This is the great majestic Mancos Canyon, well known\n"+
         "territory to the Anasazi indian tribes.  Pinon pine trees\n"+
         "and Juniper bushes grow in abundance alongside the Mancos\n"+
         "River that flows beside this well traveled canyon bottom.\n";
