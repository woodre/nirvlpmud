...
if(!arg) {
  ...
  dest_dir = ({"/players/mouzar/castle/under/under18","north",
               "/players/mouzar/castle/under/under19","west",
               "/players/mouzar/castle/under/under16","east",
               });
           }
if(!present("noble"))
move_object(clone_object("/players/mouzar/castle/under/mon/dnoble"),this_object());
} 
