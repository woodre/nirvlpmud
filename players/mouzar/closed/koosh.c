...
who->query_real_name() == "aingeal" || who->query_real_name() == "hogath" ||
       who->query_real_name() == "data" || who->query_real_name() == "khrell" ||
      ...
      who->query_real_name() == "lexi") {
          ...
          if(this_player()->query_real_name() == "mouzar")
            tell_object(who,"You have been "+color+"kooshed"+NORM+" by the Master!\n");
