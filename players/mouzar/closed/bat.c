...
#define FILENAME "players/mouzar/closed/bat"
...
id(str) { return str=="bat"; }

short() { return "A Bat perched on Mouzar's Shoulder"; }

long() {
  write("This is a well trained bat Mouzar has trained to do his bidding.\n"+
        "It stares at you with red glowing eyes that give you the feeling\n"+
        "of real power behind them.\n");
}
