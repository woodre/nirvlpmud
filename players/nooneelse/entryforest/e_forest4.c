...
reset(arg) {
  ...
  dest_dir=({
             ...
             "players/nooneelse/entryforest/e_forest3", "south",
          });
  if (!find_living("nixie")) {
    nixie_obj=clone_object("players/nooneelse/mon/nixie");
    move_object(nixie_obj, this_object());
  }
}
...
swim(str) {
  ...
  if (str=="water" || str=="pool" || str2=="water" || str2=="pool") {
    ...
    this_player()->move_player("X#players/nooneelse/entryforest/e_forest9");
    return 1;
  }
  return 0;
}
