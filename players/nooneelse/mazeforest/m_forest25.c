...
reset(arg) {
  ...
  dest_dir=({
             "players/nooneelse/mazeforest/m_forest26", "north",
             "players/nooneelse/mazeforest/m_forest5", "east",
             "players/nooneelse/mazeforest/m_forest1", "south",
             "players/nooneelse/mazeforest/m_forest1", "west",
           });
}
