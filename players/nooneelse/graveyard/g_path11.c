...
reset(arg) {
  ...
  dest_dir=({
             "players/nooneelse/graveyard/g_path14", "east",
             "players/nooneelse/graveyard/g_path10", "south",
             "players/nooneelse/graveyard/g_path12", "west",
           });
  if (!present("chest")) {
    obj=clone_object("players/nooneelse/mon/mimic");
