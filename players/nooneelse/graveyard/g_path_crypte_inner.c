...
reset(arg) {
  ...
  items=({
          "arch", "It is door-sized opening in the west wall",
          "stairs", "Stairs carved out of solid granite, leading down",
        });
  dest_dir=({
             "players/nooneelse/graveyard/g_path_crypte_stairs", "down",
             "players/nooneelse/graveyard/g_path_crypte", "west",
           });
}
