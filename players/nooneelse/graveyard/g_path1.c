...
reset(arg) {
  ...
  dest_dir=({
             "players/nooneelse/graveyard/g_path9", "north",
             "players/nooneelse/graveyard/g_path13", "east",
             "players/nooneelse/graveyard/g_path0", "south",
             "players/nooneelse/graveyard/g_path2", "west",
           });
}
