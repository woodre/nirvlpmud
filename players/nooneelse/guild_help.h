...
if(str == "abat" || str == "mbat" || str == "bat") help_file_name="bats";
...
if (str=="back" &&
  ...
  if (str=="wrath" || str=="demon wrath") help_file_name="demon_wrath";
  ...
  if (str=="fix" || str=="title" || str=="fix title" ||
      str=="fix heartbeat" || str=="fix heart beat" ||
      str=="heartbeat" || str=="heart beat")
  ...
  if (str=="paralyze") help_file_name="paralyze";
  ...
  if (str=="shadow") help_file_name="shadow";
  ...
  if (str=="title") help_file_name="title";
  ...
  if (str=="spell levels" || str=="vsl") {
    cat("/players/nooneelse/black/hlp/spell_levels.hlp");
    return 1;
  }
  if (str=="spell category" || str=="vsc") {
    cat("/players/nooneelse/black/hlp/spell_category.hlp");
    return 1;
  }
  return 0;
}
