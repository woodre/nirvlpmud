...
west() {
  this_player()->move_player("west#"+ALCHEMIST_SHOP);
  return 1;
}
...
short() { return "Storeroom for the Alchemist Guild's Shop"; }

long() { write("All things from the Alchemist Guild's Shop are stored here.\n"); }
