...
/*
  ...
  TOOK OUT!!! wtf... first off the spells not only must be at max comparable to the normal mud spells equivalent in level fashion
but they have to use spell_object
- Mythos  <3-14-1999>
*/
