...
reset(arg) {
  ...
  dest_dir=({
    "/players/nooneelse/graves/forest_lawn3", "north",
    "/players/nooneelse/graves/forest_lawn7", "east",
    "/players/nooneelse/graves/forest_lawn9", "south",
    "/players/nooneelse/graves/forest_lawn5", "west",
  });
}
