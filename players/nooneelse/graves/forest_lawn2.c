...
reset(arg) {
  ...
  dest_dir=({
    "/players/nooneelse/graves/forest_lawn3", "east",
    "/players/nooneelse/graves/forest_lawn5", "south",
  });
  if (!present("protege stone"))
    move_object(clone_object("/players/nooneelse/graves/gravestone_protege"),
                this_object());
}
