/*
 groad21.c - evil side of green road
*/

inherit "room/room";

object sticker, coins;
...
reset(arg) {
  ...
  dest_dir=
    ({
      "players/nooneelse/green/groad22", "north",
      "players/nooneelse/green/groad20", "south",
    });
  if (!present("sticker"))
    move_object(clone_object("players/nooneelse/mon/sticker"), this_object());
  return;
}
