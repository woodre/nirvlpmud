/*
 door.c - since the keys in the one on nirvana don't work I uploaded this one.
*/
...
string key_type;
string door_long;
int can_lock, is_locked, is_closed, is_pickable;
...
set_both_status()
{
  ...
  call_other( partner_door, "set_pickable", is_pickable);
}
set_door_long( str)
{
  door_long = str;
