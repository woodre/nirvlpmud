...
for(blah = 0; blah < 3; blah++){
   ...
   move_object(clone_object("/players/jaraxle/ares/mobs/gate_guard.c"), this_object());
...
if(DAEMON->gate1_condition() && !present("big_ol_gate", this_object())){
   ...
   move_object(clone_object("/players/jaraxle/ares/mobs/gate1.c"), this_object());
...
YEL+"###"+HIR+"x"+NORM+YEL+"####"+NORM+"\n");
   ...
   add_exit("/players/jaraxle/cont/rooms/606", "exit"); 
