...
else if(room_num[nroom - 61] == "#") return GRN+room_num[nroom - 61]+NORM; 
else return HIR+room_num[nroom - 61]+NORM;
}
...
else if(room_num[nroom - 67] == "#") return GRN+room_num[nroom - 67]+NORM; 
else return HIR+room_num[nroom - 67]+NORM;
}
...
else if(room_num[nroom - 29] == "#") return GRN+room_num[nroom - 29]+NORM; 
else return HIR+room_num[nroom - 29]+NORM;
}
...
else if(room_num[nroom - 35] == "#") return GRN+room_num[nroom - 35]+NORM; 
else return HIR+room_num[nroom - 35]+NORM;
}
...
else if(room_num[nroom - 3] == "#") return GRN+room_num[nroom - 3]+NORM; 
else return HIR+room_num[nroom - 3]+NORM;
}
...
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"#include \"/players/maledicta/ansi.h\"\n"+
"#define RNUM "+nroom+"\n"+
...
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"\"/players/maledicta/cont/tcrooms/"+(nroom-32)+".c\",\"north\",\n");
}
if(room_num[nroom - 31] != "~" && room_num[nroom - 31] != "M"){
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"\"/players/maledicta/cont/tcrooms/"+(nroom-31)+".c\",\"northeast\",\n");
}
if(room_num[nroom - 33] != "~" && room_num[nroom - 33] != "M"){
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"\"/players/maledicta/cont/tcrooms/"+(nroom-33)+".c\",\"northwest\",\n");
}

if(room_num[nroom + 32] != "~" && room_num[nroom + 32] != "M"){
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"\"/players/maledicta/cont/tcrooms/"+(nroom+32)+".c\",\"south\",\n");
}
if(room_num[nroom + 33] != "~" && room_num[nroom + 33] != "M"){
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"\"/players/maledicta/cont/tcrooms/"+(nroom+33)+".c\",\"southeast\",\n");
}
if(room_num[nroom + 31] != "~" && room_num[nroom + 31] != "M"){
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"\"/players/maledicta/cont/tcrooms/"+(nroom+31)+".c\",\"southwest\",\n");
}
if(room_num[nroom + 1] != "~" && room_num[nroom + 1] != "M"){
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"\"/players/maledicta/cont/tcrooms/"+(nroom+1)+".c\",\"east\",\n");
}
if(room_num[nroom - 1] != "~" && room_num[nroom - 1] != "M"){
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"\"/players/maledicta/cont/tcrooms/"+(nroom-1)+".c\",\"west\",\n");
}
write_file("/players/maledicta/cont/tcrooms/"+nroom+".c",
"});\n");
/*************************************************/
