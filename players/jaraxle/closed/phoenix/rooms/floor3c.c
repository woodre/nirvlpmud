...
reset(arg) {
   ...
   add_exit("/players/jaraxle/closed/phoenix/rooms/floor3d.c","around");
   add_exit("/players/jaraxle/closed/phoenix/rooms/floor3b.c","back");
...
enter_door(str){
   ...
   if(str == "door" || str == "wooden door"){
      ...
      this_player()->move_player("through the door#/players/jaraxle/closed/phoenix/rooms/door2");
      return 1; }
