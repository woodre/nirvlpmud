...
else if(i == 2){ hit_point = 70; max_hp = 70; spell_point = 15; max_sp = 15; } 
else if(i == 3){ hit_point = 80; max_hp = 80; spell_point = 20; max_sp = 20; } 
else if(i == 4){ hit_point = 90; max_hp = 90; spell_point = 25; max_sp = 25; } 
else if(i == 5){ hit_point = 115; max_hp = 115; spell_point = 40; max_sp = 40; } 
else if(i == 6){ hit_point = 125; max_hp = 125; spell_point = 50; max_sp = 50; } 
else if(i == 7){ hit_point = 135; max_hp = 135; spell_point = 65; max_sp = 65; } 
else if(i == 8){ hit_point = 150; max_hp = 150; spell_point = 80; max_sp = 80; } 
else if(i == 9){ hit_point = 170; max_hp = 170; spell_point = 90; max_sp = 90; } 
else if(i == 10){ hit_point = 200; max_hp = 200; spell_point = 125; max_sp = 125; } 
...
object death_coins;
 ...
 DAEMON->set_squire_xp(spot, (xp/2));
...
pkill_me(str){
if(str == query_name() || str == "squire"){
if(!TP->query_pl_k()){ write("You are not brave enough to attack this squire.\n");
return 1; }
}
}
...
cmd_stop_follow(){
   ...
   if(follow_me == 0){
      write(query_name()+" is already holding his position.\n");
      return 1; }
...
cmd_shield(){
  ...
  if(spell_point <= 29){ write(query_name()+" needs ["+HIC+"30"+NORM+"] sp to shield himself.\n"); return 1; }
...
cmd_missile(string str){
   object target;
   if (!str) return 0;
  if(spell_point <= 14){ write(query_name()+" needs ["+HIC+"15"+NORM+"] sp to do this.\n"); return 1; }
...
cmd_shock(string str){
   ...
   object target;
   if (!str) return 0;
   if(spell_point <= 49){ write(query_name()+" needs ["+HIC+"50"+NORM+"] sp to use this.\n"); return 1; }
   if(SPELL_WAIT >=1){ write(query_name()+" cannot cast another spell yet.\n"); return 1; }
...
cmd_fireball(string str){
   ...
   object target;
   if (!str) return 0;
   if(spell_point <= 59){ write(query_name()+" needs ["+HIC+"60"+NORM+"] sp to use this.\n"); return 1; }
   if(SPELL_WAIT >=1){ write(query_name()+" cannot cast another spell yet.\n"); return 1; }
