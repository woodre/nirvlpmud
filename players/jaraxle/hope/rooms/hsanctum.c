...
move_object(clone_object("/players/jaraxle/templar/eplate.c"), this_object());
}
if(!present("bulletin board", this_object())){
move_object(clone_object("/players/jaraxle/hope/eboard.c"), this_object());
}
...
dest_dir = ({
  "/players/jaraxle/hope/rooms/hinner.c", "east",
});
