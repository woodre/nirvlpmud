...
move_object(clone_object("/players/jaraxle/hope/mobs/templar_guard2.c"), this_object());
move_object(clone_object("/players/jaraxle/hope/mobs/templar_guard2.c"), this_object());
}
  if(arg) return;
set_light(1);
...
dest_dir = ({
  "/players/jaraxle/hope/rooms/hinner.c","north",
  "/players/jaraxle/hope/rooms/hdedication.c","east",
