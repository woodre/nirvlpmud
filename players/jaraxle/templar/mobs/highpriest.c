...
reset(arg)  {
   ...
   load_chat("Jeserius preaches: If you are having a difficult time with evil I have\n"+
      "the solution for you!\n");
   load_chat("Jeserius preaches: Evil has no defenses for the "+HIW+"bless"+NORM+"ings of\n"+
      "the church of the Templar.\n");
   load_chat("Jeserius preaches: When the Templar "+HIW+"bless"+NORM+" their "+HIW+"weapons"+NORM+" at\n"+
      "the church, evil has no recourse!\n");
   load_chat("Jeserius preaches: A donation of "+HIY+"5,000"+NORM+" coins to the church\n"+
      "will allow me to assist you in the fight against evil.\n");
   load_chat("Jeserius preaches: Once your battles are done the church can\n"+
      ""+HIW+"disenchant"+NORM+" your Templar blessings free of charge!\n");
...
init(){
   ...
   add_action("remove_bless", "disenchant");
}
...
remove_bless(str){
   ...
   if(!ob->weapon_class()){
      write("You don't think that is a weapon.\n");
      return 1;
   }
   ...
   if(!ob->query_enchantment("templar_holy_water")){
      write("This item has not been blessed with Holy Water.\n");
      return 1; 
   }
   
   ob->remove_enchantment("templar_holy_water");
   write("Jeserius takes hold of the "+str+" and wipes it clean of "+HIW+"Holy Water"+NORM+"...\n"+
      "The weapon's soft aura slowly fades away.\n"+
...
bless_weapon(str){
   ...
   ob->add_enchantment("templar_holy_water",""+HIC+"<"+HIW+"BLESSED"+HIC+">"+NORM+"",""+HIW+"This weapon has been dipped in Holy Water."+NORM+"",5,"other|water",3600,0,0,0);
   write(
