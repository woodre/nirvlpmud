...
reset(arg)  {
   ...
   set_long(
    ...
    "face is creased and slightly wrinkled. He wears the robes of his office\n"+
...
bless_weapon(str){
   ...
   ob->add_enchantment("templar_holy_water",""+HIC+"<"+HIW+"BLESSED"+HIC+">"+NORM+"",""+HIW+"This weapon has been dipped in Holy Water."+NORM+"",5,"other|good",3600,0,0,0);
   write(
