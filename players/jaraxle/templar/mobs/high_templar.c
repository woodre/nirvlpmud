...
set_race("human");
set_gender("male");
set_short(HIR+"High Templar"+NORM);
set_long(
"  Before you stands the most powerful of the templar guard. He is\n"+
"dressed in a full suit of plate armor, each tinted blue with a white\n"+
...
"at the hip. He seems ready for any combat. Use '"+GRN+"command info"+NORM+"' for\n"+
"more information on this guard.\n");  
set_level(20);
set_hp(1050);
set_al(1000);
...
set_spell_mess2(
  "You feel a biting pain as the High Templar's sword slices into your flesh!\n");
...
GRN+"command kill"+NORM+" <"+GRN+"who"+NORM+">\n"+
GRN+"command guard"+NORM+" <"+GRN+"where"+NORM+">\n"+
"Locations include: "+GRN+"gatehouse"+NORM+", "+GRN+"church"+NORM+", "+GRN+" training"+NORM+", "+GRN+"courtyard"+NORM+", "+GRN+"mainhall"+NORM+".\n");
return 1;
}
...
move_object(this_object(), "players/jaraxle/templar/rooms/gatehouse");
guarding = 1;
tell_room(environment(),
...
tell_room(environment(),
"The guard nods and leaves.\n");
move_object(this_object(), "players/jaraxle/templar/rooms/courtyard");
guarding = 1;
tell_room(environment(),
...
tell_room(environment(),
"The guard nods and leaves.\n");
move_object(this_object(), "players/jaraxle/templar/rooms/main");
guarding = 1;
tell_room(environment(),
...
tell_room(environment(),
"The guard nods and leaves.\n");
move_object(this_object(), "players/jaraxle/templar/rooms/church");
guarding = 1;
tell_room(environment(),
...
tell_room(environment(),
"The guard nods and leaves.\n");
move_object(this_object(), "players/jaraxle/templar/rooms/adv_guild");
guarding = 1;
tell_room(environment(),
