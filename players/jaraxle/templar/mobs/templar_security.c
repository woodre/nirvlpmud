...
set_gender("male");
	...
	set_long(
      "  The guard stands tall, bearing his heavy suit of plate armor well.\n"+
      "His face is hidden behind a protective visor on his helm, and he has\n"+
      "the red cross of the Knights Templar emblazoned upon his breastplate.\n"+
      "If you have lost your cross, he will bring one for you. Type: "+GRN+"cross"+NORM+".\n");
	set_level(15);
	set_hp(250);
	set_al(1000);
	weapon = clone_object("players/jaraxle/templar/items/sword2");
