...
#define BOARD_NAME "players/jaraxle/templar/rooms/eboard"
...
long() {
	int ind;
	write("This is the "+HIR+"E"+NORM+BOLD+"lite"+NORM+" bulletin board.\n");
	if (!msg_num) {
   ...
   write("Usage:  "+HIR+"note"+NORM+" <"+HIR+"headline"+NORM+">, "+HIR+"read"+NORM+"/"+HIR+"remove"+NORM+" <"+HIR+"message number"+NORM+">\n");
   write("        "+HIR+"store"+NORM+" <"+HIR+"message number"+NORM+"> <"+HIR+"file name"+NORM+">\n");
   write(" \n");
...
short() {
	return ""+HIR+"E"+NORM+BOLD+"lite"+NORM+" bulletin board(" + msg_num + " msg(s))";
}
