...
if(!present("weapon_owner")){
	owner = clone_object("/players/jaraxle/templar/mobs/weapon_owner.c");
...
dest_dir = ({
  "/players/jaraxle/templar/rooms/courtyard.c","west",
});
...
purchase_it(string str){
 ...
 if(!present("weapon_owner", this_object())){
	...
	if(purchase == "1"){
	  cost = 1200;
	  item = clone_object("/players/jaraxle/templar/items/sword.c");
	  what = "sword";
	  }
	else if(purchase == "2"){
	  cost = 1400;
	  item = clone_object("/players/jaraxle/templar/items/axe.c");
	  what = "battle axe";
	  }
	else if(purchase == "3"){
	  cost = 1000;
	  item = clone_object("/players/jaraxle/templar/items/hammer.c");
	  what = "hammer";
	  }
	else if(purchase == "4"){
	  cost = 850;
	  item = clone_object("/players/jaraxle/templar/items/mace.c");
	  what = "mace";
	  }
	else if(purchase == "5"){
	  cost = 2500;
	  item = clone_object("/players/jaraxle/templar/items/pike2.c");
	  what = "pike";
	  }
	else if(purchase == "6"){
	  cost = 400;
	  item = clone_object("/players/jaraxle/templar/items/knife.c");
	  what = "knife";
	  }
	else if(purchase == "7"){
	  cost = 10000;
	  item = clone_object("/players/jaraxle/templar/items/bardsword.c");
	  what = "bardsword";
	  }
	else if(purchase == "8"){
	  cost = 10000;
	  item = clone_object("/players/jaraxle/templar/items/bardsword2.c");
	  what = "bardsword";
	  }
	else if(purchase == "9"){
	  cost = 10000;
	  item = clone_object("/players/jaraxle/templar/items/bardswordb.c");
	  what = "bardsword";
	  }
    else if(purchase == "10"){
	  cost = 10000;
	  item = clone_object("/players/jaraxle/templar/items/bardswordxs.c");
	  what = "bardsword";
	  }
	else{
