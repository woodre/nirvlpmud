...
#define CHUNK 20
#define SAVE_PATH "players/jaraxle/templar/eplate/plate_obj"
...
if(file_size("/players/jaraxle/templar/eplate/"+str+".plt") < 1){
...
more("/players/jaraxle/templar/eplate/"+str+".plt");
return 1;
}
...
cat("/players/jaraxle/templar/eplate/"+i+".plt");
write(
HIY+""+
"_______________________________________________________________"+NORM+"\n");
return 1;
...
if(counter < 9){
write_file("/players/jaraxle/templar/eplate/"+numero+".plt",
...
write_file("/players/jaraxle/templar/eplate/"+namer+".plt",
