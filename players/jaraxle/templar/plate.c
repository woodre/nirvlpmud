...
#define CHUNK 20
#define SAVE_PATH "players/jaraxle/templar/plate/plate_obj"
...
if(file_size("/players/jaraxle/templar/plate/"+str+".plt") < 1){
...
more("/players/jaraxle/templar/plate/"+str+".plt");
return 1;
}
...
cat("/players/jaraxle/templar/plate/"+i+".plt");
write(
HIY+""+
"_______________________________________________________________"+NORM+"\n");
return 1;
...
if(counter < 9){
write_file("/players/jaraxle/templar/plate/"+numero+".plt",
...
write_file("/players/jaraxle/templar/plate/"+namer+".plt",
