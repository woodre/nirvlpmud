...
reset(arg) {
   ...
   "throughout the tunnel.  The tunnel leads further north\n"+
   ...
   dest_dir = ({
         "/players/jaraxle/templar/rooms/EXITHERE","back",
       "/players/jaraxle/templar/quests/unicorn/rooms/cave2.c","north",
});
