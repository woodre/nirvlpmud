...
short(){ return "Kra"+HIR+"K"+NORM+"in, the DualAxe"+(wielded?" "+HIR+"("+NORM+"dual"+HIR+"-"+NORM+"wielded"+HIR+")"+NORM+"":""); }

query_offwielded(){ return wielded; }

query_save_flag(){ return 3; }
