...
reset(arg) {
  ...
  ""+GRN+"\t@@@@@@"+BLU+"~~~"+NORM+GRN+"@@\n"+
   "\t@@@@@@@"+BLU+"~"+NORM+GRN+"@@@\n"+
   "\t@@@@@@@"+BLU+"~"+NORM+GRN+"@@@\n"+
   "\t@@@@"+HIM+"~"+HIB+"X"+NORM+GRN+"@"+BLU+"~"+NORM+GRN+"@@@\n"+
   "\t@@@@"+HIM+"~~~"+NORM+RED+"="+GRN+"@@@\n"+
...
west(){
   ...
   this_player()->move_player("west#/players/jaraxle/3rd/ooze/rooms/room2n");
   return 1; }

south(){
   write("You slosh south out of the "+HIM+"Living Ooze"+NORM+".\n");
...
search_me(arg){
   if(!arg){
      write(HIM+"   A living pool of bubbling, gurgling ooze.  The ooze covers the\n"+
         ...
         "very slowly. A forest can be seen to the east, while tops of a few\n"+
