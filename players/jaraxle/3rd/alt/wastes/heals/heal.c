...
reset(arg) {
   if(arg) return; 
   shots = 3;  }
id(str) { return str == "heal" || str == "pack pack" || str == "heal pack" || str == "customheal" || str == "heals" || str == "pack of healing" || str == "healing" || str == "pack of heals"; }
...
if(no == 7){ COL = ""+HIB+""; }
if(no == 10){ COL = ""+HIR+""; }
return COL+"Healing Pack "+COL+"-"+NORM+shots+COL+"-"+NORM; }
