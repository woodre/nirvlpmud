...
break;
case 1: my_name = lower_case("/players/jaraxle/closed/names"->get_female_name());
break;
}
   switch(random(4)){
  ...
  set_wander(30, 0, ({ "pass" }));
   ...
   move_object(clone_object("/players/jaraxle/3rd/alt/mobs/fallen_weap.c"),TO);
...
capitalize(my_name)+" is a human, 5 feet 11 inches tall, 208 lbs.\n"+
...
"The Fallen falls to the ground, dead.\n");
   return 0;
}
