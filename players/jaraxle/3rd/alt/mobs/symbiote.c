...
gold->set_money(5000+random(1501));
...
set_wc(int i) { if(!base_wc) base_wc = i; return ::set_wc(i); }
set_ac(int i) { if(!base_ac) base_ac = i; return ::set_ac(i); }
