...
switch(random(4)){
case 0: weap_name = "Krypt";
break;
case 1: weap_name = "Pryme";
break;
case 2: weap_name = "ScreAmer";
break;
case 3: weap_name = "Templar Slayer";
break;
}
   ::reset(arg);
   if(arg) return;
   ...
   gold->set_money(5000+random(501));                              
...
long(){
   ...
   write(capitalize(my_name)+" is a human, 6 feet 1 inches tall, 296 lbs.\n"+
    ...
    ""+capitalize(my_name)+" has Cybernetic Implants.\n"+
      ...
      ""+capitalize(my_name)+" has "+BOLD+"FluX"+NORM+" jacks.\n"+
      ""+capitalize(my_name)+" has a smartweapon link.\n"+
    ""+capitalize(my_name)+"'s arms are plated with poison dart cannons.\n"+
      "\t"+capitalize(my_name)+" is carrying:\n"+
      weap_name+" <vortex-forged> (wielded).\n"+
    HIY+"CyberNinja"+NORM+" Implants.\n");
}

monster_died() {
   tell_room(environment(this_object()),
"The CyberNinja falls to the ground, dead.\n");
   return 0;
}
