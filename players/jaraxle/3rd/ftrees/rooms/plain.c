...
long_desc =
        "  A wide open clearing.  The thick forest looms to the north with a\n"+
        "small path between a set of trees.  The grass looks extremely dry\n"+
        "and has a yellow tint to it.  The ground is hard and warm to the\n"+
        "touch.  A haze creates distorting waves in the air to the south.\n";
