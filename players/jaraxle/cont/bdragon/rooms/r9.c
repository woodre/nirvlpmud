...
move_object(clone_object("/players/jaraxle/cont/mobs/bdragon1.c"), this_object());
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/bdragon/rooms/r8.c","east",
...
if(str == "pillar" || str == "pillars"){
 ...
 if(this_player()->query_attack()){
  ...
  move_object(this_player(), "/players/jaraxle/cont/bdragon/rooms/r10.c");
