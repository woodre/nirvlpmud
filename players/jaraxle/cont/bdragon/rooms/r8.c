...
move_object(clone_object("/players/jaraxle/cont/mobs/bdragon4"), this_object());
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/bdragon/rooms/r6.c","east",

  "/players/jaraxle/cont/bdragon/rooms/r9.c","west",
