...
move_object(clone_object("/players/jaraxle/cont/mobs/blue_prisoner"), this_object());

}

if(!present("ice dragon", this_object())){

move_object(clone_object("/players/jaraxle/cont/mobs/ice_dragon"), this_object());
...
"through to your nostrils. To the west the tunnel leads\n"+
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/bdragon/rooms/r3.c","west",
