...
move_object(clone_object("/players/jaraxle/cont/mobs/bdragon2.c"), this_object());
move_object(clone_object("/players/jaraxle/cont/mobs/bdragon2.c"), this_object());
...
"vast border.  An archway leading to the south and a large\n"+
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/bdragon/rooms/r3.c","south",
