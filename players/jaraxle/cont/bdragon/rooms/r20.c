...
"The symbol is of a huge serpent intertwined around a frozen\n"+

"pillar.  It appears as though something can be inserted into\n"+

"the center of the huge moon that is over the scene",
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/bdragon/rooms/r18.c","out",
...
if(str == "dagger into moon"){

  if(present("dagger_blue_dragon", this_player())){

    write("You insert the dagger into the moon of the symbol...\n");

    destruct(present("dagger_blue_dragon", this_player()));
...
object coins6;
  ...
  move_object(clone_object("players/jaraxle/cont/bdragon/amulet.c"), this_object());
  move_object(clone_object("players/jaraxle/cont/bdragon/potion.c"), this_object());
  move_object(clone_object("players/jaraxle/cont/bdragon/potion.c"), this_object());
  move_object(clone_object("players/jaraxle/cont/bdragon/potion.c"), this_object());
