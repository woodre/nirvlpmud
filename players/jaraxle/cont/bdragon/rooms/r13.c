...
dest_dir = ({
  ...
  "/players/jaraxle/cont/bdragon/rooms/r14.c","north",

  "/players/jaraxle/cont/bdragon/rooms/r19.c","south",

  "/players/jaraxle/cont/bdragon/rooms/r12.c","east",
