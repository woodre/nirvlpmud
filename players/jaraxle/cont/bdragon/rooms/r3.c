...
"The tunnel continues to the east, or to the south and\n"+
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/bdragon/rooms/r21.c","north",
  "/players/jaraxle/cont/bdragon/rooms/r2.c","south",

  "/players/jaraxle/cont/bdragon/rooms/r4.c","east",
