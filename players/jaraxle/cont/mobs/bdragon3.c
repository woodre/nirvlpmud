...
monster_died(){
   ...
   move_object(clone_object("/players/jaraxle/cont/bdragon/dagger.c"),
...
heart_beat(){
   ...
   if(query_hp() < 1000 && random(100) < 20){ 
      ...
      tell_room(environment(),
         ...
         HIY+"<>"+NORM+" The King lets out a roar of anger!\n\n"+
         
         HIY+"<>"+NORM+" You draw back in fear as his strikes begin to rip apart the surrounding area!\n");
      
      armor_class += 1+random(5);
      weapon_class += random(2);
   ...
   if(!bdelay && random(100) < 60 && attacker_ob){
      ...
      attacker_ob->hit_player(random(70) + 20, "other|electric");
   ...
   if(bdelay && attacker_ob){
      ...
      if(rnum > 70){
         ...
         if(alt_attacker_ob && random(100) < 30){
            ...
            alt_attacker_ob->hit_player(35, "other|electric");
  ...
  if(alt_attacker_ob)
      ...
      if(hit_point < 100 && attacker_ob){
         ...
         attacker_ob->hit_player(random(25) + 1, "other|electric");
