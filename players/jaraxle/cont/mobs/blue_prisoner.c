...
if(str == "prisoner" || str == "elf" || str == "slave"){

if(present("ice dragon", environment(this_player()))){

  write("The ice dragon moves to intercept you, keeping you from the prisoner.\n");
  ...
  write("\n\nYou reach out and release the Elf prisoner from his chains.\n"+
        ...
        "give.'  He then leans closer and says,'west from the entrance of the oak\n"+

        "and then north and through the woods. Continue northwest until you find a\n"+
...
tester->set_alias("rescued_blue_elf_dood_mal");
