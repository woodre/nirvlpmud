...
set_short(HIB+"Blue "+NORM+BLU+"Dragon"+NORM+" [soldier]");
...
add_action("exit_block", "west", 1);
add_action("exit_block", "south");
add_action("exit_block", "s");
...
attacker_ob->hit_player(random(40) + 10, "other|electric");
