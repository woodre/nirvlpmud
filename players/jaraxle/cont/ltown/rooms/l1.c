...
if(!present("cont_lizardguard")){
	...
	guard1 = clone_object("/players/jaraxle/cont/ltown/mobs/lguard.c");

	move_object(guard1, this_object());

	guard2 = clone_object("/players/jaraxle/cont/ltown/mobs/lguard.c");
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/ltown/rooms/l2.c","north",

  "/players/jaraxle/cont/ltown/rooms/lbar.c", "east",

  "/players/jaraxle/3rd/warrior/rooms/room3.c","leave"
