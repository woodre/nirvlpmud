...
thug = clone_object("/players/jaraxle/cont/ltown/mobs/lthug.c");
...
short_desc = "Third Earth ["+HIG+"Terk'ula"+BOLD+BLK+" (dark alley)"+NORM+"]";
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/ltown/rooms/l5.c", "west",
