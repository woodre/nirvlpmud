...
if(!present("clerk_owner")){
	...
	owner = clone_object("/players/jaraxle/cont/ltown/mobs/store_owner.c");
...
short_desc = "Third Earth ["+HIG+"Terk'ula Equipment Store"+NORM+"]";
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/ltown/rooms/l2.c","out",
...
purchase_it(string str){
 ...
 if(!present("clerk_owner", this_object())){
	...
	if(!str){ write("Usage: purchase 1-5.\n"); return 1; }

	if(str == "1"){

	  cost = 50;

	  item = clone_object("/players/jaraxle/cont/ltown/objects/sbag.c");
	  ...
	  item = clone_object("/players/jaraxle/cont/ltown/objects/lbag.c");
	  ...
	  item = clone_object("/players/jaraxle/cont/ltown/objects/tenfoot.c");
	  ...
	  item = clone_object("/players/jaraxle/cont/ltown/objects/chalk.c");
	  ...
	  item = clone_object("/players/jaraxle/cont/ltown/objects/herbs.c");
