...
dest_dir = ({
  ...
  "/players/jaraxle/cont/ltown/rooms/l5.c","north",

  "/players/jaraxle/cont/ltown/rooms/hut2.c", "east",

  "/players/jaraxle/cont/ltown/rooms/hut3.c", "west",

  "/players/jaraxle/cont/ltown/rooms/l2.c", "south",
