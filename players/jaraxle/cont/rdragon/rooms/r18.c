...
dest_dir = ({
  ...
  "/players/jaraxle/cont/rdragon/rooms/r19.c","east",

  "/players/jaraxle/cont/rdragon/rooms/r16.c","north",
...
squeeze(str){
 ...
 if(str == "into gap" || str == "gap" || str == "wall" || str == "into wall"){
  ...
  move_object(this_player(), "/players/jaraxle/cont/rdragon/rooms/r20.c");
