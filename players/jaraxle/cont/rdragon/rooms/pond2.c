...
int rapier_searched, sword_searched;
...
reset(arg) {
   ...
   short_desc = "Third Earth ["+HIB+"the pond"+NORM+"]";
   ...
   "and continues to the southeast into the forest.\n";
...
search(){  
   ...
   if(present("rescued_elf_dood_mal", this_player())){ 
   if(rapier_searched){ write("You search but find nothing.\n"); return 1; }
      
      destruct(present("rescued_elf_dood_mal", this_player()));
      
      write("You search carefully and uncover a small treasure trove...\n");
      
      move_object(clone_object("/players/jaraxle/cont/rdragon/elven_rapier.c"), this_object());
   ...
   if(present("rescued_blue_elf_dood_mal", this_player())){ 
   if(sword_searched){ write("You search but find nothing.\n"); return 1; }
      
      destruct(present("rescued_blue_elf_dood_mal", this_player()));
      
      write("You search carefully and uncover a small treasure trove...\n");
      
      move_object(clone_object("/players/jaraxle/cont/bdragon/sword.c"),
         this_object());
