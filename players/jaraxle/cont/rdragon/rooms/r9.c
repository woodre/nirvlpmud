...
dest_dir = ({
  ...
  "/players/jaraxle/cont/rdragon/rooms/r8.c","east",
...
move_object(clone_object("/players/jaraxle/cont/mobs/rdragon5.c"), this_object());
...
if(str == "pillar" || str == "pillars"){
 ...
 if(this_player()->query_attack()){
  ...
  move_object(this_player(), "/players/jaraxle/cont/rdragon/rooms/r10.c");
