...
move_object(clone_object("/players/jaraxle/cont/mobs/rdragon1"), this_object());
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/rdragon/rooms/r6.c","east",

  "/players/jaraxle/cont/rdragon/rooms/r9.c","west",
