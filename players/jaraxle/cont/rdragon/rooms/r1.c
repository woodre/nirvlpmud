...
reset(arg) {
   ...
   short_desc = "Entrance to the "+HIR+"Red"+NORM+RED+" Dragon Clan"+NORM;
   ...
   dest_dir = ({
         ...
         "/players/jaraxle/3rd/volcano/rooms/trail5.c","out",
         
         "/players/jaraxle/cont/rdragon/rooms/r2.c","west",
