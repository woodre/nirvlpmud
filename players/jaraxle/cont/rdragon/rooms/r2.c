...
for(i = 0; i < 4; i++){
 ...
 move_object(clone_object("/players/jaraxle/cont/mobs/darkling"), this_object());
...
dest_dir = ({
  ...
  "/players/jaraxle/cont/rdragon/rooms/r3.c","north",

  "/players/jaraxle/cont/rdragon/rooms/r1.c","east",

  "/players/jaraxle/cont/rdragon/rooms/r5.c","west",
