...
set_name(BOLD+"Queen Delarintoris, "+HIG+"Emerald "+NORM+GRN+"Dragon"+NORM);
...
"tearing apart nearly any creature in existence. She has been imprisoned\n"+

"here in the caves for over 4 millenia. She is perhaps the most \n"+

"intimidating sight you have ever seen.\n");
...
load_chat("The Queen hisses...\n");

load_chat("The light reflects from green scale and bounces around the room.\n");
  move_object(clone_object("/players/jaraxle/cave/mobs/orb.c"),this_object());
...
if(sps < 1000) sps += random(20);

rnum = random(100);

if(random(100) > 90 && query_hp() < query_mhp() && sps > 100){
...
if(random(100) > 95 && !shield_on && sps > 100){
