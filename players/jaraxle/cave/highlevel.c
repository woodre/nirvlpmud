...
set_chat_chance(5);
  ...
  load_chat("The huge "+RED+"Ettin"+NORM+" swings its clubs in anticipation.\n");

  load_chat("Both of the heads of the "+RED+"Ettin"+NORM+" sneer at you.\n");
...
"You look up in time to see both of the "+RED+"Ettin"+NORM+"s clubs drop down on you...\n\n"+
...
set_chat_chance(5);
  ...
  load_chat("The "+BOLD+BLK+"golem"+NORM+" stands perfectly still.\n");

set_a_chat_chance(15);

  load_a_chat("Your weapon rings out against the "+BOLD+BLK+"stone"+NORM+" skin of the "+BOLD+BLK+"golem"+NORM+"!\n");

  load_a_chat(BOLD+BLK+"Golem"+NORM+" hits you very hard.\n");
...
"The "+BOLD+BLK+"golem"+NORM+" spins about "+HIM+"SLAMMING"+NORM+" its opponent!\n");

set_spell_mess2(

"You feel dazed as the "+BOLD+BLK+"golem"+NORM+" "+HIM+"SLAMS"+NORM+" you with its arms!\n");
...
set_name(HIR+"Fire Elemental"+NORM);
...
set_name(HIW+"Skeletal "+BOLD+BLK+"Knight"+NORM+"");
...
set_name(GRN+"Shambling Mound"+NORM+"");  
...
write_file("/players/jaraxle/log/high_mob",
