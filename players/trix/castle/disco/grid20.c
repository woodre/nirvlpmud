...
"The toilet is south of here.\n";

   short_desc = "EclYpsE";
    dest_dir = ({ "/players/trix/castle/disco/grid15.c","north",
                  "/players/trix/castle/disco/e3.c","east",
                  "/players/trix/castle/disco/wc.c","south",
                  "/players/trix/castle/disco/grid19.c","west",
                  "/players/trix/castle/disco/grid24.c","southwest"});
    cont=0;
    while(cont<random(2))
