...
"closed eyes in what you suppose could be a drug induced trance.\n";
   ...
   short_desc = "EclYpsE";
    dest_dir = ({ "/players/trix/castle/disco/grid11.c","north",
                  "/players/trix/castle/disco/w3.c","west",
                  "/players/trix/castle/disco/bar.c","south",
                  "/players/trix/castle/disco/grid17.c","east",
                  "/players/trix/castle/disco/grid22.c","southeast"});
    cont=0;
    while(cont<random(2))
