...
"closed in what you suppose could be a drug induced trance.  The DJ is\n"+
"south of here.\n";
   short_desc = "EclYpsE";
    dest_dir = ({ "/players/trix/castle/disco/grid3.c","north",
                  "/players/trix/castle/disco/grid13.c","south"});
    cont=0;
    while(cont<random(2))
