...
"closed eyes in what you suppose could be a drug induced trance.\n";
   ...
   short_desc = "EclYpsE";
    dest_dir = ({ "/players/trix/castle/disco/grid4.c","northwest",
                  "/players/trix/castle/disco/grid15.c","south",
                  "/players/trix/castle/disco/grid9.c","west",
                  "/players/trix/castle/disco/e1.c","east"});
    cont=0;
    while(cont<random(2))
