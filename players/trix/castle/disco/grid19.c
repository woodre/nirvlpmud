...
"North of here you see some stairs leading down.\n";

   short_desc = "EclYpsE";
    dest_dir = ({ "/players/trix/castle/disco/grid14.c","north",
                  "/players/trix/castle/disco/grid18.c","west",
                  "/players/trix/castle/disco/grid20.c","east"});
    cont=0;
    while(cont<random(2))
