...
reset(arg) {
   ...
   short_desc = "EclYpsE's Restaurant";
    dest_dir = ({ "/players/trix/castle/disco/d1.c","north",
                  "/players/trix/castle/disco/d2.c","northeast",
                  "/players/trix/castle/disco/d12.c","southeast",
                  "/players/trix/castle/disco/d11.c","south"});
