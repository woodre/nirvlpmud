...
"closed eyes in what you suppose could be a drug induced trance.\n";
   short_desc = "EclYpsE";
    dest_dir = ({ "/players/trix/castle/disco/grid2.c","northeast",
                  "/players/trix/castle/disco/w1.c","west",
                  "/players/trix/castle/disco/grid7.c","east",
                  "/players/trix/castle/disco/grid11.c","south"});
    cont=0;
    while(cont<random(2))
