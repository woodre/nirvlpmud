...
reset(arg) {
   ...
   long_desc =
              ...
              "disappears in dark depths flowing through a huge grating, and depositing\n"+
    ...
    dest_dir = ({
                  "/players/trix/castle/quest/Eseg8","up"
                                                        });
    discovered=0;
...
{ object pen;
  ...
  if(arg!="grid" && arg!="grate" && arg!="grating") { write("Search what?\n"); return 1; }
