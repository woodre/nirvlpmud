...
#define FILENAME "players/trix/closed/ball"
...
short() { return "Arkangel's Crystal Ball"; }
...
init() {
  ...
  if(this_player()->query_real_name()!="trix")
        { tell_object(this_player(),"You're Evil, the ball shines and glows, you loose consciousness.\n");
