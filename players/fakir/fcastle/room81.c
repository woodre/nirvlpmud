...
"the right, and give a good view of the eastern approach to the\n"+
"castle wall.  Ahead and behind, two-story guard towers over-\n"+
"look this area of the castle's outer ward, as well as the entire\n"+
"northern and southern wards. You are standing on the eastern\n"+
"ward, facing north.\n";
...
"ward",       "The defensive walkway and battlement that surrounds the entire\n"+
              ...
              "defending the castle. You are standing on the eastern ward, facing"+
              "north",
});
...
dest_dir = ({
   "/players/fakir/fcastle/room80.c", "north",
   "/players/fakir/fcastle/room13.c", "south",
});
}
