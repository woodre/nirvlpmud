...
"main drawbridge.  Far along the ward to the west, a two-story\n"+
"guard tower overlooks this area of the castle's outer ward, as\n"+
"well as the entire western ward. Behind you, to the east, an-\n"+
"other guard tower would be in view if you were to turn that\n"+
"direction.  You are standing on the southern ward, facing west.\n";
...
dest_dir = ({
   "/players/fakir/fcastle/room2.c", "west",
