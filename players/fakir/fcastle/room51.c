...
"wall",     "The north wall of the guest bedroom in the east tower",
"sun",      "You can only see the sunlight",
"room",     "The guest bedroom of the east tower",
...
dest_dir = ({
   "/players/fakir/fcastle/room91.c", "out",
