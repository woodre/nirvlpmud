...
"right, and give a good view of the southern approach to the main\n"+
"drawbridge.  Just ahead, a two-story guard tower overlooks this\n"+
"area of the castle's outer ward, as well as the entire eastern\n"+
"ward.  You are standing on the southern ward, facing east.\n";
...
dest_dir = ({
   "/players/fakir/fcastle/room17.c", "east",
