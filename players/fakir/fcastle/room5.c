...
"the left, and give a good view of the western approach to the\n"+
...
"You are standing on the western ward, facing north.\n";
...
dest_dir = ({
   "/players/fakir/fcastle/room6.c", "north",
   "/players/fakir/fcastle/room73.c", "south",
});
}
