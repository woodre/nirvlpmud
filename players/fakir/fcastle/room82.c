...
"the right, and give a good view of the easterh approach to the\n"+
"castle wall.  Along the ward to the north, a two-story guard\n"+
"tower overlooks this area of the castle's outer ward, as well\n"+
"as the entire northern ward. Behind you, to the south, another\n"+
"guard tower would be in view if you were to turn that direction.\n"+
"You are standing on the eastern ward, facing north.\n";
...
dest_dir = ({
   "/players/fakir/fcastle/room81.c", "north",
   "/players/fakir/fcastle/room14.c",  "south",
});
}
