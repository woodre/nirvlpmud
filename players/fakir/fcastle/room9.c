...
"castle wall.  Along the ward to the east, a two-story guard\n"+
"tower overlooks this area of the castle's outer ward, as well\n"+
"as the entire eastern ward. Behind you, to the west, another\n"+
"guard tower would be in view if you were to turn that direction.\n"+
"You are standing on the northern ward, facing east.\n";
...
dest_dir = ({
   "/players/fakir/fcastle/room10.c", "east",
   "/players/fakir/fcastle/room77.c", "west",
});
}
