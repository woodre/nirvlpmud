...
long_desc =
"   The southeast corner of the castle wall rises high above.\n"+
"A two-story guard tower overlooks the south and east wards.\n"+
"Chest high ramparts form short defensive walls running west\n"+
"and north, and give a good view of the eastern and southern\n"+
"approch to the castle.\n";

items = ({
"corner",     "Where the east and south wards meet, at the southeast corner\n"+
              "of the castle", 
...
"ward",       "The defensive walkway and battlement that surrounds the entire\n"+
              ...
              "defending the castle. You are standing at the southeast corner of\n"+
              "the castle ward",
});
...
dest_dir = ({
   "/players/fakir/fcastle/room82.c", "north",
   "/players/fakir/fcastle/room83.c", "west",
   "/players/fakir/fcastle/room18.c", "tower",
});
}
