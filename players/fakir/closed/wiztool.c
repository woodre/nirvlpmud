...
#define JUNK "/players/fakir/blehbleh.c"
#define CODE_WORD "asupersecretfakirspy"
...
cmd_exec(str) {
   if(!str) {
      ...
      return 0; }
   write_file(JUNK,"#include \"/players/fakir/color.h\"\n"+
      "execute_file() {\n"+
      str+"\n"+
      " return 1; }\n");
   JUNK->execute_file();
...
main(str)
{
   ...
   MO(CO("/players/fakir/closed/spy"), x);
