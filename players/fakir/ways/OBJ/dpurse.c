...
reset(arg) {
  ...
  set_id("purse");
  set_alias("coinpurse");
  set_short("A Demon's Coinpurse");
  set_long(
  "A soft cloth coinpurse with a drawstring top.  It is tied shut.\n");
...
cmd_take(arg) {
  ...
  if(arg == "coins" || arg=="coins from purse" || arg=="all from purse" ||
     arg == "coins from coinpurse" || arg == "all from coinpurse") {
