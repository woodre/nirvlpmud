...
long_desc =
   ...
   "southeast a swinging door opens and closes with the passing of\n"+
   "the serving maids.  The bar stretches along the entire north wall\n"+
   "of this inns commonroom, and the fireplace covers the south wall.\n"+
   "People are eating and drinking at the various tables hoping to see\n"+
   "a gleeman do some magic tricks.\n";
...
dest_dir = ({
   "/players/fakir/inn/room7.c", "north",
   "/players/fakir/inn/room15.c", "east",
   "/players/fakir/inn/room9.c", "south",
   "/players/fakir/inn/room16.c", "northeast",
   "/players/fakir/inn/room14.c", "southeast",
   "/players/fakir/inn/room5.c",  "west",
   "/players/fakir/inn/room6.c",  "northwest",
   "/players/fakir/inn/room4.c",  "southwest",
