...
long_desc =
   ...
   "wall to the west.  Alcoves have been built into the face of the\n"+
...
if(!present("cenn",this_object()))
 move_object(clone_object("/players/fakir/inn/NPC/cenn.c"),this_object());
dest_dir = ({
   "/players/fakir/inn/room13.c", "north",
   "/players/fakir/inn/room11.c", "west",
   "/players/fakir/inn/room10.c", "northwest",
});
