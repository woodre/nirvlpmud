...
long_desc =
   ...
   "box.  A small amount of smoke escapes the firebox and swirls upward in\n"+
...
items = ({
   ...
   "keystone",  "Wider at the top than at the bottom, it acts as a wedge and\n"+
                ...
                "keystone has some Ogier runes inscribed upon it.",
   ...
   "runes",     "The runes are covered in soot and hard to see.  You should try\n"+
                "to 'rub' them.",
