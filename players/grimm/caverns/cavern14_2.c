...
south() {
   if(!present("zombie")) {
      this_player()->move_player("south#players/grimm/caverns/cavern15_2");
      return 1; 
   }
...
west() {
   this_player()->move_player("west#players/grimm/caverns/cavern12_2");
   return 1;
}
east() {
  this_player()->move_player("east#players/grimm/caverns/cavern16_2");
  return 1;
}
monster() {
   object monster;
