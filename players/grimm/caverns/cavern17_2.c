...
north() {
   if(!present("zombie")) {
      this_player()->move_player("north#players/grimm/caverns/cavern16_2");
      return 1; 
   }
...
west() {
   this_player()->move_player("west#players/grimm/caverns/cavern15_2");
   return 1;
}
up() {
  this_player()->move_player("up#players/grimm/caverns/cavern3");
  return 1;
}
monster() {
   object monster;
