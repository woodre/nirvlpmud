...
east() {
   if(!present("zombie")) {
      this_player()->move_player("east#players/grimm/caverns/cavern17_2");
      return 1; 
   }
...
west() {
   this_player()->move_player("west#players/grimm/caverns/cavern13_2");
   return 1;
}
north() {
  this_player()->move_player("north#players/grimm/caverns/cavern14_2");
  return 1;
}
monster() {
   object monster;
