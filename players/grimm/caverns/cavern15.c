...
east() {
   if(!present("zombie")) {
      this_player()->move_player("east#players/grimm/caverns/cavern17");
      return 1; 
   }
...
west() {
   this_player()->move_player("west#players/grimm/caverns/cavern13");
   return 1;
}
north() {
  this_player()->move_player("north#players/grimm/caverns/cavern14");
  return 1;
}
monster() {
   object monster;
