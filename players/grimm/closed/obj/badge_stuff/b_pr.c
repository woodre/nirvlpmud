...
reset(arg) {
if(!present("board"))
  move_object(clone_object("/players/grimm/closed/obj/badge_stuff/barbboard"),this_object());
if(arg) return;
short_desc="Barbarian's Faction Party Room";
long_desc="This is the Barbarian's Party Room.  You are obviously in\n"+
