...
short() {
    return "Bubba's Franchised Saloon";
}
...
long() {
    write("You are in Bubba's saloon.  Bubba sits behind the counter\n");
...
north() {
  this_player()->move_player("east#/players/grimm/closed/mall/hall2");
  return 1;
  }
