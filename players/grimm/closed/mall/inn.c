...
ONE_EXIT("/players/grimm/closed/mall/hall3","west",
"Zelda's Inn",
"You are in the Zelda's Inn. Here you can buy food to still your\n"+
...
/* commonor's meal, price 20, heals 2, preferably for levels 1-6 */ 
if(s=="1"||s=="<1>") {
...
/* merchant's meal, price 50, heals 4, preferably for levels 7-12 */ 
 if(s=="2"||s=="<2>") {
...
/* rich man's meal, price 90, heals 6, preferably for levels 13+ */ 
 if(s=="3"||s=="<3>") {
