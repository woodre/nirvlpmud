...
wind1(str){
 if(str=="handle" || str=="crank" || str=="lever"){
  if(atach=="yes"){
   ...
   write("You start to lift the container off the ground but unfortunately\n" +
         "release a trapdoor throwing you down into the mire below\n\n");
   say(CAPTPLNM + " turns the handle lifting a large container\n\n");
   TPL->move_player("falling through a trapdoor#"+"players/persephone/rooms/und_gr1");
   return 1;
  }
