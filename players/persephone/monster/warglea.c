/* Changed coin value from 3000+r2000 to 1000+r2000. This value is greater than the monster level allows but this is found in a fairly dangerous dark area and is the leader of a pack. -Snow 1/00 */
inherit "obj/monster";
