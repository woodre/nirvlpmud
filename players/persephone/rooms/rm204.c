...
reset(arg){
 ...
 short_desc="The Honeymoon Suite";
  ...
  items=({"waterbed","The waterbed looks extremely comfortable and recently made\n" +
          ...
          "curtains","The curtains are made of red velvet and look to be extremely expensive",
          "window","You cannot see the window as the curtains are drawn",
          "Bar","Well actually it is a bar fridge and no you cannot open it this is not\n" +
                "it is not your room",
          });
  dest_dir=({"players/persephone/rooms/hcorr2c","south",
          });
 }
}
realm() { return "NT"; }
