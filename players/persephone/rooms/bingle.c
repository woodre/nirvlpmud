...
reset(arg){
 if (!arg) {
  ...
  long_desc="You are in the center of the square of Stormhold. Perhaps the most\n" +
            ...
            "\n";
  items=({"statue","This marble statue is a statue of Persephone's ancestor Storm the Great\n" +
                   "who founded the town many centuries ago as a refuge for Nirvana's\n" +
                   "greatest artisans. You cannot resist but to touch the statue to\n" +
                   "find out if it has the power that it is reputed to have",
          "tree","A large and wizened old black oak tree that appears to be mourning\n" +
