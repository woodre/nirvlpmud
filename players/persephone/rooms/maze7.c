...
"alleys","A narrow place between two walls",
      ...
      "graffiti..",
      "graffiti","`Sharks rule' `Jets rock' `The sharks smell' and such",
      "water","H2O, my friend",
      "skittering","The pitter-pat of little feet...yuck",
    });
    dest_dir = ({
"/players/persephone/rooms/maze7","north",
"/players/persephone/rooms/maze4","west",
"/players/persephone/rooms/maze4","south",
"/players/persephone/rooms/maze7","east",
    });
 }
}
realm(){ return "NT";}
