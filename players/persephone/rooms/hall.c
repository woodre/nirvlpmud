/* Changed the exit and function 'north' to 'newbie' to reduce confusion. -Snow 1/00 */
...
reset(int arg){
 ...
 if(arg) return;
  ...
  dest_dir=({"room/hump","out",
            ...
            "players/persephone/rooms/stream2","newbie",
          });
}
init(){
 ::init();
...
TPL->move_player(" being sucked into a hole in the space time continuum#"+"players/persephone/rooms/ppelai");
 return 1;
 }
}
