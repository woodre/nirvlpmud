...
reset(arg) {
   ...
   long_desc="\tBlue light reflects off of mirrored walls.  The light has no source,\n"+
      ...
      "geometric symmetry rise around you with one passage leading east.\n"+
      "Melodic chimes can be heard from all directions.\n";
   dest_dir=({
      "/players/llew/closed/crystal/crys4.c","east",
      });
   items=({
      "walls","You look at the mirrored walls and see your own reflection,\n"+
         "but it is not quite you.  It is yourfect without any flaws. It is perfect.\n",
   });
   }
