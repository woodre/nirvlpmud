...
if(!arg) {
   ...
   set_level(20);
   set_race("demon");
   /*upped hp by base of 200-sami-*/
   set_hp(random(300)+600);
   set_al(-1000);
   set_short("Xetra");
   ...
   set_spell_dam(20);
   /*added a spell that deals a small amount of evil/fire damage to "demon", hits room, total 20 damage-Sami-*/
   add_spell("small_fire",
    "#MN# engulfs you in a small "+HIR+"blaze"+NORM+" of fire.\n",
    "#TN#  is quickly engulfed by #MN#'s "+HIR+"blaze"+NORM+" of fire.\n",
	20,({10,10}),({"other|fire","other|evil"}),1);
