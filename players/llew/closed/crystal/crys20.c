...
reset(arg) {
   ...
   long_desc="\tBlue light reflects off of mirrored walls.  The light has no source,\n"+
      ...
      "geometric symmetry rise around you with one passage leading up, and an evil.\n"+
      " feeling down.  Melodic chimes can be heard from all directions.\n";
   dest_dir=({
      "/players/llew/closed/crystal/crys17.c","up",
      "/players/llew/closed/crystal/crys21.c","down",
      });
   items=({
...
init() {
   write(BOLD+"Note: Down is dangerous.\n"+NORM);
   ::init();
}
