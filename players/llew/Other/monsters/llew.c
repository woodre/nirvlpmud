...
*/
   ...
   set_chance(44);
   set_spell_dam(76);
   set_spell_mess1("The " + GRN + "Forest Lord" + NORM + " calls Nature's Wrath!\n" +
      GRY + "(_ " + NORM + " (_/ " + GRY + "/^\\_   )\n" +
      "  \\   __)  (__/\n" + 
      "  (___)     " + HIW + " \\\n" +
      "   /\\\\       /\\_\n" +
      ...
      "       '  /\\\n" +
      NORM);
   set_spell_mess2("The " + GRN + "Forest Lord" + NORM + " calls Nature's Wrath!\n" +
      GRY + "(_ " + NORM + " (_/ " + GRY + "/^\\_   )\n" +
      "  \\   __)  (__/\n" + 
      "  (___)     " + HIW + " \\\n" +
      "   /\\\\       /\\_\n" +
...
monster_died() {
write_file("/players/llew/closed/logs/forest_lord",attacker_ob->query_name()+" killed me at "+ctime(time())+".\n");
}
