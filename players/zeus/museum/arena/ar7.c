...
reset(arg){
 if(arg) return;
  ...
  if(!present("Invisible_catch_tell_Object"), this_object())
  {
    ...
    ctob->set_location("SW");
    move_object(ctob, this_object());
  }

	short_desc = HIW+"Museum Arena"+NORM;
	long_desc =
"You are in the southwest corner of the arena.  To the south and west\n"+
...
"floor of the arena.  They are very beautiful",
	...
	set_light(1);
	dest_dir=({
		"/players/zeus/museum/arena/ar4.c", "north",
		"/players/zeus/museum/arena/ar5.c", "northeast",
		"/players/zeus/museum/arena/ar8.c", "east",
	});
}
