...
reset(arg){
 if(arg) return;
  ...
  if(!present("Invisible_catch_tell_Object"), this_object())
  {
	...
	long_desc =
"You are in the south side of the arena.  Directly to the south is a clear\n"+
"wall which gives you an excellent view of outer space.  The ceiling and\n"+
"floor are also perfectly clear.  A soft light is coming from the ceiling.\n"+
...
"floor of the arena.  They are very beautiful",
	...
	set_light(1);
	dest_dir=({
		"/players/zeus/museum/arena/ar7.c", "west",
		"/players/zeus/museum/arena/ar4.c", "northwest",
		"/players/zeus/museum/arena/ar5.c", "north",
		"/players/zeus/museum/arena/ar6.c", "northeast",
		"/players/zeus/museum/arena/ar9.c", "east",
	});
}
