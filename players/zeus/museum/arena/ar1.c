...
reset(arg){
 if(arg) return;
  ...
  if(!present("Invisible_Museum_Mob"), this_object())
  {
    ctob = clone_object("/players/zeus/museum/NPC/ctmob.c");
    ctob->set_location("NW");
...
*/
	...
	long_desc =
"You are in the northwest corner of the arena.  To the north and west\n"+
"is a clear wall which gives you an excellent view of outer space.  The\n"+
"ceiling and floor are also perfectly clear.  A soft light is coming\n"+
"from the ceiling.  To leave type 'exit arena'.\n";
	items=({
		"walls",
...
"floor of the arena.  They are very beautiful",
	...
	set_light(1);
	dest_dir=({
		"/players/zeus/museum/arena/ar2.c", "east",
		"/players/zeus/museum/arena/ar5.c", "southeast",
		"/players/zeus/museum/arena/ar4.c", "south",
	});
}
