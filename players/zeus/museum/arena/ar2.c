...
reset(arg){
 if(arg) return;
  ...
  if(!present("Invisible_catch_tell_Object"), this_object())
  {
	...
	long_desc =
"You are in the north part of the arena.  To the north is a clear wall\n"+
...
"floor of the arena.  They are very beautiful",
	...
	set_light(1);
	dest_dir=({
		"/players/zeus/museum/arena/ar3.c", "east",
		"/players/zeus/museum/arena/ar6.c", "southeast",
		"/players/zeus/museum/arena/ar5.c", "south",
		"/players/zeus/museum/arena/ar4.c", "southwest",
		"/players/zeus/museum/arena/ar1.c", "west",
	});
}
