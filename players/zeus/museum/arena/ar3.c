...
reset(arg){
 if(arg) return;
  ...
  if(!present("Invisible_catch_tell_Object"), this_object())
  {
    ...
    ctob->set_location("NE");
    move_object(ctob, this_object());
  }

	short_desc = HIW+"Museum Arena"+NORM;
	long_desc =
"You are in the northeast corner of the arena.  To the north and east\n"+
...
"floor of the arena.  They are very beautiful",
	...
	set_light(1);
	dest_dir=({
		"/players/zeus/museum/arena/ar2.c", "west",
		"/players/zeus/museum/arena/ar5.c", "southwest",
		"/players/zeus/museum/arena/ar6.c", "south",
	});
}
