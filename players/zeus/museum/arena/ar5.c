...
reset(arg){
 if(arg) return;
  ...
  if(!present("Invisible_catch_tell_Object"), this_object())
  {
	...
	long_desc =
"You are standing directly in the center of the arena.  On all sides of\n"+
"you are clear walls, however they are not right near you.  The ceiling\n"+
"and the floor are also perfectly clear.  A soft light is coming from the\n"+
"ceiling.  To leave type 'exit arena'.\n";
	items=({
		"walls",
...
"floor of the arena.  They are very beautiful",
	...
	set_light(1);
	dest_dir=({
		"/players/zeus/museum/arena/ar2.c", "north",
		"/players/zeus/museum/arena/ar3.c", "northeast",
		"/players/zeus/museum/arena/ar6.c", "east",
		"/players/zeus/museum/arena/ar9.c", "southeast",
		"/players/zeus/museum/arena/ar8.c", "south",
		"/players/zeus/museum/arena/ar7.c", "southwest",
		"/players/zeus/museum/arena/ar4.c", "west",
		"/players/zeus/museum/arena/ar1.c", "northwest",
	});
}
