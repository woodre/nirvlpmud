...
reset(arg){
 if(arg) return;
  ...
  if(!present("Invisible_catch_tell_Object"), this_object())
  {
    ...
    ctob->set_location("SE");
    move_object(ctob, this_object());
  }

	short_desc = HIW+"Museum Arena"+NORM;
	long_desc =
"You are in the southeast corner of the arena.  To the south and east\n"+
...
"floor of the arena.  They are very beautiful",
	...
	set_light(1);
	dest_dir=({
		"/players/zeus/museum/arena/ar6.c", "north",
		"/players/zeus/museum/arena/ar5.c", "northwest",
		"/players/zeus/museum/arena/ar8.c", "west",
	});
}
