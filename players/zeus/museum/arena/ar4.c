...
reset(arg){
 if(arg) return;
  ...
  if(!present("Invisible_catch_tell_Object"), this_object())
  {
	...
	long_desc =
"You are in the west side of the arena.  Directly to the west is a clear\n"+
...
"floor of the arena.  They are very beautiful",
	...
	set_light(1);
	dest_dir=({
		"/players/zeus/museum/arena/ar1.c", "north",
		"/players/zeus/museum/arena/ar2.c", "northeast",
		"/players/zeus/museum/arena/ar5.c", "east",
		"/players/zeus/museum/arena/ar8.c", "southeast",
		"/players/zeus/museum/arena/ar7.c", "south",
	});
}
