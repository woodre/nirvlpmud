...
reset(arg){
 if(!arg){
  ...
  long_desc=
"  Directly to the east large mountains are visible protruding from\n"+
...
"whips overhead.  The ground is littered with small rocks and sand.\n"+
"A few large boulders are visible to the north.\n";
  items=({
  "boulders",
"The boulders are large and very dull looking.  Each one is resting\n"+
"quietly on the desert floor, among the smaller rocks and the sand.\n"+
"They help to block your vision to the north",
  "mountains",
"The towering mountains impede passage to the east.  They are hidden\n"+
...
"flat ground",
  ...
  dest_dir=({  "/players/zeus/desert/r/ec2.c", "north",
               "/players/zeus/desert/r/ec11.c", "south",
               "/players/zeus/desert/r/ec5.c", "west",  });
 }
}
