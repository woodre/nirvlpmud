/*
 *      File:                 /players/star/hotel/rooms/211.c
 *      Function:
...
reset(arg)
{
  ::reset(arg);
    if(!present("charles"))
      move_object(clone_object(HOTEL+"npcs/grondin.c"),this_object());
  if(arg) return;
  set_light(1);
  short_desc = "Room 211";
  long_desc =
  ...
  ({
    ...
    "picture",
    "This is a picture of a farm surrounded by fields of hay",
    "door",
