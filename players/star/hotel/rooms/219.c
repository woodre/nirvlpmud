/*
 *      File:                 /players/star/hotel/rooms/219.c
 *      Function:
...
reset(arg)
{
  ::reset(arg);
    if(!present("richard"))
      move_object(clone_object(HOTEL+"npcs/richard.c"),this_object());
  if(arg) return;
  set_light(1);
  short_desc = "Room 219";
  long_desc =
  ...
  ({
    ...
    "picture",
    "This is a picture of a beach and a few palm trees",
    "door",
