/*
 *      File:                 /players/star/hotel/rooms/215.c
 *      Function:
...
reset(arg)
{
  ::reset(arg);
    if(!present("peter"))
      move_object(clone_object(HOTEL+"npcs/peter.c"),this_object());
  if(arg) return;
  set_light(1);
  short_desc = "Room 215";
  long_desc =
  ...
  ({
    ...
    "picture",
    "This is a picture of a dog with a duck in his mouth",
    "door",
