/*
 *      File:                 /players/star/hotel/rooms/up_hall5.c
 *      Function:
...
reset(arg)
{
  ...
  long_desc = 
    ...
    "number 215 gleaming in the light.\n";
  ...
  ({
    ...
    "door",
    "The door is wooden, brown, has the number 215 on it, and can be\n"+
    "entered... if you dare",
    "number",
  ...
  dest_dir =
  ({
    HOTEL+"rooms/up_hall4.c",     "west",
    HOTEL+"rooms/up_hall6.c",     "east",
  });
}
...
int cmd_enter(string str)
{
  ...
  if(str != "door" && str != "215" && str != "room" && str != "room 215")
  {
    notify_fail("You can only \"enter\" the \"door\".\n");
    return 0;
  }

    write("You enter room 215.\n");
    this_player()->move_player("through the door#/players/star/hotel/rooms/215.c");
