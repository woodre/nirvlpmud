/*
 *      File:                 /players/star/hotel/rooms/213.c
 *      Function:
...
reset(arg)
{
  ::reset(arg);
    if(!present("horace"))
      move_object(clone_object(HOTEL+"npcs/horace.c"),this_object());
  if(arg) return;
  set_light(1);
  short_desc = "Room 213";
  long_desc =
  ...
  ({
    ...
    "picture",
    "This is a picture of a field of tulips",
    "door",
