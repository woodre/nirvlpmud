/*
 *      File:                 /players/star/hotel/npcs/carl.c
 *      Function:
...
reset(arg)
{
  ...
  set_race("human");
  set_gender("male");
  set_short("Ghost of Jimmy-Ricks");
  set_long("Carl \"Jimmy-Ricks\" Prashkin looks quite comfortable standing in a\n"+
    "hotel room with Vito the Chopper.  Obviously he is not concerned that\n"+
    "he might be the next one chopped.\n");
  set_level(15);
  set_hp(250);
  set_al(-100);
  set_wc(20);
  ...
  add_spell("cold_fear",
    ...
    20,20,0,0);
  set_chat_chance(3);
    load_chat("Jimmy kisses some major butt with Vito.\n");
    load_chat("Jimmy nods in agreement with everything Vito says.\n");
    load_chat("Jimmy looks at Vito with adoring respect.\n");
}
