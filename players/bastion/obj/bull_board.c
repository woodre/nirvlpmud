...
long() {
    write("This is the bulletin board for the Empire of Antaria. Leave\n"+
...
reset(arg) {
    if (arg)
	return;
    restore_object("players/bastion/obj/board_save");
}
...
get_body(str) {
	...
	new_body = 0;
	new_hd = 0;
        save_object("players/bastion/obj/board_save");
	write("Ok.\n");
	who = 0;
	return;
    }
