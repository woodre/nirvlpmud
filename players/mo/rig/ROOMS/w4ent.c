...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("Chinle Oil Platform - Outside Well #4");
   set_long(
   ...
   add_exit("/players/mo/rig/ROOMS/well4/r1.c","enter");
   add_exit("/players/mo/rig/ROOMS/d10.c","west");
   add_exit("/players/mo/rig/ROOMS/d18.c","east");
