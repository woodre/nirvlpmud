...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("Chinle Oil Platform - East");
   set_long(
      
      "                 "+BOLD+"East Chinle Oil Platform\n"+
      ...
      "|  "+NORM+"(W    W)"+BOLD+"             <  >     "+BWHT+""+BLK+"X"+NORM+""+BOLD+"                   |\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/d15.c","north");
   add_exit("/players/mo/rig/ROOMS/cafentsw.c","east");
   add_exit("/players/mo/rig/ROOMS/cmdentnorth.c","west");
   add_exit("/players/mo/rig/ROOMS/d20.c","southeast");
