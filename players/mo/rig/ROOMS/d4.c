...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("West side of Control Center - Chinle Oil Platform");
   set_long(
      
      "                "+BOLD+"Outside the Control Center\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/d5.c","west");
   add_exit("/players/mo/rig/ROOMS/d3.c","around");
}
