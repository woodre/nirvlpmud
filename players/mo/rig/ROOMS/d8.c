...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("Chinle Oil Platform - West");
   set_long(
      
      "                    "+BOLD+"West Chinle Oil Platform\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/d9.c","north");
   add_exit("/players/mo/rig/ROOMS/d13.c","east");
   add_exit("/players/mo/rig/ROOMS/d6num2.c","south");
   add_exit("/players/mo/rig/ROOMS/w2ent.c","west");
