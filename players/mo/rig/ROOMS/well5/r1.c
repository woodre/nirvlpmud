...
reset(arg) {
   ...
   set_long(
      "     You have just entered "+BOLD+"Well Site #5"+NORM+" on the Chinle Oil Platform. You\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/well5/r2.c","around");
   add_exit("/players/mo/rig/ROOMS/w5ent.c","out");
   ...
   add_object("/players/mo/rig/MON/toolhand5.c",1);
}
