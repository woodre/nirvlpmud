...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("Chinle Oil Platform - NE");
   set_long(
      
      "                   "+BOLD+"NE Chinle Oil Platform\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/d16.c","east");
   add_exit("/players/mo/rig/ROOMS/d12.c","west");
   
   add_exit("/players/mo/rig/ROOMS/cafentnw.c","south");
}
