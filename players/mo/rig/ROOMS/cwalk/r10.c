...
reset(arg) {
   ...
   move_object(clone_object(({"/players/mo/rig/MON/toolhand2.c","/players/mo/rig/MON/roughneck.c"})[random_index]),
      this_object());
   set_light(1);
   ...
   set_long(
      ...
      "|     |                                              |\n"+
      "|     |                                              |\n"+
      "|     "+YEL+""+BWHT+"X"+NORM+""+BOLD+"                                              |\n"+
      "|     |                                              | You are standing above\n"+
      "|     |                                              | Well 2. A pressure meter\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/cwalk/r9.c","north");
   add_exit("/players/mo/rig/ROOMS/cwalk/r11.c","south");
