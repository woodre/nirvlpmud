...
reset(arg) {
   ...
   move_object(clone_object(({"/players/mo/rig/MON/toolhand.c","/players/mo/rig/MON/d.c"})[random_index]),
      this_object());
   set_light(1);
   ...
   add_exit("/players/mo/rig/ROOMS/cwalk/r11.c","north");
