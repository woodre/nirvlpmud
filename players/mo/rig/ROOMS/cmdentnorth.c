...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("Chinle Oil Platform - N Command Center Entrance");
   set_long(
      
      "                    "+BOLD+"North Command Center Entrance\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/d6num2.c","west");
   add_exit("/players/mo/rig/ROOMS/d13.c","north");
   add_exit("/players/mo/rig/ROOMS/d17.c","east");
   add_exit("/players/mo/rig/ROOMS/cc/r1.c","enter");
}
