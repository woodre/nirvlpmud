...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("Chinle Oil Platform - Outside Well #1");
   set_long(
      ...
      "|      "+BWHT+""+BLK+"X"+NORM+""+BOLD+"            |__      __|            _________|\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/well1/r1.c","enter");
   add_exit("/players/mo/rig/ROOMS/d6.c","east");
