...
reset(arg) {
   ...
   add_exit("/players/mo/rig/ROOMS/d18.c","north");
   add_exit("/players/mo/rig/ROOMS/d14.c","east");
   add_exit("/players/mo/rig/ROOMS/d11.c","west");
   add_exit("/players/mo/rig/ROOMS/d15.c","south");
