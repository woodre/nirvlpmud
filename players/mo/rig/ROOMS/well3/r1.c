...
reset(arg) {
   ...
   move_object(clone_object(({"/players/mo/rig/MON/roughneck.c","/players/mo/rig/MON/toolhand3.c"})[random_index]),
      this_object());
   move_object(clone_object(({"/players/mo/rig/MON/geologist.c","/players/mo/rig/MON/d.c"})[random_index]),
      this_object());
   set_light(1);
   set_short("Well #3 - Chinle Oil Platform");
   set_long(
      "     You have just entered "+BOLD+"Well Site #3"+NORM+" on the Chinle Oil Platform. You\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/well3/r2.c","around");
   add_exit("/players/mo/rig/ROOMS/w3ent.c","out");
