...
reset(arg) {
   ...
   set_long(
     "This is the northern portion of the Chinle Oil Platform "+BBLU+"Command\n"+
     "Center"+NORM+".  Ahead is a long hallway with a nice, black and white tiled floor.\n"+
      ...
      "\n");
   add_exit("/players/mo/rig/ROOMS/cmdentnorth.c","out");
   add_exit("/players/mo/rig/ROOMS/cc/r2.c","south");
