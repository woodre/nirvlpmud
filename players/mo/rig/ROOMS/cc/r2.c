...
reset(arg) {
   ...
   add_exit("/players/mo/rig/ROOMS/cc/r1.c","north");
   add_exit("/players/mo/rig/ROOMS/cc/r3.c","south");
   add_item("hallway","A long hallway with checkered floors.\n");
   add_item("floor","A clean checkered floor.\n");
   add_item("door",""+BOLD+"(Drill Team Leader)"+NORM+" labeled on the door.  Perhaps you could 'enter'\n");
...
enter_me(str) {
   ...
   this_player()->move_player("into the doorway#players/mo/rig/ROOMS/cc/office1.c");
