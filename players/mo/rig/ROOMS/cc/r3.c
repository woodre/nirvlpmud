...
reset(arg) {
   ...
   add_exit("/players/mo/rig/ROOMS/cc/r2.c","north");
   add_exit("/players/mo/rig/ROOMS/cc/r4.c","south");
   add_exit("/players/mo/rig/ROOMS/cc/r9.c","west");
   add_item("hallway","A long hallway with checkered floors.\n");
   add_item("floor","A clean checkered floor.\n");
   add_item("door",""+BOLD+"(Head Toolhand)"+NORM+" labeled on the door.  Perhaps you could 'enter'\n");
...
enter_me(str) {
   ...
   this_player()->move_player("into the doorway#players/mo/rig/ROOMS/cc/office2.c");
