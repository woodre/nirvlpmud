...
reset(arg) {
   ...
   move_object(clone_object(({"/players/mo/rig/MON/geologist.c","/players/mo/rig/MON/toolhand.c"})[random_index]),
      this_object());
   move_object(clone_object(({"/players/mo/rig/MON/geologist.c","/players/mo/rig/MON/toolhand.c"})[random_index]),
      this_object());
   set_light(1);
   set_short("Well #1 - Chinle Oil Platform");
   set_long(
"     You have just entered "+BOLD+"Well Site #1"+NORM+" on the Chinl
e Oil Platform. You\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/well1/r2.c","around");
   add_exit("/players/mo/rig/ROOMS/w1ent.c","out");
