...
reset(arg) {
   ...
   set_long(
      "     Directly ahead is a metal floor that circles around the well.  The floor\n"+
      "leads workers "+BOLD+"around"+NORM+" the well area, but the view does not change much.\n"+
