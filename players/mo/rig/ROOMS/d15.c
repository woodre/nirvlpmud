...
reset(arg) {
   ...
   add_exit("/players/mo/rig/ROOMS/d12.c","north");
   add_exit("/players/mo/rig/ROOMS/cafentnw.c","east");
   add_exit("/players/mo/rig/ROOMS/d13.c","west");
   add_exit("/players/mo/rig/ROOMS/d17.c","south");
