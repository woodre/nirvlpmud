...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("Chinle Oil Platform - North");
   set_long(
      
      "                    "+BOLD+"North Chinle Oil Platform\n"+
      ...
      "|                                                    |\n"+
      "|                                                    |\n"+
      "|                       "+BWHT+""+BLK+"X"+NORM+""+BOLD+"             ___________    |\n"+
      "|                                    |           |   |\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/d11.c","north");
   add_exit("/players/mo/rig/ROOMS/d15.c","east");
   add_exit("/players/mo/rig/ROOMS/cmdentnorth.c","south");
   add_exit("/players/mo/rig/ROOMS/d8.c","west");
}
