...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("Chinle Oil Platform - Outside Well #5");
   set_long(
   ...
   add_exit("/players/mo/rig/ROOMS/well5/r1.c","enter");
   add_exit("/players/mo/rig/ROOMS/d18.c","west");
   add_exit("/players/mo/rig/ROOMS/lift2.c","east");
