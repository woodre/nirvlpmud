...
reset(arg) {
   if(arg) return;
   set_light(1);
   set_short("SW Cafe Entrance - Chinle Oil Platform");
   set_long(
      
      "          "+BOLD+"SW Cafe Entrance - Chinle Oil Platform\n"+
      ...
      "|   "+NORM+"(WWWW)"+BOLD+"               __          "+BWHT+"|_"+NORM+""+BOLD+"__________|   |\n"+
      "|  "+NORM+"(W    W)"+BOLD+"             <  >                         |\n"+
   ...
   add_exit("/players/mo/rig/ROOMS/cafesw.c","in");
   add_exit("/players/mo/rig/ROOMS/d17.c","west");
   add_exit("/players/mo/rig/ROOMS/d20.c","south");
