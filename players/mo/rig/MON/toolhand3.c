...
set_race("human");
set_alias("toolhand");
set_short( ({"Skip"+BOLD+" |Well 3 Toolhand|"+NORM+"","Snip"+BOLD+" |Well 3 Toolhand|"+NORM+"","Steve"+BOLD+" |Well 3 Toolhand|"+NORM+"","Arnold"+BOLD+" |Well 3 Toolhand|"+NORM+"","Verte"+BOLD+" |Well 3 Toolhand|"+NORM+"","Justin"+BOLD+" |Well 3 Toolhand|"+NORM+""})[random_index]);
set_long(
...
"|Well #3 Toolhand| and it is slightly covered by reflective gear.\n"+
