...
reset(arg) {
  ...
  set_light(1);
short_desc=
"a Helicopter Launchpad";
  long_desc=
"  The sidewalk is weathered.  There are several cracks; almost as many cracks as there are crack whores.\n"+
"There are no street lights.   Only a single sign provides light, Mo's.\n";
  items=({
