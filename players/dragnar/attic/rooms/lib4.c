...
#define change cult=clone_object("/players/dragnar/mons/member.c");
...
dest_dir=
({
"players/dragnar/rooms/lib5.c","east",
"players/dragnar/rooms/lib6.c","north",
"players/dragnar/rooms/lib3.c","south",
});
}
east() {
	if(present("member")) {
