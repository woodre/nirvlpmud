...
reset(int arg) {
	...
	digger = clone_object("/players/dragnar/mons/grave");
...
"had to be done in a short time.\n";
    dest_dir = ({
	"players/dragnar/rooms/grave1","east",
	"players/dragnar/rooms/grave2","west",
	"players/dragnar/rooms/grave3","north",
	"players/dragnar/rooms/room_road1","south",
    });
}
