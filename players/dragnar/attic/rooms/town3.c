...
dest_dir=
({
"players/dragnar/rooms/town2.c","north",
});
...
east() {
	if(x > 2) {
	call_other(this_player(),"move_player","east#/players/dragnar/rooms/town4.c");
	return 1;
	}
	else if(x < 2) {
...
north() {
	call_other(this_player(),"move_player","north#/players/dragnar/rooms/town2.c");
	return 1;
}
