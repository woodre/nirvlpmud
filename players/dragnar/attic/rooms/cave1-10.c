...
reset(arg) {
	portal=clone_object("/players/dragnar/items/quest/portal.c");
...
enter(str) {
	...
	timer=clone_object("/players/dragnar/items/quest/timer.c");
	...
	this_player()->move_player("portal#/players/dragnar/past/cave1-10.c");
	return 1;
	}
}
