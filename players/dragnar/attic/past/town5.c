...
reset(arg) {
	guard=clone_object("/players/dragnar/mons/guard.c");
...
dest_dir=
({
"players/dragnar/past/town4.c","south",
});
}
open(str) {
	if(str=="doors"){
...
enter() {
	if(x > 2) {
	call_other(this_player(),"move_player","enter#/players/dragnar/past/town6.c");
	return 1;
	}
	else if(x < 2) {
