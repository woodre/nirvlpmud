...
"Just type 'buy condom' to get a 100% effective condom.  Dragnar's\n"+
"condoms are guaranteed to work or your money back! (only valid when used as\n"+
"directed).  The condoms are unisex so males and females can use them.\n");
}
init() {
	add_action("buy","buy");
}
buy(str) {
	...
	condom=clone_object("/players/dragnar/armor/condom.c");
