...
join() {
   ...
   joinme=clone_object("/players/dragnar/guild/items/NOJOIN.c");
	move_object(joinme, this_player());
	nomove=clone_object("/players/dragnar/guild/items/NOMOVE.c");
	move_object(nomove, this_player());
	return 1;
	}
	else{
	joinme=clone_object("/players/dragnar/guild/items/JOINOB.c");
	move_object(joinme, this_player());
	nomove=clone_object("/players/dragnar/guild/items/NOMOVE.c");
	move_object(nomove, this_player());
	return 1;
