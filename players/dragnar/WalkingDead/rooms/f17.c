...
hiding in these trees with their leaves giving perfect cover",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f22","north",
    "/players/dragnar/WalkingDead/rooms/f11","south",
    "/players/dragnar/WalkingDead/rooms/f18","east",
    "/players/dragnar/WalkingDead/rooms/f16","west",
  });
  long_desc=
