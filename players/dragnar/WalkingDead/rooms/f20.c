...
entering the village from this point",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f15","south",
    "/players/dragnar/WalkingDead/rooms/r4","east",
    "/players/dragnar/WalkingDead/rooms/f19","west",
  });
  long_desc=
"The forest stretches out from this point to the south and west. To\n\
...
the border of the village. To the east the trees are cleared and a\n\
paved road runs north and south. West heads deeper into the forest\n\
and seems to have a slight uphill slope.\n";
