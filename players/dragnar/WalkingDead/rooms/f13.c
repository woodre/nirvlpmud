...
to take over. The forest continues south along the cliff edge and east\n\
...
feet across, but it is hard to judge from this height",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f14","east",
    "/players/dragnar/WalkingDead/rooms/f7","south",
  });
  long_desc=
...
down it. The forest continues south along the edge of the cliff\n\
and also back toward the road to the east.\n";
