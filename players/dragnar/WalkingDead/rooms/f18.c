...
and buckthorn. The canopy here allows "+HIY+"sunlight"+NORM+" in and somehow makes\n\
...
way a person could traverse the swamp",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f12","south",
    "/players/dragnar/WalkingDead/rooms/f17","west",
  });
  long_desc=
"The forest thins out here and the slope comes to an end at a "+YEL+"swamp"+NORM+"\n\
that stretches to the east and north. The swamp has no visible path\n\
through it. The forest continues south along the edge of the swamp\n\
and also back toward the road to the west.\n";
