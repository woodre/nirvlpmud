...
on the monitor",
    "ground", "The ground is clear of any growth except for a few small "+GRN+"ferns"+NORM,
    "clearing","The area is void of any major growth for 30 feet in a circular pattern",
    "cable","It looks like a standard coaxial cable for transmitting video",
    "bones",GRY+"You can clearly see the exposed femur and fibula bones"+NORM,
    "stomach", "This is more of where the stomach used to be. Something ATE it",
    "entrails","Chunks of "+HIBLK+"guts"+NORM+" turned black from decomposition",
    "head","Obviously a male, but something about him seems very wrong",
    "wound","The head wound is deep and exposes "+GRY+"brain matter"+NORM+" inside",
...
than the corpse, there is a large digital "+HIW+"monitor"+NORM+" that has been erected\n\
