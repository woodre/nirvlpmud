...
hiding in these trees with their leaves giving perfect cover",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f14","north",
    "/players/dragnar/WalkingDead/rooms/f5","south",
    "/players/dragnar/WalkingDead/rooms/f9","east",
    "/players/dragnar/WalkingDead/rooms/f7","west",
  });
  long_desc=
