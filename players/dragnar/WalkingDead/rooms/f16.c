...
hiding in these trees with their leaves giving perfect cover",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f21","north",
    "/players/dragnar/WalkingDead/rooms/f10","south",
    "/players/dragnar/WalkingDead/rooms/f17","east",
    "/players/dragnar/WalkingDead/rooms/r3","west",
  });
  long_desc=
...
looks pretty much the same in all directions except west. To the west\n\
the trees are cleared and a paved road runs north and south.  East heads\n\
deeper into the forest and seems to have a slight downhill slope.\n";
