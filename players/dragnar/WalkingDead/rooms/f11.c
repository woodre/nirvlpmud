...
hiding in these trees with their leaves giving perfect cover",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f17","north",
    "/players/dragnar/WalkingDead/rooms/f2","south",
    "/players/dragnar/WalkingDead/rooms/f12","east",
    "/players/dragnar/WalkingDead/rooms/f10","west",
  });
  long_desc=
