...
of only growing on the north sides of the trees",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f9","north",
    "/players/dragnar/WalkingDead/rooms/r1","east",
    "/players/dragnar/WalkingDead/rooms/f5","west",
  });
  long_desc=
...
blocking passage in that direction. To the east the trees are\n\
