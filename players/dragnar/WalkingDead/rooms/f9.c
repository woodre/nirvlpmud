...
hiding in these trees with their leaves giving perfect cover",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f15","north",
    "/players/dragnar/WalkingDead/rooms/f4","south",
    "/players/dragnar/WalkingDead/rooms/r2","east",
    "/players/dragnar/WalkingDead/rooms/f8","west",
  });
  long_desc=
...
the south the forest seems to "+HIBLK+"darken"+NORM+". To the east the trees are\n\
cleared and a paved road runs north and south. West heads deeper\n\
into the forest and seems to have a slight uphill slope.\n";
