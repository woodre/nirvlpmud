...
hiding in these trees with their leaves giving perfect cover",
  ...
  dest_dir=({
    "/players/dragnar/WalkingDead/rooms/f11","north",
    "/players/dragnar/WalkingDead/rooms/f3","east",
    "/players/dragnar/WalkingDead/rooms/f1","west",
  });
  long_desc=
...
blocking passage in that direction. To the west the forest continues\n\
and slopes gently upwards. East heads deeper into the forest and has\n\
a pronounced downhill grade. The forest must thin out in that\n\
