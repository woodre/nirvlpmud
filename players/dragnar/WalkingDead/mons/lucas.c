...
#define HEAL_STR YEL+"Soup,"+NORM+HIG+" Shake,"+NORM+HIB+" Blueberry Shake,"+NORM+" or "+RED+"Firewater"+NORM
...
TellRoom(int arg) {
  ...
  case 7:
    /** Purchase **/
    tell_room(env, "\n");
    tell_room(env, "Lucas says: 'You can 'purchase <amount> <food_name>' to buy heals.\n\
             You can purchase "+HEAL_STR+".\n\
