...
reset(arg){
  ...
  set_long("The man has a yellow scarf around his neck and a white silk patch\n"+
    ...
    "that controls his soul.  Something about his missing eye makes you shiver.\n");
  set_level(23);
  set_hp(900);
  set_al(-1000);
  set_wc(90);
  ...
  gold->set_money(random(8000)+4000);
  move_object(gold,this_object());
  key=clone_object("/players/dragnar/WasteLands/obj/quest/mag1.c");
