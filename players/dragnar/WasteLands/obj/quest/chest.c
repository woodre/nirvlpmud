...
ncnc() {
    ...
    demon=clone_object("/players/dragnar/WasteLands/mons/demon.c");
...
if(str == "chest" && opened && K == 1) {
  ...
  move_object(clone_object("players/dragnar/WasteLands/obj/quest/mag4.c"),this_player());
  K = 0;
  return 1; }
else {
