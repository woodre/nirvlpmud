inherit "room/room";
	object key, launcher, gold;
init() {
	::init();
	this_player()->set_fight_area();
}
reset(arg) {
	launcher=clone_object("/players/dragnar/WasteLands/weap/launcher.c");
...
*/
	...
	gold->set_money(random(9000)+3000);
...
dest_dir=
({
"players/dragnar/WasteLands/rooms/lib5","out",
});
}
