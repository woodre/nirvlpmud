#define shit cult=clone_object("/players/dragnar/WasteLands/mons/cult2.c");
...
dest_dir=
({
"players/dragnar/WasteLands/rooms/lib4.c","west",
});
}
open(str) {
	if(str=="door"){
...
"He stares at you and you feel a deep fear.\n");
	...
	if(x > 2) {
	call_other(this_player(),"move_player","enter#/players/dragnar/WasteLands/rooms/libstorage.c");
	return 1;
	}
	else if(x < 2) {
