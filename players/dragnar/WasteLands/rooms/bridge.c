...
object invis;
reset(arg) {
invis=clone_object("players/dragnar/WasteLands/rooms/sign.c");
...
dest_dir=
({
"players/dragnar/WasteLands/rooms/bridge2.c","east",
"players/dragnar/WasteLands/rooms/room_road2.c","west",
});
}
