...
ONE_EXIT("/players/dragnar/WasteLands/rooms/town.c", "west",
	 "Wastelands' Shop",
"This is an old shop.  The place is a mess and the building around you is\n"+
"in ruins, but some things seem to be in working order.  It looks as if \n"+
"someone started to fix the shop but didn't get very far.  There is\n"+
"a sign on the far end of the shop that reads:\n"+
