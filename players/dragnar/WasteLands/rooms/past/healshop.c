...
"one seems to be in one peace.\n",
      dest_dir = ({
	"/players/dragnar/WasteLands/rooms/entrance.c","north",
	});
}
}
init() {
...
buy(str){
   ...
   if(!str) { write("Huh?\n"); return 1; }
      ...
      name = str;
      item = clone_object("/players/dragnar/WasteLands/heals/auto_heal.c");
      value = 30000;
   }
   else if (str =="pack" || str =="2"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/pack.c");
      value=10000;
   }
   else if (str == "sisco" || str== "3") {
      name = str;
      item = clone_object("/players/dragnar/WasteLands/heals/sisco.c");
      value = 10000;
   }
   else if (str == "firewater" || str == "4") {
      name = str;
      item = clone_object("/players/dragnar/WasteLands/heals/firewater.c");
      value = 9000;
   }
   else if (str == "bud" || str == "5"){
      name = str;
      item = clone_object("/players/dragnar/WasteLands/heals/bud.c");
      value = 4800;
   }
	else if(str=="beast" || str=="6"){
      name = str;
      item = clone_object("/players/dragnar/WasteLands/heals/beast.c");
      value = 3600;
   }
	else if(str == "hotdog" || str=="8"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/hotdog.c");
      value=4800;
   }
	else if(str=="snapple" || str=="9"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/snapple.c");
      value=4000;
   }
	else if(str=="hamburger" || str=="10"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/burger.c");
      value=1000;
   }
	else if(str=="double burger" || str=="11"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/dbburger.c");
      value=1400;
   }
	else if(str=="coffee" || str=="12"){
      name=str;
      item=clone_object("players/dragnar/WasteLands/heals/coffee.c");
      value=4000;
   }
	else if(str=="speed" || str=="13"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/speed.c");
      value=3000;
   }
   else if(str =="pretzel" || str =="14"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/pretzel.c");
      value=3500;
   }
   else if(str =="beer" || str =="can" || str=="15"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/bud2.c");
      value=500;
   }
	else if(str=="vodka" || str=="7"){
      name=str;
      item=clone_object("/players/dragnar/WasteLands/heals/vodka.c");
      value=2500;
}
	else if(str=="list" || str=="16"){
	name=str;
	item=clone_object("/players/dragnar/WasteLands/heals/list.c");
	value=10;
   } else { write("What?\n"); return 1;}
