...
ONE_EXIT("players/dragnar/WasteLands/rooms/past/town.c","west",
	 "Wastelands' Shop",
"This is a shop, although no one seems to be around.  You find it kind of \n"+
"strange that you haven't seen anyone on a day as beautiful as this.\n"+
"All you can hear is the siren going off.  There is a sign on the far\n"+
"end of the shop that reads:\n"+
