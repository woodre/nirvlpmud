...
move_object(clone_object("/players/dragnar/SevenSpires/mons/gdragon/rdragon4.c"), this_object());
move_object(clone_object("/players/dragnar/SevenSpires/mons/gdragon/rdragon4.c"), this_object());
}
...
dest_dir = ({
  "/players/dragnar/SevenSpires/rooms/gdragon/r8.c","east",
});

if(!present("king", this_object())){
move_object(clone_object("/players/dragnar/SevenSpires/mons/gdragon/rdragon5.c"), this_object());
 }
}
...
if(str == "pillar" || str == "pillars"){
 ...
 if(this_player()->query_attack()){
  ...
  tpn+" climbs a pillar.\n");
  move_object(this_player(), "/players/dragnar/SevenSpires/rooms/gdragon/r10.c");
  tell_room(environment(this_player()),
