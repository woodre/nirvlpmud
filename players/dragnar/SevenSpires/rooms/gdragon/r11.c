...
move_object(clone_object("/players/dragnar/SevenSpires/mons/gdragon/rdragon1.c"), this_object());
move_object(clone_object("/players/dragnar/SevenSpires/mons/gdragon/rdragon1.c"), this_object());
}
  if(arg) return;
set_light(1);
...
dest_dir = ({
  "/players/dragnar/SevenSpires/rooms/gdragon/r12.c","west",
  "/players/dragnar/SevenSpires/rooms/gdragon/r10.c","east",
...
no_west(){
if(present("cont_dragon", this_object())){
write("The Green Dragon blocks you from going deeper into the volcano!\n");
return 1;
}
return;
}
