...
dest_dir = ({
  "/players/dragnar/SevenSpires/rooms/gdragon/r15.c","north",
  "/players/dragnar/SevenSpires/rooms/gdragon/r18.c","south",
  "/players/dragnar/SevenSpires/rooms/gdragon/r17.c","outcropping"
});
}
