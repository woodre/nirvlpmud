...
dest_dir = ({
  "/players/dragnar/SevenSpires/rooms/gdragon/r14.c","north",
  "/players/dragnar/SevenSpires/rooms/gdragon/r19.c","south",
  "/players/dragnar/SevenSpires/rooms/gdragon/r12.c","east",
