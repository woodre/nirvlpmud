...
dest_dir = ({
  "/players/dragnar/SevenSpires/rooms/gdragon/r19.c","east",
  "/players/dragnar/SevenSpires/rooms/gdragon/r16.c","north",
});
...
squeeze(str){
 ...
 if(str == "into gap" || str == "gap" || str == "wall" || str == "into wall"){
  ...
  move_object(this_player(), "/players/dragnar/SevenSpires/rooms/gdragon/r20.c");
