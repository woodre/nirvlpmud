...
"on the far side, or to the north and the entrance of the\n"+
"the core.\n"; 
items = ({
"core",
...
dest_dir = ({
  "/players/dragnar/SevenSpires/rooms/gdragon/r18.c","west",
  "/players/dragnar/SevenSpires/rooms/gdragon/r13.c","north",
});
