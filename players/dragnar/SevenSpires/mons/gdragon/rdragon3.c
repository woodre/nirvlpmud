...
set_race("dragon");
set_short(HIG+"Green "+NORM+GRN+"Dragon"+NORM+" [duke]");
set_long(
"This is a huge green dragon.  Its body is over 100 feet in\n"+
...
set_chat_chance (10);
load_chat("The green dragons hisses,'Come and face death, come to me!'\n");
...
if(!random(4)){
scale3 = clone_object("/players/dragnar/SevenSpires/obj/gdragon/dragonscale.c");
...
/* testing something- mizan */
/*
   tell_room(environment(),
   "The dragon's tail lashes out and strikes "+alt_attacker_ob->query_name()+"!\n");
*/
   say("The dragon's tail lashes out and strikes furiously!\n");
