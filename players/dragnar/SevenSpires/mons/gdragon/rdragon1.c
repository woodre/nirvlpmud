...
set_race("dragon");
set_short(HIG+"Green "+NORM+GRN+"Dragon"+NORM+" [soldier]");
set_long(
"  This is a large green dragon.  Its body is covered in thick\n"+
"greenish hued plates.  Its head is nearly 6 feet in length, and\n"+
