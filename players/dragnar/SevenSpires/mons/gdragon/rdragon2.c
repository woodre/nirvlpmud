...
set_race("dragon");
set_short(HIG+"Green "+NORM+GRN+"Dragon"+NORM+" [infant]");
set_long(
"This is an infant green dragon. Its body is nearly seven feet\n"+
...
set_spell_dam(15);
set_spell_mess1(
"The infant green dragon bites down on its opponent hard!\n");
set_spell_mess2(
