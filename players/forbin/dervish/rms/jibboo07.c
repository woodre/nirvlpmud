...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo08.c","north");
  add_exit(ROOT+"rms/jibboo01.c","northeast");
  add_exit(ROOT+"rms/jibboo06.c","east");
  add_exit(ROOT+"rms/jibboo19.c","southeast");
  add_exit(ROOT+"rms/jibboo20.c","south");
  add_exit(ROOT+"rms/jibboo21.c","southwest");
  add_exit(ROOT+"rms/jibboo22.c","west");
  add_exit(ROOT+"rms/jibboo23.c","northwest");
}
