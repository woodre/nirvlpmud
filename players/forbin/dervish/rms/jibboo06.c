...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo01.c","north");
  add_exit(ROOT+"rms/jibboo04.c","northeast");
  add_exit(ROOT+"rms/jibboo05.c","east");
  add_exit(ROOT+"rms/jibboo18.c","southeast");
  add_exit(ROOT+"rms/jibboo19.c","south");
  add_exit(ROOT+"rms/jibboo20.c","southwest");
  add_exit(ROOT+"rms/jibboo07.c","west");
  add_exit(ROOT+"rms/jibboo08.c","northwest");
}
