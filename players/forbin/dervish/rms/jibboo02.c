...
reset(arg) {
  ...
  create_random_room(); 
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo11.c","north");
  add_exit(ROOT+"rms/jibboo12.c","northeast");
  add_exit(ROOT+"rms/jibboo03.c","east");
  add_exit(ROOT+"rms/jibboo04.c","southeast");
  add_exit(ROOT+"rms/jibboo01.c","south");
  add_exit(ROOT+"rms/jibboo08.c","southwest");
  add_exit(ROOT+"rms/jibboo09.c","west");
  add_exit(ROOT+"rms/jibboo10.c","northwest");
}
