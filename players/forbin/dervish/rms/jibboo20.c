...
reset(arg) {
  ...
  create_random_room();
  add_item("rock",
    "A heavily pocked rock scoured by the powerful desert winds");
  add_item("rocks",
    "Several of the rocks are arranged in a pattern pointing northward");
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo07.c","north");
  add_exit(ROOT+"rms/jibboo06.c","northeast");  
  add_exit(ROOT+"rms/jibboo19.c","east");
  add_exit(ROOT+"rms/jibboo11.c","southeast");
  add_exit(ROOT+"rms/jibboo10.c","south");
  add_exit(ROOT+"rms/jibboo25.c","southwest");
  add_exit(ROOT+"rms/jibboo21.c","west");
  add_exit(ROOT+"rms/jibboo22.c","northwest");
}
