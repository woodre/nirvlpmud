  ...
  switch(random(4)) {
    case 0:
      long_desc = HIY+BYEL+
        ...
        "across the smooth surface of the sand.  A few rocks lie scattered\n"+
        "about here.                                                      \n"+
    ...
    case 1:
      long_desc = HIY+BYEL+
        ...
        "but sand and a few scattered rocks.  High in the sky off towards \n"+
        "the horizon, you can make out the fluttering forms of things you \n"+
        "suppose are birds.                                               \n"+
        "    You could travel in any of the compass directions.           \n"+NORM;
    ...
    case 2:
      long_desc = HIY+BYEL+
        "  A sandstorm rages all around you.  It is diffficult to see much\n"+
        "save for the few rocks that lie about your feet.  Here, rolling  \n"+
        "hills of sand ripple outward hugging the contours of the ground  \n"+
        "and rocks that lie beneath.  Winds scour the landscape, kicking  \n"+
        "up particles of sand and assaulting you with them.  This place is\n"+
        " sandy quicksilver; the sands churn and move constantly with the \n"+
        "hard wind that blows.                                            \n"+
        "    You could travel in any of the compass directions.           \n"+NORM;
    ...
    case 3:
      if(slopedir == "north" || slopedir == "south") {
        long_desc = HIY+BYEL+
          "  Sand stretches off in all directions.  The ground slopes gently\n"+
          "to the "+slopedir+", then falls off sharply down a sand covered incline.\n"+  
          "Rocks and sand have spilled down this "+slopedir+"ern slope; the sand   \n"+ 
          "piled towards the bottom in a lump.  Black shadows are cast here \n"+ 
          "and there by the high dunes that surround the area.              \n"+
          "    You could travel in any of the compass directions.           \n"+NORM;      
      }
      if(slopedir == "east" || slopedir == "west") {
        ...
        long_desc = HIY+BYEL+
          "  Sand stretches off in all directions.  The ground slopes \n"+
          "gently to the "+slopedir+", then falls off sharply down a sand\n"+  
          "covered incline.  Rocks and sand have spilled down this    \n"+
          ""+slopedir+"ern slope; the sand piled towards the bottom in a \n"+
          "lump.  Black shadows are cast here and there by the high   \n"+
          "dunes that surround the area.                              \n"+
          "    You could travel in any of the compass directions.     \n"+NORM;      
      }      
...
/* commented out till I get it working -forbin  
  int sandy;
  sandy = present("dervish_tattoo", this_player())->query_sand_points();
