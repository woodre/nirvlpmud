...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo23.c","north");
  add_exit(ROOT+"rms/jibboo08.c","northeast");
  add_exit(ROOT+"rms/jibboo07.c","east");
  add_exit(ROOT+"rms/jibboo20.c","southeast");
  add_exit(ROOT+"rms/jibboo21.c","south");
  add_exit(ROOT+"rms/jibboo17.c","southwest");
  add_exit(ROOT+"rms/jibboo16.c","west");
  add_exit(ROOT+"rms/jibboo15.c","northwest");
}
