...
reset(arg) {
  ...
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo14.c","north");
  add_exit(ROOT+"rms/jibboo24.c","northeast");  
  add_exit(ROOT+"rms/jibboo23.c","east");
  add_exit(ROOT+"rms/jibboo22.c","southeast");
  add_exit(ROOT+"rms/jibboo16.c","south");
