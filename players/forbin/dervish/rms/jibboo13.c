...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo17.c","north");
  add_exit(ROOT+"rms/jibboo21.c","northeast");
  add_exit(ROOT+"rms/jibboo25.c","east");
  add_exit(ROOT+"rms/jibboo24.c","southeast");
  add_exit(ROOT+"rms/jibboo14.c","south");
  add_exit(ROOT+"rms/jibboo03.c","southwest");
  add_exit(ROOT+"rms/jibboo12.c","west");
  add_exit(ROOT+"rms/jibboo18.c","northwest");
}
