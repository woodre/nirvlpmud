...
reset(arg) {
  ...
  create_random_room();
  no_exit_display = 1;
  add_exit(ROOT+"rms/jibboo22.c","north");
  add_exit(ROOT+"rms/jibboo07.c","northeast");
  add_exit(ROOT+"rms/jibboo20.c","east");
  add_exit(ROOT+"rms/jibboo10.c","southeast");
  add_exit(ROOT+"rms/jibboo25.c","south");
  add_exit(ROOT+"rms/jibboo13.c","southwest");
  add_exit(ROOT+"rms/jibboo17.c","west");
  add_exit(ROOT+"rms/jibboo16.c","northwest");
}
