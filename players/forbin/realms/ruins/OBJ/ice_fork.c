...
reset(arg){
  ...
  set_alias("icebrand");
  set_short(HIK+"Chu'Sarth Military Fork"+HIW+" ["+HIC+"Icebrand"+HIW+"]"+NORM);
  set_long(
...
if(W>16)  {
  say("\t"+BOLD+""+BLK+""+user+"'s Military Fork summons forth a powerful\n\n"+
      ""+HIC+"                             CYCLONE OF FROST "+NORM+"\n\n"+
      "\t\t"+BOLD+""+BLK+"which engulf's its victim with tendrils of pure pain!"+NORM+"\n");

  write(
  "\t"+BOLD+""+BLK+"Your Military Fork summons forth a"+NORM+"\n\n"+
  ""+HIC+"                        CYCLONE OF FROST"+NORM+"\n\n"+
  "\t\t"+BOLD+""+BLK+" which engulf's your foe with tendrils of pure pain!"+NORM+"\n");
  return 7;
   }
if(W>9)  {
  say(""+BOLD+""+BLK+""+user+"'s Military fork drives into it's victim slamming them with"+
  " shards of "+HIC+"ICE!"+NORM+"\n");

  write(
  ""+BOLD+""+BLK+"Your Military Fork drives into your foe sending shards of"+HIC+" ICE"+NORM+""+
