...
reset(arg){
  ...
  set_alias("icebrand");
  set_short(HIK+"Chu'Sarth Hammer"+HIW+" ["+HIC+"Icebrand"+HIW+"]"+NORM);
  set_long(
...
"\t"+BOLD+""+BLK+"You spin the Hammer over your head, summoning forth a"+NORM+"\n\n"+
  ""+HIC+"                        CYCLONE OF FROST"+NORM+"\n\n"+
  "\t\t"+BOLD+""+BLK+" which engulfs your foe with tendrils of pure pain!"+NORM+"\n");
  return 7;
   }
if(W>9)  {
  say(""+BOLD+""+BLK+""+user+"'s Hammer drives into its victim slamming them with"+
  " shards of "+HIC+"ICE!"+NORM+"\n");

  write(
  ""+BOLD+""+BLK+"Your Hammer drives into your foe sending shards of"+HIC+" ICE"+NORM+""+
