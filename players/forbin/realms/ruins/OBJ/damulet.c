...
if(!id(str)) return 0;
  ...
  write("is completely incompatible to your race.\n");
...
short() {
  if(environment(this_object())->query_shadowmane())
    return HIR+"Amulet"+NORM+" [glowing] (worn)";
  else return HIR+"Amulet"+NORM+" [glowing]"; 
}
