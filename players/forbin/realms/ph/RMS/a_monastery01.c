...
cmd_strike(string str) {
  ...
  if(!Doors) {
    write("You quitely climb the stairs and strike the gong once.\n"+
          "\n       A LOUD CLANG RINGS OUT!!!\n\n"+
          "You quickly walk back down the stairs.\n");
    say(this_player()->query_name()+" quitely climbs the stairs and strikes the gong once.\n"+
         "\n       A LOUD CLANG RINGS OUT!!!\n\n");
    Doors = 1;
...
open_sesame() {
    tell_room(this_object(), "The monastery doors swing open.\n");  
     add_exit(RMS+"a_monastery02","enter");   
}