...
//    2013.09.07 -Dragnar - upped heal rate.
*/ 
...
reset(arg)  {
  ...
  set_chat_chance(5);
    ...
    load_chat("Sebassis points at you and says, \"Leave while you still can!\"\n");
...
/*
//  SPELL ATTACKS:
//  darkmagic ::::: 20% chance 20-50 other|evil damage to random attacking player
//  lavastrike :::: 16% chance 30-70 other|fire damage to random attacking player 
//  toss :::::::::: 16% chance 45-95 physical damage to random attacking player
//  fireball :::::: 16% chance 60-110 other|fire damage to random attacking player
//  inferno :::::::  8% chance 75-125 other|fire damage to all attacking players
*/
  add_spell("darkmagic",
