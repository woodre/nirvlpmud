...
reset(arg) {
  ...
  add_exit(RMS+"cots05","north");
  add_exit(RMS+"cots06","northeast");
  add_exit(RMS+"cots07","east");
  add_exit(RMS+"cots08","southeast");
  add_exit(RMS+"cots09","south");
  add_exit(RMS+"cots03","west");
}
