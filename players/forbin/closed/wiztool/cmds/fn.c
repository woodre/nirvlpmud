...
int unsave() {
  int a;
  a = restore_object("players/forbin/closed/wiztool/ftsave");
  return a;
}
...
status main(string arg) {
  ...
  write_file("/players/forbin/closed/"+FileName, str1+"\n");
  write_file("/players/forbin/closed/"+FileName+".nc", str2+"\n"); 
  save_object("players/forbin/closed/wiztool/ftsave");    
