...
set_alias("firebrand");
set_short(""+BOLD+""+BLK+"Chu'Tath Battleaxe"+HIW+" ["+HIR+"Firebrand"+HIW+"]"+NORM+"");
set_long(
...
wield(string str) {
  ::wield();
  this_player()->RegisterArmor(this_object(), ({ "physical", 2, 0, "" }));   
}

stopwield(string str) {
  ::stopwield();
