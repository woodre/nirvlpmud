...
Date: 5/30/01
Description:
  A common locker room for crystal mages to use, with 12 slots.
*/

#include "/players/feldegast/crystal/defs.h"

#define SAVE_FILE "players/feldegast/crystal/rooms/storage"
...
int cmd_read(string str)
{
  if(str=="sign")
  {
    write(
      ...
      "\there for other players to use, or you may take an item\n"+
