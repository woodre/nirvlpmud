...
crowded street.  To the north of you is an intersection.\n";
  items=({
    ...
    "intersection", "Just to the north, Quartz street intersects with Marble street",
    "shops",        "None of the shops appear to be of interest to you",
    "townhouses",   "Neat little townhouses line the street",
  });
  dest_dir=({
    PATH+"marble4.c", "north",
    PATH+"quartz4.c","south",
  });
}   
