 cove(int lvl,int pi) {
  object acer, targ;
   ...
   return 1; }
     ...
     /* Replaced cove.c with newcove.c - Feldegast 1/20/01 */
     else targ = clone_object(root+"obj/newcove.c");
     targ->set_base(lvl+pi);

     /* I added this line because I assume it was forgotten accidentally. -Feldegast 1/20/01 */
     targ->set_caster(this_player());
