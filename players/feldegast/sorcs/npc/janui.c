...
reset(){
set_short(HIC+"Janui the Illusionist"+NORM);
set_name("janui");
set_level(30);
set_hp(500);
set_wc(50);
...
ask_mage(){
write("Janui says, \"I can help you study many things in the art of sorcery.\"\n");
write("Janui says, \"What would you like help with:\n"+
      "                  pestilence,\n"+
      "                  or lifedrain?\"\n");
say("Janui speaks privately with "+this_player()->query_name()+".\n");
return 1;
}
...
int xexp,exp,chance;
if(!str){
  notify_fail("Janui says, \"What would you like help studing?\"\n");
  return 0;
}
switch(str){
case "pestilence":  exp = 30000; chance = 3; break;
case "lifedrain": exp = 40000; chance = 40; break;
default: notify_fail("Janui says, \"I'm sorry, but I can not help you with that.\"\n");
        return 0; break;
}
...
if(xexp < exp){
  write("Janui says, \"You don't have enought knowldege.  To train you would be \n"+
        "a waste of my time.\"\n");
  return 1;
}
write("Janui shows and explain the spell to you then leaves you to study\n"+
...
write(HIC+"The ink glows a cyan and the spell takes form.\n"+NORM);
...
case 6:  msg = "Janui tears up your paper and curses at you.\n"; break;
