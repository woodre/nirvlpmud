...
short() {
   return "Backroom of Gene Eric's Shop";
}
...
west() {
  this_player()->move_player("west#players/feldegast/arena/rooms/geneshop");
   return 1;
}
...
reset(arg) {
   ...
   if (!present("torch")) {
    ...
    if(!present("statue")) {
      object statue;
      statue=clone_object("/players/feldegast/obj/statue");
      move_object(statue,this_object());
    }
    move_object(clone_object("/players/feldegast/wep/pistol.c"),this_object());
    move_object(clone_object("/players/feldegast/wep/8mmammo.c"),this_object());
    move_object(clone_object("/players/feldegast/wep/8mmammo.c"),this_object());
    if(!present("ring")) {
      object ring;
      ring=clone_object("/players/feldegast/obj/eng_ring");
      move_object(ring,this_object());
    }
    if(!present("watch")) {
      object watch;
      watch=clone_object("/players/feldegast/obj/watch");
