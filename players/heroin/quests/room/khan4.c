...
dest_dir=({
"/players/heroin/hunting_grounds/preds/hg10", "out",});
long_desc =
"You find the third and final outpost of Ghengis.\n"+
"Congrats!! But Alas you took too long and Ghengis\n"+
"has moved his camp to another area of the hunt..\n";
}
init(){
::init();
