...
move_object(clone_object("/players/heroin/hunting_grounds/predclaws.c"), this_object());
move_object(clone_object("/players/heroin/hunting_grounds/predstone.c"), this_object());
/*
move_object(clone_object("/players/heroin/hunting_grounds/bioarmor.c"), this_object());
*/
set_chance(10);
enable_commands();
set_heart_beat(1);
