...
move_object(clone_object("/players/heroin/hunting_grounds/preds/predclaws"), this_object());
move_object(clone_object("/players/heroin/hunting_grounds/preds/predstone"), this_object());
move_object(clone_object("/players/heroin/hunting_grounds/preds/bioarmor"), this_object());
set_chance(10);
enable_commands();
set_heart_beat(1);
set_spell_dam(30);
