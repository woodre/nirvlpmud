...
short_desc="Ravines and Crags   ";
dest_dir=({
"/players/heroin/hunting_grounds/preds/hg1","up",});
long_desc =
"Nothing humorous about this place, nothing here but rock\n"+
"blood, and the Universe's most perfect killer!\n";
}
init(){
::init();
