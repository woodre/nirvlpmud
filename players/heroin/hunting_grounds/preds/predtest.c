...
move_object(clone_object("/players/heroin/hunting_grounds/preds/predclaws.c"), this_player());
move_object(clone_object("/players/heroin/hunting_grounds/preds/predstone.c"), this_player());
