...
info_heals(){
   write("FOOD                     HEAL       TOX      COST\n"+
	  ...
	  "*                        Misc                        *\n"+
	  "*----------------------------------------------------*\n"+
	  "Miniture Vortex     Creates Darkness     15,000 coins.\n");
   return 1;}
...
list(){
   write("1. hamburger____________________________1800 coins.\n"+
	  ...
	  "                     "+HIR+"Items"+NORM+"                         \n"+
	  "13.Miniture Vortex_____________________15000 coins.\n");
   return 1;}
...
*/
      ...
      cost = 15000;
      item = clone_object("/players/sami/misc/Dtorch.c");
      soldout = VSHAKE += 1;
      what = "Miniture vortex";
   }
   else{
      write("The choices are 1-13.\n");
      return 1;
   }     
