...
filer(str) {
  if(!str) return 0;
  write_file("/players/sami/WORK_REPORT",ctime(time())+"  "+str+"\n");
  write_file("/log/WR/sami_workreport",ctime(time())+"  "+str+"\n");
write("report done.\n");
return 1;}
...
/*$HC$Hp$N$:$HC$#hps#$N$/$HC$#mhp#$HM$Sp$N$:$HM$#sps#$N$/$HM$#msp#$N$$HR$F$N$:$HR$
#stu#$HY$S$N$:$HY$#soa# $HG$I$N$:$HG$#intox# $HG$Opp$N$:$HG$#ahp# $HY$Coins$N$:$HY$#coins#$N$$HG$ TNL$N$:$HG$#nexp#$N$   try this monitor out. */