...
" | ---"+HIR+"*"+NORM+"-"+HIY+"#"+NORM+"  |  their trying to figure something out.  The vents are no longer\n"+
...
add_exit("/players/sami/area/GPO/medlab5.c","west");
add_exit("/players/sami/area/GPO/medlab3.c","east");
}
init() {
     ::init();
