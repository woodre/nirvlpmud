/*                      /                                             *
 *    File:             /players/sami/area/GPO/abarracks10.c   *
 *    Function:         room                                          *
...
" |    "+HIY+"#"+NORM+"-   |  and are dimly lighting the area with their red glow.\n"+
" |         |\n"+
" O-==========================================================================-O\n";
...
add_exit("/players/sami/area/GPO/abarracks9.c","south");
add_exit("/players/sami/area/GPO/abarracks11.c","north");
}