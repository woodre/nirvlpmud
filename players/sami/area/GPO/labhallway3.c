...
" | -"+HIY+"*"+NORM+"-"+HIR+"*"+NORM+"--- |  onto the floors.  The smell of chemicals eminates from up ahead\n"+
...
add_exit("/players/sami/area/GPO/labhallway4.c","west");
add_exit("/players/sami/area/GPO/labhallway2.c","east");
}
init() {
     ::init();
