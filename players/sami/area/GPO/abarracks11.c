/*                      /                                             *
 *    File:             /players/sami/area/GPO/abarracks11.c   *
 *    Function:         room                                          *
...
" |    "+HIY+"#"+NORM+"-   |  sleep.  Along the hallways are destroyed rooms that used to be\n"+
...
add_exit("/players/sami/area/GPO/abarracks10.c","south");
add_exit("/players/sami/area/GPO/abarracks12.c","north");
}