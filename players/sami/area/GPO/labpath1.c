...
" |  "+HIY+"*"+NORM+"-"+HIR+"*"+NORM+"--- |  as the assorted vials and storage shelves.  However, there is\n"+
" |         |  blood sprayed everywhere.  There are dead bodies in lab coats\n"+
" |         |  lying on the ground, with blood soaked vampires standing above\n"+
" |         |  them.\n"+
" O-==========================================================================-O\n";
...
add_exit("/players/sami/area/GPO/droom.c","west");
add_exit("/players/sami/area/GPO/labpath2.c","east");
}
init() {
     ::init();
