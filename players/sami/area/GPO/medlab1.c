...
" |   -"+HIY+"#"+NORM+"-   |  seems as if the fon stones are losing their power.\n"+
" |         |\n"+
" O-==========================================================================-O\n";
...
add_exit("/players/sami/area/GPO/labhallway4.c","south");
add_exit("/players/sami/area/GPO/medlab2.c","north");
}
init() {
     ::init();
