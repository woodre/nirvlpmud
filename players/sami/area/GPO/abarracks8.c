...
" |  "+HIY+"#"+NORM+"-"+HIR+"*"+NORM+"--- |  dead bodies, and slink back into the darkness when they notice\n"+
...
add_exit("/players/sami/area/GPO/abarracks7.c","east");
add_exit("/players/sami/area/GPO/abarracks9.c","west");
}