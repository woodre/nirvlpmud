...
" | ---"+HIR+"*"+NORM+"-"+HIY+"*"+NORM+"  |  onto the floors.  The smell of chemicals eminates from up ahead\n"+
...
add_exit("/players/sami/area/GPO/labhallway3.c","west");
add_exit("/players/sami/area/GPO/labhallway1.c","east");
}
init() {
     ::init();
