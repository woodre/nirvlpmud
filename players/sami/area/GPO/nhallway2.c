...
reset(arg) {
  ...
  long_desc =
" O-==========================================================================-O\n"+
" |    |    |  The northern hallway is riffled with different sounds coming from\n"+
...
" |    |    |  is dark room, and to the east another hallway.\n"+
" O-==========================================================================-O\n";
...
add_exit("/players/sami/area/GPO/nhallway1.c","south");
add_exit("/players/sami/area/GPO/ldeck9.c","west");
add_exit("/players/sami/area/GPO/nhallway3.c","north");
add_exit("/players/sami/area/GPO/labhallway7.c","east");
}