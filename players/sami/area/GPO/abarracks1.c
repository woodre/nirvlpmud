/*                      /                                             *
 *    File:             /players/sami/area/GPO/abarracks1.c   *
 *    Function:         room                                          *
...
" | -"+HIY+"#"+NORM+"-"+HIR+"*"+NORM+"-"+HIY+"#"+NORM+"  |  debris lying everywhere; smaller vampires have made this\n"+
...
add_exit("/players/sami/area/GPO/bentrance.c","west");
add_exit("/players/sami/area/GPO/abarracks2.c","east");
}