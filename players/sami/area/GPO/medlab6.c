...
" |         |  resting beds are broken, and the healing machines are destroyed.\n"+
" |         |  Vampires have infested the lab, scouring over every inch as if\n"+
" |  "+HIY+"#"+NORM+"-"+HIR+"*"+NORM+"--- |  their trying to figure something out.  The vents are no longer\n"+
" |  |      |  pouring in their healing mist, and the lights are quit dim.  It\n"+
" |         |  seems as if the fon stones are losing their power.\n"+
" |         |\n"+
" O-==========================================================================-O\n";
   items =
    ({
...
add_exit("/players/sami/area/GPO/nhallway5.c","west");
add_exit("/players/sami/area/GPO/medlab5.c","east");
}
init() {
     ::init();
