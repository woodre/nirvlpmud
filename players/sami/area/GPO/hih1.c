...
" | ---"+HIR+"*"+NORM+"-"+HIY+"#"+NORM+"- |  The metal floors are stained heavy with blood, and there are\n"+
...
add_exit("/players/sami/area/GPO/entrance.c","east");
add_exit("/players/sami/area/GPO/hih2.c","west");
}