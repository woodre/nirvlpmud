...
reset(arg) {
  ...
  long_desc =
" O-==========================================================================-O\n"+
" |    "+HIY+"*"+NORM+"    |  The remains of the old GPO Laboratory has for the most part\n"+
...
add_exit("/players/sami/area/GPO/labpath7.c","north");
add_exit("/players/sami/area/GPO/labpath5.c","south");
}
init() {
     ::init();
