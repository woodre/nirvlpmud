/*                      /                                             *
 *    File:             /players/sami/area/GPO/abarracks12.c   *
 *    Function:         room                                          *
...
" |  "+HIY+"#"+NORM+"-"+HIR+"*"+NORM+"-"+HIY+"#"+NORM+"- |  debris lying everywhere, and smaller vampires have made this\n"+
...
add_exit("/players/sami/area/GPO/abarracks12.c","west");
add_exit("/players/sami/area/GPO/bentrance.c","east");
}