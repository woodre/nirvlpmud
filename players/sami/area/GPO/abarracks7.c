...
" | ---"+HIR+"*"+NORM+"--- |  dead bodies, and slink back into the darkness when they notice\n"+
" |         |  your presence.  All the doors to the former bedrooms are busted\n"+
" |         |  in and the rooms have collapsed in.  However, to the north it\n"+
" |         |  looks like you could make it past the debris and enter the room.\n"+
" O-==========================================================================-O\n";
   ...
   items =
	...
	"There appears to be movement on the other side, mayby you can venture north?",
	"stones",
...
add_exit("/players/sami/area/GPO/abarracks6.c","east");
add_exit("/players/sami/area/GPO/abarracks8.c","west");
}
init()   {
  ::init();
...
north() {
TP->move_player("north#players/sami/area/GPO/hroom1.c");
return 1;}
