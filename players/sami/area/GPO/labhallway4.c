...
" |         |  To the north lies the entrance to the Medical Lab.\n"+
" O-==========================================================================-O\n";
...
add_exit("/players/sami/area/GPO/labhallway5.c","west");
add_exit("/players/sami/area/GPO/labhallway3.c","east");
add_exit("/players/sami/area/GPO/medlab1.c","north");
}
init() {
     ::init();
