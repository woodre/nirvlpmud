/*                      /                                             *
 *    File:             /players/sami/area/GPO/shallway2.c   *
 *    Function:         room                                          *
...
" |    |    |  and the smell of blood can be smell coming from the south.  There\n"+
...
add_exit("/players/sami/area/GPO/shallway1.c","north");
add_exit("/players/sami/area/GPO/shallway3.c","south");
}