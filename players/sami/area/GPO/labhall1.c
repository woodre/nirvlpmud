...
" | -"+HIY+"#"+NORM+"-"+HIR+"*"+NORM+"--- |  onto the floors.  The smell of chemicals emanates from up ahead\n"+
...
add_exit("/players/sami/area/GPO/labhall2.c","east");
add_exit("/players/sami/area/GPO/entrance.c","west");
}
init() {
     ::init();
