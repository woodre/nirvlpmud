...
" |  "+HIY+"#"+NORM+"-"+HIR+"*"+NORM+"--- |  fon stones here have lost most of their power, blood has been\n"+
...
" O-==========================================================================-O\n";
   ...
   items =
    ...
    "eyes",
    "moving eyes are attached to the walls glaring at you mennacingly.",
	"stones",
...
add_exit("/players/sami/area/GPO/ldeck6.c","west");
add_exit("/players/sami/area/GPO/ldeck8.c","east");
}
