...
" |  "+HIY+"#"+NORM+"-"+HIR+"*"+NORM+"--- |  The metal floors are stained heavy with blood, and there are\n"+
...
add_exit("/players/sami/area/GPO/hih3.c","east");
add_exit("/players/sami/area/GPO/hih5.c","west");
}