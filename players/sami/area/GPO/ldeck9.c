...
" | ---"+HIR+"*"+NORM+"-"+HIY+"#"+NORM+"- |  fon stones here have lost most of their power, blood has been\n"+
...
add_exit("/players/sami/area/GPO/nhallway2.c","east");
add_exit("/players/sami/area/GPO/ldeck8.c","west");
}
