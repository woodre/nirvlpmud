...
"|    "+HIY+"#"+NORM+"-   |  is dark, and no light can be seen coming from the other side.\n"+
"|         |\n"+
"O-==========================================================================-O\n";
...
add_exit("/players/sami/area/GPO/labhall3.c","north");
add_exit("/players/sami/area/GPO/droom.c","south");
}
init() {
     ::init();
