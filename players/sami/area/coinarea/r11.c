...
reset(arg) {
  if(!present("spiderman"))  {
    MOCO("/players/sami/area/coinarea/npc/spiderman.c"),this_object()); }
   if(arg) return;
   set_light(0);
...
add_exit("/players/sami/area/coinarea/r19","south");
add_exit("/players/sami/area/coinarea/r12","east");
}
