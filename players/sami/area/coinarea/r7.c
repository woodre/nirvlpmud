...
reset(arg) {
  if(!present("captain_1"))  {
    MOCO("/players/sami/area/coinarea/npc/cptamm.c"),this_object()); }
   if(arg) return;
   set_light(0);
...
add_exit("/players/sami/area/coinarea/r6","west");
add_exit("/players/sami/area/coinarea/r8","east");
}
