...
reset(arg) {
  ...
  dest_dir = ({
    "/players/mythos/closed/guild/forest/rooms/hunter4.c", "north",
    "/players/mythos/closed/guild/forest/rooms/hunter12.c", "east",
    "/players/mythos/closed/guild/forest/rooms/hunter11.c", "south",
    "/players/mythos/closed/guild/forest/rooms/hunter6.c", "west",
  });
  call_out("timing",10);
} }
realm() { return "NT";}
