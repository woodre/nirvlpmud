...
reset(arg) {
  ...
  /*
  if(!present("amoril")) {
    move_object(clone_object("/players/mythos/closed/guild/forest/mon/servant.c"),
    this_object()); }
    */
  mn = 1;
  if(!arg) {
  ...
  dest_dir = ({
    "/players/mythos/closed/guild/forest/rooms/hunter8.c", "north",
    "/players/mythos/closed/guild/forest/rooms/hunter5.c", "east",
    "/players/mythos/closed/guild/forest/rooms/hunter10.c", "south",
    "/players/mythos/closed/guild/forest/rooms/hunter3.c", "west",
  });
} }
realm() { return "NT";}
