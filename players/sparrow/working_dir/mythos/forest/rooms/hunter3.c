...
reset(arg) {
  ...
  dest_dir = ({
    "/players/mythos/closed/guild/forest/rooms/hunter7.c", "north",
    "/players/mythos/closed/guild/forest/rooms/hunter4.c", "east",
    "/players/mythos/closed/guild/forest/rooms/hunter6.c", "south",
    "/players/mythos/closed/guild/forest/rooms/hunter2.c", "west",
  });
} }
realm() { return "NT";}
