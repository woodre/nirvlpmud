...
reset(arg) {
  ...
  dest_dir = ({
    "/players/mythos/closed/guild/forest/rooms/hunter9.c", "north",
    "/players/mythos/closed/guild/forest/rooms/hunter14.c", "east",
    "/players/mythos/closed/guild/forest/rooms/hunter4.c", "south",
    "/players/mythos/closed/guild/forest/rooms/hunter7.c", "west",
  });
} }
realm() { return "NT";}
