...
reset(arg)  {
  ...
  set_race("creature");
  set_short(HIW+"White Wolf"+NORM);
  set_long(HIW+"A great white wolf- albino in appearance,\n"+
           HIR+"blood red eyes"+HIW+" and a coat of bright white.  Yet\n"+
  ...
  load_chat(HIR+"Red eyes"+NORM+" gleam out from the darkness....\n");
