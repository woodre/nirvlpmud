/*  10/09/06 - Rumplemintz: Moved inherit to top of file  */
inherit "/players/rumplemintz/working_dir/inheritroom.c";
#include "/players/wocket/closed/ansi.h"
#define MASTER "/players/rumplemintz/working_dir/mastercr.c"
...
newnorth(){
	...
	if(random(10) == 1 && MASTER->query_sinjaroom() == 0){
	    northroom = "/players/rumplemintz/working_dir/sinjaroom.c";
	}
	else{
	    northroom = clone_object("/players/rumplemintz/working_dir/croom.c");
	}  
...
newsouth(){
    ...
    if(!southroom){
	southroom = clone_object("/players/rumplemintz/working_dir/croom.c");
...
newwest(){
    ...
    if(!westroom){
	westroom = clone_object("/players/rumplemintz/working_dir/croom.c");
...
neweast(){
    ...
    if(!eastroom){
	eastroom = clone_object("/players/rumplemintz/working_dir/croom.c");
...
move_me(object room,string way){
    if(room == "/players/rumplemintz/working_dir/sinjaroom.c") room = find_object(room);
