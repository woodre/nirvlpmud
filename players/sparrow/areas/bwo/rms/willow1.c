...
inherit "room/room";
  ...
  if(!arg){
    ...
    long_desc="The Avenue of Shadows comes to an adrupt halt at the western wall of Willow\n"+
    		  "Grove.  Pale golden paving stones fitted perfectly together stretch eastward\n"+
    		  "through the town leading to the center square.  Shadows dance freely across\n"+
