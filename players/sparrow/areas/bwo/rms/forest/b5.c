...
inherit "room/room";
  ...
  if(!arg){
    ...
    dest_dir=({
      BWO+"forest/a5.c","west",
      BWO+"forest/c5.c","east",
      BWO+"forest/a6.c","southwest",
    });
  }   
}
...
enter_shadows(string wha) {
  ...
  this_player()->move_player("suddenly disappearing into the shadows#players/sparrow/areas/bwo/rms/forest/a6.c");
  return 1;
}
