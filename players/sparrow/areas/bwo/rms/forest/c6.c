...
inherit "room/room";
  ...
  if(!arg){
    ...
    dest_dir=({
      BWO+"forest/d6.c","east",
      BWO+"forest/c5.c","north",
      BWO+"forest/b6.c","west",
    });
  }   
}
...
enter_shadows(string wha) {
  ...
  this_player()->move_player("suddenly disappearing into the shadows#players/sparrow/areas/bwo/rms/forest/a5.c");
  return 1;
}
