...
inherit "room/room";
  ...
  if(!arg){
    ...
    dest_dir=({
      BWO+"forest/c5.c","northeast",
      BWO+"forest/c6.c","east",
      BWO+"forest/a6.c","west",
    });
  }   
}
...
enter_shadows(string wha) {
  ...
  this_player()->move_player("suddenly disappearing into the shadows#players/sparrow/areas/bwo/rms/forest/e5.c");
  return 1;
}
