...
inherit "room/room";
  ...
  if(!arg){
	...
	long_desc="The forest is dark, very dark. The only light that permiates the darkness is the\n"+
	    	  "twinkling pinpoints of light that eminate from the buds of the trees. The darkness\n"+
    ...
    dest_dir=({
      "/players/sparrow/areas/darkGauntlet/rms/forest3.c","north",
      "/players/sparrow/areas/darkGauntlet/rms/forest2.c","east",
      "/players/sparrow/areas/darkGauntlet/rms/forest1.c","south",
      "/players/sparrow/areas/darkGauntlet/rms/forest3.c","west",
      "/players/sparrow/areas/darkGauntlet/rms/forest2.c","northeast",
      "/players/sparrow/areas/darkGauntlet/rms/forest1.c","northwest",
      "/players/sparrow/areas/darkGauntlet/rms/forest3.c","southeast",
      "/players/sparrow/areas/darkGauntlet/rms/forest2.c","southwest",
    });
  }
}
