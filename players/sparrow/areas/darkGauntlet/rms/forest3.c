...
inherit "room/room";
  ...
  if(!arg){
    ...
    dest_dir=({
      "/players/sparrow/areas/darkGauntlet/rms/forest4.c","north",
      "/players/sparrow/areas/darkGauntlet/rms/forest1.c","east",
      "/players/sparrow/areas/darkGauntlet/rms/forest2.c","south",
      "/players/sparrow/areas/darkGauntlet/rms/forest4.c","west",
      "/players/sparrow/areas/darkGauntlet/rms/forest1.c","northeast",
      "/players/sparrow/areas/darkGauntlet/rms/forest2.c","northwest",
      "/players/sparrow/areas/darkGauntlet/rms/forest4.c","southeast",
      "/players/sparrow/areas/darkGauntlet/rms/forest1.c","southwest",
    });
  }
}
