/*****************************************************************************
 *      File:                   herensugue.c
 *      Function:               herensugue the seven headed serpent
 *      Author(s):              Sparrow@Nirvana
 *      Copyright:              Copyright (c) 2015 Sparrow
 *                              All Rights Reserved.
 *      Source:                 1/22/15 
 *      Notes:
 *      Change History:
...
reset(arg) {
  ...
  if (!arg) {
    ...
    */
    ...
    set_name("herensugue");
    set_alias("serpent");
    set_short(HIK+"Herensugue "+HIG+"["+HIW+"Seven Headed Serpent"+HIG+"]"+NORM);
    set_race( "demon");
    set_long("Herensugue fed but once in three months, the whole forest was made desolate. With a\n"+
	         "strong inspiration of his breath, he drew into his capacious maw, across the valleys,\n"+
			 "whole flocks of sheep and goats, herds of oxen, men, women, children, the population\n"+ 
			 "of whole villages at once. He was now asleep, and inert, after such a repast. The\n"+
			 "serpent has now awoken in a rage at having his slumbers broken, with a roar like a\n"+
			 "thunderbolt rocks have uptorn or split open, the mountains shattered, the glaciers\n"+ 
			 "beaten into dust as the serpent twists and lashes about in his anger. To quench his\n"+ 
			 "thirst for destruction his seven heads writhe and twist looking for something to devour.\n");
    set_gender("male");
    set_level(40);
    set_ac(40+random(10));
    set_wc(70+random(10));
