...
void ninjaWeapon() {
  ...
  set_multi_attack(     36, 80);
  set_max_attack(       26, 40, "standard",     random(alv) + random(alv/3));
  set_med_attack(       16, 30, "standard",     random(alv/3) + 2);
  set_min_attack(       5, 20, "hit_location", random(alv/5));
