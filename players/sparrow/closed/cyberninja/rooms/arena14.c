...
"1. Biometric Solution           300\n"+
"2. Neurotic Solution            300\n"+
"3. Polymer Solution             300\n"+
"4. Power Cell                   800\n"+
"5. Liquid Circuit Cooler        3500\n"+
"________________________________________\n"+
"\n");
  return 1;
}
...
break;
case "curcuit cooler": value = 3500;  objectpath = "/players/dune/closed/guild/heals/cooler.c";
break;
case "cooler": value = 3500;  objectpath = "/players/dune/closed/guild/heals/cooler.c";
break;
case "5": value = 3500;  objectpath = "/players/dune/closed/guild/heals/cooler.c";
break;
case "power cell": value = 800;  objectpath = "/players/dune/closed/guild/heals/cell.c";
    break;
case "cell": value = 800;  objectpath = "/players/dune/closed/guild/heals/cell.c";
break;
case "4": value = 800;  objectpath = "/players/dune/closed/guild/heals/cell.c";
break;
case "biometric solution": value = 300;  objectpath = "/players/dune/closed/guild/heals/bheal.c";
break;
case "Biometric solution": value = 300;  objectpath = "/players/dune/closed/guild/heals/bheal.c";
break;
case "1": value = 300;  objectpath = "/players/dune/closed/guild/heals/bheal.c";
break;
case "polymer solution": value = 300;  objectpath = "/players/dune/closed/guild/heals/pheal.c";
break;
case "Polymer solution": value = 300;  objectpath = "/players/dune/closed/guild/heals/pheal.c";
break;
case "3": value = 300;  objectpath = "/players/dune/closed/guild/heals/pheal.c";
break;
case "neurotic solution": value = 300;  objectpath = "/players/dune/closed/guild/heals/nheal.c";
break;
case "Neurotic solution": value = 300;  objectpath = "/players/dune/closed/guild/heals/nheal.c";
break;
case "2": value = 300;  objectpath = "/players/dune/closed/guild/heals/nheal.c";
break;
