...
dest_dir=({
ROOMDIR + "/arena14.c", "up",
ROOMDIR + "/arena19.c", "northwest",
ROOMDIR + "/arena20.c", "north",
ROOMDIR + "/arena21.c", "northeast",
ROOMDIR + "/arena24.c", "east",
ROOMDIR + "/arena27.c", "southeast",
ROOMDIR + "/arena26.c", "south",
ROOMDIR + "/arena25.c", "southwest",
ROOMDIR + "/arena22.c", "west",
});
