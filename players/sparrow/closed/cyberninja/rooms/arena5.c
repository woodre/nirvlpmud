...
dest_dir=({
ROOMDIR + "/arena14.c", "down",
ROOMDIR + "/arena1.c", "northwest",
ROOMDIR + "/arena2.c", "north",
ROOMDIR + "/arena3.c", "northeast",
ROOMDIR + "/arena6.c", "east",
ROOMDIR + "/arena9.c", "southeast",
ROOMDIR + "/arena8.c", "south",
ROOMDIR + "/arena7.c", "southwest",
ROOMDIR + "/arena4.c", "west",
});
