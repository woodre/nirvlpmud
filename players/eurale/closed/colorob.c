...
setcolor(str){
	...
	if (str == "hir") colorstr = HIR+backstr;
	if (str == "hig") colorstr = HIG+backstr;
	if (str == "hiy") colorstr = HIY+backstr;
	if (str == "hib") colorstr = HIB+backstr;
	if (str == "him") colorstr = HIM+backstr;
	if (str == "hic") colorstr = HIC+backstr;
	if (str == "hiw") colorstr = HIW+backstr;
return 1;
}
setstyle(str){
      if (str == "norm")
