...
set_long(
  ...
  "Abyss.  This huge, black guardian of the portal is a haggard and pale\n"+
  "imitation of the person gazing at it.  It's eyes are dull and life-\n"+
  "less and it reflexively breaks into a twisted grin when its eyes\n"+
...
monster_died() {
  ...
  "As the life fades from its eyes, you sense the phrase to black\n"+
  "reply, 'from darkness to darkness my voice echoes in the abyss'\n");
  write_file("/players/eurale/Abyss/LOG/abyss",
  tp->query_real_name()+"     "+ctime(time())+"     fetch4\n");
return 0; }
