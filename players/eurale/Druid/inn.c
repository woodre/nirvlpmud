...
ONE_EXIT("players/eurale/Druid/df10.c","south",
BOLD+GRN+"Druid Eatery"+NORM,
"You are in the Druid Eatery. Here you can buy food to still your\n"+
...
show_menu() {
 ...
 if(!(cm||mm||rmm)) 
  ...
  write("1: Twice-baked potato     ");write(cm);write(" at 210 gp\n");
...
if(s=="1"||s=="<1>") {
  ...
  write("You are served a twice-baked potato - very nourishing\n");
...
/* Leak soup, price 300, heals 25 times 12 per pt  */
 if(s=="2"||s=="<2>") {
  ...
  write("You are served a bowl of leak soup - very good\n");
...
/*  Beef stew, price 350, heals 35 times 10 per pt  */
 if(s=="3"||s=="<3>") {
  ...
  write("You are served a plate of beef stew - very delicious\n");
