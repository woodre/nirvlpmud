...
long_desc =
	...
	"There is a park off to the west with large statues of lions \n"+
	"and historical figures that the children enjoy climbing.  To the \n"+
	"east is the beautiful Westminster Bridge.\n";
...
dest_dir = ({
	"players/eurale/Dis/Pan/pc12.c","north",
	"players/eurale/Dis/Pan/pc4.c","south",
