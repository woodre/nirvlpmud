...
long_desc =
	...
	"There is a park off to the north with large statues of lions \n"+
...
dest_dir = ({
	"players/eurale/Dis/Pan/pc4.c","northeast",
	"players/eurale/Dis/Pan/pch2.c","enter",
	"players/eurale/Dis/Pan/pc6.c","west",
});
