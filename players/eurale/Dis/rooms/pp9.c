...
long_desc =
	...
	"flowers grow along the edge of the parkway.  There is a small \n"+
	"stone house partially hidden off to the east.\n";
...
dest_dir = ({
	"players/eurale/Dis/rooms/pp8.c","south",
	"players/eurale/Dis/rooms/pp13.c","east",
});
