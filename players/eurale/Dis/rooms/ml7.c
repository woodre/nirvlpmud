...
if(!present("highwayman")) {
  move_object(clone_object("players/eurale/Dis/rooms/NPC/hwyman"),TO); }
...
dest_dir = ({
	"players/eurale/Dis/rooms/ml6.c","south",
	"players/eurale/Dis/rooms/ml8.c","north",
});
