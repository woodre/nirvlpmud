...
long_desc =
	...
	"flowers grow along the edge of the parkway.  Just off the road \n"+
	"to the east is a small opening to what appears to be a cave.\n";
...
dest_dir = ({
	"players/eurale/Dis/rooms/pp8.c","north",
	"players/eurale/Dis/rooms/pp6.c","west",
	"players/eurale/Dis/rooms/pp12.c","in",
});
