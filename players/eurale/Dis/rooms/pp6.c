...
long_desc =
	...
	"flowers grow along the edge of the parkway.  Just over the \n"+
	"mound of dirt to the south you can barely see the roof of a small\n"+
	"straw hut.\n";
...
dest_dir = ({
	"players/eurale/Dis/rooms/pp11.c","south",
	"players/eurale/Dis/rooms/pp7.c","east",
	"players/eurale/Dis/rooms/pp5.c","west",
});
