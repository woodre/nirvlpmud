...
long_desc =
	...
	"flowers grow along the edge of the parkway.  Hidden among the \n"+
	"trees is a compact stick hut.\n";
...
dest_dir = ({
	"players/eurale/Dis/rooms/pp10.c","north",
	"players/eurale/Dis/rooms/pp6.c","east",
	"players/eurale/Dis/rooms/pp4.c","west",
});
