...
items = ({
	"bushes","A mulberry bush",
	"road","A dirt road",
	"clouds","That one looks like a cat",
});

dest_dir = ({
	"players/eurale/Dis/Pino/twt16.c","south",
	"players/eurale/Dis/Pino/twt8.c","east",
	"players/eurale/Dis/Pino/twt10.c","west",
});
