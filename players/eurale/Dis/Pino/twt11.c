...
long_desc =
	...
	"look like giant cotton balls.  Off to the north you can see the\n"+
...
dest_dir = ({
	"players/eurale/Dis/Pino/twt13.c","north",
	"players/eurale/Dis/Pino/twt10.c","south",
	"players/eurale/Dis/Pino/twt12.c","west",
});
