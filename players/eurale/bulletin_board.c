...
long() { write(
  "This is a player "+BOLD+"bulletin board"+NORM+".\n"+
...
board_message_file = "players/eurale/generic_board_save";
...
remove(str) {
  ...
  if(TPL < 21 &&
    TPRN != "eurale" &&
    TPRN != "magus") {
    write("Only Eurale and Magus can remove notes.\n");
    return 1; }
