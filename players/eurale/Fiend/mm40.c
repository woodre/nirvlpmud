...
reset(arg) {
if(!present("godzilla")) {
  move_object(clone_object("players/eurale/Fiend/NPC/godzilla"),TO); }
  if(arg) return;
set_light(0);

short_desc = "Fiendsville";
long_desc =
	"  You have reached the southern boundaries of this 'island-like'\n"+
...
dest_dir = ({
	"players/eurale/Fiend/mm38.c","north",
});
