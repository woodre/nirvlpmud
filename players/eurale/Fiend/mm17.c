...
long_desc =
	...
	"to your inability to navigate.  To the south you see some\n"+
	"overgrown steps that lead down to an underground crypt of\n"+
	"some kind.\n";
...
items = ({
	...
	"steps","Stone steps overgrown with grass and covered with leaves",
	"crypt","A heavy wooden door to an underground enclosure",
});

dest_dir = ({
	"players/eurale/Fiend/mm16.c","north",
	"players/eurale/Fiend/mm35.c","down",
});
