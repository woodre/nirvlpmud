...
long_desc =
	...
	"up and down the walls.  The dank air has a must odor to it and\n"+
	"off to the east, the cave seems to be much brighter.\n";
...
dest_dir = ({
	"players/eurale/Keep/k13.c","east",
	"players/eurale/Keep/k11.c","south",
});
