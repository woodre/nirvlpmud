...
wolf_do(str)
{
  ...
  if(!master)
  {
    say("The "+BOLD+"dire wolf"+NORM+" looks lost and lopes off looking for "+
  ...
  if(lower_case(str) == "dismissed")
  {
    tell_room(environment(TO),
      "The "+BOLD+"dire wolf"+NORM+" seems to nod at "+capitalize(master_name)+
      " and lopes away.\n");
  ...
  if(str == "stay")
  {
    say("The "+BOLD+"dire wolf"+NORM+" pads into a dark area to sit and wait.\n");
    wait_here = 1;
    return 1;
  }
  ...
  if(str == "heel")
  {
    say("The "+BOLD+"dire wolf"+NORM+" scrambles to its feet and stands at "+
...
/*      }  */
    ...
    if(obj) TO->attack_object(obj);
      ...
      write("The "+BOLD+"dire wolf"+NORM+" growls:  "+str2+" is not here!\n");
    return 1;
  }
  ...
  if(sscanf(str, "stop %s", str)==1)
  {
    if(str == "attack")
    {
      ...
      TO->stop_fight();
      TO->stop_hunter();
      write("The "+BOLD+"dire wolf"+NORM+" stops fighting.\n");
      return 1;
    }
  }
  ...
  if(str2 == "corpse")
  {
    ...
    if(TO->query_hp() > 100)
    {
      write("The "+BOLD+"dire wolf"+NORM+" pants: I'm healthy.\n");
      return 1;
    }
    ...
    destruct(obj);
    say("The "+BOLD+"dire wolf"+NORM+" excitedly jumps on the "+
  ...
  if(str == "protect me")
  {
    ...
    {
      wolf_protecting = 0;
      write("The dire wolf's protection mode is now "+HIR+"OFF"+NORM+".\n");
      return 1;
    }
    else
    {
      wolf_protecting = 1;
      write("The dire wolf's protection mode is now "+HIR+"ON"+NORM+".\n");
      return 1;
    }
  }
}
...
follow(str)
{
  ...
  if(master)
    ...
    {
      tell_room(environment(TO), "The " + BOLD + "dire wolf" + NORM +
                " lopes away after " + capitalize(master_name) + ".\n");
      move_object(TO, environment(master));
      tell_room(environment(master), "A " + BOLD + "dire wolf" + NORM +
...
short()
{
  if(!this_player()) return "A large dire wolf";
  if(TPRN == master_name)
  if(wolf_name)
    return capitalize(master_name)+"'s "+BOLD+"dire wolf"+NORM+" named '"+
           capitalize(wolf_name)+"'";
  else
    return capitalize(master_name)+"'s "+BOLD+"dire wolf"+NORM;
  else
    return "A large dire wolf";
}
...
long()
{
  ...
  str2 = "wolf";
  if(wolf_name)
    str2 = capitalize(master_name)+"'s "+BOLD+"dire wolf"+NORM+" named '"+
             wolf_name+"'";
  else
    str2 = capitalize(master_name)+"'s dire wolf";
  return 1;
}
...
summon_wolf()
{
  tell_room(environment(this_object()),
           "The "+BOLD+"dire wolf's"+NORM+" ears stand up for a second.  He scrambles to his feet\n"+
           "and lopes away.\n");
  wait_here = 0;
  follow();
  return 1;
