...
long() { write(
  "This is the "+HIR+"Eurale's Bulletin Board"+NORM+".\n"+
  "Only Eurale can write or remove notes but all should read them.\n"+
...
short() { return HIR+"Eurale's Bulletin Board"+NORM; }
...
*/
    new_hd = new_hd+"("+extract(ctime(time()),4,9)+", 2006)";
/*
  new_hd = new_hd+"("+this_player()->query_real_name()+", "+
