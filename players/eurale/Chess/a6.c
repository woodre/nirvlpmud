...
East() {
  TP->move_player("into the mist#players/eurale/Chess/b6.c");
  return 1; }

North() {
  TP->move_player("into the mist#players/eurale/Chess/a5.c");
  return 1; }

South() {
  TP->move_player("into the mist#players/eurale/Chess/a7.c");
  return 1; }
