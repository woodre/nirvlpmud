...
East() {
  TP->move_player("into the mist#players/eurale/Chess/f5.c");
  return 1; }

West() {
  TP->move_player("into the mist#players/eurale/Chess/d5.c");
  return 1; }

North() {
  TP->move_player("into the mist#players/eurale/Chess/e4.c");
  return 1; }

South() {
  TP->move_player("into the mist#players/eurale/Chess/e6.c");
  return 1; }
