...
West() {
  TP->move_player("into the mist#players/eurale/Chess/a3.c");
  return 1; }

North() {
  TP->move_player("into the mist#players/eurale/Chess/b2.c");
  return 1; }

South() {
  TP->move_player("into the mist#players/eurale/Chess/b4.c");
  return 1; }
