...
West() {
  TP->move_player("into the mist#players/eurale/Chess/g4.c");
  return 1; }

North() {
  TP->move_player("into the mist#players/eurale/Chess/h3.c");
  return 1; }

South() {
  TP->move_player("into the mist#players/eurale/Chess/h5.c");
  return 1; }
