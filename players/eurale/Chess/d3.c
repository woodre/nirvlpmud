...
reset(arg) {
  if(arg) return;
if(!present("pawn")) {
  move_object(clone_object("players/eurale/Chess/NPC/w_pawn"),TO); }
set_light(0);
...
East() {
  TP->move_player("into the mist#players/eurale/Chess/e3.c");
  return 1; }

West() {
  TP->move_player("into the mist#players/eurale/Chess/c3.c");
  return 1; }

North() {
  TP->move_player("into the mist#players/eurale/Chess/d2.c");
  return 1; }

South() {
  TP->move_player("into the mist#players/eurale/Chess/d4.c");
  return 1; }
