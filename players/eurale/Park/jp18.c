...
dest_dir = ({
	"players/eurale/Park/jp8.c","north",
	"players/eurale/Park/jp9.c","northeast",
	"players/eurale/Park/jp19.c","east",
	"players/eurale/Park/jp29.c","southeast",
	"players/eurale/Park/jp28.c","south",
	"players/eurale/Park/jp27.c","southwest",
	"players/eurale/Park/jp17.c","west",
	"players/eurale/Park/jp7.c","northwest",
});
