/*  Altered path to clone raptors to NPC dir - 10/04/06 - Rumplemintz  */
/*  Jurassic Park  */
...
if(!present("raptor 1")) {
move_object(clone_object("players/eurale/Park/NPC/raptor1.c"),
	this_object()); }
if(!present("raptor 2")) {
move_object(clone_object("players/eurale/Park/NPC/raptor2.c"),
	this_object()); }
...
dest_dir = ({
	"players/eurale/Park/jp32.c","north",
	"players/eurale/Park/jp33.c","northeast",
	"players/eurale/Park/jp51.c","southwest",
	"players/eurale/Park/jp41.c","west",
	"players/eurale/Park/jp31.c","northwest",
});
