...
long_desc =
	...
	"A small painted arrow, partially hidden sits just off the path.\n";

items = ({
	"arrow","An 'Exit' arrow pointing west",
...
dest_dir = ({
	"players/eurale/Park/jp4.c","east",
	"players/eurale/Park/jp2.c","west",
});
