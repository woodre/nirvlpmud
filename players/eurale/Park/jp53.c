...
long_desc =
	...
	"There is a small sign stuck in the ground beside the path.\n";

items = ({
	"sign","An 'Exit' sign pointing south",
...
dest_dir = ({
	"players/eurale/Park/jp43.c","north",
	"players/eurale/Park/jp63.c","south",
	"players/eurale/Park/jp52.c","west",
});
