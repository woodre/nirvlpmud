...
dest_dir = ({
	"players/eurale/Park/jp7.c","north",
	"players/eurale/Park/jp8.c","northeast",
	"players/eurale/Park/jp18.c","east",
	"players/eurale/Park/jp28.c","southeast",
	"players/eurale/Park/jp27.c","south",
	"players/eurale/Park/jp26.c","southwest",
	"players/eurale/Park/jp16.c","west",
	"players/eurale/Park/jp6.c","northwest",
});
