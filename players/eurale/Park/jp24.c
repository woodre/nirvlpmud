...
dest_dir = ({
	"players/eurale/Park/jp14.c","north",
	"players/eurale/Park/jp15.c","northeast",
	"players/eurale/Park/jp33.c","southwest",
	"players/eurale/Park/jp23.c","west",
	"players/eurale/Park/jp13.c","northwest",
});
