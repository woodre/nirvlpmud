...
move_object(clone_object("players/eurale/Park/mess86.c"),
	this_object()); }
...
dest_dir = ({
	"players/eurale/Park/jp76.c","north",
	"players/eurale/Park/jp77.c","northeast",
	"players/eurale/Park/jp87.c","east",
	"players/eurale/Park/jp97.c","southeast",
	"players/eurale/Park/jp96.c","south",
	"players/eurale/Park/jp95.c","southwest",
	"players/eurale/Park/jp85.c","west",
	"players/eurale/Park/jp75.c","northwest",
});
