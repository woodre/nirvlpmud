...
long_desc =
	...
	"the sound of huge animals all round you.  The ground is soft \n"+
...
dest_dir = ({
	"players/eurale/Park/jp10.c","north",
	"players/eurale/Park/jp30.c","south",
	"players/eurale/Park/jp29.c","southwest",
	"players/eurale/Park/jp19.c","west",
	"players/eurale/Park/jp9.c","northwest",
});
