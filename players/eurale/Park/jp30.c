...
long_desc =
	...
	"the sound of huge animals all around you.  The ground is soft \n"+
	"like it was covered with water recently.\n";
...
dest_dir = ({
	"players/eurale/Park/jp20.c","north",
	"players/eurale/Park/jp40.c","south",
	"players/eurale/Park/jp39.c","southwest",
	"players/eurale/Park/jp29.c","west",
	"players/eurale/Park/jp19.c","northwest",
});
