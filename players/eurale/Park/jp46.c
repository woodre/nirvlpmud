...
long_desc =
	...
	"the south makes passage that way nearly impossible.  The under-\n"+
	"brush is so thick, one would have to search for a trail down as \n"+
...
dest_dir = ({
	"players/eurale/Park/jp36.c","north",
	"players/eurale/Park/jp45.c","west",
});
...
search(str) {
  ...
  this_player()->move_player("search#players/eurale/Valley/v31.c");
  return 1; }
}
