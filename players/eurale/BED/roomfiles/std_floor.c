...
long_desc = 
  ...
  "  Carved wooden archways line the entrance of each guest room. Along\n"+
  "the hallway, soft glowing globes of yellow_orange emite a pleasant\n"+
  "light.  To inquire about room exits, type 'enter'.\n";
     }
  }
