...
move_object(clone_object("players/eurale/Maze/mess14.c"),this_object()); }
...
dest_dir = ({
	"/players/eurale/Maze/tun13.c","north",
	"/players/eurale/Maze/tun15.c","south",
	"/players/eurale/Maze/tun7.c","east",
	"/players/eurale/Maze/tun11.c","west",
});
