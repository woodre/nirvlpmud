...
dest_dir = ({
	"players/eurale/Valley/v14.c","east",
	"players/eurale/Valley/v29.c","southeast",
	"players/eurale/Valley/v28.c","south",
	"players/eurale/Valley/v27.c","southwest",
	"players/eurale/Valley/v12.c","west",
});
