...
dest_dir = ({
	"players/eurale/Valley/v29.c","east",
	"players/eurale/Valley/v14.c","northeast",
	"players/eurale/Valley/v13.c","north",
	"players/eurale/Valley/v12.c","northwest",
	"players/eurale/Valley/v27.c","west",
});
