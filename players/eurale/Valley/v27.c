...
dest_dir = ({
	"players/eurale/Valley/v28.c","east",
	"players/eurale/Valley/v13.c","northeast",
	"players/eurale/Valley/v12.c","north",
	"players/eurale/Valley/v11.c","northwest",
	"players/eurale/Valley/v26.c","west",
});
