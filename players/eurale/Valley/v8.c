...
dest_dir = ({
	"players/eurale/Valley/v9.c","east",
	"players/eurale/Valley/v24.c","southeast",
	"players/eurale/Valley/v23.c","south",
	"players/eurale/Valley/v22.c","southwest",
	"players/eurale/Valley/v7.c","west",
});
