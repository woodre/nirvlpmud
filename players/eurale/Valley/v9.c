...
dest_dir = ({
	"players/eurale/Valley/v10.c","east",
	"players/eurale/Valley/v25.c","southeast",
	"players/eurale/Valley/v24.c","south",
	"players/eurale/Valley/v23.c","southwest",
	"players/eurale/Valley/v8.c","west",
});
