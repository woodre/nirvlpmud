...
dest_dir = ({
	"players/eurale/Valley/v26.c","east",
	"players/eurale/Valley/v11.c","northeast",
	"players/eurale/Valley/v10.c","north",
	"players/eurale/Valley/v9.c","northwest",
	"players/eurale/Valley/v24.c","west",
});
