...
dest_dir = ({
	"players/eurale/Valley/v22.c","east",
	"players/eurale/Valley/v7.c","northeast",
	"players/eurale/Valley/v6.c","north",
	"players/eurale/Valley/v5.c","northwest",
	"players/eurale/Valley/v20.c","west",
});
