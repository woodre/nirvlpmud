...
dest_dir = ({
	"players/eurale/Valley/v2.c","west",
	"players/eurale/Valley/v19.c","southeast",
	"players/eurale/Valley/v18.c","south",
	"players/eurale/Valley/v17.c","southwest",
});
