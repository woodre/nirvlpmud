...
long_desc =
	...
	"floor.  There is a huge boulder to the northwest that you might be \n"+
	"be able to climb.\n";
...
dest_dir = ({
	"players/eurale/Valley/v21.c","east",
	"players/eurale/Valley/v6.c","northeast",
	"players/eurale/Valley/v5.c","north",
	"players/eurale/Valley/v19.c","west",
});
