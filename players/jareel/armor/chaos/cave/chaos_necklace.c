...
#define NAME HIK+"Dark "+NORM+RED+"Cha"+HIR+"os "+HIK+"Necklace"+NORM
...
status id(string arg) { return ( ::id(arg) || arg == "chaos_necklace" || arg == "necklace" || arg == "pentical" || arg == "chaos necklace"); }
