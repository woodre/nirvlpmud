...
#define NAME HIK+"Dark "+NORM+RED+"Cha"+HIR+"os "+HIK+"Shorts"+NORM
...
status id(string arg) { return ( ::id(arg) || arg == "chaos_underwear" || arg == "underwear" || arg == "under" || arg == "chaos underwear"); }
