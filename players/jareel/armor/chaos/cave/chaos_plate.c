/*
 *      File:                   /players/jareel/armor/chaos/woods2/chaos_plate.c
 ...
 *      Source:                 8/11/06
 *      Approved by:            
 *      Notes:                  This is the Main armor for the Chaos set
 *      Properties:             Physical 4,10.,0
 *      Full Set:               The armor as a full set adds nothing
 *      Full Forged Set:        This piece adds 
 *                                   Physical 4.11.0
 *                                   light    0.-100.0
 *                                              
 *      Change History:
...
#define NAME HIK+"Dark "+NORM+RED+"Cha"+HIR+"os "+HIK+"Plate"+NORM
...
status id(string arg) { return ( ::id(arg) || arg == "chaos_armor" || arg == "armor" || arg == "plate" || arg == "chaos plate"); }
