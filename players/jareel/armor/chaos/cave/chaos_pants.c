...
#define NAME HIK+"Dark "+NORM+RED+"Cha"+HIR+"os "+HIK+"Vambraces"+NORM
...
status id(string arg) { return ( ::id(arg) || arg == "chaos_pants" || arg == "vambraces" || arg == "pants" || arg == "chaos vambraces"); }
