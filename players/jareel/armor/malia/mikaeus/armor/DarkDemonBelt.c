...
reset(int arg) {
  ...
  set_alias("tail");
  set_short(HIK+"Demonic "+HIK+"T"+HIB+"a"+HIK+"I"+HIB+"l "+HIK+"of the Cacodemon"+NORM+" ["+RED+"Demon Fire"+NORM+HIK+"] ["+SETNAME+"]"); 
  set_long(
...
status id(string arg) { return ( ::id(arg) || arg == "BelyOfTheDeathWalker" || arg == "misc of the deathwalker"); }
...
string short() {
  ...
  if (check_full_set())
    return (HIK+"Demonic "+HIK+"T"+HIB+"a"+HIK+"I"+HIB+"l "+HIK+"of the Cacodemon"+NORM+" ["+RED+"Demon Fire"+NORM+HIK+"] ["+FULLSETNAME+"]"+NORM+" (worn)"+NORM);

  if ((status)this_object()->query_worn())
    return(HIK+"Demonic "+HIK+"T"+HIB+"a"+HIK+"I"+HIB+"l "+HIK+"of the Cacodemon"+NORM+" ["+RED+"Demon Fire"+NORM+HIK+"] ["+SETNAME+"]"+NORM+" (worn)"+NORM);

  return HIK+"Demonic "+HIK+"T"+HIB+"a"+HIK+"I"+HIB+"l "+HIK+"of the Cacodemon"+NORM+" ["+RED+"Demon Fire"+NORM+HIK+"] ["+SETNAME+"]"+NORM+""+NORM+NORM;
}
