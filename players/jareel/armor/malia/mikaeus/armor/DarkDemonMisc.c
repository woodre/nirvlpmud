...
reset(int arg) {
  ...
  set_weight(1);
  set_type("misc");
  set_name("demonic tendrils of the death walker");
  set_alias("plate");
  set_short(HIK+"Demonic "+HIK+"T"+HIB+"e"+HIK+"N"+HIB+"d"+HIK+"R"+HIB+"i"+HIK+"L"+HIB+"s "+HIK+"of the Sembraki"+NORM+" ["+RED+"Demon Fire"+NORM+HIK+"] ["+SETNAME+"]"); 
  set_long(
  ...
  Armor_pieces = ({ "MiscOfTheDeathWalker", "BraceletOfDarkness", "MiscOfDarkness", "GuardOfDarkNess" });
     }

status id(string arg) { return ( ::id(arg) || arg == "PlateOfTheUnderworld" || arg == "misc of the deathwalker"); }
...
string short() {
  ...
  if (check_full_set())
    return (HIK+"Demonic "+HIK+"T"+HIB+"e"+HIK+"N"+HIB+"d"+HIK+"R"+HIB+"i"+HIK+"L"+HIB+"s "+HIK+"of the Sembraki"+NORM+" ["+RED+"Demon Fire"+NORM+HIK+"] ["+FULLSETNAME+"]"+NORM+" (worn)"+NORM);

  if ((status)this_object()->query_worn())
    return(HIK+"Demonic "+HIK+"T"+HIB+"e"+HIK+"N"+HIB+"d"+HIK+"R"+HIB+"i"+HIK+"L"+HIB+"s "+HIK+"of the Sembraki"+NORM+" ["+RED+"Demon Fire"+NORM+HIK+"] ["+SETNAME+"]"+NORM+" (worn)"+NORM);

  return HIK+"Demonic "+HIK+"T"+HIB+"e"+HIK+"N"+HIB+"d"+HIK+"R"+HIB+"i"+HIK+"L"+HIB+"s "+HIK+"of the Sembraki"+NORM+" ["+RED+"Demon Fire"+NORM+HIK+"] ["+SETNAME+"]"+NORM+""+NORM+NORM;
}
