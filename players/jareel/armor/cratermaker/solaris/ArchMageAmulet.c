...
string query_short() {
  if( check_full_set() )
    return HIR+"Blood Amulet"+NORM+" of "+HIK+"["+HIW+"Power"+NORM+HIK+"]"+NORM+BOLD+" ("+NORM+HIG+"Set of Power"+NORM+BOLD+")"+NORM;
  else
    return HIR+"Blood Amulet"+NORM+" of "+HIK+"["+HIW+"Power"+NORM+HIK+"]"+NORM;
}
