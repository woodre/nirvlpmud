...
string *Armor_pieces;
     ...
     set_name("boots of the dead");
     set_ac(0);
     set_value(4200);
     set_weight(1);
     set_type("boots");
     set_short(HIK+"Dark Boots"+NORM+" of the "+HIK+"["+HIW+"Dead"+NORM+HIK+"]"+NORM);
     set_long(
...
status id(string arg) { return ( ::id(arg) || arg == "ArchMageBoots" || arg == "necro boots"); }
...
string short() {
  ...
  if (check_full_set())
    return (HIK+"Dark Boots"+NORM+" of the "+HIK+"["+HIW+"Dead"+NORM+HIK+"]"+NORM+BOLD+" ("+NORM+HIG+"Set of the Necromancer"+NORM+BOLD+")"+NORM+" (worn)"+NORM);

  if ((status)this_object()->query_worn())
    return(HIK+"Dark Boots"+NORM+" of the "+HIK+"["+HIW+"Dead"+NORM+HIK+"]"+NORM+NORM+" (worn)");

  return HIK+"Dark Boots"+NORM+" of the "+HIK+"["+HIW+"Dead"+NORM+HIK+"]"+NORM+NORM;
}
#endif
...
string query_short() {
  ...
  if (check_full_set())
    return HIK+"Dark Boots"+NORM+" of the "+HIK+"["+HIW+"Dead"+NORM+HIK+"]"+NORM+BOLD+" ("+NORM+HIG+"Set of the Necromancer"+NORM+BOLD+")"+NORM;
  else
    return HIK+"Dark Boots"+NORM+" of the "+HIK+"["+HIW+"Dead"+NORM+HIK+"]"+NORM;
}
...
do_special(owner) {
  ...
  while(i--) {
    ...
    set_params("physical",0,0,"heal3up");
}
