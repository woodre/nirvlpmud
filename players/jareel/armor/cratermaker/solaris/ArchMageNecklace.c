...
string query_short() {
  ...
  if (check_full_set())
    return YEL+"Golden"+NORM+" Necklace of the "+RED+"Red Goddess"+NORM+BOLD+" ("+NORM+HIG+"Set of the Caster"+NORM+BOLD+")"+NORM;
  else
    return YEL+"Golden"+NORM+" Necklace of the "+RED+"Red Goddess"+NORM;
}
