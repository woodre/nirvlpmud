...
string *Armor_pieces;
     ...
     set_long(
       RED+"              ["+HIG+"Set of the Dead"+NORM+RED+"]\n"+
...
string query_short() {
  ...
  if (check_full_set())
    return HIK+"Dark Ring"+NORM+" of the "+HIK+"["+HIW+"Dead"+NORM+HIK+"]"+NORM+BOLD+" ("+NORM+HIG+"Set of the Necromancer"+NORM+BOLD+")"+NORM;
  else
    return HIK+"Dark Ring"+NORM+" of the "+HIK+"["+HIW+"Dead"+NORM+HIK+"]"+NORM+HIK+"]"+NORM;
}
