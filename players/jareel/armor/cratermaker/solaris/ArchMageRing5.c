...
string *Armor_pieces;
     ...
     set_weight(1);
     set_type("ring");
     set_short(HIW+"Platinum Ring"+NORM+" of "+HIK+"["+HIW+"Evocation"+NORM+HIK+"]"+NORM);
     set_long(
       RED+"              \n"+
...
status id(string arg) { return ( ::id(arg) || arg == "ArchMageRing5" || arg == "blah"); }
...
string short() {
  ...
  if (check_full_set())
    return (HIW+"Platinum Ring"+NORM+" of "+HIK+"["+HIW+"Evocation"+NORM+HIK+"]"+NORM+BOLD+" ("+NORM+HIG+"Set of Illusion"+NORM+BOLD+")"+NORM+" (worn)"+NORM);

  if ((status)this_object()->query_worn())
    return(HIW+"Platinum Ring"+NORM+" of "+HIK+"["+HIW+"Evocation"+NORM+HIK+"]"+NORM+NORM+" (worn)");

  return HIW+"Platinum Ring"+NORM+" of "+HIK+"["+HIW+"Evocation"+NORM+HIK+"]"+NORM+HIK+"]"+NORM+NORM;
}
#endif
...
string query_short() {
  ...
  if (check_full_set())
    return HIW+"Platinum Ring"+NORM+" of "+HIK+"["+HIW+"Evocation"+NORM+HIK+"]"+NORM+BOLD+" ("+NORM+HIG+"Set of Illusion"+NORM+BOLD+")"+NORM;
  else
    return HIW+"Platinum Ring"+NORM+" of "+HIK+"["+HIW+"Evocation"+NORM+HIK+"]"+NORM+HIK+"]"+NORM;
}
