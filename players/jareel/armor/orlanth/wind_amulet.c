...
status id(string arg) { return ( ::id(arg) || arg == "wind_amulet" || arg == "amulet" || arg == "storm" || arg == "amulet of the coming storm"); }
...
do_special(owner) {
  ...
  tell_room(environment(USER),
   ""+BOLD+" <"+BLU+"<>"+NORM+BOLD+">"+BLU+" Swirling wind surounds "+environment()->query_name()+"'s body "+BOLD+" <"+BLU+"<>"+NORM+BOLD+">\n"+NORM);
  return 100;
}
