...
string short() {
  ...
  if (check_full_set() && check_wielded() )
    set_short(RED+"Berserker Axe Roar"+HIK+"["+HIC+" Chaos Honed "+HIK+"]"+NORM+" ["+FULLSETNAME+"]"+NORM);
  else
    set_short(RED+"Berserker Axe Roar"+HIK+"["+HIC+" Chaos Honed "+HIK+"]"+NORM+" ["+SETNAME+"]"+NORM+""+NORM);
  return (string) ::short();
}
