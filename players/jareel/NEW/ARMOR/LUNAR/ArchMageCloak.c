...
string *Armor_pieces;
     ...
     set_long(
       ...
       "pulsates within the chests core crystal.  A thick gold chain the cloak to be worn on the\n"+
       "persons neck.  This does not look like it would provide much protection\n");
