...
string *Armor_pieces;
     ...
     set_long(
       ...
       "pulsates within the Earring core crystal.  A gold hoop allows the Earring to be worn in\n"+
       "a persons ear.  This does not look like it would provide much protection\n");
