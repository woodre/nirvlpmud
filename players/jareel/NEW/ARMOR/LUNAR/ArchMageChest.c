...
string *Armor_pieces;
     ...
     set_long(
       ...
       "pulsates within the chests core crystal.  A thick gold allows the chests to be worn over the\n"+
       "persons shoulder.  This does not look like it would provide much protection\n");
