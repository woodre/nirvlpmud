...
string *Armor_pieces;
     ...
     set_long(
       ...
       "pulsates within the chests core crystal.  A thick gold allows the bracer to be worn on the\n"+
       "persons wrist.  This does not look like it would provide much protection\n");
