...
string *Armor_pieces;
     ...
     set_long(
       ...
       "A swirling black and white crystal encrusted in a soft silver polished metal.  Raw energy\n"+
       "pulsates within the belts crystal buckle.  A thick black leather cord allows the belt to \n"+
       "be worn around a persons waist.  This does not look like it would provide much protection\n");
