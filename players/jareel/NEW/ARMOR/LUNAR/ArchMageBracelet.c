...
string *Armor_pieces;
     ...
     set_long(
       ...
       "pulsates within the bracelets core crystal.  A thick gold chain allows the bracelets to be worn\n"+
       "a persons wrist.  This does not look like it would provide much protection\n");
