...
s_mess(){
 ...
 m = random(6);
  switch(k){
   case 0..2: mess = "A voice whispers to you:   "+HIR+"K I L L"; break;
...
f_youwiz()
{
    ...
    if(manager == "jareel" || manager == "pestilence" || manager == "vertebraker" || manager == "wicket"  || manager == "forbin")
         return 0;
