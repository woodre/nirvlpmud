...
return str == "generic_wc_bonus"|| str == "dknight_ob"  ||  str == "no_spell"  ||  str == "dark aura" || str == "aura" || str == "notarmor"  || str == "pro_object"  || str == "dark_sight_object"  || str == "no_mini"  || str == "pesty_guild" || str == "party_object"; }
else
*/
  if(!test_my_wear(previous_object())) {
return str == "generic_wc_bonus"|| str == "GI" || str == "dknight_ob"  ||  str == "no_spell"  ||  str == "dark aura" || str == "aura" || str == "notarmor" || str == "pro_object"  || str == "dark_sight_object"  || str == "no_mini"  || str == "party_object" ||  str == "pesty_guild"; }

}
return str == "generic_wc_bonus"|| str == "GI" || str == "dknight_ob"  ||  str == "no_spell"  ||  str == "dark aura" || str == "aura" || str == "pro_object"  || str == "dark_sight_object"  || str == "no_mini"  || str == "party_object"||  str == "pesty_guild"; }
