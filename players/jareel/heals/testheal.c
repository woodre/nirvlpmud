...
#define TAB BOLD+"Large Dosage Injector Tab (UM)"+OFF

int shots, price;
id(str) { return str == "ultramorph" || str == "UM" || str == "tab" || str == "ltab" || str == "UltraMorph" || str == "injector tab"; }
  ...
  inject_um(arg){
    ...
    if(!TP->drink_alcohol(14)) return 1;
  else{
    if(arg == "um" || arg == "UM") {
  shots--;
    TP->heal_self(50);
