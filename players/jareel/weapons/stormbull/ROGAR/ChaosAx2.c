...
#define  F11 HIY+" *     *     *     *     *     *     *     *     *     *     *     *"+NORM
#define  F12 HIY+"  *   *    *   *   *   *   *   *   *   *   *   *   *   *   *    *   *  *"+NORM
#define  F13 HIY+"*   *    *   *   * "+HIW+"R I G H T E O U S  F U R Y"+HIY+"   *   *   *   *   *   *"+NORM
...
F13+"\n");
    ...
    attacker->do_damage( ({ 10+random(10), 10+random(10) }), ({ "other|light", "other|good" }) );
/*
    attacker->hit_player(20+random(20), "other|good");
*/
 /* Only affects Specific Mobs in My area sword is designed to light up to kill these mobs */
  return 1; return 1;
   }
}
