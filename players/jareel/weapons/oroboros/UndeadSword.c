...
reset(arg) {
  ::reset(arg);
    ...
    set_short("Night"+BOLD+"fall"+NORM);
    set_long(
"Night"+BOLD+"fall"+NORM+" has been crafted by Graum, with ore extracted from deep within the Dark Tunnels.\n"+
"The alabaster hue of the steel edge has been forged in dragon's flame, to create a keen razor\n"+
...
"A twirling 'Undead' glyph is engraved upon the guard, hilt and scabbard each being a different\n"+
"hue. A alabaster pearl ruby rests in the pommel surrounded by four ribs giving the impression of a\n"+
"dragon's claw clutching it.  Night"+BOLD+"fall"+NORM+" is capable of cutting through magical Undead wards and \n"+ 
"Undead beings.  The faint alabaster hue flows from the hilt over the razor-sharp blade absorbing\n"+
