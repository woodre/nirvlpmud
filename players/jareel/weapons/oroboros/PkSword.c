...
reset(arg) {
  ::reset(arg);
    ...
    set_short(BOLD+"Heart"+BLK+"eater"+NORM);
    set_long(
BOLD+"Heart"+BOLD+"eater"+NORM+" has been crafted by Graum, with ore extracted from deep within the Dark Tunnels.\n"+
"The "+BLK+"black"+NORM+" hue of the steel edge has been forged in dragon's flame, to create a keen razor\n"+
...
"A twirling 'Man' glyph is engraved upon the guard, hilt and scabbard each being a different\n"+
"hue. A dark "+BLK+"black onyx"+NORM+" rests in the pommel surrounded by four ribs giving the impression of a\n"+
"dragon's claw clutching it.  "+BOLD+"Heart"+BLK+"eater"+NORM+" is capable of cutting through illusions others can not and\n"+
"other interactive beings.  The faint "+BLK+"shadowy"+NORM+" hue flows from the hilt over the razor-sharp blade\n"+
"absorbing the surrounding lighting with its strange mystical gleaming power.\n");
