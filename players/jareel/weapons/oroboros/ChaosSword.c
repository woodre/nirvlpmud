...
RED+"Black"+BOLD+"fyre"+NORM);
       
	   set_long(

	   RED+"Black"+BOLD+"fyre"+NORM+" has been crafted by Graum, with ore extracted from deep within the Dark Tunnels.\n"+
"The "+RED+"crimson"+NORM+" hue of the steel edge has been forged in dragon's flame, to create a keen razor\n"+
...
"hue. A blood red "+RED+"ruby"+NORM+" rests in the pommel surrounded by four ribs giving the impression of a\n"+
"dragon's claw clutching it.  "+RED+"Black"+BOLD+"fyre"+NORM+" is capable of cutting through magical Demon wards and \n"+ 
"Chaotic beings.  The faint "+RED+"crimson"+NORM+" hue flows from the hilt over the razor-sharp blade absorbing\n"+
