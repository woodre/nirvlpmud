...
reset(arg) {
  ::reset(arg);
    ...
    set_short(BLU+"Widow's"+BOLD+" Wail"+NORM);
    set_long(
BLU+"Widow's"+BOLD+" Wail"+NORM+" has been crafted by Graum, with ore extracted from deep within the Dark Tunnels.\n"+
"The "+BLU+"sapphire"+NORM+" hue of the steel edge has been forged in dragon's flame, to create a keen razor\n"+
...
"A twirling 'Spirit' glyph is engraved upon the guard, hilt and scabbard each being a different\n"+
"hue. A rich "+BLU+"blue sapphire"+NORM+" rests in the pommel surrounded by four ribs giving the impression of a\n"+
"dragon's claw clutching it.  "+BLU+"Widow's"+BOLD+" Wail"+NORM+" is capable of cutting through magical Spirit wards and \n"+ 
"Spiritual beings.  The faint "+BLU+"blue"+NORM+" hue flows from the hilt over the razor-sharp blade absorbing\n"+
