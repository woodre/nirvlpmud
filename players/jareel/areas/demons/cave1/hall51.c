...
[Hall 51], North [hall 41], South [hall 60]
...
void reset(int arg) {
  ...
  set_light(-10);
  short_desc = HIK+"The Demon Chamber ["+NORM+HIK+"Demon Coridor"+HIK+"]"+NORM;
  long_desc=
    ...
    HIK+"@"+HIY+"*"+HIW+"------|"+HIK+"@"+HIW+"X"+HIK+"@"+HIW+"|------"+HIY+"*"+HIK+"@"+NORM+NORM+DESCD->get_long_desc(5)+
