...
reset(arg) {
	...
	""+GRN+"##"+NORM+"|R"+BBLU+HIB+"www"+NORM+"R"+BBLU+HIB+"ww"+NORM+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"     with a moisture covering the rocks.  Big, tall puffy\n"+
	...
	dest_dir = ({
			"/players/jareel/areas/duck_pond/road4.c","east",
                        "/players/jareel/areas/duck_pond/road2.c","west",			
