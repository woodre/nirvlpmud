...
reset(arg) {
	...
	""+GRN+"##"+NORM+"|-----"+YEL+"B"+NORM+"-"+BOLD+"X"+NORM+"---"+GRN+"#"+NORM+"     Dancing light reflects over the ripping water of the\n"+
	...
	dest_dir = ({
			"/players/jareel/areas/duck_pond/road8.c","west",
                        "/players/jareel/areas/duck_pond/road10.c","east",			
