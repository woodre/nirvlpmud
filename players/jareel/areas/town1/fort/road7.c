...
#define l5 "  fortress walls keeping the enemy's out."
  ...
  long_desc=
    ...
    "--+"+HIY+"Y"+NORM+"X"+RED+"A"+BYEL+"%"+NORM+l3+"\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/town1/fort/road3","south",
    "/players/jareel/areas/town1/fort/road10","north",
    "/players/jareel/areas/town1/fort/yelm","west",
    "/players/jareel/areas/town1/fort/alchemist","east",
  });
