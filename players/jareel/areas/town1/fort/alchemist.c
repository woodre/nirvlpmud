/*                                                                   
*    File:              /players/jareel/areas/town1/fort/alchemist.c                                   
*    Author(s):         Jareel                            
*    Change History:    corrected many grammar errors / Added sign.c    
*                       Angel 07-21-09                                          
*                       changed to Alchemist in many files
*                       Rumplemintz 11-04-2009
*/
...
reset(arg) {
   if(!present("alchemist"))  {
      move_object(clone_object("/players/jareel/monsters/YELMALIAN/alchemist"), this_object());
   }
   if(!present("sign"))  {
      move_object(clone_object("/players/jareel/general_stuff/alc_shop_sign"), this_object());
   }
   if(!present("notice"))  {
      move_object(clone_object("/players/jareel/areas/town1/fort/sign"), this_object());
   }
   if(arg) return;
