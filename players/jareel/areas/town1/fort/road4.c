...
#define l4 "  Shops and housing line the reienforced "
#define l5 "  fortress walls keeping the enemy's out."
  ...
  set_light(3);
  short_desc=(YEL+"Yelmalian Fort"+NORM);
  long_desc=
  ...
  dest_dir = ({
    "/players/jareel/areas/town1/fort/road5","east",
    "/players/jareel/areas/entrance/road7","west",
  });
