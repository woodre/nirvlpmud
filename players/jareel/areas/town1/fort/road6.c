...
#define l5 "  fortress walls keeping the enemy's out."
  ...
  long_desc=
    ...
    "--X"+HIY+"Y"+NORM+"+"+RED+"A"+BYEL+"%"+NORM+l3+"\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/town1/fort/road1","south",
    "/players/jareel/areas/town1/fort/road8","north",
    "/players/jareel/areas/town1/fort/yelm","east",
    "/players/jareel/areas/town1/fort/road5","west",
  });
