...
#define l4 "  Shop and housing line the reinforced "
#define l5 "  fortress walls keeping the enemy's out."
  ...
  long_desc=
    ...
    BYEL+"%"+NORM+""+CYN+"Q"+NORM+"--X"+BOLD+"T"+NORM+BYEL+"%"+NORM+l4+"\n"+
    BYEL+"%%%%%%%"+NORM+l5+"\n";
  ...
  dest_dir = ({
    "/players/jareel/areas/town1/fort/road7","north",
    "/players/jareel/areas/town1/fort/trainer","east",
    "/players/jareel/areas/town1/fort/road2","west",
  });
