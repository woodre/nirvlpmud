...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid8/for8","north",
     "/players/jareel/areas/chaos/grid8/for3","south",
     "/players/jareel/areas/chaos/grid8/for5","east",
});
}
