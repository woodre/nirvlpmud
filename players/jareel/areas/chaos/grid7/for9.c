...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid7/for8","west",
     "/players/jareel/areas/chaos/grid7/for10","east",
});
}
...
SecretDoor(str) {
     if(str == "push" || "east" || "e") {  
       this_player()->move_player("pushes aside the trees#/players/jareel/areas/chaos/grid7/secdoor1.c");
       return 1;  
     } 
}