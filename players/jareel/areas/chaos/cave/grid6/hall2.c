...
reset(arg) {
	...
	""+NORM+"-|"+HIK+"@"+NORM+"|R"+NORM+LINE2+"   \n"+
	""+HIK+"@@"+NORM+"R"+HIK+"@@"+NORM+LINE3+"     \n"+
	"---"+HIK+"@@"+NORM+LINE4+"    \n"+
	""+HIK+"@@@@@"+NORM+LINE5+"\n"+
	"     "+LINE6+"\n"+
	"     "+LINE7+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid6/hall1.c","west",
			"/players/jareel/areas/chaos/cave/grid6/hall3.c","east",
