...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"--"+BOLD+"X"+HIK+"@"+NORM+LINE8+"    \n"+
	"-|"+HIK+"@"+NORM+"|R"+LINE9+"     \n"+
	""+HIK+"@@"+NORM+"R"+HIK+"@@"+NORM+LINE10+"    \n"+
	"---"+HIK+"@@"+NORM+LINE11+"     \n"+
	""+HIK+"@@@@@"+NORM+LINE12+"\n"+
	"     "+LINE13+"\n"+
	"     "+LINE14+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid6/hall2.c","west",
			"/players/jareel/areas/chaos/cave/grid6/hall6.c","south",
			"/players/jareel/areas/chaos/cave/grid5/hall12.c","north",
