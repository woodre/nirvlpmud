...
reset(arg) {
	...
	""+NORM+"-|"+HIK+"@"+NORM+"|R"+NORM+LINE34+"    \n"+
	""+HIK+"@@"+NORM+"R"+HIK+"@@"+NORM+LINE35+"    \n"+
	""+NORM+"---"+HIK+"@@"+NORM+LINE36+"     \n"+
	""+HIK+"@@@@@"+NORM+LINE37+"     \n"+
	"     "+LINE38+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid6/hall5.c","south",
			"/players/jareel/areas/chaos/cave/grid6/hall2.c","east",
