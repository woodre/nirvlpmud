...
reset(arg) {
	...
	""+NORM+"-|"+HIK+"@"+NORM+BOLD+"X"+NORM+"R"+NORM+LINE29+"     \n"+
	""+HIK+"@@"+NORM+"R"+HIK+"@@"+NORM+LINE30+"     \n"+
	""+NORM+"---"+HIK+"@@"+NORM+LINE31+"     \n"+
	""+HIK+"@@@@@"+NORM+LINE32+"     \n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid6/room1.c","east",
			"/players/jareel/areas/chaos/cave/grid6/hall3.c","north",
