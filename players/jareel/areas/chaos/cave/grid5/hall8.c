...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|--"+NORM+HIK+"@"+NORM+LINE28+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE29+"     \n"+
	""+HIK+"@"+NORM+"|R|"+BOLD+"X"+NORM+LINE30+"     \n"+
	"-|"+NORM+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE31+"     \n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE32+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid5/hall7.c","west",
			"/players/jareel/areas/chaos/cave/grid2/hall7.c","east",
