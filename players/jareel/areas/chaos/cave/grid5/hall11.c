...
reset(arg) {
	...
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE34+"    \n"+
	""+HIK+"@"+NORM+"|R|-"+LINE35+"     \n"+
	"-|"+HIK+"@"+NORM+BOLD+"X"+NORM+HIK+"@"+NORM+LINE36+"     \n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE37+"\n"+
	"     "+LINE38+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid5/hall7.c","north",
			"/players/jareel/areas/chaos/cave/grid5/hall12.c","south",
