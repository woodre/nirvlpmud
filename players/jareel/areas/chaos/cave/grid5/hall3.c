...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|-"+BOLD+"X"+NORM+HIK+"@"+NORM+LINE1+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE1+"   \n"+
	""+HIK+"@"+NORM+"|R|-"+LINE1+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid5/hall2.c","west",
			"/players/jareel/areas/chaos/cave/grid5/hall5.c","south",
