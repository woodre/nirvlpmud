...
#define LINE9 "   caverned walls entwuine in every direction. The path beneath"
...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|--"+HIK+"@"+NORM+LINE8+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE9+"   \n"+
	""+HIK+"@"+NORM+"|R|-"+LINE10+"     \n"+
	"-|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE11+"     \n"+
	""+HIK+"@@@"+NORM+BOLD+"X"+NORM+HIK+"@"+NORM+LINE12+"     \n"+
	"     "+LINE13+"\n"+
	"     "+LINE14+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid5/hall11.c","north",
			"/players/jareel/areas/chaos/cave/grid6/hall3.c","south",
