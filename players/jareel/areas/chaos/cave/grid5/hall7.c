...
reset(arg) {
	...
	""+HIK+"@"+NORM+"|R"+BOLD+"X"+NORM+LINE10+"-    \n"+
	"-|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE11+"     \n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE12+"    \n"+
	"     "+LINE13+"\n"+
	"     "+LINE14+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid5/hall5.c","north",
			"/players/jareel/areas/chaos/cave/grid5/hall11.c","south",
			"/players/jareel/areas/chaos/cave/grid5/hall8.c","east",
