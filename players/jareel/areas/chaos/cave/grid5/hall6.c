...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|--"+HIK+"@"+NORM+LINE15+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE16+"     \n"+
	""+HIK+"@"+NORM+BOLD+"X"+NORM+"R|-"+LINE17+"     \n"+
	"-|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE18+"     \n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE19+"\n"+
	"     "+LINE20+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid5/hall4.c","north",
			"/players/jareel/areas/chaos/cave/grid5/hall10.c","south",
			"/players/jareel/areas/chaos/cave/grid5/room1.c","east",
