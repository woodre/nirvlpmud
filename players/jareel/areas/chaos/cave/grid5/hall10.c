...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|--"+NORM+HIK+"@"+NORM+LINE21+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE22+"     \n"+
	""+HIK+"@"+NORM+"|R|-"+LINE23+"     \n"+
	"-"+BOLD+"X"+NORM+HIK+"@"+NORM+"|"+HIK+"@"+NORM+LINE24+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid5/hall9.c","west",
			"/players/jareel/areas/chaos/cave/grid5/hall6.c","north",
