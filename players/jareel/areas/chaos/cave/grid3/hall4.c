...
reset(arg) {
    ...
    long_desc=
      "\n"+
	  "|--R"+HIK+"@"+NORM+LINE21+"   \n"+
	  ""+HIK+"@@"+NORM+BOLD+"X"+HIK+"@@"+NORM+LINE22+"   \n"+
	  ""+HIK+"@@"+NORM+"|"+HIK+"@@"+NORM+LINE23+"   \n"+
	  ""+HIK+"@"+NORM+"R-R"+HIK+"@"+NORM+LINE24+"   \n"+
	  ""+HIK+"@@@@@"+NORM+LINE25+"   \n"+
	  "     "+LINE26+"\n"+
	  "     "+LINE27+"\n";
	...
	dest_dir = ({
			"/players/jareel/areas/chaos/cave/grid3/hall5.c","south",
			"/players/jareel/areas/chaos/cave/grid3/hall3.c","north",
