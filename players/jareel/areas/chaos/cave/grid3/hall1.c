...
long_desc=
"\n"+
""+BOLD+"X"+NORM+"-|R"+HIK+"@"+NORM+LINE1+"   \n"+
""+HIK+"@@"+NORM+"|"+HIK+"@@"+NORM+LINE2+"   \n"+
""+HIK+"@@"+NORM+"|"+HIK+"@@"+NORM+LINE3+"   \n"+
""+HIK+"@"+NORM+"R-R"+HIK+"@"+NORM+LINE4+"   \n"+
""+HIK+"@@@@@"+NORM+LINE5+"   \n"+
"     "+LINE6+"\n"+
"     "+LINE7+"\n";
...
"/players/jareel/areas/chaos/cave/grid3/hall2.c","east",
"/players/jareel/areas/chaos/cave/grid2/hall12.c","north",
