...
reset(arg) {
   ...
   long_desc=
	...
	""+HIK+"@"+NORM+"R"+BOLD+"X"+NORM+"R"+HIK+"@"+NORM+LINE36+"   \n"+
	""+HIK+"@@@@@"+NORM+LINE37+"   \n"+
	"     "+LINE38+"\n";
	...
	dest_dir = ({
			"/players/jareel/areas/chaos/cave/grid3/room3.c","west",
			"/players/jareel/areas/chaos/cave/grid3/room1.c","east",
			"/players/jareel/areas/chaos/cave/grid3/hall5.c","north",
