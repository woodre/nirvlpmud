...
long_desc=
"\n"+
"|"+BOLD+"X"+NORM+"|R"+HIK+"@"+NORM+LINE8+"   \n"+
""+HIK+"@@"+NORM+"|"+HIK+"@@"+NORM+LINE9+"   \n"+
""+HIK+"@@"+NORM+"|"+HIK+"@@"+NORM+LINE10+"   \n"+
""+HIK+"@"+NORM+"R-R"+HIK+"@"+NORM+LINE11+"   \n"+
""+HIK+"@@@@@"+NORM+LINE12+"   \n"+
"     "+LINE13+"\n"+
"     "+LINE14+"\n";
...
"/players/jareel/areas/chaos/cave/grid3/hall3.c","east",
"/players/jareel/areas/chaos/cave/grid3/hall1.c","west",
