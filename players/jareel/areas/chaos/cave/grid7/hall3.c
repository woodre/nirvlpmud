...
reset(arg) {
	...
	""+HIK+"@"+NORM+BOLD+"X"+HIK+"@"+NORM+"--"+NORM+LINE24+"     \n"+
	""+HIK+"@"+NORM+"-R|"+HIK+"@"+NORM+LINE25+"\n"+
	"     "+LINE26+"\n"+
	"     "+LINE27+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid7/hall2.c","north",
			"/players/jareel/areas/chaos/cave/grid7/hall6.c","south",
