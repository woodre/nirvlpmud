...
reset(arg) {
    ...
    "\n"+
	""+HIK+"@@@@@"+NORM+LINE15+"     \n"+
	""+HIK+"@"+NORM+"-"+HIK+"@@@"+NORM+LINE16+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE17+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+BOLD+"X"+NORM+"-"+NORM+LINE18+"     \n"+
	""+HIK+"@"+NORM+"-R-"+HIK+"@"+NORM+LINE19+"\n"+
	"     "+LINE20+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid7/room1.c","north",
			"/players/jareel/areas/chaos/cave/grid7/hall5.c","east",
                        "/players/jareel/areas/chaos/cave/grid7/hall7.c","south",
