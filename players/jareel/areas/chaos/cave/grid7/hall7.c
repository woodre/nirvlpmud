...
reset(arg) {
    ...
    "\n"+
	""+HIK+"@@@@@"+NORM+"     \n"+
	""+HIK+"@"+NORM+"-"+HIK+"@@@"+NORM+LINE22+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE23+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"--"+NORM+LINE24+"     \n"+
	""+HIK+"@"+NORM+"-R"+BOLD+"X"+HIK+"@"+NORM+LINE25+"\n"+
	"     "+LINE26+"\n"+
	"     "+LINE27+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid7/room2.c","west",
			"/players/jareel/areas/chaos/cave/grid8/hall1.c","south",
			"/players/jareel/areas/chaos/cave/grid7/hall4.c","north",
