...
reset(arg) {
	...
	""+HIK+"@"+NORM+BOLD+"X"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE30+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"--"+NORM+LINE31+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid7/hall1.c","north",
			"/players/jareel/areas/chaos/cave/grid7/hall3.c","south",
