...
reset(arg) {
	...
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE3+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"--"+NORM+LINE4+"     \n"+
	""+HIK+"@"+NORM+BOLD+"X"+NORM+"R|"+HIK+"@"+NORM+LINE5+"     \n"+
	"     "+LINE6+"\n"+
	"     "+LINE7+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid7/hall3.c","north",
			"/players/jareel/areas/chaos/cave/grid7/room2.c","east",
