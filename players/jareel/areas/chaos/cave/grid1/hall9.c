...
int monsters;
     ...
     long_desc=
        ...
        "R"+HIK+"@"+NORM+"|-E"+LINE10+"   \n"+
        "--|"+HIK+"@@"+NORM+LINE11+"    \n"+
        "|"+HIK+"@"+NORM+BOLD+"X"+NORM+"R"+HIK+"@"+NORM+LINE12+"\n"+
    	"     "+LINE13+"\n"+
    	"     "+LINE14+"\n";;
     items = ({
...
dest_dir = ({
     "/players/jareel/areas/chaos/cave/grid1/hall5.c","north",
     "/players/jareel/areas/chaos/cave/grid2/hall3.c","south",
     "/players/jareel/areas/chaos/cave/grid1/room1.c","east",
     });
    get_monsters();
}
