...
int monsters;
      ...
      long_desc=
        ...
        ""+HIK+"@@@@@"+NORM+LINE21+"\n"+
        "---"+HIK+"@@"+NORM+LINE22+"\n"+
        "R"+HIK+"@"+NORM+BOLD+"X"+NORM+"-E"+LINE23+"\n"+
        "--|"+HIK+"@@"+NORM+LINE24+"\n"+
...
dest_dir = ({
      "/players/jareel/areas/chaos/cave/grid1/hall3.c","north",
      "/players/jareel/areas/chaos/cave/grid1/hall5.c","south",
      "/players/jareel/areas/chaos/cave/grid1/hall10.c","east",
      });
    get_monsters();
}
