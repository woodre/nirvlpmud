...
dest_dir = ({
      "/players/jareel/areas/chaos/cave/grid1/hall4.c","north",
      "/players/jareel/areas/chaos/cave/grid1/hall9.c","south",
      "/players/jareel/areas/chaos/cave/grid1/hall6.c","west",
      });
    get_monsters();
}
