...
int monsters;
      ...
      long_desc=
        ...
        ""+HIK+"@@@@@"+NORM+LINE33+"   \n"+
        "---"+HIK+"@@"+NORM+LINE34+"    \n"+
        "R"+HIK+"@"+NORM+"|-"+NORM+"E"+LINE35+"    \n"+
        ""+BOLD+"X"+NORM+"-|"+HIK+"@@"+NORM+LINE36+"   \n"+
...
dest_dir = ({
      "/players/jareel/areas/chaos/cave/grid4/hall7.c","west",
      "/players/jareel/areas/chaos/cave/grid1/hall6.c","east",
      "/players/jareel/areas/chaos/cave/grid1/hall8.c","south",
      });
    get_monsters();
}
