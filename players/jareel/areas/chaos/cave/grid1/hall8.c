...
int monsters;
     ...
     if(arg) return;
      ...
      long_desc=
        ...
        ""+HIK+"@@@@@"+NORM+LINE1+"    \n"+
        "---"+HIK+"@@"+NORM+LINE2+"   \n"+
        "R"+HIK+"@"+NORM+"|-"+NORM+"E"+LINE3+"   \n"+
        "--|"+HIK+"@@"+NORM+LINE4+"   \n"+
        ""+BOLD+"X"+NORM+HIK+"@"+NORM+"|R"+HIK+"@"+NORM+LINE5+"  \n"+
	    "     "+LINE6+"\n"+
	    "     "+LINE7+"\n";		;
      items = ({
...
dest_dir = ({
      "/players/jareel/areas/chaos/cave/grid1/hall7.c","north",
      "/players/jareel/areas/chaos/cave/grid2/hall1.c","south",
     });
    get_monsters();
}
