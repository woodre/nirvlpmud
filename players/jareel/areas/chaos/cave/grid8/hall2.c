...
reset(arg) {
	...
	""+HIK+"@@@"+NORM+BOLD+"X"+HIK+"@"+NORM+LINE16+"    \n"+
	""+HIK+"@"+NORM+"--|"+HIK+"@"+NORM+LINE17+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R-"+NORM+LINE18+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid8/hall1.c","north",
			"/players/jareel/areas/chaos/cave/grid8/hall5.c","south",
