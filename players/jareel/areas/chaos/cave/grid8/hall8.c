...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE33+"     \n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE34+"     \n"+
	""+HIK+"@"+NORM+"--|"+HIK+"@"+NORM+LINE35+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R-"+NORM+LINE36+"     \n"+
	""+HIK+"@"+NORM+BOLD+"X"+HIK+"@@@"+NORM+LINE37+"\n"+
		"     "+LINE38+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid8/hall6.c","north",
			"/players/jareel/areas/chaos/cave/grid9/hall1.c","south",
