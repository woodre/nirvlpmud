...
reset(arg) {
	...
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE1+"     	\n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE2+"     \n"+
	""+HIK+"@"+NORM+"-"+BOLD+"X"+NORM+"|"+HIK+"@"+NORM+LINE3+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R-"+LINE4+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@@@"+NORM+LINE5+"\n"+
	"     "+LINE6+"\n"+
	"     "+LINE7+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid8/hall5.c","east",
			"/players/jareel/areas/chaos/cave/grid8/hall3.c","west",
