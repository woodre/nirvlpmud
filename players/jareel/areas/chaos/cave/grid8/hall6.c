...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE21+"     \n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE22+"     \n"+
	""+HIK+"@"+NORM+"--|"+HIK+"@"+NORM+LINE23+"     \n"+
	""+HIK+"@"+NORM+BOLD+"X"+HIK+"@"+NORM+"R-"+NORM+LINE24+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid8/hall3.c","north",
			"/players/jareel/areas/chaos/cave/grid8/hall8.c","south",
