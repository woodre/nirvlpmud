...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@@@"+NORM+BOLD+"X"+HIK+"@"+NORM+LINE21+"     \n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE22+"     \n"+
	""+HIK+"@"+NORM+"--|"+HIK+"@"+NORM+LINE23+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R-"+NORM+LINE24+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@@@"+NORM+LINE25+"\n"+
	"     "+LINE26+"\n"+
	"     "+LINE27+"\n";;
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid7/hall7.c","north",
			"/players/jareel/areas/chaos/cave/grid8/hall2.c","south",
