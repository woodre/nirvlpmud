...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE28+"     \n"+
	""+HIK+"@@@"+NORM+"|"+HIK+"@"+NORM+LINE29+"     \n"+
	""+HIK+"@"+NORM+"--"+BOLD+"X"+HIK+"@"+NORM+LINE30+"    \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R-"+NORM+LINE31+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid8/hall2.c","north",
			"/players/jareel/areas/chaos/cave/grid8/hall4.c","west",
