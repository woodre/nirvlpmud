...
#define MON1 "/players/jareel/MON1sters/chaos/caves/trolls/"
...
reset(arg) {
    ...
    long_desc=
     "\n"+
	 ""+HIK+"@@@@@"+NORM+LINE1+"     \n"+
	 ""+BOLD+"X"+NORM+"--R"+HIK+"@"+NORM+LINE2+"     \n"+
	 "|"+HIK+"@@@@"+NORM+LINE3+"     \n"+
	 "|"+HIK+"@"+NORM+"R--"+LINE4+"     \n"+
  	 ""+HIK+"@"+NORM+"R"+HIK+"@@@"+NORM+LINE5+"\n"+
	 "     "+LINE6+"\n"+
	 "     "+LINE7+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid4/hall2.c","east",
			"/players/jareel/areas/chaos/cave/grid4/hall4.c","south",
...
getMON1sters_00to05()
{
    move_object(clone_object(MON1+"greattroll.c"),this_object());

    if(random(2) == 1) move_object(clone_object(MON1+"trollkin.c"),this_object());
}

getMON1sters_06to20()
{
   move_object(clone_object(MON1+"darktroll.c"),this_object());
    if(random(5) == 1)
    {
        move_object(clone_object(MON1+"troll1.c"),this_object());
        if(random(3) == 1)
            move_object(clone_object(MON1+"troll2.c"),this_object());
    }
}
...
{
    if(1 == random(3))
        move_object(clone_object(MON1+"trollkin.c"),this_object());
    if(1 == random(5))
        move_object(clone_object(MON1+"zorakzoronlord.c"),this_object());
    if(1 == random(4))
        move_object(clone_object(MON1+"kygorlitorlord.c"),this_object());
    if(1 == random(4))
        move_object(clone_object(MON1+"trollshaMON1.c"),this_object());
    if(1 == random(6))
        move_object(clone_object(MON1+"scarab.c"),this_object());
...
getMON1sters_default()
{
    if(random(50)==1)  move_object(clone_object(MON1+"greattroll.c"),this_object());
    if(random(20)==1)  move_object(clone_object(MON1+"zorakzoronlord.c"),this_object());
    if(random(17)==1){  move_object(clone_object(MON1+"troll1.c"),this_object());
    if(random(2)==1) move_object(clone_object(MON1+"troll2.c"),this_object()); }
    if(random(15)==1)  move_object(clone_object(MON1+"darktroll.c"),this_object());
    if(random(10)==1)  move_object(clone_object(MON1+"kygorlitorlord.c"),this_object());
    if(random(7)==1)  move_object(clone_object(MON1+"trollshaMON1.c"),this_object());
    if(random(5)==1)  move_object(clone_object(MON1+"troll1.c"),this_object());
    if(random(5)==1)  move_object(clone_object(MON1+"troll2.c"),this_object());
    if(random(3)==1)  move_object(clone_object(MON1+"trollkin.c"),this_object());
}
