...
reset(arg) {
	...
	""+HIK+"@@@@@"+NORM+LINE33+"     \n"+
	"---R"+HIK+"@"+NORM+LINE34+"     \n"+
	""+BOLD+"X"+NORM+HIK+"@@@@"+NORM+LINE35+"     \n"+
	"|"+HIK+"@"+NORM+"R--"+NORM+LINE36+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid4/hall1.c","north",
			"/players/jareel/areas/chaos/cave/grid4/hall5.c","south",
