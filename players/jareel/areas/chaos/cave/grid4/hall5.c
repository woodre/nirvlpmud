...
reset(arg) {
    ...
    long_desc=
	 ...
	 ""+HIK+"@@@@@"+NORM+LINE21+"     \n"+
	 "---R"+HIK+"@"+NORM+LINE22+"    \n"+
	 "|"+NORM+HIK+"@@@@"+NORM+LINE23+"     \n"+
	 ""+BOLD+"X"+NORM+HIK+"@"+NORM+"R--"+NORM+LINE24+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid4/hall4.c","north",
			"/players/jareel/areas/chaos/cave/grid7/hall5.c","west",
