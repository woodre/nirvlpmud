...
reset(arg) {
    ...
    "\n"+
	""+HIK+"@@@@@"+NORM+LINE28+"     \n"+
	"--"+BOLD+"X"+NORM+"R"+HIK+"@"+NORM+LINE29+"     \n"+
	"|"+HIK+"@@@@"+NORM+LINE30+"     \n"+
	"|"+HIK+"@"+NORM+"R--"+NORM+LINE31+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid4/room1.c","east",
			"/players/jareel/areas/chaos/cave/grid4/hall2.c","west",
