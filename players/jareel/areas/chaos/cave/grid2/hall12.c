...
"|"+HIK+"@"+NORM+"-|"+HIK+"@"+NORM+LINE24+"   \n"+
""+BOLD+"X"+HIK+"@"+NORM+"R"+HIK+"@@"+NORM+LINE25+"\n"+
"     "+LINE26+"\n"+
"     "+LINE27+"\n";
...
dest_dir = ({
"/players/jareel/areas/chaos/cave/grid2/hall9.c","north",
"/players/jareel/areas/chaos/cave/grid3/hall1.c","south",
