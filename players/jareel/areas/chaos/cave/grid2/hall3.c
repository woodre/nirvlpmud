...
long_desc=
"\n"+
"|-"+BOLD+"X"+NORM+"|"+HIK+"@"+NORM+LINE33+"\n"+
"|"+HIK+"@@"+NORM+"|"+HIK+"@"+NORM+LINE34+"\n"+
"|"+HIK+"@@"+NORM+"|"+HIK+"@"+NORM+LINE35+"\n"+
"|"+HIK+"@"+NORM+"-|"+HIK+"@"+NORM+LINE36+"\n"+
"|"+HIK+"@"+NORM+"R"+HIK+"@@"+NORM+LINE37+"   \n"+
"     "+LINE38+"\n";
...
dest_dir = ({
"/players/jareel/areas/chaos/cave/grid2/hall2.c","west",
"/players/jareel/areas/chaos/cave/grid2/hall4.c","east",
"/players/jareel/areas/chaos/cave/grid1/hall9.c","north",
