...
""+BOLD+"X"+NORM+HIK+"@@"+NORM+"|"+HIK+"@"+NORM+LINE30+"   \n"+
"|"+HIK+"@"+NORM+"-|"+HIK+"@"+NORM+LINE31+"   \n"+
"|"+HIK+"@"+NORM+"R"+HIK+"@@"+NORM+LINE32+"\n";
...
dest_dir = ({
"/players/jareel/areas/chaos/cave/grid2/hall5.c","north",
"/players/jareel/areas/chaos/cave/grid5/hall8.c","west",
"/players/jareel/areas/chaos/cave/grid2/hall9.c","south",
