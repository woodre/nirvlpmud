...
long_desc=
"\n"+
""+BOLD+"X"+NORM+"-+|"+HIK+"@"+NORM+LINE8+"   \n"+
"|"+HIK+"@@"+NORM+"|"+HIK+"@"+NORM+LINE9+"   \n"+
"|"+HIK+"@@"+NORM+"|"+HIK+"@"+NORM+LINE10+"   \n"+
...
dest_dir = ({
"/players/jareel/areas/chaos/cave/grid1/hall8.c","north",
"/players/jareel/areas/chaos/cave/grid2/hall2.c","east",
"/players/jareel/areas/chaos/cave/grid2/hall5.c","south",
