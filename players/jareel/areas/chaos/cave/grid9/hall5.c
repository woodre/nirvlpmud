...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE8+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|-"+NORM+LINE9+"    \n"+
	""+HIK+"@"+NORM+BOLD+"X"+NORM+"-|"+HIK+"@"+NORM+LINE10+"     \n"+
	""+HIK+"@"+NORM+"R"+HIK+"@"+NORM+"|-"+NORM+LINE11+"     \n"+
	""+HIK+"@@@@@"+NORM+LINE12+"\n"+
	"     "+LINE13+"\n"+
	"     "+LINE14+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid9/hall2.c","north",
			"/players/jareel/areas/chaos/cave/grid9/room2.c","south",
			"/players/jareel/areas/chaos/cave/grid9/hall6.c","east",
