...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE21+"     	\n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+BOLD+"X"+NORM+"-"+NORM+LINE22+"     \n"+
	""+HIK+"@"+NORM+"--|"+HIK+"@"+NORM+LINE23+"     \n"+
	""+HIK+"@"+NORM+"R"+HIK+"@"+NORM+"|-"+NORM+LINE24+"     \n"+
	""+HIK+"@@@@@"+NORM+LINE25+"     \n"+
	"     "+LINE26+"\n"+
	"     "+LINE27+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid9/room1.c","north",
			"/players/jareel/areas/chaos/cave/grid9/hall7.c","south",
			"/players/jareel/areas/chaos/cave/grid9/hall4.c","east",
