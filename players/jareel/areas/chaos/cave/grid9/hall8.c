...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE33+"    \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|-"+NORM+LINE34+"     \n"+
	""+HIK+"@"+NORM+"--|"+HIK+"@"+NORM+LINE35+"     \n"+
	""+HIK+"@"+NORM+"R"+HIK+"@"+NORM+BOLD+"X"+NORM+"-"+NORM+LINE36+"    \n"+
	""+HIK+"@@@@@"+NORM+LINE37+"\n"+
	"     "+LINE38+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid9/hall7.c","north",
			"/players/jareel/areas/chaos/cave/grid9/hall9.c","east",
