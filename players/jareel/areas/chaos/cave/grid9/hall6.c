...
reset(arg) {
	...
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|-"+NORM+LINE22+"     \n"+
	""+HIK+"@"+NORM+"-"+BOLD+"X"+NORM+"|"+HIK+"@"+NORM+LINE23+"     \n"+
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid9/hall5.c","west",
			"/players/jareel/areas/chaos/cave/grid9/hall7.c","east",
