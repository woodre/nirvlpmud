...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE28+"     \n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|-"+NORM+LINE29+"     \n"+
	""+HIK+"@"+NORM+"|"+NORM+"-"+BOLD+"X"+HIK+"@"+NORM+LINE30+"     \n"+
	""+HIK+"@"+NORM+"R"+HIK+"@"+NORM+"|-"+NORM+LINE31+"     \n"+
	""+HIK+"@@@@@"+NORM+LINE32+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid9/hall3.c","north",
			"/players/jareel/areas/chaos/cave/grid9/hall8.c","south",
			"/players/jareel/areas/chaos/cave/grid9/hall6.c","west",
