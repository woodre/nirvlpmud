...
reset(arg) {
    ...
    long_desc=
    "\n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"R"+HIK+"@"+NORM+LINE1+"     	\n"+
	""+HIK+"@"+NORM+"|"+HIK+"@"+NORM+"|-"+NORM+LINE2+"     \n"+
	""+HIK+"@"+NORM+"--|"+HIK+"@"+NORM+LINE3+"     \n"+
	""+HIK+"@"+NORM+"R"+HIK+"@"+NORM+"|"+BOLD+"X"+NORM+LINE4+"     \n"+
	""+HIK+"@@@@@"+NORM+LINE5+"\n"+
	"     "+LINE6+"\n"+
	"     "+LINE7+"\n";
	...
	dest_dir = ({
			...
			"/players/jareel/areas/chaos/cave/grid9/hall8.c","west",
			"/players/jareel/areas/chaos/cave/grid6/hall7.c","east",
