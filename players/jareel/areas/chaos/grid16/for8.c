...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid16/for7","west",
     "/players/jareel/areas/chaos/grid16/crimsonbatroom","south",
     "/players/jareel/areas/chaos/grid16/for9","east",
});
}
