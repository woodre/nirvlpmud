...
#include "/players/jareel/define.h"
     ...
     long_desc=
       ...
       ""+HIK+"@"+NORM+"--"+BOLD+"X"+NORM+HIK+"T"+NORM+GRN+"#"+NORM+"   a tower pierces the trees canopy.  The path that leads to\n"+
       ...
       ""+HIK+"@"+NORM+GRN+"#"+NORM+"|"+GRN+"###"+NORM+"   dark shadows, that seem to watch your every move.\n";
     items = ({
       ...
       "tower","The Legendary Tower of the Sembrak rests to the east",
...
dest_dir = ({
     "/players/jareel/areas/chaos/forest8","west",
     "/players/jareel/areas/chaos/forest6","east",
     "/players/jareel/areas/chaos/forest4","south",
     });
}
