...
reset(arg) {
     ...
     long_desc=
       ""+GRN+"##"+NORM+"|"+GRN+"##"+NORM+line1+"   \n"+
       ""+GRN+"##"+NORM+"|"+GRN+"##"+NORM+line2+"   \n"+
       ""+NORM+"-"+GRN+"#"+NORM+"--"+GRN+"#"+NORM+line3+"   \n"+
       ""+GRN+"###"+NORM+"|-"+NORM+line4+"   \n"+
       ""+NORM+"-X"+GRN+"###"+NORM+line5+"   \n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+line6+"\n";
     items = ({
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid10/for1","south",
     "/players/jareel/areas/chaos/grid10/for3","west",
});
}
