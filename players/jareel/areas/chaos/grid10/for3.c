...
reset(arg) {
     ...
     long_desc=
       ""+GRN+"##"+NORM+"|"+GRN+"##"+NORM+l1+"   \n"+
       ""+GRN+"##"+NORM+"|"+GRN+"##"+NORM+l2+"   \n"+
       ""+NORM+"-"+GRN+"#"+NORM+"--"+GRN+"#"+NORM+l3+"   \n"+
       ""+GRN+"###"+NORM+"|-"+NORM+l4+"   \n"+
       ""+NORM+"X-"+GRN+"###"+NORM+l5+"   \n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"\n";
     items = ({
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid9/for6","west",
     "/players/jareel/areas/chaos/grid10/for4","east",
});
}
...
SecretDoor(str) {
     if(str == "push" || "east" || "e") {  
       this_player()->move_player("pushes aside the trees#/players/jareel/areas/chaos/grid10/secdoor.c");
       return 1;  
     } 
}