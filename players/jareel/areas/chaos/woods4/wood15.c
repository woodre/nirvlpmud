...
int monsters;
 ...
 void setDescriptions() {
   ...
   line4 += ({ "Running shadows shift and flow over to forest floor." });   
       ...
       GRN+"#"+NORM+"X-|"+NORM+GRN+"####"+NORM+"|"+NORM+GRN+"##   "+NORM+line4[random(sizeof(line4))]+"\n"+
...
dest_dir = ({
 ...
 "/players/jareel/areas/chaos/woods4/wood16","east",
  "/players/jareel/areas/chaos/woods4/wood13","north",
