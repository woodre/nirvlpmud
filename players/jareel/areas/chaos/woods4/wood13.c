...
int monsters;
 ...
 void setDescriptions() {
   ...
   line4 += ({ "Running shadows shift and flow over to forest floor." });   
       ...
       GRN+"#"+NORM+"X"+NORM+GRN+"#"+NORM+HIK+"S"+NORM+GRN+"####"+NORM+"|"+NORM+GRN+"##   "+NORM+line3[random(sizeof(line3))]+"\n"+
...
dest_dir = ({
 ...
 "/players/jareel/areas/chaos/woods4/wood15","south",
  "/players/jareel/areas/chaos/woods4/wood11","north",
