...
int monsters;
 ...
 void setDescriptions() {
   ...
   line4 += ({ "Running shadows shift and flow over to forest floor." });   
       ...
       GRN+"#"+NORM+"|---------   "+NORM+line1[random(sizeof(line1))]+"\n"+
       GRN+"#"+NORM+"|"+NORM+GRN+"######"+NORM+"|"+NORM+GRN+"##   "+NORM+line2[random(sizeof(line2))]+"\n"+
       GRN+"#"+NORM+"|"+NORM+GRN+"#"+NORM+HIK+"S"+NORM+GRN+"####"+NORM+"X"+NORM+GRN+"##   "+NORM+line3[random(sizeof(line3))]+"\n"+
...
dest_dir = ({
 ...
 "/players/jareel/areas/chaos/woods4/wood18","south",
  "/players/jareel/areas/chaos/woods4/wood12","north",
