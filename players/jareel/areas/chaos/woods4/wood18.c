...
int monsters;
 ...
 void setDescriptions() {
   ...
   line4 += ({ "Running shadows shift and flow over to forest floor." });   
       ...
       GRN+"#"+NORM+"|-|"+NORM+GRN+"####"+NORM+"X"+NORM+GRN+"##   "+NORM+line4[random(sizeof(line4))]+"\n"+
...
dest_dir = ({
 ...
 "/players/jareel/areas/chaos/woods4/wood21","south",
  "/players/jareel/areas/chaos/woods4/wood14","north",
