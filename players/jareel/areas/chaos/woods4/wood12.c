...
int monsters;
 ...
 void setDescriptions() {
   ...
   line4 += ({ "Running shadows shift and flow over to forest floor." });   
       ...
       GRN+"#"+NORM+"|"+NORM+GRN+"######"+NORM+"X"+NORM+GRN+"##   "+NORM+line2[random(sizeof(line2))]+"\n"+
...
dest_dir = ({
 ...
 "/players/jareel/areas/chaos/woods4/wood14","south",
  "/players/jareel/areas/chaos/woods4/wood3","north",
