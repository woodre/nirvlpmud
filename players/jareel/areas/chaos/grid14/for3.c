...
reset(arg) {
     ...
     long_desc=
       ...
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+l3+"    \n"+
       ""+GRN+"#"+NORM+"X"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+l4+"    \n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+l5+"   \n"+
       ""+GRN+"#####"+NORM+"\n";
     items = ({
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid14/for5","north",
     "/players/jareel/areas/chaos/grid14/for1","south",
});
}
...
SecretDoor(str) {
     if(str == "push" || "east" || "e") {  
       this_player()->move_player("pushes aside the trees#/players/jareel/areas/chaos/grid14/secdoor.c");
       return 1;  
     } 
}