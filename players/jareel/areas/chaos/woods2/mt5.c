...
reset(arg) {
  ...
  long_desc=
    GRN+"###"+NORM+"|"+GRN+"###"+NORM+"   Large colorful trees press against the lustrous palace.\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   Paths lead from the palace in all directions. The\n"+
    "---+"+BOLD+"X"+NORM+"+"+GRN+"#"+NORM+"   trees allow a lot of light into the mystical glade, washing\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   a sense of peace over the land.\n"+
    GRN+"#######"+NORM+"   \n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/mt4","west",
    "/players/jareel/areas/chaos/woods2/mt6","east",
    "/players/jareel/areas/chaos/woods2/mt2","north",
    "/players/jareel/areas/chaos/woods2/mt8","south",
  });
