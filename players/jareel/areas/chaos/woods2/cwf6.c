...
reset(arg) {
  ...
  if(!present("npc"))  {
     MOCO("/players/jareel/monsters/chaos/woods2/rhino_broo.c"),this_object()); }
  ...
  long_desc=
    ...
    HIK+"@"+NORM+GRN+"##"+NORM+"|"+BOLD+"X"+NORM+GRN+"#"+NORM+"   that branch to the north and south lead to the unknown.  The\n"+
    HIK+"@"+NORM+GRN+"#"+NORM+"H++-"+NORM+"   little light the canopy allows to pass cast deep shadows over\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/cwf4","north",
    "/players/jareel/areas/chaos/woods2/cwf5","west",
    "/players/jareel/areas/chaos/woods2/cwf8","south",
  });
}
