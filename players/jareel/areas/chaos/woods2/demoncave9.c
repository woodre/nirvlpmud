...
reset(arg) {
  ...
  long_desc=
    HIK+"@@@@@@"+NORM+"   The floor of the cavern is covered with a red mucus bile that\n"+
    HIK+"@"+NORM+"----"+HIK+"@"+NORM+"   sticks to anything it touches; bones and weapons that lay in\n"+
    HIK+"@"+NORM+"|"+HIK+"@@"+NORM+"|-   the mucus dissolve in its acidic nature.  The walls are\n"+
    HIK+"@"+NORM+"|"+BOLD+"X"+BOLD+YEL+"*"+HIK+"@@"+NORM+"   decorated with half eaten corpses, rotten and maggot ridden.\n"+
    HIK+"@@@@@@"+NORM+"   The air permeates a methane death that lingers and eats\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/demoncave8","west",
    "/players/jareel/areas/chaos/woods2/demoncave10","east",
  });
