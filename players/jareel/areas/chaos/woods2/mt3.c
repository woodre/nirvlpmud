...
reset(arg) {
  ...
  if(!present("broo"))  {
    MOCO("/players/jareel/monsters/chaos/woods2/unicorn.c"),this_object()); 
  }
  ...
  long_desc=
    GRN+"###"+NORM+"|"+GRN+"###"+NORM+"   Large colorful trees line the Faerie Grove.  To the west\n"+
    GRN+"###"+NORM+"--"+BOLD+"X"+NORM+GRN+"#"+NORM+"   and south the paths weave their way into the grove.  The\n"+
    "---+C+"+GRN+"#"+NORM+"   forest to the north and east impedes any progression.\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   Flowing, mystical energy creates a quiescent aura that\n"+
    GRN+"#######"+NORM+"   flutters in the air.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/mt2","west",
    "/players/jareel/areas/chaos/woods2/mt6","south",
  });
