...
reset(arg) {
  ...
  long_desc=
    ...
    HIK+"@"+NORM+"----"+GRN+"#"+NORM+"   and south vegetation lines the dirt path, while to the\n"+
    HIK+"@"+NORM+GRN+"##"+NORM+"||"+GRN+"#"+NORM+"   east and west the path leads to the unknown.  The little\n"+
    HIK+"@"+NORM+GRN+"#"+NORM+"H++"+BOLD+"X"+NORM+"   bit of light the canopy allows to pass, casts deep shadows\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/cwf8","west",
    "/players/jareel/areas/chaos/woods2/path1","east",
  });
}
