...
reset(arg) {
  ...
  long_desc=
    ...
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   and south forest walls block the paths, while to the\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/path2","west",
    "/players/jareel/areas/chaos/woods2/mt4","east",
  });
}
