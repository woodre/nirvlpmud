...
reset(arg) {
  ...
  long_desc=
    ...
    HIK+"@"+NORM+"----"+HIK+"@"+NORM+"   rocks hang from the rough, textured wall. Strange, purple \n"+
    HIK+"@"+NORM+BOLD+"X"+HIK+"@@"+NORM+"|-   flowers seem to grow in abundance over the moss, shrinking \n"+
    HIK+"@"+NORM+"|-"+BOLD+YEL+"*"+HIK+"@@"+NORM+"   back and hiding in the palpable darkness.\n"+
    HIK+"@@@@@@"+NORM+"\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/demoncave8","south",
    "/players/jareel/areas/chaos/woods2/demoncave6","north",
  });
