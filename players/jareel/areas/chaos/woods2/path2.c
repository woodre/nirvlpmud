...
reset(arg) {
  ...
  long_desc=
    ...
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   and south the forest walls block the paths, while to the\n"+
    "-"+BOLD+"X"+NORM+"-+C+"+GRN+"#"+NORM+"   east and west the paths lead into the Wood.  The trees allow\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   a few rays of light past their canopy, creating deep dark\n"+
    GRN+"#######"+NORM+"   shadows that seem to watch your every move.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/path1","west",
    "/players/jareel/areas/chaos/woods2/path3","east",
  });
}
