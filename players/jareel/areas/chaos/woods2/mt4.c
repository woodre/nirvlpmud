...
reset(arg) {
  ...
  long_desc=
    GRN+"###"+NORM+"|"+GRN+"###"+NORM+"   Large colorful trees line the Faerie Grove.  To the east a\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   palace rests within the quiet grove.  The path branches\n"+
    "---"+BOLD+"X"+NORM+"C+"+GRN+"#"+NORM+"   off in every direction, leading to the Chaos Wood and into\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   the mystical grove.  The trees open up here allowing the\n"+
    GRN+"#######"+NORM+"   light to cast a peaceful glow over the field.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/path3","west",
    "/players/jareel/areas/chaos/woods2/mt5","east",
    "/players/jareel/areas/chaos/woods2/mt1","north",
    "/players/jareel/areas/chaos/woods2/mt7","south",
  });
