...
reset(arg) {
  ...
  long_desc=
    GRN+"###"+NORM+"|"+GRN+"###"+NORM+"   Large colorful trees line the Faerie Grove.  To the east\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   and north the paths weave their way around the mystical grove.\n"+
    "---+C+"+GRN+"#"+NORM+"   The trees to the south and west impede any progression.  An\n"+
    GRN+"###"+NORM+BOLD+"X"+NORM+"--"+GRN+"#"+NORM+"   opening in the trees allow a lot of light to pass.  A magical\n"+
    GRN+"#######"+NORM+"   aura surrounds this peacefull setting.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/mt8","east",
    "/players/jareel/areas/chaos/woods2/mt4","north",
  });
