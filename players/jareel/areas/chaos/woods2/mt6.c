...
reset(arg) {
  ...
  long_desc=
    ...
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   a palace rests on an open field.  The paths leading to\n"+
    "---+C"+BOLD+"X"+NORM+GRN+"#"+NORM+"   the north and south weave around the mystical land.  The\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   trees allow a lot of light to surpass, creating a calm\n"+
    GRN+"#######"+NORM+"   serenity over the land.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/mt5","west",
    "/players/jareel/areas/chaos/woods2/mt3","north",
    "/players/jareel/areas/chaos/woods2/mt9","south",
  });
