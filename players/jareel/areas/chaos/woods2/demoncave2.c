...
reset(arg) {
  ...
  long_desc=
    ...
    HIK+"@"+NORM+"----"+HIK+"@"+NORM+"   rocks accumulate in the passage, chipped from its very walls.\n"+
    HIK+"@"+NORM+"|"+HIK+"@@"+NORM+BOLD+"X"+NORM+"-   The cavern leads to the east and north here.  A small, strange,\n"+
    HIK+"@"+NORM+"|"+NORM+"-"+BOLD+YEL+"*"+HIK+"@@"+NORM+"   purple flower blossoms in the moss.\n"+
    HIK+"@@@@@@"+NORM+"\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/demoncave1","east",
    "/players/jareel/areas/chaos/woods2/demoncave3","north",
  });
