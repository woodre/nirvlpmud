...
reset(arg) {
  ...
  long_desc=
    GRN+"###"+NORM+"|"+GRN+"###"+NORM+"   Large colorful trees line the Faerie Grove.  To the east and\n"+
    GRN+"###"+NORM+BOLD+"X"+NORM+"--"+GRN+"#"+NORM+"   south the paths weave their way around the mystical grove.\n"+
    "---+C+"+GRN+"#"+NORM+"   The trees to the north and west impede any progression.  The\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   trees open up here allowing a lot of light to pass.  A magical\n"+
    GRN+"#######"+NORM+"   aura surounds this peacefull setting.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/mt2","east",
    "/players/jareel/areas/chaos/woods2/mt4","south",
	"/players/jareel/areas/chaos/woods3/wood1","north",
  });
