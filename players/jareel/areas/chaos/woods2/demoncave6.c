...
reset(arg) {
  ...
  long_desc=
    HIK+"@@@@@@"+NORM+"   The cavern walls are coated in a slimy, mucus moss.  Loose \n"+
    HIK+"@"+NORM+BOLD+"X"+NORM+"---"+HIK+"@"+NORM+"   rocks hang from the rough, textured wall.  The palpable\n"+
    HIK+"@"+NORM+"|"+HIK+"@@"+NORM+"|-   darkness envelopes the air in the room.  Moss can be found\n"+
    HIK+"@"+NORM+"|-"+BOLD+YEL+"*"+HIK+"@@"+NORM+"   in every crack and crevice in the walls.  The passage\n"+
    HIK+"@@@@@@"+NORM+"   leads south and west here.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/demoncave7","south",
    "/players/jareel/areas/chaos/woods2/demoncave5","east",
  });
