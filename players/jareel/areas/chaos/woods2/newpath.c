...
reset(arg) {
  ...
  long_desc=
    GRN+"###"+NORM+BOLD+"X"+NORM+GRN+"###"+NORM+"   Large colorful trees line the Faerie Grove.  To the east and\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   south the paths weave their way around the mystical grove.\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/grid1/for1","north",
    "/players/jareel/areas/chaos/woods2/mt1","south",
  });
