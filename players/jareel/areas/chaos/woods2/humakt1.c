...
reset(arg) {
  ...
  if(!present("tyric"))  {
    MOCO("/players/jareel/monsters/chaos/woods2/tyric.c"),this_object());
  }
  ...
  long_desc=
    ...
    "the protective walls.  A small, ornate alter rests in the center\n"+
    "of the floor.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/humakt2","east",
  });
}
