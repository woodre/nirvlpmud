...
reset(arg) {
  ...
  long_desc=
    HIK+"@"+NORM+GRN+"#####"+NORM+"   Large, colorful trees line the forest path.  To the south\n"+
    HIK+"@"+NORM+"----"+GRN+"#"+NORM+"   a tower pierces the canopy.  The patha that lead to\n"+
    HIK+"@"+NORM+GRN+"##"+NORM+"||"+GRN+"#"+NORM+"   the north and west lead into the Wood.  The trees allow\n"+
    HIK+"@"+NORM+GRN+"#"+NORM+"H++-"+NORM+"   a few rays of light past their canopy, creating deep, dark\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/cwf8","north",
    "/players/jareel/areas/chaos/woods2/cwf10","west",
    "/players/jareel/areas/chaos/forest6","south",
  });
}
