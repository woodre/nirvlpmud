...
reset(arg) {
  ...
  long_desc=
    ...
    HIK+"@"+NORM+"|"+HIK+"@@"+NORM+"|"+BOLD+"X"+NORM+"     flowers seem to grow in abundance over the moss, shrinking\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/demoncave2","west",
    "/players/jareel/areas/chaos/woods2/cwf1","east",
  });
