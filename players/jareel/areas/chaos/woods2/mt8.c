...
reset(arg) {
  ...
  long_desc=
    GRN+"###"+NORM+"|"+GRN+"###"+NORM+"   Large colorful trees line the Faerie Grove.  To the north\n"+
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   a palace lies within the mystical trees.  The paths that lead\n"+
    "---+C+"+GRN+"#"+NORM+"   to the west and east travel around and inside the grove.  An\n"+
    GRN+"###"+NORM+"-"+BOLD+"X"+NORM+"-"+GRN+"#"+NORM+"   opening in the canopy allows a lot of light to pass, creating\n"+
    GRN+"#######"+NORM+"   a well lit opening.  A mystic energy fills the air.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/mt9","east",
    "/players/jareel/areas/chaos/woods2/mt7","west",
    "/players/jareel/areas/chaos/woods2/mt5","north",
  });
