...
reset(arg) {
  ...
  long_desc=
    ...
    HIK+"@"+NORM+"---"+BOLD+"X"+HIK+"@"+NORM+"   rocks accumulate in the passage, chipped from its very walls.\n"+
    HIK+"@"+NORM+"|"+HIK+"@@"+NORM+"|-   The cavern leads to the south and west here.  A small, strange,\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/demoncave2","south",
    "/players/jareel/areas/chaos/woods2/demoncave4","west",
  });
