...
reset(arg) {
  ...
  long_desc=
    ...
    HIK+"@"+NORM+"--"+BOLD+"X"+NORM+"-"+GRN+"#"+NORM+"   the foliage grows horribly thick, while to the east, west\n"+
    HIK+"@"+NORM+GRN+"##"+NORM+"||"+GRN+"#"+NORM+"   and south the paths lead into the unknown.  The little\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/cwf2","west",
    "/players/jareel/areas/chaos/woods2/cwf4","east",
    "/players/jareel/areas/chaos/woods2/cwf5","south",
  });
