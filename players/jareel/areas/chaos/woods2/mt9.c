...
reset(arg) {
  ...
  long_desc=
    ...
    GRN+"###"+NORM+"---"+GRN+"#"+NORM+"   and north the paths weaves their way into the grove.  The\n"+
    "---+C+"+GRN+"#"+NORM+"   forest to the south and east impedes any progression.\n"+
    GRN+"###"+NORM+"--"+BOLD+"X"+NORM+GRN+"#"+NORM+"   Mystical energy flowing nearby emanates a peaceful aura\n"+
    GRN+"#######"+NORM+"   that fills the air.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/mt8","west",
    "/players/jareel/areas/chaos/woods2/mt6","north",
  });
