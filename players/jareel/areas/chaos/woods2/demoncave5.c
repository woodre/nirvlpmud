...
reset(arg) {
  ...
  long_desc=
    ...
    HIK+"@"+NORM+"|"+HIK+"@@"+NORM+"|-   darkness envelopes the air.  Moss can be found in every\n"+
    HIK+"@"+NORM+"|-"+BOLD+YEL+"*"+HIK+"@@"+NORM+"   crack and crevice in the walls.  The passage leads east\n"+
    HIK+"@@@@@@"+NORM+"   and west here.\n";
  items = ({
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods2/demoncave6","west",
    "/players/jareel/areas/chaos/woods2/demoncave4","east",
  });
