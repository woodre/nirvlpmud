...
reset(arg) {
     ...
     long_desc=
       ...
       ""+NORM+"|"+GRN+"#"+NORM+"X"+GRN+"#"+NORM+"-"+NORM+line2+"   \n"+
       ""+NORM+"|-|"+GRN+"##"+NORM+line3+"   \n"+
       ""+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"##"+NORM+line4+"   \n"+
       ""+NORM+"+----"+NORM+line5+"   \n"+
       ""+GRN+"#####"+NORM+line6+"\n";
     items = ({
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid3/for14","north",
     "/players/jareel/areas/chaos/grid3/for10","south",
});
}
