...
reset(arg) {
     ...
     long_desc=
       ...
       ""+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"-"+NORM+l2+"   \n"+
       ""+NORM+"|-X"+GRN+"##"+NORM+l3+"   \n"+
       ""+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"##"+NORM+l4+"   \n"+
       ""+NORM+"+----"+NORM+l5+"   \n"+
       ""+GRN+"#####"+NORM+"\n";
     items = ({
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid3/for12","north",
     "/players/jareel/areas/chaos/grid3/for7","south",
     "/players/jareel/areas/chaos/grid3/for9","west",
    });
}
