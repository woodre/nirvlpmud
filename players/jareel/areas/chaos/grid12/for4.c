...
reset(arg) {
     ...
     long_desc=
       ...
       ""+NORM+"+-"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+l2+"   \n"+
       ""+NORM+"|"+GRN+"####"+NORM+l3+"   \n"+
       ""+GRN+"##"+NORM+"-X"+GRN+"#"+NORM+l4+"   \n"+
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid12/for3","west",
});
}
...
SecretDoor(str) {
     if(str == "push" || "west" || "w") {  
       this_player()->move_player("pushes aside the trees#/players/jareel/areas/chaos/grid12/secdoor.c");
       return 1;  
     } 
}