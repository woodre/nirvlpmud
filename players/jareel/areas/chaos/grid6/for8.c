...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid6/for10","north",
     "/players/jareel/areas/chaos/grid6/for7","west",
     "/players/jareel/areas/chaos/grid6/for9","east",
});
}
...
SecretDoor(str) {
     if(str == "push" || "west" || "w") {  
       this_player()->move_player("pushes aside the trees#/players/jareel/areas/chaos/grid6/secdoor.c");
       return 1;  
     } 
}