...
int monsters;
 ...
 void setDescriptions() {
   ...
   line4 += ({ "Running shadows shift and flow over to forest floor." });   
        ...
        long_desc=
       GRN+"###########     "+NORM+"   \n"+
       GRN+"#"+NORM+"--|--|---"+GRN+"#   "+NORM+line1[random(sizeof(line1))]+"\n"+
       GRN+"###"+NORM+HIM+"S"+NORM+GRN+"##"+NORM+"|"+NORM+GRN+"####   "+NORM+line2[random(sizeof(line2))]+"\n"+
       GRN+"######"+NORM+"|"+NORM+GRN+"####   "+NORM+line3[random(sizeof(line3))]+"\n"+
       GRN+"######"+NORM+"|"+NORM+GRN+"####   "+NORM+line4[random(sizeof(line4))]+"\n"+
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid16/for9","west",
     "/players/jareel/areas/chaos/grid17/for5","east",
});
