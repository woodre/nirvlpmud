...
#define LINE4 "the open air chamber.  Crimson light radiates out from the "
...
reset(arg) {
  ...
  if(!present("solaris"))  {
    MOCO("/players/jareel/monsters/LUNAR/CraterMaker/Solaris.c"),this_object());
  }
  ...
  long_desc=
    "\n"+HBWHT+"     "+NORM+"  "+LINE1+"\n"+
    HBWHT+"  "+NORM+" "+HBWHT+"  "+NORM+"  "+LINE2+"\n"+
    HBWHT+" "+NORM+" X "+HBWHT+" "+NORM+"  "+LINE3+"\n"+
  ...
  dest_dir = ({
    "/players/jareel/areas/chaos/woods3/spire1","north",
	"/players/jareel/areas/chaos/woods3/spire2","south",
	"/players/jareel/areas/chaos/woods3/spire3","east",
	"/players/jareel/areas/chaos/woods3/spire4","west",
		"/players/jareel/areas/chaos/woods3/wood9","out",
