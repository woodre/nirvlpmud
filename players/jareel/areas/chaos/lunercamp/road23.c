...
YEL+"%"+NORM+"|"+RED+"@"+NORM+"C---X"+RED+"@@@"+NORM+"H"+RED+"@@"+NORM+"|"+YEL+"%     "+NORM+l8+"\n"+
...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road26","north",
     "/players/jareel/areas/chaos/lunercamp/road17","south",
     "/players/jareel/areas/chaos/lunercamp/road22","west",
});
}
