...
YEL+"%"+NORM+"|"+RED+"@@@@@"+NORM+"K"+RED+"@@@"+NORM+"A"+RED+"@@"+NORM+"|"+YEL+"%     "+NORM+l6+"\n"+ 
...
YEL+"%"+NORM+"+-----X------+"+YEL+"%     "+NORM+"F  - Lunar Forge\n"+
...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road17","north",
     "/players/jareel/areas/chaos/lunercamp/road1","south",
     "/players/jareel/areas/chaos/lunercamp/road9","east",
     "/players/jareel/areas/chaos/lunercamp/road7","west",
});
}
