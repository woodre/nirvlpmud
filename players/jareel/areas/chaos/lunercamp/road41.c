...
YEL+"%"+NORM+"|"+RED+"@"+NORM+"+---|"+RED+"@@@@"+NORM+""+RED+"@@"+NORM+"|"+YEL+"%     "+NORM+l3+"s\n"+
YEL+"%"+NORM+"|"+RED+"@"+NORM+"|"+RED+"@@@"+NORM+"X----+-+"+YEL+"%     "+NORM+l4+"\n"+
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/lunercamp/road54","north",
     "/players/jareel/areas/chaos/lunercamp/road42","east",
