...
YEL+"%"+NORM+"XB+T"+RED+"@@"+NORM+"M"+RED+"@@@@"+NORM+"F"+RED+"@"+NORM+"|"+YEL+"%     "+NORM+l5+"\n"+ 
...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road39","north",
     "/players/jareel/areas/chaos/lunercamp/road34","south",
});
}
