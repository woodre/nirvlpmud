...
YEL+"%"+NORM+"|"+RED+"@"+NORM+"C---|"+RED+"@@@"+NORM+"H"+RED+"@@"+NORM+"X"+YEL+"%     "+NORM+l8+"\n"+
...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road33","north",
     "/players/jareel/areas/chaos/lunercamp/road18","south",
