...
YEL+"%"+NORM+"|"+RED+"@"+NORM+"+---X"+RED+"@@@@"+NORM+""+RED+"@@"+NORM+"|"+YEL+"%     "+NORM+l3+"\n"+
...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road57","north",
     "/players/jareel/areas/chaos/lunercamp/road41","south",
     "/players/jareel/areas/chaos/lunercamp/road53","west",
});
}
