...
YEL+"%"+NORM+"X"+RED+"@"+NORM+"C---|"+RED+"@@@"+NORM+"H"+RED+"@@"+NORM+"|"+YEL+"%     "+NORM+l8+"\n"+
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/lunercamp/road25","north",
     "/players/jareel/areas/chaos/lunercamp/road16","south",
