...
YEL+"%"+NORM+"+B+T"+RED+"@@"+NORM+"M"+RED+"@@@@"+NORM+"F"+RED+"@"+NORM+"X"+YEL+"%     "+NORM+l5+"\n"+ 
...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road48","north",
     "/players/jareel/areas/chaos/lunercamp/road35","south",
