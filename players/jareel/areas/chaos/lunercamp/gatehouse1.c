...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road","north",
     "/players/jareel/areas/chaos/lunercamp/road","south",
     "/players/jareel/areas/chaos/lunercamp/road","east",
     "/players/jareel/areas/chaos/lunercamp/road","west",
});
}
