...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road57","south",
     "/players/jareel/areas/chaos/lunercamp/road66","east",
     "/players/jareel/areas/chaos/lunercamp/road64","west",
});
}
