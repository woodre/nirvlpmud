...
YEL+"%"+NORM+"|"+RED+"@@@@@"+NORM+"K"+RED+"@@@"+NORM+"A"+RED+"@@"+NORM+"X"+YEL+"%     "+NORM+l6+"\n"+ 
...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road38","north",
     "/players/jareel/areas/chaos/lunercamp/road33","south",
});
}
