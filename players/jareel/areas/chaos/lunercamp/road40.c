...
YEL+"%"+NORM+"|"+RED+"@"+NORM+"X"+RED+"@@@"+NORM+"+----+-+"+YEL+"%     "+NORM+l4+"\n"+
...
YEL+"%"+NORM+"+-----+------+"+YEL+"%     "+NORM+l10+"F  - Lunar Forge\n"+
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/lunercamp/road50","north",
     "/players/jareel/areas/chaos/lunercamp/road37","south",
