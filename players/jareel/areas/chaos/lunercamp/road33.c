...
YEL+"%"+NORM+"|"+RED+"@@@@"+NORM+"S+---+--X"+YEL+"%     "+NORM+l7+"\n"+
...
dest_dir = ({
     "/players/jareel/areas/chaos/lunercamp/road35","north",
     "/players/jareel/areas/chaos/lunercamp/road24","south",
     "/players/jareel/areas/chaos/lunercamp/road32","west",
});
}
