...
reset(arg) {
     ...
     long_desc=
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+l1+"   \n"+
       ""+NORM+"-+"+GRN+"#"+NORM+"X"+GRN+"#"+NORM+l2+"   \n"+
       ""+GRN+"###"+NORM+"|"+GRN+"#"+NORM+l3+"   \n"+
       ""+NORM+"+--+"+GRN+"#"+NORM+l4+"   \n"+
       ""+NORM+"|"+GRN+"####"+NORM+l5+"   \n"+
       ""+GRN+"#####"+NORM+"\n";
     items = ({
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid4/for11","north",
     "/players/jareel/areas/chaos/grid4/for6","south",
});
}
...
SecretDoor(str) {
     if(str == "push" || "west" || "w") {  
       this_player()->move_player("pushes aside the trees#/players/jareel/areas/chaos/grid4/secdoor1.c");
       return 1;  
     } 
}
