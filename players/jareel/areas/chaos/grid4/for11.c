...
reset(arg) {
     ...
     long_desc=
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"X"+GRN+"#"+NORM+line1+"   \n"+
       ""+NORM+"-+"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+line2+"   \n"+
       ""+GRN+"###"+NORM+"|"+GRN+"#"+NORM+line3+"   \n"+
       ""+NORM+"+--+"+GRN+"#"+NORM+line4+"   \n"+
       ""+NORM+"|"+GRN+"####"+NORM+line5+"   \n"+
       ""+GRN+"#####"+NORM+line6+"\n";
     items = ({
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid10/for2","north",
     "/players/jareel/areas/chaos/grid4/for9","south",
});
}
