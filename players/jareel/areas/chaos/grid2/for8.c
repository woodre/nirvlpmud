...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid2/for7","west",
     "/players/jareel/areas/chaos/grid2/for10","north",
     "/players/jareel/areas/chaos/grid2/for5","south",
});
}
