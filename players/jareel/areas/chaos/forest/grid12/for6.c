...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/forest/grid11/for10","west",
     "/players/jareel/areas/chaos/forest/grid12/for5","south",
     "/players/jareel/areas/chaos/forest/grid12/for7","east",
});
}
