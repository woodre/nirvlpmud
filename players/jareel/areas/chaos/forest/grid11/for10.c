...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/forest/grid11/for9","west",
     "/players/jareel/areas/chaos/forest/grid11/for8","south",
     "/players/jareel/areas/chaos/forest/grid12/for6","east",
});
}
