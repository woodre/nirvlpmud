...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/forest/grid11/for4","west",
     "/players/jareel/areas/chaos/forest/grid11/for2","south",
     "/players/jareel/areas/chaos/forest/grid11/for6","east",
});
}
