...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/forest/grid13/for3","west",        
     "/players/jareel/areas/chaos/forest/grid13/for7","north",
     "/players/jareel/areas/chaos/forest/grid13/for2","south",
     "/players/jareel/areas/chaos/forest/grid13/for5","east",
});
}
