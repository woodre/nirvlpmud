...
reset(arg) {
     ...
     long_desc=
       ""+GRN+"#"+NORM+"|"+GRN+"###"+NORM+"   Large colorful trees line the way on either side of the\n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"   narrow path.  To the north and the south the path leads\n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"+-"+NORM+"   deeper into the unknown.  The foliage allows the passage \n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"   of light casting deep dark shadows over the forest floor.\n"+
       ""+GRN+"#"+NORM+"|"+GRN+"###"+NORM+"   The shadows seem to watch your every move.\n"+
       ""+GRN+"#"+NORM+"X"+GRN+"###"+NORM+"\n";
     items = ({
...
dest_dir = ({
     "/players/jareel/areas/entrance_area/grass_plain_3","south",
     "/players/jareel/areas/chaos/forest/grid1/for2","north",
});
}
