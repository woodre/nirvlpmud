...
reset(arg) {
     ...
     long_desc=
       ...
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"   narrow path.  To the east and the west the path leads\n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"+-"+NORM+"   deeper into the unknown.  The foliage allows the passage \n"+
       ""+GRN+"#"+NORM+"|X|"+GRN+"#"+NORM+"   of light casting deep dark shadows over the forest floor.\n"+
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/forest/grid1/for3","west",
     "/players/jareel/areas/chaos/forest/grid1/for7","east",
});
}
