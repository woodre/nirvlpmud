...
reset(arg) {
     ...
     long_desc=
       ""+GRN+"#"+NORM+"X"+GRN+"###"+NORM+"   Large colorful trees line the way on either side of the\n"+
...
dest_dir = ({
     "/players/jareel/areas/chaos/forest/grid7/for1","north",
     "/players/jareel/areas/chaos/forest/grid1/for5","south",
});
}
