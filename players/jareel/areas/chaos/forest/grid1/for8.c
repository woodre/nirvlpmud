...
reset(arg) {
     ...
     long_desc=
       ...
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"X-"+NORM+"   that makes passage impossible.  The forest's path leads\n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"   off to the east deeper into the Wood.  Light invades\n"+
...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/forest/grid1/for9","north",
     "/players/jareel/areas/chaos/forest/grid1/for7","south",
     "/players/jareel/areas/chaos/forest/grid1/for10","east",
});
}
