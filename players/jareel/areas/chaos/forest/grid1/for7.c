...
reset(arg) {
     ...
     long_desc=
       ...
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"   Looking over the foliage you see the forests chaotic growth\n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"+-"+NORM+"   that makes passage impossible.  The Chaos Woods path leads\n"+
       ""+GRN+"#"+NORM+"|"+GRN+"#"+NORM+"X"+GRN+"#"+NORM+"   off to the north deeper into the unknown.  Light invades\n"+
...
dest_dir = ({
     "/players/jareel/areas/chaos/forest/grid1/secdoor","west",
     "/players/jareel/areas/chaos/forest/grid1/for8","north",
});
}
