...
dest_dir = ({
     ...
     "/players/jareel/areas/chaos/grid5/for9","west",
     "/players/jareel/areas/chaos/grid5/for11","east",
});
}
...
SecretDoor(str) {
     if(str == "push" || "west" || "w") {  
       this_player()->move_player("pushes aside the trees#/players/jareel/areas/chaos/grid5/secdoor.c");
       return 1;  
     } 
}
