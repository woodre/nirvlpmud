...
object gold,helmet,armor,spear;
  ...
  set_name("Jaquay - "+HIY+"Y"+NORM+BOLD+"elmalian "+HIY+"R"+NORM+BOLD+"uneshield"+NORM);
  set_alias("runeshield");
  set_alt_name("jaquay");
  set_short("Jaquay - "+HIY+"Y"+NORM+BOLD+"elmalian "+HIY+"R"+NORM+BOLD+"uneshield"+NORM);
  set_long(
    "The imposing figure standing before you bears the mark of\n"+
    "the Yelmalian Runeshield.  Legend has it the Runeshields are some\n"+
