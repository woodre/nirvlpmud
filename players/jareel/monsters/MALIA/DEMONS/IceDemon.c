...
reset(arg)  {
  ...
  set_short(HIB+"Ice Demon"+NORM);
  set_long(
          HIK+"The demon is an enormous writhing mass, formed out of ropy\n"+
          "ice blue tentacles.  Here and there, the demon's surface is \n"+
  ...
  set_armor_params("other|fire",0,-100,0);   /* -30 damage from fire */
  set_armor_params("other|ice",0,100,0);     /* -30 damage from ice */
