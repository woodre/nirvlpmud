...
reset(arg)  {
  ...
  set_short(RED+"Fire Demon"+NORM);
  set_long(
          RED+"The demon is an enormous writhing mass, formed out of Mass\n"+
          "of burning red tentacles.  Here and there, the demon's surface is \n"+
  ...
  set_armor_params("other|fire",0,80,0); /* -80 damage from dark */
  set_armor_params("other|ice",0,-80,0); /* +80 damage from dark */
