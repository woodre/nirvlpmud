...
reset(arg)  {
  ...
  set_name("stone demon");
  set_race("chaos");
  set_alt_name("stone");
  set_alias("demon");

  set_short(HIC+"AIR Demon"+NORM);
  set_long(
          HIW+"The demon is an enormous writhing mass, formed out of hunks\n"+
          "of mystical tubes.  Here and there, the demon's pale, dull surface is  \n"+
