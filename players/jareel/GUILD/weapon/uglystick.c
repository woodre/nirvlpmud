...
inherit "players/jareel/GUILD/weapon/weapon.c";
...
reset(arg){
	...
	set_weight(1);
	set_value(0);
	add_special_fun("/players/jareel/GUILD/weapon/powers/death.c");
   add_special_fun("/players/jareel/GUILD/weapon/powers/greed.c");
   add_special_fun("/players/jareel/GUILD/weapon/powers/glacier.c");
   add_special_fun("/players/jareel/GUILD/weapon/powers/magi.c");
   add_special_fun("/players/jareel/GUILD/weapon/powers/cleansing.c");
