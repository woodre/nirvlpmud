...
reset(arg) {
  ...
  dest_dir = ({
    "/players/mythos/aroom/forest/forest8.c","north",
    "/players/mythos/aroom/forest/forest5.c","east",
    "/players/mythos/aroom/forest/pool.c","south",
    "/players/mythos/aroom/forest/pathway2.c","west",
  });
} }
