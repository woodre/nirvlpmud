/*  10/08/06 - Rumplemintz: changed spell_dam to rspell_dam to remove conflict with pretypes.c */
#include "/obj/living_pretypes.h"
#include "/obj/clean.c"
...
int spell_chance, rspell_dam, pet_command, wander;
...
heart_beat()
{
	...
	call_other(attacker_ob, "hit_player", random(rspell_dam));
    }
