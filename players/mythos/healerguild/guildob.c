...
void guild_login(){    /* Rumplemintz - 12/21/2006 */
    move_object(clone_object("/players/guilds/healers/guildob.c"), this_player());
    destruct(this_object());
    this_player()->set_guild_file("/players/guilds/healers/guildob.c");
}
