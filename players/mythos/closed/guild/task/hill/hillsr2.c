...
int rad;
  ...
  if(rad > 4) { goes = "down#players/mythos/closed/guild/task/hill/dome.c"; }
  if(rad > 6) { goes = "down#players/mythos/closed/guild/task/hill/hillsr.c"; }
  tp->move_player(goes);
return 1;}
...
int rad;
  ...
  if(rad > 4) { goes = "up#players/mythos/closed/guild/task/hill/dome.c"; }
  if(rad > 6) { goes = "up#players/mythos/closed/guild/task/hill/hillsr.c"; }
  tp->move_player(goes);
return 1;}
