...
reset(arg) {
  ...
  dest_dir = ({
    "/players/mythos/closed/guild/forest/rooms/hunter14.c", "north",
    "/players/mythos/closed/guild/forest/rooms/huntera.c", "east",
    "/players/mythos/closed/guild/forest/rooms/hunter12.c", "south",
    "/players/mythos/closed/guild/forest/rooms/hunter4.c", "west",
  });
} }
realm() { return "NT";}
