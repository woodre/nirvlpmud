...
reset(arg) {
  if(!arg) {
  set_light(1);
    short_desc = "Library: ** People Stacks **";
    long_desc =
    "You are in a room filled with books.  The books here are\n"+
    "biographies, autobiographies, and interviews of the famous\n"+
    "and infamous of Nirvana.  'Search' the stacks to find the books\n"+
