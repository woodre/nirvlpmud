...
reset(arg) {
  if(!arg) {
  set_light(1);
    short_desc = "Library: ** Lands Stacks **";
    long_desc =
    "You are in a room filled with books.  Books which cover\n"+
    "the exploits of other adventurers into other lands.  'Search'\n"+
    "through the stacks to find the books for you to 'read to your\n"+
    "heart's content!\n";
  items = ({
