...
status Busy;
string owned;  /* Removed 'name' from string define - not used
                  11-5-2007 - Rumplemintz   */
int hp, ac, wc, guard;
int timed;
...
*/
           ...
           "                          - A Mythos Product <6-9-95>\n"+
           "\nYou can add color to your pet's name using the $\n"+
           "standards.... check out 'help moncolor' for more\n"+
           "information.\n");
   set_level(1);
   set_hp(1);
   set_wc(1);
