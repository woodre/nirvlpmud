...
long_desc =
      ...
      HIK+"   ######"+HIW+"|"+HIK+"######\n"+
          ...
          "   ##"+HIW+"/   |   \\"+HIK+"##\n"+
          "   #"+HIW+"/    |    \\"+HIK+"#\n"+
      HIW+"  B-"+HIW+"|---"+HIM+"GGG"+HIW+"---"+HIM+"*"+HIW+"-C\n"+
      HIK+"   #"+HIW+"\\    |    /"+HIK+"#\n"+
          "   ##"+HIW+"\\   |   /"+HIK+"##\n"+
          "   ###"+HIW+"'-----'"+HIK+"###\n"+
          "   ######"+HIW+"|"+HIK+"######\n"+
...
dest_dir = ({
  RMS+"center/cellChall.c",       "east",
  RMS+"center/center_hall17",     "west",
  RMS+"center/center_hall15",     "northwest",
  RMS+"center/center_hall20",     "southwest",
});
}
