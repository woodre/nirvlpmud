...
id(str) { return (::id(str) || str == "convict" || str == "con" || str == "yakuza" ); }
...
reset(arg){
  ...
  set_alias("Yakuza");
  set_gender("male");
  set_short("A member of the Yakuza");
  set_long(
    "xxx\n"+
    "xxx\n"+
	"xxx\n"+
  ...
  set_chat_chance(10);
  load_chat(
    "The yakuza drops into a Tiger Fist stance and windmills his arms around.\n");
  set_a_chat_chance(10);
  load_a_chat(
    "The yakuza hollars for help from his nearby gang.\n");
