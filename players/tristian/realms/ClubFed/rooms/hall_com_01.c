...
short_desc = HIR+"Club Fed"+NORM+" Hallway"; 

long_desc =
	" This is a hallway between the Cellblocks in"+HIR+" Club Fed"+NORM+", the minimum\n"+
	"security facility where white collar criminals and celebrities \n"+
	"come to serve their sentences for their crimes against society.\n";
add_property("NT");
