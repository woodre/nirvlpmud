...
reset(arg){
   ...
   set_long("A prison quality tatto of a naked woman. You can use this\n"+
	   "tattoo to talk directly with Tristian, if he is here.\n"+
...
*/
    ...
    tell_object(atell,""+BOLD+GRN+":::::"+this_player()->query_name()+" : "+str+NORM+"\n");
	return 1;
	}
...
*/
	...
	write_file ("/players/tristian/log/TELLER", msg);
 	tell_object(atelle,""+BOLD+GRN+":::::"+this_player()->query_name()+" "+str+NORM+"\n");
	return 1;
	}
