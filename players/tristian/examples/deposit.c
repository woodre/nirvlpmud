...
#define SAVEDEPOSIT "players/cronos/bank/deposits/"
/* Dar's Code 'Thanks Dar' */
int deposit_amount;
static int amount;
...
init() {
	...
	if(TPRN == "jareel" || TPRN == "stone" || TPRN == "konya" || TPRN == "justin" || TPRN == "bone" || TPRN == "cooper" || TPRN =="magus")
