...
"shedding enough light for you to see by. The passage itself heads back west to\n"+
"the main cave, and east deeper into the rock.\n";
...
"cave","The main cave of the complex is west from here",
"passage","The passage runs west into the main cave and east into darkness",
