...
{   if (arg) return;
   ...
   set_short("A "+HIC+"softly glowing"+NORM+" portal");
...
enter_portal(str)  {
  if(str == "portal")  {
if((this_player()->query_level() > 18) && (this_player()->query_level() < 20)) {
write("You are too high in level to enter this portal.\n");
return 1; }
  write("You feel the energy of the glowing portal flow into your body\n"+
        "as you enter the portal.\n");
  this_player()->move_player("through the portal#players/daranath/wastes/entry.c");
return 1;
        }
