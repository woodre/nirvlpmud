/* Taken from Saber's Kung fu weapons with full permisson of Saber himself. 
   I build this kung fu style for my wife, who also muds here.
          -Dar */
...
set_alias("kitten");
set_type("martial");         /* set type added by Pavlik */
set_alt_name("kung fu");
set_short("Pouncing Kitten Style Kung Fu");
set_long("The knowledge and mastery of the legendary Master Monk Kaya. She\n"+
         "developed this fighting style called the Pouncing Kitten.\n"+
         "It is a deadly weapon in the right hands.\n");
set_class(18);
set_weight(3);
set_value(3500);
