...
write("1: "+HIW+"Recall Orb"+NORM+"             100      200          \n");
write("2: "+HIW+"Breathing Scarf"+NORM+"        100      250          \n");
...
write("6: "+HIW+"Piece of Flesh"+NORM+"         1700     750        Food Heal\n");
write("7: "+HIW+"Shard of Bone"+NORM+"          1700     750        Drink Heal\n");
write("8: "+HIW+"Rancid Ichor "+NORM+"          1700     750        Combo Heal\n");
write("9: "+HIW+"Wand of Immolation"+NORM+"     500      15000      Unique Item\n");
write(WHT+"<--------------------------------------------------------------->"+NORM+"\n");
}
...
if((!(str == "bone")) && (!(str == "scarf")) && (!(str == "flesh")) && (!(str == "blood")) && (!(str == "essence")) && (!(str == "orb")) && (!(str == "wand")) && (!(str == "ichor")) && (!(str == "hook"))) {
write("What exactly do you want to purchase?.\n");
write("Please use: buy <scarf, hook, orb, essence, blood, ichor, flesh, wand or bone>\n");
return 1; }
...
if(str == "orb") {
value = 100; creds = 200; ob = clone_object(ROOT+"recall_orb.c");
}
if(str == "essence") {
...
if(str == "flesh") {
value = 1700; creds = 750; ob = clone_object(ROOT+"flesh.c");
}
if(str == "ichor") {
value = 1700; creds = 750; ob = clone_object(ROOT+"ichor.c");
}
if(str == "bone") {
value = 1700; creds = 750; ob = clone_object(ROOT+"bone.c");
}
if(str == "wand") {
