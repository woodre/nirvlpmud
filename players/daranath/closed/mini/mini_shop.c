int is_succubus, is_larn, is_gypsy, is_kender, is_blade, is_goth, is_feline;
...
int count;
  ...
  if(is_goth && !present("goth_obj", this_player())) move_object(clone_object("/players/saber/closed/new_mini/goth.c"), this_player());
...
nix(str)  {
  ...
  if(str != "succubus" && str != "gypsy" && str != "kender" && str != "blade" && str != "goth" && str != "feline" && str != "larn")  {
