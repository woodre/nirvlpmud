...
write("Items for sale at the East Road Shop:\n"+
 ...
 "           A large shield           :  450 gold coins\n"+
 "           Rat on a stick           :  450 gold coins\n"+
 "           Chainmail armor          :  600 gold coins\n"+
...
else if (str == "shield" || str == "large shield")  {
  write("You buy a large shield.\n");
   value = 450;
if(TPM<value){write("You don't have "+value+" coins.\n");return 1;}
move_object(clone_object("/players/daranath/qualtor/obj/crusader_sh.c"),this_player());
}
else if (str == "sandles") {
