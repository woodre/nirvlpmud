...
{   if (arg) return;
   ...
   set_id("portal");
   set_alias("dark red portal");
   set_short("A "+HIR+"dark red"+NORM+" glowing portal");
   set_long("A glowing portal swirling with a dark red color, this seems to\n"+
...
enter_portal(str)  {
  ...
  this_player()->move_player("through the portal#players/daranath/qualtor/portal1.c");
return 1;
        }
