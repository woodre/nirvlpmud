#define SAVEDEPOSIT "players/daranath/qualtor/docs/deposits/"
int deposit_amount;
static int amount;
...
init() {
  ...
  if(this_player()->query_real_name() == "daranath") add_action("deposit_list","deposit_list");
}
...
deposit_list() {
  ...
  write("\n ----------------------------------------------------\n\n");
  restore_object(SAVEDEPOSIT+"daranath");
return 1; }
