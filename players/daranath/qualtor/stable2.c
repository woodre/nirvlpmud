...
short_desc= (BLK+BOLD+"City of Qual'tor "+NORM+"(City Stables)");
    ...
    dest_dir=({
      "/players/daranath/qualtor/stable3.c","north",
      "/players/daranath/qualtor/stable1.c","south",
      "/players/daranath/qualtor/stable5.c","east",
      "/players/daranath/qualtor/stable4.c","west",
    });
