...
move_object(clone_object("/players/daranath/qualtor/folk/obj/quarterstaff.c"),this_object());
...
init_command("wield quarterstaff");
...
load_chat("Qual'tor Guardsman says: Take care of yourself.\n");
