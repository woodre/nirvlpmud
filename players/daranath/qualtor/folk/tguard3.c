...
move_object(clone_object("/players/daranath/qualtor/folk/obj/warhammer.c"),this_object());
...
load_chat("Guardsman slaps the warhammer down into his hand and glares at you.\n");
