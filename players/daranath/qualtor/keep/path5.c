...
reset(int arg){
  ...
  if(!arg){
    ...
    set_light(1);
    short_desc= "Within the shadow of the ruined Keep";
    long_desc=
   ...
   "darkness","The dark can hide many enemies from view",
    ...
    dest_dir=({
     "/players/daranath/qualtor/keep/path4.c","south",
     "/players/daranath/qualtor/keep/entry.c","east",
      "/players/daranath/qualtor/keep/area3.c","west",
    });
