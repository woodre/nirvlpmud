...
set_light(1);
short_desc= "Dark Graveyard <1st row>";
long_desc=
...
dest_dir=({
"/players/daranath/qualtor/keep/grave6.c","north",
"/players/daranath/qualtor/keep/grave1.c","south",
"/players/daranath/qualtor/keep/grave4.c","east",
"/players/daranath/qualtor/keep/grave3.c","west",
    });
