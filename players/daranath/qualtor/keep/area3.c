...
reset(int arg){
  if(!arg){
    ...
    set_light(1);
    short_desc= "Just outside the Ruined Keep";
    long_desc=
    ...
    dest_dir=({
      "/players/daranath/qualtor/keep/area4.c","north",
      "/players/daranath/qualtor/keep/area2.c","south",
      "/players/daranath/qualtor/keep/path5.c","east",
      "/players/daranath/qualtor/keep/gard1.c","west",
    });
