...
reset(int arg){
  ...
  if(!arg){
    ...
    set_light(1);
    short_desc= "Outside the ruined Servant's Quarters";
    long_desc=
   ...
   "toes","You know what your toes look like",
    ...
    dest_dir=({
     "/players/daranath/qualtor/keep/path4.c","north",
     "/players/daranath/qualtor/keep/path2.c","west",
     "/players/daranath/qualtor/keep/serv1.c","enter",
    });
