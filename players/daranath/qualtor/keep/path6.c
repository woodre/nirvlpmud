...
reset(int arg){
  ...
  if(!arg){
    ...
    set_light(1);
    short_desc= "Stone road to the Graveyard";
    long_desc=
     "The shadow of the ruined keep falls all about the area, continually\n"+
     "keeping the pathway in darkness. The path itself turns north from\n"+
   ...
   "darkness","The dark can hide many enemies from view",
    ...
    dest_dir=({
     "/players/daranath/qualtor/keep/path7.c","north",
      "/players/daranath/qualtor/keep/entry.c","west",
    });
