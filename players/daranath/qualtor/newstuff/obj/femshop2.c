...
if((!(str == "sash")) && (!(str == "dress")) && (!(str == "boots")) && (!(str == "vest")) && (!(str == "skirt")) && (!(str == "box")) && (!(str == "catsuit")) && (!(str == "mace")) && (!(str == "chainmail"))) {
write("What exactly do you want to purchase?.\n");
write("Please use: buy <scarf, hook, saw, essence, blood, flesh or bone>\n");
return 1; }
...
if(str == "flesh") {
value = 1750; creds = 800; ob = clone_object(ROOT+"flesh.c");
}
if(str == "bone") {
value = 1750; creds = 800; ob = clone_object(ROOT+"bone.c");
}
