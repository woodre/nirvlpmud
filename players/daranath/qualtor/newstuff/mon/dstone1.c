...
move_object(clone_object(ROOT+"weps/dstone_bril.c"),this_object());
...
set_spell_mess2("Darkstone giant spins with the Bril'thir, twisting it around ...\n\n"+
     "The Giant slashes repeatedly with the viscious weapon.\n");
