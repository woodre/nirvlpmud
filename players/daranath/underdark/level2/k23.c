...
reset(int arg){
  if(!arg){
    ...
    dest_dir=({
      "/players/daranath/underdark/level2/k24.c","east",
      "/players/daranath/underdark/level2/k22.c","west",
      "/players/daranath/underdark/level2/trog_entry.c","south",
    });
    ...
    search(){
    write("You find clawed footprints running about the area.\n");
