...
reset(int arg){
  if(!arg){
    ...
    long_desc=
      ...
      "portal to the east glows with a green glow, while the one on the\n"+
      "western wall has a bright white hue to it.\n";
    ...
    dest_dir=({
      "/players/daranath/underdark/level2/hall1.c","north",
      "/players/daranath/underdark/level2/hall3.c","south",
    });
    ...
    path = "/players/daranath/underdark/level2/vengeance.c";}
    if(str == "green portal"){
    msg = "\n\nThe mist of the portal engulfs you as you step into it.\n"+
           "Emotions strike your body with a wave of force, washing over\n"+ 
           "you and filling your mind with thoughts of\n\n"+
           "      "+HIG+"JEALOUSY"+NORM+"  \n\n"+
           "As your mind clears, you find yourself someplace else.\n";
    path = "/players/daranath/underdark/level2/jealousy.c";}
    write(msg);
    if(path) {
