...
reset(int arg){
  if(!arg){
    ...
    dest_dir=({
      "/players/daranath/underdark/level2/stairs2.c","northeast",
      "/players/daranath/underdark/level2/tunnel1.c","southwest",
    });
