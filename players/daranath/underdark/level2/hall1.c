...
reset(int arg){
  if(!arg){
    ...
    long_desc=
      ...
      "portal to the east glows with a magenta glow, while the one on\n"+
      "the western wall has a bright red hue to it.\n";
    ...
    dest_dir=({
      "/players/daranath/underdark/level2/hall2.c","south",
    });
    ...
    path == "/players/daranath/underdark/level2/damnation.c";}
    if(str == "magenta portal"){
    msg == "\n\nThe mist of the portal engulfs you as you step into it.\n"+
           "Emotions strike your body with a wave of force, washing over\n"+ 
           "you and filling your mind with thoughts of\n\n"+
           "      "+HIM+"RETRIBUTION"+NORM+"  \n\n"+
           "As your mind clears, you find yourself someplace else.\n";
    path == "/players/daranath/underdark/level2/retribution.c";}
    write(msg);
