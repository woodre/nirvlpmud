...
move_object(clone_object("/players/daranath/mons/un_knight2.c"),this_object());
  if(!arg){
    ...
    long_desc=
      "Doubling back upon itself, the marble hall runs from the northwest\n"+
      "back unto the west. A large granite archway is mounted into the\n"+
      "walls further down the western tunnel. A soft, rolling mist is\n"+
    ...
    items=({
      ...
      "dirt", "The dirt spills about the area, covering the white stone\n"+
              "floor and walls",
      "arch", "The large granite archway leads westward into a small\n"+
              "room filled with a strange mist",
      "archway", "The large granite archway leads westward into a small\n"+
                 "room filled with a strange mist",
      "mist", "A light blue colored mist is flowing through the archway\n"+
              "to the west from here. It is cool to the touch",
     });

    dest_dir=({
      "/players/daranath/underdark/crypt/hall3.c","northwest",
      "/players/daranath/underdark/crypt/death.c","west",
    });
