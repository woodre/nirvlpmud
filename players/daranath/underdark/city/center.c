...
items=({
  ...
  dest_dir=({
 "/players/daranath/underdark/city/main5.c","north",
 "/players/daranath/underdark/city/main4.c","south",
 "/players/daranath/underdark/city/teken1.c","east",
 "/players/daranath/underdark/city/west1.c","west",
           });
  }
}
