...
reset(int arg){
move_object(clone_object("/players/daranath/mons/carrion_cr.c"),this_object());
 if(!arg){
...
items=({
 ...
 "walls", "The rough hewn walls surround you, encasing you within the\n"+
  ...
  dest_dir=({
 "/players/daranath/underdark/level1/d,6.c","west",
 "/players/daranath/underdark/level1/e,7.c","south",
           });
  }   }
init(){
 ::init();
