...
reset(int arg){
 if(!arg){
  ...
  "that you are not along. Directly to the north from your position, the\n"+
  "tunnels seems to end, and smooth marble floor, walls and ceiling starts\n"+
  "from there and continues northward.\n";
...
items=({
 ...
 "walls", "The rough hewn walls surround you, encasing you within the\n"+
          "darkness all about",
 "marble", "White marble lines the flooring and walls of the hallway to\n"+
           "the north, making it seem completely out of place",
 "hallway", "The hall to the north leads into darkness",
 });

  dest_dir=({
 "/players/daranath/underdark/level1/c,11.c","south",
           });
  }   }
init(){
 ::init();
