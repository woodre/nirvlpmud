...
items=({
 ...
 "walls", "The rough hewn walls surround you, encasing you within the\n"+
  ...
  dest_dir=({
 "/players/daranath/underdark/level1/i,11.c","north",
 "/players/daranath/underdark/level1/k,11.c","south",
 /* "/players/daranath/underdark/level1/k,12.c","southeast", */
/* "/players/daranath/underdark/level1/sp_haven1.c","west", */
           });
  }   }
init(){
 ::init();
