...
move_object(clone_object("/players/daranath/mons/elven_slave.c"),this_object());
 ...
 if(!arg){
  ...
  long_desc=
   ...
   "giant mushrooms can be seen here. The cavern extends to the north,\n"+
   "south and west while the walls meet some 30 feet overhead on the\n"+
   "domed ceiling.\n";
...
items=({
 ...
 "darkness", "The darkness leaves you wondering what might be hidden in"+
  ...
  dest_dir=({
 "/players/daranath/underdark/level1/farm3.c","north",
 "/players/daranath/underdark/level1/farm5.c","south",
  "/players/daranath/underdark/level1/farm7.c","east",
 "/players/daranath/underdark/level1/farm1.c","west",
           });
  }   }
init(){
 ::init();
