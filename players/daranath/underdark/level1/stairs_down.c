...
reset(int arg){
 if(!arg){
  ...
  "that you are not alone. The tunnel slopes downward from here, leading\n"+
  "into the unknown.\n";
...
items=({
 ...
 "walls", "The rough hewn walls surround you, encasing you within the\n"+
  ...
  dest_dir=({
 "/players/daranath/underdark/level1/n,7.c","northeast",
 "/players/daranath/underdark/level2/entry.c","down",
           });
  }   }
init(){
 ::init();
