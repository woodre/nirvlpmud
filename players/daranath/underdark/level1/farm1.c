...
move_object(clone_object("/players/daranath/mons/elven_slave.c"),this_object());
 ...
 if(!arg){
  ...
  long_desc=
   ...
   "south and east while the walls meet some 30 feet overhead on the\n"+
   "domed ceiling.\n";
...
items=({
 ...
 "darkness", "The darkness leaves you wondering what might be hidden in"+
  ...
  dest_dir=({
 "/players/daranath/underdark/level1/farm2.c","north",
 "/players/daranath/underdark/level1/farm6.c","south",
 "/players/daranath/underdark/level1/farm4.c","east",
 "/players/daranath/underdark/level1/e,11.c","west",
           });
  }   }
init(){
 ::init();
