...
reset(int arg){
 if(!arg){
  ...
  "that you are not alone. Blood is trickling along the floor from the\n"+
  "tunnel to the north.\n";
...
items=({
 ...
 "blood", "The dark red liquid is commonly found amongst the tunnels of\n"+
  ...
  dest_dir=({
  "/players/daranath/underdark/level1/bloodpool.c","north",
  "/players/daranath/underdark/level1/f,5.c","east",
           });
  }   }
init(){
 ::init();
