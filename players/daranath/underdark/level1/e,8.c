...
reset(int arg){
 if(!arg){
  ...
  "that you are not alone. A warm glow is coming from a small cave to\n"+
  "the east.\n";
...
items=({
 ...
 "walls", "The rough hewn walls surround you, encasing you within the\n"+
  ...
  dest_dir=({
 "/players/daranath/underdark/level1/f,8.c","south",
 "/players/daranath/underdark/level1/fire.c","east",
           });
  }   }
init(){
 ::init();
