...
items=({
 ...
 "walls", "The rough hewn walls surround you, encasing you within the\n"+
  ...
  dest_dir=({
/* "/players/daranath/underdark/level1/sp_haven5.c","north", */
 "/players/daranath/underdark/level1/n,8.c","east",
/* "/players/daranath/underdark/level1/stairs_down.c","southwest", */
           });
  }   }
init(){
 ::init();
