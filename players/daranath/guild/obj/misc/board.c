...
#define ERROR_LOG "/players/daranath/guild/docs/BOARD_ER"
#define BOARD_NAME "players/daranath/guild/docs/BOARD"
...
remove_msg(what_msg) {
    ...
    if((this_player()->query_real_name() != lower_case(player) &&
       this_player()->query_level() < 70) ||
		...
		write("Only GCs may remove other peaple's notes.\n");
