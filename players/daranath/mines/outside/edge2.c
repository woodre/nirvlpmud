...
reset(int arg){
  if(!arg){
    ...
    dest_dir=({
      "/players/daranath/mines/outside/walk.c","north",
      "/players/daranath/mines/outside/climb4.c","south",
      "/players/daranath/mines/outside/edge3.c","east",
      "/players/daranath/mines/outside/edge1.c","west",
    });
