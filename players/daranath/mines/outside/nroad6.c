...
reset(int arg){
  if(!arg){
    ...
    dest_dir=({
      "/players/daranath/mines/outside/nend.c","north",
      "/players/daranath/mines/outside/nroad5.c","south",
      "/players/daranath/mines/outside/clear.c","east",
      "/players/daranath/mines/outside/cave1.c","west",
    });
