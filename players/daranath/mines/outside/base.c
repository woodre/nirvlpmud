...
reset(int arg){
  if(!arg){
    ...
    dest_dir=({
     "/players/daranath/mines/outside/extra.c","south",
     "/players/daranath/mines/outside/path3.c","west",
     "/players/daranath/mines/outside/climb1.c","up",
    });
