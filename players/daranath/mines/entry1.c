...
reset(int arg){
move_object(clone_object("/players/daranath/mines/obj/dw_corpse.c"),this_object());
  if(!arg){
...
short_desc= (BOLD+BLK+"City of Qual'tor"+NORM+" (Northern Realms)");
    ...
    dest_dir=({
      "/players/daranath/mines/entry2.c","enter",
      "/players/daranath/clearing/mtrail9.c","south",
    });
    ...
    dar_enter(){
    write("That area is currently under construction.\n"+
          "Thanks...  -Daranath\n");
    return 1;
    }
