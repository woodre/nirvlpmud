...
short(){ return BOLD+"The zombie of "+capitalize(name)+OFF; }
long(){  
  write("The undead skeleton of "+capitalize(name)+".  It stand errect, held together only\n"+
...
set_name(n){ name = n; cap_name = BOLD+capitalize(name)+"'s zombie carcass"+OFF; }
set_level(l){ lev = l; }
