...
short_desc= "Storm Mountain (Peak)";
    long_desc=
      "The clearing at the top of the mountain spreads about to the north\n"+
      "and west from here, large rocky walls encasing the area in\n"+
    ...
    dest_dir=({
      "/players/daranath/clearing/marea6.c","north",
      "/players/daranath/clearing/marea4.c","west",
    });
