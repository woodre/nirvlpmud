...
short_desc= (BOLD+"DarkenWood"+NORM+" (Deep Forest)");
  ...
  "extend in all directions about you. A small path leads off to the\n"+
  "west from here.\n";
...
dest_dir=({
 "/players/daranath/clearing/dwood10.c","north",
 "/players/daranath/clearing/dwood12.c","south",
 "/players/daranath/clearing/dwood8.c","east",
 "/players/daranath/clearing/kobold2.c","west",
           });
        }
        }
