...
short_desc= (BOLD+"DarkenWood"+NORM+" (Northern Pathway)");
    long_desc=
      ...
      "exsists within the area to cast deep shadows all about. Through\n"+
    ...
    dest_dir=({
      "/players/daranath/clearing/mpath3.c","north",
      "/players/daranath/clearing/dwood9.c","south",
      "/players/daranath/clearing/mpath2.c","east",
      "/players/daranath/clearing/shrine1.c","west",
    });
