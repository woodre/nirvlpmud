...
move_object(clone_object("/players/daranath/mons/kobold5.c"),this_object());
move_object(clone_object("/players/daranath/mons/kobold0.c"),this_object());
    set_light(1);
short_desc= (BOLD+"DarkenWood"+NORM+" (Kobold Village)");
  ...
  "into its front. A small graveyard sits to the north.\n";
...
dest_dir=({
/*
 "/players/daranath/clearing/kobold_grave.c","north",
*/
