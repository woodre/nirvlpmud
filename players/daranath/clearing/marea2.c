...
short_desc= "Storm Mountain (peak)";
    long_desc=
      ...
      "and west from here, large rocky walls encasing the area in an\n"+
      "almost deliberate manner. The dark clouds flash and rumble over-\n"+
      "head, threatening to unleash their fury at you.\n";
    ...
    dest_dir=({
      "/players/daranath/clearing/marea1.c","east",
/*
      "/players/daranath/clearing/marea3.c","west",
*/
      "/players/daranath/clearing/mtent.c","south",
    });
