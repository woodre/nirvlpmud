...
short_desc= (BOLD+"DarkenWood"+NORM+" ("+BLK+BOLD+"Ruined Shrine"+NORM+")");
    ...
    dest_dir=({
      "/players/daranath/clearing/shrine3.c","north",
      "/players/daranath/clearing/dwood10.c","south",
      "/players/daranath/clearing/mpath1.c","east",
      "/players/daranath/clearing/shrine2.c","west",
    });
