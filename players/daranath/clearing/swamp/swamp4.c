...
if(!present("ogre"))  {
for(t=0;t<3;t++)  {
move_object(clone_object("/players/daranath/dar/ogre.c"),this_object());  }  }
if(!present("giant"))  {
for(t=0;t<2;t++)  {
move_object(clone_object("/players/daranath/dar/giant1.c"),this_object());  }
move_object(clone_object("/players/daranath/dar/giant3.c"),this_object());  }
 if(!arg){
  set_light(1);
...
items=({
 "myre","Yes, you are in the Dark Myre",
  ...
  dest_dir=({
 "/players/daranath/dar/rooms/swamp6.c","north",
 "/players/daranath/dar/rooms/swamp1.c","south",
 "/players/daranath/dar/rooms/swamp5.c","west",
           });
  }   }
init(){
 ::init();
