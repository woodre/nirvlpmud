...
if(!present("giant"))  {
for(t=0;t<4;t++)  {
move_object(clone_object("/players/daranath/dar/giant2.c"),this_object());  }  }
 if(!arg){
  set_light(1);
...
items=({
 "myre","Yes, you are in the Dark Myre",
  ...
  dest_dir=({
 "/players/daranath/dar/rooms/cave1.c","west",
 "/players/daranath/dar/rooms/swamp5.c","south",
 "/players/daranath/dar/rooms/swamp6.c","east",
           });
  }   }
init(){
 ::init();
