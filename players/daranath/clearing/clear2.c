...
short_desc= (BOLD+"DarkenWood"+NORM+" (Clearing)");
 ...
 "stands to the northeast from here, while the clearing continues to the\n" +
 "north and east.\n";
...
items=({
 ...
 "fountain", "The stone fountain stands to the north from here",
 });


dest_dir=({
 "/players/daranath/clearing/clear3.c","north",
 "/players/daranath/clearing/clear1.c","east",
 "/players/daranath/clearing/statue.c","northeast",
 "/players/daranath/clearing/dwood1.c","west",
           });
        }
        }
