...
short_desc= (BOLD+"DarkenWood"+NORM+" (Northern Pathway)");
    long_desc=
     ...
     "The pathway leads right up to the center peak.\n";
    ...
    dest_dir=({
      "/players/daranath/clearing/mpath4.c","north",
      "/players/daranath/clearing/mpath1.c","south",
/*
      "/players/daranath/qualtor/mansion/lot12.c","west",
*/
    });
