...
dest_dir=({
 "/players/daranath/clearing/kobold8.c","north",
 "/players/daranath/clearing/kobold9.c","south",
 "/players/daranath/clearing/kobold6.c","east",
 "/players/daranath/clearing/kobold_keep1.c","enter",
           });
        }
        }
