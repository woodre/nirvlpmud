...
dest_dir=({
 "/players/daranath/clearing/dwood12.c","north",
 "/players/daranath/clearing/dwood19.c","south",
 "/players/daranath/clearing/dwood16.c","east",
 "/players/daranath/clearing/dwood18.c","west",
           });
        }
        }
