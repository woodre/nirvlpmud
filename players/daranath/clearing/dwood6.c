...
dest_dir=({
 "/players/daranath/clearing/mpath2.c","north",
 "/players/daranath/clearing/dwood5.c","south",
 "/players/daranath/clearing/dwood3.c","east",
 "/players/daranath/clearing/dwood9.c","west",
           });
        }
        }
