...
dest_dir=({
 "/players/daranath/clearing/dwood6.c","north",
 "/players/daranath/clearing/dwood4.c","south",
 "/players/daranath/clearing/dwood2.c","east",
 "/players/daranath/clearing/dwood8.c","west",
           });
        }
        }
