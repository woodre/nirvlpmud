...
dest_dir=({
 "/players/daranath/clearing/dwood3.c","north",
 "/players/daranath/clearing/dwood1.c","south",
 "/players/daranath/clearing/clear3.c","east",
 "/players/daranath/clearing/dwood5.c","west",
           });
        }
        }
