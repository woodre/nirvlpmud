...
dest_dir=({
 "/players/daranath/clearing/dwood8.c","north",
 "/players/daranath/clearing/dwood16.c","south",
 "/players/daranath/clearing/dwood4.c","east",
 "/players/daranath/clearing/dwood12.c","west",
           });
        }
        }
