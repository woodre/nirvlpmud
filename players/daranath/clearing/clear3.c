...
short_desc= (BOLD+"DarkenWood"+NORM+" (Clearing)");
 ...
 "stands to the east from here, while the clearing continues to the\n" +
 "north and south.\n";
...
items=({
 ...
 "fountain", "The stone fountain stands to the east from here",
 });


dest_dir=({
 "/players/daranath/clearing/clear4.c","north",
 "/players/daranath/clearing/statue.c","east",
 "/players/daranath/clearing/clear2.c","south",
 "/players/daranath/clearing/dwood2.c","west",
           });
        }
        }
