...
short_desc= (BOLD+"DarkenWood"+NORM+" (Clearing)");
 ...
 "stands to the southeast from here, while the clearing continues to the\n" +
 "south and east.\n";
...
items=({
 ...
 "fountain", "The stone fountain stands to the southeast from here",
 });


dest_dir=({
 "/players/daranath/clearing/clear3.c","south",
 "/players/daranath/clearing/clear5.c","east",
 "/players/daranath/clearing/statue.c","southeast",
 "/players/daranath/clearing/dwood3.c","west",
           });
        }
        }
