...
dest_dir=({
 "/players/daranath/clearing/dwood2.c","north",
 "/players/daranath/clearing/dwood14.c","south",
 "/players/daranath/clearing/clear2.c","east",
 "/players/daranath/clearing/dwood4.c","west",
           });
        }
        }
