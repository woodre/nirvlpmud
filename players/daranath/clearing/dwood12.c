...
dest_dir=({
 "/players/daranath/clearing/kobold1.c","north",
 "/players/daranath/clearing/dwood17.c","south",
 "/players/daranath/clearing/dwood7.c","east",
 "/players/daranath/clearing/dwood13.c","west",
           });
        }
        }
