...
short_desc= (BOLD+"DarkenWood"+NORM+" (Clearing)");
 ...
 "stands to the north from here, while the clearing continues to the\n" +
 "east and west.\n";
...
dest_dir=({
 "/players/daranath/clearing/statue.c","north",
 "/players/daranath/clearing/clear2.c","west",
 "/players/daranath/clearing/clear6.c","east",
 "/players/daranath/clearing/path.c","south",
           });
        }
        }
