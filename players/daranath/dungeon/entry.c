...
climb_ladder(){
write("You climb back to the city streets of Qual'tor.\n");
this_player()->move_player("up the iron rung ladder#players/daranath/qualtor/south_gate.c");
return 1;
}
