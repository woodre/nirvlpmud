...
reset(int arg){
  if(!arg){
    ...
    set_light(1);
    short_desc= " Entry into a small Village";
    long_desc=
  ...
  "trail","The road narrows into little more then a trail leading east",
    ...
    dest_dir=({
  "/players/daranath/outside/vil_one.c","north",
  "/players/daranath/outside/vil_four.c","south",
  "/players/daranath/outside/vil_center.c","east",
  "/players/daranath/outside/west_vil.c","west",
    });
...
search(){
write("The mud within the village obscures anything of interest.\n");
