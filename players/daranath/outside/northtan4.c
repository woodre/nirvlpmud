...
reset(int arg){
  if(!arg){
    ...
    set_light(1);
    short_desc= "Tanner's Road North";
    long_desc=
  ...
  "trail","The road narrows into little more then a trail leading east",
    ...
    dest_dir=({
  "/players/daranath/outside/northtan5.c","north",
  "/players/daranath/outside/northtan3.c","south",
  "/players/daranath/outside/dtrail1.c","east",
    });
