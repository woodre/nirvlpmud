...
move_object(clone_object("/players/daranath/weps/unded_spear.c"),this_object());
move_object(clone_object("/players/daranath/arms/unded_gaunt.c"),this_object());
