...
short() { return GRN+"Bunch of green leaves "+NORM+BOLD+"["+NORM+GRN+uses+NORM+BOLD+"]"+NORM; }  
long(){
   write(
"    A bunch of magical green leaves collected and wrapped together. Warriors\n"+
"have been using these leaves for centuries to increase their health and stat\n"+
"of mind.\n"+   
