...
short() { return RED+"Bunch of red leaves "+NORM+BOLD+"["+NORM+RED+uses+NORM+BOLD+"]"+NORM; }  
long(){
   write(
"    A bunch of magical red leaves collected and wrapped together. These\n"+
"leaves were used for centuries by the puplic to increase their health and\n"+
"stat of mind.\n"+   
"It has "+RED+"["+uses+"]"+NORM+" bites left in it.\n"); }
