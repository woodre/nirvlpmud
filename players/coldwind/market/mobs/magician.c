...
short() {
  return "Farha, the magician";
}

long() {
  write(
    "Farha is an old woman. She has great knowledge of white and black magic,\n"+
    "and the preperation of most spells; nevertheless, Farha quit magic and\n"+
	"now use her reputation as a powerful magician to sell some simple tricks\n"+
	"in this shop. You can 'ask' her for a list of what she sells.\n");
}
