...
set_short(HIW+"Cleaver "+HIK+"of the giant"+NORM);
set_long(HIW+
" A huge white cleaver made from a strange material. On its cold handle,\n"+
""+HIW+"in black letters, carved one word....\n"+
" \n"+
""+HIK+"                           A S H G A N                 \n"+NORM);
set_type("knife");
set_class(18);
set_weight(4);
set_value(1000);
/* dark forces implies dark damage - <ill> may 2005
...
if(W>10)  {
  say(HIK+"Dark mist encircles "+user+"'s cleaver."+NORM+"\n"+
"                         "+HBWHT+HIB+" A S H G A N "+NORM+"\n"+ 
""+HIK+"                                "+ attacker->query_name() + " is hit by an invisible force."+NORM+"\n");

  write(HIK+"Dark mist encircles your cleaver."+NORM+"\n"+
"                         "+HBWHT+HIB+" A S H G A N "+NORM+"\n"+
