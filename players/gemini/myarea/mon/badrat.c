...
reset(arg) {
  ...
  set_short("A bad rat");
  set_long(
"     This rat is about 4 inches long and does seem to want to hurt\n"+
"you with great pain. It has a scar across its face like it got into\n"+
"a brawl with another animal. It is brown in color and looks to be\n"+
