...
if(!present("sloth")) {
move_object(clone_object("/players/katya/area/esquire/goonies/m/sloth.c"),this_object());
}
...
The soil on the ground is blended with rubble from the jagged wall.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/t41",  "west",
        "/players/katya/area/esquire/goonies/r/t43",  "south",
        "/players/katya/area/esquire/goonies/r/D5",  "north",
   });}
