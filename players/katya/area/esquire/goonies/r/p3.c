...
path seems to be leading somewhere, seemingly dangerous.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/p2",  "west",
        "/players/katya/area/esquire/goonies/r/p4",  "east",
        "/players/katya/area/esquire/goonies/r/D3",  "south",
        "/players/katya/area/esquire/goonies/r/t12",  "north",
   });}
