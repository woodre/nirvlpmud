...
if(!present("brandon")) {
move_object(clone_object("/players/katya/area/esquire/goonies/m/brandon.c"),this_object());
}
...
The dark, damp tunnel sharply curves in many different directions.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/t13",  "east",
        "/players/katya/area/esquire/goonies/r/t11",  "west",
        "/players/katya/area/esquire/goonies/r/t18",  "north",
   });}
