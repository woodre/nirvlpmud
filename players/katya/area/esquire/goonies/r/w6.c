...
object hovers over the water in the distance.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/w5.c",  "north",
        "/players/katya/area/esquire/goonies/r/w7.c",  "south",
        "/players/katya/area/esquire/goonies/r/wt8.c",  "west",
        "/players/katya/area/esquire/goonies/r/wt12.c",  "southwest",
   });}
