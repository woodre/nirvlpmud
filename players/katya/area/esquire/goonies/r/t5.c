...
if(!present("data")) {
move_object(clone_object("/players/katya/area/esquire/goonies/m/data.c"),this_object());
}
...
The dark, damp tunnel sharply curves in many different directions.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/t4",  "west",
        "/players/katya/area/esquire/goonies/r/t6",  "east",
        "/players/katya/area/esquire/goonies/r/t18",  "south",
   });}
