...
if(!present("stef")) {
move_object(clone_object("/players/katya/area/esquire/goonies/m/stef.c"),this_object());
}
...
The dark, damp tunnel sharply curves in many different directions.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/t4",  "east",
        "/players/katya/area/esquire/goonies/r/t2",  "south",
   });}
