...
object hovers over the water in the distance.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/w13.c",  "north",
        "/players/katya/area/esquire/goonies/r/w11.c",  "southeast",
        "/players/katya/area/esquire/goonies/r/wt9.c",  "northeast",
   });}
