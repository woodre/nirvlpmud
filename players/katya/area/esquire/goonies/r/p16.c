...
if(!present("andy")) {
move_object(clone_object("/players/katya/area/esquire/goonies/m/andy.c"),this_object());
}
...
path seems to be leading somewhere, seemingly dangerous.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/p15",  "north",
        "/players/katya/area/esquire/goonies/r/p17",  "south",
        "/players/katya/area/esquire/goonies/r/t26",  "west",
   });}
