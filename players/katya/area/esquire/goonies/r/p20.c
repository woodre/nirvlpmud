...
path seems to be leading somewhere, seemingly dangerous.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/p19",  "west",
        "/players/katya/area/esquire/goonies/r/D4",  "east",
        "/players/katya/area/esquire/goonies/r/t30",  "south",
        "/players/katya/area/esquire/goonies/r/p21",  "north",
   });}
