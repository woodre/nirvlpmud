...
if(!present("mikey")) {
move_object(clone_object("/players/katya/area/esquire/goonies/m/mikey.c"),this_object());
}
...
The soil on the ground is blended with rubble from the jagged wall.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/p9",  "north",
        "/players/katya/area/esquire/goonies/r/D1",  "south",
   });}
