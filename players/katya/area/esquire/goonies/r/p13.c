...
path seems to be leading somewhere, seemingly dangerous.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/p14",  "east",
        "/players/katya/area/esquire/goonies/r/t25",  "south",
        "/players/katya/area/esquire/goonies/r/t26",  "north",
        "/players/katya/area/esquire/goonies/r/p12",  "west",
   });}
