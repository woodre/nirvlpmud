...
The dark, damp tunnel sharply curves in many different directions.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/p11",  "west",
        "/players/katya/area/esquire/goonies/r/p15",  "east",
        "/players/katya/area/esquire/goonies/r/p13",  "north",
        "/players/katya/area/esquire/goonies/r/t24",  "south",
   });}
