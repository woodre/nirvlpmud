...
path seems to be leading somewhere, seemingly dangerous.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/p8",  "north",
        "/players/katya/area/esquire/goonies/r/p10",  "east",
        "/players/katya/area/esquire/goonies/r/t17",  "south",
        "/players/katya/area/esquire/goonies/r/t23",  "west",
   });}
