...
object hovers over the water in the distance.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/w4.c",  "northwest",
        "/players/katya/area/esquire/goonies/r/w6.c",  "south",
        "/players/katya/area/esquire/goonies/r/wt4.c",  "west",
        "/players/katya/area/esquire/goonies/r/wt8.c",  "southwest",
   });}
