...
object hovers over the water in the distance.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/w12.c",  "south",
        "/players/katya/area/esquire/goonies/r/wt9.c",  "southeast",
        "/players/katya/area/esquire/goonies/r/w14.c",  "north",
        "/players/katya/area/esquire/goonies/r/wt5.c",  "northeast",
   });}
