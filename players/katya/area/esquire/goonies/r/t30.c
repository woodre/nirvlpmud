...
if(!present("mouth")) {
move_object(clone_object("/players/katya/area/esquire/goonies/m/mouth.c"),this_object());
}
...
The soil on the ground is blended with rubble from the jagged wall.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/t29",  "west",
        "/players/katya/area/esquire/goonies/r/p20",  "north",
   });}
