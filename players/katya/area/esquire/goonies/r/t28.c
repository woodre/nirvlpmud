...
The soil on the ground is blended with rubble from the jagged wall.\n",
   ...
   dest_dir=({
        "/players/katya/area/esquire/goonies/r/t38",  "west",
        "/players/katya/area/esquire/goonies/r/t29",  "east",
        "/players/katya/area/esquire/goonies/r/tD2",  "south",
        "/players/katya/area/esquire/goonies/r/p18",  "north",
   });}
