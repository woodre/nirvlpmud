...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m3","southwest");
      add_exit("/players/katya/area/mountain/r/m4","southeast");
      add_exit("/players/katya/area/mountain/r/m16","northeast");
      add_exit("/players/katya/area/mountain/r/m15","northwest");
      add_exit("/players/katya/area/mountain/r/m9","west");
      add_exit("/players/katya/area/mountain/r/m11","east");
