...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m16","southwest");
      add_exit("/players/katya/area/mountain/r/m17","southeast");
      add_exit("/players/katya/area/mountain/r/t2","northwest");
      add_exit("/players/katya/area/mountain/r/t3","northeast");
      add_exit("/players/katya/area/mountain/r/m22","east");
      add_exit("/players/katya/area/mountain/r/m20","west");
set_chance(10);
