...
reset(arg) {
  ...
  { 
   ...
   if(!present("squirrel"))
  {
    move_object(clone_object("/players/katya/area/mountain/m/squirrel.c"),
      this_object());
  }
...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m9","southwest");
      add_exit("/players/katya/area/mountain/r/m10","southeast");
      add_exit("/players/katya/area/mountain/r/m16","east");
      add_exit("/players/katya/area/mountain/r/m14","west");
      add_exit("/players/katya/area/mountain/r/m19","northwest");
      add_exit("/players/katya/area/mountain/r/m20","northeast");
set_chance(10);
