...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m21","west");
      add_exit("/players/katya/area/mountain/r/m19","east");
      add_exit("/players/katya/area/mountain/r/m18","southeast");
      add_exit("/players/katya/area/mountain/r/m17","southwest");
      add_exit("/players/katya/area/mountain/r/t3","northwest");
      add_exit("/players/katya/area/mountain/r/t1","northeast");
