...
"barrier",
      ...
      add_exit("/players/katya/area/mountain/r/t1","southwest");
      add_exit("/players/katya/area/mountain/r/t5","west");
      add_exit("/players/katya/area/mountain/r/t5","east");
      add_exit("/players/katya/area/mountain/r/t6","northeast");
