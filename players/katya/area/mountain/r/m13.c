...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m1","southeast");
      add_exit("/players/katya/area/mountain/r/m14","northeast");
      add_exit("/players/katya/area/mountain/r/m18","northwest");
      add_exit("/players/katya/area/mountain/r/m6","southwest");
      add_exit("/players/katya/area/mountain/r/m8","east");
      add_exit("/players/katya/area/mountain/r/m12","west");
