...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m1","west");
      add_exit("/players/katya/area/mountain/r/m3","east");
      add_exit("/players/katya/area/mountain/r/m8","northwest");
      add_exit("/players/katya/area/mountain/r/m9","northeast");
