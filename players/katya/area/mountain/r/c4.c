...
reset(arg) {
  ...
  { 
   ...
   if(!present("xiulicoatl"))
  {
    move_object(clone_object("/players/katya/area/mountain/m/xiulicoatl.c"),
      this_object());
  }
   set_light(0);
...
"plantation",
	"A silky, moist fungus climbs the damp, rigid rock walls",
      ...
      add_exit("/players/katya/area/mountain/r/c3.c","west");
      add_exit("/players/katya/area/mountain/r/c5.c","east");
