...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m11","southwest");
      add_exit("/players/katya/area/mountain/r/m12","southeast");
      add_exit("/players/katya/area/mountain/r/m18","east");
      add_exit("/players/katya/area/mountain/r/m16","west");
      add_exit("/players/katya/area/mountain/r/m21","northwest");
      add_exit("/players/katya/area/mountain/r/m22","northeast");
