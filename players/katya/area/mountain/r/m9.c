...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m8","west");
      add_exit("/players/katya/area/mountain/r/m10","east");
      add_exit("/players/katya/area/mountain/r/m3","southeast");
      add_exit("/players/katya/area/mountain/r/m2","southwest");
      add_exit("/players/katya/area/mountain/r/m14","northwest");
