...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m4","southwest");
      add_exit("/players/katya/area/mountain/r/m5","southeast");
      add_exit("/players/katya/area/mountain/r/m15","northeast");
      add_exit("/players/katya/area/mountain/r/m16","northwest");
      add_exit("/players/katya/area/mountain/r/m10","west");
      add_exit("/players/katya/area/mountain/r/m12","east");
