...
reset(arg) {
  ...
  { 
   ...
   if(!present("bunny"))
  {
    move_object(clone_object("/players/katya/area/mountain/m/bunny.c"),
      this_object());
  }
   set_light(1);
...
"barrier",
      ...
      add_exit("/players/katya/area/mountain/r/m20","southeast");
      add_exit("/players/katya/area/mountain/r/m19","southwest");
      add_exit("/players/katya/area/mountain/r/t3","west");
      add_exit("/players/katya/area/mountain/r/t4","northeast");
      add_exit("/players/katya/area/mountain/r/t5","northwest");
