...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m5","southwest");
      add_exit("/players/katya/area/mountain/r/m6","southeast");
      add_exit("/players/katya/area/mountain/r/m18","northeast");
      add_exit("/players/katya/area/mountain/r/m17","northwest");
      add_exit("/players/katya/area/mountain/r/m11","west");
      add_exit("/players/katya/area/mountain/r/m13","east");
