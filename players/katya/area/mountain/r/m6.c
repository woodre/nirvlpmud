...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m5","west");
      add_exit("/players/katya/area/mountain/r/m7","east");
      add_exit("/players/katya/area/mountain/r/m13","northeast");
      add_exit("/players/katya/area/mountain/r/m12","northwest");
}
 }
