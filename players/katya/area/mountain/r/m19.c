...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m18","southwest");
      add_exit("/players/katya/area/mountain/r/m15","southeast");
      add_exit("/players/katya/area/mountain/r/m22","west");
      add_exit("/players/katya/area/mountain/r/m20","east");
