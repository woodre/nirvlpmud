...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m6","west");
      add_exit("/players/katya/area/mountain/r/m1","east");
      add_exit("/players/katya/area/mountain/r/m13","northwest");
      add_exit("/players/katya/area/mountain/r/m8","northeast");
