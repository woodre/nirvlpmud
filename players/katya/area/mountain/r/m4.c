...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m3","west");
      add_exit("/players/katya/area/mountain/r/m5","east");
      add_exit("/players/katya/area/mountain/r/m11","northeast");
      add_exit("/players/katya/area/mountain/r/m10","northwest");
