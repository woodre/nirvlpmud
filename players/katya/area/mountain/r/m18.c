...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m17","west");
      add_exit("/players/katya/area/mountain/r/m14","east");
      add_exit("/players/katya/area/mountain/r/m12","southwest");
      add_exit("/players/katya/area/mountain/r/m13","southeast");
