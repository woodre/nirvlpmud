...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m2","west");
      add_exit("/players/katya/area/mountain/r/m4","east");
      add_exit("/players/katya/area/mountain/r/m9","northwest");
      add_exit("/players/katya/area/mountain/r/m10","northeast");
