...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m4","west");
      add_exit("/players/katya/area/mountain/r/m6","east");
      add_exit("/players/katya/area/mountain/r/m11","northwest");
      add_exit("/players/katya/area/mountain/r/m12","northeast");
