...
reset(arg) {
  ...
  { 
   ...
   if(!present("hex"))
  {
    move_object(clone_object("/players/katya/area/mountain/m/hex.c"),
      this_object());
  }
   set_light(1);
...
"moss",
	"Velvety green vegetation creep along the gray stones on the malleable ground",
      ...
      add_exit("/players/katya/area/mountain/r/m18","west");
      add_exit("/players/katya/area/mountain/r/m15","east");
      add_exit("/players/katya/area/mountain/r/m19","northeast");
      add_exit("/players/katya/area/mountain/r/m22","northwest");
      add_exit("/players/katya/area/mountain/r/m8","southwest");
      add_exit("/players/katya/area/mountain/r/m9","southeast");
