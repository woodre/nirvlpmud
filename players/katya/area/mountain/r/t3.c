...
"barrier",
      ...
      add_exit("/players/katya/area/mountain/r/m22","southeast");
      add_exit("/players/katya/area/mountain/r/m21","southwest");
      add_exit("/players/katya/area/mountain/r/t1","east");
