...
**********************************/
#define ERROR_LOG "players/blackadder/bboard/BOARD"
#define BOARD_NAME "players/blackadder/bboard/bull_save"
...
long() {
   int ind;
   write("Blackadder's bulletin board.\n");
   write("Please leave any bugs or suggestions here.\n");
   write("If you can think of anything that you'd like to add to the\n");
   write("game, I'll do my best to accomodate your ideas.\n");
   write("\n");
   write("                       - Blackadder\n");
   write("\n");
...
short() {
   return "Blackadders' bulletin board";
}
get() {
...
reset(arg) {
   say("The maid appears and secures some " +
      "notes on the board that were loose.\n");
   say("The maid leaves again.\n");
}
new_msg(msg_head) {
   line = 1;
   if (!msg_head)
...
remove_msg(what_msg) {
   ...
   if ((this_player()->query_name() != player) &&
      ...
      write("Only wizards may remove messages from this board!\n");
