...
long()
{  write("These are playing cards.\n"+
         "To see your cards, type 'show'.\n"+
         "Type 'rules' if you don't know how to play.\n");
}
short() { return "A hand of BlackJack cards"; }
get() { return 1; }
drop() { return 0; }
value() { return 0; }
...
rules(str)
{  if(str!="blackjack")
   {  write("What rules you wanna see? --> blackjack?\n");
      return 1;
  }
   write("\t...............................................\n"+
         "\t..................BLACKJACK....................\n"+
         ...
         "players involved. Jack, Queen and King have value 10, Ace is 1 or 11,\n"+
         "the other cards show their own values. I give you two cards in advance.\n"+
         "Commands are 'card' for another card, or 'stay' when you are finished\n"+
         "and it's my turn to draw cards. I stay if I have more than 17 points,\n"+
         "else I draw another card. Suppose one has exactly 21, than he gets a 750\n"+
...
{  int i,tmp,next,cardsc,coins,ace,mon;
   ...
   {  write("Hmm.. you don't have enough money to gamble. First make sure\n"+
     ...
     say("You laugh... "+TP+" has too little money to play BlackJack!\n");
      return 1;
   }
   ...
   {  next=next+1;
      ...
      else { if(cardnum=="J") { cardnum="Jack"; myscore=myscore+10; }
         else { if(cardnum=="Q") { cardnum="Queen"; myscore=myscore+10; }
             else { if(cardnum=="K") { cardnum="King"; myscore=myscore+10; }
   ...
   {  write("I have "+myscore+" points, you have "+score+" points. \n");
      ...
      {  coins=(score-myscore)*200;
         ...
         {  coins=coins+750;
           ...
           say(TP+" has 21 points with BlackJack!\n");
         }
         else
      ...
      {  if(score==myscore)
         {  coins=0;
          write("I'll shake the cards again. You can have a look at them\n"+
         ...
         {  if(score<myscore)
            {  coins=(score-myscore)*200;
              ...
              say(TP+" lost his BlackJack game.\n");
   }  }  }  }
  coins = 0;
...
{  int cardsc,tmp,coins;
   ...
   {  tmp=sscanf(shaked[n],"%s-%s",dump,pic);
      if(pic=="J") { score=score+10; }
         else { if (pic=="Q") { score=score+10; }
      else { if (pic=="K") { score=score+10; }
                else { if (pic=="A")
                       {  score=score+11;
                           joho=joho+1;
