...
{ int i,j,k,l,chance,next,tmp,intpoints;
  ...
  { if(CTP==pl[i])
    { if(coughts[i]>2)
    { write("You have already been caught three times, and don't take the risk\n"+
         "of being caught another time. That would embarrass you too much.\n");
        say("You saw "+CTP+" moving his head another time, trying too peek again.\n"+
          "But then he reminded the other three times he was caught and decided\n"+
  ...
  { if(CTP==pl[j])
    { for(i=0;i<nrofpl;i++)
      ...
      { write("Oeps... they caught ya. That wasn't a smart move, bud!\n"+
...
{ string toomany,more;
  ...
  str=str+" ";
  nrofpl=sscanf(str,"%s %s %s %s %s",pl[1],pl[2],pl[3],more,toomany);
  nrofpl=nrofpl+1;
  if(nrofpl>4)
