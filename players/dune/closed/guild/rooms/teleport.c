...
init()
{
  ...
  add_action("cont",	 "cont");
  add_action("derellia", "derellia");
  }
   ::init();
}
...
cont()	{ TEL, "continent #players/maledicta/cont/rooms/606.c"); return 1; }
derellia()	{ TEL, "derellia #players/maledicta/town/rooms/t1.c"); return 1; }
