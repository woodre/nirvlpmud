...
#define FLUXES ({ ({"light", "UV",BOLD,"*"}), ({"fire","Heat",BOLD+RED,"f"}), ({"ice","Freeze",BOLD+CYAN,"z"}), ({"electric", "Electric",BOLD+YELLOW,"-"}), ({"laser","Magnetic",BOLD+MAGENTA,"|"}), ({"poison","Acid",BOLD+GREEN,"%"}), ({"mental","Psi",BOLD+BLUE,"O"})/*, ({"sonic","Sonic",BOLD+WHITE,"n"})*/ })
