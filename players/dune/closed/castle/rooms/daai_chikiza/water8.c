...
"There is no sign as to where the source of the water comes from.\n";
   ...
   dest_dir=({
        CASTLEROOM+"/water7.c","east"  ,
        CASTLEROOM+"/water5.c","northeast"  ,
        CASTLEROOM+"/water4.c","north"  ,
        CASTLEROOM+"/water3.c","northwest"  ,
        CASTLEROOM+"/water9.c","west"  ,
        CASTLEROOM+"/whirlpool.c","southwest"  ,
            });
