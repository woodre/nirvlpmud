...
"There is no sign as to where the source of the water comes from.\n";
   ...
   dest_dir=({
        CASTLEROOM+"/water8.c","east"  ,
        CASTLEROOM+"/water4.c","northeast"  ,
        CASTLEROOM+"/water3.c","north"  ,
        CASTLEROOM+"/water2.c","northwest"  ,
        CASTLEROOM+"/water10.c","west"  ,
        CASTLEROOM+"/water11.c","southwest"  ,
        CASTLEROOM+"/whirlpool.c","south"  ,
            });
