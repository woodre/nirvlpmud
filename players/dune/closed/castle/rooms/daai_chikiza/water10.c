...
"There is no sign as to where the source of the water comes from.\n";
   ...
   dest_dir=({
        CASTLEROOM+"/water1.c","northwest"  ,
        CASTLEROOM+"/water2.c","north"  ,
        CASTLEROOM+"/water3.c","northeast"  ,
        CASTLEROOM+"/water9.c","east"  ,
        CASTLEROOM+"/whirlpool.c","southeast"  ,
        CASTLEROOM+"/water11.c","south"  ,
            });
