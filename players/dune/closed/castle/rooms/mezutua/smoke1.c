...
"clothes.\n";
    ...
    dest_dir=({
        CASTLEROOM+"/smoke2.c","south"  ,
        CASTLEROOM+"/smoke4.c","north"  ,
        CASTLEROOM+"/smoke5.c","northwest"  ,
        CASTLEROOM+"/smoke3.c","southwest"  ,
        CASTLEROOM+"/smoke9.c","northeast"  ,
        CASTLEROOM+"/north4.c","southeast"  ,
        CASTLEROOM+"/passage1.c","east"  ,
    });
