...
id(str) { return str == "orb" || str == "steel orb" || 
...
long()
{
  ...
  write("Gazing into it, you see a sharp object.\n");
  if(!name)
    write("An inner voice tells you to name the orb.\n");
  else
    write("The name of the Steel Orb is "+name+".\n");
}
...
int name (string str)
{
  ...
  if (orbType == "steel")
  {
    write("You name the Steel Orb "+orbName+".\n");
    set_name(orbName);
    return 1;
  }
}
