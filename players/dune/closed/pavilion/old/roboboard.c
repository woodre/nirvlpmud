#define ERROR_LOG "players/dune/closed/guild/log/BOARDERRORS"
...
long() {
  int ind;
  write("This is RoboMech Terminal, please feel free to\n"+
        "input any RoboMech related information here.\n");
...
short() {
  return "RoboMech Terminal ("+msg_num+" entries)";
}

get() {
  write("It is magnetically locked in place.\n");
  return 0;
}
