...
"Situated upon these walls stand several black flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/black2.c", "e",
   "/players/dune/closed/pavilion/rooms/field/black3.c", "s",
   "/players/dune/closed/pavilion/rooms/field/black4.c", "se",
