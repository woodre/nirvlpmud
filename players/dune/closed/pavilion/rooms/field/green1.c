...
"Situated upon these walls stand several green flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/green2.c", "e",
   "/players/dune/closed/pavilion/rooms/field/green3.c", "s",
   "/players/dune/closed/pavilion/rooms/field/green4.c", "se",
"/players/dune/closed/pavilion/rooms/field/greena.c", "w",
   "/players/dune/closed/pavilion/rooms/field/greenb.c", "sw",
   "/players/dune/closed/pavilion/rooms/field/white3.c", "ne",
