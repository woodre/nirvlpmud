...
"Situated upon these walls stand several red flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/red3.c", "sw",
   "/players/dune/closed/pavilion/rooms/field/red4.c", "s",
   "/players/dune/closed/pavilion/rooms/field/red1.c", "w",
   "/players/dune/closed/pavilion/rooms/field/reda.c", "e",
   "/players/dune/closed/pavilion/rooms/field/redb.c", "se",
