...
"Situated upon these walls stand several black flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/black1.c", "nw",
   "/players/dune/closed/pavilion/rooms/field/black3.c", "w",
   "/players/dune/closed/pavilion/rooms/field/black2.c", "n",
    "/players/dune/closed/pavilion/rooms/field/blacka.c", "ne",
   "/players/dune/closed/pavilion/rooms/field/blackb.c", "e",
   "/players/dune/closed/pavilion/rooms/field/white2.c", "sw",
