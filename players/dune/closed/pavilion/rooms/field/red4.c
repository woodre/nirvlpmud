...
"Situated upon these walls stand several red flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/red1.c", "nw",
   "/players/dune/closed/pavilion/rooms/field/red3.c", "w",
   "/players/dune/closed/pavilion/rooms/field/red2.c", "n",
    "/players/dune/closed/pavilion/rooms/field/reda.c", "ne",
   "/players/dune/closed/pavilion/rooms/field/redb.c", "e",
