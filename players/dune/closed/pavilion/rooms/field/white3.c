...
"Situated upon these walls stand several white flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/white2.c", "ne",
   "/players/dune/closed/pavilion/rooms/field/white4.c", "e",
   "/players/dune/closed/pavilion/rooms/field/white1.c", "n",
   "/players/dune/closed/pavilion/rooms/field/green2.c", "s",
   "/players/dune/closed/pavilion/rooms/field/green1.c", "sw",
   "/players/dune/closed/pavilion/rooms/field/blue4.c",  "nw",
