...
"Situated upon these walls stand several green flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/green1.c", "nw",
   "/players/dune/closed/pavilion/rooms/field/green3.c", "w",
   "/players/dune/closed/pavilion/rooms/field/green2.c", "n",
