...
"Situated upon these walls stand several blue flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/blue2.c", "ne",
   "/players/dune/closed/pavilion/rooms/field/blue4.c", "e",
   "/players/dune/closed/pavilion/rooms/field/blue1.c", "n",
