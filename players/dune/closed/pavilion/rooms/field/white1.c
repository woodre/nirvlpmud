...
"Situated upon these walls stand several white flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/white2.c", "e",
   "/players/dune/closed/pavilion/rooms/field/white3.c", "s",
   "/players/dune/closed/pavilion/rooms/field/white4.c", "se",
   "/players/dune/closed/pavilion/rooms/field/blue4.c",  "w",
   "/players/dune/closed/pavilion/rooms/field/blue2.c",  "nw",
   "/players/dune/closed/pavilion/rooms/field/black3.c", "ne",
