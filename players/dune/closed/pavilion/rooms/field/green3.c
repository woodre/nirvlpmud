...
"Situated upon these walls stand several green flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/green2.c", "ne",
   "/players/dune/closed/pavilion/rooms/field/green4.c", "e",
   "/players/dune/closed/pavilion/rooms/field/green1.c", "n",
