...
"Situated upon these walls stand several white flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/white1.c", "nw",
   "/players/dune/closed/pavilion/rooms/field/white3.c", "w",
   "/players/dune/closed/pavilion/rooms/field/white2.c", "n",
   "/players/dune/closed/pavilion/rooms/field/red1.c",   "e",
   "/players/dune/closed/pavilion/rooms/field/red3.c",   "se",
   "/players/dune/closed/pavilion/rooms/field/green2.c", "sw",
