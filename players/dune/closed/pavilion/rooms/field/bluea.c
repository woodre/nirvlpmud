...
"Situated upon these walls stand several blue flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/blue1.c", "e",
   "/players/dune/closed/pavilion/rooms/field/blueb.c", "s",
   "/players/dune/closed/pavilion/rooms/field/blue3.c", "se",
