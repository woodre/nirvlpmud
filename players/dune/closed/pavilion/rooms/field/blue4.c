...
"Situated upon these walls stand several blue flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/blue1.c",  "nw",
   "/players/dune/closed/pavilion/rooms/field/blue3.c",  "w",
   "/players/dune/closed/pavilion/rooms/field/blue2.c",  "n",
   "/players/dune/closed/pavilion/rooms/field/white1.c", "e",
   "/players/dune/closed/pavilion/rooms/field/white3.c", "se",
