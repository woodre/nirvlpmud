...
"Situated upon these walls stand several green flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/green3.c", "e",
   "/players/dune/closed/pavilion/rooms/field/greena.c", "n",
   "/players/dune/closed/pavilion/rooms/field/green1.c", "ne",
