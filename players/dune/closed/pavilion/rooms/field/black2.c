...
"Situated upon these walls stand several black flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/black3.c", "sw",
   "/players/dune/closed/pavilion/rooms/field/black4.c", "s",
   "/players/dune/closed/pavilion/rooms/field/black1.c", "w",
   "/players/dune/closed/pavilion/rooms/field/blacka.c", "e",
   "/players/dune/closed/pavilion/rooms/field/blackb.c", "se",
