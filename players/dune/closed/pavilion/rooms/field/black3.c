...
"Situated upon these walls stand several black flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/black2.c", "ne",
   "/players/dune/closed/pavilion/rooms/field/black4.c", "e",
   "/players/dune/closed/pavilion/rooms/field/black1.c", "n",
   "/players/dune/closed/pavilion/rooms/field/white2.c", "s",
   "/players/dune/closed/pavilion/rooms/field/white1.c", "sw",
