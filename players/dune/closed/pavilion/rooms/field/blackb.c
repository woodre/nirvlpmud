...
"Situated upon these walls stand several black flags.\n";
   ...
   dest_dir=({
   "/players/dune/closed/pavilion/rooms/field/black2.c", "nw",
   "/players/dune/closed/pavilion/rooms/field/black4.c", "w",
   "/players/dune/closed/pavilion/rooms/field/blacka.c", "n",
