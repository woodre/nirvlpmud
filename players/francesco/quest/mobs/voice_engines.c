  ...
  if(arg) return;
   ...
   if(typ == 1) 
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'motore'?\n"); }
   if(typ == 2) 
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'potenza'?\n"); } 
   if(typ == 3)
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'lavoro'?\n"); }
   if(typ==4)
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'conversione'?\n"); }
   if(typ==5)
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
