  ...
  if(arg) return;
   ...
   if(typ == 1) 
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'termodinamica'?\n"); }
   if(typ == 2) 
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'proprieta''?\n"); } 
   if(typ == 3)
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'variazioni'?\n"); }
   if(typ==4)
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'temperatura'?\n"); }
   if(typ==5)
    { load_chat("You notice the librarian which comes close to you and whispers:\n"+
                tpn+", help me please:  what is the english translation for 'energia'?\n"); }
}
...
whisper(str) {
   ...
   if(str=="thermodynamics" && typ==1 || str=="properties" && typ==2 || str=="changes" && typ==3 || str=="temperature" && typ == 4 || str=="energy" && typ == 5)
{
    if(contatore == 1){
    ...
    write("The librarian whispers to you:  hmmm, no, "+tpn+", your answer did noit work.\n"); 
    return 1; 
}
