...
set_long(HIW+"This is an aluminium table, covered with a soft green felt, with\n"+
         "ashtrays at the four corners.  A flier is hanging down the table\n"+
         "and can be 'read'.  The table is light enough to be carried around \n"+
         "and can be 'drop'ped when willing to play a game.\n"+NORM);
}
