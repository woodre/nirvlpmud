...
quest_check() {
   ...
   if(bet == 500 && levelle == "easy") {
     if(!present("quest11n",TP)) {
       ob= clone_object("players/francesco/games/items/quest11c.c");
       move_object(ob,TP);
     return 1; }
     if(!present("quest12n",TP)) {
       ob= clone_object("players/francesco/games/items/quest12c.c");
       move_object(ob,TP);
     return 1; }
   return 1; }
   if(bet == 1000 && levelle == "medium") {
     if(!present("quest21n",TP)) {
       ob= clone_object("players/francesco/games/items/quest21c.c");
       move_object(ob,TP);
     return 1; }
     if(!present("quest22n",TP)) {
       ob= clone_object("players/francesco/games/items/quest22c.c");
       move_object(ob,TP);
     return 1; }
   return 1; }
    if(bet == 2000 && levelle == "tough") {
     if(!present("quest31n",TP)) {
       ob= clone_object("players/francesco/games/items/quest31c.c");
       move_object(ob,TP);
     return 1; }
     if(!present("quest32n",TP)) {
       ob= clone_object("players/francesco/games/items/quest32c.c");
       move_object(ob,TP);
     return 1; }
   return 1; }
return 1;}
