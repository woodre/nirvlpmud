...
set_long(HIW+"This is an aluminium table, covered with a soft green felt, with\n"+
         "ashtrays at the four corners.  There are also three buttons to \n"+
        "'push'.  A flier is hanging down the table and can be 'read'.\n"+
        "The table is light enough to be carried around and can be\n"+
       "'drop'ped when willing to play a game.\n"+NORM);
game_on = 0;
guess1="";
guess2="";
}
