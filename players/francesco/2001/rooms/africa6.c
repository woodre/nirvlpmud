...
reset(arg) {
  if(arg) return;
if (!present("tooth")) {
  move_object(clone_object("/players/francesco/2001/mobs/member.c"),
	this_object());  }
...
long_desc =
     ...
     "This area has been often chosen by the members of the Moonwatcher tribe\n"+
     "for finding occasionally berries and fruits for food.\n",
...
dest_dir = ({
  "/players/francesco/2001/rooms/africa17.c","north",
  "/players/francesco/2001/rooms/africa2.c","south",
  "/players/francesco/2001/rooms/africa14.c","east",
  "/players/francesco/2001/rooms/africa13.c","west",
});
