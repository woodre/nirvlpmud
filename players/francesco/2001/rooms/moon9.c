...
long_desc =
     ...
     "the east the landscape keeps goind always the same, to the south\n"+
...
items = ({
   ...
   "earth","It looks a sphere at the horizon, with the brown and the blue \n"+
           ...
           "is visible as well",
   "cupoles","They are round and transparent spheres, about 200 feet tall",
});

dest_dir = ({
  "/players/francesco/2001/rooms/moon3.c","southeast",
  "/players/francesco/2001/rooms/moon10.c","east",
  "/players/francesco/2001/rooms/moon11.c","north",
});
