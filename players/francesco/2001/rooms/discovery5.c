...
long_desc =
     ...
     "of the spacecraft.  The hub is located to the east and can be \n"+
...
dest_dir = ({
  "/players/francesco/2001/rooms/discovery22.c","east",
  "/players/francesco/2001/rooms/discovery12.c","south",
  "/players/francesco/2001/rooms/discovery15.c","north",
});
