...
random_long() {
  switch(random(42)) {
    case 0:
      return HIW+" "+HIB+"  T"+HIW+"h"+HIB+"e k"+HIW+"a"+HIB+"lei"+HIW+"d"+HIB+"osc"+HIW+"o"+HIB+"pe "+HIW+"i"+HIB+"s a"+HIR+"n optical toy consisting of a tube"+NORM+"\n"+
      ...
      break;
    case 1:
      return HIG+"   The kaleidoscope"+HIW+" is an optical toy c"+HIR+"onsisting of a tube\n"+
      ...
      break;
    case 2:
      return "   "+YEL+"The "+NORM+"kaleidoscope is"+YEL+" an opti"+NORM+"cal toy consist"+YEL+"ing of a "+NORM+"tube\n"+
      ...
      break;
    case 3:
      return "   "+HIC+"The "+NORM+"kaleidoscope is"+HIC+" an opti"+NORM+"cal toy consist"+HIC+"ing of a "+NORM+"tube\n"+
      ...
      break;
    case 4:
      return "   "+HIR+"The "+NORM+"kaleidoscope is"+HIR+" an opti"+NORM+"cal toy consisti"+HIR+"ng of a "+NORM+"tube\n"+
      ...
      break;
    case 5:
      return "   "+HIY+"The "+NORM+"kaleidoscope is"+HIY+" an opti"+NORM+"cal toy consisti"+HIY+"ng of a "+NORM+"tube\n"+
      ...
      break;
    case 6:
      return "   "+HIB+"The "+NORM+"kaleidoscope is"+HIR+" an opti"+NORM+"cal toy consist"+HIY+"ing of a "+NORM+"tube\n"+
      ...
      break;
    case 7:
      return "   "+HIW+"The "+NORM+"kaleidoscope is"+HIW+" an opti"+NORM+"cal toy consist"+HIW+"ing of a "+NORM+"tube\n"+
      ...
      break;
    case 8:
      return "   "+HIR+"The "+NORM+"kaleidoscope is"+HIW+" an opti"+NORM+"cal toy consist"+HIR+"ing of a "+NORM+"tube\n"+
      ...
      break;
    case 9:
      return "   "+HIC+"The k"+NORM+"aleidosco"+HIC+"pe is"+NORM+" an optic"+HIC+"al to"+NORM+"y consist"+HIC+"ing o"+NORM+"f a tube\n"+
      ...
      break;
    case 10:
      return "   "+HIR+"The k"+NORM+"aleidosco"+HIR+"pe is"+NORM+" an optic"+HIR+"al to"+NORM+"y consist"+HIR+"ing o"+NORM+"f a tube\n"+
      ...
      break;
    case 11:
      return "   "+HIB+"The k"+NORM+"aleidosco"+HIB+"pe is"+NORM+" an optic"+HIB+"al to"+NORM+"y consist"+HIB+"ing o"+NORM+"f a tube\n"+
      ...
      break;
    case 12:
      return "   "+HIB+"The k"+NORM+"aleidosco"+HIR+"pe is"+NORM+" an optic"+HIB+"al to"+NORM+"y consist"+HIR+"ing o"+NORM+"f a tube\n"+
      ...
      break;
    case 13:
      return "   "+HIM+"The k"+NORM+"aleidosco"+HIM+"pe is"+NORM+" an optic"+HIM+"al to"+NORM+"y consist"+HIM+"ing o"+NORM+"f a tube\n"+
      ...
      break;
    case 14:
      return "   "+HIM+"The k"+NORM+"aleidosco"+HIY+"pe is"+NORM+" an optic"+HIM+"al to"+NORM+"y consist"+HIY+"ing o"+NORM+"f a tube\n"+
      ...
      break;
    case 15:
      return HIR+"   The kaleidoscope is an optical toy consisting of a tube\n"+
      ...
      break;
    case 16:
      return "   "+HIM+"The kaleidosco"+HIY+"pe is an optic"+HIM+"al toy consist"+HIY+"ing of a tube\n"+
      ...
      break;
    case 17:
      return "   The kaleidoscope is an "+HIR+"optical"+NORM+" toy consisting of a tube\n"+
      ...
      break;
    case 18:
      return "   The kaleidoscope is an "+HIB+"optical"+NORM+" toy consisting of a tube\n"+
      ...
      break;
    case 19:
      return "   The kaleidoscope is an "+HIC+"optical"+NORM+" toy consisting of a tube\n"+
      ...
      break;
    case 20:
      return "   The kaleidoscope is an "+HIC+"opt"+HIR+"ical"+NORM+" toy consisting of a tube\n"+
      ...
      break;
    case 21:
      return "   The kaleidoscope is an "+HIB+"opt"+HIY+"ical"+NORM+" toy consisting of a tube\n"+
      ...
      break;
    case 22:
      return "   "+HIB+"The kaleidosco"+HIR+"pe is an optic"+HIB+"al toy consist"+HIR+"ing of a tube\n"+
    ...
    case 23:
      ...
      break;
    case 24:
      return "   The kaleidoscope is an "+HIY+"opt"+HIY+"ical"+NORM+" toy consisting of a tube\n"+
    ...
    case 25:
      ...
      break;
    case 26:
      return "   The kaleidoscope is an "+HIM+"optical"+NORM+" toy consisting of a tube\n"+
      ...
      break;
    case 27:
      return "   "+HIR+"The kal"+NORM+"eidoscope is an optical toy consisting of a "+HIR+"a tube"+NORM+"\n"+
      ...
      break;
    case 28:
      return "   "+HIB+"The kal"+NORM+"eidoscope is an optical toy consisting of a "+HIB+"a tube"+NORM+"\n"+
    ...
    case 29:
      ...
      break;
    case 30:
      return "   "+HIB+"The kaleidoscope is an optical toy consisting of a a tube"+NORM+"\n"+
      ...
      break;
    case 31:
      return "   "+HIB+"The kaleidoscope is an optical toy consisting of a a tube"+HIY+"\n"+
      ...
      break;
    case 32:
      return "   The ka"+HIR+"leidoscope is an optical toy consisting o"+NORM+"f a tube\n"+
      ...
      break;
    case 33:
      return "   The ka"+HIB+"leidoscope is an optical toy consisting o"+NORM+"f a tube\n"+
    ...
    case 34:
      ...
      break;
    case 35:
      return "   The ka"+HIW+"leidoscope is an optical toy consisting o"+NORM+"f a tube\n"+
      ...
      break;
    case 36:
      return "   The ka"+HIM+"leidoscope is an optical toy consisting o"+NORM+"f a tube\n"+
      ...
      break;
    case 37:
      return "   The kaleidoscope is an "+HIW+"optical"+NORM+" toy consisting of a tube\n"+
      ...
      break;
    case 38:
      return HIR+"   The k"+HIY+"aleidosc"+HIR+"ope is a"+HIY+"n optica"+HIR+"l toy co"+HIY+"nsisting"+HIR+" of a tu"+HIY+"be\n"+
      ...
      break;
    case 39:
      return HIM+"   The k"+HIY+"aleidosc"+HIM+"ope is a"+HIY+"n optica"+HIM+"l toy co"+HIY+"nsisting"+HIM+" of a tu"+HIY+"be\n"+
      ...
      break;
    case 40:
      return " "+HIB+"  T"+HIW+"h"+HIB+"e k"+HIW+"a"+HIB+"lei"+HIW+"d"+HIB+"osc"+HIW+"o"+HIB+"pe "+HIW+"i"+HIB+"s a"+HIR+"n optical toy consisting of a tube"+NORM+"\n"+
      HIB+"co"+HIW+"n"+HIB+"tai"+HIW+"n"+HIB+"ing"+HIW+" "+HIB+"two"+HIW+" "+HIB+"pla"+HIW+"n"+HIB+"e m"+HIW+"i"+HIB+"rr"+HIW+"ors placed at an angle of 60 degrees."+NORM+"\n"+
      HIW+"T"+HIB+"hey"+HIW+" "+HIB+"are"+HIW+" "+HIB+"mou"+HIW+"n"+HIB+"ted"+HIW+" "+HIB+"so "+HIW+"t"+HIB+"hat"+HIW+" "+HIR+"a symmetrical pattern produced by"+NORM+"\n"+
      HIB+"mu"+HIW+"l"+HIB+"tip"+HIW+"l"+HIB+"e r"+HIW+"e"+HIB+"fle"+HIW+"c"+HIB+"tio"+HIW+"n"+HIB+" ca"+HIW+"n"+HIB+" b"+HIW+"e observed through a peephole at"+NORM+" \n"+
      HIW+"o"+HIB+"ne "+HIW+"e"+HIB+"nd "+HIW+"o"+HIB+"f t"+HIW+"h"+HIB+"e k"+HIW+"a"+HIB+"lei"+HIW+"d"+HIB+"osc"+HIW+"o"+HIR+"pe itself.  However, this happens"+NORM+" \n"+
      HIW+"only when objects (such as pieces of coloured glass) at the"+NORM+"\n"+
      HIR+"other end are suitably illuminated.  When the two mirrors are"+NORM+"\n"+
      HIW+"rotated or shifted one against the other, the pattern will"+NORM+"\n"+
      HIR+"change, thus producing an almost endless combination of shapes"+NORM+"\n"+
  ...
  return "BAD LONG DESCRIPTION, PLEASE REPORT THIS BUG!\n";
}
