...
long_desc =
     ...
     "conta"+HIB+"ining"+NORM+" two plan"+HIR+"e mir"+NORM+"rors plac"+HIB+"ed at"+NORM+" an angle"+HIR+" of 6"+NORM+"0 degrees.\n"+
     "They ar"+HIB+"e mou"+NORM+"nted so t"+HIR+"hat a"+NORM+" symmetri"+HIB+"cal p"+NORM+"attern pr"+HIR+"oduce"+NORM+"d by\n"+
     "multiple "+HIB+"refle"+NORM+"ction can"+HIR+" be o"+NORM+"bserved t"+HIB+"hroug"+NORM+"h a peeph"+HIR+"ole a"+NORM+"t \n"+
     ""+HIR+"on"+NORM+"e end of "+HIB+"the k"+NORM+"aleidosco"+HIR+"pe it"+NORM+"self.  Ho"+HIB+"wever"+NORM+", this ha"+HIR+"ppens"+NORM+" \n"+
     ""+HIR+"only"+NORM+" when obj"+HIB+"ects "+NORM+"(such as "+HIR+"piece"+NORM+"s of colo"+HIB+"ured "+NORM+"glass) at"+HIR+" the"+NORM+"\n"+
     "o"+HIR+"ther "+NORM+"end are s"+HIB+"uitab"+NORM+"ly illumi"+HIR+"nated"+NORM+".  When t"+HIB+"he tw"+NORM+"o mirrors"+HIR+" are"+NORM+"\n"+
     "rot"+HIR+"ated "+NORM+"or shifte"+HIB+"d one"+NORM+" against "+HIR+"the o"+NORM+"ther, the"+HIB+" patt"+NORM+"ern will\n"+
