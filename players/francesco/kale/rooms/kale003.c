...
long_desc =
     ...
     "beam of light through a colored glass, towards the mirrors.  The\n"+
     "multiple reflections do it that the same pattern of light, with \n"+
     "the same shape and the same colors, can be seen, regardless the\n"+
     "position of the spectator within the room.  By suitable mechanisms\n"+
     "the mirrors can be rotated and shifted one against the others as to\n"+
     "produce other patterns, differently shaped and colored.  This is \n"+
     "the working principle of the kaleidoscope, which can show endless\n"+
