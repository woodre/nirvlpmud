...
short() { return ""+HIW+BLINK+HIR+"Ka"+YEL+"le"+HIY+"id"+HIG+"os"+HIB+"co"+HIM+"pic  "+HIR+"Ka"+YEL+"le"+HIY+"id"+HIG+"os"+HIB+"co"+HIM+"pe"+NORM+""; }
...
*/
    if (arg=="money") 
     { 
      call_other(this_player(),"add_money",(6300+random(7400))); 
      write("Hope says: Well done, "+call_other(this_player(),"query_name")+", these coins will help you in your further mud life.\n");
      write_file("/players/francesco/kale/log/superkale",this_player()->query_name()+"   "+ctime(time())+" superkale\n");
      destruct(this_object());
      this_player()-> recalc_carry();
      return 1; 
     }
