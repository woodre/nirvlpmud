...
long() { write("The Easter eggs has been acknowledged as a symbol of continuing life and \n"+
               ...
               "family, friends and servants.  This egg is all colored in "+HIR+"red "+NORM+".  By\n"+
               "returning it to the proper person, it is possible to 'obtain money' or, \n"+
               "alternatively, 'obtain heals'.\n"); }

short() { return ""+HIB+"BLUE "+HIR+"Ea"+NORM+YEL+"st"+HIY+"er"+HIG+" e"+HIB+"gg"+HIM+""+NORM+""; }
    ...
    if(arg=="heals")
     {
      ...
      move_object(item,this_player());
      write("Hope says: Well done, "+call_other(this_player(),"query_name")+", enjoy these two sets of heals.\n");
