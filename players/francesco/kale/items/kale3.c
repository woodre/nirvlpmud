...
long() { write("This kaleidoscope is just a toy which both adults and childrens\n"+
               ...
               "end, and is all colored in "+HIY+"yellow"+NORM+".  By returning it to the proper\n"+
               "person, it is possible to 'obtain money' or, alternatively, \n"+
               "'obtain heals'.\n"); }

short() { return ""+HIY+"YELLOW "+HIR+"Ka"+NORM+YEL+"le"+HIY+"id"+HIG+"os"+HIB+"co"+HIM+"pe"+NORM+""; }
    ...
    if(arg=="heals")
     {
      ...
      write_file("/players/francesco/kale/log/"+this_player()->query_name()+"",ctime(time())+" yellow  1\n");
