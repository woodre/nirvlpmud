...
reset(arg){
  ...
  if(arg) return;
   ...
   set_gender("neuter");
     ...
     set_long(""+HIR+"\nTh"+NORM+YEL+"e "+HIY+"ka"+HIG+"le"+HIB+"id"+HIM+"os"+NORM+""+HIR+"co"+NORM+YEL+"pe"+HIY+" i"+HIG+"s "+HIB+"an"+HIM+" o"+NORM+""+HIR+"pt"+NORM+YEL+"ic"+HIY+"al"+HIG+" t"+HIB+"oy"+HIM+" w"+NORM+""+HIR+"hi"+NORM+YEL+"ch"+HIY+" s"+HIG+"ho"+HIB+"ws"+HIM+"  "+NORM+"\n\n"+
