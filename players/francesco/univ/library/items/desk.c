...
long() {
 write("This desk is used to put the books on it when you want \n"+
       "to apply for a degree.  It has "+counter+" books on it.\n"); }
...
apply_degree(str) {
   object ob;
    ...
    if(str == "for degree") {
      if(counter == 21) {
      ob = (clone_object("/players/francesco/univ/library/items/degree.c"));
