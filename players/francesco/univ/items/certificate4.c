...
long() { write("This medium certificate entitles you to 'obtain' different things:\n"+
    ...
    if(arg=="support")
     {
      ...
      write("Well done, "+call_other(this_player(),"query_name")+", enjoy this full set of heals.\n");
      destruct(this_object());
      return 1;
     }
