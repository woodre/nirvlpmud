...
dest_dir = ({
  ...
  "/players/francesco/games/rooms/hubnew.c","games"
});
...
init() {
    ...
    add_action("roma","roma");
}

roma(){
 if(tpn != "Fran") return 0;
  else
      this_player()->move_player("to Rome#players/francesco/roma/rooms/hub.c");
return 1;}
