...
reset(arg) {
  if(arg) return;
 if (!present("monster")) {
   move_object(clone_object("/players/francesco/hall/mobs/witt.c"),this_object());}
set_light(1);
...
dest_dir = ({
  "/players/francesco/hall/rooms/y6.c","northeast",
  "/players/francesco/hall/rooms/y8.c","west"
});}
