...
reset(arg) {
  if(arg) return;
   if (!present("monster")) {  
   move_object(clone_object("/players/francesco/hall/mobs/otto.c"),
	this_object());  }
set_light(1);
...
dest_dir = ({
  "/players/francesco/hall/rooms/b14.c","north",
  "/players/francesco/hall/rooms/b12.c","south"
});}
...
buoy(str) {
   ...
   if(str=="sign"){
    write("For more info on freestyle, please feel free to visit\n"+
          "the following sites:\n"+
          "http://www.svl.ch/crawl/freestyle.html\n"+
          "http://www.sportsci.org/news/biomech/skeptic.html#brown and counsilman\n"+
          "http://www.wellesley.edu/Athletics/pe/swimming/swimming_freewhole.html");
    return 1;}
