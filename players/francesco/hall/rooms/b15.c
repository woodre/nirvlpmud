...
reset(arg) {
  if(arg) return;
   if (!present("monster")) {  
   move_object(clone_object("/players/francesco/hall/mobs/spitz.c"),
	this_object());  }
set_light(1);
...
dest_dir = ({
  "/players/francesco/hall/rooms/b1.c","northeast",
  "/players/francesco/hall/rooms/b14.c","southwest"
});}
...
buoy(str) {
   ...
   if(str=="sign"){
    write("For more info on butterfly, please feel free to visit\n"+
          "the following sites:\n"+
          "http://www.svl.ch/butterfly/butterfly.html\n"+
          "http://www.wellesley.edu/Athletics/pe/swimming/swimming_butterflywhole.html");
    return 1;}
