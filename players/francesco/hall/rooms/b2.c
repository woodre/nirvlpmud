...
reset(arg) {
  if(arg) return;
   if (!present("monster")) {  
   move_object(clone_object("/players/francesco/hall/mobs/chet.c"),
	this_object());  }
set_light(1);
...
dest_dir = ({
  "/players/francesco/hall/rooms/b1.c","west",
  "/players/francesco/hall/rooms/b3.c","east"
});}
...
buoy(str) {
   ...
   if(str=="sign"){
    write("For more info on breaststroke, please feel free to visit\n"+
          "the following sites:\n"+
          "http://www.breaststroke.info\n"+
          "http://www.svl.ch/breaststroke/brustschwimmen.html\n"+
          "http://www.wellesley.edu/Athletics/pe/swimming/swimming_breaststrokewhole.html\n");
    return 1;}
