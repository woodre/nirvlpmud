...
dest_dir = ({
  "/players/francesco/hall/rooms/b2.c","east",
  "/players/francesco/hall/rooms/b15.c","southwest"
});}
...
buoy(str) {
   ...
   if(str=="sign"){
    write("The breaststroke style requires more strenght than any other style,\n"+
          "including butterly.  Matter of fact, the reciprocating action of \n"+ 
          "both legs and arms is done at the same time under the water, thus \n"+
          "raising the friction and decreasing the speed as well.\n");
    return 1;}
