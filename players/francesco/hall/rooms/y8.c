...
short_desc = ""+HIW+"A snowy road"+NORM+"" ;
long_desc =

     ""+HIW+"   This snowy road connects downtown with the cross-country \n"+
            "skiing area.  it can be easily walked by because the snow is\n"+
            "well compacted and the risks of sliding are close to zero.\n"+
            "The perfect visibility of the far mountains and the wonderful\n"+
...
dest_dir = ({
  "/players/francesco/hall/rooms/y7.c","east",
  "/players/francesco/hall/rooms/y9.c","west"
});}
