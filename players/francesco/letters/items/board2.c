...
long() {
    write("  This "+name+" board is open to everyone to write their own notes\n"+
          "about their personal past here in Nirvana.  How they roleplay, \n"+
          "how they handle their personal relationships, what they expected \n"+
          "from the mud and what they got, how they like to be considered\n"+
          "and how they consider their friends.  In other words, a mental \n"+
          "image of yourself.  Everything can be posted, provided it is not\n"+
          "offensive, nor rude, nor scurrilous to anyone. \n"+
