/*                                                                    *
 *    File: valen  /players/valen/area/catacombs/rooms/dungeonb1.c    *
 *    Function:         room                                          *
 *    Author(s):        valen@Nirvana                                 *
 *    Copyright:        Copyright (c) 2009 valen                      *
 *                              All Rights Reserved.                  *
 *    Source:           08/09/09                                      *
 *    Notes:            dungeon room b 1                              *
 *                                                                    *
 *                                                                    *
 *    Change History:                                                 *
 */
...
to be some type of glowing runes on the arched gateway."+NORM+"\n";
  ...
  dest_dir =
  ({
    "/players/valen/area/catacombs/rooms/dungeona1.c",     "west",
    "/players/valen/area/catacombs/rooms/dungeonb2.c",     "south",
    "/players/valen/area/catacombs/rooms/dungeonc1.c",     "east",
  });
}