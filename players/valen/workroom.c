...
reset(arg) {
  ...
  set_light(1);
  long_desc=
"	A dungeon deep underneath Nirvana.  The lack of air is making it \n"+
"hard to breath here.  It's dark and cold in this small vault. There \n"+
"is a granite desk with a stack of books on the ground in the middle \n"+
"of the room.  A dirty pool is in the corner. A glowing portal is floating \n"+
"in a different corner.\n"+
"This is a example of"+RED+" foreground colors"+NORM+"\n"+
"This is a example of"+BLK+" foreground colors"+NORM+"\n"+
"This is a example of"+HIG+" Hi Intensity Foreground Colors"+NORM+"\n"+
"This is a example of"+HIBLK+" Hi Intensity Foreground Colors"+NORM+"\n"+
"This is a example of"+BBLU+" Background Colors"+NORM+"\n"+
"This is a example of"+HBCYN+" High Intensity Background Colors"+NORM+"\n"; 
    ...
    "portal","A swirling blue gateway through which you can travel.\n"+
             "Type 'tp' for help",
    "pool",
             "A pool of water. You can see moss floating in the water. \n"+
    ...
    "desk",
    		"The desk is made of pure stone.  As if it was craved\n"+
...
short() {
  ...
  if(cloak) {
    ...
    return str+""+NORM+capitalize(OWNER)+"'s dungeon"+str+""+NORM;
  }
}
