...
ONE_EXIT("players/ultramagnus/hobvil4","east",
	"The Hobbit Ville Equipment Bazaar",
	"You are in the only shop in this small town that sells equipment\n"+
	"for adventuring.  These equipments are available if and only if\n"+
	"the store has them in stock...\n"+
	"To the west, you see a door with a sign that says: PRIVATE\n"+
	"Through the windows, you see a hobbit, the owner, counting his money\n"+
	"To the south, you see a sign for the village blacksmith...\n"+
	"However, you also notice a sign by the door saying: This shop\n" +
...
north() {
	...
	write("You run into a locked door.\n");
	say(call_other(this_player(), "query_name", 0) +
	    " walks into a locked for.\n");
	return 1;
    }
