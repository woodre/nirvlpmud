	...
	if(!present("notice"))
{
 ...
 if (!present("terminal"))
  ...
  set_light(1);
   ...
   long_desc=
          "  You've entered Hogath's Workroom, it's pretty damn empty!\n";
  items=({});
  dest_dir=({
	"/room/vill_green","green",
	"/room/post","post",
  "/room/adv_inner","wizhall",
  "/players/hogath/area/forest/PATH/path0","forest",
  });
}

cmd_smell(str) {
  write("You smell a man's room, use your imagination darn it!.\n");
  return 1;
}

cmd_listen(str) {
  write("You hear the sound of Hogath thinking.  Man it's quiet!.\n");
  return 1;
}
...
short() {
  ...
  if(cloak) {
    switch(random(4)) {
      case 0: str="Cyber Heal Pod"; break;
      case 1: str="A bend in the road"; break;
      case 2: str="Shop"; break;
      case 3: str="Casa de Nirvana room number 210"; break;
      case 4: str="Village Green"; break;
      default: str="Unknown";
    }
    return str;
  }
...
scry(string str) {
  ...
  write("You gaze into the TV and see: \n");
  person->long();
