  ...
  "corner of the wall reads, ‘Rooms 476 - 499'.  Soft track lighting\n"+
  ...
  "and air conditioning unit.  To the west is a similarly decorated \n"+
  "hallway, the mirrored plate on the corner reading,‘Rooms 451 - 475'.\n"+
  "Another hallway lies to the north, its room numbers obscured from this\n"+
  "distance. \n");
items=({
