...
*/
    ...
    dest_dir = ({"players/beren/Rooms/Gdemia/groom5", "east",
                 "players/beren/Rooms/Gdemia/groom4", "west",
                 "players/beren/Rooms/Gdemia/groom2", "up",
                 "players/beren/Rooms/Gdemia/groom6", "down"});
}
