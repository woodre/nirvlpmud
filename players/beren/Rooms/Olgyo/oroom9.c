...
"you can do - don't trouble them!\n";
    dest_dir = ({"players/beren/Rooms/Olgyo/oroom14", "north",
                 "players/beren/Rooms/Olgyo/oroom", "south",
                 "players/beren/Rooms/Olgyo/oroom12", "east",
		 "players/beren/Rooms/Olgyo/oroom10", "west"});
}
