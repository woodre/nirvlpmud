...
short_desc = BOLD+BLK+"Below "+NORM+"the"+HIM+" Living Ooze"+NORM;
...
dest_dir = ({
   ...
   "/players/jaraxle/3rd/ooze/rooms/rooms.c","up",
...
for(i=0; i < sizeof(entered); i++){
  ...
  return 1;
   ...
   test = clone_object("/players/jaraxle/cave/rooms/randomcave.c");
