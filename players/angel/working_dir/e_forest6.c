...
reset(arg) {
  ...
  dest_dir=({
             "players/nooneelse/entryforest/e_forest7", "north",
             "players/nooneelse/entryforest/e_forest2", "east",
             "players/nooneelse/entryforest/e_forest9", "west",
             "players/nooneelse/entryforest/e_forest5", "south",
           });
}
