/*                                                                    *
 *    File:             /players/angel/area/stargate/room/hall11.c    *
 *    Function:         room                                          *
...
is well secured. The hallway leads to many rooms."+NORM+"\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/stargate/room/hall1",  "north",
	"/players/angel/area/stargate/room/hall12", "south",
	"/players/angel/area/stargate/room/lr",     "east",
  });
}
