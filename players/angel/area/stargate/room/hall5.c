/*                                                                    *
 *    File:             /players/angel/area/stargate/room/hall5.c     *
 *    Function:         room                                          *
...
is well secured. The hallway leads to many rooms."+NORM+"\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/stargate/room/hall4", "north",
	"/players/angel/area/stargate/room/hall6", "south",
	"/players/angel/area/stargate/room/ar", "west",
  });
}
