 ...
 * the NPC's roam to kick in when loaded */
  ...
  long_desc =
"    "+HIC+"~ ARMORY ~"+NORM+"\n\
"+CYN+"  Though there is a main armory at S.G.C., several smaller arms lockers\n\
like this can be found throughout the base. Often equipped with\n\
bullet-proof gear, P-90s and other Earth equipment, the armories\n\
...
weapons in the event an intruder cannot be disabled otherwise."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/stargate/room/hall1", "east",
  });
}
