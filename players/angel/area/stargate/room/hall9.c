/*                                                                    *
 *    File:             /players/angel/area/stargate/room/hall9.c     *
 *    Function:         room                                          *
...
is well secured. The hallway leads to many rooms."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/stargate/room/hall8",  "north",
	"/players/angel/area/stargate/room/hall10", "south",
	"/players/angel/area/stargate/room/hc4",    "east",
	"/players/angel/area/stargate/room/hc",     "west",
  });
}
