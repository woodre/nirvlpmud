/*                                                                    *
 *    File:             /players/angel/area/stargate/room/hall12.c    *
 *    Function:         room                                          *
...
is well secured. The hallway leads to many rooms."+NORM+"\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/stargate/room/hall11", "north",
	"/players/angel/area/stargate/room/hall13", "south",
	"/players/angel/area/stargate/room/cl",     "east",
	"/players/angel/area/stargate/room/dl",     "west",
  });
}
