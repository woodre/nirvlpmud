/*                                                                    *
 *    File:             /players/angel/area/stargate/room/hall1.c     *
 *    Function:         room                                          *
...
reset(arg)
{
  ...
  dest_dir =
  ({
	"/players/angel/area/stargate/room/hall11",  "south",
	"/players/angel/area/stargate/room/cr",      "east",
	"/players/angel/area/stargate/room/ar3",     "west",
  });
}
...
long(str)
{
    ...
    write("There are four obvious exit: north, south, east and west.\n");
    if (lamp_is_lit)
...
id(str) {
    ...
    north() {
        if (call_other("/players/angel/area/stargate/room/elevator", "query_door", 0) ||
            call_other("/players/angel/area/stargate/room/elevator", "query_level", 0) != 26) {
            write("The door is closed.\n");
            return 1;
    }
    ...
    open(str)
    {
        if (str != "door")
            return 0;
        if (call_other("/players/angel/area/stargate/room/elevator", "query_level", 0) != 26) {
    ...
    push(str)
    {
        if (!str || str != "button")
            return 0;
        if (call_other("/players/angel/area/stargate/room/elevator", "call_elevator", 26))
            lamp_is_lit = 1;
