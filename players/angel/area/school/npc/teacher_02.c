...
reset(arg)
{
  ...
  set_long("\
This is an average school teacher. She is in her mid 40's and\n\
enjoys children\n");
  set_level(13);
  set_hp(195);
  set_wc(17);
  ...
  load_chat("The teacher says, lets get started class!\n");
  gold=clone_object("obj/money");
  gold->set_money(random(400)+25);
  move_object(gold, this_object());
  armor=clone_object("/players/angel/area/school/obj/nike_01.c");
