/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/s_02.c      *
 *    Function:         room                                          *
...
not harmed.  From this point you may continue up the stais,\n\
to the Tree Top City, or down, to the Elven Forest.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/s_03",        "stairs",
	"/players/angel/area/elvandar/room/s_01",        "down",
	"/players/angel/area/elvandar/room/stables",     "south",
  });
}