/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/es_03.c     *
 *    Function:         room                                          *
...
this point you may go South or West, upon the Elven Paths.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/es_04",     "south",
	"/players/angel/area/elvandar/room/es_01",     "west",
  });
}