/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/es_02.c     *
 *    Function:         room                                          *
...
this point you may go South or East, upon the Elven Paths.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/es_05",     "south",
	"/players/angel/area/elvandar/room/es_01",     "east",
  });
}