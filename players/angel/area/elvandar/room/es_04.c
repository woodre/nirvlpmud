/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/es_04.c     *
 *    Function:         room                                          *
...
this point you may go West, or North and South upon the Elven\n\
Paths.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/es_03",     "north",
	"/players/angel/area/elvandar/room/es_06",     "south",
	"/players/angel/area/elvandar/room/house",     "west",
  });
}