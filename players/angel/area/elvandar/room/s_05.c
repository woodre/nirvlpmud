/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/s_05.c      *
 *    Function:         room                                          *
...
to the Tree Top City, or down, to the Elven Forest.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/s_07",      "stairs",
	"/players/angel/area/elvandar/room/s_04",      "down",
	"/players/angel/area/elvandar/room/es_01",     "south",
  });
}