/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/es_07.c     *
 *    Function:         room                                          *
...
this point you may go South, or North and East on the Elven Paths.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/es_05",     "north",
	"/players/angel/area/elvandar/room/s_06",      "south",
	"/players/angel/area/elvandar/room/es_08",     "east",
  });
}