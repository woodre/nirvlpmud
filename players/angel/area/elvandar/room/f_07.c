/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/f_07.c      *
 *    Function:         room                                          *
...
to the North, South, and East, deeper into the Forest.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/f_08",       "north",
	"/players/angel/area/elvandar/room/f_06",       "south",
	"/players/angel/area/elvandar/room/glade",      "east",
  });
}