/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/f_04.c      *
 *    Function:         room                                          *
...
to North or West, deeper into the Forest.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/f_03",      "north",
	"/players/angel/area/elvandar/room/f_05",      "west",
  });
}