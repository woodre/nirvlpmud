/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/es_06.c     *
 *    Function:         room                                          *
...
this point you may go North or West on the Elven Paths.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/es_04",     "north",
	"/players/angel/area/elvandar/room/es_08",     "west",
  });
}