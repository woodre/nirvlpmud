/*                                                                    *
 *    File:             /players/angel/area/elvandar/room/s_07.c      *
 *    Function:         room                                          *
...
higher and higher in your throat with pure exhilaration.  In\n\
...
not harmed.  From this point you may continue North, East, to\n\
the Tree Tops, or South to the Elven Forest.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/elvandar/room/heights",     "stairs",
	"/players/angel/area/elvandar/room/s_05",        "down",
  });
}