inherit "room/room";
/*                                                                    *
 *    File:             /players/angel/area/town/room/beech_05.c      *
 *    Function:         room                                          *
...
'131' Beech Drive\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/beech_06",     "east",
    "/players/angel/area/town/room/beech_04",     "northwest",
  });
}

init() {
  ::init();
    add_action("enter","131");
}
...
enter(str) {
    ...
    "walking over to the lawn#/players/angel/area/town/land/land_07.c");
