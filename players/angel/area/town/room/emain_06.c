/*                                                                    *
 *    File:             /players/angel/area/town/room/emain_06.c      *
 *    Function:         room                                          *
...
reset(arg)
{
  ...
  if(arg) return;
  set_light(1);
  short_desc = "East Main & 6th";
  long_desc =
"    "+HIB+"East Main and Sixth"+NORM+".\n\
...
main street.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/emain_07",     "east",
    "/players/angel/area/town/room/emain_05",     "west",
  });
