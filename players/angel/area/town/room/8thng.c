/*                                                                    *
 *    File:             /players/angel/area/town/room/8thng.c         *
 *    Function:         room                                          *
...
reset(arg)
{
  ...
  if(arg) return;
  set_light(1);
  short_desc = "8th & North G";
  long_desc =
"    "+HIB+"Eighth and North G street"+NORM+"\n\
...
south is the entrance of Beech Drive.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/8thnh",     "north",
    "/players/angel/area/town/room/8thnf",     "south",
  });
}