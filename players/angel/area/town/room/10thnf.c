/*                                                                    *
 *    File:             /players/angel/area/town/room/10thnf.c        *
 *    Function:         room                                          *
...
reset(arg)
{
  ...
  if(arg) return;
  set_light(1);
  short_desc = "10th & North F";
  long_desc =
"    "+HIY+"Tenth and North F street"+NORM+"\n\
...
trees provide plenty of shade for people looking for cover.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/10thng",     "north",
    "/players/angel/area/town/room/10thne",     "south",
  });
}