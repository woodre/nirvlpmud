inherit "room/room";
/*                                                                    *
 *    File:             /players/angel/area/town/room/beech_06.c      *
 *    Function:         room                                          *
...
'133' Beech Drive\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/8thne",        "east",
    "/players/angel/area/town/room/beech_05",     "west",
  });
}

init() {
  ::init();
    add_action("enter","133");
}
...
enter(str) {
    ...
    "walking over to the lawn#/players/angel/area/town/land/land_08.c");
