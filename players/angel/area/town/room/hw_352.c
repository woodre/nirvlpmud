/*                                                                    *
 *    File:             /players/angel/area/town/room/hw_352.c        *
 *    Function:         room                                          *
...
Kentucky Fried Chicken [KFC] to the north in a gas station shopping\n\
center.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/hw_351",   "east",
    "/players/angel/area/town/room/hw_353",   "west",
  });
