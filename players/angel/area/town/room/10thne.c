/*                                                                    *
 *    File:             /players/angel/area/town/room/10thne.c        *
 *    Function:         room                                          *
...
reset(arg)
{
  ...
  if(arg) return;
  set_light(1);
  short_desc = "10th & North E";
  long_desc =
"    "+HIY+"Tenth and North E street"+NORM+"\n\
...
trees provide plenty of shade for people looking for cover.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/10thnf",     "north",
    "/players/angel/area/town/room/10thnd",     "south",
  });
}