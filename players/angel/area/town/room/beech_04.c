inherit "room/room";
/*                                                                    *
 *    File:             /players/angel/area/town/room/beech_04.c      *
 *    Function:         room                                          *
...
'129' Beech Drive\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/beech_03",     "northwest",
    "/players/angel/area/town/room/beech_05",     "southeast",
  });
}

init() {
  ::init();
    add_action("enter","129");
}
...
enter(str) {
    ...
    "walking over to the lawn#/players/angel/area/town/land/land_06.c");
