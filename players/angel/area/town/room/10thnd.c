/*                                                                    *
 *    File:             /players/angel/area/town/room/10thnd.c        *
 *    Function:         room                                          *
...
reset(arg)
{
  ...
  if(arg) return;
  set_light(1);
  short_desc = "10th & North D";
  long_desc =
"    "+HIY+"Tenth and North D street"+NORM+"\n\
...
trees provide plenty of shade for people looking for cover.\n";
  ...
  dest_dir =
  ({
    "/players/angel/area/town/room/10thne",     "north",
    "/players/angel/area/town/room/10thnc",     "south",
  });
}