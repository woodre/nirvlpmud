/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/hall_07.c   *
 *    Function:         room                                          *
...
turn on and off as people walk in and out of each area."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/atlantis/room/hall_08.c",     "north",
    "/players/angel/area/atlantis/room/hall_06.c",     "south",
    "/players/angel/area/atlantis/room/lq_04.c",       "east",
    "/players/angel/area/atlantis/room/lq.c",          "west",
  });
}