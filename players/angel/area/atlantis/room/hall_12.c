/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/hall_12.c   *
 *    Function:         room                                          *
...
turn on and off as people walk in and out of each room."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/atlantis/room/hall_13.c",     "north",
    "/players/angel/area/atlantis/room/hall_11.c",     "south",
    "/players/angel/area/atlantis/room/mh_02.c",          "west",
  });
}