/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/hall_04.c   *
 *    Function:         room                                          *
...
turn on and off as people walk in and out of each room."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/atlantis/room/hall_05.c",     "north",
	"/players/angel/area/atlantis/room/tp_01.c",       "east",
    "/players/angel/area/atlantis/room/hall_03.c",     "west",
  });
}