/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/tp_05.c     *
 *    Function:         room                                          *
...
if(arg) return;
  set_light(1);
  short_desc = " Transporter 5";
  long_desc =
"      "+WHT+"~ Transporter 5 ~"+NORM+"\n\
...
center screen is in english."+NORM+"\n";
  ...
  ({
    ...
    Brig, Gate, Quarters, and Labs",
  });

  dest_dir =
  ({
	"/players/angel/area/atlantis/room/pjb.c",         "east",
