/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/hall_08.c   *
 *    Function:         room                                          *
...
turn on and off as people walk in and out of each room."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/atlantis/room/hall_09.c",     "northeast",
    "/players/angel/area/atlantis/room/hall_07.c",     "south",
    "/players/angel/area/atlantis/room/lq_03.c",       "east",
    "/players/angel/area/atlantis/room/lq_02.c",       "west",
  });
}