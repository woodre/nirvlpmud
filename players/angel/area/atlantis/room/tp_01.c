/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/tp_01.c     *
 *    Function:         room                                          *
...
if(arg) return;
  set_light(1);
  short_desc = " Transporter 1";
  long_desc =
"      "+WHT+"~ Transporter 1 ~"+NORM+"\n\
...
center screen is in english."+NORM+"\n";
  ...
  ({
    ...
    Brig, Labs, Quarters, and Bay",
  });

  dest_dir =
  ({
	"/players/angel/area/atlantis/room/hall_04.c",     "west",
