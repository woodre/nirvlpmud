/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/hall_14.c   *
 *    Function:         room                                          *
...
turn on and off as people walk in and out of each room."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/atlantis/room/hall_15.c",     "north",
	"/players/angel/area/atlantis/room/tp_04.c",       "south",
    "/players/angel/area/atlantis/room/lab.c",         "west",
  });
}