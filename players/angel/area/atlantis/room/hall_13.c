/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/hall_13.c   *
 *    Function:         room                                          *
...
turn on and off as people walk in and out of each area."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/atlantis/room/lq_06.c",      "north",
    "/players/angel/area/atlantis/room/hall_12.c",    "south",
	"/players/angel/area/atlantis/room/lq_07.c",      "east",
    "/players/angel/area/atlantis/room/lq_05.c",      "west",
  });
}