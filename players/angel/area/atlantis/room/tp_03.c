/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/tp_03.c     *
 *    Function:         room                                          *
...
if(arg) return;
  set_light(1);
  short_desc = " Transporter 3";
  long_desc =
"      "+WHT+"~ Transporter 3 ~"+NORM+"\n\
...
center screen is in english."+NORM+"\n";
  ...
  ({
    ...
    Bay, Gate, Quarters, and Labs",
  });

  dest_dir =
  ({
	"/players/angel/area/atlantis/room/brig.c",        "north",
