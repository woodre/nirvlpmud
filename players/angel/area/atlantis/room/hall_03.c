/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/hall_03.c   *
 *    Function:         room                                          *
...
turn on and off as people walk in and out of each room."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/atlantis/room/mb.c",          "north",
	"/players/angel/area/atlantis/room/mh.c",          "south",
	"/players/angel/area/atlantis/room/hall_04.c",     "east",
    "/players/angel/area/atlantis/room/hall_02.c",     "west",
  });
}