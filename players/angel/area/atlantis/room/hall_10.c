/*                                                                    *
 *    File:             /players/angel/area/atlantis/room/hall_10.c   *
 *    Function:         room                                          *
...
turn on and off as people walk in and out of each room."+NORM+"\n";
  ...
  dest_dir =
  ({
	"/players/angel/area/atlantis/room/hall_11.c",     "north",
	"/players/angel/area/atlantis/room/tp_02.c",       "east",
    "/players/angel/area/atlantis/room/ag.c",          "west",
  });
}