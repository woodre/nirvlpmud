/*                                       
 *  File:   /players/mosobp/areas/TOWER/rooms/t21.c    
 *  Function:  room                      
...
reset(arg)
{
  ...
  "are trees all around. There is a fountain in the corner\n"+
  "of the room."+NORM+"\n";
  ...
  ({
    ...
    "fountain",
    "A giant fountain of a couple of fish in the corner",
   });
  
  dest_dir =
  ({
    "/players/mosobp/areas/TOWER/rooms/t22.c",  "east",
    "/players/mosobp/areas/TOWER/rooms/t20.c",  "west",
    "/players/mosobp/areas/TOWER/rooms/t17.c",  "north",
  });
  return 1;
}