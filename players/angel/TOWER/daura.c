/*                                       
 *  File:   /players/mosobp/areas/TOWER/obj/daura.c
 *  Function:  object                    
...
reset(arg) 
{
	set_name("aura");
	set_alias("misc");
	set_short(HIK+"An Energy Aura"+NORM);
	set_long(
	"This is the energy aura of an Evil fighter. When\n"+
	"an evil fighter is powered up this forms around their ki.\n"+
	"This particular aura only forms around someone of the deepest\n"+
	"of evil intenions.\n");
  ...
  return;
   ...
   if(arg=="aura"){
      if(this_player()->query_alignment() > 100) {
         write("The Aura refuses to power up for good.\n");
         return 1;
      }
      if(::wear(arg));
