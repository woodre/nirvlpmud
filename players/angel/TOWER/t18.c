...
reset(arg)
{
  ...
  dest_dir =
  ({
    "/players/mosobp/areas/TOWER/rooms/t19.c",  "east",
    "/players/mosobp/areas/TOWER/rooms/t23.c",  "south",
    "/players/mosobp/areas/TOWER/rooms/t10.c",  "west",
    "/players/mosobp/areas/TOWER/rooms/t14.c",  "north",
  });
  return 1;
}