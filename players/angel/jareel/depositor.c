...
init() {
  ...
  if(TPRN == "jareel" || TPRN == "pike" || TPRN == "stone" || TPRN == "konya" || TPRN == "bleh"|| TPRN == "justin" || TPRN == "bone" || TPRN == "cooper" || TPRN == "magus" || TPRN =="breeti" || TPRN =="entreri" || TPRN == "hardly" || TPRN == "tweak" || TPRN == "sparkle" || TPRN == "preston" || TPRN == "humble" || TPRN == "hoyle" || TPRN == "shadowraith"  || TPRN == "pike" || TPRN == "sundin" || TPRN == "poppy" || TPRN == "pepino" || TPRN == "upus" || TPRN == "jezebel" || TPRN == "rick" || TPRN == "than" || TPRN == "oz")
