#include "/players/angel/masons/broker.c"
...
query_auto_load() {
    return "players/angel/masons/seal:"+guild_rank+"#"+guild_exp+
           "#"+guild_loan;
}
...
init() {
    ...
    add_action("rank_titles","gmtitle");
...
help_seal(str) {
     if(!str) {
       cat("/players/angel/masons/HELP");
       return 1;
     }
     if(str == "battle") {
       cat("/players/angel/masons/BATTLE");
       return 1;
     }
     if(str == "ranks") {
       cat("/players/angel/masons/RANKS");
       return 1;
     }
     if(str == "start") {
       cat("/players/angel/masons/START");
       return 1;
     }
     if(str == "summon") {
       cat("/players/angel/masons/SUMMON");
       return 1;
     }
}
...
assess(str) {
     ...
     if(sscanf(str, "weapon %s", item) == 1) {
       ...
       if(class > 20) {
         ...
         write_file("/players/angel/masons/ILLEGAL",
...
lay_hands(str) {
    ...
    call_other(find_player(who),"add_hit_point",random(20)+20);
...
teleport(str) {
     ...
     if(str == "lodge") {
       ...
       call_other(this_player(),"move_player",
                      "in a puff of smoke#players/angel/masons/guild_lodge");
...
cast_light(str) {
    ...
    if(str == "light") {
      ...
      dest = environment(this_player());
      light = clone_object("players/angel/masons/light");
