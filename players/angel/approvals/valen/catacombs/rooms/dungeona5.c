...
reset(arg)
{
  ...
  long_desc =
  HIBLK+"  The catacombs storage is dark. The shelves are empty except\n\
for the spider webs.  The ground is covered with dust. The\n\
arched ceiling is is covered with weeds. The ground is dusty\n\
