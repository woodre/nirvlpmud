/*                                                                    *
 *    File: valen  /players/valen/area/catacombs/rooms/dungeona3.c    *
 *    Function:         room                                          *
 *    Author(s):        valen@Nirvana                                 *
 *    Copyright:        Copyright (c) 2009 valen                      *
 *                              All Rights Reserved.                  *
 *    Source:           08/09/09                                      *
 *    Notes:            dungeon room a 3                              *
 *                                                                    *
 *                                                                    *
 *    Change History:                                                 *
 */
...
reset(arg)
{
  ...
  smaller. One pillar has succumbed to the wrath of time.\n\
  There are few torches hanging on the pillars.\n\
  ...
  ({
    ...
    "pillar",
    "The broken pillar blocks the path to the north",
  });
  dest_dir =
  ({
    "/players/valen/area/catacombs/rooms/dungeonb3.c",     "east",
  });
}