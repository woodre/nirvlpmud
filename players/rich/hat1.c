...
zap(str) {
    ...
    shout("You see a phaser lance across the sky!!!!\n");
    shout("You see a great explosion as the phaser strike hits its target!!!\n");
    tell_object(liv,"You are unfortunately the target.\n");
