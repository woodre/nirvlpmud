	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze32.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze22.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze34.c","west",
		});
	}
}