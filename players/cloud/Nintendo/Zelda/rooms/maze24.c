	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze25.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze13.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze31.c","north",
			"players/cloud/Nintendo/Zelda/rooms/maze23.c","west",
		});
	}
}