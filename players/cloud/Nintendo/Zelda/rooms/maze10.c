	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze9.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze11.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze27.c","north",
		});
	}
}