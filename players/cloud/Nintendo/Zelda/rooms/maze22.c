	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze23.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze15.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze33.c","north",
			"players/cloud/Nintendo/Zelda/rooms/maze21.c","west",
		});
	}
}