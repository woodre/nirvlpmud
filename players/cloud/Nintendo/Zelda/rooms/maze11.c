	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze10.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze8.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze12.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze26.c","north",
		});
	}
}