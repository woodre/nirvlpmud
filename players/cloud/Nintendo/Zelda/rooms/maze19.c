	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze20.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze18.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze36.c","north",
		});
	}
}