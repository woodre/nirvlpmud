	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze17.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze1.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze19.c","north",
		});
	}
}