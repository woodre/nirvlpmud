	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze15.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze3.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze17.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze21.c","north",
		});
	}
}