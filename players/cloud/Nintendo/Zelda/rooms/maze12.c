	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze11.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze7.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze13.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze25.c","north",
		});
	}
}