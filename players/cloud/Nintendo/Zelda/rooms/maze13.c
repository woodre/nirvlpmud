	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze12.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze6.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze14.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze24.c","north",
		});
	}
}