	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze3.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze1.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze17.c","north",
		});
	}
}