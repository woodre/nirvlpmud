	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze5.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze7.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze13.c","north",
		});
	}
}