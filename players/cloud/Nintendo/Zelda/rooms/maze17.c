	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze16.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze2.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze18.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze20.c","north",
		});
	}
}