	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze24.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze14.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze32.c","north",
			"players/cloud/Nintendo/Zelda/rooms/maze22.c","west",
		});
	}
}