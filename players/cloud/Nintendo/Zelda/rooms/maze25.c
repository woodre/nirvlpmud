	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze26.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze12.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze30.c","north",
			"players/cloud/Nintendo/Zelda/rooms/maze24.c","west",
		});
	}
}