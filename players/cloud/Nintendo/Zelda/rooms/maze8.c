	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze7.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze9.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze11.c","north",
		});
	}
}