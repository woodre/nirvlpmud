...
{	
	...
	if(!present("link"))
	{
		move_object(clone_object("/players/cloud/Nintendo/Zelda/mobs/link.c"),this_object());
	}
	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze21.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze17.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze35.c","north",
			"players/cloud/Nintendo/Zelda/rooms/maze19.c","west",
		});
	}
}