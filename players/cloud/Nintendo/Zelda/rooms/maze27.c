	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze10.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze28.c","north",
			"players/cloud/Nintendo/Zelda/rooms/maze26.c","west",
		});
	}
}