	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze14.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze4.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze16.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze22.c","north",
		});
	}
}