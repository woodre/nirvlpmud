	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze33.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze21.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze35.c","west",
		});
	}
}