	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze13.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze5.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze15.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze23.c","north",
		});
	}
}