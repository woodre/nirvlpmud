	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze30.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze24.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze32.c","west",
		});
	}
}