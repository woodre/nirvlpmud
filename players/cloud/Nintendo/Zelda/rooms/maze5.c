	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze0.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze4.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze6.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze14.c","north",
		});
	}
}