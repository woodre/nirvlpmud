	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze22.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze16.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze34.c","north",
			"players/cloud/Nintendo/Zelda/rooms/maze20.c","west",
		});
	}
}