	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze34.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze20.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze36.c","west",
		});
	}
}