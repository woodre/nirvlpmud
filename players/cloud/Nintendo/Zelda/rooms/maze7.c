	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze6.c","west",
			"players/cloud/Nintendo/Zelda/rooms/maze8.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze12.c","north",
		});
	}
}