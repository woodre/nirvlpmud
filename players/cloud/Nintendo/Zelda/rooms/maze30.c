	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze29.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze25.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze31.c","west",
		});
	}
}