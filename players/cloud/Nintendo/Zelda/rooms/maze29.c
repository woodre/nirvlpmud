	...
	if(!arg)
 	{
		...
		dest_dir = 
		({
			"players/cloud/Nintendo/Zelda/rooms/maze28.c","east",
			"players/cloud/Nintendo/Zelda/rooms/maze26.c","south",
			"players/cloud/Nintendo/Zelda/rooms/maze30.c","west",
		});
	}
}