...
#include <is_wizard.h>          // Chameloid, 3-Nov-1998
#include <prop/room.h>          // room properties
#include <server.h>             // global servers
#include <timedep.h>            // time predefines, Coogan, 25-Oct-1997
#include <light.h>              // light defines, Ugh Apr-07-1999
#include <event.h>
#include <libs.h>               // for LIB_LIGHT, Coogan, 11-Apr-2002
...
inherit "basic/timedepdesc";    // provide time dependant descriptions,
                                // Coogan, 25-Oct-1997
inherit "basic/description";    // provide short and long description
inherit "basic/namespace";      // provide namespace for timedep
inherit "basic/timedep";        // provide time dependant behaviour
inherit "basic/timedepitem";    // provide time dependant faked items
inherit "basic/exit";           // provide exits and exit hooks
inherit "basic/light";          // provide easy light handling
inherit "basic/extralong";      // provide extra descriptions to our long
inherit "basic/property";       // provide property values
inherit "basic/region";         // provide absolute location of the room
inherit "basic/take_action";    // provide possibility to take fakeitems
inherit "basic/notify";         // provide ability to notify other objects of
                                // reset in this object
inherit "basic/autoloading";    // saving of contained auto_load-objects
inherit "basic/populate";       // provide easy populating, Coogan, 10-Mar-1999
inherit "basic/view";           // provide view to other rooms Alfe 2002-Jan-17
inherit "basic/event_listener"; // provide moveevent-listening Alfe 2002-Mar-14
inherit "basic/traces";         // provide traces in rooms Alfe 2002-Mar-14
inherit "complex/create";       // Coogan, 10-Mar-1999
