...
void preggers_long(int me_me, int fat, int ptime)
{
  if(fat > 250) ptime -= 600;
  if(fat > 300) ptime -= 200;
  if(fat > 350) ptime -= 400;
  if(fat > 400) ptime -= 400;
  
  if (ptime <= 4000) return;
  write((me_me?"You look":(string)this_object()->query_name()+" looks"));
    
  if      (ptime < 5001)   write(" about 3 months pregnant.\n");
  else if (ptime < 7200)   write(" about 4 months pregnant.\n");
  else if (ptime < 9000)   write(" about 5 months pregnant.\n");
  else if (ptime < 10800)  write(" about 6 months pregnant.\n");
  else if (ptime < 12700)  write(" about 7 months pregnant.\n");
  else if (ptime < 14400)  write(" about 8 months pregnant.\n");
  else if (ptime < 163000) write(" about 9 months pregnant.\n");
  else                     write(" about 10 months pregnant, WOW!\n");
}    
