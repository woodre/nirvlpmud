...
north()
{
    call_other(this_player(),"move_player", "north#room/south/sshore4");
    return 1;
}

south()
{
    call_other(this_player(), "move_player", "south#room/south/sshore6");
    return 1;
}

east()
{
    call_other(this_player(),"move_player", "east#room/south/sforst13");
    return 1;
}
