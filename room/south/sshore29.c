...
east()
{
    call_other(this_player(),"move_player", "east#room/south/sforst8");
    return 1;
}

west()
{
    call_other(this_player(), "move_player", "west#room/south/sshore28");
    return 1;
}

southeast()
{
    call_other(this_player(),"move_player", "southeast#room/south/sshore1");
    return 1;
}
