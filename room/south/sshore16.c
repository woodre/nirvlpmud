...
northwest()
{
    call_other(this_player(),"move_player", "northwest#room/south/sshore17");
    return 1;
}

south()
{
    call_other(this_player(), "move_player", "south#room/south/sforst40");
    return 1;
}

southeast()
{
    call_other(this_player(),"move_player", "southeast#room/south/sshore15");
    return 1;
}

west()
{
    call_other(this_player(),"move_player", "west#room/south/sforst34");
    return 1;
}
