...
north()
{
    call_other(this_player(),"move_player", "north#room/south/sshore1");
    return 1;
}

south()
{
    call_other(this_player(), "move_player", "south#room/south/sshore3");
    return 1;
}

east()
{
    call_other(this_player(),"move_player", "east#room/south/sforst10");
    return 1;
}
