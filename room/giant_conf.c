...
extra_reset() {
	...
	call_other(giant2, "set_ac", 7);
call_other(giant2, "set_hp", 300);
	...
	call_other(giant3, "set_ac", 8);
	call_other(giant3, "set_al", -150);
 call_other(giant3, "set_hp", 330);
	...
	call_other(giant1, "set_ac", 8);
call_other(giant1, "set_hp", 350);
