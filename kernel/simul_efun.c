...
#if 0 /* Moved to kernel/simul/game.c - Rumplemintz */
mapping living_name_m, name_living_m;
  /* Living -> Name and Name -> Living mappings.
   */
#endif

#if 0 /* Moved to kernel/simul/game - Rumplemintz */
//----------------------------------------------------------------------------
...
#if 0 /* Moved to /kernel/simul/misc.c - Rumplemintz */
//---------------------------------------------------------------------------
string version() {
    return __VERSION__;
}
