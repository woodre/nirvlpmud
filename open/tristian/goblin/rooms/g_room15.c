...
int rope;
    ...
    long_desc =
        " This area is almost overgrown in grass and trees there is a crude\n"+
        "tower built from logs and stones on the far side. With further\n"+
        "examination you notice clear cut kill zones and sight lines in the\n"+
        "trees and grass. The main camp is back the way you came and the forest\n"+
        "presses in close in every other direction.\n";
    ...
    move_object(this_player(),"/players/tristian/realms/goblin/rooms/tower2.c");
