...
reset(arg) {
  ...
  set_long(
    ...
    "Equipped with his plummers hat and overalls, its the peoples"+HIY+"Hero"+NO
RM+".\n"+
  ...
  set_wc(40);
  set_aggressive(0);
  move_object(clone_object("/players/sami/area/carnival/obj/armors/belt.c"),this
_object());
...
+"!!!\n",
  " "+HIR+"#MN#"+NORM+"jumps out of sight and lands on #AKN# "+HIR+"S K U L L"+N
ORM+"\n",
