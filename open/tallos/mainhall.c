...
#define PATH "/players/tallos/examples/7tigersrooms"
inherit "room/room";
reset(arg) {
  if(arg) return;

short_desc = HIY+"7 Tigers Inn"+NORM+":"+HIC+" Main Hall"+NORM;
long_desc = "      "+HIY+"The main hall of the "+NORM+""+NORM+""+YEL+"Inn"+HIY+" can be found here. Many\n"+
            ""+HIM+"doors"+HIY+" lead off to the inner part of the hotel.  As you\n"+
            "move you are passed by busy Inn "+HIC+"employees"+HIY+" on there way\n"+ 
            "to do the tasks that they are assigned.  In the center\n"+
            "of the room is a large "+HIB+"HOTEL DIRECTORY"+HIY+".  A huge "+BLK+"marble\n"+
            "sta"+HIR+"irc"+BLK+"ase"+HIY+" starts here and goes up."+NORM+"\n";
items = ({
  "employees",
  "Bellhops and hotel clerks move about doing odd tasks",
  "bellhops",
