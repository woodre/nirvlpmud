...
set_chance(10);
set_spell_dam(20);
set_spell_mess1("The Polymorph visciously attacks "+attacker_ob+" with its toothy maw. \n");    /*others*/
...
if(!random(10) && attacker_ob) big_special();
...
big_special() {
          if(environment())
          tell_room(environment(),"The Polymorph rears up in its true form. It's double jaws \n"+
          ...
          switch(random(5))  {
              ...
              case 4:
                     say ("The Polymorph slurps noisily on "+attacker_ob+"'s "+RED+"ANGER"+NORM+".\n");    /*others*/
                     write ("The Polymorph drains your "+RED+"ANGER"+NORM+" away.\n");    /*attacker*/
                     attacker_ob->hit_player(30,"other|mental");
                     break;

              case 3:
                     say ("The Polymorph slurps noisily on "+attacker_ob+"'s "+CYN+"COOL"+NORM+".\n");    /*others*/
                     write ("The Polymorph drains your "+CYN+"COOL"+NORM+" away.\n");    /*attacker*/
                     attacker_ob->hit_player(30,"other|mental");
                     break;

              case 2:
                     say ("The Polymorph slurps noisily on "+attacker_ob+"'s "+BLU+"GUILT"+NORM+".\n");    /*others*/
                     write ("The Polymorph drains your "+BLU+"GUILT"+NORM+" away.\n");    /*attacker*/
                     attacker_ob->hit_player(30,"other|mental"); 
                     break;

              case 1: 
                     say ("The Polymorph slurps noisily on "+attacker_ob+"'s "+YEL+"FEAR"+NORM+".\n");    /*others*/
                     write ("The Polymorph drains your "+YEL+"FEAR"+NORM+" away.\n");    /*attacker*/
                     attacker_ob->hit_player(30,"other|mental");
                     break;

              case 0: 
                     say ("The Polymorph slurps noisily on "+attacker_ob+"'s "+MAG+"LUST"+NORM+".\n");    /*others*/
                     write ("The Polymorph drains your "+MAG+"LUST"+NORM+" away.\n");    /*attacker*/
                     attacker_ob->hit_player(30,"other|mental");
                     break;
