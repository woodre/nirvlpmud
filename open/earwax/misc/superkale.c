...
reset(arg){
  ...
  if(arg) return;
   ...
   set_alias("kale");
   set_gender("neuter");
     set_short(HIW+BLINK+HIR+"Ka"+YEL+"le"+HIY+"id"+HIG+"os"+HIB+"co"+HIM+"pic  "+HIR+"Ka"+YEL+"le"+HIY+"id"+HIG+"os"+HIB+"co"+HIM+"pe"+NORM+"");
   ...
   set_spell_mess1("");
   set_spell_dam(35);
   kale = clone_object("/players/francesco/kale/items/kale10.c");
