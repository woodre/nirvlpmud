...
set_a_chat_chance(15);
  ...
  load_a_chat("Archangel snarls with anger as his sword strikes at you!\n");
...
heart_beat() {
  ...
  if(attacked && query_changed() == 0){
      ...
      " "+BOLD+""+RED+"Archangel of Fire."+NORM+"\n");
  	...
  	"armor. A flaming sword is held in his grip, its blade razor sharp.\n"+
  	"Huge flaming wings spread out from its back, sending out flaming\n"+
  	"waves of heat. You detect no humanity eminating from this thing\n"+
  	"of evil.\n");
...
monster_died() {
  ...
  tell_room(environment(this_object()),
  "As the Archangel dies you see his flaming sword fall from his limp hand, it\n"+
