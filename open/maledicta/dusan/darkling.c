...
set_long(
  "  This small creature seems to be all claws and teeth. Its body\n"+
  "is covered in small black gleaming scales, which offers good\n"+
  "protection against any attack. Its long arms and legs allow for\n"+
  "great speed and leaping, making this creature extremely dangerous.\n");
