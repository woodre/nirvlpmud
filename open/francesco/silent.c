...
add_action("","");                   /*  symbiotes          */
add_action("","");                   /*  necromancers       */
add_action("","");                   /*  necromancers       */
add_action("trap","att");            /*  templar alliance   */
add_action("trap","ate");            /*  templar alliance   */
add_action("trap","at");             /*  shardak aliance    */
add_action("trap","bc");             /*  bards              */
add_action("trap","bce");            /*  bards              */
...
trap(str){write("Shhhhh.......Dont speak here.......Just whisper......\n"); return 1;}
