...
long_desc =
"Short grass and a few bushes blend into the treeline south, east, and west.  The\n"+
"shore of a lake is to the north, and a narrow waterfall is visible on the cliff face\n"+
"behind the lake.  Small mounds of brown earth, some very freshly dug, spot the clearing.\n"+
"The clearing extends a bit farther south, but the tree line is very close to the west.\n"+
"Lodgepole pine grow so close together east as to make passage that way impossible.\n";
...
"mounds",  "The dirt pushed up from below by small creatures called\n"+
           ...
           "could 'dig' up a digger if you tried",
...
if(found) { write("All the diggers are hiding too deep in the ground now.\n"); 
return 1; }
