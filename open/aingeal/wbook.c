...
"\nThe "+HIR+"Wizard Handbook"+NORM+" index:\n\n"+
  "welcome     rules1     creativity1     interaction1     area1\n"+
...
if(str == "interaction3") { write(
  ...
  "way disrupting the game play of others and they will not stop after you've\n"+
  ...
  "should be shown to or shared with the player base until has been approved,\n"+
...
if(str == "area1") { write(
  ...
  "Proper grammar and punctuation should be used and that includes two spaces \n"+
...
if(str == "area2") { write(
  ...
  "space carrying money so use your head.  Once you've made an appropriately\n"+
...
if(str == "area3") { write(
  ...
  "are not done properly.  Here's a suggestion.  Only do about 3 rooms with and\n"+
  ...
  "for you.  Consider this first area a test.\n\n");
  return 1; }
