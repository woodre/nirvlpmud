...
/* The ring is armor worth about 1500 */
  move_object(clone_object("/players/aingeal/casino/armor/lring.c"),this_object());
}
     ...
     set_long("Liberace wears a brilliant smile only a shade less bright\n"+
              ...
              "at his fingertips.  He simpers ingratiatingly at the\n"+
              "audience as he announces his next number.\n");
     set_level(22);
     set_ac(16 + random(2));
     set_wc(32 + random(5));
   ...
   set_spell_dam(50);
     ...
     load_chat("Liberace pounds out a strident chord, then pauses \n"+
               "dramatically to smile broadly at you.\n");
     ...
     load_chat("Liberace launches into a spirited rendition of\n"+
               "Korsakov's 'Flight of the Bumblebee' on his baby grand.\n");
     ...
     load_chat("Liberace pauses dramatically over the keyboard of his\n"+
               "baby grand, then caresses your ears with the soothing\n"+
               "strains of 'Moonlight Sonata'.\n");
