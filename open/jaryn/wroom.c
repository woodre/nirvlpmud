...
reset(arg) {
  ...
  set_light(1);
  long_desc=
      "This is a balcony above the luxurious New Orleans French Quarter. Down\n"+
      "below is a horde of dancing people masquarading in brilliant costumes.\n"+
      "Enormous green, gold and purple balloons and floats thunder by in a\n"+
      "procession of festivities, like none known before. Beautiful women\n"+
      "holler and scream from the nearby balconies shouting for beads and\n"+
      "offering to show a little flesh!\n";
  items=({
...
short() {
  ...
  if(cloak) {
    ...
    switch(random(6)) {
      ...
      case 2: str=YEL;break;
      case 3: str=GRN;break;
      case 4: str=MAG;break;
      case 5: str=CYN;break;
      default: str=HIB; break;
    }
return str+BOLD+"The balcony of The Cats Meow"+str+NORM;
  }
}
