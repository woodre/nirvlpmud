...
id(str) { return (::id(str) || str == "eye" || str == "eyeball" 
     ...
     set_short(
       "An "+GRN+"Emerald Tree Boa"+NORM+" skin");
     set_long(
       "  This is the skin from an emerald tree boa, which has been cut off\n"+
       "the giant snake. It is a beautiful deep green color with white stripes\n"+
       "tainting its great length. It looks to be about eight feet long.\n"+
       "It would fetch a good price from the right person.\n");
     set_weight(3);
