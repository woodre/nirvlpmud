...
cmd_stoop() {
  write("You climb the stairs of the stoop, open the door, and enter\n"+
        "the dojo.\n");
  say("After climbing the steps, ");
  TP->move_player("into the dojo#"+HROOM+"halle");
  return 1;
}
