...
use_heal(str) 
{
  ...
  if(!random(5) && !present("bean_affect", environment(this_object()))) /* 20% chance of WC bonus */
  {
    write("Your strength is intensified.\n");
    ob = clone_object("/open/fred/bean_affect.c");
