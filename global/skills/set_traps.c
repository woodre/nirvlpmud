...
void create() {
  set_influence(S_M_SET_TRAPS,"sight","query_sight_quality",#'sight_influence);
  set_influence(S_P_SET_TRAPS,"sight","query_sight_quality",#'sight_influence);

  set_influence(S_M_SET_TRAPS, "intelligence", "query_int", #'int_influence);

  set_influence(S_P_SET_TRAPS, "intelligence", "query_int", #'int_influence);
  set_influence(S_P_SET_TRAPS, "dexterity",    "query_dex", #'dex_influence);
  set_influence(S_P_SET_TRAPS, "strength",     "query_str", #'str_influence);
}
